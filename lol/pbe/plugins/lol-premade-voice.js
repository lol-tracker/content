(() => {
    var e = [, e => {
            ...
            e.exports = function(e = document) {
                ...
                t(l.default), t(a.default), t(o.default), t(i.default), t(r.default), e.premadeVoiceElementsRegistered = !0
            }
        }, (e, t, n) => {
            "use strict";
            Object.defineProperty(t, "__esModule", {
            ...
            class b extends a.default {
                ...
                constructor() {
                    super(), this._participants = [], this._participantMap = new Map, this._multiUserChatId = null, this._gameflowPhase = "", this._isGameClientRunning = !1, this._lastVolumeUpdate = 0, this._lockOutMemberJoinSound = !1, this._clashRoster = null, this._headerType = A.HEADER_LOBBY, this._selectors = {
                ...
                _handleDisconnectedState(e) {
                    ...
                    e ? (this._updateConnectionState(h.VOICE_DISCONNECTED_STATE), t && t.setAttribute("disabled", ""), this.addClass("disabled", this._selectors.currentPlayerContent)) : (t && t.removeAttribute("disabled"), this.removeClass("disabled", this._selectors.currentPlayerContent)), this._updateCurrentPlayerMuteButton()
                }
                _showPanelMessage(e) {
                ...
                _checkAvailabilityMessaging() {
                    ...
                    e = this._outsideVoiceChannelMessaging(), e || (e = this._insideVoiceChannelMessaging()), this._availability.showDisconnectedState && (e = l.tra.get("parties_comm_panel_error")), e ? this._showPanelMessage(e) : this._hidePanelMessage()
                }
                _outsideVoiceChannelMessaging() {
                    let e = null;
                    return this._availability && this._availability.voiceChannelAvailable && 0 === this._participants.length && (e = l.tra.get("parties_comm_panel_msg_disconnected")), e
                }
                _insideVoiceChannelMessaging() {
                    let e = null;
                    return this._availability && this._availability.voiceChannelAvailable && this._participantMap.get(this._currentPlayerPuuid) && 1 === this._participants.length && (e = l.tra.get("parties_comm_panel_msg_premade_no_channel")), e
                }
                ...
                lobbyUpdated(e) {
                    const t = e || {};
                    t.multiUserChatId && t.multiUserChatId !== this._multiUserChatId && (this._conversations && this._chatParticipantsObserver(t.multiUserChatId), this._headerType = A.HEADER_LOBBY), this._multiUserChatId = t.multiUserChatId
                }
                clashRostersUpdated(e) {
                    const t = (e || []).find((e => e.tournamentState !== m.CLASH_ROSTER_STATE.IDLE));
                    t && t.multiUserChatId && (t.multiUserChatId !== this._multiUserChatId && (this._conversations && this._chatParticipantsObserver(t.multiUserChatId), this._headerType = A.HEADER_CLASH, this._clashRoster = t), this._multiUserChatId = t.multiUserChatId)
                }
                ...
                sessionUpdated(e) {
                    ...
                    if (this._currentPlayerPuuid = e.puuid, this._setVoiceHaloPuuid(this._currentPlayerPuuid), this._currentPlayerSummonerId !== e.summonerId) {
                        ...
                        const t = this.shadowRoot.querySelector(this._selectors.currentPlayerName);
                ...
                currentPlayerChatInfoUpdated(e) {
                    ...
                    const {
                        availability: t
                    } = e, n = e.icon, a = this.shadowRoot.querySelector(this._selectors.currentPlayerChatIcon);
                    a && t && n && (a.setAttribute("availability", t), a.setAttribute("icon-id", n))
                }
                ...
                _chatParticipantsObserver(e) {
                    if (p.default.removeObservers(C), this._conversations && e) {
                        ...
                        t && (p.default.createObserver(C, `/v1/conversations/${encodeURIComponent(t.id)}/participants`), p.default.observe(C, this.chatParticipantsUpdated.bind(this)))
                    }
                }
                _chatParticipant(e) {
                    let t = null;
                ...
                _updateConnectionState(e) {
                    ...
                    t !== e && (this._connectionState = e, this.removeClass(t, this._selectors.connectionBar), this.addClass(this._connectionState, this._selectors.connectionBar), this.addInnerHtml(this._getTranslatedString(this._connectionState), this._selectors.connectionState))
                }
                _isVoiceEligible() {
                    return 0 !== this._participants.length
                }
                _connectionMouseEnter() {
                    this._connectionState === h.VOICE_DISCONNECTED_STATE ? this.addInnerHtml(l.tra.get("parties_comm_panel_connect_text"), this._selectors.connectionState) : this._connectionState === h.VOICE_CONNECTED_STATE && this.addInnerHtml(l.tra.get("parties_comm_panel_disconnect_text"), this._selectors.connectionState), this.addClass("button-hover", this._selectors.connectionBar)
                }
                ...
                _connectionClick() {
                    ...
                    }), 1e3), this._connectionState === h.VOICE_DISCONNECTED_STATE ? (this._updateConnectionState(h.VOICE_CONNECTING_STATE), this._lockOutMemberJoinSound = !0, i.default.connect().then(this._joinVoiceSessionSuccess.bind(this)).catch(this._joinVoiceSessionFailed.bind(this))) : this._connectionState === h.VOICE_CONNECTED_STATE ? i.default.disconnect().then(this._leaveVoiceSessionSuccess.bind(this)) : void 0
                }
                ...
                _joinVoiceSessionFailed(e) {
                    if (e && e.data) {
                        ...
                        l.logger.warning(`Failed to join voice channel: ${t}`), this._updateConnectionState(h.VOICE_DISCONNECTED_STATE)
                    }
                }
                ...
                _updateMemberParticipant(e) {
                    ...
                    return t ? (t.updateSelf(e), !0) : (this.addChildElement(this._createParticipantElement(e), this._selectors.participants), !1)
                }
                ...
                _updateCurrentPlayerMuteButton() {
                    this._availability && this._settings && (this._availability.showDisconnectedState || this._settings.inputMode === u.INPUT_MODE_PUSH_TO_TALK ? (this.addClass("disabled", this._selectors.currentPlayerMic), this.removeClass("muted", this._selectors.currentPlayerMic)) : (this.removeClass("disabled", this._selectors.currentPlayerMic), this._settings && this._settings.localMicMuted ? this.addClass("muted", this._selectors.currentPlayerMic) : this.removeClass("muted", this._selectors.currentPlayerMic)), this._attachMuteSelfTooltip())
                }
                _createParticipantElement(e) {
                    const t = document.createElement(this._selectors.participantElement);
                    t.setAttribute("participant-id", e.puuid), t.setAttribute("summoner-id", e.summonerId), t.updateSelf(e);
                    const n = this._chatParticipant(e.summonerId);
                    return t.updateChatParticipant(n), t
                }
                _initDataBinding() {
                    this.lobbyDataListener = this.lobbyUpdated.bind(this), s.default.observe("lobby", this.lobbyDataListener), s.default.lobby().then(this.lobbyDataListener), this.clashChatListener = this.clashRostersUpdated.bind(this), d.default.observe("rosters", this.clashChatListener), d.default.clashRosters().then(this.clashChatListener), this.gameflowSessionListener = this.gameflowSessionUpdated.bind(this), o.default.observe("session", this.gameflowSessionListener), o.default.session().then(this.gameflowSessionListener), this.postgameStatsListener = this.postgameStatsUpdated.bind(this), c.default.observe("stats", this.postgameStatsListener), c.default.stats().then(this.postgameStatsListener), this.availabilityDataListener = this.availabilityUpdated.bind(this), i.default.observe("availability", this.availabilityDataListener), i.default.availability().then(this.availabilityDataListener), this.participantsDataListener = this.participantsUpdated.bind(this), i.default.observe("participants", this.participantsDataListener), i.default.participants().then(this.participantsDataListener), this.settingsDataListener = this.settingsUpdated.bind(this), i.default.observe("settings", this.settingsDataListener), i.default.settings().then(this.settingsDataListener), this.sessionDataListener = this.sessionUpdated.bind(this), r.default.observe("session", this.sessionDataListener), r.default.session().then(this.sessionDataListener), this.currentPlayerChatInfoListener = this.currentPlayerChatInfoUpdated.bind(this), p.default.observe("me", this.currentPlayerChatInfoListener), p.default.me().then(this.currentPlayerChatInfoListener), this.conversationsListener = this.conversationsUpdated.bind(this), p.default.observe("conversations", this.conversationsListener), p.default.conversations().then(this.conversationsListener)
                }
                _toggleMute() {
                    this._settings && this._settings.inputMode !== u.INPUT_MODE_PUSH_TO_TALK && i.default.muteSelf(!this._settings.localMicMuted)
                }
                _settingsClicked() {
                    this._isGameClientRunning || l.SettingsApi.show(u.SETTINGS_CATEGORY_NAME)
                }
                ...
                _attachMuteSelfTooltip() {
                    ...
                    let t;
                    t = this._settings.inputMode === u.INPUT_MODE_PUSH_TO_TALK ? l.tra.get("parties_comm_panel_tooltip_mute_disabled") : this._settings.localMicMuted ? l.tra.get("parties_comm_panel_tooltip_unmute_self") : l.tra.get("parties_comm_panel_tooltip_mute_self"), v.default.attachSmallTooltip(e, t)
                }
                _attachSettingsTooltip() {
                    const e = this.shadowRoot.querySelector(this._selectors.settingsButton);
                    let t;
                    t = this._isGameClientRunning ? l.tra.get("parties_comm_panel_tooltip_settings_disabled") : l.tra.get("parties_comm_panel_tooltip_settings"), v.default.attachSmallTooltip(e, t)
                }
                _willHide() {
                ...
                _attachSliderTooltipDelegate() {
                    ...
                    e && e.setTooltipContentDelegate((function(e) {
                        return l.tra.formatString("parties_comm_panel_tooltip_mic_level", {
                            value: e
                        })
                    }))
                }
            ...
            var i = class {
                ...
                dataBinding(e) {
                    return this._binding = (0, a.dataBinding)(e, a.default.getProvider().getSocket()), this._binding
                }
                createObserver(e, t) {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.SETTINGS_CATEGORY_NAME = t.INPUT_MODE_VOICE = t.INPUT_MODE_PUSH_TO_TALK = void 0;
            ...
            var l = {
                attachSmallTooltip: function(e, t, n, l, i) {
                    ...
                    n = n || {
                        ...
                        x: "center",
                        y: "bottom"
                    }, i = 0 === i || i ? i : 400, a.TooltipManager.unassign(e);
                    ...
                    s.innerHTML = t, r.appendChild(s), o.appendChild(r), a.TooltipManager.assign(e, o, null, {
                        targetAnchor: n,
                        tooltipAnchor: l,
                        showDelay: i
                    })
            ...
            e.exports = function(e) {
                ...
                return t.toString = function() {
                    ...
                    for (var c = 0; c < e.length; c++) {
                        var p = [].concat(e[c]);
                        a && o[p[0]] || (void 0 !== i && (void 0 === p[5] || (p[1] = "@layer".concat(p[5].length > 0 ? " ".concat(p[5]) : "", " {").concat(p[1], "}")), p[5] = i), n && (p[2] ? (p[1] = "@media ".concat(p[2], " {").concat(p[1], "}"), p[2] = n) : p[2] = n), l && (p[4] ? (p[1] = "@supports (".concat(p[4], ") {").concat(p[1], "}"), p[4] = l) : p[4] = "".concat(l)), t.push(p))
                    }
                }, t
            }
        }, e => {
            ...
            class d extends l.default {
                ...
                availabilityUpdated(e) {
                    a.logger.trace("Voice availability: " + JSON.stringify(e)), this._voiceDisabled = !e || !e.showUI, this._handleVoiceDisabled(), this._disabledAfterLogin = e && e.disabledAfterLogin, (this._disabledAfterLogin || e && !e.voiceChannelAvailable) && !this._buttonDisabled ? (this._buttonDisabled = !0, this.addClass("button-disabled", this._elements.voiceButton), this._checkIfTooltipNeeded(), this._hidePanel()) : e && e.voiceChannelAvailable && this._buttonDisabled && (this._buttonDisabled = !1, this.removeClass("button-disabled", this._elements.voiceButton), this._voicePanelElement.dispatchEvent(new Event("voiceButtonEnabled")), this._detachDisabledTooltip())
                }
                lobbyUpdated(e) {
                ...
                _initDataBinding() {
                    this.lobbyDataListener = this.lobbyUpdated.bind(this), r.default.observe("lobby", this.lobbyDataListener), r.default.lobby().then(this.lobbyDataListener), this.availabilityDataListener = this.availabilityUpdated.bind(this), i.default.observe("availability", this.availabilityDataListener), i.default.availability().then(this.availabilityDataListener), this._voiceFirstExperienceListener = this._voiceFirstExperienceUpdated.bind(this), i.default.observe("firstExperience", this._voiceFirstExperienceListener), i.default.firstExperience().then(this._voiceFirstExperienceListener), this.gameflowSessionListener = this.gameflowSessionUpdated.bind(this), o.default.observe("session", this.gameflowSessionListener), o.default.session().then(this.gameflowSessionListener)
                }
                gameflowSessionUpdated(e) {
                    e && e.phase && "ReadyCheck" === e.phase && this._hidePanel()
                }
                _showPanel(e = !0) {
                    this._buttonDisabled || (this.addClass("active", this._elements.voiceButton), a.FlyoutManager.sendEvent(this, "showVoicePanel"), this._voicePanelElement && (this._voicePanelElement.dispatchEvent(new Event("willShowVoicePanel")), e && this._playSound("/fe/lol-premade-voice/sfx-soc-ui-chatwindow-open.ogg")))
                }
                _hidePanel() {
                    a.FlyoutManager.sendEvent(this, "hideVoicePanel")
                }
                _willHide() {
                    this._showedFirstExperience && a.TooltipManager.unassign(this), this.removeClass("active", this._elements.voiceButton), this._voicePanelElement && this._voicePanelElement.dispatchEvent(new Event("willHideVoicePanel"))
                }
                ...
                _attachDisabledTooltip(e) {
                    ...
                    t.appendChild(l), a.TooltipManager.assign(this, t, null, {
                        targetAnchor: {
                            x: "center",
                            y: "top"
                        },
                ...
                _detachDisabledTooltip() {
                    this._tooltipType && (a.TooltipManager.unassign(this), this._tooltipType = null)
                }
                ...
                _checkIfFirstExperience() {
                    this._isSocial && this._showFirstExperience && this._isInPremade && !this._showedFirstExperience && this.parentNode && (this._showPanel(!1), this._attachFirstExperienceTooltip(), i.default.firstExperienceCompleted(), this._showedFirstExperience = !0)
                }
                _attachFirstExperienceTooltip() {
                    const e = this._tooltipContentBlock(a.tra.get("parties_comm_panel_tooltip_first_experience"));
                    this._firstExperienceContextualNotification = a.ContextualNotificationManager.add(e, {
                        target: {
                            domNode: this
                        },
                        offset: {
                ...
                _removeFirstExperienceContextualNotification() {
                    this._firstExperienceContextualNotification && a.ContextualNotificationManager.remove(this._firstExperienceContextualNotification)
                }
            }
            ...
            var a = n(22),
                l = n(23)(a);
            l.push([e.id, '.lol-premade-voice-button {\n  display: flex;\n  width: 38px;\n  height: 32px;\n  background-image: url("/fe/lol-premade-voice/voice-button.png");\n  background-position-y: 0px;\n  background-size: cover;\n  cursor: pointer;\n}\n.lol-premade-voice-button:hover:not(.button-disabled) {\n  background-position-y: -32px;\n}\n.lol-premade-voice-button:active:not(.button-disabled) {\n  background-position-y: -64px;\n}\n.lol-premade-voice-button.button-disabled {\n  background-position-y: -160px;\n  cursor: default;\n}\n.lol-premade-voice-button.active {\n  background-position-y: -96px;\n}\n.lol-premade-voice-button.voice-disabled {\n  display: none;\n}\nlol-uikit-content-block.lol-premade-voice-button-tooltip[type=tooltip-small] {\n  padding: 9px;\n}\n', "", {
                version: 3,
                sources: ["webpack://./fe/rcp-fe-lol-premade-voice/src/elements/voice-button/style.styl"],
                names: [],
                mappings: "AAAA;EACE,aAAa;EACb,WAAW;EACX,YAAY;EACZ,+DAA+D;EAC/D,0BAA0B;EAC1B,sBAAsB;EACtB,eAAe;AACjB;AACA;EACE,4BAA4B;AAC9B;AACA;EACE,4BAA4B;AAC9B;AACA;EACE,6BAA6B;EAC7B,eAAe;AACjB;AACA;EACE,4BAA4B;AAC9B;AACA;EACE,aAAa;AACf;AACA;EACE,YAAY;AACd",
                sourcesContent: ['.lol-premade-voice-button {\n  display: flex;\n  width: 38px;\n  height: 32px;\n  background-image: url("/fe/lol-premade-voice/voice-button.png");\n  background-position-y: 0px;\n  background-size: cover;\n  cursor: pointer;\n}\n.lol-premade-voice-button:hover:not(.button-disabled) {\n  background-position-y: -32px;\n}\n.lol-premade-voice-button:active:not(.button-disabled) {\n  background-position-y: -64px;\n}\n.lol-premade-voice-button.button-disabled {\n  background-position-y: -160px;\n  cursor: default;\n}\n.lol-premade-voice-button.active {\n  background-position-y: -96px;\n}\n.lol-premade-voice-button.voice-disabled {\n  display: none;\n}\nlol-uikit-content-block.lol-premade-voice-button-tooltip[type=tooltip-small] {\n  padding: 9px;\n}\n'],
                sourceRoot: ""
            }]), e.exports = l
        }, (e, t, n) => {
            "use strict";
            ...
            class s extends a.default {
                ...
                updateSelf(e) {
                    ...
                    t && (t.setAttribute("puuid", e.puuid), t.setAttribute("summoner-id", e.summonerId))
                }
                ...
                _attachMuteTooltip(e) {
                    ...
                    let n;
                    n = e ? i.tra.get("parties_comm_panel_tooltip_unmute_participant") : i.tra.get("parties_comm_panel_tooltip_mute_participant"), o.default.attachSmallTooltip(t, n, {
                        x: "right",
                        y: "center"
                    }, {
                        x: "left",
                ...
                _attachSliderTooltipDelegate() {
                    const e = this.shadowRoot.querySelector(this._selectors.sliderElement);
                    e && e.setTooltipContentDelegate((function(e) {
                        return i.tra.formatString("parties_comm_panel_tooltip_participant_volume", {
                            value: e
                        })
                    }))
                }
            ...
            h.push([e.id, ".lol-premade-voice-participant .lol-premade-voice-panel-participant-content lol-uikit-slider {\n  width: 155px;\n  height: 15px;\n  --slider-base-before-top: 7px;\n  --slider-btn-cursor: pointer;\n  --slider-btn-width: 15px;\n  --slider-btn-height: 15px;\n  --slider-btn-hover-background-position: 0 -15px;\n  --slider-btn-active-background-position: 0 -30px;\n  --slider-fill-top: 6px;\n}\n.lol-premade-voice-participant {\n  display: flex;\n  flex-direction: row;\n  height: 100%;\n  width: 100%;\n  align-items: center;\n  position: relative;\n}\n.lol-premade-voice-participant.speaking {\n  background: linear-gradient(to right, rgba(255,255,255,0.1) 0%, rgba(255,255,255,0) 100%);\n}\n.lol-premade-voice-participant .lol-premade-voice-panel-chat-icon {\n  align-self: center;\n}\n.lol-premade-voice-participant .lol-premade-voice-panel-participant-mute {\n  background-image: url(" + m + ");\n  background-position: center;\n  background-size: cover;\n  background-repeat: no-repeat;\n  width: 18px;\n  height: 18px;\n  margin-top: 14px;\n  cursor: pointer;\n  position: relative;\n}\n.lol-premade-voice-participant .lol-premade-voice-panel-participant-mute:hover {\n  background-image: url(" + u + ");\n}\n.lol-premade-voice-participant .lol-premade-voice-panel-participant-mute:active {\n  background-image: url(" + A + ");\n}\n.lol-premade-voice-participant .lol-premade-voice-panel-participant-mute.muted {\n  background-image: url(" + v + ");\n}\n.lol-premade-voice-participant .lol-premade-voice-panel-participant-mute.muted:hover {\n  background-image: url(" + g + ");\n}\n.lol-premade-voice-participant .lol-premade-voice-panel-participant-mute.muted:active {\n  background-image: url(" + C + ");\n}\n.lol-premade-voice-participant .lol-premade-voice-panel-participant-content {\n  display: flex;\n  flex-direction: column;\n  width: 205px;\n  color: #a09b8c;\n  font-size: 14px;\n  margin: 11px 0 11px 9px;\n}\n.lol-premade-voice-participant .lol-premade-voice-panel-participant-content:lang(ar-ae) {\n  margin: 11px 9px 11px 0;\n}\n.lol-premade-voice-participant .lol-premade-voice-panel-participant-content .lol-premade-voice-panel-participant-volume-row {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  width: 155px;\n}\n.lol-premade-voice-participant .lol-premade-voice-panel-participant-content .lol-premade-voice-panel-participant-volume-row .lol-premade-voice-panel-participant-name {\n  max-width: 130px;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n  overflow: hidden;\n}\n.lol-premade-voice-participant .lol-premade-voice-panel-participant-content .lol-premade-voice-panel-participant-volume-row .lol-premade-voice-panel-participant-volume {\n  margin: 0 2px 0 0;\n}\n.lol-premade-voice-participant .lol-premade-voice-panel-participant-content .lol-premade-voice-panel-participant-volume-row .lol-premade-voice-panel-participant-volume:lang(ar-ae) {\n  margin: 0 0 0 2px;\n}\n", "", {
                version: 3,
                sources: ["webpack://./fe/rcp-fe-lol-premade-voice/src/elements/voice-panel/voice-participant/style.styl"],
                names: [],
            ...
            class s extends a.default {
                ...
                _initDataBinding() {
                    this.participantsDataListener = this._handleParticipantsChanged.bind(this), l.default.observe("participants", this.participantsDataListener), l.default.participants().then(this.participantsDataListener)
                }
            }
            ...
            l.push([e.id, ":host .lol-premade-voice-comm-halo {\n  transition: box-shadow 0.15s ease-in-out;\n  position: relative;\n}\n:host .lol-premade-voice-comm-halo:before {\n  content: '';\n  opacity: 0;\n  width: 100%;\n  height: 100%;\n  position: absolute;\n  top: 0;\n  left: 0;\n  transition: opacity 0.15s ease-in-out;\n  box-shadow: 0 0 0 2px #4bb44b;\n}\n:host .lol-premade-voice-comm-halo.speaking:before {\n  opacity: 1;\n}\n:host .lol-premade-voice-comm-halo.small:before {\n  box-shadow: 0 0 0 1px #4bb44b;\n}\n:host .lol-premade-voice-comm-halo {\n  border-radius: 50%;\n}\n:host .lol-premade-voice-comm-halo:before {\n  border-radius: 50%;\n}\n:host {\n  --premade-voice-halo-margin: 0 0 0 0;\n  --premade-voice-halo-width: auto;\n  --premade-voice-halo-height: auto;\n  --premade-voice-halobefore-box-shadow: none;\n}\n:host .lol-premade-voice-comm-halo {\n  margin: var(--premade-voice-halo-margin);\n  width: var(--premade-voice-halo-width);\n  height: var(--premade-voice-halo-height);\n}\n:host .lol-premade-voice-comm-halo:before {\n  box-shadow: var(--premade-voice-halobefore-box-shadow);\n}\n", "", {
                ...
                sourcesContent: [":host .lol-premade-voice-comm-halo {\n  transition: box-shadow 0.15s ease-in-out;\n  position: relative;\n}\n:host .lol-premade-voice-comm-halo:before {\n  content: '';\n  opacity: 0;\n  width: 100%;\n  height: 100%;\n  position: absolute;\n  top: 0;\n  left: 0;\n  transition: opacity 0.15s ease-in-out;\n  box-shadow: 0 0 0 2px #4bb44b;\n}\n:host .lol-premade-voice-comm-halo.speaking:before {\n  opacity: 1;\n}\n:host .lol-premade-voice-comm-halo.small:before {\n  box-shadow: 0 0 0 1px #4bb44b;\n}\n:host .lol-premade-voice-comm-halo {\n  border-radius: 50%;\n}\n:host .lol-premade-voice-comm-halo:before {\n  border-radius: 50%;\n}\n:host {\n  --premade-voice-halo-margin: 0 0 0 0;\n  --premade-voice-halo-width: auto;\n  --premade-voice-halo-height: auto;\n  --premade-voice-halobefore-box-shadow: none;\n}\n:host .lol-premade-voice-comm-halo {\n  margin: var(--premade-voice-halo-margin);\n  width: var(--premade-voice-halo-width);\n  height: var(--premade-voice-halo-height);\n}\n:host .lol-premade-voice-comm-halo:before {\n  box-shadow: var(--premade-voice-halobefore-box-shadow);\n}\n"],
                sourceRoot: ""
            }]), e.exports = l
        }, (e, t, n) => {
            "use strict";
            ...
            class c extends l.default {
                ...
                connectedCallback() {
                    super.connectedCallback(), i.default.participants().then(this._listeners.participantsChanged), i.default.settings().then(this._listeners.settingsChanged), this.attachListener("click", this._listeners.click, this._elements.button)
                }
                disconnectedCallback() {
                    super.disconnectedCallback(), this.detachListener("click", this._listeners.click, this._elements.button), this._testIsRunning && i.default.stopMicTest()
                }
                getComponentFolderPath() {
                    return super.getComponentFolderPath(), "mic-test-button"
                }
                _clickHandler() {
                    this._inVoiceChannel || (this._testIsRunning ? i.default.stopMicTest() : i.default.startMicTest())
                }
                _handleVoiceTest(e) {
                ...
                _updateState() {
                    ...
                    let e;
                    this._updateEnabled(!0), this._testIsRunning ? (e = a.tra.get("mic_test_button_label_testing"), this.addClass("active", this._elements.button)) : (e = a.tra.get("mic_test_button_label_test"), this.removeClass("active", this._elements.button)), this.addInnerHtml(e, this._elements.label)
                }
                _updateEnabled(e) {
                    const t = this.shadowRoot.querySelector(this._elements.button);
                    e ? (this.removeClass("button-disabled", this._elements.button), r.default.removeTooltip(t)) : (this.addInnerHtml("&nbsp;", this._elements.label), this.addClass("button-disabled", this._elements.button), r.default.attachSmallTooltip(t, a.tra.get("mic_test_button_tooltip_disabled")))
                }
                _initDataBinding() {
                    i.default.observe("mictest", this._listeners.testDataChanged), i.default.observe("participants", this._listeners.participantsChanged), i.default.observe("settings", this._listeners.settingsChanged)
                }
            }
            ...
            l.push([e.id, '.lol-voice-mic-test-label {\n  font-family: var(--font-body);\n}\n.lol-voice-mic-test-label {\n  font-family: var(--font-body);\n}\n.lol-voice-mic-test-label {\n  -webkit-user-select: none;\n}\n.lol-voice-mic-test-label {\n  font-kerning: normal;\n  -webkit-font-feature-settings: "kern" 1;\n  -webkit-font-smoothing: antialiased;\n}\n.lol-voice-mic-test-label {\n  color: #a09b8c;\n  font-size: 12px;\n  font-weight: normal;\n  line-height: 16px;\n  letter-spacing: 0.025em;\n  -webkit-font-smoothing: subpixel-antialiased;\n}\n.lol-voice-mic-test-label:lang(ja-jp) {\n  font-size: 13px;\n}\n.lol-voice-mic-test-label:lang(ar-ae) {\n  letter-spacing: 0;\n}\n.lol-voice-mic-test-button {\n  display: flex;\n  width: 38px;\n  height: 32px;\n  background-image: url("/fe/lol-premade-voice/voice-button.png");\n  background-position-y: 0px;\n  background-size: cover;\n  cursor: pointer;\n}\n.lol-voice-mic-test-button:hover:not(.button-disabled) {\n  background-position-y: -32px;\n}\n.lol-voice-mic-test-button:active:not(.button-disabled) {\n  background-position-y: -64px;\n}\n.lol-voice-mic-test-button.button-disabled {\n  background-position-y: -160px;\n  cursor: default;\n}\n.lol-voice-mic-test-button.active {\n  background-position-y: -96px;\n}\n.lol-voice-mic-test-button {\n  transition: box-shadow 0.15s ease-in-out;\n  position: relative;\n}\n.lol-voice-mic-test-button:before {\n  content: \'\';\n  opacity: 0;\n  width: 100%;\n  height: 100%;\n  position: absolute;\n  top: 0;\n  left: 0;\n  transition: opacity 0.15s ease-in-out;\n  box-shadow: 0 0 0 2px #4bb44b;\n}\n.lol-voice-mic-test-button.speaking:before {\n  opacity: 1;\n}\n.lol-voice-mic-test-button.small:before {\n  box-shadow: 0 0 0 1px #4bb44b;\n}\n.lol-voice-mic-test-label {\n  min-height: 16px;\n  margin-bottom: 5px;\n}\n.lol-voice-mic-test-button.active {\n  background-position-y: -96px;\n}\n', "", {
                ...
                sourcesContent: ['.lol-voice-mic-test-label {\n  font-family: var(--font-body);\n}\n.lol-voice-mic-test-label {\n  font-family: var(--font-body);\n}\n.lol-voice-mic-test-label {\n  -webkit-user-select: none;\n}\n.lol-voice-mic-test-label {\n  font-kerning: normal;\n  -webkit-font-feature-settings: "kern" 1;\n  -webkit-font-smoothing: antialiased;\n}\n.lol-voice-mic-test-label {\n  color: #a09b8c;\n  font-size: 12px;\n  font-weight: normal;\n  line-height: 16px;\n  letter-spacing: 0.025em;\n  -webkit-font-smoothing: subpixel-antialiased;\n}\n.lol-voice-mic-test-label:lang(ja-jp) {\n  font-size: 13px;\n}\n.lol-voice-mic-test-label:lang(ar-ae) {\n  letter-spacing: 0;\n}\n.lol-voice-mic-test-button {\n  display: flex;\n  width: 38px;\n  height: 32px;\n  background-image: url("/fe/lol-premade-voice/voice-button.png");\n  background-position-y: 0px;\n  background-size: cover;\n  cursor: pointer;\n}\n.lol-voice-mic-test-button:hover:not(.button-disabled) {\n  background-position-y: -32px;\n}\n.lol-voice-mic-test-button:active:not(.button-disabled) {\n  background-position-y: -64px;\n}\n.lol-voice-mic-test-button.button-disabled {\n  background-position-y: -160px;\n  cursor: default;\n}\n.lol-voice-mic-test-button.active {\n  background-position-y: -96px;\n}\n.lol-voice-mic-test-button {\n  transition: box-shadow 0.15s ease-in-out;\n  position: relative;\n}\n.lol-voice-mic-test-button:before {\n  content: \'\';\n  opacity: 0;\n  width: 100%;\n  height: 100%;\n  position: absolute;\n  top: 0;\n  left: 0;\n  transition: opacity 0.15s ease-in-out;\n  box-shadow: 0 0 0 2px #4bb44b;\n}\n.lol-voice-mic-test-button.speaking:before {\n  opacity: 1;\n}\n.lol-voice-mic-test-button.small:before {\n  box-shadow: 0 0 0 1px #4bb44b;\n}\n.lol-voice-mic-test-label {\n  min-height: 16px;\n  margin-bottom: 5px;\n}\n.lol-voice-mic-test-button.active {\n  background-position-y: -96px;\n}\n'],
                sourceRoot: ""
            }]), e.exports = l
        }, (e, t, n) => {
            "use strict";
            ...
            e.exports = class {
                ...
                _addVoiceSocialButton() {
                    a.Social.addSocialButton(this.voiceButton({
                        social: "true"
                    }), "CommButton", 1)
                }
                _voicePanel() {
                ...
                _registerComponents() {
                    a.ComponentFactory.setFactory("lol-parties-comm-panel", (() => this._voicePanel()))
                }
            }
        }],
        t = {};
