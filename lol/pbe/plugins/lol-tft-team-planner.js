        ...
        t.default = class {
          ...
          _registerComponents() {
            const e = {
              ...
              TeamPlannerService: g.default.extend({ privateApi: this }),
            ...
            for (
              a.forEach((e) => {
                if (0 === e.indexOf(f))
                  ...
                  a.max_units && (o = o && n <= a.max_units),
                    (e = o
                      ? (e = e.replace(_, v)).replace(g, y)
                      : (e = e.replace(_, b)).replace(g, x)),
                    r++,
                    (l += e + h);
                } else {
