(() => {
  var e = [
        ...
        t.default = class {
          ...
          _registerComponents() {
            const e = {
              ...
              TierContainerComponent: _.default,
      ...
      (e, t, n) => {
        ...
        e.exports = { FixDataBindingMixin: r, DataBindingMixin: l };
      },
      (e, t, n) => {
        "use strict";
      ...
      (e, t, n) => {
        ...
        var i = a.Ember.Component.extend({
          ...
          actions: {
            clearTeam() {
              r.delete("/lol-tft-team-planner/v1/team/champions");
            },
          },
        });
        t.default = i;
      ...
      (e, t, n) => {
        ...
        var a = n(1),
          l = n(6);
        const r = "/lol-matchmaking/v1/ready-check",
        ...
        var k = a.Ember.Service.extend({
          ...
          _calculateTraitLevel(e, t, n) {
            ...
            if (
              (e.conditional_trait_sets.forEach((e) => {
                t >= e.min_units
                  ...
                  : r < 0 && "kChromatic" !== e.style_name && (r = e.min_units);
              }),
              -1 === r)
            ) {
            ...
            (n.style = a), (n.styleRank = l), (n.nextThreshold = r);
          },
          _generateTraitData(e) {
            ...
            for (const l in e) {
              const r = e[l],
                ...
                s = {};
              (s.id = l),
                (s.displayName = i.display_name),
                (s.icon_path = i.icon_path),
                (s.tooltipText = this._replaceTokens(i.tooltip_text, i, r)),
                (s.currentCount = r),
                this._calculateTraitLevel(i, r, s);
              const o = a.Ember.Object.create(s);
              t.pushObject(o);
            }
            return t;
          },
          ...
          _replaceTokens(e, t, n) {
            const a = e.split(h);
            let l = "";
            const r = t.conditional_trait_sets.reduce((e, t) => {
                let a = n >= t.min_units;
                return t.max_units && (a = a && n <= t.max_units), a ? t : e;
              }),
              i = this._generateTokenSubstitutions(r, t);
            let s = 0;
            for (
              a.forEach((e) => {
                if (0 === e.indexOf(_))
                  t.conditional_trait_sets.forEach((a) => {
                    const r = this._generateTokenSubstitutions(a, t);
                    let i = e,
                      s = this._replaceFirstToken(i, r);
                    for (; s.didReplace; )
                      (i = s.replacedString),
                        (s = this._replaceFirstToken(i, r));
                    let o = n >= a.min_units;
                ...
                else if (0 === e.indexOf(f)) {
                  const a = t.conditional_trait_sets[s],
                    r = this._generateTokenSubstitutions(a, t);
                  let i = this._replaceFirstToken(e, r);
                  for (; i.didReplace; )
                    (e = i.replacedString), (i = this._replaceFirstToken(e, r));
                  let o = n >= a.min_units;
                  a.max_units && (o = o && n <= a.max_units),
                    (e = o
                      ? (e = e.replace(f, v)).replace(g, y)
                      : (e = e.replace(f, b)).replace(g, x)),
                    s++,
                    (l += e + h);
                } else {
          ...
          _replaceFirstToken(e, t) {
            ...
            if (l) {
              ...
              r = l.toFixed(n.precision);
            } else a = !0;
            return {
              replacedString:
                e.slice(0, n.start) + r + e.slice(n.end + 1, e.end),
              didReplace: !0,
              error: a,
            };
          },
          ...
          saveAndExit(e = "tft-teamPlanner") {
            this.get("remindersFeatureEnabled") && u.patch(s, !0),
              u.put(m),
  ...
  (n.r = (e) => {
    ...
    (() => {
      ...
      const r = window.getPluginAnnounceEventName(a.PLUGIN_NAME);
      l.addEventListener(
        r,
        function (e) {
