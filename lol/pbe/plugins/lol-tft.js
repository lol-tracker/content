(() => {
    var e = [, e => {
            ...
            const E = {
                ...
                formatTimeSpent: (e, t, n = {}) => E.format(e, E.TYPE.TIME_SPENT, e, {
                    [E.KEY.TIME_SPENT]: t,
                    ...n
                })
            };
                        ...
                        this._indexModel = t,
                            function(e) {
                                const t = {
                                        ...
                                        TftTrovesComponent: n(142).default,
                                        RewardCardComponent: n(146).default,
                                        PortalVideoComponent: n(147).default,
                                        TrovesSpriteAnimationComponent: n(148).default,
                                        TimeRemainingWidgetComponent: n(149).default,
                                        ApplicationController: n(150).default,
                                        BattlePassController: n(151).default,
                                        HomeController: n(152).default,
                                        MatchHistoryController: n(153).default,
                                        NewsController: n(154).default,
                                        TrovesController: n(155).default,
                                        EventPageController: n(156).default,
                                        EqHelper: s.Ember.Helper.helper((e => e[0] === e[1])),
                                        TftService: n(157).default,
                                        QueueService: n(160).default,
                                        PublishingService: n(161).default,
                                        StoreService: n(162).default,
                                        TftTrovesService: n(163).default,
                                        SummonerService: n(164).default,
                                        TEMPLATES: {
                                            application: n(165),
                                            index: n(166),
                                            loading: n(167),
                                            [a.TFT_HOME_ROUTE]: n(168),
                                            [a.TFT_NEWS_ROUTE]: n(169),
                                            [a.TFT_BATTLE_PASS_ROUTE]: n(170),
                                            [a.TFT_MATCH_HISTORY_ROUTE]: n(171),
                                            [a.TFT_TEST_ROUTE]: n(172),
                                            [a.TFT_EVENT_ROUTE]: n(173),
                                            "components/mythic-button": n(174),
                                            "components/mythic-token-dialog": n(175),
                                            "components/pull-button": n(176),
                                            "components/pull-buttons-container": n(177),
                                            "components/pull-error-dialog": n(178),
                                            "components/item-purchase": n(179),
                                            "components/time-remaining-widget": n(180),
                                            "components/troves-banners": n(181),
                                            "components/troves-ceremony": n(182),
                                            "components/troves-ceremony-highlight-rewards": n(183),
                                            "components/troves-ceremony-standard-rewards": n(184),
                                            "components/chased-content": n(185),
                                            "components/tft-troves": n(186),
                                            "components/reward-card": n(187),
                                            "components/portal-video": n(188),
                                            "components/troves-sprite-animation": n(189),
                                            troves: n(190)
                                        }
                                    },
                                    l = {
                                        tra: s.traService,
                                        ComponentFactory: s.componentFactory,
                                        ItemPurchaseComponent: n(191).default
                                    };
                                ...
                                const o = {
                                    tra: s.traService,
                                    ComponentFactory: s.componentFactory,
                                    RewardCelebrationComponent: n(192).default
                                };
                                s.emberApplicationFactory.setFactoryDefinition(a.REWARD_CELEBRATION_NAME, o);
                                const i = {
                                    tra: s.traService,
                                    ComponentFactory: s.componentFactory,
                                    RewardCelebrationComponent: n(195).default
                                };
            ...
            var l = s.Ember.Component.extend({
                ...
                progress: s.Ember.computed("milestone.state", "milestone.pointsEarnedForMilestone", "milestone.pointsNeededForMilestone", (function() {
                    if ("REWARDABLE" === this.get("milestone.state") || "CLAIMABLE" === this.get("milestone.state") || "COMPLETE" === this.get("milestone.state")) return 100;
            ...
            var o = s.Ember.Component.extend({
                ...
                showRSC: s.Ember.computed("currentRouteName", "trovesService.trovesV2Enabled", (function() {
                    return !1
                })),
                init() {
                    this._super(...arguments)
            ...
            var h = s.Ember.Component.extend({
                ...
                tencentLogoAssetId: s.Ember.computed("eventHubTencentConfigs", (function() {
                    const e = this.get("eventHubTencentConfigs");
                    return s.Ember.isEmpty(e) || s.Ember.isEmpty(e[0].logoAssetId) ? "" : e[0].logoAssetId
                })),
                hasTencentLogoAssetId: s.Ember.computed.notEmpty("tencentLogoAssetId"),
                eventHubAssets: s.Ember.computed.alias("tftService.eventHubAssets"),
                logoTftNameTencentImagePath: s.Ember.computed("eventHubAssets", "tencentLogoAssetId", (function() {
            ...
            var p = s.Ember.Component.extend({
                ...
                missionTrackerIcons: s.Ember.computed("missionTrackerTotal", "missionTrackerCurrent", "currentMissionCompleted", "eventHubAssets", (function() {
                    const e = [],
            ...
            var u = s.Ember.Component.extend({
                ...
                hasEventBannerTexture: s.Ember.computed("displayedBanner", (function() {
                    return this.get("displayedBanner").eventHubBannerTexture.endsWith(".png")
                })),
                bannerTexture: s.Ember.computed("displayedBanner", "hasEventBannerTexture", (function() {
            ...
            var s = n(1),
                ...
                l = s.Ember.Component.extend({
                    ...
                    isSinglePullDisabledTrovesV2: s.Ember.computed("trovesTokensAmount", "activeBannerStatus", "isPulling", "pullCost", (function() {
                        const e = this.get("trovesTokensAmount"),
                            t = this.get("activeBannerStatus"),
                            n = this.get("isPulling"),
                            s = this.get("pullCost");
                    ...
                    isTenPullDisabledTrovesV2: s.Ember.computed("trovesTokensAmount", "activeBannerStatus", "isPulling", "pullCost", (function() {
                        const e = this.get("trovesTokensAmount"),
                            t = this.get("activeBannerStatus"),
                            n = this.get("isPulling"),
                            s = this.get("tenPullCost");
                    ...
                    isDisabledForPullTrovesV2: (e, t, n, s) => !!s || (!!n.isCollectorBountyMaxRollsMet || (!t || !n || t < e)),
            ...
            var r = o.extend({
                ...
                onPityUpdate: null,
                trovesService: s.Ember.inject.service("tftTroves"),
                chasedContentOwnedText: i("chasedContent", (function() {
                    const e = this.get("chasedContent"),
                        t = this.get("tra");
                    return e && e.name ? t.formatString("troves_chased_content_owned", {
                        name: e.name
                    }) : ""
                })),
                pityCounter: i("chasedContent.status", "chasedContent.pityLimit", (function() {
                ...
                pityText: i("pityCounter", "chasedContent.name", "chasedContent.status", (function() {
                ...
                legalDisclaimer: i("chasedContent.isCollectorBounty", (function() {
                ...
                legalDisclaimerTrovesV2: i((function() {
                    return {
                        badgeTitle: "Mini-Promise",
                        title: "Mini-Promise",
                        description: "Mini-Promise Description",
                        subtitle: "Mini-Promise Additional Information",
                        iconCssClass: "bad-luck-protection-icon"
                    }
                })),
                showBannerTimer: i("chasedContent", (function() {
                    const e = this.get("chasedContent");
                    if (!e || !e.endDate) return !1;
                    const t = new Date(e.endDate) - Date.now();
                    return t <= l.TIME.TIME_CONVERSIONS.MILLISECONDS_IN_A_WEEK && t > 0
                })),
            ...
            const o = n(143),
                ...
                c = "troves-hub-banner-error",
                m = "troves-hub-banner-empty",
                u = "troves-hub-cloud-platform-image";
            var d = i.extend({
                classNames: ["rcp-fe-lol-tft-troves"],
                trovesService: s.Ember.inject.service("tftTroves"),
                activeBanner: null,
                onBannerSelected: null,
                isLoading: r.alias("trovesService.isLoading"),
                hasBannerError: r.alias("trovesService.hasBannerError"),
                trovesPromoAssets: r.alias("trovesService.trovesPromoAssets"),
                activeBanners: r.alias("trovesService.troveActiveBanners"),
                _visitId: null,
                isEmpty: r.empty("activeBanners"),
                errorBannerImage: r("trovesPromoAssets", (function() {
                    const e = this.get("trovesPromoAssets");
                    return e && e[c] ? e[c] : ""
                })),
                emptyBannerImage: r("trovesPromoAssets", (function() {
                    const e = this.get("trovesPromoAssets");
                    return e && e[m] ? e[m] : ""
                })),
                cloudPlatformImage: r("trovesPromoAssets", (function() {
                    const e = this.get("trovesPromoAssets");
                    return e && e[u] ? e[u] : ""
                })),
                activePlatformImage: r("cloudPlatformImage", "activeBanner", (function() {
                ...
                activeBannerStatus: r.alias("activeBanner.status"),
                currencySegmentData: r.alias("activeBanner.celebrationTheme.currencySegmentData"),
                pullCost: r.alias("activeBanner.pullCost"),
                selectedOfferId: r.alias("activeBanner.rollOffer"),
                showBannersList: r("activeBanners", (function() {
                    const e = this.get("activeBanners");
                    return e && e.length > 1
                })),
                showBannerTimer: r("activeBanner", (function() {
                    const e = this.get("activeBanner");
                    if (!e || !e.endDate) return !1;
                    const t = new Date(this.get("activeBanner.endDate")) - Date.now();
                    return t <= l.TIME.TIME_CONVERSIONS.MILLISECONDS_IN_A_WEEK && t > 0
                })),
                mythicOfferId: r("activeBanner", (function() {
                    const e = this.get("activeBanner");
            ...
            var l = s.Ember.Controller.extend({
                ...
                hubBackground: s.Ember.computed("media", "displayEventPass", "eventHubBackgroundImagePath", (function() {
                    return this.get("displayEventPass") ? this.get("media.background--eventpass") : this.get("eventHubBackgroundImagePath")
                })),
            ...
            var s, a = n(1),
                l = (s = n(158)) && s.__esModule ? s : {
                    default: s
                },
                o = n(2);
            const i = n(159).default;
            ...
            e.exports = s.HTMLBars.template({
                id: "uQJPzevz",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_14_2\\\\LeagueClientContent_Release\\\\15680\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-tft\\\\src\\\\app\\\\templates\\\\index.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["block",["if"],[["get",["model","isVisible"]]],null,0]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","    "],["open-element","div",[]],["flush-element"],["close-element"],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const s = n(1).Ember;
            e.exports = s.HTMLBars.template({
                id: "wYwcbtu/",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_14_2\\\\LeagueClientContent_Release\\\\15680\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-tft\\\\src\\\\app\\\\templates\\\\loading.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["append",["unknown",["uikit-spinner"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const s = n(1).Ember;
            ...
            e.exports = s.HTMLBars.template({
                id: "/kJdxbIR",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_14_2\\\\LeagueClientContent_Release\\\\15680\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-tft\\\\src\\\\app\\\\templates\\\\troves.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","rcp-fe-lol-tft-application-background"],["dynamic-attr","style",["concat",["background-image:url(",["unknown",["backgroundPath"]],")"]]],["flush-element"],["text","\\n  "],["open-element","div",[]],["static-attr","class","rcp-fe-lol-tft-application"],["static-attr","style","height: 720px; width: 1055px;"],["flush-element"],["text","\\n"],["block",["if"],[["helper",["riot-future"],null,null]],null,3,0],["text","  "],["close-element"],["text","\\n"],["close-element"],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","    "],["append",["helper",["tft-troves"],null,[["activeBanner","onBannerSelected"],[["get",["displayedBanner"]],["helper",["action"],[["get",[null]],"onBannerSelected"],null]]]],false],["text","\\n"]],"locals":[]},{"statements":[["text","      "],["append",["helper",["tft-troves"],null,[["activeBanner","onBannerSelected"],[["get",["displayedBanner"]],["helper",["action"],[["get",[null]],"onBannerSelected"],null]]]],false],["text","\\n"]],"locals":[]},{"statements":[["text","      "],["append",["helper",["tft-troves-v2"],null,[["activeBanner","onBannerSelected"],[["get",["displayedBanner"]],["helper",["action"],[["get",[null]],"onBannerSelected"],null]]]],false],["text","\\n"]],"locals":[]},{"statements":[["block",["if"],[["get",["trovesService","trovesV2Enabled"]]],null,2,1]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
