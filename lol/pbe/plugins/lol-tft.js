    ...
    var e = [, e => {
            ...
            var i = l.extend({
                ...
                pityText: o("pityCounter", "chasedContent.name", "chasedContent.status", (function() {
                    ...
                    let o;
                    return this.get("chasedContent.isCollectorBounty") ? (l.max_roll = this.get("chasedContent.maxTotalRolls"), o = s.isCollectorBountyMaxRollsMet ? "troves_collectors_pity_max_rolls_text" : a ? "troves_collectors_pity_owned_text" : "troves_collectors_pity_text") : o = "troves_chased_content_pity_text", t.formatString(o, l)
                })),
            ...
            var l = s.Ember.Controller.extend({
                ...
                displayedBanner: s.Ember.computed("activeBannersById", "displayedBannerId", (function() {
                    const e = this.get("displayedBannerId");
                    if (e) {
            ...
            var l = s.Ember.Controller.extend({
                ...
                actions: {
                    toggleEventPass() {
                        ...
                        const e = this.get("tftService");
                        e && (e.toggleProperty("isSubNavEnabled"), e.toggleProperty("isHeaderButtonsEnabled")), this.get("displayEventPass") ? (this.set("telemetryEventPassTimeStart", Date.now()), s.Telemetry.sendCustomData(a.DEFAULT_TELEMETRY_TABLE, a.TFT_TELEMETRY_EVENT.formatOpen(a.TFT_TELEMETRY_EVENT.FROM.EVENT_PASS))) : (s.Telemetry.sendCustomData(a.DEFAULT_TELEMETRY_TABLE, a.TFT_TELEMETRY_EVENT.formatClose(a.TFT_TELEMETRY_EVENT.FROM.EVENT_PASS)), this.set("telemetryEventPassTimeSpent", Date.now() - this.get("telemetryEventPassTimeStart")), s.Telemetry.sendCustomData(a.DEFAULT_TELEMETRY_TABLE, a.TFT_TELEMETRY_EVENT.formatTimeSpent(a.TFT_TELEMETRY_EVENT.FROM.EVENT_PASS, this.get("telemetryEventPassTimeSpent"))))
                    }
                }
            });
            t.default = l
            ...
            e.exports = s.HTMLBars.template({
                id: "z1jIlt5V",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_24\\\\LeagueClientContent_Release\\\\15690\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-tft\\\\src\\\\app\\\\templates\\\\index.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["block",["if"],[["get",["model","isVisible"]]],null,0]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","    "],["open-element","div",[]],["flush-element"],["close-element"],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const s = n(1).Ember;
            e.exports = s.HTMLBars.template({
                id: "ZIpMYOm5",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_24\\\\LeagueClientContent_Release\\\\15690\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-tft\\\\src\\\\app\\\\templates\\\\loading.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["append",["unknown",["uikit-spinner"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const s = n(1).Ember;
