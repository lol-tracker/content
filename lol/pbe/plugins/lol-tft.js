(() => {
    var e = [, e => {
                ...
                showTroves(e = 1) {
                    this.show().then((t => {
                        t.renderPromise.then((t => {
                            ...
                            n ? n.set("trovesV2Enabled", 2 === e) : s.logger.warning("Failed to fetch TFT service from TFT Ember app");
                            const l = t.__container__.lookup("router:main");
                            l ? l.transitionTo(a.TFT_TROVES_ROUTE) : s.logger.warning("Failed to fetch TFT main router from TFT Ember app")
                        }))
                    }))
                }
                showEventPass() {
            ...
            var d = i.extend({
                ...
                activeBanners: r("trovesService.troveActiveBanners", (function() {
                    const e = this.get("trovesService.troveActiveBanners");
                    return e && e.length ? e.filter((e => 1 === e.version)) : []
                })),
            ...
            var a = s.Ember.Controller.extend({
                ...
                setAnnouncementIcon: s.Ember.computed("mapData.assets.set-announcement-icon", "tftService.locale", (function() {
            ...
            var p = a.Ember.Service.extend({
                ...
                _initObservers() {
                    d.addObserver(u.STAR_SHARDS_TOGGLES, this, (e => {
                        ...
                        e && (this.set("storePromoAssets", e[m]), this.set("eventPromoTileAssets", e["lcu-assets-tft-event-promo-tile"]), this.set("eventHubAssets", e["lcu-assets-tft-event-hub"]), this.set("rotationalShopAssets", e["lcu-assets-tft-rotational-shop"]), this.set("teamPlannerButtonAssets", e["lcu-assets-tft-team-planner-button"]))
                ...
                _setLocale() {
                    (0, a.dataBinding)("/riotclient").get("/region-locale").then((e => {
