(() => {
    var e = [, e => {
            ...
            var i = l.extend({
                ...
                onPityUpdate: null,
                trovesService: s.Ember.inject.service("tftTroves"),
                chasedContentOwnedText: o("chasedContent", (function() {
