  ...
  var e = [
      ...
      (e, t) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.soundsRoot =
            ...
            t.TFT_INDEX_ROUTE =
            t.TFT_HOME_ROUTE =
            t.TFT_GAME_SELECT_MODE_GROUP =
            t.TFT_GAME_SELECT_CATEGORY =
            t.TFT_GAME_MODE =
            t.TFT_EVENT_ROUTE =
        ...
        t.TFT_GAME_SELECT_CATEGORY = "kPvP";
        t.TFT_GAME_MODE = "TFT";
        t.TFT_GAME_SELECT_MODE_GROUP = "kTFT";
        t.TFT_MAP_ID = 22;
      ...
      (e, t, n) => {
        ...
        var o = s.Ember.Component.extend({
          ...
          level: s.Ember.computed("activeMilestone.level", function () {
            const e = Math.max(0, this.get("activeMilestone.level"));
        ...
        var i = s.Ember.Component.extend(l.default, {
          ...
          availableQueueIds: s.Ember.computed(function () {
            return s.Parties.getAvailableQueueIds(
              a.TFT_GAME_SELECT_CATEGORY,
              a.TFT_GAME_SELECT_MODE_GROUP,
            );
          }),
      ...
      (e, t, n) => {
        ...
        var a = s.Ember.Controller.extend({
          ...
          setAnnouncementOKButtonDefault: s.Ember.computed.alias(
            "mapData.assets.set-announcement-ok-button-default",
          ),
          setAnnouncementOKButtonClicked: s.Ember.computed.alias(
            "mapData.assets.set-announcement-ok-button-clicked",
          ),
          setAnnouncementOKButtonHover: s.Ember.computed.alias(
            "mapData.assets.set-announcement-ok-button-hover",
          ),
      ...
      (e, t, n) => {
        ...
        var o = s.Ember.Controller.extend({
          ...
          backgrounds: s.Ember.computed(
            "eventHubAssets.background--battlepass-completion",
            function () {
              return {
                "background--battlepass-completion": this.get(
                  "eventHubAssets.background--battlepass-completion",
                ),
              };
            },
      ...
      (e, t, n) => {
        ...
        var r = s.Ember.Component.extend({
          ...
          didRender() {
            const e = document
              .querySelector(".item-purchase-container")
              ?.closest("lol-uikit-dialog-frame")?.shadowRoot;
            if (e) {
