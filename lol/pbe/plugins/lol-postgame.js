      ...
      (e, t, n) => {
        ...
        var a = n(1),
          s = a.Ember.Component.extend({
            ...
            characterPortraitBorder: a.Ember.computed.alias("barkData.Image"),
            characterDescriptionText:
              a.Ember.computed.alias("barkData.Sidebar"),
            characterIcon: a.Ember.computed.alias("barkData.Image"),
            missionLogText: a.Ember.computed.alias("barkData.Content"),
            actions: {
              closeModal() {
                this.sendAction("closeNarrativeLogsModal");
              },
            },
          });
        t.default = s;
