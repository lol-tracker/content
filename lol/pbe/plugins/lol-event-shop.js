(() => {
  var e = [
      ...
      (e, t, n) => {
        ...
        const { RemainingTimeTextComponent: K } = s.SharedComponents,
          Y = "rcp-fe-lol-event-shop";
        t.APP_NAME = Y;
      },
      (e, t, n) => {
        "use strict";
      ...
      (e, t, n) => {
        ...
        var l = s.Ember.Component.extend({
          ...
          willDestroyElement() {
            this._super(...arguments),
              this.eventShopDataBinding.removeObserver(
                "/token-shop-data",
                this,
              );
          },
