(() => {
  var e = [
          ...
          createChampionDetailsComponent({
            ...
            return (
              ...
              this.loginSessionBinding.get("/v1/session").then((s) => {
                const { summonerId: r, puuid: a } = s;
                this.championsBinding
                  .get(`/v1/inventories/${r}/champions/${e}`)
                  .then((s) => {
                    let r = !1;
                    s &&
                      s.ownership &&
              ...
              o(t, [
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    return (
                      (e.priority = (0, a.sanitizeInteger)(
                        e.priority,
                        Number.MAX_SAFE_INTEGER,
                      )),
                      (e.enabled = (0, a.sanitizeBoolean)(e.enabled, !0)),
            ...
            i(e, [
              {
                ...
                value: function (e) {
                  ...
                  (this._library = e),
                    ...
                    this._library.addEventListener(
                      a.EVENT_OUT_REGISTER_SUBSECTION,
                      function () {
                        var e = (
              ...
              o(t, [
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    e &&
                      ((this._currentSectionId = e),
                      this._library.dispatchEvent(a.EVENT_IN_SECTION_SHOW, e));
                  },
                },
                {
                  key: "_onSectionWillHide",
                  ...
                  value: function (e, t, n) {
                    for (
                      var o = this.sectionsRenders[t],
                        i = r.default.create(o, n),
                        s = r.default.getDOMNode(i);
                      e.firstChild;
      ...
      (e, t) => {
        ...
        var a = { TIME_UNITS: n, TIME_CONVERSIONS: r };
        t.default = a;
      },
      (e) => {
        "use strict";
      ...
      (e, t, n) => {
        ...
        n(94);
        var s,
          r = (s = n(95)) && s.__esModule ? s : { default: s };
        function a(e) {
        ...
        e.exports = o.Ember.Component.extend({
          ...
          replaceFormulas(e) {
            ...
            return (e = e.replace(
              ...
              (e, n, o, s = 1) => {
                ...
                s = parseFloat(s);
                const { link: a, coefficient: l } = t[n];
          ...
          replaceFormulaExpression(e, t, n, o, i) {
            ...
            const r = s[0] + "Amount",
              a = i[r];
            if (a) {
              const e = this.formatAbilityTokenValues(a.slice(1))
                .split("/")
                .map((e) => this.prettyFloat(parseFloat(e) * n))
                .join("/");
          ...
          replaceFormulaExpressions(e) {
            if (/@(f[0-9])@/.test(e)) {
              ...
              e = e.replace(
                ...
                (e, o, i, s = 1) => {
                  s = parseFloat(s);
                  const { link: r, coefficient: a } = t[o];
                  let l;
                  return (
                    (l = this.replaceFormulaExpression(r, a, s, e, n)),
        ...
        (e = n.nmd(e)),
          function () {
            ...
            var gn = (function e(t) {
              var n,
                o = (t =
                  null == t ? ht : gn.defaults(ht.Object(), t, gn.pick(ht, rt)))
                  .Array,
                xe = t.Date,
                we = t.Error,
                Te = t.Function,
              ...
              function to(e, t, n) {
                ((n !== i && !Ur(e[t], n)) || (n === i && !(t in e))) &&
                  ro(e, t, n);
              }
              function no(e, t, n) {
                var o = e[t];
                (je.call(e, t) && Ur(o, n) && (n !== i || t in e)) ||
                  ro(e, t, n);
              }
              function oo(e, t) {
                for (var n = e.length; n--; ) if (Ur(e[n][0], t)) return n;
                return -1;
              }
              function io(e, t, n, o) {
                return (
              ...
              function ao(e, t) {
                for (
                  var n = -1, s = t.length, r = o(s), a = null == e;
                  ++n < s;
              ...
              function mo(e, t, n, o) {
                ...
                n && (t = Rt(t, Zt(n))),
                  o
                    ? ((s = Dt), (r = !1))
                    : t.length >= 200 && ((s = en), (r = !1), (t = new Yn(t)));
                e: for (; ++i < a; ) {
                  var u = e[i],
                    p = null == n ? u : n(u);
              ...
              function ti(e, t, n, o) {
                if (!ea(e)) return e;
                for (
                  var s = -1, r = (t = Ei(t, e)).length, a = r - 1, l = e;
                  null != l && ++s < r;
              ...
              function mi(e, t) {
                return (
                  null == (e = Os(e, (t = Ei(t, e)))) || delete e[js(Qs(t))]
                );
              }
              function fi(e, t, n, o) {
              ...
              function gi(e, t, n) {
                ...
                for (var s = -1, r = o(i); ++s < i; )
                  for (var a = e[s], l = -1; ++l < i; )
                    l != s && (r[s] = mo(r[s] || a, e[l], t, n));
                return di(yo(r, 1), t, n);
              }
              function vi(e, t, n) {
                for (
                  var o = -1, s = e.length, r = t.length, a = {};
                  ++o < s;
              ...
              function Di(e) {
                return Zo(function (t, n) {
                  var o = -1,
                    ...
                    a = s > 2 ? n[2] : i;
                  for (
                    r = e.length > 3 && "function" == typeof r ? (s--, r) : i,
                      a && Es(n[0], n[1], a) && ((r = s < 3 ? i : r), (s = 1)),
                      t = Ie(t);
                    ++o < s;
              ...
              function Gi(e) {
                return function (t, n, s) {
                  return (
                    ...
                    (function (e, t, n, i) {
                      for (
                        var s = -1, r = yn(_t((t - e) / (n || 1)), 0), a = o(r);
                        r--;
                      ...
                      ? (function (e, t, n) {
                          ...
                          return function r() {
                            ...
                            return (a -= p.length) < n
                              ...
                              : Ct(
                                  this && this !== ht && this instanceof r
                                    ? s
                                    : e,
                                  this,
                                  l,
              ...
              function ts(e, t, n, o, s, r) {
                return (
                  ea(e) &&
                    ea(t) &&
                    (r.set(t, e), Ko(e, t, i, ts, r), r.delete(t)),
                  e
                );
              }
              function ns(e) {
              ...
              ((wn && _s(new wn(new ArrayBuffer(1))) != R) ||
                (Tn && _s(new Tn()) != w) ||
                (Cn && _s(Cn.resolve()) != I) ||
                (In && _s(new In()) != A) ||
                (On && _s(new On()) != P)) &&
              ...
              var Us = Zo(function (e, t) {
                ...
                Vs = Zo(function (e, t) {
                  ...
                  return (
                    Gr(n) && (n = i),
                    Gr(e) ? mo(e, yo(t, 1, Gr, !0), us(n, 2)) : []
                  );
                }),
                Hs = Zo(function (e, t) {
                  var n = Qs(t);
                  return (
                    Gr(n) && (n = i), Gr(e) ? mo(e, yo(t, 1, Gr, !0), i, n) : []
                  );
                });
              function Ws(e, t, n) {
              ...
              function Ks(e, t, n) {
                ...
                return (
                  n !== i &&
                    ((s = fa(n)), (s = n < 0 ? yn(o + s, 0) : bn(s, o - 1))),
                  Ht(e, us(t, 3), s, !0)
                );
              }
              function qs(e) {
              ...
              var rr = Zo(function (e, t) {
                ...
                cr = Zo(function (e) {
                  var t = Qs(e);
                  return (
                    (t = "function" == typeof t ? t : i), gi(Lt(e, Gr), i, t)
                  );
                }),
                ur = Zo(ir);
              var pr = Zo(function (e) {
                var t = e.length,
                  n = t > 1 ? e[t - 1] : i;
                return (
                  (n = "function" == typeof n ? (e.pop(), n) : i), sr(e, n)
                );
              });
              function dr(e) {
                var t = Vn(e);
              ...
              function Nr(e, t, n) {
                ...
                return (
                  ...
                  ea(n) &&
                    ((d = !!n.leading),
                    (a = (m = "maxWait" in n) ? yn(_a(n.maxWait) || 0, t) : a),
              ...
              function ia(e) {
                ...
                return (
                  "function" == typeof n && n instanceof n && Me.call(n) == Ve
                );
              }
              var sa = xt
                ? Zt(xt)
              ...
              var xa = Zo(function (e, t) {
                  ...
                  for (s && Es(t[0], t[1], s) && (o = 1); ++n < o; )
                    for (
                      var r = t[n], a = La(r), l = -1, c = a.length;
                      ++l < c;

                    ) {
                      var u = a[l],
                        p = e[u];
                      (p === i || (Ur(p, De[u]) && !je.call(e, u))) &&
                        (e[u] = r[u]);
                    }
                  return e;
                }),
              ...
              function al(e, t, n) {
                var o = Na(t),
                  i = xo(t, o);
                null != n ||
                  (ea(t) && (i.length || !o.length)) ||
                  ((n = t), (t = e), (e = this), (i = xo(t, Na(t))));
              ...
              return (
                ...
                (Vn.chunk = function (e, t, n) {
                  ...
                  if (!s || t < 1) return [];
                  for (var r = 0, a = 0, l = o(_t(s / t)); r < s; )
                    l[a++] = si(e, r, (r += t));
                  return l;
                }),
                ...
                (Vn.difference = Us),
                (Vn.differenceBy = Vs),
                (Vn.differenceWith = Hs),
                (Vn.drop = function (e, t, n) {
                  var o = null == e ? 0 : e.length;
                  return o
                    ? si(e, (t = n || t === i ? 1 : fa(t)) < 0 ? 0 : t, o)
                    : [];
                }),
                  ...
                  return s
                    ? (n &&
                      ...
                      (function (e, t, n, o) {
                        var s = e.length;
                        for (
                          (n = fa(n)) < 0 && (n = -n > s ? 0 : s + n),
                            (o = o === i || o > s ? s : fa(o)) < 0 && (o += s),
                            o = n > o ? 0 : ha(o);
                          n < o;
                ...
                (Vn.intersection = Gs),
                (Vn.intersectionBy = zs),
                (Vn.intersectionWith = Ys),
                (Vn.invert = Ia),
                (Vn.invertBy = Oa),
                (Vn.invokeMap = Er),
                (Vn.iteratee = il),
                ...
                (Vn.throttle = function (e, t, n) {
                  ...
                  return (
                    ...
                    Nr(e, t, { leading: o, maxWait: t, trailing: i })
                  );
                }),
                (Vn.thru = mr),
                (Vn.toArray = da),
                ...
                (Vn.isMatchWith = function (e, t, n) {
                  return (
                    (n = "function" == typeof n ? n : i), Ro(e, t, ds(t), n)
                  );
                }),
                (Vn.isNaN = function (e) {
                  return oa(e) && e != +e;
                ...
                (Vn.repeat = function (e, t, n) {
                  return (
                    (t = (n ? Es(e, t, n) : t === i) ? 1 : fa(t)), Xo(va(e), t)
                  );
                }),
                (Vn.replace = function () {
                  var e = arguments,
                  ...
                  if ((a && (l += c.length - l), sa(s))) {
                    if (e.slice(l).search(s)) {
                      var u,
                        p = c;
                      for (
                        s.global || (s = Oe(s.source, va(he.exec(s)) + "g")),
                          s.lastIndex = 0;
                        (u = s.exec(p));
                ...
                (Ln[Hi(i, 2).name] = [{ name: "wrapper", func: i }]),
      ...
      (e, t, n) => {
        ...
        e.exports = o.Ember.Component.extend(r, l, {
          ...
          isTieredSkinEventActive: o.Ember.computed(
            "activeSkinObject.id",
        ...
        e.exports = o.Ember.Service.extend(a, {
          ...
          openPawChampionModal(e) {
            o.PawPlugin.createPAWModal(
              { itemId: e, inventoryType: r.PAW.INVENTORY_TYPES.CHAMPION },
              i.CDP_PAW_ID,
              r.PAW.MODAL_TYPES.CHAMPION_MODAL,
              this.element,
            );
          },
          ...
          openPawSkinModal(e) {
            o.PawPlugin.createPAWModal(
              { itemId: e, inventoryType: r.PAW.INVENTORY_TYPES.CHAMPION_SKIN },
              i.CDP_PAW_ID,
              r.PAW.MODAL_TYPES.SKIN_VIEWER_MODAL,
              this.element,
            );
          },
          willDestroy() {
      ...
      (e, t, n) => {
        ...
        e.exports = o.Ember.Service.extend({
          ...
          willDestroy() {
            ...
            this.binding.removeObserver(`${r}/${a}/${e}`, this),
              this.binding.removeObserver(`${r}/${l}/${e}`, this),
              (this.binding = null);
          },
          ...
          observeEternalsData: function () {
            const e = this.get("championId");
            e &&
              this.binding.observe(`${r}/${a}/${e}`, this, (e) => {
          ...
          observeFeaturedStatstones: function () {
            const e = this.get("championId");
            e &&
              this.binding.observe(`${r}/${l}/${e}`, this, (e) => {
                this.set("featuredStatstones", e);
              });
          },
          setFeaturedStatstone(e, t, n) {
            ...
            return (
              ...
              this.binding.post(
                `${r}/${l}/${t.boundChampionItemId}/${t.statstoneId}`,
                i,
              )
            );
          },
        ...
        e.exports = o.Ember.Service.extend({
          init: function () {
            this._super(...arguments),
              ...
              this.eventHubDataBinding.observe(i, this, (e) => {
                this.set("skinsFromActiveEvents", e);
              });
          },
          willDestroy() {
            this._super(...arguments),
              this.eventHubDataBinding.unobserve(i, this);
          },
        });
      },
      (e, t, n) => {
