    ...
    var e = [, e => {
            ...
            var y = new class {
                ...
                _handleVideoCache(e, t) {
                    "Lobby" === e && "Lobby" !== t && this.largeAreaAnimationsEnabled && (this.champSelectVideoCache.release(), b.forEach(function(e) {
                ...
                champSelectShowHandler() {
                    return this.showPromise = this.showPromise.then(function() {
                        ...
                        this._isClashGame ? this.appControls.addMessage(this._clashDodgeMessage) : this._isCustomGame || this.appControls.addMessage(this._dodgeMessage), this.screenRoot.bump(), this._isShown = !0, _.endTracingEvent("champ-select-init"), Promise.all([this.gameflowBinding.get("/v1/session"), this.champSelectBinding.get("/v1/session"), h("/lol-summoner/v1/current-summoner").get(), h("/lol-inventory/v2/inventory/WARD_SKIN").get(), h("/lol-inventory/v2/inventory/CHAMPION").get()]).then((([e, t, n, s, o]) => {
                            ...
                            "GAME_STARTING" === r ? (_.recordTracingStepEvent("UI_entered-champ-select-in-phase-game-starting"), _.invokeWithLowProbability((function() {
                                i.captureEvent({
                                    message: "entered-champ-select-in-phase-game-starting"
                                }), _.sendEvent("entered-champ-select-in-phase-game-starting", k), _.recordNonTimingTracingEvent("entered-champ-select-in-phase-game-starting", 1, "event")
                            }))) : "" === r ? (_.recordTracingStepEvent("UI_entered-champ-select-in-phase-empty-string"), _.invokeWithLowProbability((function() {
                                i.captureEvent({
                                    message: "entered-champ-select-in-phase-empty-string"
                                }), _.sendEvent("entered-champ-select-in-phase-empty-string", k), _.recordNonTimingTracingEvent("entered-champ-select-in-phase-empty-string", 1, "event")
                            }))) : h ? (_.recordTracingStepEvent("UI_entered-ranked-champ-select-after-initial-phase"), _.invokeWithLowProbability((function() {
                                i.captureEvent({
                                    message: "entered-ranked-champ-select-after-initial-phase"
                                }), _.sendEvent("entered-ranked-champ-select-after-initial-phase", k), _.recordNonTimingTracingEvent("entered-ranked-champ-select-after-initial-phase", 1, "event")
                            }))) : f && (_.recordTracingStepEvent("UI_entered-champ-select-late"), _.invokeWithLowProbability((function() {
                                i.captureEvent({
                                    message: "entered-champ-select-late"
                                }), _.sendEvent("entered-champ-select-late", k), _.recordNonTimingTracingEvent("entered-champ-select-late", 1, "event")
                            })))
                        }))
                    }.bind(this)), !0
                }
            ...
            function b(e, t, n) {
                ...
                function r(e, t) {
                    try {
                        (n = s[e](t)).value instanceof _ ? Promise.resolve(n.value.v).then(l, c) : m(o[0][2], n)
                    } catch (e) {
                        m(o[0][3], e)
                    }
                    var n
            ...
            function h() {
                var e = p();
                return f(e) && !S(e).isOlderThan(m) || _(e, new u), (0, r.isNodeEnv)() ? function(e) {
                    try {
                        var t = g();
                        if (!t) return S(e);
            ...
            function k(e, t, n) {
                return void 0 === n && (n = !1),
                    function(i) {
                        b = void 0, i && y !== i && (y = i, x && clearTimeout(x), n ? x = setTimeout((function() {
                            t({
                                event: i,
                                name: e
                            })
            ...
            function E(e) {
                return function(t) {
                    ...
                    var i = n && n.tagName;
                    i && ("INPUT" === i || "TEXTAREA" === i || n.isContentEditable) && (b || k("input", e)(t), clearTimeout(b), b = setTimeout((function() {
                        b = void 0
                    }), v))
                }
            }
            ...
            const g = n(89),
                ...
                b = ["name_visibility_type_team_hidden_gromp", "name_visibility_type_team_hidden_krug", "name_visibility_type_team_hidden_murk_wolf", "name_visibility_type_team_hidden_raptor", "name_visibility_type_team_hidden_scuttle_crab"];
            var y = i.Ember.Component.extend(m, u, s.default, a.default, {
                ...
                _initSummonerObservers: function() {
                    this.summonerBySlotId = {}, _.forEach((e => {
                ...
                myTeamSummoners: i.Ember.computed("gameModeSubteamData", (function() {
                    const e = _.filter((e => this._isSummonerSlotIdInMyTeam(e))).map((e => this.summonerBySlotId[e]));
                    return i.Ember.A(e)
                })),
            ...
            e.exports = i.HTMLBars.template({
                id: "FSBnUwZq",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15692\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\templates\\\\application.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["append",["helper",["champ-select-root"],null,[["model"],[["get",["model"]]]]],false],["text","\\n\\n"],["append",["unknown",["outlet"]],false],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const i = n(1).Ember;
            e.exports = i.HTMLBars.template({
                id: "xoKb0f4f",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15692\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\templates\\\\index.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }],
        t = {};
