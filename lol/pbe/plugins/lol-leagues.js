(() => {
    var e = [, e => {
            ...
            e.exports = a.Ember.Component.extend(u, {
                ...
                seasonNameText: a.Ember.computed("isViewingCherry", "isViewingTft", "tftSets", "currentYear", "currentSeason.metadata.currentSplit", (function() {
            ...
            e.exports = a.Ember.Component.extend({
                ...
                isNonTopTierStandingRow: a.Ember.computed("data.summonerName", "isTopSummoner", "isViewingApexTier", (function() {
                ...
                _displayEosNotification(e) {
                    ...
                    const _ = e.seasonEndTime - 36e5,
                        E = {
                            ...
                            iconUrl: "/fe/lol-static-assets/images/ranked-emblem.png",
                            data: {
                                date: (0, s.convertDateMillisToString)(_, l, {
                                    month: "long",
                                    day: "numeric"
                                }),
                    ...
                    n.push(t), (0, a.dataBinding)("player-notifications").post("/v1/notifications", E), (0, a.dataBinding)("lol-ranked").post(`/v1/eos-notifications/${t}/acknowledge`, {})
                },
