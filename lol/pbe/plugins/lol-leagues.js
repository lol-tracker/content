(() => {
  var e = [
      ...
      (e) => {
        ...
        function n(e, t, n) {
          const { regions: a, region: s, locale: i } = e.metadata();
        ...
        e.exports = function (e, a, s) {
          ...
          return (
            ...
            i.set("service", i),
            i.addObserver("metadata.region", n.bind(null, a, "region")),
            i.addObserver("metadata.locale", n.bind(null, a, "locale")),
            s &&
              (console.warning(
          ...
          (t.default = function (e, t, a) {
            ...
            t.setFactoryDefinition({
              ...
              t.setFactoryDefinition({
                ...
                CareerStatsService:
                  s.default.CareerStatsAPI.getCareerStatsService(),
              });
          });
        var a,
      ...
      (e, t, n) => {
        ...
        e.exports = a.Ember.Component.extend(u, {
          ...
          honorLevel: 0,
          rankedService: (0, a.dataBinding)(
            "/lol-ranked",
            (0, a.getProvider)().getSocket(),
          ),
          chatService: (0, a.dataBinding)(
            "/lol-chat",
            (0, a.getProvider)().getSocket(),
          ),
          ...
          init: function () {
            ...
            this.set(
              "leagues",
              a.Ember.Object.create({ apexQueueInfoByQueueAndTier: {} }),
            ),
              this.set("ratedLadderByQueueType", a.Ember.Object.create({})),
              this.set("selectedState", a.Ember.Object.create()),
          ...
          summonerReadyChanged: a.Ember.observer("summonerReady", function () {
            ...
            this.set("viewerId", o.summonerId),
              ...
              t && o.summonerId !== t
                ? s.observe(i, this, this._handleSummonerLeaguesData)
          ...
          _cacheApexQueueInfo: function (e, t, n) {
            if (this.get(`leagues.apexQueueInfoByQueueAndTier.${t}`))
              ...
              const a = {};
              (a[n] = e),
                this.set(`leagues.apexQueueInfoByQueueAndTier.${t}`, a);
            }
          },
          ...
          _handleFriendsData: function (e) {
            e &&
              this.set(
                "friendsIdSet",
                new Set(a.Lodash.map(e, (e) => e.summonerId)),
              );
          },
          defaultLeagueObserver: a.Ember.observer(
            "isLoading",
          ...
          _applyRelationship: function (e) {
            ...
            let s = null;
            a && a.has(t) && (s = i.StandingRelationship.FRIEND),
              e.set("relationship", n === t ? i.StandingRelationship.SELF : s);
          },
          _fillInDivisions: function (e, t) {
            ...
            return (
              t
                ? ((s = a.LeaguesConsts.APEX_TIERS.slice()), (i = "tier"))
                : ((s = a.LeaguesConsts.DIVISIONS.slice()), (i = "division")),
              s.forEach((s) => {
                let o,
                  l,
                  r = a.Lodash.filter(e.divisions, (e) => e && e[i] === s)[0];
                t ? ((l = s), (o = "I")) : ((l = e.tier), (o = s)),
          ...
          arrayToEmberObjects: (e) =>
            a.Lodash.map(e, (e) => a.Ember.Object.create(e)),
          ...
          showingPlayerNotRanked: a.Ember.computed(
          ...
          showingRewards: a.Ember.computed(
          ...
          isShowingSplitEndCountdown: a.Ember.computed(
            "showingRewards",
            "isViewingTft",
            function () {
          ...
          splitTimeRemainingText: a.Ember.computed(
          ...
          isViewingCherry: a.Ember.computed(
            "selectedState.league",
            function () {
              return "CHERRY" === this.get("selectedState.league.queueType");
            },
          ),
          nextUpdateMillis: a.Ember.computed(
          ...
          currentSeasonYear: a.Ember.computed(
          ...
          seasonNameText: a.Ember.computed(
            "isViewingCherry",
            "isViewingTft",
            "tftSets",
            "currentSeasonYear",
          ...
          viewedSummonerId: a.Ember.computed(
            "summonerId",
          ...
          isViewingLocalSummoner: a.Ember.computed(
            "currentSummoner.summonerId",
            "summonerId",
            function () {
              return (
      ...
      (e, t, n) => {
        ...
        n(28),
          (e.exports = a.Ember.Component.extend({
            ...
            layout: n(29),
            leagueTierNames: a.LeagueTierNames,
            isValidDaysUntilDecay: a.Ember.computed(
              "daysUntilDecay",
              function () {
            ...
            daysUntilDecay: a.Ember.computed(
              "league",
              "myRankedStats",
              "isViewingApexTier",
              function () {
            ...
            shouldDisplayDecayWarningInDays: a.Ember.computed(
            ...
            decayWarningText: a.Ember.computed(
              "daysUntilDecay",
              "isViewingApexTier",
              function () {
                const e = this.get("daysUntilDecay");
            ...
            decayWarningDaysRemaining: a.Ember.computed(
              "daysUntilDecay",
              function () {
                const e = this.get("daysUntilDecay");
                return e > 0
            ...
            shouldDisplayDecayWarningInCountdownTimer: a.Ember.computed(
              "isValidDaysUntilDecay",
              "daysUntilDecay",
              "isViewingApexTier",
              function () {
            ...
            countdownLabel: a.Ember.computed(
              "shouldDisplayDecayWarningInCountdownTimer",
              "decayWarningText",
              function () {
            ...
            isDecayUrgent: a.Ember.computed(
              "isValidDaysUntilDecay",
              "daysUntilDecay",
              function () {
                const e = this.get("isValidDaysUntilDecay"),
            ...
            shouldCountdownTimerBeUrgent: a.Ember.computed(
              "isDecayUrgent",
              "shouldDisplayDecayWarningInCountdownTimer",
              function () {
            ...
            shouldDisplayCountdownTimer: a.Ember.computed(
              "isViewingApexTier",
          ...
          (e.exports = a.Ember.Component.extend({
            ...
            setRankedData(e, t, n) {
              e &&
                ...
                n.queueMap[t] &&
                n.queueMap[t].tier &&
                n.queueMap[t].tier !== a.LeaguesConsts.TIER_NAME_NONE
            ...
            unranked: a.Ember.computed("tier", "displayedTier", function () {
              ...
              return (
                !e ||
                e === a.LeaguesConsts.TIER_NAME_UNRANKED ||
                e === a.LeaguesConsts.TIER_NAME_NONE ||
                !t ||
                t === a.LeaguesConsts.TIER_NAME_UNRANKED ||
                t === a.LeaguesConsts.TIER_NAME_NONE
              );
            }),
            hasApexLadderRank: a.Ember.computed(
              "tier",
              "ladderRank",
              function () {
                return (
                  a.LeaguesConsts.APEX_TIERS.includes(this.get("tier")) &&
                  this.get("ladderRank")
                );
              },
            ),
            ...
            provisionalGamesProgressText: a.Ember.computed(
            ...
            apexLadderRank: a.Ember.computed(
              "tra",
              "hasApexLadderRank",
              "ladderRank",
              function () {
            ...
            showLeaguePoints: a.Ember.computed(
              "unranked",
              "leaguePoints",
              function () {
                return (
            ...
            leaguePointsString: a.Ember.computed(
              "leaguePoints",
              "tier",
              function () {
                const e = a.LeaguesConsts.APEX_TIERS.includes(this.get("tier"))
                  ? this.get("leaguePoints")
                  : Math.min(100, this.get("leaguePoints"));
                return this.leagueTierNames.getLpLoc(e);
              },
            ),
            tierDivisionLabel: a.Ember.computed(
              "tier",
              "division",
              function () {
                const e = this.get("tier"),
      ...
      (e, t, n) => {
        ...
        e.exports = a.Ember.Component.extend({
          ...
          rankedIntroSections: a.Ember.computed(
            "queueType",
      ...
      (e, t, n) => {
        ...
        n(40),
          (e.exports = a.Ember.Component.extend({
            ...
            activeTabIndex: a.Ember.computed(
            ...
            leagueStandings: a.Ember.computed.readOnly(
              "selectedState.division.standings",
            ),
            isViewingRatedLadder: a.Ember.computed.readOnly(
              "selectedState.isViewingRatedLadder",
            ),
            ratedLadderStandings: a.Ember.computed.readOnly(
              "selectedState.league.standings",
            ),
            displayedStandings: a.Ember.computed(
              "leagueStandings",
              "isViewingRatedLadder",
              ...
              if (t !== e) {
                ...
                this.set(
                  ...
                  n.on("animationend", () => {
                    ...
                    this.sendAction("selectDivision", a),
                      n.off("animationend"),
                      this.set(
                        "animationClass",
                        t > e
      ...
      (e, t, n) => {
        ...
        n(43),
          (e.exports = a.Ember.Component.extend({
            ...
            layout: n(44),
            containsPlayer: a.Ember.computed(
              "leagueDivisionInfo.standings",
              function () {
                return !a.Lodash.isEmpty(
                  a.Lodash.find(this.get("leagueDivisionInfo.standings"), {
            ...
            text: a.Ember.computed(
              ...
              function () {
                return a.LeaguesConsts.APEX_TIERS.includes(
                  ...
                  ? a.LeagueTierNames.getTierName(
                      this.get("leagueDivisionInfo.tier"),
                    )
                  : a.LeagueTierNames.getDivisionName(
            ...
            playerDivisionStyle: a.Ember.computed(
              "containsPlayer",
              function () {
                return this.get("containsPlayer") ? "player-division" : null;
              },
            ),
            selectedStateDidChange: a.Ember.on(
              "init",
              a.Ember.observer("selectedDivision", function () {
      ...
      (e, t, n) => {
        ...
        if (a.AudioPlugin) {
          ...
          i = e.createSound(
            `${s.ASSET_PATH}sounds/sfx-uikit-button-text-click.ogg`,
          );
        }
        e.exports = a.Ember.Component.extend({
          classNames: [
          ...
          divisionExistenceObserver: a.Ember.observer(
            "hasDivision",
            function () {
          ...
          localizedTier: a.Ember.computed(
            "selectedState.league.tier",
            function () {
              return a.LeagueTierNames.getTierName(
                this.get("selectedState.league.tier"),
              );
            },
          ),
      ...
      (e, t, n) => {
        ...
        e.exports = a.Ember.Component.extend({
          ...
          isApexTierNotMaxSize: a.Ember.computed(
          ...
          isEmptyDivisionOrNotFullApexTier: a.Ember.computed.or(
            "divisionIsEmpty",
            "isApexTierNotMaxSize",
          ),
          hasApexUnlockTimeInTheFuture: a.Ember.computed(
          ...
          divisionOrTierEmptyText: a.Ember.computed(
            "divisionIsEmpty",
            "selectedState.isViewingApexTier",
            "selectedState.division.tier",
            "selectedState.division.apexUnlockTimeMillis",
            ...
            function () {
              ...
              if (e)
                (t = this.addPromotionDemotionCutoffs(t)),
                  t.splice(0, 0, a.Ember.Object.create({ isHeader: !0 }));
              else {
                const e = a.Lodash.findIndex(
                  t,
                  (e) => !a.Lodash.get(e, "miniseriesResults.length") > 0,
                );
                e < 0
                  ? t.splice(0, 0, a.Ember.Object.create({ isHeader: !0 }))
                  : 0 === e
                    ? t.splice(
                        0,
                        0,
                        a.Ember.Object.create({ isSecondHeader: !0 }),
                      )
                    : (t.splice(0, 0, a.Ember.Object.create({ isHeader: !0 })),
                      t.splice(
                        e + 1,
          ...
          addPromotionDemotionCutoffs(e) {
            ...
            const { hasDemotionCutoff: s, demotionCutoffIndex: i } =
          ...
          findPromotionCutoffIndex(e) {
            let t = !1,
              n = 0;
            for (let a = 0; a < e.length && e[a].pendingPromotion; a++)
              (t = !0), (n = a);
          ...
          findDemotionCutoffIndex(e) {
            let t = !1,
              n = e.length;
            for (let a = e.length - 1; a >= 0 && e[a].pendingDemotion; a--)
              (t = !0), (n = a);
          ...
          headerData: a.Ember.computed("rows", function () {
            return a.Lodash.find(this.get("rows"), { isHeader: !0 });
          }),
          secondaryHeaderData: a.Ember.computed("rows", function () {
            return a.Lodash.find(this.get("rows"), { isSecondHeader: !0 });
          }),
      ...
      (e, t, n) => {
        ...
        if (a.AudioPlugin) {
          const e = a.AudioPlugin.getChannel("sfx-ui");
          l = e.createSound(
            `${s.ASSET_PATH}sounds/sfx-uikit-click-generic.ogg`,
          );
        }
        e.exports = a.Ember.Component.extend({
          tagName: "li",
          ...
          isSecondaryHeader: a.Ember.computed(
            "data.isSecondHeader",
            function () {
              return Boolean(this.get("data.isSecondHeader"));
            },
          ),
          secondaryHeaderStyle: a.Ember.computed(
            "isSecondaryHeader",
            function () {
          ...
          isTopSummoner: a.Ember.computed(
          ...
          isViewingApexTier: a.Ember.computed(
            "leagueDivisionInfo.tier",
            function () {
              return a.LeaguesConsts.APEX_TIERS.includes(
                this.get("leagueDivisionInfo.tier"),
          ...
          isTopTierStandingRow: a.Ember.computed(
            "isViewingApexTier",
            "isHeader",
            "isSecondaryHeader",
          ...
          isNonTopTierStandingRow: a.Ember.computed(
            "data.puuid",
            "isTopSummoner",
            "isViewingApexTier",
            function () {
          ...
          divisionChangeStyle: a.Ember.computed(
          ...
          positionDeltaStyle: a.Ember.computed(
            "data.positionDelta",
            function () {
          ...
          isAvailableForSpectate: a.Ember.computed(
            "data.summonerName",
            "spectatableSummonerNames",
            "spectatableSummonerIds",
            "spectateBySummonerIdEnabled",
          ...
          isFriend: a.Ember.computed("data.relationship", function () {
            return (
              this.get("data.relationship") === s.StandingRelationship.FRIEND
            );
          }),
          isSelf: a.Ember.computed("data.relationship", function () {
            return (
              this.get("data.relationship") === s.StandingRelationship.SELF
            );
          }),
          isSelectedSummoner: a.Ember.computed(
            "data.summonerId",
            "summonerId",
            function () {
          ...
          selfStyle: a.Ember.computed("data.relationship", function () {
            if (this.get("data.relationship") === s.StandingRelationship.SELF)
              return "me";
          }),
          miniseriesStyles: a.Ember.computed(
            "data.miniseriesResults",
            function () {
              return a.Lodash.map(
                ...
                t.setMenuItems([
                  ...
                  },
                  {
                    ...
                    action: async function () {
                      ...
                      (await a.ProfilesAPI.hasPrivateProfile(e))
                        ? a.ProfilesAPI.showAlertSummonerIsPrivate(t)
                        : this.get("spectatorService")
                            .spectateGame(
              ...
              c(
                typeof (i =
                  null != (i = n.title || (null != t ? t.title : t))
                    ? i
                    : l) === r
                  ? i.call(o, { name: "title", hash: {}, data: s })
                  : i,
              ) +
              ...
              c(
                typeof (i =
                  null != (i = n.message || (null != t ? t.message : t))
                    ? i
                    : l) === r
                  ? i.call(o, { name: "message", hash: {}, data: s })
                  : i,
              ) +
              "</p>\r\n</div>\r\n\r\n"
            );
        ...
        (t.default = function (e) {
          e.registerHelper("with", function (e, t) {
            ...
            return (
              t.data &&
                t.ids &&
                ((s = a.createFrame(t.data)).contextPath = a.appendContextPath(
                  t.data.contextPath,
                  t.ids[0],
                )),
              n(e, {
          ...
          (t.template = function (e, t) {
            ...
            var n = {
              ...
              invokePartial: function (n, a, i) {
                i.hash &&
                  ((a = s.extend({}, a, i.hash)), i.ids && (i.ids[0] = !0)),
                  (n = t.VM.resolvePartial.call(this, n, a, i));
                var l = t.VM.invokePartial.call(this, n, a, i);
                if (
                  (null == l &&
                    t.compile &&
                    ((i.partials[i.name] = t.compile(n, e.compilerOptions, t)),
                    (l = i.partials[i.name](a, i))),
                  null != l)
                ) {
                  if (i.indent) {
                    for (
                ...
                e.useDepths &&
                  (o = s.depths
                    ? t != s.depths[0]
                      ...
                      : s.depths
                    : [t]),
                (c = u(e.main, c, n, s.depths || [], i, r))(t, s)
              );
            }
            return (
              (a.isTop = !0),
      ...
      (e, t, n) => {
        ...
        n(76),
          (e.exports = a.Ember.Component.extend({
            ...
            challengerQueues: a.Ember.computed(
              "challengerLaddersEnabled",
              function () {
                const e = this,
            ...
            summonerLeagues: a.Ember.computed(
            ...
            topRatedLadderQueues: a.Ember.computed(
              "topRatedLaddersEnabled",
              function () {
                const e = this,
        ...
        e.exports = a.Ember.Component.extend({
          ...
          didUpdateAttrs: function () {
            ...
            e !== this.prevVictoriousSkinId &&
              a.LeagueTierNames.asyncGetRewardImage(e, "splashPath").then(
                (e) => {
          ...
          victoriousSkinBackgroundStyle: a.Ember.computed(
          ...
          positionElements: function () {
            ...
            for (let e = 0; e < a.length; e++) {
              ...
              0 === e || e === a.length - 1 ? (i += n / 2) : (i += n),
                (s[t.splitPoints] = { size: n });
            }
            const o = a.length - 1,
          ...
          flattenedSplitRewards: a.Ember.computed(
          ...
          lastEarnedReward: a.Ember.computed(
            "currentSplit.rewardTrack.[]",
            "playerPoints",
            function () {
          ...
          getVictoriousPointsNeededForTier: (e, t) =>
            ...
            1600,
          isVictoriousSkinUnlocked: a.Ember.computed(
            "victoriousPointsPercentageEarned",
            function () {
              return 100 === this.get("victoriousPointsPercentageEarned");
            },
          ),
          victoriousPointsPercentageEarned: a.Ember.computed(
            "currentSplit",
            "myRankedStats",
            "playerPoints",
            function () {
              ...
              if (!e || !t || !n) return 0;
              const a = this.getVictoriousPointsNeededForTier(
                e,
          ...
          victoriousPointsSilverBelow: a.Ember.computed(
            ...
            function () {
              ...
              return e && a.LeagueTierNames.getConstants().TIERS.indexOf(e) <= 2
          ...
          victoriousPointsNeededSilverBelow: a.Ember.computed(
            "currentSplit",
            function () {
              return this.getVictoriousPointsNeededForTier(
                this.get("currentSplit"),
                a.LeagueTierNames.getConstants().TIERS[2],
              );
            },
          ),
          victoriousPointsNeededGoldAbove: a.Ember.computed(
            "currentSplit",
            function () {
              return this.getVictoriousPointsNeededForTier(
                this.get("currentSplit"),
                a.LeagueTierNames.getConstants().TIERS[3],
              );
            },
          ),
          showHonorWarning: a.Ember.computed(
            "honorLevel",
      ...
      (e, t, n) => {
        ...
        e.exports = a.Ember.Component.extend({
          ...
          pointsRequiredTooltipMessage: a.Ember.computed(
            "tra",
            "unlocked",
          ...
          unlockedString: a.Ember.computed(
          ...
          nextRewardPointsRequired: a.Ember.computed(
            "nextReward.splitPoints",
            function () {
              return this.get("nextReward.splitPoints") || 0;
            },
          ),
          pointsNeededText: a.Ember.computed(
            "isNextReward",
            "reward.splitPoints",
            "playerPoints",
            function () {
          ...
          shouldShowPointProgress: a.Ember.computed.or(
            "isNextReward",
            "isHovered",
          ),
          ...
          (e.exports = a.Ember.Component.extend({
            ...
            ratedTier: a.Ember.computed("queue", "isTft", function () {
              ...
              return t && t.ratedTier
                ? t.ratedTier
                : e
                  ? a.LeagueTierNames.getConstants().LOWEST_TFT_RATED_TIER
                  : a.LeagueTierNames.getConstants().LOWEST_CHERRY_RATED_TIER;
            }),
            isUnrated: a.Ember.computed("ratedTier", function () {
              return a.LeagueTierNames.isUnrated(this.get("ratedTier"));
            }),
            ratedTierImagePath: a.Ember.computed(
              "ratedTier",
              "queueType",
              function () {
            ...
            displayedRatedRating: a.Ember.computed(
              "queue",
              "ratedTier",
              "isUnrated",
              function () {
                ...
                this.set(
                  ...
                  setInterval(
                    ...
                    () => {
                      ...
                      e >= s.PROMOTE_COUNTDOWN_INTERVAL_MS
                        ? ((e -= s.PROMOTE_COUNTDOWN_INTERVAL_MS),
      ...
      (e, t, n) => {
        ...
        e.exports = a.Ember.Service.extend(s, {
          spectateEnabled: a.Ember.computed(
      ...
      (e, t, n) => {
        ...
        var a,
          s = n(1),
          i = n(23),
          o = (a = n(92)) && a.__esModule ? a : { default: a };
        n(93);
        ...
        e.exports = s.Ember.Component.extend(l, o.default, {
          ...
          shouldAnimate: s.Ember.computed(
            "isLowSpec",
            "isShowing",
            "animationStarted",
            function () {
          ...
          introVideoPath: s.Ember.computed(
            "previousTier",
          ...
          introAudioPath: s.Ember.computed(
            "previousTier",
            "isCompletedProvisionals",
            function () {
              if (this.get("isCompletedProvisionals"))
          ...
          isTierPromotion: s.Ember.computed(
            "isCompletedProvisionals",
            "isApex",
            "division",
            function () {
          ...
          isCompletedProvisionals: s.Ember.computed(
            ...
            function () {
              return this.get("isCompletedProvisionals")
                ? this.get("tra").formatString(
                    ...
                    {
                      tierDivisionLpLoc: s.LeagueTierNames.getTierDivisionLpLoc(
                        this.get("tierUpperCase"),
                        this.get("division"),
                        this.get("leaguePoints"),
                      ),
          ...
          subheaderText: s.Ember.computed(
            "isCompletedProvisionals",
            "queueType",
            function () {
              const e = this.get("queueType"),
      ...
      (e, t, n) => {
        ...
        n(96),
          (e.exports = a.Ember.Component.extend({
            ...
            showChromaBackground: a.Ember.computed(
              "notification.rewardEarnedType",
              function () {
                return (
                  this.get("notification.rewardEarnedType") ===
                  a.LeagueTierNames.getConstants().REWARD_TYPES
                    .CHAMPION_SKIN_CHROMA
                );
              },
            ),
            showGoldBackgroundGlow: a.Ember.computed(
              "notification.rewardEarnedType",
              function () {
      ...
      (e, t, n) => {
        ...
        var a,
          s = n(1),
          i = (a = n(92)) && a.__esModule ? a : { default: a };
        n(102);
        const o = {
            GRAY: void 0,
            GREEN: n(103),
        ...
        e.exports = s.Ember.Component.extend(i.default, {
          ...
          cherryRatingVideoSrc: s.Ember.computed(
            "ratedTier",
            "notification.queueType",
            function () {
      ...
      (e, t, n) => {
        ...
        e.exports = a.Ember.Component.extend(s, {
          ...
          layout: n(114),
          isDependenciesInitialized: a.Ember.computed(
            "session",
            "session.state",
            "accountLeaguesSettings",
            "settingsReady",
      ...
      (e, t, n) => {
        ...
        var a,
          s = n(1),
          i = (a = n(116)) && a.__esModule ? a : { default: a },
          o = n(23);
        n(117);
        const l = (0, s.emberDataBinding)({
            Ember: s.Ember,
        ...
        e.exports = s.Ember.Component.extend(l, {
          currentSeason: null,
          platformConfigObserver: s.Ember.observer(
            "currentSeason",
            "accountLeaguesSettings",
            "seasonModalEnabled",
            function () {
          ...
          _showSeasonStartToast(e) {
            const t = {
              ...
              data: { seasonYear: (o.SEASON_YEAR_BASE + e).toString() },
            };
      ...
      (e, t, n) => {
        ...
        var s = {
          saveLocalSetting: (e, t) => {
            const n = { [e]: t };
            return (0, a.dataBinding)("/lol-settings").patch(
      ...
      (e, t, n) => {
        ...
        var a,
          ...
          i = n(23),
          o = n(50),
          l = (a = n(116)) && a.__esModule ? a : { default: a };
        n(119);
        const r = n(120),
        ...
        e.exports = s.Ember.Component.extend(c, {
          ...
          platformConfigObserver: s.Ember.observer(
            ...
            function () {
              ...
              const l = parseFloat(t + "." + i.splitId),
                r = (0, o.getDaysBetweenDateMillis)(
                  Date.now(),
                  i.endTimeMillis,
                );
              this._shouldDisplaySplitEndNotification(l, r, e, a) &&
                this._displaySplitEndNotification(l, i, n);
            },
          ),
          ...
          _renderSplitEndNotification: function (e) {
            const t = document.createElement("div"),
              ...
              s = r({
                ...
                detail: this.get("tra").formatString(m, { endDate: a }),
              });
            return (
              (t.innerHTML = s), t.classList.add("split-end-notification"), t
            );
          },
          _initPlayerNotifications() {
            s.Social.playerNotifications().registerToastRenderer(
              ...
              s.Social.playerNotifications().on(
                u,
                d,
                "click",
          ...
          _navigateToProfileSubsection: function (e) {
            return (
              s.ProfilesAPI.setActive(!0),
              s.ProfilesAPI.mainSection().show(e),
              !0
            );
          },
        });
              ...
              c(
                typeof (i =
                  null != (i = n.detail || (null != t ? t.detail : t))
                    ? i
                    : l) === r
                  ? i.call(o, { name: "detail", hash: {}, data: s })
                  : i,
              ) +
              "</div>"
            );
      ...
      (e, t, n) => {
        ...
        var a,
          ...
          o = n(23),
          l = n(50),
          r = (a = n(116)) && a.__esModule ? a : { default: a },
          c = n(24);
        n(122);
        const u = n(123),
        ...
        e.exports = s.Ember.Component.extend(d, {
          ...
          platformConfigObserver: s.Ember.observer(
            ...
            function () {
              ...
              const u = parseFloat(t + "." + c.splitId),
                d = (0, l.getDaysBetweenDateMillis)(
                  Date.now(),
                  c.endTimeMillis,
                ),
                p = this._getHighestRankedNonTFTEntryQueue(n);
              this._shouldTryToDisplaySplitStartModal(u, d, e, p, s, i, r, o) &&
                (this.set("hasSplitStartModalShownThisSession", !0),
                i.loadCurrentSeasonStatsGames(s.puuid).then((e) => {
              ...
              s.Lodash.forEach(n, (e) => {
                s.Lodash.forEach(e.rewards, (e) => {
                  ...
                  if (!a[e.id]) {
                    ...
                    n === i.SUMMONER_ICON
                      ? (t.unshift(c),
                        o.unshift(s.LeagueTierNames.asyncGetRewardImage(e.id)))
                      : (t.push(c),
                        o.push(s.LeagueTierNames.asyncGetRewardImage(e.id))),
                      (a[e.id] = !0);
                  }
                });
              }),
          ...
          _getBestChampionStatsPanelData(e, t, n, a, s, i, o) {
            ...
            let l = this._getBestChampionInfoForRanked(e, t, n),
              r = m;
            return (
              l || ((l = this._getBestChampionInfoForNormals(e)), (r = g)),
              l
                ? this._getStatsPanelDataForChampion(l, a, s, r)
          ...
          _getBestChampionInfoForNormals(e) {
            ...
            return (
              s.Lodash.forEach(
                ...
                (n) => {
                  const a = this._getBestChampionInfoForQueue(
                    e,
                    n,
          ...
          _getBestChampionInfoForFilteredQueueGames(e, t, n) {
            ...
            s.Lodash.forEach(e, (e) => {
              ...
              a[e.championId] && a[e.championId][t]
                ? a[e.championId][t].push(e)
                : a[e.championId] && !a[e.championId][t]
                  ? (a[e.championId][t] = [e])
                  : (a[e.championId] = { [t]: [e] });
            });
            ...
            for (const [e, o] of s.Lodash.entries(a))
              for (const [a, l] of s.Lodash.entries(o)) {
                ...
                s >= this.careerStatsAPI.getMinGamesToUnlockStats() &&
                  (!i || i.winrate <= o) &&
                  (i = {
          ...
          _isRankedQueueValid: function (e) {
            return (
              ...
              Boolean(e.queueType) &&
              Boolean(e.tier) &&
              e.tier !== s.LeaguesConsts.TIER_NAME_NONE
            );
          },
          _getCurrentSplitData: function (e) {
            if (!e || !e.currentSplitId) return null;
        ...
        e.exports = (a.default || a).template({
          ...
          main: function (e, t, n, a, s, i) {
            ...
            return (
              ...
              (null !=
              (o = n.each.call(l, null != t ? t.rewardsInfo : t, {
                name: "each",
                hash: {},
              ...
              (null !=
              (o = n.if.call(l, null != t ? t.statsInfo : t, {
                name: "if",
                hash: {},
              ...
              (o = n.if.call(
                l,
                null != (o = null != t ? t.rankInfo : t) ? o.isInApex : o,
                {
                  name: "if",
                  hash: {},
              ...
              (o = n.if.call(
                l,
                null != (o = null != t ? t.rankInfo : t) ? o.isInPlacements : o,
                {
                  name: "if",
                  hash: {},
      ...
      (e, t, n) => {
        ...
        e.exports = a.Ember.Component.extend({
          ...
          previousSplit: a.Ember.computed(
            "splitsConfig.splits.@each.endTimeMillis",
            function () {
          ...
          _initDataBindings() {
            (this.rankedDataBinding = (0, a.dataBinding)(
              "/lol-ranked",
              (0, a.getProvider)().getSocket(),
            )),
          ...
          _displayEosNotification(e) {
            ...
            switch (u) {
              ...
              case o.EOS_NOTIFICATION_TYPES.SECOND_WARNING:
                (g = `ranked_eos_notification_last_day_warning_${_}_title`),
                  (h = `ranked_eos_notification_last_day_warning_${_}_description`);
                break;
              case o.EOS_NOTIFICATION_TYPES.SEASON_ENDED:
                (g = `ranked_eos_notification_ended_${_}_title`),
                  (h =
                    e.tier && "DEFAULT" !== e.tier
                      ? "ranked_eos_notification_ended_description"
                      : "ranked_eos_notification_ended_tier_DEFAULT"),
                  (0, i.isTftQueueType)(d) || (f = this.get("previousSplit"));
                break;
              default:
                return;
            }
            ...
            if (
              (f
                ? ((E = f.splitId), (S = f.startTimeMillis))
                : ((E = this.get("currentSplit")), (S = e.seasonStartTime - c)),
              !E && !(0, i.isTftQueueType)(d))
            )
              return;
            ...
            n.push(t),
              ...
              (0, a.dataBinding)("lol-ranked").post(
          ...
          (e.exports = s.Ember.Component.extend(d, {
            ...
            splits: s.Ember.computed(
              ...
              function () {
                ...
                if (e && e.length)
                  return (
                    (e = s.Lodash.cloneDeep(e)),
                    e.sort((e, t) => parseInt(e.splitId) - parseInt(t.splitId)),
                    e
                  );
              },
            ),
            highestRankedNonTFTEntryQueue: s.Ember.computed.alias(
              "currentRankedStats.highestRankedEntrySR",
            ),
            eligibleNonTFTQueues: s.Ember.computed(
              "currentRankedStats",
              "currentRankedStats.queues.[]",
              function () {
            ...
            isGameflowPhaseValid: s.Ember.computed(
              "gameflowSession",
            ...
            isConfigReady: s.Ember.computed(
              "rewardsService",
            ...
            isConfigReadyObserver: s.Ember.observer(
              "isConfigReady",
              function () {
                this.get("isConfigReady") && this._initializeModal();
              },
            ),
            isHonorEligible: s.Ember.computed(
              "honorConfig.Enabled",
              "honorProfile.honorLevel",
              function () {
                return (
            ...
            _tryToDisplaySeasonMemorialModal: function (e) {
              const t = this.get("currentSeason"),
                ...
                o = this._getBestChampionStatsPanelData(
                  e.games,
                  n,
                  s,
                  a,
            ...
            _getSeasonMemorialModalRewardsInfoPromise: function () {
              const e = this.get("currentSeason"),
                ...
                d = u ? u.rewards : null,
                p =
                  s.LeaguesConsts.TIER_NAME_TO_ORDINAL[a.previousSeasonEndTier];
              if (d) {
                ...
                i &&
                  ...
                  i.forEach((e) => {
                    if (a && u && p >= a)
                      for (let e = a; e <= p; e++) {
                        ...
                        if (a) {
                          ...
                          c.push(s.LeagueTierNames.asyncGetRewardImage(a)),
                            r.push(t);
                        }
                      }
                    const t =
                    ...
                    if (n) {
                      ...
                      c.push(s.LeagueTierNames.asyncGetRewardImage(n)),
                        r.push(a);
                    }
                  });
              }
            ...
            _getSeasonMemorialModalRankInfo: function () {
              ...
              return {
                ...
                currentRankText: s.LeagueTierNames.getFullTierDivisionName(
                  n,
                  a,
                ),
                queueTypeText: this.get("tra").formatString(
                  "SPLIT_START_TAKEOVER_QUEUE_TYPE_TEXT",
                  {
                    queueType: s.LeagueTierNames.getRankedQueueName(
                      t.queueType,
                    ),
                  },
                ),
            ...
            _getBestChampionStatsPanelData(e, t, n, a, s, i) {
              let o = this._getBestChampionInfoForRanked(e, t, n),
                l = m;
              return (
                o || ((o = this._getBestChampionInfoForNormals(e)), (l = g)),
                o
                  ? this._getStatsPanelDataForChampion(o, a, s, l)
                  : this._getStatsPanelDataForChampionMastery(i)
              );
            },
            _getBestChampionInfoForRanked(e, t, n) {
            ...
            _getStatsPanelDataForChampion(e, t, n, a) {
              const s = this.careerStatsAPI.getCareerStatsQueueType(
                e.queueType,
              );
              return t
                .getChampionStatPercentiles(e.championId, [
            ...
            _getRankedSeasonEndTime(e) {
              if (e && e.seasons) {
                ...
                for (let n = 0; n < t.length; n++) {
                  const a = t[n];
                  if (!(0, c.isTftQueueType)(a))
                    return e.seasons[a].currentSeasonEnd;
                }
              }
              return null;
            },
            ...
            _isRankedQueueValid: function (e) {
              return (
                Boolean(e) &&
                Boolean(e.queueType) &&
                Boolean(e.previousSeasonEndTier) &&
                e.previousSeasonEndTier !== s.LeaguesConsts.TIER_NAME_NONE
              );
            },
            _getMiniSeriesWinsNeeded: function (e) {
              if (e) {
        ...
        e.exports = (a.default || a).template({
          ...
          main: function (e, t, n, a, s, i) {
            ...
            return (
              ...
              '">\r\n                            </lol-regalia-emblem-element>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n            <div class="rank-progress-footnote">\r\n              <div class="rank-text-wrapper">\r\n                <lol-uikit-resizing-text-field class="lp-text" data-max-width="200">' +
              u(c(null != (o = null != t ? t.rankInfo : t) ? o.lpText : o, t)) +
              '</lol-uikit-resizing-text-field>\r\n              </div>\r\n              <div class="rank-text-wrapper">\r\n                <lol-uikit-resizing-text-field class="wins-text" data-max-width="200">' +
              u(
                c(null != (o = null != t ? t.rankInfo : t) ? o.winsText : o, t),
              ) +
              "</lol-uikit-resizing-text-field>\r\n              </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>"
            );
          },
      ...
      (e, t, n) => {
        ...
        const l = n(132),
          ...
          T = { [c]: 500, [u]: 1e3, [d]: 500, [f]: 1e3, [_]: 1e3, [E]: 1e3 },
          v = {
            [c]: "LARGE",
            [u]: "SMALL",
            [d]: "LARGE",
        ...
        e.exports = a.Ember.Component.extend(r, {
          ...
          settingsService: (0, a.dataBinding)(
            "/lol-settings",
            (0, a.getProvider)().getSocket(),
          ),
          modalManager: a.ModalManager,
          ...
          _processNotifications: function (e) {
            if (e)
              for (let t = 0; t < e.length; t++) {
                ...
                a.has(n.id) ||
                  (a.add(n.id), this._waitForUnlock(this._showNotification, n)),
                  this.set("displayedNotificationsIds", a);
              }
          },
          _processGlobalNotifications: function (e) {
            ...
            for (let a = 0; a < e.length; a++) {
              ...
              n.has(o) ||
                (t[o] && !(t[o] < i)) ||
                (n.add(o),
                this._waitForUnlock(this._showGlobalNotification, s)),
          ...
          _handleGlobalNotificationClicked(e) {
            e.notifyReason === g
              ? a.Telemetry.sendEvent("leagues-first-challenger-toast-clicked")
              : e.notifyReason === h &&
                a.Telemetry.sendEvent("leagues-final-rank-one-toast-clicked");
          },
          _sendGlobalNotificationShownTelemetry(e) {
            e.notifyReason === g
              ? a.Telemetry.sendEvent("leagues-first-challenger-toast-shown")
              : e.notifyReason === h &&
                a.Telemetry.sendEvent("leagues-final-rank-one-toast-shown");
          },
          ...
          _showVignetteNotificationAfterLoadingRewardAssets: function (e) {
            ...
            a.LeagueTierNames.asyncGetSplitRewardLocalization(t).then((n) => {
              ...
              s
                ? ((e.imagePath = s), this._showVignetteNotification(e))
                : a.LeagueTierNames.asyncGetRewardImage(t).then((t) => {
          ...
          _showVignetteNotification: function (e) {
            ...
            return a.LeagueTierNames.getTiersForQueue(e.queueType).then((r) => {
              const c = a.Ember.Object.create({
                ...
                u =
                  e.notifyReason === _ &&
                  e.queueType === s.QUEUES.RANKED_CHERRY_QUEUE_TYPE;
              if (
                e.notifyReason === f &&
                e.queueType === s.QUEUES.RANKED_CHERRY_QUEUE_TYPE
              )
              ...
              const d = u ? S.CHERRY_RATED_TIER_PROMOTED : S[i],
                p = a.componentFactory.create({ type: d, data: c }),
                m = {
                  ...
                  content: p,
                  onClick: function () {
                    a.VignetteCelebrationManager.remove(this),
                      a.Ember.run.later(() => {
                        o(e);
                      }, 1e3);
                  },
          ...
          _showModalNotification: function (e) {
            ...
            const s = l({ header: t, body: n }),
              i = document.createElement("div");
            i.classList.add("leagues-modal-notification"), (i.innerHTML = s);
            const o = { contents: i.outerHTML, okText: a };
            this.get("modalManager")
            ...
            if (o === p)
              l === m
                ? ((n = t.get("LEAGUES_SYSTEM_DECAY_DEMOTION_TITLE")),
                  (a = t.formatString("LEAGUES_SYSTEM_DECAY_DEMOTION", {
                ...
                : !0 === e.eligibleForPromoHelper
                  ...
                  : ((n = t.get("LEAGUES_GENERAL_LEAGUE_UPDATE_TITLE")),
                    (a = t.formatString("LEAGUES_MESSAGE_LEAGUE_DEMOTED", {
                      tierDivisionLoc: this._getTierDivisionLoc(e),
                      queueType: r,
                    })));
            else if ("MINISERIES_START" === o)
              (n = t.get("LEAGUES_GENERAL_LEAGUE_MINISERIES_TITLE")),
                (a = t.formatString("LEAGUES_MESSAGE_MINISERIES_START", {
              ...
              !0 === e.eligibleForPromoHelper
                ...
                : ((n = t.get("LEAGUES_GENERAL_LEAGUE_MINISERIES_TITLE")),
                  (a = t.formatString("LEAGUES_MESSAGE_MINISERIES_LOST", {
                    queueType: r,
                  })));
            else if ("MINISERIES_CANCEL" === o)
              l === m
                ? ((n = t.get("LEAGUES_SYSTEM_SERIES_ENDED_TITLE")),
                  (a = t.formatString("LEAGUES_SYSTEM_SERIES_ENDED_DECAY", {
                    queueType: r,
                  })))
                : ((n = t.get("LEAGUES_SYSTEM_SERIES_ENDED_TITLE")),
                  (a = t.formatString("LEAGUES_SYSTEM_SERIES_ENDED", {
                    queueType: r,
                  })));
            else if ("LEAGUE_DECAY_WARNING" === o)
              (n = t.get("LEAGUES_SYSTEM_DECAY_SOON_TITLE")),
                (a = t.formatString("LEAGUES_SYSTEM_DECAY_SOON", {
              ...
              (n = t.get("LEAGUES_SYSTEM_PROMOTION_SERIES_DECAY_SOON_TITLE")),
                (a = t.formatString("LEAGUES_SYSTEM_SERIES_INACTIVITY", {
                  timeUntilInactivityStatusChangesDays: (0,
                  i.timeInMillisToDays)(e.timeUntilInactivityStatusChanges),
                  queueType: r,
                }));
              ...
              (n = t.get("LEAGUES_SYSTEM_DECAY_TITLE")),
                (a = t.formatString("LEAGUES_SYSTEM_DECAY", { queueType: r }));
            else {
              ...
              e.wasAfkOrLeaver &&
                ...
                (s = t.get("player_behavior_afk_lp_penalty_notification_cta")));
            }
            return [n, a, s];
          },
          _showToastNotification: function (e) {
            const [t, n] = this._getToastNotificationText(e),
              s = this._isToastMuted(e),
              i = document.createElement("div");
            (i.style.height = "100%"),
              (i.style.width = "100%"),
            ...
            o.setAttribute("ranked-tier", e.tier),
              ...
              a.Ember.run.later(() => {
                this.toastCelebrationManager.add({
                  data: { title: t, details: n, iconElement: i, isMuted: s },
                  timing: "slow",
                });
              }, 1e3),
              this._acknowledgeNotification(e);
            ...
            return (
              "LEAGUE_SEEDED" === s
                ? ((t = this._getTierDivisionLpLoc(e)),
                  (n = a.formatString("TOAST_PROVISIONAL_START_BODY", {
                    queueType: i,
                  })))
                : s === d
                  ? ((t = a.formatString("TOAST_DIVISION_PROMOTION_HEADER", {
                      tierDivisionLoc: this._getTierDivisionLoc(e),
                    })),
                  ...
                  : s === p &&
                    ((t = a.formatString("TOAST_DEMOTION_HEADER", {
                      tierDivisionLoc: this._getTierDivisionLoc(e),
                    })),
          ...
          _getTierDivisionLoc: (e) =>
            a.LeagueTierNames.getFullTierDivisionName(e.tier, e.division),
          _getTierDivisionLpLoc: (e) =>
            a.LeagueTierNames.getTierDivisionLpLoc(
              e.tier,
              e.division,
              e.leaguePoints,
            ),
          _getQueueLoc: (e) =>
            a.LeagueTierNames.getRankedQueueName(e.queueType),
          _getSeasonId(e) {
          ...
          _waitForUnlock: function (e, t) {
            ...
            if (a.LockAndLoad.getLockState()) {
              const e = function () {
                a.LockAndLoad.removeEventListener("unlock", e),
                  setTimeout(function () {
                    n(t);
                  }, 5e3);
              };
              ...
              c(
                typeof (i =
                  null != (i = n.header || (null != t ? t.header : t))
                    ? i
                    : l) === r
                  ? i.call(o, { name: "header", hash: {}, data: s })
                  : i,
              ) +
              '</h4>\r\n<hr class="heading-spacer" />\r\n<p>' +
              c(
                typeof (i =
                  ...
                  r
                  ? i.call(o, { name: "body", hash: {}, data: s })
                  : i,
              ) +
              "</p>\r\n"
            );
      ...
      (e, t, n) => {
        ...
        e.exports = a.Ember.Service.extend(i, {
          getRewardData: function (e, t, n) {
            ...
            if (e === s.ETERNALS_CAPSULE_REWARD_TYPE)
          ...
          getRewardFromCatalog: function (e, t, n) {
            ...
            return { imagePath: s, split: i, loc: this.getRewardLoc(e, i) };
          },
          getRegalia: function (e, t, n) {
            ...
            return (
              (i =
                n && n.transparent
                  ? `${s.ASSET_PATH}images/Split_Reward_Level_${a}_Transparent.png`
                  : n && n.small
                    ? `${s.ASSET_PATH}images/Split_Reward_Level_${a}_Small.png`
                    : `${s.ASSET_PATH}images/Split_Reward_Level_${a}.jpg`),
              { imagePath: i, loc: this.getRewardLoc(e, a) }
            );
          },
          ...
          getRewardLoc: function (e, t) {
            ...
            return (
              e === s.EMOTE_REWARD_TYPE
                ? (n = "LEAGUES_REWARD_EMOTE")
                : e === s.REGALIA_REWARD_TYPE
                  ? (n = "LEAGUES_REWARD_REGALIA")
                  : e === s.ETERNALS_CAPSULE_REWARD_TYPE &&
          ...
          regaliaRewards: a.Ember.computed(
            ...
            function () {
              ...
              return e
                ? Object.keys(e)
                    .map((t) => e[t])
                    .filter((e) => e.rewardType === s.REGALIA_REWARD_TYPE)
                : [];
            },
          ),
          numberOfNotEarnedRegalia: a.Ember.computed(
      ...
      (e, t, n) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.default = function (e, t, n) {
            ...
            (s.className = "lol-leagues lol-leagues-full"),
              (s.type = "LeaguesRootComponent");
            ...
            r(m, s, t, !1, null, h),
              ...
              f.addEventListener("showSubsection", (e, t) => {
                if (!t || !t.puuid) return;
                const n = o + t.puuid;
                (0, a.dataBinding)(i, (0, a.getProvider)().getSocket())
                  .get(n)
                  .then((e) => {
        ...
        function r(e, t, n, s, i, o) {
          e.addEventListener("selected", (l) => {
            let r = null,
              c = null;
            if (
              (a.Telemetry.startTracingEvent("profile-ranked-rendered"),
              !l || !l.summonerId)
            )
              return (
        ...
        function u(e, t, n, a) {
          ...
          e &&
            (e.setEnabled(s),
            e.setTooltip(s ? null : a.get("LEAGUES_SERVICE_UNAVAILABLE")));
        }
      },
    ],
    t = {};
        ...
        function (a) {
          (0, a.registrationHandler)(function (a) {
            ...
            return e.default
              ...
              .then(() => {
                const { Ember: a } = e.default,
                  { emberApplicationFactory: s, componentFactory: o } =
                    e.default,
                  l = (0, t.default)(a, i);
                e.default.tra = i;
                const r = n(3).default,
