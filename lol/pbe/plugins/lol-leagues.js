    ...
    var e = [, e => {
            ...
            e.exports = s.Ember.Component.extend(u, {
                ...
                _enrichSpectateAvailability: function(e) {
                    ...
                    this.get("spectatorService.spectateV3Enabled") ? this.get("spectatorService").availableForSpectateByPuuids(t.map((e => e.puuid))) : this.get("spectateBySummonerIdEnabled") ? this.get("spectatorService").availableForSpectateBySummonerIds(t.map((e => e.summonerId))).then((t => {
            ...
            const a = (0, s.emberDataBinding)({
                ...
                boundProperties: {
                    ...
                    spectatablePuuidsResponse: {
                        api: "spectator",
                        path: "/v3/buddy/spectate"
                    }
                }
            });
            e.exports = s.Ember.Service.extend(a, {
                ...
                availableForSpectateByPuuids: function(e) {
                    this.get("spectateV3Enabled") && this.get("api.spectator").post("v3/buddy/spectate", e, {
                        skipCache: !0
                    })
                }
            })
            ...
            e.exports = s.Ember.Component.extend({
                ...
                _displayEosNotification(e) {
                    ...
                    let g = "",
                        h = "",
                        f = null;
                    const E = (0, i.isTftQueueType)(d) ? "TFT" : "SR";
                    switch (u) {
                        case o.EOS_NOTIFICATION_TYPES.FIRST_WARNING:
                        case o.EOS_NOTIFICATION_TYPES.SECOND_WARNING:
                            g = `ranked_eos_notification_last_day_warning_${E}_title`, h = `ranked_eos_notification_last_day_warning_${E}_description`;
                            break;
                        case o.EOS_NOTIFICATION_TYPES.SEASON_ENDED:
                            g = `ranked_eos_notification_ended_${E}_title`, h = e.tier && "DEFAULT" !== e.tier ? "ranked_eos_notification_ended_description" : "ranked_eos_notification_ended_tier_DEFAULT", (0, i.isTftQueueType)(d) || (f = this.get("previousSplit"));
                            break;
                        default:
                            return
                    }
                    let _ = null,
                        S = null;
                    if (f ? (_ = f.splitId, S = f.startTimeMillis) : (_ = this.get("currentSplit"), S = e.seasonStartTime - c), !_ && !(0, i.isTftQueueType)(d)) return;
            ...
            e.exports = s.Ember.Component.extend(c, {
                ...
                _showVignetteNotification: function(e) {
                    ...
                    return s.LeagueTierNames.getTiersForQueue(e.queueType).then((r => {
                        ...
                        if (e.notifyReason === E && e.queueType === a.QUEUES.RANKED_CHERRY_QUEUE_TYPE) return void o(e);
