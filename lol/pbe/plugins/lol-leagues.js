(() => {
  var e = [
          ...
          (t.default = function (e, t, s) {
            ...
            t.setFactoryDefinition({
              ...
              t.setFactoryDefinition({
                ...
                EosNotificationsComponent: n(121),
                SeasonMemorialModalComponent: n(124),
                LeaguesDialogsComponent: n(127),
                RewardsService: n(130),
                CareerStatsService:
      ...
      (e, t, n) => {
        ...
        e.exports = s.Ember.Component.extend(d, {
          ...
          summonerReadyChanged: s.Ember.observer("summonerReady", function () {
            ...
            this.set("viewerId", o.summonerId),
              n && this.set("honorLevel", n.honorLevel),
              t && o.summonerId !== t
                ? a.observe(i, this, this._handleSummonerLeaguesData)
                : (this.set("summonerId", o.summonerId),
                  this.set("puuid", o.puuid),
                  a.observe(
          ...
          _fillInDivisions: function (e, t) {
            ...
            return (
              ...
              a.forEach((a) => {
                ...
                t ? ((l = a), (o = "I")) : ((l = e.tier), (o = a)),
                  r || (r = { division: o, tier: l, standings: [] }),
                  n.push(r);
              }),
              n
            );
          ...
          _enrichSpectateAvailability: function (e) {
            ...
            this.get("spectatorService.spectateV3Enabled")
              ? this.get("spectatorService")
                  .availableForSpectateByPuuids(t.map((e) => e.puuid))
                  .then((t) => {
                    const n = this.get("selectedState");
                    n.league.queueType === e.queueType &&
                      n.league.tier === e.tier &&
                      this.set("spectatablePuuids", t);
                  })
              : this.get("spectateBySummonerIdEnabled")
                ? this.get("spectatorService")
                    .availableForSpectateBySummonerIds(
                      t.map((e) => e.summonerId),
                    )
                    .then((t) => {
                      const n = this.get("selectedState");
                      n.league.queueType === e.queueType &&
      ...
      (e, t) => {
        ...
        var l = { TIME_UNITS: n, TIME_CONVERSIONS: o };
        t.default = l;
      },
      (e, t, n) => {
        "use strict";
          ...
          (e.exports = s.Ember.Component.extend({
            ...
            setRankedData(e, t, n) {
              e &&
                ...
                n.queueMap &&
                n.queueMap[t] &&
                n.queueMap[t].previousSeasonEndTier &&
                n.queueMap[t].previousSeasonEndTier !==
      ...
      (e, t, n) => {
        ...
        e.exports = s.Ember.Component.extend({
          ...
          isRatedQueue: s.Ember.computed(
            "selectedState.league.queueType",
            function () {
              return o.QUEUES.ALL_RATED_QUEUE_TYPES.includes(
                this.get("selectedState.league.queueType"),
              );
            },
          ),
          ...
          divisionOrTierEmptyText: s.Ember.computed(
            ...
            function () {
              ...
              return t && n
                ? o.formatString("LEAGUES_APEX_TIER_UNLOCKED_EMPTY_MIN_LP", {
                    minLpForTier: t,
          ...
          playerHeaderText: s.Ember.computed("isTft", function () {
            return this.get("isTft")
              ...
              : this.get("tra.LEAGUES_PROFILE_TABLE_HEADER_PLAYERS");
          }),
      ...
      (e, t, n) => {
        ...
        e.exports = s.Ember.Component.extend({
          ...
          isAvailableForSpectate: s.Ember.computed(
            ...
            "spectatorService.spectateV3Enabled",
            function () {
              ...
              if (this.get("spectatorService.spectateEnabled")) {
          ...
          click: function () {
            this.get("isSecondaryHeader") ||
              this.get("isHeader") ||
              (l && l.play(), this.sendAction("onRowClick", this.get("data")));
          },
              ...
              c(
                typeof (i =
                  null != (i = n.title || (null != t ? t.title : t))
                    ? i
                    : l) === r
                  ? i.call(o, { name: "title", hash: {}, data: a })
                  : i,
              ) +
              ...
              c(
                typeof (i =
                  null != (i = n.message || (null != t ? t.message : t))
                    ? i
                    : l) === r
                  ? i.call(o, { name: "message", hash: {}, data: a })
                  : i,
              ) +
              "</p>\r\n</div>\r\n\r\n"
            );
        ...
        (t.default = function (e) {
          e.registerHelper("blockHelperMissing", function (t, n) {
            ...
            if (n.data && n.ids) {
              ...
              (o.contextPath = s.appendContextPath(n.data.contextPath, n.name)),
                (n = { data: o });
            }
            return i(t, n);
          });
          ...
          (t.template = function (e, t) {
            ...
            var n = {
              ...
              program: function (e, t, n, s, a) {
                ...
                return (
                  t || a || s || n
                    ? (i = r(this, e, o, t, n, s, a))
                    : i || (i = this.programs[e] = r(this, e, o)),
                  i
                );
              },
              data: function (e, t) {
        ...
        e.exports = s.Ember.Component.extend({
          ...
          getVictoriousPointsNeededForTier: (e, t) =>
            (t &&
              ...
              e.victoriousSkinRewardGroup.splitPointsByHighestSeasonEndTier &&
              e.victoriousSkinRewardGroup.splitPointsByHighestSeasonEndTier[
                t
              ]) ||
            1600,
          ...
          victoriousPointsSilverBelow: s.Ember.computed(
            ...
            function () {
              ...
              return e && s.LeagueTierNames.getConstants().TIERS.indexOf(e) <= 2
                ? `${this.get("playerPoints")} / ${this.get("victoriousPointsNeededSilverBelow")}`
                : `${this.get("victoriousPointsNeededSilverBelow")} / ${this.get("victoriousPointsNeededSilverBelow")}`;
            },
          ),
      ...
      (e, t, n) => {
        ...
        e.exports = s.Ember.Component.extend({
          ...
          optionItem: s.Ember.computed(
            "iconPath",
            "rewardOptionState",
            function () {
              return {
                state: this.get("rewardOptionState"),
                thumbIconPath: this.get("iconPath"),
              };
            },
          ),
          didReceiveAttrs: function () {
      ...
      (e, t, n) => {
        ...
        const a = (0, s.emberDataBinding)({
          ...
          boundProperties: {
            ...
            spectateV3Config: { api: "spectator", path: "/v1/spectate/config" },
          },
        });
        e.exports = s.Ember.Service.extend(a, {
          ...
          spectateV3Enabled: s.Ember.computed.alias(
            "spectateV3Config.isEnabled",
          ),
          spectateGame: function (e, t, n) {
            return this.get("spectateV3Enabled") || this.get("spectateEnabled")
          ...
          availableForSpectateByPuuids: function (e) {
            return this.get("spectateV3Enabled")
              ? this.get("api.spectator")
                  .post("v3/buddy/spectate", e, { skipCache: !0 })
                  .then(
                    (e) =>
                      e.availableForWatching ? e.availableForWatching : [],
                    (e) => (
                      s.logger.error(
                        "Failed to retrieve spectatable puuids",
                        e,
                      ),
                      []
                    ),
      ...
      (e, t, n) => {
        ...
        var s,
          a = n(1),
          i = n(23),
          o = (s = n(92)) && s.__esModule ? s : { default: s };
        n(93);
        ...
        e.exports = a.Ember.Component.extend(l, o.default, {
          ...
          introVideoPath: a.Ember.computed(
            ...
            function () {
              ...
              return e
                ? `${i.ASSET_PATH}videos/ranked/tier-promotion-from-${e.toLowerCase()}.webm`
                : "";
            },
          ),
          outroVideoPath: a.Ember.computed("currentTier", function () {
            const e = this.get("currentTier");
            return e
              ? `${i.ASSET_PATH}videos/ranked/tier-promotion-to-${e.toLowerCase()}.webm`
              : "";
          }),
          introAudioPath: a.Ember.computed(
            ...
            function () {
              ...
              const e = this.get("previousTier");
              return e
                ? `${i.ASSET_PATH}sounds/ranked/sfx-tier-wings-promotion-from-${e.toLowerCase()}.ogg`
                : "";
            },
          ),
          outroAudioPath: a.Ember.computed("currentTier", function () {
            const e = this.get("currentTier");
            return e
              ? `${i.ASSET_PATH}sounds/ranked/sfx-tier-wings-promotion-to-${e.toLowerCase()}.ogg`
              : "";
          }),
          outroImagePath: a.Ember.computed("currentTier", function () {
            const e = this.get("currentTier");
            return e
              ? `${i.ASSET_PATH}images/ranked-emblem/emblem-${e.toLowerCase()}.png`
              : "";
          }),
      ...
      (e, t, n) => {
        ...
        e.exports = s.Ember.Component.extend({
          ...
          init() {
            this._super(...arguments),
              (this._dataBinding = s.dataBinding.bindTo(
                (0, s.getProvider)().getSocket(),
              )),
              ...
              this._dataBinding.observe(
                ...
                this,
                this.handleSplitsConfig,
              ),
              this._dataBinding.observe(
                "/lol-ranked/v1/current-ranked-stats",
                this,
                this.handleRankedStats,
              ),
              this._dataBinding.observe(
                "/riotclient/region-locale",
                this,
                this.handleRegionLocale,
              ),
              this._dataBinding.observe(
          ...
          handleSettingsReady(e) {
            e &&
              this._dataBinding.observe(
                "/lol-settings/v2/account/LCUPreferences/lol-leagues",
                this,
                this.handleAccountLeaguesSettings,
              ),
              this.set("settingsReady", e);
          },
          handleSplitsConfig(e) {
            this.set("splitsConfig", e),
              this.get("recentSeasons") ||
                this._dataBinding
                  .post("/lol-seasons/v1/allSeasons/product/LOL", {
                    lastNYears: 2,
                  })
                  .then((e) => {
          ...
          previousSeason: s.Ember.computed(
            "recentSeasons.@each.seasonEnd",
            function () {
          ...
          previousSplit: s.Ember.computed(
            "splitsConfig.splits.@each.seasonId",
          ...
          currentSeason: s.Ember.computed(
            "splitsConfig",
            "splitsConfig.currentSplit",
          ...
          isDependenciesInitialized: s.Ember.computed(
            "session.state",
            "currentSummoner.unnamed",
            "currentSummoner.nameChangeFlag",
            "currentSeason",
            "previousSeason",
            "previousSplit",
            "splitsConfig",
            ...
            function () {
              const e = this.get("session.state"),
                ...
                n = Boolean(this.get("currentSeason")),
                s = Boolean(this.get("previousSeason")),
                a = Boolean(this.get("previousSplit")),
                i = Boolean(this.get("splitsConfig")),
                o = Boolean(this.get("currentRankedStats")),
                l = Boolean(this.get("settingsReady")),
                r = Boolean(this.get("accountLeaguesSettings")),
                c = Boolean(this.get("regionLocale"));
              return (
                !this._isLoginSessionInvalid(e) &&
                this._isNamedSummoner(t) &&
                n &&
                s &&
                a &&
                i &&
      ...
      (e, t, n) => {
        ...
        e.exports = a.Ember.Component.extend(o, {
          ...
          _showSeasonStartToast() {
            ...
            i.default.saveAccountSetting(l, { season: n });
          },
        });
      },
      (e, t, n) => {
      ...
      (e, t, n) => {
        ...
        var s,
          ...
          i = n(23),
          o = n(26),
          l = (s = n(116)) && s.__esModule ? s : { default: s };
        n(119);
        const r = n(120),
        ...
        e.exports = a.Ember.Component.extend(c, {
          ...
          platformConfigObserver: a.Ember.observer(
            ...
            function () {
              ...
              if (!Boolean(i) || !a) return;
              const l = (0, o.getDaysBetweenDateMillis)(
                Date.now(),
                i.endTimeMillis,
              );
              this._shouldDisplaySplitEndNotification(t, l, e, s) &&
                this._displaySplitEndNotification(t, i, n);
            },
          ),
          ...
          _displaySplitEndNotification: function (e, t, n) {
            const s = Boolean(t)
                ? (0, o.convertDateMillisToString)(t.startTimeMillis, n, {
                    year: "numeric",
                  })
                : new Date().getFullYear(),
              i = {
                ...
                data: {
                  ...
                  endDate: (0, o.convertDateMillisToString)(
                    t.endTimeMillis - 1,
                    n,
            ...
            (0, a.dataBinding)("player-notifications").post(
              ...
              l.default.saveAccountSetting(g, e),
          ...
          _renderSplitEndNotification: function (e) {
            const t = document.createElement("div"),
              ...
              s = isNaN(e.data.endDate)
                ? e.data.endDate
                : (0, o.convertDateMillisToString)(e.data.endDate - 1, n, {
                    month: "long",
                    day: "numeric",
                  }),
              a = r({
              ...
              c(
                typeof (i =
                  null != (i = n.detail || (null != t ? t.detail : t))
                    ? i
                    : l) === r
                  ? i.call(o, { name: "detail", hash: {}, data: a })
                  : i,
              ) +
              "</div>"
            );
          ...
          _displayEosNotification(e) {
            ...
            switch (c) {
              ...
              case o.EOS_NOTIFICATION_TYPES.SECOND_WARNING:
                (m = `ranked_eos_notification_last_day_warning_${f}_title`),
                  (g = `ranked_eos_notification_last_day_warning_${f}_description`);
                break;
              case o.EOS_NOTIFICATION_TYPES.SEASON_ENDED:
                (m = `ranked_eos_notification_ended_${f}_title`),
                  (g =
                    e.tier && "DEFAULT" !== e.tier
                      ? "ranked_eos_notification_ended_description"
                      : "ranked_eos_notification_ended_tier_DEFAULT"),
                  (0, i.isTftQueueType)(u) || (h = this.get("previousSplit"));
                break;
              default:
                return;
            }
            ...
            if (
              (h
                ? ((E = h.splitId), (_ = h.startTimeMillis))
                : ((E = this.get("currentSeason.split.splitId")),
                  (_ = this.get("currentSeason.split.startTimeMillis"))),
              !E && !(0, i.isTftQueueType)(u))
            )
              return;
      ...
      (e, t, n) => {
        ...
        const c = n(126),
          ...
          m = "normals",
          g = new Map();
        g.set("RANKED_FLEX_SR", "FLEX"),
          g.set("RANKED_SOLO_5x5", "SOLODUO"),
          (e.exports = a.Ember.Component.extend(u, {
            ...
            init() {
              this._super(...arguments),
                this.get("isConfigReady"),
                (this._dataBinding = a.dataBinding.bindTo(
                  (0, a.getProvider)().getSocket(),
                ));
            },
            previousSeasonRankedSRQueues: a.Ember.computed(
              "currentRankedStats.queues.@each.queueType",
              "currentRankedStats.queues.@each.previousSeasonEndTier",
              function () {
                return (this.get("currentRankedStats.queues") || []).filter(
                  (e) => {
                    const t =
                        e.previousSeasonEndTier &&
                        e.previousSeasonEndTier !==
                          a.LeaguesConsts.TIER_NAME_NONE,
            ...
            previousSeasonHighestRankedSRQueue: a.Ember.computed(
              "previousSeasonRankedSRQueues.@each.previousSeasonEndTier",
              function () {
            ...
            eosRewardsMap: a.Ember.computed(
              "eosRewardsConfig.seasons.[]",
              "previousSeason.seasonId",
              function () {
            ...
            _initializeModal() {
              ...
              t.loadPreviousSeasonStatsGames(e, n).then((t) => {
                this._tryToDisplaySeasonMemorialModal(t, e),
            ...
            _displaySeasonMemorialModal: function (e) {
              ...
              return this._getSeasonMemorialModalRewardsInfoPromise().then(
                (n) => (
                  a.ModalManager.add({
                    type: "DialogConfirm",
                    data: {
              ...
              if (t)
                return {
                  seasonTitle: this.get("tra").formatString(
                    ...
                    {
                      seasonYear: (0, l.convertDateMillisToString)(
                        t.startTimeMillis,
                        e,
                        { year: "numeric" },
                      ),
                  ...
                  splitDurationTitle: this.get("tra").formatString(
                    ...
                    {
                      splitStartString: (0, l.convertDateMillisToString)(
                        t.startTimeMillis,
                        e,
                      ),
                      splitEndString: (0, l.convertDateMillisToString)(
                        t.endTimeMillis - 1,
                        e,
                      ),
                    },
            ...
            _getRewardImageInfoPromise: (e) =>
              e.overrideImagePath
                ? Promise.resolve(e.overrideImagePath)
                : a.LeagueTierNames.asyncGetRewardImage(e.id),
            _getSeasonMemorialModalRewardsInfoPromise: function () {
              ...
              if (s) {
                const n = {
                  description: this.get(
                    "tra.REWARD_TYPE_ETERNALS_CAPSULE_DESCRIPTION",
                  ),
              ...
              const i = this.get(
                  "previousSeasonHighestRankedSRQueue.previousSeasonEndTier",
                ),
                l = (this.get(
                  "previousSplit.victoriousSkinRewardGroup.splitPointsByHighestSeasonEndTier",
                ) || {})[i],
              ...
              if (r >= l) {
                ...
                if (s ? s.id : null) {
                  const n = {
                    description: this.get(
                      "tra.REWARD_TYPE_CHAMPION_SKIN_DESCRIPTION",
                    ),
              ...
              (this.get("previousSeasonRankedSRQueues") || []).forEach((s) => {
                const a =
                  n[
                    `SUMMONER_ICON_${g.get(s.queueType)}_${s.previousSeasonEndTier}`
                  ];
                if (a ? a.id : null) {
                  const n = o.SUMMONER_ICON_REWARD_TYPE,
                    i = {
                      description: this.get(
                        `tra.SEASON_MEMORIAL_TAKEOVER_REWARD_TYPE_${n}_${s.queueType}_DESCRIPTION`,
                      ),
                      ...
                      const s = n.rewardType,
                        ...
                        o = {
                          description: this.get("tra").formatString(
                            "SEASON_MEMORIAL_TAKEOVER_REWARD_DESCRIPTION",
                            {
                              splitName: i,
                              rewardTypeDescription: this.get(
                                `tra.REWARD_TYPE_${s}_DESCRIPTION`,
                              ),
                            },
                          ),
                          cssClass: `reward-image-${s}`,
                        };
                      t.push(a.LeagueTierNames.asyncGetRewardImage(n.id)),
                        e.push(o);
                    });
                  }
                });
            ...
            _getSeasonMemorialModalRankInfo: function () {
              const e = this.get("previousSeasonHighestRankedSRQueue"),
                ...
                s = e.previousSeasonHighestTier,
                i = e.previousSeasonHighestDivision;
              return {
                ...
                highestRankTier: s,
                highestRankDivision: i,
                highestRankText: a.LeagueTierNames.getFullTierDivisionName(
                  s,
                  i,
                ),
            ...
            _getBestChampionStatsPanelData(e, t, n, s, a, i) {
              let o = this._getBestChampionInfoForRanked(e, t, n),
                l = p;
              return (
                o || ((o = this._getBestChampionInfoForNormals(e)), (l = m)),
                o
                  ? this._getStatsPanelDataForChampion(o, s, a, l)
                  : this._getStatsPanelDataForChampionMastery(i)
              );
            },
            _getBestChampionInfoForRanked(e, t, n) {
              const s = n.queueType;
              let a = this._getBestChampionInfoForQueue(
                e,
                s,
                n.previousSeasonEndTier,
              );
              return (
                a ||
                  t.forEach((t) => {
            ...
            _getChampionGameAssets: function (e) {
              return this._dataBinding.get(
                "/lol-game-data/assets/v1/champions/" + e + ".json",
              );
            },
            _navigateToProfileSubsection: function (e) {
              return (
      ...
      (e, t, n) => {
        ...
        e.exports = (s.default || s).template({
          ...
          3: function (e, t, n, s, a, i) {
            ...
            return (
              '          <div class="reward-container-column">\r\n            <div class="reward-image-container">\r\n              <img src="' +
              r(l(null != (o = i[0][0]) ? o.imagePath : o, t)) +
              '" class="rewards-image ' +
              r(l(null != (o = i[0][0]) ? o.cssClass : o, t)) +
              '">\r\n            </div>\r\n            <div class="reward-description">' +
              r(l(null != (o = i[0][0]) ? o.description : o, t)) +
              "</div>\r\n          </div>\r\n"
            );
          },
          compiler: [7, ">= 4.0.0"],
          main: function (e, t, n, s, a, i) {
            ...
            return (
              ...
              '">\r\n' +
              (null !=
              (o = n.each.call(r, null != t ? t.rewardsInfo : t, {
                name: "each",
                hash: {},
              ...
              u(
                c(
                  null != (o = null != t ? t.titlesInfo : t) ? o.splitTitle : o,
                  t,
                ),
              ) +
              ...
              u(
                c(
                  null != (o = null != t ? t.statsInfo : t) ? o.statsTitle : o,
                  t,
                ),
              ) +
              ...
              u(
                c(
                  null != (o = null != t ? t.statsInfo : t) ? o.statsFooter : o,
                  t,
                ),
              ) +
      ...
      (e, t, n) => {
        ...
        n(128);
        var o,
          l = (o = n(116)) && o.__esModule ? o : { default: o };
        const r = n(129),
          ...
          v = { [u]: 500, [d]: 1e3, [p]: 500, [E]: 1e3, [_]: 1e3, [S]: 1e3 },
          R = {
            [u]: "LARGE",
            [d]: "SMALL",
            [p]: "LARGE",
        ...
        e.exports = s.Ember.Component.extend(c, {
          ...
          _processGlobalNotifications: function (e) {
            ...
            for (let s = 0; s < e.length; s++) {
              ...
              n.has(o) ||
                (t.data[o] && !(t.data[o] < i)) ||
                (n.add(o),
                l.default.saveAccountSetting(o, i),
              ...
              s.Ember.run.later(() => {
                this._getDisplayNames([e.participantId]).then((n) => {
                  ...
                  this.toastCelebrationManager.add({
                    data: { title: i, details: o, iconElement: t },
                    timing: "slow",
          ...
          _getGlobalNotificationText(e, t) {
            ...
            if (e.notifyReason === h)
              (n = o.formatString("TOAST_FIRST_CHALLENGER_HEADER", {
                name: t,
              })),
              ...
              if (Boolean(e)) {
                const a = (0, i.convertDateMillisToString)(
                  e.startTimeMillis,
                  this.get("regionLocale"),
                  { year: "numeric" },
                );
          ...
          _showNotification: function (e) {
            "TOAST" === e.displayType
              ...
              : "VIGNETTE" === e.displayType
                ? e.notifyReason === d && e.rewardEarnedId
          ...
          _showModalNotification: function (e) {
            ...
            const a = r({ header: t, body: n }),
              i = document.createElement("div");
            i.classList.add("leagues-modal-notification"), (i.innerHTML = a);
            const o = { contents: i.outerHTML, okText: s };
            this.get("modalManager")
              .add({ type: "DialogAlert", data: o })
              .okPromise.then(() => {
          ...
          _getModalNotificationText: function (e) {
            ...
            else if ("LEAGUE_DECAY_WARNING" === o)
            ...
            else if ("MINISERIES_DECAY_WARNING" === o)
          ...
          _showToastNotification: function (e) {
            ...
            o.setAttribute("ranked-tier", e.tier),
              i.appendChild(o),
              s.Ember.run.later(() => {
                this.toastCelebrationManager.add({
          ...
          _getSeasonId(e, t) {
            if (t && t === f) {
              return this.get("previousSplit.seasonId");
            }
            {
              ...
              c(
                typeof (i =
                  null != (i = n.header || (null != t ? t.header : t))
                    ? i
                    : l) === r
                  ? i.call(o, { name: "header", hash: {}, data: a })
                  : i,
              ) +
              '</h4>\r\n<hr class="heading-spacer" />\r\n<p>' +
              c(
                typeof (i =
                  null != (i = n.body || (null != t ? t.body : t)) ? i : l) ===
                  r
                  ? i.call(o, { name: "body", hash: {}, data: a })
                  : i,
              ) +
              "</p>\r\n"
            );
      ...
      (e, t, n) => {
              ...
              f.addEventListener("showSubsection", (e, t) => {
                ...
                (0, s.dataBinding)(i, (0, s.getProvider)().getSocket())
                  ...
                  .then((e) => {
                    ...
                    E.setEnabled(t), E.setTooltip(t ? null : s.Tra.get(l));
                  });
              }),
              s.Tra.observe(() => {
                E.tooltip && E.setTooltip(s.Tra.get(l));
              }),
        ...
        function r(e, t, n, a, i, o) {
          e.addEventListener("selected", (l) => {
            ...
            if (
              ...
              return (
                o && o.set("refreshTopChamps", !0),
                i || (i = n.create("LeaguesRootComponent", o)),
        ...
        function c(e, t, n) {
          ...
          (0, s.dataBinding)(
            "/lol-platform-config",
            (0, s.getProvider)().getSocket(),
          ).observe("v1/namespaces/LeagueConfig", (e) => {
            (o = e && !1 !== e.LeagueServiceEnabled), u(i, o, l, n);
          });
          return (
            (0, s.dataBinding)(
              "/lol-ranked",
            ...
            return e.default
              ...
              .then(() => {
                const { Ember: s } = e.default,
                  { emberApplicationFactory: a, componentFactory: o } =
                    e.default,
                  l = (0, t.default)(s, i);
                e.default.tra = i;
                const r = n(3).default,
