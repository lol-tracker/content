  ...
  var e = [
      ...
      (e, t, n) => {
        ...
        e.exports = s.Ember.Component.extend({
          ...
          _displayEosNotification(e) {
            ...
            if (
              (h
                ? ((_ = h.splitId), (E = h.startTimeMillis))
                : ((_ = this.get("currentSeason.split.splitId")),
                  (E = this.get("currentSeason.split.startTimeMillis"))),
              !_ && !(0, i.isTftQueueType)(u))
            )
              return;
            const S = e.seasonEndTime - 36e5,
              T = {
                ...
                data: {
                  ...
                  year: (0, a.convertDateMillisToString)(E, l, {
                    year: "numeric",
                  }),
                  split: _ ? _.toString() : "",
      ...
      (e, t, n) => {
        ...
        const r = n(129),
          ...
          v = { [u]: 500, [d]: 1e3, [p]: 500, [_]: 1e3, [E]: 1e3, [S]: 1e3 },
          R = {
            [u]: "LARGE",
            [d]: "SMALL",
            [p]: "LARGE",
