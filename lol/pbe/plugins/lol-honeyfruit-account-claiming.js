    ...
    var e = [, e => {
            ...
            var r = a.Ember.Controller.extend({
                ...
                importedItems: a.Ember.computed("hasPlayedAGame", "isReservedSummonerName", (function() {
                    ...
                    return t ? e ? [this.buildBox(s.PROGRESS_AND_RANKED_HISTORY, i.OVERWRITTEN), this.buildBox(s.IDENTITY_AND_FRIENDS, i.OVERWRITTEN), this.buildBox(s.LOOT_INVENTORY, i.OVERWRITTEN)] : [this.buildBox(s.PROGRESS_AND_RANKED_HISTORY), this.buildBox(s.IDENTITY_AND_FRIENDS), this.buildBox(s.LOOT_INVENTORY), this.buildBox(s.CONTENT), this.buildBox(s.RP_BALANCE), this.buildBox(s.ESSENCE_BALANCES)] : t ? [] : e ? [this.buildBox(s.PROGRESS_AND_RANKED_HISTORY, i.OVERWRITTEN), this.buildBox(s.IDENTITY_AND_FRIENDS, i.NOT_GUARANTEED), this.buildBox(s.LOOT_INVENTORY, i.OVERWRITTEN)] : [this.buildBox(s.PROGRESS_AND_RANKED_HISTORY), this.buildBox(s.IDENTITY_AND_FRIENDS, i.NOT_GUARANTEED), this.buildBox(s.LOOT_INVENTORY), this.buildBox(s.CONTENT), this.buildBox(s.RP_BALANCE), this.buildBox(s.ESSENCE_BALANCES)]
                })),
                buildBox: (e, t = null) => ({
                    type: e,
                    warning: t
                ...
                mergedItems: a.Ember.computed("hasPlayedAGame", "isReservedSummonerName", (function() {
                    return this.get("hasPlayedAGame") ? [this.buildBox(s.RP_BALANCE), this.buildBox(s.ESSENCE_BALANCES), this.buildBox(s.CONTENT, i.POSSIBLE_DUPLICATES)] : []
                })),
                changedItems: a.Ember.computed("hasPlayedAGame", "isReservedSummonerName", (function() {
                    return [this.buildBox(s.NEW_SEASON_START), this.buildBox(s.FRESH_MATCH_HISTORY)]
                }))
            });
            t.default = r
        }, (e, t) => {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                let n;
                const i = function(r) {
                    r.puuid && (l.dataBinding.unobserve(t, i), a = r.puuid, o || (o = !0, s(a, e).then((function(e) {
                        n(e)
                    }))))
                };
            ...
            var m = a.Ember.Component.extend({
                ...
                possibleDupes: a.Ember.computed.equal("warning", s.POSSIBLE_DUPLICATES),
            ...
            var r = a.Ember.Service.extend({
                ...
                observeUntilLinked: () => new Promise((e => {
                    const t = "/lol-honeyfruit/v1/account-claim/account-status",
                        n = l => {
                            const o = l && l.linking_status ? l.linking_status.account_details : null;
                            if (!o) return null;
            ...
            e.exports = l.HTMLBars.template({
                id: "MhciDdEV",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15692\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-honeyfruit-account-claiming\\\\src\\\\app\\\\templates\\\\application.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["text","\\n"],["block",["unless"],[["get",["RIOT_PUBLIC"]]],null,0],["text","\\n"],["append",["unknown",["outlet"]],false],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","  "],["append",["unknown",["dev-cheats"]],false],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const l = n(1).Ember;
            ...
            e.exports = l.HTMLBars.template({
                id: "BDKiEeus",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15692\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-honeyfruit-account-claiming\\\\src\\\\app\\\\templates\\\\loading.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["open-element","h1",[]],["static-attr","class",""],["flush-element"],["text","\\n  Loading...\\n  "],["append",["unknown",["uikit-spinner"]],false],["text","\\n"],["close-element"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const l = n(1).Ember;
            ...
            e.exports = l.HTMLBars.template({
                id: "egTVSUBa",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15692\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-honeyfruit-account-claiming\\\\src\\\\app\\\\templates\\\\account-changes\\\\index.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const l = n(1).Ember;
            ...
            e.exports = l.HTMLBars.template({
                id: "IDXs6QSa",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15692\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-honeyfruit-account-claiming\\\\src\\\\app\\\\templates\\\\components\\\\blank-template.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["yield","default"],["text","\\n"]],"locals":[],"named":[],"yields":["default"],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const l = n(1).Ember;
            ...
            const o = new Set([n.PROMPT, n.CONFIRM_SNOOZE, n.ERROR, n.IN_PROGRESS, n.LINKING_COMPLETE]);
            ...
            var i = a.Ember.Component.extend({
                ...
                isError: a.Ember.computed("honeyfruit.linkingStatus.error", "isLoading", (function() {
                    return !this.get("isLoading") && this.get("honeyfruit.linkingStatus.error") !== o.LinkingStatusError.NO_ERROR
                })),
                isLoading: !1,
                ...
                isLinkingVisible: a.Ember.computed("honeyfruit.linkingStatus.state", (function() {
                    return this.get("honeyfruit.linkingStatus.state") !== o.LinkingState.HIDDEN
                })),
                ...
                actions: {
                    async launchModal(e) {
                        if (!this.get("isDisabled")) try {
                            this.set("isLoading", !0), await this.get("honeyfruit").putAction(o.ActionType.LINK, e), this.set("isLoading", !1)
                        } catch (e) {
                    ...
                    launchModalGarena(e) {
                        if (!this.get("isDisabled")) try {
                            this.set("isLoading", !0), s.default.show(), this.set("isLoading", !1)
                        } catch (e) {
                            this.get("logger").error(`Error launching honeyfruit linking ${e.message}`), this.set("isLoading", !1)
                        }
                    }
                ...
                o = function(e, t) {
                    ...
                    for (var o in e)
                        if ("default" !== o && Object.prototype.hasOwnProperty.call(e, o)) {
                            ...
                            i && (i.get || i.set) ? Object.defineProperty(l, o, i) : l[o] = e[o]
            ...
            t.default = class {
                ...
                _createEmberApp(e) {
                    ...
                    l.emberApplicationFactory.setFactoryDefinition(o.EMBER_APP_NAME, t, {
                        EMBER_CLI_COMPAT: !0
                    }, l.tra);
                    return l.componentFactory.create(o.EMBER_APP_NAME).emberAppInstancePromise
                }
                        ...
                        g = function(e) {
                            e && (d.unobserve(p, g), h().then((async function(e) {
                                ...
                                if (n === o.COMPLETED_SUCCESSFULLY || n === o.SUCCESS);
                                    ...
                                    if (!l && t.reason_code === s.ALREADY_LINKED) m.show();
                                    else {
