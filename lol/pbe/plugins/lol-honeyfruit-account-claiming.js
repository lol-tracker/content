(() => {
  var e = [
      ...
      (e, t, n) => {
        ...
        var l,
          a = n(1),
          o = (l = n(13)) && l.__esModule ? l : { default: l };
        const s = o.default.REVIEW_ACCOUNT_CHANGE_BOXES,
          i = o.default.REVIEW_ACCOUNT_CHANGE_WARNINGS;
        var r = a.Ember.Controller.extend({
            ...
            function () {
              ...
              return t
                ? e
                  ? [
                      this.buildBox(
                        s.PROGRESS_AND_RANKED_HISTORY,
                        i.OVERWRITTEN,
                      ),
                      this.buildBox(s.IDENTITY_AND_FRIENDS, i.OVERWRITTEN),
                      this.buildBox(s.LOOT_INVENTORY, i.OVERWRITTEN),
                    ]
                  : [
                      this.buildBox(s.PROGRESS_AND_RANKED_HISTORY),
                      this.buildBox(s.IDENTITY_AND_FRIENDS),
                      this.buildBox(s.LOOT_INVENTORY),
                      this.buildBox(s.CONTENT),
                      this.buildBox(s.RP_BALANCE),
                      this.buildBox(s.ESSENCE_BALANCES),
                    ]
                : t
                  ? []
                  : e
                    ? [
                        ...
                        this.buildBox(s.IDENTITY_AND_FRIENDS, i.NOT_GUARANTEED),
                        this.buildBox(s.LOOT_INVENTORY, i.OVERWRITTEN),
                      ]
                    : [
                        this.buildBox(s.PROGRESS_AND_RANKED_HISTORY),
            ...
            function () {
              return this.get("hasPlayedAGame")
                ? [
                    this.buildBox(s.RP_BALANCE),
                    this.buildBox(s.ESSENCE_BALANCES),
                    this.buildBox(s.CONTENT, i.POSSIBLE_DUPLICATES),
                  ]
                : [];
            },
          ),
          changedItems: a.Ember.computed(
            ...
            function () {
              return [
                this.buildBox(s.NEW_SEASON_START),
                this.buildBox(s.FRESH_MATCH_HISTORY),
              ];
            },
          ),
        });
      ...
      (e, t, n) => {
        ...
        var l,
          a = n(1),
          o = (l = n(13)) && l.__esModule ? l : { default: l };
        o.default.REVIEW_ACCOUNT_CHANGE_BOXES;
        const s = o.default.REVIEW_ACCOUNT_CHANGE_WARNINGS,
          i = o.default.REVIEW_ACCOUNT_COLUMNS,
          r = {
        ...
        var m = a.Ember.Component.extend({
          ...
          overwritten: a.Ember.computed.equal("warning", s.OVERWRITTEN),
          notGuaranteed: a.Ember.computed.equal("warning", s.NOT_GUARANTEED),
          ...
          buildWarningMessage(e) {
            ...
            switch (l) {
              case s.OVERWRITTEN:
                return t.get(e);
              case s.NOT_GUARANTEED:
                return t.get("label_not_guaranteed");
              case s.POSSIBLE_DUPLICATES:
      ...
      (e, t, n) => {
        ...
        var l,
          ...
          o = (l = n(13)) && l.__esModule ? l : { default: l },
          s = n(19);
        const { MIGRATION_RESULT_CODE: i } = o.default;
        var r = a.Ember.Service.extend({
          accountClaimDetails: null,
          fetchAccountStatus: (e) => (0, s.fetchAccountStatus)(e),
          isAccountMigrated() {
                ...
                n = (l) => {
                  const o =
                    l && l.linking_status
                      ...
                      : null;
                  if (!o) return null;
                  a.dataBinding.unobserve(t, n), e(o);
                };
      ...
      (e, t, n) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.default = void 0);
        var l = n(1);
        const { Service: a, computed: o } = l.Ember,
          { readOnly: s, or: i } = o;
        (function (e, t) {
          const n = e.split(".");
        ...
        const r = a.extend({
          currentRouteName: s("_router.currentRouteName"),
          currentURL: i("_router.currentURL", "_router.url"),
          location: s("_router.location"),
          rootURL: s("_router.rootURL"),
          _router: null,
          transitionTo(...e) {
            let t;
            const n = e[0];
            ...
            const o = e.shift(),
              s = this._router._doTransition(o, e, t, !0);
            return (s._keepDefaultQueryParamValues = !0), s;
          },
          replaceWith() {
      ...
      (e, t, n) => {
        ...
        e.exports = l.HTMLBars.template({
          id: "MhciDdEV",
          block:
            '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15692\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-honeyfruit-account-claiming\\\\src\\\\app\\\\templates\\\\application.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["text","\\n"],["block",["unless"],[["get",["RIOT_PUBLIC"]]],null,0],["text","\\n"],["append",["unknown",["outlet"]],false],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","  "],["append",["unknown",["dev-cheats"]],false],["text","\\n"]],"locals":[]}],"hasPartials":false}',
          meta: {},
        });
      },
      (e, t, n) => {
      ...
      (e, t, n) => {
        ...
        e.exports = l.HTMLBars.template({
          id: "BDKiEeus",
          block:
            '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15692\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-honeyfruit-account-claiming\\\\src\\\\app\\\\templates\\\\loading.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["open-element","h1",[]],["static-attr","class",""],["flush-element"],["text","\\n  Loading...\\n  "],["append",["unknown",["uikit-spinner"]],false],["text","\\n"],["close-element"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
          meta: {},
        });
      },
      (e, t, n) => {
      ...
      (e, t, n) => {
        ...
        e.exports = l.HTMLBars.template({
          id: "egTVSUBa",
          block:
            '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15692\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-honeyfruit-account-claiming\\\\src\\\\app\\\\templates\\\\account-changes\\\\index.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
          meta: {},
        });
      },
      (e, t, n) => {
      ...
      (e, t, n) => {
        ...
        e.exports = l.HTMLBars.template({
          id: "IDXs6QSa",
          block:
            '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15692\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-honeyfruit-account-claiming\\\\src\\\\app\\\\templates\\\\components\\\\blank-template.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["yield","default"],["text","\\n"]],"locals":[],"named":[],"yields":["default"],"blocks":[],"hasPartials":false}',
          meta: {},
        });
      },
      (e, t, n) => {
      ...
      (e, t, n) => {
        ...
        e.exports = l.HTMLBars.template({
          id: "NJtCsbjz",
          block:
            '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15692\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-honeyfruit-account-claiming\\\\src\\\\app\\\\templates\\\\components\\\\next-back-buttons.hbs\\" style-path=\\"null\\" js-path=\\"T:\\\\cid\\\\p4\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15692\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-honeyfruit-account-claiming\\\\src\\\\app\\\\components\\\\next-back-buttons.js\\" "],["text","\\n"],["block",["link-to-button"],[["get",["backRoute"]],["get",["backModel"]]],[["class","disabled"],["back",["get",["backDisabled"]]]],1],["block",["link-to-button"],[["get",["nextRoute"]],["get",["nextModel"]]],[["disabled","class","primary"],[["get",["nextDisabled"]],"next",true]],0]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","  "],["append",["unknown",["tra","button_next"]],false],["text","\\n"]],"locals":[]},{"statements":[["text","  <\\n"]],"locals":[]}],"hasPartials":false}',
          meta: {},
        });
      },
      (e, t, n) => {
      ...
      (e, t, n) => {
        ...
        var l,
          a = n(1),
          o = n(94),
          s = (l = n(93)) && l.__esModule ? l : { default: l };
        n(102);
        var i = a.Ember.Component.extend({
          ...
          isAlreadyLinked: a.Ember.computed("linkingState", function () {
            return this.get("linkingState") === o.LinkingState.LINKED;
          }),
      ...
      (e, t, n) => {
        ...
        t.default = class {
          ...
          _createEmberApp(e) {
            ...
            return l.componentFactory.create(o.EMBER_APP_NAME)
  ...
  (n.r = (e) => {
    ...
    (() => {
      ...
      n(92);
      const { MIGRATION_RESULT_CODE: o, LINKING_STATUS: s } = l.default,
                    ...
                    e &&
                      ...
                      h().then(async function (e) {
                        const { linking_status: t, migration_status: n } = e,
                          l = t && t.eligible;
                        if (n === o.COMPLETED_SUCCESSFULLY || n === o.SUCCESS);
                        else {
                          if (!l && t.reason_code === s.ALREADY_LINKED)
                            m.show();
                          else {
