    ...
    var t = [, t => {
            ...
            const n = {
                ...
                _getValue: function(t, a) {
                    let n;
                    return "function" == typeof a ? (n = a(e), n || console.warn("The function for key " + t + " returned a falsy value: ", n)) : "string" == typeof a ? (n = e.get(a), n || console.warn("The provider `get` invocation for the key " + t + " returned a falsy value: ", n)) : "object" == typeof a && (n = a), n
                },
                add: function(t) {
                    t = t || {};
                    const e = [],
                    ...
                    return Object.keys(t).forEach((function(n) {
                        ...
                        l && l.then ? (l.then((function(t) {
                            t || console.warn("The promise for the key " + n + " resolved with a falsy value: ", t), a._addValue(n, t)
                        })), e.push(l)) : a._addValue(n, l)
                    })), Promise.all(e)
                },
            ...
            class l {
                constructor() {
                    ...
                    this.tra = t.get("rcp-fe-lol-l10n").tra().overlay("/fe/lol-l10n/trans.json").overlay("/fe/lol-match-history/trans.json");
                    const e = a(3);
            ...
            class o {
                ...
                displayMatchSummary(t = {}) {
                    l.Telemetry.startTracingEvent("profile-match-history-rendered"), new Promise((t => {
                        Promise.resolve().then((() => {
                            t(a(4))
                        }).bind(null, a)).catch(a.oe)
                    })).then((e => {
                        const a = !(!t || !t.summonerId) && t.summonerId;
                        e(this._provider, this._traService, a, t.rootElement).then((e => t.matchHistorySection.component = e))
                    }))
                }
                hideMatchSummary(t = {}) {
                    t.matchHistorySection.component && t.rootElement && (t.rootElement.removeChild(t.matchHistorySection.component.domNode), t.matchHistorySection.component.componentPromise.then((t => t.app.destroy())), t.matchHistorySection.component = null)
                }
            }
            ...
            const l = n.Ember.Object.extend(s.DataBindingMixin, s.FixDataBindingMixin, {
                    champions() {
                        return this.retrieveData("api.gameData", "/assets/v1/champion-summary.json").then((t => this._indexEntities(t)))
                    },
                    championsByAlias() {
                        return this.retrieveData("api.gameData", "/assets/v1/champion-summary.json").then((t => t.reduce(((t, e) => t.set(e.alias, e)), n.Ember.Map.create())))
                    },
                    tftChampionsByAlias() {
                        return this.retrieveData("api.gameData", "/assets/v1/tftchampions.json").then((t => t.reduce(((t, e) => e.name ? t.set(e.name.toLowerCase(), e) : t.set(e.character_id.toLowerCase(), e)), n.Ember.Map.create())))
                    },
                    tftTraitsById() {
                        return this.retrieveData("api.gameData", "/assets/v1/tfttraits.json").then((t => t.reduce(((t, e) => t.set(e.trait_id.toLowerCase(), e)), n.Ember.Map.create())))
                    },
                    tftGameVariationsByAlias() {
                        return this.retrieveData("api.gameData", "/assets/v1/tftgamevariations.json").then((t => t.reduce(((t, e) => t.set(e.game_variation_decorated_name.toLowerCase(), e)), n.Ember.Map.create())))
                    },
                    tftSets() {
                        return this.retrieveData("api.gameData", "/assets/v1/tftsets.json").then((t => t.LCTFTModeData.mActiveSets))
                    },
                    tftDefaultSet() {
                        return this.retrieveData("api.gameData", "/assets/v1/tftsets.json").then((t => t.LCTFTModeData.mDefaultSet))
                    },
                    items() {
                        return this.retrieveData("api.gameData", "/assets/v1/items.json").then((t => this._indexEntities(t)))
                    },
                    runes() {
                        return this.retrieveData("api.gameData", "/assets/v1/perks.json").then((t => this._indexEntities(t)), (() => n.Ember.Map.create()))
                    },
                    runesStyles() {
                        return this.retrieveData("api.gameData", "/assets/v1/perkstyles.json").then((t => t.styles ? this._indexEntities(t.styles) : this._indexEntities(t)), (() => n.Ember.Map.create()))
                    },
                    maps() {
                        return this.retrieveData("api.maps", "/v2/maps").then((t => n.Ember.A(t)))
                    },
                    queues() {
                        return this.retrieveData("api.queues", "/v1/queues").then((t => this._indexEntities(t)))
                    },
                    spells() {
                        return this.retrieveData("api.gameData", "/assets/v1/summoner-spells.json").then((t => this._indexEntities(t)))
                    },
                    augments() {
                        return this.retrieveData("api.gameData", "/assets/v1/cherry-augments.json").then((t => this._indexEntities(t)))
                    },
                    tftItems() {
                        return this.retrieveData("api.gameData", "/assets/v1/tftitems.json").then((t => this._indexEntities(t)))
                    },
                    tftItemsByName() {
                        return this.retrieveData("api.gameData", "/assets/v1/tftitems.json").then((t => this._indexEntitiesByName(t)))
                    },
                    _indexEntitiesByName: t => n.Ember.isArray(t) ? t.reduce(((t, e) => t.set(e.nameId, e)), n.Ember.Map.create()) : n.Ember.Map.create(),
                    _indexEntities: t => n.Ember.isArray(t) ? t.reduce(((t, e) => t.set(e.id, e)), n.Ember.Map.create()) : n.Ember.Map.create()
                }),
                i = l.create();
            t.exports = {
                MapsAndGameData: l,
            ...
            const s = (0, n.EmberDataBinding)({
                ...
                l = n.Ember.Mixin.create({
                    retrieveData(t, e, a) {
                        return this.get(t).get(e, a).then((t => t ? Promise.resolve(t) : Promise.reject(void 0)))
                    }
                });
            t.exports = {
            ...
            t.exports = p.extend(s.DataBindingMixin, s.FixDataBindingMixin, l.default, {
                ...
                masteries: u("isThirdPersonView", "targetMasteries", "myMasteries", (function() {
                    let t;
                    return t = this.get("isThirdPersonView") ? this.get("targetMasteries") : this.get("myMasteries"), n.Lodash.keyBy(t, "championId")
                })),
                ...
                _addTftReplayButtons: function() {
                    ...
                    if (0 === t.length) {
                        ...
                        if (e.length > 0) {
                            const a = (Boolean(this.get("thirdPersonAccessibleGameQueues")) ? this.get("thirdPersonAccessibleGameQueues").split(",") : []).map((function(t) {
                            ...
                            this.$(".tft-player-history-accessory-game-action").toArray().forEach(((s, l) => {
                                ...
                                o ? (this.$(s).html(o.domNode), t.push(o)) : n.logger.error("Unable to create replay button for match", i)
                            }))
                        }
                    }
                },
                _addGeneralReplaysButtons: function() {
                    ...
                    if (!(t.length > 0))
                        if (n.Replays.isGeneralReplaysEnabled() && this.get("areAllGeneralMatchesLoaded") && this.get("atLeastOneMatch")) {
                            const e = this.$(".player-history-accessory-game-action").toArray();
                            if (e.length > 0) {
                                const a = this.get("allGeneralMatches"),
                                    s = (Boolean(this.get("thirdPersonAccessibleGameQueues")) ? this.get("thirdPersonAccessibleGameQueues").split(",") : []).map((function(t) {
                                        return parseInt(t, 10)
                                    }));
                                e.forEach(((e, l) => {
                                    const i = a[l];
                                    ...
                                    o ? (this.$(e).html(o.domNode), t.push(o)) : n.logger.error("Unable to create replay button for match", i)
                                }))
                            }
                ...
                destroyReplayButtons() {
                    n.Lodash.forEach(this.get("replayButtons"), (t => t.destroy())), this.get("replayButtons").length = 0, n.Lodash.forEach(this.get("tftReplayButtons"), (t => t.destroy())), this.get("tftReplayButtons").length = 0
                },
                actions: {
                ...
                _updateSummoner() {
                    this.isDestroying || this.isDestroyed || this.get("api.platformConfig").get("v1/namespaces/NewMatchHistory/TftMatchHistoryEnabled").then((t => {
                        null !== t && this.set("isTftMatchHistoryEnabled", t);
                        const e = this.get("puuid");
                        this.get("isTftMatchHistoryEnabled") && e ? this._loadTftPlayerData(e) : this.set("tftMatchesLoading", !1)
                    })).finally((() => {
                ...
                _endOfGameStateObserver: n.Ember.on("init", (function() {
                    (0, n.dataBinding)("/lol-end-of-game", (0, n.getProvider)().getSocket()).observe("/v1/state", this, (t => {
                        t && "BeforeEndOfGame" === t.state && (this.get("generalMatchesLoading") || this.get("isThirdPersonView") || this._loadCurrentPlayerData(this.get("summoner.summonerId"), !0))
                    }))
                })),
                calculateMatchResult: function(t) {
                    const e = n.Lodash.get(t, "participant.win"),
                        a = n.Lodash.get(t, "participant.stats.gameEndedInEarlySurrender"),
                        s = n.Lodash.get(t, "participant.stats.causedEarlySurrender"),
                        l = n.Lodash.get(t, "participant.stats.earlySurrenderAccomplice"),
                        i = n.Lodash.get(t, "participant.stats.teamEarlySurrendered");
                    return a && !s && !l ? g : a && i && s ? f : a && l ? y : e ? _ : "DEFEAT"
                },
                calculateTitleClass: function(t) {
                    const e = "defeat";
                    return t === g ? "earlySurrender" : t === f || t === y ? e : t === _ ? "victory" : e
                },
                calculateMatchResultTitle: function(t) {
                    return t === g ? this.get("tra.MATCH_HISTORY_MATCH_RESULT_REMAKE") : t === f ? this.get("tra.MATCH_HISTORY_MATCH_RESULT_REMAKE_LEAVER") : t === y ? this.get("tra.MATCH_HISTORY_MATCH_RESULT_REMAKE_RESTRICTED") : t === _ ? this.get("tra.MATCH_HISTORY_MATCH_RESULT_VICTORY") : this.get("tra.MATCH_HISTORY_MATCH_RESULT_DEFEAT")
                },
                _formatChampMasteryIpXpDescription(t) {
                    const e = [];
                    return t.champMastery && e.push(t.champMastery), t.ipDelta && e.push(t.ipDelta + " " + this.get("tra.postgame_progress_ip")), t.xpDelta && e.push(t.xpDelta + " " + this.get("tra.postgame_progress_xp")), e.length > 0 ? e.join(" / ") : null
                },
                _enrichSummary(t, e, a, s) {
                    const l = this.calculateMatchResult(t);
                    let r = "";
                    if (t.gameType === o.CUSTOM_GAME_TYPE) r = this.get("tra.MATCH_HISTORY_QUEUE_MODE_CUSTOM");
                    else {
                        const e = a.get(n.Lodash.get(t, "queueId"));
                        r = n.Lodash.get(e, "detailedDescription"), r || (r = n.Lodash.get(e, "description"))
                    }
                    t.titleInfo = {
                        ...
                        creationTime: i.default.formatDate(t.gameCreation, this.get("tra.MATCH_DETAILS_GAME_CREATION_DATE_FORMAT"), this.get("tra"))
                    };
                    ...
                    if (c && c.platformDelta) {
                        ...
                        }), c.champMastery && n.Lodash.assign(t.additionalInfo, {
                            champMastery: c.champMastery.grade
                        });
                        const e = this._formatChampMasteryIpXpDescription(t.additionalInfo);
                        n.Lodash.assign(t.additionalInfo, {
                            champMasteryIpXpDesc: e
                        })
                    }
                    return t
                },
                _loadCurrentPlayerData(t, e = !1) {
                    return d.hashSettled({
                        ...
                        this.get("isDestroyed") || (e || "fulfilled" === t.matchListData.state || "fulfilled" === t.deltas.state ? "fulfilled" === t.deltas.state && this._updateDeltas(t.deltas.value) : 404 === t.matchListData.reason.status || 404 === t.deltas.reason.status ? this.set("generalMatchesLoading", !1) : this.showModal({
                            type: "DialogAlert",
                            data: {
                        ...
                        }), this._updateMatches(t.matchListData.value), t.matchListData.value && t.matchListData.value.platformId && this.set("acsAccountInfo", {
                ...
                _loadTftPlayerData(t, e = !1) {
                    const a = this.get("tftDefaultSet"),
                        n = a ? `/v1/products/tft/${t}/matches?begin=0&count=20&tag=${a.SetCoreName}` : `/v1/products/tft/${t}/matches?begin=0&count=20`;
                    return d.hashSettled({
                        ...
                        if ("fulfilled" !== t.tftMatchListData.state) return e || 404 === t.tftMatchListData.reason.status || this.showModal({
                            type: "DialogAlert",
                            data: {
                                contents: this.get("tra.MATCH_DETAILS_LOADING_ERROR"),
                                okText: this.get("tra.MATCH_DETAILS_LOADING_ERROR_CONFIRMATION"),
                        ...
                        const a = this._enrichTftGames(t.tftMatchListData.value.games);
                        this.set("tftMatches", a), this.set("tftMatchesLoading", !1)
                    }))
                },
                _enrichTftGames(t) {
                    return n.Lodash.forEach(t, (t => {
                        t && t.json && t.json.participants && (this._enrichGameVariation(t), n.Lodash.forEach(t.json.participants, (e => {
                            this._enrichUnits(e), this._enrichTraits(t, e), this._enrichAugments(e)
                        })))
                    })), t
                },
                _enrichUnits(t) {
                    ...
                    n.Lodash.forEach(t.units, (t => {
                        ...
                        if (l) l.character_record ? (t.iconPath = l.character_record.squareIconPath, t.championName = l.character_record.display_name) : (t.iconPath = l.squareIconPath, t.championName = l.display_name);
                        else {
                            const e = t.name.replace("TFT_", "").replace("TFT2_", "");
                            l = s.get(e), l ? (t.iconPath = l.squarePortraitPath, t.championName = l.name) : n.logger.trace("Unknown champion: " + t)
                        }
                        n.Lodash.forEach(t.itemNames, (e => {
                            const s = a.get(e);
                            s && (t.equippedItems || (t.equippedItems = n.Ember.A([])), t.equippedItems.pushObject(s))
                        }))
                    })), t.units.sort(((t, e) => t.tier > e.tier ? -1 : t.tier < e.tier ? 1 : t.itemNames && (!e.itemNames || t.itemNames.length > e.itemNames.length) ? -1 : e.itemNames && (!t.itemNames || t.itemNames.length < e.itemNames.length) ? 1 : t.rarity > e.rarity ? -1 : t.rarity < e.rarity ? 1 : t.name.localeCompare(e.name)))
                },
                _enrichTraits(t, e) {
                    const a = this.get("tftTraitsById");
                    "object" == typeof e.traits && e.traits.length && (n.Lodash.forEach(e.traits, (e => {
                        if ("object" == typeof e) {
                            const n = a.get(e.name.toLowerCase());
                            n && (e.name = n.display_name, e.iconPath = n.icon_path), t.metadata.data_version >= 3 ? e.rank = e.style : e.tier_current === e.tier_total ? e.rank = 3 : 0 === e.tier_current ? e.rank = 0 : 1 === e.tier_current ? e.rank = 1 : e.rank = 2
                        }
                    })), e.traits.sort(((t, e) => t.rank === e.rank ? 0 : t.rank > e.rank ? -1 : t.rank < e.rank ? 1 : t.name.localeCompare(e.name))))
                },
                _enrichAugments(t) {
                    if (t.augments) {
                ...
                _enrichGameVariation(t) {
                    ...
                    a && (t.json.gameVariation = {}, t.json.gameVariation.displayName = a.game_variation_display_name, t.json.gameVariation.iconPath = a.icon_path, t.json.gameVariation.description = a.game_variation_description)
                },
                _loadFriendData() {
                    return d.hash({
                        ...
                        this._updateMatches(t.matchListData), this.set("acsAccountInfo", {
                            platformId: t.matchListData.platformId,
                            accountId: t.matchListData.accountId
                        }), this._updateMatchTypeSubnavigation(), this.set("generalMatchesLoading", !1)
                    }), (t => {
                        n.logger.error(`Could not load your friend data because of ${JSON.stringify(t)}`), 404 !== t.status ? this.showModal({
                            type: "DialogAlert",
                            data: {
                                contents: this.get("tra.MATCH_DETAILS_LOADING_ERROR"),
                                okText: this.get("tra.MATCH_DETAILS_LOADING_ERROR_CONFIRMATION"),
                ...
                _updateDeltas(t) {
                    const e = n.Lodash.get(t, "deltas", []).reduce(((t, e) => t.set(e.gameId, e)), new Map);
                    this.set("deltas", e), n.logger.trace(`Setting deltas to ${JSON.stringify(e)}`)
                },
                _updateMatches(t) {
                    const e = this.get("maps"),
                        ...
                        i = r.default.create({
                            games: l
                        }).get("matchSummaries").map((t => this._enrichSummary(t, e, a, s)));
                ...
                _updateGoldEarned() {
                    this.get("allGeneralMatches").forEach((t => {
                        const {
                            goldEarned: e
                        } = t.participant, a = this.get("tra.metadata.locale.id");
            ...
            t.exports = n.Ember.Mixin.create({
                ...
                showModal: function(t) {
                    ...
                    return n.Ember.get(e, "data.onOk") && e.okPromise ? e.okPromise.then(t.data.onOk) : e.acceptPromise && e.acceptPromise.then((() => {
            ...
            var i = s.Ember.Object.extend({
                ...
                init() {
                    ...
                    const t = arguments[0];
                    this.set("gameId", t.gameId), this.set("gameCreation", t.gameCreation), this.set("gameDuration", t.gameDuration), this.set("queueId", t.queueId), this.set("mapId", t.mapId), this.set("seasonId", t.seasonId), this.set("gameVersion", t.gameVersion), this.set("gameMode", t.gameMode), this.set("gameType", t.gameType);
                    const e = new l.default(t.participants[0], t.participantIdentities[0]);
            ...
            var l = n.Ember.Object.extend({
                ...
                init() {
                    if (this._super(this, arguments), 2 === arguments.length && arguments[0] && arguments[1]) {
                        const [t, e] = arguments;
                        this.set("puuid", t.puuid), this.set("participantId", t.participantId), this.set("teamId", t.teamId), this.set("championId", t.championId), this.set("spell1Id", t.spell1Id), this.set("spell2Id", t.spell2Id), this.set("highestAchievedSeasontier", t.highestAchievedSeasontier), this.set("player", e.player);
            ...
            t.exports = n.Ember.Component.extend({
                ...
                champRoles: n.Ember.computed("matches", (function() {
                    ...
                    return t.forEach((t => {
                        const {
                            championId: a
                        } = t.participant, s = this.get("champions").get(a);
                        s ? e[s.roles[0]] ? e[s.roles[0]]++ : e[s.roles[0]] = 1 : n.logger.error("Cannot find champ summary for id " + a)
                    })), e
                })),
                recentlyPlayedChamps: n.Ember.computed("masteries", "matches", "champions", "areAllMatchesLoaded", "atLeastOneMatch", (function() {
                    ...
                    if (t && 0 !== t.length) {
                        ...
                        const o = (0, n.Lodash)(l).orderBy(["count"], ["desc"]).take(3).map((e => {
                        ...
                        return o.map((t => t.mastery ? {
                            ...t,
                            championName: t.name,
                            roleTitle: i.default.roleTitle([t, this.get("tra")]),
                            score: i.default.scoreDisplay([t, this.get("finalPointDrivenLevel"), this.get("tra")]),
                ...
                recentlyPlayedChampsBottomLabel: n.Ember.computed("matches", (function() {
                    const t = this.get("matches");
                    return t && t.length > 0 ? this.get("tra.MATCH_HISTORY_SUMMARY_PERCENTAGE_OF_GAME_PLAYED_LABEL") : this.get("tra.MATCH_HISTORY_SUMMARY_GO_PLAY_SOME_GAMES_LABEL")
                })),
                tooltipConfig: {
                    targetAnchor: {
                        x: "center",
            ...
            function i(t) {
                const [e] = t;
                if (e.mastery) return Math.round(e.mastery.championPointsSinceLastLevel / (e.mastery.championPointsSinceLastLevel + e.mastery.championPointsUntilNextLevel) * 100)
            }
                        ...
                        if (t && t.gameId) {
                            ...
                            this.get("isThirdPersonView") ? n.MatchApi.displayMatchDetails({
                                ...
                                closeModalCallback: t => {
                                    this.isDestroying || this.isDestroyed || this.element.dispatchEvent(new Event(t, {
                                        bubbles: !0
                                    }))
                                }
            ...
            t.exports = n.Ember.Component.extend({
                ...
                matchLength: n.Ember.computed("matchData.game_length", "matchData.game_datetime", (function() {
                    const t = this.get("matchData.game_length"),
                        ...
                        n = ~~t % 60;
                    let s = "";
                    return e > 0 && (s += e + ":" + (a < 10 ? "0" : "")), s += a + ":" + (n < 10 ? "0" : ""), s += "" + n, s
                })),
                ...
                matchCompanion: n.Ember.computed("companions", "currentPlayer.companion.content_ID", (function() {
                    ...
                    if (!t || !e) return null;
                    let a;
                    return t.groups.every((t => t.items.every((t => t.contentId === e ? (a = [t], !1) : (a = t.upgrades.filter((function(t) {
            ...
            var i = n.Ember.Component.extend({
                ...
                tooltipSetup() {
                    ...
                    if (this.tooltipHoverElement = this.element.parentElement, !t && this.tooltipHoverElement) {
                        const t = this.get("tooltipId");
                        this.tooltipElement = this.element.querySelector(`#match-history-tooltip-${t}`), this.attachTooltip(), this.toolTipAttached = !0
                    }
                },
                didInsertElement() {
                ...
                attachTooltip: function() {
                    ...
                    n.TooltipManager.assign(this.tooltipHoverElement, this.tooltipElement, null, t)
                },
            ...
            function e(t) {
                const a = {};
                for (const n in t) "object" == typeof t[n] ? a[n] = e(t[n]) : a[n] = t[n];
                return a
            }
            ...
            function a(t, e, a) {
                ...
                if ((a = a.get("metadata." + e)) && "region" === e && a.id !== s.id) {
                    const e = n[a.id],
                        s = e.defaultLocale ? e.defaultLocale.id : e.availableLocales[0].id;
                    t.setLocale(s, a.id)
            ...
            t.exports = function(t, n, s) {
                ...
                return n = n.observe((() => {
                    if (l) {
                        ...
                        l.set("metadata", t), l.beginPropertyChanges(), Object.keys(i).forEach((t => {
            ...
            class i {
                constructor(t, e) {
                    ...
                    const a = e.overlay("/fe/lol-l10n/trans.json").overlay("/fe/lol-shared-components/trans.json"),
                        n = (0, s.default)(l.Ember, a);
                    this._tra = a, this._traService = n, this._provider = t
                }
                displayMatchDetails(t) {
                    this._matchDetailsApi ? this._matchDetailsApi.showMatchDetails(t) : this._initMatchDetailsApi((e => e.showMatchDetails(t)))
                }
                hideMatchDetails() {
                    this._matchDetailsApi && this._matchDetailsApi.hideMatchDetails()
                }
                _initMatchDetailsApi(t) {
                    if (this._matchDetailsApi) return t && t(this._matchDetailsApi), this._matchDetailsApi;
                    new Promise((t => {
                        Promise.resolve().then((() => {
                            t(a(43))
                        }).bind(null, a)).catch(a.oe)
                    })).then((e => {
                        this._matchDetailsApi = new e(this._provider, this._traService), t(this._matchDetailsApi)
                    }))
                }
            }
            let o;
            ...
            t.exports = class {
                constructor(t, e) {
                    s.logger.trace("Creating Match Details Ember application"), u || function(t, e) {
                        r = s.Viewport.overlay().getScreenRoot("rcp-fe-lol-match-details-overlay"), d = r.getElement(), h = document.createElement("lol-uikit-full-page-modal"), h.className = "rcp-fe-lol-match-details-overlay-content", d.appendChild(h), h.addEventListener("closeButtonClick", f), h.addEventListener("closeMatchDetailModalOnly", y), s.EmberApplicationFactory.setFactoryDefinition({
                            ...
                            e && "rcp-fe-lol-match-details-overlay" === e.name && p && s.Lodash.isFunction(p) && !g && (p("closeButtonClick"), g = !0)
                ...
                showMatchDetails(t) {
                    this.hideMatchDetails(),
                        function(t) {
                            let e = !1;
                            t.closeModalCallback && s.Lodash.isFunction(t.closeModalCallback) ? (p = t.closeModalCallback, e = !0) : p = null;
                            g = !1;
                            ...
                            s.Ember.RSVP.hash({
                                ...
                                s.logger.trace(`Displaying match details for gameId ${t.gameId} and summoner ${t.summonerId}`), c && (h.removeChild(h.childNodes[0]), c.componentPromise.then((function(t) {
                                    t.app.destroy()
                                }))), m = {
                                    dataSource: d,
            ...
            var n = a(1),
                s = n.Ember.Service.extend({
                    ...
                    reportedPlayerObserver: n.Ember.observer("gameId", (function() {
                        ...
                        t && (this.playerReportSenderBinding.removeObserver(this.get("playerReportSenderBasePath"), this), this.playerReportSenderBinding.observe(`/v1/reported-players/gameId/${t}`, this, this.handleReportedPlayersUpdate))
                    })),
            ...
            t.exports = n.Ember.Component.extend(c, i.DataBindingMixin, i.FixDataBindingMixin, l.default, {
                ...
                getNameFallback(t, e) {
                    return void 0 === t || "" === t ? this.get("tra.MATCH_DETAILS_SUMMONER_NAME") + e : t
                },
                loadData() {
                    ...
                    const a = this.retrieveData("api.matchHistory", `/v1/games/${t}`),
                        l = this.retrieveData("api.matchHistory", `/v1/game-timelines/${t}`);
                    return n.Ember.RSVP.hashSettled({
                        ...
                        if (e.participants && e.participantIdentities && (e.participantIdentities.forEach(((t, a) => {
                                const {
                                    summonerName: n,
                                    gameName: s,
                                    tagLine: l
                                ...
                                i = s && l ? this.get("_playerNames")?.formatPlayerName({
                                    ...
                                    gameName: s,
                                    tagLine: l
                                })?.playerName : n, e.participantIdentities[a].player.displayName = i
                            })), e.participants = e.participants.map((t => {
                                const a = n.Lodash.find(e.participantIdentities, (e => e.participantId === t.participantId));
                                return a.player.summonerName = this.getNameFallback(a.player.summonerName, t.participantId), a.player.displayName = this.getNameFallback(a.player.displayName, t.participantId), n.Lodash.set(a.player, "participantId", a.participantId), new s.default(t, a)
                            }))), this.get("baseSummonerId")) {
                            const t = n.Lodash.find(e.participants, (t => t.player.summonerId === this.get("baseSummonerId")));
                            e.participants = n.Lodash.sortBy(e.participants, ["teamId", function(e) {
                                return e.player.summonerId === t.player.summonerId ? -1 : 0
                            }]), this.set("baseCurrentParticipant", t)
                        }
                        this.set("baseGameData", e), "fulfilled" === t.gameTimeline.state ? this.set("baseGameTimeline", t.gameTimeline.value) : this.set("baseGameTimeline", null), this.set("isLoading", !1)
                    }), (t => {
                        404 !== t.status && (n.logger.error("Could not load match details data", t), this.showModal({
                            type: "DialogAlert",
                            data: {
                                contents: this.get("tra.MATCH_DETAILS_LOADING_ERROR"),
                                okText: this.get("tra.MATCH_DETAILS_LOADING_ERROR_CONFIRMATION"),
                ...
                addNavigationListenersOnInserted: n.Ember.on("didInsertElement", (function() {
                    this.$("lol-uikit-navigation-bar").get(0).addEventListener("lol-uikit-navigation-item-attr-set-event", (t => {
                ...
                displaySections: n.Ember.computed("tra.metadata", "sections.@each.sectionName", "currentSelectedSectionName", "matchHistoryConfig", "isGameModeWithSubteams", "subteamGameModeData", (function() {
                    ...
                    this.get("isGameModeWithSubteams") && (l = this.get("subteamGameModeData")[i].disabledSections), t = n.Lodash.sortBy(t, ["priority"]);
                    let o = !1;
                    return t.forEach((t => {
                        ...
                        m && (o = !0), i.set("name", t.sectionName), i.set("displayName", this.get(`tra.${t.locKey}`)), i.set("selected", m), i.set("disabled", !t.enabled || r), i.set("display", (t.display || !c) && !p), s.push(i)
                ...
                showSection: function(t) {
                    this.get("currentSelectedSectionName") === t || this.get("isTransitioning") || (this.set("currentSelectedSectionName", t), this.set("isTransitioning", !0))
                }
            })
        }, (t, e) => {
            "use strict";
            ...
            var n = a(1),
                s = a(6),
                l = a(5);
            a(50), t.exports = n.Ember.Component.extend(s.DataBindingMixin, {
                layout: a(51),
                ...
                map: n.Ember.computed("maps", "gameData.mapId", "gameData.gameMode", (function() {
                    ...
                    return t || n.Lodash.find(this.get("maps"), {
                        id: l.DEFAULT_MAP_ID
                    })
                })),
                createdAt: n.Ember.computed("gameData", "tra.MATCH_DETAILS_GAME_CREATION_DATE_FORMAT", (function() {
                    ...
                    return (0, n.moment)(new Date(t)).format(this.get("tra.MATCH_DETAILS_GAME_CREATION_DATE_FORMAT"))
                })),
                ...
                type: n.Ember.computed("gameData.gameType", "gameData.queueId", "queues", "tra.MATCH_HISTORY_QUEUE_MODE_CUSTOM", (function() {
                    ...
                    return t ? t.detailedDescription ? t.detailedDescription : t.description : ""
                })),
                outcome: n.Ember.computed("currentParticipant.win", "tra.postgame_progress_victory", "tra.postgame_progress_defeat", "tra.MATCH_HISTORY_MATCH_RESULT_REMAKE", "currentParticipant.stats.gameEndedInEarlySurrender", (function() {
                    ...
                    return this.get("currentParticipant.stats.gameEndedInEarlySurrender") ? this.get("tra.MATCH_HISTORY_MATCH_RESULT_REMAKE") : this.get("tra." + (t ? "postgame_progress_victory" : "postgame_progress_defeat"))
                })),
                mapIcon: n.Ember.computed("currentParticipant.win", "gameData.mapId", "animationDisabled", (function() {
                    const t = this.get("map");
                    return this.get("animationDisabled") ? this.get("currentParticipant.win") ? n.Lodash.get(t, "assets.icon-victory") : n.Lodash.get(t, "assets.icon-defeat") : this.get("currentParticipant.win") ? n.Lodash.get(t, "assets.icon-victory-video") : n.Lodash.get(t, "assets.icon-defeat-video")
                })),
                isThirdPersonView: !1,
                ...
                whitelistedQueueIds: n.Ember.computed("thirdPersonAccessibleGameQueues", (function() {
                    return n.Ember.A((this.get("thirdPersonAccessibleGameQueues") || "").split(",").map((function(t) {
                        return parseInt(t, 10)
                    })))
                })),
                replayButton: null,
                shouldShowReplayButton: n.Ember.computed("gameData", "isThirdPersonView", "whitelistedQueueIds", (function() {
                    ...
                    return !(!t || !n.Replays.isGeneralReplaysEnabled()) && (!(this.get("isThirdPersonView") && !this.get("whitelistedQueueIds").includes(t.queueId)) || (n.logger.trace("Queue id for this game is not whitelisted, not adding replay button"), !1))
                })),
                ...
                _addReplayButton: n.Ember.observer("shouldShowReplayButton", (function() {
                    ...
                    const t = this.element ? this.element.querySelector(".match-layer-header-replay") : null;
                    if (!t) return;
            ...
            const i = ["DARKSTAR", "STARGUARDIAN"],
                o = n.Ember.Component.extend({
                    ...
                    hasTimelineData: n.Ember.computed("gameTimeline", (function() {
                        ...
                        return t.frames && t.frames.length > 0 && !this.shouldSkipTimelineData()
                    })),
                    ...
                    actions: {
                        selectTimelineChart: function(t) {
                            this.set("displayed.teamGoldAdvantage", !1), this.set("displayed.teamGold", !1), this.set("displayed.championGold", !1), this.set("displayed." + t, !0), this.set("displayedChart", t)
                        }
                    },
                    didInsertElement: function() {
                        const t = n.Ember.$(this.element).find(".match-details-overview-container")[0];
            ...
            function c(t, e) {
                const a = {};
                return n.Lodash.each(t.participants, (t => {
            ...
            function m(t, e, a, s) {
                const l = n.Lodash.filter(t.participantIdentities, (t => t.player.currentAccountId === a))[0],
                    i = c(t, s);
                return {
                    participants: i,
            ...
            function d(t, e, a, s) {
                ...
                const m = t.filter((t => !!n.Lodash.includes(l.default.RELEVANT_EVENT_TYPES, t.type) && (t.type !== l.default.CHAMP_KILL_EVENT_TYPE || 0 !== t.victimId))),
                ...
                n.Lodash.each(m, (t => {
                    ...
                    switch (t.type) {
                        ...
                        case l.default.ELITE_MONSTER_KILL_TYPE:
                            ...
                            o[s] = f(o[s], h, l.default.OBJECTIVE_GREATENESS_MAP), t.monsterSubType && l.default.OBJECTIVE_TYPE_DISPLAY_MAP[t.monsterSubType] && (h = l.default.OBJECTIVE_TYPE_DISPLAY_MAP[t.monsterSubType]), r.push({
                                isChampion: !1,
                                class: `${h}-${s}`
                            })
                    }
                }));
                const d = n.Lodash.reduce(i, ((t, e, a) => (e > 0 && t.push({
                        teamId: a,
                        count: e
                    }), t)), []),
                    h = n.Lodash.reduce(o, ((t, e, a) => (e && t.push({
                        teamId: a,
                        objective: e
                    }), t)), []);
                return c = n.Lodash.fromPairs(n.Lodash.map(c, ((t, a) => [a, {
            ...
            function h(t, e) {
                ...
                const a = [],
                    s = n.Lodash.reduce(t.participantFrames, ((t, n) => {
                        const {
                            teamId: s
                        } = e[n.participantId];
                        return t.teamGolds[s] || (t.teamGolds[s] = 0, a.push(s)), t.championGolds[n.participantId] = n.totalGold, t.teamGolds[s] += n.totalGold, t
                    }), {
                        teamGolds: {},
                        championGolds: {}
                    });
            ...
            function u(t, e) {
                switch (t.type) {
                    ...
                    default:
                        return n.logger.warning("Cannot infer teamId from event: ", t), -1
                }
            }
            ...
            const i = a(58),
                ...
                r = n.Ember.Component.extend({
                    ...
                    draw: function(t, e) {
                        ...
                        h.append("svg:g").attr("class", "match-details-timeline-axis-y").attr("transform", _(r.margin.left, r.margin.top)).call(r.axis.y).selectAll("g").filter((t => 0 === t)).classed("zero-line", !0), h.append("svg:g").attr("class", "match-details-timeline-axis-x").attr("transform", _(r.margin.left, r.innerH + r.margin.top)).call(r.axis.x);
                        ...
                        u.append("svg:line").attr("class", "vertical-rule-sync").attr("y1", 0).attr("y2", r.innerH + r.margin.bottom).style("display", "none"), u.on("mouseover", (() => n.d3.selectAll(".vertical-rule-sync").style("display", "block"))).on("mouseout", (() => n.d3.selectAll(".vertical-rule-sync").style("display", "none"))).on("mousemove", (function() {
                            ...
                            n.d3.selectAll(".vertical-rule-sync").attr("x1", t).attr("x2", t)
                        })), u.append("svg:rect").attr("width", r.innerW).attr("height", r.innerH + r.margin.bottom).attr("class", "background-rect"), o[e]({
                            chartSvg: u,
                            outerSvg: h,
                            chart: r,
                            data: a,
                    ...
                    createTooltip: function() {
                        ...
                        n.Lodash.each(t, (t => {
                            n.TooltipManager.assign(t, i({
                                text: t.attributes.tooltip.value
                            }), {}, {
                                targetAnchor: {
                                    x: "center",
                                    y: "top"
                    ...
                    didInsertElement: function() {
                        ...
                        if (t) {
                            ...
                            let s = n.Lodash.sortBy(t.participants, (function(t) {
                                ...
                                l = 1;
                            s = n.Lodash.keyBy(s, (() => l++)), this.set("chartData.participants", s), this.draw(t, this.get("chartType"))
                        }
                    }
                });
            ...
            function c(t, e, a, s, l) {
                const i = a.width,
                    ...
                    m = i - r.left - r.right;
                let p, d = 0;
                if ("teamGoldAdvantage" === e) p = Math.max(n.d3.max(t, (t => t.gold)), Math.abs(n.d3.min(t, (t => t.gold)))), d = -p;
                else if ("teamGold" === e) {
                    const e = t[t.length - 1];
                    p = n.Lodash.max(n.Lodash.values(n.Lodash.omit(e, "timestamp")))
                } else "championGold" === e && (p = n.Lodash.max(n.Lodash.values(t[t.length - 1].champions)));
                p = 1e3 * Math.ceil(p / 1e3), d = 1e3 * Math.floor(d / 1e3);
                const h = n.d3.scale.linear().range([0, m]).domain([0, t[t.length - 1].timestamp]),
                    ...
                    f = n.d3.svg.axis().scale(u).orient("left").tickSize(-m).tickPadding(a.tickPadding.y).tickFormat((t => {
            ...
            function m(t) {
                const {
                    ...
                    blue: o,
                    red: r
                } = t, c = u(s), m = e.append("svg:g");
                m.selectAll("line").data(c).enter().append("line").attr("class", (t => 0 === t.y1 && 0 === t.y2 ? "data-line data-stroke-even" : t.y1 > 0 || t.y2 > 0 ? "data-line data-stroke-100" : "data-line data-stroke-200")).attr("x1", (t => a.scale.x(t.x1))).attr("y1", a.scale.y(0)).attr("x2", (t => a.scale.x(t.x2))).attr("y2", a.scale.y(0)), m.selectAll("line").data(c).transition().delay(200).duration(430).ease("cubic-out").attr("y1", (t => a.scale.y(t.y1))).attr("y2", (t => a.scale.y(t.y2)));
                const p = n.d3.svg.area().interpolate("linear").x((t => a.scale.x(t.x))).y0(a.scale.y(0)).y1((t => a.scale.y(t.y))),
                    d = n.d3.svg.area().interpolate("linear").x((t => a.scale.x(t.x))).y0(a.scale.y(0)).y1(a.scale.y(0)),
                    h = g(c),
                    y = e.append("svg:g");
                y.selectAll("path").data(h).enter().append("path").attr("class", (t => "data-area data-fill-" + t.teamId)).attr("d", (t => d(t.data))), y.selectAll("path").data(h).transition().delay(200).duration(430).ease("cubic-out").attr("d", (t => p(t.data)));
                const _ = e.append("svg:g");
                _.selectAll(".timeline-data-point").data(s).enter().append("circle").attr("class", (t => t.gold > 0 ? "timeline-data-point data-fill-100" : t.gold < 0 ? "timeline-data-point data-fill-200" : "timeline-data-point data-fill-even")).attr("cx", (t => a.scale.x(t.timestamp))).attr("cy", a.scale.y(0)).attr("r", (() => a.pointRarius)).attr("tooltip", (t => f(t, l, i, t.gold > 0 ? o : r))), _.selectAll(".timeline-data-point").data(s).transition().delay(200).duration(430).ease("cubic-out").attr("cy", (t => a.scale.y(t.gold)))
            }
            ...
            function p(t) {
                ...
                n.Lodash.each([100, 200], (t => {
                    const r = n.d3.svg.line().x((t => a.scale.x(t.timestamp))).y((e => a.scale.y(e[t]))).interpolate("linear");
                    e.append("svg:g").selectAll(".data-line").data([s]).enter().append("svg:path").attr("class", "data-line data-stroke-" + (t === o ? "100" : "200")).attr("d", r(s)), e.append("svg:g").selectAll(".timeline-data-point").data(s).enter().append("svg:circle").attr("class", "timeline-data-point data-fill-" + (t === o ? "100" : "200")).attr("cx", (t => a.scale.x(t.timestamp))).attr("cy", (e => a.scale.y(e[t]))).attr("r", (() => a.pointRarius)).attr("tooltip", (e => y(e[t], e.timestamp, l, i)))
                }))
            }
            ...
            function d(t) {
                ...
                n.Lodash.each(r, (t => {
                    const o = t.participantId + "" === s.ownerId,
                        ...
                        c = o ? "" : "none",
                        m = e.append("svg:g").attr("class", "data-champ-gold-" + t.participantId).style("display", c).selectAll(".data-champ-gold"),
                        p = n.d3.svg.line().x((t => a.scale.x(t.timestamp))).y((e => a.scale.y(e.champions[t.participantId]))).interpolate("linear");
                    m.data([s]).enter().append("svg:path").attr("class", `data-line data-stroke-${r}`).attr("d", p(s)), m.data(s).enter().append("svg:circle").attr("class", `timeline-data-point data-fill-${r}`).attr("cx", (t => a.scale.x(t.timestamp))).attr("cy", (e => a.scale.y(e.champions[t.participantId]))).attr("r", (() => a.pointRarius)).attr("tooltip", (e => y(e.champions[t.participantId], e.timestamp, l, i)));
                    ...
                    f.classList.add("champ-gold-toggle-img"), f.src = t.imgSrc, g.appendChild(f), h.appendChild(g), g.addEventListener("click", (() => {
            ...
            function h(t) {
                let e = 100;
                return n.Lodash.each(t.participants, (a => {
                    a.participantId + "" === t.ownerId && (e = a.teamId)
                })), e
            }

            function u(t) {
                return n.Lodash.reduce(t, ((e, a, n) => {
                    const s = t[n + 1];
                    if (s)
                        if (a.gold * s.gold < 0) {
                            const t = a.timestamp + Math.abs((s.timestamp - a.timestamp) * a.gold / (s.gold - a.gold));
                            e.push({
                                x1: a.timestamp,
                                y1: a.gold,
                                x2: t,
            ...
            function g(t) {
                if (t.length) {
                    ...
                    return n.Lodash.reduce(t, ((t, e) => {
                        const a = {
                            x: e.x2,
                            y: e.y2
                        };
                        return a.y >= 0 && t[0].data.push(a), a.y <= 0 && t[1].data.push(a), t
                    }), [{
                        teamId: 100,
                        data: [e]
                    }, {
            ...
            function f(t, e, a, s) {
                ...
                return 0 === t.gold ? e("MATCH_HISTORY_OVERVIEW_TIMELINE_GOLD_ADVANTAGE_TOOLTIP_EVEN", {
                    time: i
                }) : e("MATCH_HISTORY_OVERVIEW_TIMELINE_GOLD_ADVANTAGE_TOOLTIP_AHEAD", {
                    team: s,
            ...
            t.exports = (n.default || n).template({
                ...
                main: function(t, e, a, n, s) {
                    var l;
                    return '<lol-uikit-tooltip>\r\n  <div class="match-details-timeline-tooltip">\r\n    <span class="match-details-timeline-tooltip-text">' + t.escapeExpression("function" == typeof(l = null != (l = a.text || (null != e ? e.text : e)) ? l : a.helperMissing) ? l.call(null != e ? e : t.nullContext || {}, {
                        name: "text",
                        hash: {},
                        data: s
                    }) : l) + "</span>\r\n  </div>\r\n</lol-uikit-tooltip>"
            ...
            function p() {
                ...
                return r.extend(t, l), t.SafeString = i.default, t.Exception = o.default, t.Utils = r, t.escapeExpression = r.escapeExpression, t.VM = c, t.template = function(e) {
                    return c.template(e, t)
                }, t
            }
            var d = p();
            d.create = p, m.default(d), d.default = d, e.default = d, t.exports = e.default
        }, (t, e, a) => {
            "use strict";
            ...
            function m(t, e, a) {
                this.helpers = t || {}, this.partials = e || {}, this.decorators = a || {}, i.registerDefaultHelpers(this), o.registerDefaultDecorators(this)
            }
            m.prototype = {
                constructor: m,
                logger: r.default,
                ...
                registerHelper: function(t, e) {
                    if (s.toString.call(t) === c) {
                        if (e) throw new l.default("Arg not supported with multiple helpers");
                ...
                registerPartial: function(t, e) {
                    if (s.toString.call(t) === c) s.extend(this.partials, t);
                        ...
                        if (void 0 === e) throw new l.default('Attempting to register a partial called "' + t + '" as undefined');
                        this.partials[t] = e
                    }
                },
                ...
                registerDecorator: function(t, e) {
                    if (s.toString.call(t) === c) {
                        if (e) throw new l.default("Arg not supported with multiple decorators");
            ...
            function i(t) {
                for (var e = 1; e < arguments.length; e++)
                    for (var a in arguments[e]) Object.prototype.hasOwnProperty.call(arguments[e], a) && (t[a] = arguments[e][a]);
                return t
            }
            ...
            function n(t, e) {
                ...
                for (var o = Error.prototype.constructor.call(this, t), r = 0; r < a.length; r++) this[a[r]] = o[a[r]];
            ...
            e.__esModule = !0, e.registerDefaultHelpers = function(t) {
                s.default(t), l.default(t), i.default(t), o.default(t), r.default(t), c.default(t), m.default(t)
            };
            var s = n(a(65)),
                l = n(a(66)),
                i = n(a(67)),
            ...
            e.default = function(t) {
                t.registerHelper("blockHelperMissing", (function(e, a) {
                    ...
                    if (n.isArray(e)) return e.length > 0 ? (a.ids && (a.ids = [a.name]), t.helpers.each(e, a)) : s(this);
                    if (a.data && a.ids) {
            ...
            e.default = function(t) {
                t.registerHelper("each", (function(t, e) {
                    ...
                    function m(e, n, l) {
                        r && (r.key = e, r.index = n, r.first = 0 === n, r.last = !!l, c && (r.contextPath = c + e)), o += a(t[e], {
                            data: r,
                            blockParams: s.blockParams([t[e], e], [c + e, null])
                        })
                    }
                    if (e.data && e.ids && (c = s.appendContextPath(e.data.contextPath, e.ids[0]) + "."), s.isFunction(t) && (t = t.call(this)), e.data && (r = s.createFrame(e.data)), t && "object" == typeof t)
                        if (s.isArray(t))
                            for (var p = t.length; l < p; l++) l in t && m(l, l, l === t.length - 1);
                        else {
                            var d = void 0;
                            for (var h in t) t.hasOwnProperty(h) && (void 0 !== d && m(d, l - 1), d = h, l++);
                            void 0 !== d && m(d, l - 1, !0)
            ...
            e.__esModule = !0, e.default = function(t) {
                t.registerHelper("log", (function() {
                    for (var e = [void 0], a = arguments[arguments.length - 1], n = 0; n < arguments.length - 1; n++) e.push(arguments[n]);
                    var s = 1;
                    null != a.hash.level ? s = a.hash.level : a.data && null != a.data.level && (s = a.data.level), e[0] = s, t.log.apply(t, e)
                }))
            }, t.exports = e.default
        }, (t, e) => {
            "use strict";
            ...
            e.default = function(t) {
                t.registerHelper("with", (function(t, e) {
                    ...
                    var s = e.data;
                    return e.data && e.ids && ((s = n.createFrame(e.data)).contextPath = n.appendContextPath(e.data.contextPath, e.ids[0])), a(t, {
                        data: s,
            ...
            e.default = function(t) {
                t.registerDecorator("inline", (function(t, e, a, s) {
                    var l = t;
                    return e.partials || (e.partials = {}, l = function(s, l) {
                        var i = a.partials;
                        a.partials = n.extend({}, i, e.partials);
                        var o = t(s, l);
                        return a.partials = i, o
                    }), e.partials[s.args[0]] = s.fn, l
                }))
            }, t.exports = e.default
        }, (t, e, a) => {
            "use strict";
            ...
            e.__esModule = !0, e.checkRevision = function(t) {
                ...
                var a = {
                    ...
                    invokePartial: function(a, n, l) {
                        l.hash && (n = s.extend({}, n, l.hash), l.ids && (l.ids[0] = !0)), a = e.VM.resolvePartial.call(this, a, n, l);
                        var o = e.VM.invokePartial.call(this, a, n, l);
                        if (null == o && e.compile && (l.partials[l.name] = e.compile(a, t.compilerOptions, e), o = l.partials[l.name](n, l)), null != o) {
                            if (l.indent) {
                    ...
                    program: function(t, e, a, n, s) {
                        var l = this.programs[t],
                            i = this.fn(t);
                        return e || s || n || a ? l = r(this, t, i, e, a, n, s) : l || (l = this.programs[t] = r(this, t, i)), l
                    },
                    data: function(t, e) {
                        for (; t && e--;) t = t._parent;
                        return t
                ...
                function n(e) {
                    var s = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1],
                        l = s.data;
                    n._setup(s), !s.partial && t.useData && (l = function(t, e) {
                        e && "root" in e || ((e = e ? o.createFrame(e) : {}).root = t);
                        return e
                    }(e, l));
                    var i = void 0,
                    ...
                    return t.useDepths && (i = s.depths ? e != s.depths[0] ? [e].concat(s.depths) : s.depths : [e]), (c = m(t.main, c, a, s.depths || [], l, r))(e, s)
                }
                return n.isTop = !0, n._setup = function(n) {
                    ...
                    if (t.useBlockParams && !s) throw new i.default("must pass block params");
                    if (t.useDepths && !l) throw new i.default("must pass parent depths");
                    return r(a, e, t[e], n, 0, s, l)
                }, n
            }, e.wrapProgram = r, e.resolvePartial = function(t, e, a) {
                t ? t.call || a.name || (a.name = t, t = a.partials[t]) : t = "@partial-block" === a.name ? a.data["partial-block"] : a.partials[a.name];
                return t
                ...
                a.fn && a.fn !== c && function() {
                    ...
                    var t = a.fn;
                    l = a.data["partial-block"] = function(e) {
                        var a = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1];
                        return a.data = o.createFrame(a.data), a.data["partial-block"] = n, t(e, a)
                    }, t.partials && (a.partials = s.extend({}, a.partials, t.partials))
                }();
                void 0 === t && l && (t = l);
                if (void 0 === t) throw new i.default("The partial " + a.name + " could not be found");
            ...
            function r(t, e, a, n, s, l, i) {
                function o(e) {
                    var s = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1],
                        o = i;
                    return !i || e == i[0] || e === t.nullContext && null === i[0] || (o = [e].concat(i)), a(t, e, t.helpers, t.partials, s.data || n, l && [s.blockParams].concat(l), o)
                }
                return (o = m(a, o, t, i, n, l)).program = e, o.depth = i ? i.length : 0, o.blockParams = s || 0, o
            }
            ...
            t.exports = n.Ember.Component.extend({
                ...
                draw: function(t) {
                    const {
                        events: e
                    } = t.timelines, a = this.get("specs"), s = function(t, e) {
                        const a = e.width,
                            s = e.height,
                            {
                                margin: l
                            ...
                            c = n.d3.scale.linear().range([0, o]).domain([0, t[t.length - 1].timestamp]),
                            m = n.d3.scale.linear().range([e.pointRadius.min, e.pointRadius.max]).domain([0, r]);
                        return {
                            w: a,
                            h: s,
                            innerW: o,
                    ...
                    }(e, a), l = n.d3.select(this.$().get(0)).append("svg:svg").attr("width", s.w).attr("height", s.h).attr("class", "match-details-event-chart"), i = l.append("svg:g").attr("transform", `translate(${s.margin.left}, ${s.margin.top})`).attr("class", "match-details-event-chart-interact");
                    ...
                    const o = i.append("svg:g").selectAll(".match-details-event-frame").data(e).enter().append("svg:g").filter((t => t.kills.length + t.objectives.length > 0)).attr("class", "match-details-event-frame").attr("transform", (t => "translate(" + s.scale.x(t.timestamp) + ", 0)")).attr("tooltipData", (t => JSON.stringify(t.details))).on("mouseover", (function() {
                        n.d3.select(this).style("filter", 'url("#match-details-brightness-filter")')
                    })).on("mouseout", (function() {
                        n.d3.select(this).style("filter", "none")
                    }));
                    o.append("svg:rect").attr("x", -s.frameW / 2).attr("y", 0).attr("width", s.frameW).attr("height", s.frameH).attr("class", "background-rect"), o.selectAll(".match-details-event-kills").data((t => t.kills)).enter().append("svg:circle").attr("class", (t => "match-details-event-kills data-point data-fill-" + t.teamId)).attr("cx", 0).attr("cy", (t => a.killDotsTransition.y(t.teamId))).attr("r", (t => s.scale.radius(t.count))), o.selectAll(".match-details-event-objectives").data((t => t.objectives)).enter().append("svg:foreignObject").attr("x", 0).attr("y", (t => a.objectiveIconTransition.y(t.teamId))).append("xhtml:div").attr("class", (t => `match-details-event-objectives event-icon-${t.objective}-${t.teamId}`));
                    const r = this.get("tra.MATCH_HISTORY_OVERVIEW_EVENT_OBJECTIVES_LABEL") + " / " + this.get("tra.MATCH_HISTORY_OVERVIEW_EVENT_KILLS_LABEL");
                    for (let t = 0; t < 4; t++) l.append("svg:text").attr("x", a.textPositions.x).attr("y", a.textPositions.y[t]).attr("class", "match-details-event-label").text(t % 2 == 0 ? r : "");
                    this.createTooltip()
                },
                createTooltip: function() {
            ...
            t.exports = (n.default || n).template({
                1: function(t, e, a, n, s, l) {
                    var i;
                    return null != (i = a.unless.call(null != e ? e : t.nullContext || {}, null != (i = l[0][0]) ? i.isEmpty : i, {
                        name: "unless",
                        hash: {},
                ...
                2: function(t, e, a, n, s, l) {
                    var i, o, r = null != e ? e : t.nullContext || {},
                        c = a.helperMissing,
                        m = "function",
                ...
                3: function(t, e, a, n, s, l) {
                    ...
                    return '          <div class="event-tooltip-row">\r\n            <div class="event-tooltip-icon event-tooltip-killer event-icon-' + r(o(null != (i = null != (i = l[0][0]) ? i.killer : i) ? i.class : i, e)) + '">\r\n              <div class="event-tooltip-icon-champion">\r\n                <div class="event-tooltip-icon-cover">\r\n                  <img src="' + r(o(null != (i = null != (i = l[0][0]) ? i.killer : i) ? i.imgSrc : i, e)) + '" class="event-tooltip-icon-img ' + r(o(null != (i = null != (i = l[0][0]) ? i.killer : i) ? i.imgClass : i, e)) + '"></img>\r\n                </div>\r\n              </div>\r\n            </div>\r\n            <div class="event-tooltip-kill-sign"></div>\r\n' + (null != (i = a.each.call(null != e ? e : t.nullContext || {}, null != (i = l[0][0]) ? i.victims : i, {
                        name: "each",
                        hash: {},
                ...
                4: function(t, e, a, n, s, l) {
                    var i;
                    return '              <div class="event-tooltip-icon event-tooltip-victim event-icon-' + t.escapeExpression(t.lambda(null != (i = l[0][0]) ? i.class : i, e)) + '">\r\n' + (null != (i = a.if.call(null != e ? e : t.nullContext || {}, null != (i = l[0][0]) ? i.isChampion : i, {
                        name: "if",
                        hash: {},
                ...
                5: function(t, e, a, n, s, l) {
                    var i;
                    return '                <div class="event-tooltip-icon-champion">\r\n                  <div class="event-tooltip-icon-cover">\r\n                    <img src="' + t.escapeExpression(t.lambda(null != (i = l[1][0]) ? i.imgSrc : i, e)) + '" class="event-tooltip-icon-img"></img>\r\n                  </div>\r\n                </div>\r\n'
                },
                compiler: [7, ">= 4.0.0"],
                main: function(t, e, a, n, s, l) {
                    var i;
                    return '<lol-uikit-tooltip>\r\n  <div class="match-details-event-tooltip">\r\n' + (null != (i = a.each.call(null != e ? e : t.nullContext || {}, null != e ? e.data : e, {
                        name: "each",
                        hash: {},
            ...
            function i(t, e, a, s, l) {
                n.TooltipManager.assign(t, "MapTooltip", {
                    timestamp: e,
                    killerImgSrc: a,
                    victimImgSrc: s,
                    killerTeam: l
            ...
            t.exports = n.Ember.Component.extend({
                ...
                playerImgSrcMap: n.Ember.computed("teams", (function() {
                    const t = {};
                    return this.get("teams").forEach((e => {
                        e.forEach((e => {
                ...
                draw: function(t) {
                    const {
                        mapsInfo: e
                    } = t.timelines, a = n.Lodash.extend(this.get("specs"), {
                        mapBg: this.get("mapBg"),
                        images: s
                    }), l = a.mapDomains[t.mapId], i = n.d3.select(this.$(".map-svg-wrapper").get(0)).append("svg").attr("width", a.mapW).attr("height", a.mapH), o = n.d3.scale.linear().domain([l.min.x, l.max.x]).range([0, a.mapW]), r = n.d3.scale.linear().domain([l.min.y, l.max.y]).range([a.mapH, 0]);
                    i.append("image").attr("xlink:href", a.mapBg).attr("x", "0").attr("y", "0").attr("width", a.mapW).attr("height", a.mapH), i.append("svg:g").attr("class", "champion-kills").selectAll("champion-kill").data(e.championKills).enter().append("svg:circle").attr("id", (t => "champkill_" + t.timestamp + "_" + t.victimId)).attr("cx", (t => o(t.position.x))).attr("cy", (t => r(t.position.y))).attr("r", a.circleR).attr("class", (t => `map-data champion-event champion-kill player-${t.playerId} data-fill-${t.teamId}`)).attr("display", "none"), i.append("svg:g").attr("class", "champion-deaths").selectAll("champion-death").data(e.championDeaths).enter().append("svg:image").attr("id", (t => "championDeath_" + t.timestamp + "_" + t.playerId)).attr("xlink:href", (t => a.images.death[t.teamId])).attr("x", (t => o(t.position.x) - a.iconW / 2)).attr("y", (t => r(t.position.y) - a.iconH / 2)).attr("width", a.iconW).attr("height", a.iconH).attr("class", (t => `map-data champion-event champion-death player-${t.playerId}`)).attr("display", "none"), i.append("svg:g").attr("class", "building-kills").selectAll("building-kill").data(e.buildingKills).enter().append("svg:image").attr("id", (t => "buildingKill_" + t.timestamp + "_" + t.playerId)).attr("xlink:href", (t => a.images[t.display][t.teamId])).attr("x", (t => o(t.position.x) - a.iconW / 2)).attr("y", (t => r(t.position.y) - a.iconH / 2)).attr("width", a.iconW).attr("height", a.iconH).attr("class", (t => `map-data building-kill player-${t.playerId}`)).attr("display", "none"), this.addTooltips(e)
                },
                addTooltips: function(t) {
                    ...
                    t.championKills.forEach((t => {
                        const {
                            ...
                            victimId: s
                        } = t, l = this.get("playerImgSrcMap")[t.playerId], i = this.get("playerImgSrcMap")[t.victimId], o = this.$().find(`#champkill_${a}_${s}`)[0];
                        ...
                        const {
                            ...
                            playerId: s
                        } = t, l = this.get("playerImgSrcMap")[t.killerId], i = this.get("playerImgSrcMap")[t.playerId], o = this.$().find(`#championDeath_${a}_${s}`)[0];
                        e(o, t.timestamp, l, i, t.killerTeamId), n.TooltipManager.disable(o)
                    })), t.buildingKills.forEach((t => {
                        const {
                            timestamp: a
                        } = t, {
                            playerId: s
                        } = t, l = this.get("playerImgSrcMap")[t.playerId], i = this.$().find(`#buildingKill_${a}_${s}`)[0];
                        e(i, t.timestamp, l, void 0, t.killerTeamId), n.TooltipManager.disable(i)
                    }))
                },
                resetVisibility: function() {
                    const t = function(t, e) {
                            const a = "champion" === t;
                            return e ? `.player-${e}${a?".champion-event":".building-kill"}` : a ? ".champion-kill" : ".building-kill"
                    ...
                    n.d3.selectAll(this.$(t)).classed("map-show", !0).style("display", "inline")
                },
                actions: {
                ...
                didInsertElement: function() {
                    ...
                    if (t && this.get("mapBg")) {
                        ...
                        })), this.set("ownerTeamId", a[0][0].teamId), this.set("teams", a), this.draw(t), this.resetVisibility(), this.$(".map-type-selector")[0].refreshSelected()
                    }
                }
            })
        }, (t, e, a) => {
            ...
            const l = n.Ember.Component.extend({
                ...
                formattedTime: n.Ember.computed("timestamp", (function() {
                    ...
                    return 60 === e ? t + 1 + ":00" : e < 10 ? t + ":0" + e : t + ":" + e
                }))
            });
            n.default && n.default.EmberApplicationFactory.setFactoryDefinition({
                name: "MapTooltip",
            ...
            a(105), t.exports = n.Ember.Component.extend({
                ...
                subteams: n.Ember.computed("currentParticipant", "gameData", "hasObjectives", (function() {
                    ...
                    return n.Lodash.each(c, (s => {
                        ...
                        const o = l.GAME_MODES_WITH_SUBTEAMS[e.gameMode].subteams.find((t => t.subteamId === s.subteamId));
                        if (o) {
                            const t = o.display;
                            s.teamNameDisplayText = r.get(t.label), s.teamIcon = t.icon
                        }
                        const c = i(s.participants);
                        n.Lodash.each(s.participants, (t => {
                            t.mostKills = t.kills === c.kills, t.mostAssists = t.assists === c.assists, t.mostMinionKills = t.minionsPlusNeutralMonstersCount === c.minionsPlusNeutralMonstersCount, t.mostGoldEarned = t.goldEarned === c.goldEarned
                        })), n.Lodash.each(s.bans, (e => e.squarePortraitPath = t.get(e.championId).squarePortraitPath))
                ...
                platformTeams: n.Ember.computed("currentParticipant", "gameData", "hasObjectives", (function() {
                    ...
                    return n.Lodash.each(o, (e => {
                        e.hasBansOrObjectives = e.hasBans || a;
                        const s = i(e.participants);
                        n.Lodash.each(e.participants, (t => {
                            t.mostKills = t.kills === s.kills, t.mostAssists = t.assists === s.assists, t.mostMinionKills = t.minionsPlusNeutralMonstersCount === s.minionsPlusNeutralMonstersCount, t.mostGoldEarned = t.goldEarned === s.goldEarned
                        })), n.Lodash.each(e.bans, (e => e.squarePortraitPath = t.get(e.championId).squarePortraitPath))
                ...
                rightTitleText: n.Ember.computed("gameData.gameMode", (function() {
                    const t = this.get("tra"),
                        ...
                        a = this.get("hasObjectives");
                    let n = "";
                    return e && a ? n = "MATCH_DETAILS_BAN_AND_OBJECTIVES" : a ? n = "MATCH_DETAILS_OBJECTIVES" : e && (n = "MATCH_DETAILS_BAN"), t.get(n)
                })),
                removeAnimationWhenDone: n.Ember.on("didInsertElement", (function() {
                    const t = this.get("isHexakill") ? ".match-details-team-container-hexakill" : ".match-details-team-container",
            ...
            Object.defineProperty(e, "__esModule", {
                ...
                })) : (n.logger.error(`Could not load details for game ID ${s} - details are empty or incomplete`), n.logger.trace(`Details fo game ID ${s}: ${JSON.stringify(t)}`));
                return c = c.filter((t => t.participants.length > 0)), n.Ember.A(c)
                ...
                o ? (o.forEach((function(t) {
                    ...
                    if (!c.find((e => e.subteamId === t.playerSubteamId))) {
                        const a = {};
                        a.subteamId = e, a.teamId = e, a.placement = t.subteamPlacement, a.hasBans = !1, a.placement <= 1 && (a.bans = i[0].bans, a.hasBans = !0), c.push(a)
                    }
                })), c = c.map((t => {
                    const n = (0, s.fromJson)(t, o, r, e);
                    return n.subteamId === a.playerSubteamId && n.set("isFirstTeam", !0), n
                }))) : (n.logger.error(`Could not load details for game ID ${l} - details are empty or incomplete`), n.logger.trace(`Details fo game ID ${l}: ${JSON.stringify(t)}`));
                return c = c.filter((t => t.participants.length > 0)), n.Ember.A(c)
            };
            var n = a(1),
                s = a(102),
            ...
            Object.defineProperty(e, "__esModule", {
                ...
                const o = e.filter((e => e.playerSubteamId === t.subteamId)).map((t => {
            ...
            const i = s.Ember.Object.extend({
                ...
                kills: s.Ember.computed("participants.[]", (function() {
                    return s.Lodash.sum(this.get("participants").map((t => t.stats.kills)))
                })),
                deaths: s.Ember.computed("participants.[]", (function() {
                    return s.Lodash.sum(this.get("participants").map((t => t.stats.deaths)))
                })),
                assists: s.Ember.computed("participants.[]", (function() {
                    return s.Lodash.sum(this.get("participants").map((t => t.stats.assists)))
                })),
                gold: s.Ember.computed("participants.[]", (function() {
                    return s.Lodash.sum(this.get("participants").map((t => t.stats.goldEarned)))
                })),
            ...
            Object.defineProperty(e, "__esModule", {
                value: !0
            }), e.default = void 0, e.fromJson = function(t, e, a, n) {
                const o = e.filter((e => e.teamId === t.teamId)).map((t => {
                        const e = a.find((e => e.participantId === t.participantId)),
                            i = new l.default(t, e),
                            o = n.get(i.championId);
                        return i.titleInfo = {
            ...
            Object.defineProperty(e, "__esModule", {
                value: !0
            }), e.MODE_PLACEMENT_TRA_KEY = e.GAME_MODES_WITH_SUBTEAMS = e.GAME_MODES_WITHOUT_OBJECTIVES = void 0;
            ...
            function p(t, e) {
                n.TooltipManager.assign(t, "ScoreboardTooltip", {
                    traString: e,
                    tra: this.get("tra")
                }, {
                    ComponentFactory: n.ComponentFactory,
            ...
            t.exports = n.Ember.Component.extend({
                ...
                teamScore: n.Ember.computed("team.participants.0.stats.playerScore0", "teamKdaOverride.scoreStat", "tra.metadata.locale.id", (function() {
                    ...
                    return s.default.formatGold(e, this.get("tra.metadata.locale.id"))
                })),
                teamScoreGrade: n.Ember.computed("team.participants.0.stats.playerScore1", "teamKdaOverride.gradeStat", (function() {
                    ...
                    if (t) {
                        const e = this.get(`team.participants.0.stats.${t}`) || o.length;
                        return o[e - 1]
                    }
                })),
                ...
                setupTooltip: n.Ember.on("didInsertElement", (function() {
                    ...
                    if (this.get("teamKdaOverride")) {
                        t(n.Ember.$(this.element).find("." + this.get("teamKdaOverride.styleClass"))[0], this.get("teamKdaOverride.traKey"))
                    } else {
                        t(n.Ember.$(this.element).find(".match-details-team-kill")[0], "MATCH_HISTORY_SCOREBOARD_TEAM_KDA")
                    }
                    const e = n.Ember.$(this.element).find(".match-details-team-gold")[0],
                        a = n.Ember.$(this.element).find(".match-details-team-kill-icon")[0];
                    if (this.get("playerCSOverride")) {
                        t(n.Ember.$(this.element).find("." + this.get("playerCSOverride.styleClass")), this.get("playerCSOverride.traKey"))
                    } else {
                        t(n.Ember.$(this.element).find(".match-details-team-cs-icon")[0], "MATCH_HISTORY_SCOREBOARD_CS_ICON")
                    }
                    if (this.get("playerGoldOverride")) {
                        t(n.Ember.$(this.element).find("." + this.get("playerGoldOverride.styleClass")), this.get("playerGoldOverride.traKey"))
                    } else {
                        t(n.Ember.$(this.element).find(".match-details-team-gold-icon")[0], "MATCH_HISTORY_SCOREBOARD_GOLD_ICON")
                    }
                    t(e, "MATCH_HISTORY_SCOREBOARD_TEAM_GOLD"), t(a, "MATCH_HISTORY_SCOREBOARD_KDA_ICON")
                }))
            })
        }, (t, e, a) => {
            "use strict";
            ...
            t.exports = n.Ember.Component.extend({
                ...
                participantMap: n.Ember.computed("team.participants", (function() {
                    const t = {};
                    return this.get("team.participants").forEach((e => {
                        t[e.participantId] = !0
                    })), t
                })),
                        ...
                        for (let n = 0; n < a.length; n++) {
                            ...
                            if (s)
                                for (let a = 0; a < s.length; a++) {
                                    const n = s[a];
                                    l[n.monsterSubType] && e[n.killerId] && t.push(l[n.monsterSubType])
                                }
                        }
                    }
                    return t
                ...
                setupTooltip: n.Ember.on("didInsertElement", (function() {
                    const t = s.bind(this);
                    t(n.Ember.$(this.element).find(".tower-icon")[0], "MATCH_HISTORY_SCOREBOARD_OBJECTIVE_TOWER");
                    if (t(n.Ember.$(this.element).find(".inhibitor-icon")[0], "MATCH_HISTORY_SCOREBOARD_OBJECTIVE_INHIBITOR"), this.get("showBaron")) {
                        t(n.Ember.$(this.element).find(".baron-icon")[0], "MATCH_HISTORY_SCOREBOARD_OBJECTIVE_BARON")
                    }
                    if (this.get("showDragon")) {
                        t(n.Ember.$(this.element).find(".dragon-icon")[0], "MATCH_HISTORY_SCOREBOARD_OBJECTIVE_DRAGON", "ElementalTooltip", this.get("elementalData"))
                    }
                    if (this.get("showRiftHerald")) {
                        t(n.Ember.$(this.element).find(".rift-herald-icon")[0], "MATCH_HISTORY_SCOREBOARD_OBJECTIVE_RIFT_HERALD")
                    }
                    if (this.get("showVilemaw")) {
                        t(n.Ember.$(this.element).find(".vilemaw-icon")[0], "MATCH_HISTORY_SCOREBOARD_OBJECTIVE_VILEMAW")
                    }
                }))
            })
        }, (t, e, a) => {
            ...
            t.exports = r.extend(l.DataBindingMixin, {
                ...
                playerNames: c("summonerName", "gameName", "tagLine", (function() {
                    const t = this.get("summonerName"),
                        e = this.get("gameName"),
                        a = this.get("tagLine");
                    return e && a ? this.get("_playerNames").formatPlayerName({
                        summonerName: t,
                        gameName: e,
                        tagLine: a
                    }) : t
                ...
                playerCSDisplay: c("queueId", "participant", (function() {
                    ...
                    return t ? this.get(`participant.${t}`) : this.get("participant.minionsPlusNeutralMonstersCount")
                })),
                playerGoldDisplay: c("queueId", "goldEarnedDisplay", (function() {
                    const t = m[this.get("queueId")];
                    return t ? this.get(`participant.${t}`) : this.get("goldEarnedDisplay")
                })),
                init() {
                ...
                addContextMenu() {
                    this.$()[0].addEventListener("contextmenu", (t => {
                        ...
                        e.length > 0 && (s.ContextMenuManager.setMenuItems(e), s.ContextMenuManager.openAtEvent(t))
                    }))
                },
                ...
                getMenuItemModel: function() {
                    ...
                    return t = t.concat([r, this.get("isSummonerBlocked") ? m : c, this.get("isSummonerFriend") ? d : p, g]), t
                },
                ...
                confirmImportItemSet(t, e) {
                    ...
                    (0, s.getProvider)().getOptional("rcp-fe-lol-collections").then((t => t.getItemSetsApi().saveItemSet(a)), (t => s.logger.error("Provider getOptional failure", t)))
                },
                assignAllTooltips() {
                    ...
                    o.each((function(t) {
                        const e = a.get(r);
                        e && s.TooltipManager.assign(this, "KeystoneTooltip", {
                            keystone: e,
                            tra: n
                        }, {
                            ComponentFactory: s.ComponentFactory,
            ...
            Object.defineProperty(e, "__esModule", {
                value: !0
            }), e.NUMBER_OF_AUGMENTS = e.MAP_IDS_WITH_AUGMENTS = e.MAP_IDS_WITHOUT_CS = void 0;
            ...
            "use strict";
            var n = a(1);
            a(135), t.exports = n.Ember.Component.extend({
                ...
                sortProperty: ["teamId"],
                sortedParticipants: n.Ember.computed.sort("stats.participants", (function(t, e) {
                    const a = this.get("myTeamId");
                    return t.teamId === a ? -1 : t.teamId === e.teamId ? 0 : 1
                })),
                ...
                didInsertElement() {
                    this._super(...arguments), this.element.addEventListener("selectHoverColumnIndex", (t => {
            ...
            t.exports = n.Ember.Component.extend({
                ...
                mouseEnter: function() {
                    ...
                    t.columnIndex = this.get("currentParticipantIndex"), this.element.dispatchEvent(t)
                },
                mouseLeave: function() {
            ...
            t.exports = n.Ember.Component.extend({
                ...
                cellContents: n.Ember.computed("participants", "tra.metadata.locale.id", (function() {
                    ...
                    return this.get("participants").map((function(i) {
                        ...
                        switch (e) {
                            case "concatKDA":
                                o = s.default.concatKDA(i.stats[t[0]], i.stats[t[1]], i.stats[t[2]]);
                                break;
                ...
                isAttrWithData: n.Ember.computed("attr", "isParticipantsPopulated", (function() {
                    ...
                    if (t && Array.isArray(t.key)) t.key.forEach((function(t) {
            ...
            "use strict";
            var n = a(1);
            a(150), t.exports = n.Ember.Component.extend({
                layout: a(151),
            ...
            "use strict";
            var n = a(1);
            a(153), t.exports = n.Ember.Component.extend({
                classNames: ["match-details-graph-component"],
                layout: a(154),
                selectedAttributes: n.Ember.A([]),
                mapId: n.Ember.computed.alias("gameData.mapId"),
                removeAnimationWhenDone: n.Ember.on("didInsertElement", (function() {
                    const t = n.Ember.$(this.element).find(".match-graph-container")[0];
                    t.addEventListener("webkitAnimationEnd", (function(e) {
                        e.target === t && "fade-in" === e.animationName && t.classList.remove("match-details-loading-fade-in")
                    }))
                }))
            ...
            t.exports = n.Ember.Component.extend({
                ...
                statsCategories: n.Ember.computed("tra.metadata", "stats.participants", "mapId", (function() {
                    ...
                    return t.forEach((t => {
                        ...
                        s.set("name", t.name), s.set("selected", !1), s.set("attributes", n.Ember.A([])), s.set("locString", this.get(`tra.${t.name}`)), t.attributes.forEach((t => {
                            const e = n.Ember.Object.create();
                            e.set("name", t.name), e.set("key", t.key), e.set("locString", this.get(`tra.${t.name}`)), e.set("selected", !1), e.set("disabled", !1);
                            const l = t.hideOnMurderBridge;
                            (void 0 === l || !0 === l && 12 !== a && 14 !== a) && void 0 !== this.get(`stats.participants.0.stats.${t.key}`) && s.attributes.push(e)
                        })), e.push(s)
                    })), e
                })),
                ...
                _setDisableValues: function() {
                    ...
                    e.forEach((function(e) {
                        ...
                        e.attributes.forEach((function(e) {
                            const a = t >= 6;
                            !e.get("selected") && a ? e.set("disabled", !0) : e.set("disabled", !1)
                        }))
                    }))
                },
                actions: {
                    selectCategory: function(t) {
                        const e = this.get("statsCategories");
                        t.selected ? e.forEach((function(e) {
                            e.name === t.name ? (e.set("selected", !0), e.attributes.forEach((function(t) {
                                t.set("selected", !0)
                            }))) : (e.set("selected", !1), e.attributes.forEach((function(t) {
                                t.set("selected", !1)
                            })))
                        })) : e.forEach((function(e) {
                            e.name === t.name && (e.set("selected", !1), e.attributes.forEach((function(t) {
                    ...
                    selectAttribute: function(t) {
                        this.get("statsCategories").forEach((function(e) {
                            ...
                            e.attributes.forEach((function(n) {
                                n.name === t.get("name") && t.get("selected") && e.set("selected", !0), n.get("selected") && a++
            ...
            t.exports = n.Ember.Component.extend({
                ...
                graphData: n.Ember.computed("selectedAttributes", "stats.participants", "stats.currentSummonerId", (function() {
                    ...
                    return a && 0 !== a.length ? (a.forEach((function(a) {
                        const i = {},
                            o = a.summonerId === e;
                        o && (l = !0), i.isCurrent = o, i.isLocalPlayer = o, i.teamId = a.teamId, i.championId = a.championId, i.graphYAxisIndex = s++, i.stats = [], t.forEach((function(t) {
                            const e = {};
                            e.id = t.key, e.value = a.stats[t.key], e.name = t.locString, e.teamId = a.teamId, i.stats.push(e)
                        })), n.push(i)
                ...
                renderInitialGraph: function() {
                    const t = this.get("graphData"),
                        ...
                        i = 50,
                        o = 700 - i - a,
                        r = (this.get("stats.dataSource") === l ? 500 : 570) - e - s,
                        ...
                        u = n.d3.select(".match-graph-display .match-main-graph").append("svg").attr("width", o + i + a).attr("height", r + e + s),
                        g = u.append("g").attr("transform", "translate(" + i + "," + e + ")");
                    c.domain([0, 0]), m.domain(t.map((function(t) {
                        return t.graphYAxisIndex
                    }))), this._appendAxis(d, h, g, r), this._initialAvatarsRender(t, u, m), this.set("x", c), this.set("y0", m), this.set("y1", p), this.set("xAxis", d), this.set("yAxis", h), this.set("svg", g)
                },
                rerenderGraph: function() {
                    ...
                    e.domain([0, n.d3.max(t, (function(t) {
                ...
                _renderChampions: function(t) {
                    const e = this.get("y0");
                    t.enter().append("g").attr("class", "match-graph-champion").attr("transform", (function(t) {
                        const a = t.teamColor === i ? 0 : 16;
                ...
                _renderStats: function(t, e) {
                    const a = n.d3.scale.ordinal().range(["#1ba9bd", "#098c9e", "#06535d", "#04434a"]),
                        ...
                        l = this.get("y1"),
                        o = this.get("x");
                    t.enter().append("rect").attr("width", 0), t.attr("x", 1).attr("id", (function(t) {
                        return t.id
                        ...
                        return t.teamColor === i ? a(e) : s(e)
                    })).transition().attr("y", (function(t, a) {
                ...
                _applyTooltips: function(t) {
                    t.on("mouseover", (t => {
                        ...
                        this.$(`.${t.id}-tooltip`).remove(), this.$(".match-main-graph-tooltip-hint").remove()
                    }))
                },
                _applyTeamColors: function(t) {
                    const e = t.find((t => t.isCurrent)),
                        a = [],
                        n = [];
                    return e && (e.teamColor = i, e.stats.forEach((t => t.teamColor = i)), a.push(e)), t.forEach((function(t) {
                        t.teamId === e.teamId && !t.isCurrent ? (t.teamColor = i, t.stats.forEach((t => t.teamColor = i)), a.push(t)) : t.isCurrent || (t.teamColor = "red", t.stats.forEach((t => t.teamColor = "red")), n.push(t))
                    })), a.concat(n)
                },
                _appendAxis(t, e, a, n) {
                    a.append("g").attr("class", "match-graph-axis match-graph-x-axis").attr("transform", "translate(0," + n + ")").classed("grid", !0).call(t), a.append("g").attr("class", "match-graph-axis match-graph-y-axis").call(e)
                },
                _initialAvatarsRender: function(t, e, a) {
                    e.select(".match-graph-y-axis").selectAll("text").remove(), e.append("clipPath").attr("id", "avatar-clip").append("circle").attr("cx", 21).attr("cy", 20).attr("r", 13);
                    const n = e.selectAll(".match-graph-y-axis").selectAll(".tick").data(t).attr("class", (function(t) {
                        const e = t.isLocalPlayer ? "local-player" : "";
                        return `tick team-${t.teamColor} ${e}`
                    })).attr("transform", (function(t) {
                        const e = t.teamColor === i ? 0 : 16;
                    ...
                    n.append("svg:image").attr("class", "avatar").attr("xlink:href", (function(t) {
            ...
            t.exports = n.Ember.Component.extend({
                ...
                statStrings: n.Ember.computed("stats.rune.endOfGameStatDescs", "stats.vars", (function() {
                    ...
                    return e.length <= 0 && (e = ["--"]), e.map((e => this.fillInPlaceholders(e, t)))
                })),
            ...
            t.exports = n.Ember.Service.extend(i, {
                _eogParticipants: n.Ember.computed("eogStatsBlock", (function() {
                    ...
                    e.forEach((function(t) {
                        const e = {};
                        e.teamId = t.teamId, e.championId = t.championId, e.summonerId = t.summonerId, e.champLevel = t.stats.LEVEL, e.goldEarned = t.stats.GOLD_EARNED, e.championId = t.championId, e.player = {}, e.player.summonerName = t.summonerName, e.player.summonerId = t.summonerId, e.spellIds = [], e.spellIds[0] = t.spell1Id, e.spellIds[1] = t.spell2Id, e.itemIds = t.items, e.stats = {}, Object.keys(s).forEach((function(a) {
                            e.stats[s[a]] = t.stats[a]
                        })), Object.keys(l).forEach((function(a) {
                            e.stats[l[a]] = t.stats[a]
                        })), e.minionsPlusNeutralMonstersCount = e.stats.totalMinionsKilled + e.stats.neutralMinionsKilled, e.kills = e.stats.kills, e.deaths = e.stats.deaths, e.assists = e.stats.assists, a.push(e)
                    }));
                    const i = this.get("currentSummonerId");
                    return a = n.Lodash.sortBy(a, ["teamId", function(t) {
                ...
                _legsParticipants: n.Ember.computed("legsGameData", (function() {
                    ...
                    return e.forEach((function(e) {
                        const n = {},
                            s = t.participantIdentities.find((t => t.participantId === e.participantId));
                        n.summonerId = s.player.summonerId, n.teamId = e.teamId, n.championId = e.championId, n.stats = e.stats, a.push(n)
                    })), a
                })),
                setSourceOptions: function(t) {
                    ...
                    this.set("dataSource", t.dataSource), this.set("baseGameId", t.baseGameId), this.set("baseSummonerId", t.baseSummonerId)
                },
        ...
        s.addEventListener(l, (function(t) {
            (0, t.registrationHandler)((function(t) {
                return e.default.init(t, {
                    ...
                    ContextMenuManager: t => t.get("rcp-fe-lol-uikit").getContextMenuManager(),
                    d3: t => t.get("rcp-fe-common-libs").getD3("3"),
                    dataBinding: t => t.get("rcp-fe-common-libs").getDataBinding("rcp-fe-lol-match-history"),
                    Ember: t => t.get("rcp-fe-ember-libs").getEmber(),
                    EmberDataBinding: t => t.get("rcp-fe-ember-libs").getEmberDataBinding("rcp-fe-lol-match-history"),
                    ...
                    ModalManager: t => t.get("rcp-fe-lol-uikit").getModalManager(),
                    ...
                    Replays: t => t.get("rcp-fe-lol-shared-components").getApi_Replays(),
                    SharedReportModalApps: t => t.get("rcp-fe-lol-shared-components").getApi_SharedReportModalApps(),
                    SharedEmberComponents: t => t.get("rcp-fe-lol-shared-components").getSharedEmberComponents(),
                    Telemetry: t => t.get("rcp-fe-common-libs").getTelemetry(),
                    TooltipManager: t => t.get("rcp-fe-lol-uikit").getTooltipManager(),
                    Viewport: t => t.get("rcp-fe-lol-shared-components").getApi_Viewport(),
                    socket: t => t.getSocket()
                }).then((() => e.default.add({
                    EmberApplicationFactory: t => t.get("rcp-fe-ember-libs").getEmberApplicationFactory()
                }))).then((() => {
                    const t = a(2).default();
