          ...
          n.Lodash.each([100, 200], (t) => {
            ...
            e
              ...
              e
                ...
                .attr("r", () => a.pointRarius)
                .attr("tooltip", (e) => y(e[t], e.timestamp, l, i));
          });
        }
        function d(t) {
          const {
          ...
          n.Lodash.each(r, (t) => {
            ...
            m
              ...
              m
                ...
                .attr("r", () => a.pointRarius)
                .attr("tooltip", (e) =>
                  y(e.champions[t.participantId], e.timestamp, l, i),
                );
        ...
        t.exports = n.Ember.Component.extend({
          ...
          renderInitialGraph: function () {
            ...
            c.domain([0, 0]),
              ...
              this._initialAvatarsRender(t, u, m),
              this.set("x", c),
              this.set("y0", m),
              this.set("y1", p),
              this.set("xAxis", d),
          ...
          _applyTeamColors: function (t) {
            ...
            return (
              e &&
                ((e.teamColor = i),
                e.stats.forEach((t) => (t.teamColor = i)),
                a.push(e)),
              t.forEach(function (t) {
                t.teamId === e.teamId && !t.isCurrent
                  ? ((t.teamColor = i),
                    t.stats.forEach((t) => (t.teamColor = i)),
                    a.push(t))
                  : t.isCurrent ||
                    ((t.teamColor = "red"),
          ...
          _initialAvatarsRender: function (t, e, a) {
            ...
            const n = e
              ...
              .attr("transform", function (t) {
                ...
                return `translate(0, ${
                  a(t.graphYAxisIndex) + e - 8 + a.rangeBand() / 2 - 15
                })`;
              });
