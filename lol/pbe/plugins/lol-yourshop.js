(() => {
    var e = [, e => {
            ...
            t.default = class {
                ...
                initializeTra() {
                    this.tra = (0, a.getProvider)().get("rcp-fe-lol-l10n").tra().overlay("/fe/lol-l10n/trans.json").overlay("/fe/ember-libs/trans-icon-rarity.json").overlay("/fe/lol-yourshop/trans.json")
                }
                show() {
                    var e;
            ...
            e.exports = o.Ember.Object.extend(a, {
                ...
                rarity: o.Ember.computed("rarityId", (function() {
                    return o.RarityManager.agregatedSkinRarityInformationByTier[this.get("rarityId")]
                })),
            ...
            e.exports = o.Ember.Component.extend(a, {
                ...
                multipleDetailsclass: o.Ember.computed("hasOfferRarity", (function() {
                    return this.get("hasOfferRarity") ? "contains-multiple-detail" : "contains-single-detail"
                })),
