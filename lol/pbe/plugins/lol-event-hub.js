  ...
  var e = [
          ...
          (t.default = function () {
            const e = {
              ...
              TEMPLATES: {
                ...
                "components/event-shop-offer-card": se.default,
      ...
      (e, t, n) => {
        ...
        var o = a.Ember.Service.extend({
          ...
          willDestroy() {
            this._super(...arguments),
              this.settingsDataBinding.unobserve(s, this);
          },
      ...
      (e, t, n) => {
        ...
        var r = a.Ember.Component.extend(s, {
          ...
          pricePerLevel: 0,
          currentBalance: 0,
          isPotatoModeEnabled: a.Ember.computed.alias(
      ...
      (e, t, n) => {
        ...
        var r = a.Ember.Controller.extend({
          eventHubService: a.Ember.inject.service("event-hub"),
          playerSettingsService: a.Ember.inject.service("player-settings"),
          parallaxEnabled: a.Ember.computed.not(
            "playerSettingsService.potatoModeEnabled",
          ),
          rewardTrackProgress: a.Ember.computed.alias(
            "eventHubService.rewardTrackProgress",
