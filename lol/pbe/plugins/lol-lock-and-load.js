(() => {
    var e = [, e => {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                return e.addEventListener("riotPlugin.lifecycle.postinit", (() => t.releaseUnlockBrake())), new n.default(t)
            };
            var n = r(o(3)),
                s = r(o(5));
            ...
            e.exports = (t = {}, (t = function() {
                ...
                addEventListener: function(e, t, o) {
                    for (var n = [], s = arguments.length, r = 0; r < s; r++) n.push(arguments[r]);
                ...
                removeEventListener: function(e, t, o) {
                    if (void 0 !== this.listeners[e]) {
                        for (var n = this.listeners[e].length, s = [], r = 0; r < n; r++) {
                ...
                dispatch: function(e, t) {
                    for (var o = {
                            type: e,
                            target: t
                        }, n = [], s = arguments.length, r = 0; r < s; r++) n.push(arguments[r]);
            ...
            t.default = class {
                ...
                lockAndLoad(e = {}) {
                    ...
                    t || s.logger.warning("Lock created with no lockName. This could make debugging difficult in the future.");
                    const o = Date.now(),
                        n = e.promise,
                    ...
                    return a.then((() => {
                        ...
                        this.unlock(a);
                        const e = Date.now() - o;
                        s.logger.error("Lock loader promise rejected. Possible timeout?", {
                            lockName: t,
                            elapsedTimeMs: e
                        })
                    })), this.locks.push(a), this.updateLockedState(), i
                }
                unlock(e) {
                ...
                setLockedState() {
                    this.isLocked || (this.isLocked = !0, this.wasEverLocked = !0, r.default.dispatch("lock"))
                }
                removeLockedState() {
                    this.isLocked && (this.isLocked = !1, this.brakeReleased && r.default.dispatch("unlock"))
                }
                releaseUnlockBrake() {
                    this.brakeReleased = !0, !this.isLocked && this.wasEverLocked && r.default.dispatch("unlock")
                }
            }
        }],
        t = {};
    ...
    function o(n) {
        ...
        s.addEventListener(r, (function(e) {
