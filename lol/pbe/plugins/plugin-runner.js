(() => {
    var e = [, (e, t, n) => {
            ...
            var f = class {
                ...
                telemetry() {
                    ...
                    return "console" === this.config("telemetry") && (e.enable(), e.addListener(i.consoleDispatcher)), e
                }
                init() {
                    ...
                    const f = () => {
                        s.removeEventListener("ready", f), n.load(e).then((e => {
            ...
            t.default = class {
                ...
                use(e) {
                    var t;
                    return e.invertedDeps = (t = e.dependencies, o.default.reduce(t, ((e, t, n) => (t.forEach((t => {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                return new Promise((function(t, n) {
                    ...
                    o.open("GET", e, !0), o.setRequestHeader("Accept", "application/json"), o.onreadystatechange = function() {
                        if (4 === o.readyState)
                            if (r.indexOf(o.status) < 0) n(new Error("getJson of " + e + " failed with HTTP Error " + o.status));
                            else try {
            ...
            e = n.nmd(e),
                function() {
                    var o, i = "Expected a function",
                        ...
                        Ze = "(?:" + Re + "|" + Be + ")" + "?",
                        Ke = "[" + je + "]?",
                        Qe = Ke + Ze + ("(?:" + qe + "(?:" + [Ue, We, He].join("|") + ")" + Ke + Ze + ")*"),
                        Xe = "(?:" + [Fe, We, He].join("|") + ")" + Qe,
                        Ye = "(?:" + [Ue + Re + "?", Re, We, He, Ie].join("|") + ")",
                        et = RegExp(Ne, "g"),
                        tt = RegExp(Re, "g"),
                        nt = RegExp(Be + "(?=" + Be + ")|" + Ye + Qe, "g"),
                        rt = RegExp([ze + "?" + Me + "+" + Ge + "(?=" + [Ce, ze, "$"].join("|") + ")", Ve + "+" + Je + "(?=" + [Ce, ze + $e, "$"].join("|") + ")", ze + "?" + $e + "+" + Ge, ze + "+" + Je, "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", Le, Xe].join("|"), "g"),
                        ...
                        at = -1,
                        ut = {};
                    ut[F] = ut[M] = ut[D] = ut[B] = ut[U] = ut[W] = ut[H] = ut[z] = ut[q] = !0, ut[m] = ut[_] = ut[R] = ut[b] = ut[L] = ut[w] = ut[x] = ut[E] = ut[S] = ut[P] = ut[O] = ut[j] = ut[T] = ut[N] = ut[C] = !1;
                    var ct = {};
                    ct[m] = ct[_] = ct[R] = ct[L] = ct[b] = ct[w] = ct[F] = ct[M] = ct[D] = ct[B] = ct[U] = ct[S] = ct[P] = ct[O] = ct[j] = ct[T] = ct[N] = ct[I] = ct[W] = ct[H] = ct[z] = ct[q] = !0, ct[x] = ct[E] = ct[C] = !1;
                    var lt = {
                            "\\": "\\",
                            "'": "'",
                            "\n": "n",
                    ...
                    var gn = function e(t) {
                        var n, r = (t = null == t ? vt : gn.defaults(vt.Object(), t, gn.pick(vt, st))).Array,
                            Ae = t.Date,
                            Se = t.Error,
                            Pe = t.Function,
                            Oe = t.Math,
                            ...
                            De = 0,
                            Be = (n = /[^.]+$/.exec(Le && Le.keys && Le.keys.IE_PROTO || "")) ? "Symbol(src)_1." + n : "",
                            Ue = Re.toString,
                            We = Fe.call(ke),
                            He = vt._,
                            ze = je("^" + Fe.call(Me).replace(oe, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"),
                            qe = mt ? t.Buffer : o,
                            $e = t.Symbol,
                            Ve = t.Uint8Array,
                        ...
                        function Qn(e, t) {
                            var n = qs(e),
                                ...
                                a = s ? Qt(e.length, Te) : [],
                                u = a.length;
                            for (var c in e) !t && !Me.call(e, c) || s && ("length" == c || o && ("offset" == c || "parent" == c) || i && ("buffer" == c || "byteLength" == c || "byteOffset" == c) || bi(c, u)) || a.push(c);
                            return a
                        }
                        ...
                        function tr(e, t, n) {
                            (n !== o && !Us(e[t], n) || n === o && !(t in e)) && sr(e, t, n)
                        }

                        function nr(e, t, n) {
                            var r = e[t];
                            Me.call(e, t) && Us(r, n) && (n !== o || t in e) || sr(e, t, n)
                        }

                        function rr(e, t) {
                            for (var n = e.length; n--;)
                                if (Us(e[n][0], t)) return n;
                            return -1
                        }
                        ...
                        function ar(e, t) {
                            for (var n = -1, i = t.length, s = r(i), a = null == e; ++n < i;) s[n] = a ? o : Pa(e, t[n]);
                            return s
                        }
                        ...
                        function cr(e, t, n, r, i, s) {
                            ...
                            var d = s.get(e);
                            if (d) return d;
                            if (s.set(e, a), sa(e)) return e.forEach((function(r) {
                                a.add(cr(r, t, n, r, e, s))
                            })), a;
                            if (na(e)) return e.forEach((function(r, o) {
                                a.set(o, cr(r, t, n, o, e, s))
                            })), a;
                            var v = f ? o : (l ? c ? si : ii : c ? Ia : Na)(e);
                            return jt(v || e, (function(r, o) {
                        ...
                        function hr(e, t, n, r) {
                            var o = -1,
                                ...
                                c = t.length;
                            if (!a) return u;
                            n && (t = Lt(t, Xt(n))), r ? (i = Rt, s = !1) : t.length >= 200 && (i = en, s = !1, t = new Zn(t));
                            e: for (; ++o < a;) {
                                var l = e[o],
                                    f = null == n ? l : n(l);
                        ...
                        Wn.templateSettings = {
                        ...
                        }, Wn.prototype = zn.prototype, Wn.prototype.constructor = Wn, qn.prototype = Hn(zn.prototype), qn.prototype.constructor = qn, $n.prototype = Hn(zn.prototype), $n.prototype.constructor = $n, Vn.prototype.clear = function() {
                            ...
                            var n = this.__data__;
                            return this.size += this.has(e) ? 0 : 1, n[e] = Tn && t === o ? s : t, this
                        ...
                        function yr(e, t, n) {
                            for (var r = -1, i = e.length; ++r < i;) {
                                var s = e[r],
                                    a = t(s);
                                if (null != a && (u === o ? a == a && !ua(a) : n(a, u))) var u = a,
                                    c = s
                            }
                            return c
                        }
                        ...
                        function mr(e, t, n, r, o) {
                            ...
                            for (n || (n = _i), o || (o = []); ++i < s;) {
                                var a = e[i];
                                t > 0 && n(a) ? t > 1 ? mr(a, t - 1, n, r, o) : Ft(o, a) : r || (o[o.length] = a)
                            }
                            return o
                        }
                        var _r = Fo(),
                        ...
                        function Ar(e, t) {
                            for (var n = 0, r = (t = wo(t, e)).length; null != e && n < r;) e = e[Mi(t[n++])];
                            return n && n == r ? e : o
                        }
                        ...
                        function Pr(e) {
                            return null == e ? e === o ? "[object Undefined]" : "[object Null]" : nt && nt in ke(e) ? function(e) {
                                var t = Me.call(e, nt),
                                    n = e[nt];
                                try {
                                    e[nt] = o;
                        ...
                        function Tr(e, t, n) {
                            for (var i = n ? Rt : Ct, s = e[0].length, a = e.length, u = a, c = r(a), l = 1 / 0, f = []; u--;) {
                                var h = e[u];
                                u && t && (h = Lt(h, Xt(t))), l = bn(h.length, l), c[u] = !n && (t || s >= 120 && h.length >= 120) ? new Zn(u && h) : o
                            }
                            h = e[0];
                            var p = -1,
                                d = c[0];
                            e: for (; ++p < s && f.length < l;) {
                                var v = h[p],
                                    y = t ? t(v) : v;
                                if (v = n || 0 !== v ? v : 0, !(d ? en(d, y) : i(f, y, n))) {
                                    for (u = a; --u;) {
                                        var g = c[u];
                        ...
                        function Cr(e, t, n, r, i) {
                            return e === t || (null == e || null == t || !ta(e) && !ta(t) ? e != e && t != t : function(e, t, n, r, i, s) {
                                var a = qs(e),
                                    u = qs(t),
                                    c = a ? _ : yi(e),
                                    l = u ? _ : yi(t),
                                ...
                                if (p && !f) return s || (s = new Kn), a || ca(e) ? ri(e, t, n, r, i, s) : function(e, t, n, r, o, i, s) {
                                    switch (n) {
                                        case L:
                                        ...
                                        case T:
                                            var u = 1 & r;
                                            if (a || (a = hn), e.size != t.size && !u) return !1;
                                            var c = s.get(e);
                                            if (c) return c == t;
                                            r |= 2, s.set(e, t);
                                ...
                                return s || (s = new Kn),
                                    function(e, t, n, r, i, s) {
                                        ...
                                        for (; ++h < c;) {
                                            var g = e[p = u[h]],
                                                m = t[p];
                                            if (r) var _ = a ? r(m, g, p, t, e, s) : r(g, m, p, e, t, s);
                                            if (!(_ === o ? g === m || i(g, m, n, r, s) : _)) {
                                                v = !1;
                                                break
                                            }
                                            y || (y = "constructor" == p)
                        ...
                        function Lr(e) {
                            return !(!ea(e) || (t = e, Be && Be in t)) && (Qs(e) ? ze : me).test(Di(e));
                            var t
                        }

                        function Fr(e) {
                            return "function" == typeof e ? e : null == e ? ru : "object" == typeof e ? qs(e) ? Hr(e[0], e[1]) : Wr(e) : hu(e)
                        }
                        ...
                        function Wr(e) {
                            var t = hi(e);
                            return 1 == t.length && t[0][2] ? Oi(t[0][0], t[0][1]) : function(n) {
                                return n === e || Rr(n, e, t)
                            }
                        }

                        function Hr(e, t) {
                            return xi(e) && Pi(t) ? Oi(Mi(e), t) : function(n) {
                                var r = Pa(n, e);
                                    ...
                                    function(e, t, n, r, i, s, a) {
                                        ...
                                        if (h) {
                                            var p = qs(c),
                                                d = !p && Js(c),
                                                v = !p && !d && ca(c);
                                            f = c, p || d || v ? qs(u) ? f = u : Gs(u) ? f = No(u) : d ? (h = !1, f = So(c, !0)) : v ? (h = !1, f = Oo(c, !0)) : f = [] : oa(c) || zs(c) ? (f = u, zs(u) ? f = ga(u) : (!ea(u) || r && Qs(u)) && (f = mi(c))) : h = !1
                                        }
                        ...
                        function Gr(e, t, n, r) {
                            ...
                            for (e === t && (t = No(t)), n && (a = Lt(e, Xt(n))); ++i < s;)
                                for (var u = 0, c = t[i], l = n ? n(c) : c;
                                    (u = o(a, l, u, r)) > -1;) a !== e && Qe.call(a, u, 1), Qe.call(e, u, 1);
                            return e
                        }
                        ...
                        function eo(e, t, n, r) {
                            ...
                            for (var i = -1, s = (t = wo(t, e)).length, a = s - 1, u = e; null != u && ++i < s;) {
                                ...
                                if (i != a) {
                                    var f = u[c];
                                    (l = r ? r(f, c, u) : o) === o && (l = ea(f) ? f : bi(t[i + 1]) ? [] : {})
                                }
                                nr(u, c, l), u = u[c]
                            }
                            return e
                        ...
                        function so(e, t, n) {
                            ...
                            if ("number" == typeof t && t == t && o <= 2147483647) {
                                for (; r < o;) {
                                    var i = r + o >>> 1,
                                        s = e[i];
                                    null !== s && !ua(s) && (n ? s <= t : s < t) ? r = i + 1 : o = i
                                }
                                return o
                            }
                            return ao(e, t, ru, n)
                        ...
                        function ao(e, t, n, r) {
                            t = n(t);
                            for (var i = 0, s = null == e ? 0 : e.length, a = t != t, u = null === t, c = ua(t), l = t === o; i < s;) {
                                var f = gt((i + s) / 2),
                                    h = n(e[f]),
                                    p = h !== o,
                                    d = null === h,
                        ...
                        function ho(e, t) {
                            return null == (e = ji(e, t = wo(t, e))) || delete e[Mi(Ki(t))]
                        }
                        ...
                        function yo(e, t) {
                            var n = e;
                            return n instanceof $n && (n = n.value()), Mt(t, (function(e, t) {
                        ...
                        function go(e, t, n) {
                            ...
                            for (var i = -1, s = r(o); ++i < o;)
                                for (var a = e[i], u = -1; ++u < o;) u != i && (s[i] = hr(s[i] || a, e[u], t, n));
                        ...
                        function ko(e, t) {
                            if (e !== t) {
                                var n = e !== o,
                                    ...
                                    c = t == t,
                                    l = ua(t);
                                if (!u && !l && !s && e > t || s && a && c && !u && !l || r && a && c || !n && c || !i) return 1;
                                if (!r && !s && !l && e < t || l && n && i && !r && !s || u && n && i || !a && i || !c) return -1
                            }
                            return 0
                        }

                        function jo(e, t, n, o) {
                            for (var i = -1, s = e.length, a = n.length, u = -1, c = t.length, l = _n(s - a, 0), f = r(c + l), h = !o; ++u < c;) f[u] = t[u];
                        ...
                        function To(e, t, n, o) {
                            for (var i = -1, s = e.length, a = -1, u = n.length, c = -1, l = t.length, f = _n(s - u, 0), h = r(f + l), p = !o; ++i < f;) h[i] = e[i];
                        ...
                        function Ro(e) {
                            return Qr((function(t, n) {
                                var r = -1,
                                    ...
                                    s = i > 1 ? n[i - 1] : o,
                                    a = i > 2 ? n[2] : o;
                                for (s = e.length > 3 && "function" == typeof s ? (i--, s) : o, a && wi(n[0], n[1], a) && (s = i < 3 ? o : s, i = 1), t = ke(t); ++r < i;) {
                                    var u = n[r];
                                    u && e(t, u, r, s)
                                }
                                return t
                        ...
                        function Lo(e, t) {
                            return function(n, r) {
                                ...
                                for (var o = n.length, i = t ? o : -1, s = ke(n);
                                    (t ? i-- : ++i < o) && !1 !== r(s[i], i, s););
                                return n
                            }
                        }
                        ...
                        function Wo(e) {
                            return oi((function(t) {
                                ...
                                for (r = u ? r : n; ++r < n;) {
                                    var c = ui(a = t[r]),
                                        l = "wrapper" == c ? ai(a) : o;
                                    u = l && Ei(l[0]) && 424 == l[1] && !l[4].length && 1 == l[9] ? u[ui(l[0])].apply(u, l[3]) : 1 == a.length && Ei(a) ? u[c]() : u.thru(a)
                                }
                                return function() {
                                    var e = arguments,
                                        r = e[0];
                        ...
                        function Ho(e, t, n, i, s, a, u, c, l, h) {
                            ...
                            return function f() {
                                ...
                                if (i && (b = jo(b, i, s, y)), a && (b = To(b, a, u, y)), _ -= E, y && _ < h) {
                                    var A = ln(b, x);
                                ...
                                return _ = b.length, c ? b = function(e, t) {
                                    ...
                                    return e
                                }(b, c) : g && _ > 1 && b.reverse(), p && l < _ && (b.length = l), this && this !== vt && this instanceof f && (P = m || Bo(P)), P.apply(S, b)
                            }
                        }
                        ...
                        function qo(e, t) {
                            return function(n, r) {
                                ...
                                if (n !== o && (i = n), r !== o) {
                                    if (i === o) return r;
                                    "string" == typeof n || "string" == typeof r ? (n = lo(n), r = lo(r)) : (n = co(n), r = co(r)), i = e(n, r)
                                }
                                return i
                            }
                        }
                        ...
                        function $o(e) {
                            return oi((function(t) {
                                return t = Lt(t, Xt(li())), Qr((function(n) {
                                    var r = this;
                        ...
                        function Go(e) {
                            return function(t, n, i) {
                                return i && "number" != typeof i && wi(t, n, i) && (n = i = o), t = pa(t), n === o ? (n = t, t = 0) : n = pa(n),
                                    function(e, t, n, o) {
                                        for (var i = -1, s = _n(yt((t - e) / (n || 1)), 0), a = r(s); s--;) a[o ? s : ++i] = e, e += n;
                                        return a
                        ...
                        function Zo(e, t, n, r, i, s, a, u, f, h) {
                            ...
                            var d = [e, t, i, p ? s : o, p ? a : o, p ? o : s, p ? o : a, u, f, h],
                                v = n.apply(o, d);
                        ...
                        var Qo = kn && 1 / hn(new kn([, -0]))[1] == p ? function(e) {
                            return new kn(e)
                        } : uu;
                        ...
                        function Xo(e) {
                            return function(t) {
                                var n = yi(t);
                                return n == S ? un(t) : n == T ? pn(t) : function(e, t) {
                                    return Lt(t, (function(t) {
                                        return [t, e[t]]
                                    }))
                                }(t, e(t))
                        ...
                        function Yo(e, t, n, s, p, d, v, y) {
                            ...
                            var m = s ? s.length : 0;
                            if (m || (t &= -97, s = p = o), v = v === o ? v : _n(da(v), 0), y = y === o ? y : da(y), m -= p ? p.length : 0, t & l) {
                                var _ = s,
                                    b = p;
                                s = p = o
                            }
                            ...
                            if (w && function(e, t) {
                                    var n = e[1],
                                        ...
                                        o = n | r,
                                        i = o < 131,
                                        s = r == f && 8 == n || r == f && n == h && e[7].length <= t[8] || 384 == r && t[7].length <= t[8] && 8 == n;
                                    if (!i && !s) return e;
                                    1 & r && (e[2] = t[2], o |= 1 & n ? 0 : 4);
                                    var u = t[3];
                                    if (u) {
                                        var c = e[3];
                                        e[3] = c ? jo(c, u, t[4]) : u, e[4] = c ? ln(e[3], a) : t[4]
                                    }(u = t[5]) && (c = e[5], e[5] = c ? To(c, u, t[6]) : u, e[6] = c ? ln(e[5], a) : t[6]);
                                    (u = t[7]) && (e[7] = u);
                                    r & f && (e[8] = null == e[8] ? t[8] : bn(e[8], t[8]));
                                    null == e[9] && (e[9] = t[9]);
                                    e[0] = t[0], e[1] = o
                                }(x, w), e = x[0], t = x[1], n = x[2], s = x[3], p = x[4], !(y = x[9] = x[9] === o ? g ? 0 : e.length : _n(x[9] - m, 0)) && 24 & t && (t &= -25), t && 1 != t) E = 8 == t || t == u ? function(e, t, n) {
                                var i = Bo(e);
                                return function s() {
                                    for (var a = arguments.length, u = r(a), c = a, l = ci(s); c--;) u[c] = arguments[c];
                                    var f = a < 3 && u[0] !== l && u[a - 1] !== l ? [] : ln(u, l);
                                    return (a -= f.length) < n ? Zo(e, t, Ho, s.placeholder, o, u, f, o, o, n - a) : Ot(this && this !== vt && this instanceof s ? i : e, this, u)
                                }
                            }(e, t, y) : t != c && 33 != t || p.length ? Ho.apply(o, x) : function(e, t, n, o) {
                                var i = 1 & t,
                                    s = Bo(e);
                                return function t() {
                                    for (var a = -1, u = arguments.length, c = -1, l = o.length, f = r(l + u), h = this && this !== vt && this instanceof t ? s : e; ++c < l;) f[c] = o[c];
                        ...
                        function ti(e, t, n, r, i, s) {
                            return ea(e) && ea(t) && (s.set(t, e), zr(e, t, o, ti, s), s.delete(t)), e
                        }
                            ...
                            for (s.set(e, t), s.set(t, e); ++f < u;) {
                                ...
                                if (p) {
                                    if (!Bt(t, (function(e, t) {
                                            if (!en(p, t) && (d === e || i(d, e, n, r, s))) return p.push(t)
                                        }))) {
                                        h = !1;
                                        break
                                    }
                        ...
                        function li() {
                            ...
                            return e = e === ou ? Fr : e, arguments.length ? e(arguments[0], arguments[1]) : e
                        }
                        ...
                        function gi(e, t, n) {
                            ...
                            return i || ++r != o ? i : !!(o = null == e ? 0 : e.length) && Ys(o) && bi(s, o) && (qs(e) || zs(e))
                        }

                        function mi(e) {
                            return "function" != typeof e.constructor || Si(e) ? {} : Hn(Je(e))
                        }
                        ...
                        function wi(e, t, n) {
                            if (!ea(n)) return !1;
                            var r = typeof t;
                            return !!("number" == r ? Vs(n) && bi(t, n.length) : "string" == r && t in n) && Us(n[t], e)
                        }

                        function xi(e, t) {
                            if (qs(e)) return !1;
                            var n = typeof e;
                            return !("number" != n && "symbol" != n && "boolean" != n && null != e && !ua(e)) || (ne.test(e) || !te.test(e) || null != t && e in ke(t))
                        }
                        ...
                        function Ei(e) {
                            ...
                            var r = ai(n);
                            return !!r && e === r[0]
                        }(Sn && yi(new Sn(new ArrayBuffer(1))) != L || Pn && yi(new Pn) != S || On && yi(On.resolve()) != k || kn && yi(new kn) != T || jn && yi(new jn) != C) && (yi = function(e) {
                            var t = Pr(e),
                        ...
                        var Ui = Qr((function(e, t) {
                            ...
                            Wi = Qr((function(e, t) {
                                var n = Ki(t);
                                return Gs(n) && (n = o), Gs(e) ? hr(e, mr(t, 1, Gs, !0), li(n, 2)) : []
                            })),
                            Hi = Qr((function(e, t) {
                                var n = Ki(t);
                                return Gs(n) && (n = o), Gs(e) ? hr(e, mr(t, 1, Gs, !0), o, n) : []
                            }));
                        ...
                        function qi(e, t, n) {
                            ...
                            if (!r) return -1;
                            var i = r - 1;
                            return n !== o && (i = da(n), i = n < 0 ? _n(r + i, 0) : bn(i, r - 1)), Ht(e, li(t, 3), i, !0)
                        }
                        ...
                        var Gi = Qr((function(e) {
                            ...
                            Ji = Qr((function(e) {
                                var t = Ki(e),
                                    n = Lt(e, _o);
                                return t === Ki(n) ? t = o : n.pop(), n.length && n[0] === e[0] ? Tr(n, li(t, 2)) : []
                            })),
                            Zi = Qr((function(e) {
                                var t = Ki(e),
                                    n = Lt(e, _o);
                        ...
                        var ts = Qr((function(e) {
                            ...
                            rs = Qr((function(e) {
                                var t = Ki(e);
                                return t = "function" == typeof t ? t : o, fo(mr(e, 1, Gs, !0), o, t)
                            }));
                        ...
                        var ss = Qr((function(e, t) {
                            ...
                            cs = Qr((function(e) {
                                var t = Ki(e);
                                return t = "function" == typeof t ? t : o, go(It(e, Gs), o, t)
                            })),
                            ls = Qr(os);
                        ...
                        var ds = oi((function(e) {
                            ...
                            return !(t > 1 || this.__actions__.length) && r instanceof $n && bi(n) ? ((r = r.slice(n, +n + (t ? 1 : 0))).__actions__.push({
                                func: ps,
                                args: [i],
                                thisArg: o
                        ...
                        var Ss = Qr((function(e, t) {
                                if (null == e) return [];
                                var n = t.length;
                                return n > 1 && wi(e, t[0], t[1]) ? t = [] : n > 2 && wi(t[0], t[1], t[2]) && (t = [t[0]]), $r(e, mr(t, 1), [])
                            })),
                            Ps = pt || function() {
                                return vt.Date.now()
                            };
                        ...
                        function Os(e, t, n) {
                            return t = n ? o : t, t = e && null == t ? e.length : t, Yo(e, f, o, o, o, o, t)
                        }
                        ...
                        function Ns(e, t, n) {
                            ...
                            return t = ya(t) || 0, ea(n) && (h = !!n.leading, a = (p = "maxWait" in n) ? _n(ya(n.maxWait) || 0, t) : a, d = "trailing" in n ? !!n.trailing : d), _.cancel = function() {
                        ...
                        var Fs = xo((function(e, t) {
                                var n = (t = 1 == t.length && qs(t[0]) ? Lt(t[0], Xt(li())) : Lt(mr(t, 1), Xt(li()))).length;
                        ...
                        var Ws = Jo(Or),
                            ...
                            zs = Ir(function() {
                                ...
                                return ta(e) && Me.call(e, "callee") && !Ke.call(e, "callee")
                            },
                            qs = r.isArray,
                        ...
                        function oa(e) {
                            ...
                            return "function" == typeof n && n instanceof n && Fe.call(n) == We
                        }
                        var ia = At ? Xt(At) : function(e) {
                            return ta(e) && Pr(e) == j
                        };
                        var sa = St ? Xt(St) : function(e) {
                            return ta(e) && yi(e) == T
                        };
                        ...
                        function ya(e) {
                            ...
                            e = e.replace(se, "");
                            var n = ge.test(e);
                            return n || _e.test(e) ? ht(e.slice(2), n ? 2 : 8) : ye.test(e) ? v : +e
                        }
                        ...
                        var Aa = Qr((function(e, t) {
                                ...
                                for (i && wi(t[0], t[1], i) && (r = 1); ++n < r;)
                                    for (var s = t[n], a = Ia(s), u = -1, c = a.length; ++u < c;) {
                                        var l = a[u],
                                            f = e[l];
                                        (f === o || Us(f, Re[l]) && !Me.call(e, l)) && (e[l] = s[l])
                                    }
                                return e
                            })),
                            Sa = Qr((function(e) {
                        ...
                        var ka = zo((function(e, t, n) {
                            ...
                            ja = zo((function(e, t, n) {
                                null != t && "function" != typeof t.toString && (t = Ue.call(t)), Me.call(e, t) ? e[t].push(n) : e[t] = [n]
                            }), li),
                            Ta = Qr(Nr);
                        ...
                        function Ma(e, t) {
                            ...
                            return t = li(t), Vr(e, n, (function(e, n) {
                                return t(e, n[0])
                            }))
                        }
                        var Da = Xo(Na),
                        ...
                        function au(e, t, n) {
                            var r = Na(t),
                                o = Er(t, r);
                            null != n || ea(t) && (o.length || !r.length) || (n = t, t = e, e = this, o = Er(t, Na(t)));
                        ...
                        function hu(e) {
                            return xi(e) ? Gt(Mi(e)) : function(e) {
                                return function(t) {
                                    return Ar(t, e)
                                }
                            }(e)
                        ...
                        return Wn.after = function(e, t) {
                        ...
                        }, Wn.ary = Os, Wn.assign = _a, Wn.assignIn = ba, Wn.assignInWith = wa, Wn.assignWith = xa, Wn.at = Ea, Wn.before = ks, Wn.bind = js, Wn.bindAll = Ya, Wn.bindKey = Ts, Wn.castArray = function() {
                            if (!arguments.length) return [];
                            var e = arguments[0];
                            return qs(e) ? e : [e]
                        }, Wn.chain = hs, Wn.chunk = function(e, t, n) {
                            t = (n ? wi(e, t, n) : t === o) ? 1 : _n(da(t), 0);
                            var i = null == e ? 0 : e.length;
                            if (!i || t < 1) return [];
                            for (var s = 0, a = 0, u = r(yt(i / t)); s < i;) u[a++] = oo(e, s, s += t);
                            return u
                        ...
                        }, Wn.constant = eu, Wn.countBy = vs, Wn.create = function(e, t) {
                            var n = Hn(e);
                            ...
                            return i.placeholder = e.placeholder, i
                        }, Wn.debounce = Ns, Wn.defaults = Aa, Wn.defaultsDeep = Sa, Wn.defer = Is, Wn.delay = Cs, Wn.difference = Ui, Wn.differenceBy = Wi, Wn.differenceWith = Hi, Wn.drop = function(e, t, n) {
                            var r = null == e ? 0 : e.length;
                            return r ? oo(e, (t = n || t === o ? 1 : da(t)) < 0 ? 0 : t, r) : []
                        }, Wn.dropRight = function(e, t, n) {
                            var r = null == e ? 0 : e.length;
                            return r ? oo(e, 0, (t = r - (t = n || t === o ? 1 : da(t))) < 0 ? 0 : t) : []
                            ...
                            return i ? (n && "number" != typeof n && wi(e, t, n) && (n = 0, r = i), function(e, t, n, r) {
                                var i = e.length;
                                for ((n = da(n)) < 0 && (n = -n > i ? 0 : i + n), (r = r === o || r > i ? i : da(r)) < 0 && (r += i), r = n > r ? 0 : va(r); n < r;) e[n++] = t;
                                return e
                            }(e, t, n, r)) : []
                        ...
                        }, Wn.flatten = $i, Wn.flattenDeep = function(e) {
                            return (null == e ? 0 : e.length) ? mr(e, p) : []
                        }, Wn.flattenDepth = function(e, t) {
                            return (null == e ? 0 : e.length) ? mr(e, t = t === o ? 1 : da(t)) : []
                        }, Wn.flip = function(e) {
                            return Yo(e, 512)
                        }, Wn.flow = tu, Wn.flowRight = nu, Wn.fromPairs = function(e) {
                        ...
                        }, Wn.groupBy = bs, Wn.initial = function(e) {
                            return (null == e ? 0 : e.length) ? oo(e, 0, -1) : []
                        }, Wn.intersection = Gi, Wn.intersectionBy = Ji, Wn.intersectionWith = Zi, Wn.invert = ka, Wn.invertBy = ja, Wn.invokeMap = ws, Wn.iteratee = ou, Wn.keyBy = xs, Wn.keys = Na, Wn.keysIn = Ia, Wn.map = Es, Wn.mapKeys = function(e, t) {
                            var n = {};
                            return t = li(t, 3), wr(e, (function(e, r, o) {
                                sr(n, t(e, r, o), e)
                            })), n
                            ...
                            return Hr(e, cr(t, 1))
                        }, Wn.memoize = Rs, Wn.merge = Ca, Wn.mergeWith = Ra, Wn.method = iu, Wn.methodOf = su, Wn.mixin = au, Wn.negate = Ls, Wn.nthArg = function(e) {
                            return e = da(e), Qr((function(t) {
                                return qr(t, e)
                            }))
                        }, Wn.omit = La, Wn.omitBy = function(e, t) {
                            return Ma(e, Ls(li(t)))
                        }, Wn.once = function(e) {
                            return ks(2, e)
                        }, Wn.orderBy = function(e, t, n, r) {
                            return null == e ? [] : (qs(t) || (t = null == t ? [] : [t]), qs(n = r ? o : n) || (n = null == n ? [] : [n]), $r(e, t, n))
                        }, Wn.over = cu, Wn.overArgs = Fs, Wn.overEvery = lu, Wn.overSome = fu, Wn.partial = Ms, Wn.partialRight = Ds, Wn.partition = As, Wn.pick = Fa, Wn.pickBy = Ma, Wn.property = hu, Wn.propertyOf = function(e) {
                            return function(t) {
                                return null == e ? o : Ar(e, t)
                            }
                        }, Wn.pull = Qi, Wn.pullAll = Xi, Wn.pullAllBy = function(e, t, n) {
                            return e && e.length && t && t.length ? Gr(e, t, li(n, 2)) : e
                        }, Wn.pullAllWith = function(e, t, n) {
                            return e && e.length && t && t.length ? Gr(e, t, o, n) : e
                        }, Wn.pullAt = Yi, Wn.range = pu, Wn.rangeRight = du, Wn.rearg = Bs, Wn.reject = function(e, t) {
                        ...
                        }, Wn.reverse = es, Wn.sampleSize = function(e, t, n) {
                            return t = (n ? wi(e, t, n) : t === o) ? 1 : da(t), (qs(e) ? Yn : Yr)(e, t)
                            ...
                            var r = null == e ? 0 : e.length;
                            return r ? (n && "number" != typeof n && wi(e, t, n) ? (t = 0, n = r) : (t = null == t ? 0 : da(t), n = n === o ? r : da(n)), oo(e, t, n)) : []
                        }, Wn.sortBy = Ss, Wn.sortedUniq = function(e) {
                            return e && e.length ? uo(e) : []
                        }, Wn.sortedUniqBy = function(e, t) {
                            return e && e.length ? uo(e, li(t, 2)) : []
                        }, Wn.split = function(e, t, n) {
                            return n && "number" != typeof n && wi(e, t, n) && (t = n = o), (n = n === o ? y : n >>> 0) ? (e = ma(e)) && ("string" == typeof t || null != t && !ia(t)) && !(t = lo(t)) && an(e) ? Eo(vn(e), 0, n) : e.split(t, n) : []
                        }, Wn.spread = function(e, t) {
                            if ("function" != typeof e) throw new Ne(i);
                            return t = null == t ? 0 : _n(da(t), 0), Qr((function(n) {
                                var r = n[t],
                                    o = Eo(n, 0, t);
                            ...
                            return e && e.length ? oo(e, 0, (t = n || t === o ? 1 : da(t)) < 0 ? 0 : t) : []
                        }, Wn.takeRight = function(e, t, n) {
                            var r = null == e ? 0 : e.length;
                            return r ? oo(e, (t = r - (t = n || t === o ? 1 : da(t))) < 0 ? 0 : t, r) : []
                            ...
                            var r = !0,
                                o = !0;
                            if ("function" != typeof e) throw new Ne(i);
                            return ea(n) && (r = "leading" in n ? !!n.leading : r, o = "trailing" in n ? !!n.trailing : o), Ns(e, t, {
                                leading: r,
                                maxWait: t,
                                trailing: o
                            })
                        }, Wn.thru = ps, Wn.toArray = ha, Wn.toPairs = Da, Wn.toPairsIn = Ba, Wn.toPath = function(e) {
                            return qs(e) ? Lt(e, Mi) : ua(e) ? [e] : No(Fi(ma(e)))
                        }, Wn.toPlainObject = ga, Wn.transform = function(e, t, n) {
                            var r = qs(e),
                                o = r || Js(e) || ca(e);
                            if (t = li(t, 4), null == n) {
                                var i = e && e.constructor;
                                n = o ? r ? new i : [] : ea(e) && Qs(i) ? Hn(Je(e)) : {}
                            }
                            return (o ? jt : wr)(e, (function(e, r, o) {
                                return t(n, e, r, o)
                            })), n
                        }, Wn.unary = function(e) {
                            return Os(e, 1)
                        }, Wn.union = ts, Wn.unionBy = ns, Wn.unionWith = rs, Wn.uniq = function(e) {
                        ...
                        }, Wn.unzip = os, Wn.unzipWith = is, Wn.update = function(e, t, n) {
                            return null == e ? e : po(e, t, bo(n))
                        }, Wn.updateWith = function(e, t, n, r) {
                            return r = "function" == typeof r ? r : o, null == e ? e : po(e, t, bo(n), r)
                        }, Wn.values = Ua, Wn.valuesIn = function(e) {
                            return null == e ? [] : Yt(e, Ia(e))
                        }, Wn.without = ss, Wn.words = Qa, Wn.wrap = function(e, t) {
                            return Ms(bo(t), e)
                        }, Wn.xor = as, Wn.xorBy = us, Wn.xorWith = cs, Wn.zip = ls, Wn.zipObject = function(e, t) {
                            return mo(e || [], t || [], nr)
                        }, Wn.zipObjectDeep = function(e, t) {
                            return mo(e || [], t || [], eo)
                        }, Wn.zipWith = fs, Wn.entries = Da, Wn.entriesIn = Ba, Wn.extend = ba, Wn.extendWith = wa, au(Wn, Wn), Wn.add = gu, Wn.attempt = Xa, Wn.camelCase = Wa, Wn.capitalize = Ha, Wn.ceil = mu, Wn.clamp = function(e, t, n) {
                            return n === o && (n = t, t = o), n !== o && (n = (n = ya(n)) == n ? n : 0), t !== o && (t = (t = ya(t)) == t ? t : 0), ur(ya(e), t, n)
                        }, Wn.clone = function(e) {
                            return cr(e, 4)
                        ...
                        }, Wn.deburr = za, Wn.defaultTo = function(e, t) {
                            return null == e || e != e ? t : e
                        }, Wn.divide = _u, Wn.endsWith = function(e, t, n) {
                            e = ma(e), t = lo(t);
                            var r = e.length,
                                i = n = n === o ? r : ur(da(n), 0, r);
                            return (n -= t.length) >= 0 && e.slice(n, i) == t
                        }, Wn.eq = Us, Wn.escape = function(e) {
                        ...
                        }, Wn.find = ys, Wn.findIndex = zi, Wn.findKey = function(e, t) {
                            return Wt(e, li(t, 3), wr)
                        }, Wn.findLast = gs, Wn.findLastIndex = qi, Wn.findLastKey = function(e, t) {
                            return Wt(e, li(t, 3), xr)
                        }, Wn.floor = bu, Wn.forEach = ms, Wn.forEachRight = _s, Wn.forIn = function(e, t) {
                        ...
                        }, Wn.get = Pa, Wn.gt = Ws, Wn.gte = Hs, Wn.has = function(e, t) {
                            return null != e && gi(e, t, kr)
                        }, Wn.hasIn = Oa, Wn.head = Vi, Wn.identity = ru, Wn.includes = function(e, t, n, r) {
                            e = Vs(e) ? e : Ua(e), n = n && !r ? da(n) : 0;
                            var o = e.length;
                            return n < 0 && (n = _n(o + n, 0)), aa(e) ? n <= o && e.indexOf(t, n) > -1 : !!o && zt(e, t, n) > -1
                        ...
                        }, Wn.invoke = Ta, Wn.isArguments = zs, Wn.isArray = qs, Wn.isArrayBuffer = $s, Wn.isArrayLike = Vs, Wn.isArrayLikeObject = Gs, Wn.isBoolean = function(e) {
                            return !0 === e || !1 === e || ta(e) && Pr(e) == b
                        }, Wn.isBuffer = Js, Wn.isDate = Zs, Wn.isElement = function(e) {
                            return ta(e) && 1 === e.nodeType && !oa(e)
                        }, Wn.isEmpty = function(e) {
                            if (null == e) return !0;
                            if (Vs(e) && (qs(e) || "string" == typeof e || "function" == typeof e.splice || Js(e) || ca(e) || zs(e))) return !e.length;
                            var t = yi(e);
                        ...
                        }, Wn.isError = Ks, Wn.isFinite = function(e) {
                            return "number" == typeof e && Ut(e)
                        }, Wn.isFunction = Qs, Wn.isInteger = Xs, Wn.isLength = Ys, Wn.isMap = na, Wn.isMatch = function(e, t) {
                            return e === t || Rr(e, t, hi(t))
                        }, Wn.isMatchWith = function(e, t, n) {
                            return n = "function" == typeof n ? n : o, Rr(e, t, hi(t), n)
                        }, Wn.isNaN = function(e) {
                            return ra(e) && e != +e
                        }, Wn.isNative = function(e) {
                            if (Ai(e)) throw new Se("Unsupported core-js use. Try https://npms.io/search?q=ponyfill.");
                            return Lr(e)
                        }, Wn.isNil = function(e) {
                            return null == e
                        }, Wn.isNull = function(e) {
                            return null === e
                        }, Wn.isNumber = ra, Wn.isObject = ea, Wn.isObjectLike = ta, Wn.isPlainObject = oa, Wn.isRegExp = ia, Wn.isSafeInteger = function(e) {
                            return Xs(e) && e >= -9007199254740991 && e <= d
                        }, Wn.isSet = sa, Wn.isString = aa, Wn.isSymbol = ua, Wn.isTypedArray = ca, Wn.isUndefined = function(e) {
                            return e === o
                        ...
                        }, Wn.kebabCase = qa, Wn.last = Ki, Wn.lastIndexOf = function(e, t, n) {
                            var r = null == e ? 0 : e.length;
                            if (!r) return -1;
                            var i = r;
                            return n !== o && (i = (i = da(n)) < 0 ? _n(r + i, 0) : bn(i, r - 1)), t == t ? function(e, t, n) {
                                for (var r = n + 1; r--;)
                                    if (e[r] === t) return r;
                                return r
                            }(e, t, i) : Ht(e, $t, i, !0)
                        }, Wn.lowerCase = $a, Wn.lowerFirst = Va, Wn.lt = la, Wn.lte = fa, Wn.max = function(e) {
                        ...
                        }, Wn.stubArray = vu, Wn.stubFalse = yu, Wn.stubObject = function() {
                            return {}
                        }, Wn.stubString = function() {
                            return ""
                        }, Wn.stubTrue = function() {
                            return !0
                        }, Wn.multiply = xu, Wn.nth = function(e, t) {
                            return e && e.length ? qr(e, da(t)) : o
                        }, Wn.noConflict = function() {
                            return vt._ === this && (vt._ = He), this
                        }, Wn.noop = uu, Wn.now = Ps, Wn.pad = function(e, t, n) {
                            e = ma(e);
                            var r = (t = da(t)) ? dn(e) : 0;
                            if (!t || r >= t) return e;
                            var o = (t - r) / 2;
                            ...
                            return n || null == t ? t = 0 : t && (t = +t), xn(ma(e).replace(ae, ""), t || 0)
                        }, Wn.random = function(e, t, n) {
                            if (n && "boolean" != typeof n && wi(e, t, n) && (t = n = o), n === o && ("boolean" == typeof t ? (n = t, t = o) : "boolean" == typeof e && (n = e, e = o)), e === o && t === o ? (e = 0, t = 1) : (e = pa(e), t === o ? (t = e, e = 0) : t = pa(t)), e > t) {
                                var r = e;
                                e = t, t = r
                            }
                            if (n || e % 1 || t % 1) {
                            ...
                            return t = (n ? wi(e, t, n) : t === o) ? 1 : da(t), Kr(ma(e), t)
                        }, Wn.replace = function() {
                            var e = arguments,
                                t = ma(e[0]);
                            ...
                            return e
                        }, Wn.round = Eu, Wn.runInContext = e, Wn.sample = function(e) {
                            return (qs(e) ? Xn : Xr)(e)
                        }, Wn.size = function(e) {
                            if (null == e) return 0;
                        ...
                        }, Wn.snakeCase = Ga, Wn.some = function(e, t, n) {
                            var r = qs(e) ? Bt : io;
                            return n && wi(e, t, n) && (t = o), r(e, li(t, 3))
                            ...
                            return -1
                        }, Wn.startCase = Ja, Wn.startsWith = function(e, t, n) {
                            return e = ma(e), n = null == n ? 0 : ur(da(n), 0, e.length), t = lo(t), e.slice(n, n + t.length) == t
                        }, Wn.subtract = Au, Wn.sum = function(e) {
                            ...
                            n && wi(e, t, n) && (t = o), e = ma(e), t = wa({}, t, r, ei);
                            var i, s, a = wa({}, t.imports, r.imports, ei),
                                u = Na(a),
                                c = Yt(a, u),
                                l = 0,
                                f = t.interpolate || xe,
                                h = "__p += '",
                                p = je((t.escape || xe).source + "|" + f.source + "|" + (f === ee ? de : xe).source + "|" + (t.evaluate || xe).source + "|$", "g"),
                                d = "//# sourceURL=" + ("sourceURL" in t ? t.sourceURL : "lodash.templateSources[" + ++at + "]") + "\n";
                            e.replace(p, (function(t, n, r, o, a, u) {
                                return r || (r = o), h += e.slice(l, u).replace(Ee, sn), n && (i = !0, h += "' +\n__e(" + n + ") +\n'"), a && (s = !0, h += "';\n" + a + ";\n__p += '"), r && (h += "' +\n((__t = (" + r + ")) == null ? '' : __t) +\n'"), l = u + t.length, t
                            })), h += "';\n";
                            var v = t.variable;
                            ...
                            return o
                        }, Wn.toFinite = pa, Wn.toInteger = da, Wn.toLength = va, Wn.toLower = function(e) {
                            return ma(e).toLowerCase()
                        }, Wn.toNumber = ya, Wn.toSafeInteger = function(e) {
                            return e ? ur(da(e), -9007199254740991, d) : 0 === e ? e : 0
                        }, Wn.toString = ma, Wn.toUpper = function(e) {
                            ...
                            if (ea(t)) {
                                ...
                                n = "length" in t ? da(t.length) : n, r = "omission" in t ? lo(t.omission) : r
                            }
                            var s = (e = ma(e)).length;
                            if (an(e)) {
                                var a = vn(e);
                            ...
                            if (a && (u += c.length - u), ia(i)) {
                                if (e.slice(u).search(i)) {
                                    var l, f = c;
                                    for (i.global || (i = je(i.source, ma(ve.exec(i)) + "g")), i.lastIndex = 0; l = i.exec(f);) var h = l.index;
                                    c = c.slice(0, h === o ? u : h)
                                }
                            ...
                            var t = ++De;
                            return ma(e) + t
                        }, Wn.upperCase = Za, Wn.upperFirst = Ka, Wn.each = ms, Wn.eachRight = _s, Wn.first = Vi, au(Wn, (wu = {}, wr(Wn, (function(e, t) {
                            Me.call(Wn.prototype, t) || (wu[t] = e)
                        })), wu), {
                            chain: !1
                        }), Wn.VERSION = "4.17.10", jt(["bind", "bindKey", "curry", "curryRight", "partial", "partialRight"], (function(e) {
                            Wn[e].placeholder = Wn
                            ...
                            e = da(e);
                            var n = this;
                            return n.__filtered__ && (e > 0 || t < 0) ? new $n(n) : (e < 0 ? n = n.takeRight(-e) : e && (n = n.drop(e)), t !== o && (n = (t = da(t)) < 0 ? n.dropRight(-t) : n.take(t - e)), n)
                            ...
                            i && (Wn.prototype[t] = function() {
                                ...
                                return d && v ? e.apply(this, a) : (y = this.thru(f), d ? r ? y.value()[0] : y.value() : y)
                            })
                            ...
                            if (!n || !r && o == u && p == u) return yo(e, this.__actions__);
                            var d = [];
                            e: for (; u-- && h < p;) {
                            ...
                            return d
                        }, Wn.prototype.at = ds, Wn.prototype.chain = function() {
                            return hs(this)
                        ...
                        }, Wn.prototype.first = Wn.prototype.head, Ye && (Wn.prototype[Ye] = function() {
                            return this
                        }), Wn
                    }();
                    vt._ = gn, (r = function() {
            ...
            t.default = class {
                constructor(e) {
                    this.telemetry = e, this.lastPluginHasLoadedPromise = Promise.resolve();
                ...
                indexUrl(e, t) {
                    ...
                    return n.lastIndexOf("/") !== n.length - 1 && (n += "/"), n + "index.html"
                }
                createImport(e, t) {
                    const n = document.createElement("link");
                    return n.setAttribute("rel", "import"), n.setAttribute("href", e), n.setAttribute("data-plugin-name", t), n
                }
                insertImport(e) {
                ...
                importErrorHandler(e, t) {
                    return function() {
                        const n = e.getAttribute("href"),
                            r = new Error(`Failed to append: head.appendChild(<link href="${n}" ...>)\n Look for a 404 on the network tab.`);
                        t(r)
                    }
                }
                importLoadedHandler(e, t, n) {
                    return function() {
                        ...
                        }, o.errorHandler = n, r.dispatchEvent(o)
                    }
                }
                scriptLoadedHandler(e, t, n) {
                    const r = document,
                        o = new CustomEvent(`${s}:${n}`, {
                            detail: {
                                implName: n
                            }
                        });
                    ...
                    }, o.errorHandler = t, r.dispatchEvent(o)
                }
                scriptErrorHandler(e, t) {
                    const n = e.getAttribute("src");
                    t(new Error(`Failed to append: script(<script src="${n}" ...>)\n Look for a 404 on the network tab.`))
                }
                loadImport(e) {
                    const t = new Promise(((t, n) => {
                        e.onload = this.importLoadedHandler(e, t, n), e.onerror = this.importErrorHandler(e, n)
                    }));
                ...
                load(e, t, n, r = window) {
                    ...
                    return fetch(o).then((t => {
                        if (!t.ok) {
                            const e = {
                                    pluginFailedToLoad: !0,
                                    response: t
                                },
                                r = `${t.status}: ${t.statusText}. Failed to fetch <${n}>, falling back to an empty API.`;
                            return console.log(r), i.sendRejectEvent(n, new Error(r)), Promise.resolve([document, e])
                        }
                        return t.text().then((t => i._createPluginLoaderPromise(e, n, r, t, 2e3)))
                    }))
                }
                sendRejectEvent(e, t) {
                ...
                _createPluginLoaderPromise(e, t, n, r, s) {
                    ...
                    const d = () => {
                        h = l.addPluginContentToDocument({
                            pluginMarkup: r,
                            implName: t
                        }), f = n.setTimeout(e.dispatchEvent.bind(e, c), s), e.dispatchEvent(a)
                    };
                    if (l.instrumentPluginInitTimes) {
                        ...
                        p = l.lastPluginHasLoadedPromise.then((() => (console.time("plugin load: " + t), d(), (0, i.default)({
                            thresholdFrameCount: 10,
                            maxFrames: 1 / 0
                        }).then((n => {
                            const r = n;
                            window._riotPluginLoadTimes.push({
                                plugin: t,
                                time: r
                            }), console.timeEnd("plugin load: " + t), e()
                        })), h))), l.lastPluginHasLoadedPromise = n
                    } else d(), p = h;
                    return p.then((function(r) {
                        if ("function" != typeof r.init || "function" != typeof r.destroy) throw new Error(`Plugin API must expose init and destroy functions. The API provided for ${t} misses at least one of them.`);
                        return n.clearTimeout(f), e.dispatchEvent(u), [document, r]
                    })).catch((function(e) {
                        throw n.clearTimeout(f), l.sendRejectEvent(t, e), e
                    }))
                }
                addPluginContentToDocument({
                    pluginMarkup: e,
                    implName: t
                }) {
                    const n = document.createElement("div");
                    return n.insertAdjacentHTML("beforeend", e), this._replaceGhostScriptNode(n), this._addChildrenToHead({
                        div: n,
                        implName: t
                    })
                }
                _replaceGhostScriptNode(e) {
                    ...
                    for (let e = 0; e < t.length; e++) {
                        ...
                        o.async = n.async, o.src = n.src, r.insertBefore(o, n), r.removeChild(n)
                    }
                }
                _addChildrenToHead({
                    div: e,
                    ...
                    for (; e.children.length > 0;) {
                        ...
                        "LINK" === r.tagName && "stylesheet" === r.getAttribute("rel") && r.setAttribute("data-plugin-name", t);
                        "SCRIPT" === r.tagName && (n = new Promise(((e, n) => {
                            r.onload = () => {
                                this.scriptLoadedHandler(e, n, t), delete r.onload, delete r.onerror
                            }, r.onerror = () => {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.TelemetryEvent = t.EVENT_REGISTER_TIMEOUT = t.EVENT_REGISTER_RESOLVE = t.EVENT_REGISTER_REJECT = t.EVENT_INIT = t.EVENT_IMPORT_CREATE = t.EVENT_API_CALL = void 0;
            ...
            t.TelemetryEvent = class {
                constructor(e, t, n, r = {}) {
                    this.updateTime(), this.type = e, this.fromName = t, this.toName = n, this.args = r.args && Array.from(r.args) || [], this.nameStack = r.nameStack || [], this.error = r.err
                }
                updateTime() {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                return e = Object.assign({}, n, e), new Promise(((n, o) => {
            ...
            function r(e, t, n, o) {
                ...
                i - e.previousFrame < o.acceptableFrametimeMs ? (0 === e.highFpsFrames && (e.firstHighFpsFrame = e.previousFrame), e.highFpsFrames += 1) : e.highFpsFrames = 0, e.highFpsFrames >= o.thresholdFrameCount ? t(Math.round(e.firstHighFpsFrame - e.start)) : e.totalFrames > o.maxFrames ? n(Math.round(e.firstHighFpsFrame - e.start)) : (e.totalFrames += 1, e.previousFrame = i, window.requestAnimationFrame((() => {
                    r(e, t, n, o)
                })))
            }
        }, (e, t, n) => {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.APIError = void 0, t.awaitProvider = v, t.getProxiedInitPromise = m, t.initAll = async function(e) {
                const {
                    graph: t,
                    loaders: n
                } = e;
                ...
                const r = (await window.Promise.allSettled(Object.values(n))).filter((({
                    status: e
                }) => "fulfilled" === e)).map((({
                    value: e
                }) => e));
                await i.dispatchAll(r, i.postinitEvent), window.dispatchEvent(new Event("riotPlugin.allPluginsLoaded")), o.default.endTracingEvent("fe-plugins-loaded").catch(h), o.default.recordCriticalFlow("UI_ALL_PLUGINS_LOADED", !0, void 0)
            }, t.initPlugin = g, t.requestPlugin = function(e, t) {
                if (!t.graph.exists(e)) return Promise.reject(`${e} does not exist`);
                const n = t.graph.implementationName(e);
                if (t.graph.isLazy(n)) {
                    const r = g(e, t);
                    return t.graph.unsetLazy(n), c.injectables[n] = r.nonLazyGetInitPromise(), c.injectables[n]
                }
                return g(e, t)
            }, t.unloadPlugin = function e(t, n) {
                const o = t.implementationName(n),
                    i = t.invertedDependencies(n);
                c.unloadPromises[o] || (c.unloadPromises[o] = Promise.all(i.map((n => e(t, n)))).then((e => {
                    if (!r.default.every(e)) {
                        const t = r.default.zip(e, i).filter((([e]) => !e)).map((([e, t]) => t));
                        return console.warn(`Not unloading ${o} because the following plugins that depend on ${o}'s API do not support unloading: ${t}`), !1
                    }
                    const t = c.initApis[o].destroy();
                    return "object" != typeof t || "function" != typeof t.then || "function" != typeof t.catch ? (console.warn(`Could not unload ${o} because it did not return a valid unload promise`), !1) : t.then((() => (delete c.initApis[o], delete c.injectables[o], !0)))
                })).then((e => (delete c.unloadPromises[o], e))).catch((e => {
            ...
            function d(e, t) {
                return new Promise(((n, r) => {
                    window.requestAnimationFrame((() => {
                        p.push(e), window.dispatchEvent(new CustomEvent("riotPlugin.pluginsInitializing", {
                            detail: {
                                loadedPlugins: p
                            }
                        })), g(e, t).then(n, r)
            ...
            function v(e, t) {
                ...
                return o[e].then((([o, u]) => {
                    if (u.hasOwnProperty("pluginFailedToLoad") && u.pluginFailedToLoad) throw console.error("plugin-runtime:awaitProvider initApi failed to load, throwing...", u), new y(e, u);
            ...
            class y extends Error {
                constructor(e, t, ...n) {
                    super(`Plugin ${e} failed to load`, ...n), this.api = t, this.name = "APIError", Error.captureStackTrace && Error.captureStackTrace(this, y)
                }
            }
            ...
            function g(e, t) {
                const {
                    ...
                    basePattern: s,
                    pluginLoader: l
                } = t, f = n.implementationName(e), h = e => {
                ...
                if (!c.injectables[f]) {
                    const u = () => (r[f] = (0, a.default)(n, e) || i.loaderPromise(l, o, s, e, f), r[f].then((([e]) => (e.dispatchEvent(i.preinitEvent()), v(f, t)))).then((([e, t]) => (c.initApis[f] = e, t.setPluginName(f), Promise.resolve(e.init(t)).catch(h)))));
            ...
            e.exports = new class {
                ...
                async _makeRestRequest(e, t, n) {
                    ...
                    const r = await fetch(e, {
                        ...
                        o = await r.text();
                    if (!r.ok) throw new Error(`Telemetry request failure (${r.status}): ${o}`);
                    return o
                }
                _getData(e, t) {
                ...
                _postEventData(e, t) {
                    const n = "number" == typeof t ? "/telemetry/v1/events/general_metrics_number" : "/telemetry/v1/events/general_metrics_value",
                        r = {
                            eventName: e,
                            value: t
                        },
                ...
                _trackFrame(e, t, n, r) {
                    ...
                    o - e.previousFrame < r.acceptableFrametimeMs ? (0 === e.highFpsFrames && (e.firstHighFpsFrame = e.previousFrame), e.highFpsFrames += 1) : e.highFpsFrames = 0, e.highFpsFrames >= r.thresholdFrameCount ? t(Math.round(e.firstHighFpsFrame - e.start)) : e.totalFrames > r.maxFrames ? n(Math.round(e.firstHighFpsFrame - e.start)) : (e.totalFrames += 1, e.previousFrame = o, window.requestAnimationFrame((() => {
                        this._trackFrame(e, t, n, r)
                    })))
                }
                waitForGoodFps(e = {}) {
                    const t = window.performance.now();
                    return e = Object.assign({}, n, e), new Promise(((n, r) => {
                        window.requestAnimationFrame((() => {
                            this._trackFrame({
                                totalFrames: 0,
                                highFpsFrames: 0,
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                const r = {
                    initPromise: void 0,
                    get(r, s, a) {
                        if ("then" !== s && "constructor" !== s) return this.initPromise || (n && console.log(`${e}: Plugin lazy initialization started by ${function(){const e=(0,o.default)();if(!e||!e.length)return"unknown";const t=e[0].fileName;return e.map((e=>e.fileName)).find((e=>e!==t))||t}()} calling ${s===i.getProxiedApi?'Symbol("getProxiedApi")':s}`), this.initPromise = t()), s === i.getProxiedApi ? this.initPromise : (...t) => this.initPromise.then((n => {
                            if ("function" != typeof n[s]) throw new Error(`${s} is not a valid function of ${e}`);
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.unloadPromises = t.loaderPromises = t.injectables = t.initApis = void 0;
            t.injectables = {};
            t.initApis = {};
            t.unloadPromises = {};
            t.loaderPromises = {}
            ...
            class c {
                constructor(e, t, n) {
                    this.context = n, s.set(this, e), Object.keys(t).forEach((e => function(e, t, n) {
                        a(e).set(t, n)
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                return n && Promise.resolve([document.createElement("link"), (r = n, {
                    init: function() {
                        return r
                    },
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                if ("dev" === document.body.getAttribute("data-env")) {
                    if (!r.querySelector(".plugin-init-errors")) {
                        ...
                        e.setAttribute("style", ["position: absolute", "width: 300px", "height: 80%", "bottom: 0", "right: 0", "z-index: 100000000", "display: flex", "flex-direction: column-reverse", "color: white"].join(";")), e.className = "plugin-init-errors", r.appendChild(e), e.addEventListener("click", (t => {
                            "plugin-errors-message" === t.target.className && (e.removeChild(t.target), 0 === e.children.length && e.parentNode.removeChild(e))
                        }))
                    }
                    const t = r.querySelector(".plugin-init-errors"),
                        o = document.createElement("div");
                    o.className = "plugin-errors-message", o.setAttribute("style", ["width: 100%", "height: 100px", `background-color: ${n}`, "padding: 3px", "margin-top: 10px", "cursor: pointer", "margin-bottom: 10px", "text-align: center"].join(";")), o.innerHTML = e, t.appendChild(o)
                }
                o || console.error(e, t)
            }
        }, (e, t, n) => {
            ...
            a[o.EVENT_IMPORT_CREATE] = "Started importing plugin: {{fromName}}", a[o.EVENT_REGISTER_RESOLVE] = "Plugin registered: {{fromName}}", a[o.EVENT_REGISTER_REJECT] = "Plugin failed to register: {{fromName}}", a[o.EVENT_REGISTER_TIMEOUT] = "Plugin {{fromName}} taking long to load", a[o.EVENT_INIT] = "Initializing Plugin {{fromName}}", a[o.EVENT_API_CALL] = "API Call {{fromName}} -> {{targetName}}", a[o.EVENT_UI_IS_READY] = "UI is ready event triggered by: {{fromName}}"
        }, (e, t) => {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            ...
            t.Telemetry = class {
                ...
                addListener(e) {
                    if (this._enabled)
                        for (this._listeners.push(e); this._eventQueue.length > 0;) this.dispatchEvent(this._eventQueue.shift())
                }
                dispatchEvent(e) {
                    this._enabled && (0 === this._listeners.length ? this._eventQueue.push(e) : (e.updateTime(), this._listeners.forEach((t => t(e)))))
                }
                enable() {
                    this._enabled = !0
                }
                disable() {
                    this._enabled = !1, this._listeners = [], this._eventQueue = []
                }
                instrumented(e) {
                    return e
                }
            ...
            function i(e, t, n, r, o) {
                return "function" == typeof t && (o = n, r = t, t = ""), "object" == typeof t && (o = r, r = n, n = t, t = ""), "function" == typeof n && (o = r, r = n, n = void 0), void 0 === o && (o = e), [t, n, r, o]
            }
            e.exports = class {
                constructor(e) {
                ...
                subscribe(...e) {
                    const t = i(this, ...e),
                        [n, o, s, a] = t;
                    return r("Socket#subscribe takes three arguments: url, context, and action. context is optional", n && s), this._dispatcher.add(n, s, o, a), this
                }
                unsubscribe(...e) {
                ...
                call(e, ...t) {
                    return r("Socket#call must be called with at least a url.", "string" == typeof e), this._socket ? this._socket.call(...t) : Promise.reject(new Error("This socket cannot make calls."))
                }
                close() {
                    this.unsubscribe()
                }
            ...
            class c {
                ...
                matchesAllProvided(e, t, n) {
                    return !(e && e !== this.action || t && t !== this.context || n && n !== this.owner)
                }
            }
            class l {
                constructor(e, n, s) {
            ...
            e.exports = {
                Dispatcher: class {
                    constructor(e) {
                        e = e || {}, this._handlersRoot = new l("/"), this._onHandlerAdded = e.onHandlerAdded || a, this._onHandlerRemoved = e.onHandlerRemoved || a
                    }
                    add(e, o, i, a) {
                    ...
                    _forEachHandler(e, o) {
                        ...
                        if (s)
                            for (let t = s.length - 1; t >= 0; --t) {
                                const n = s[t];
                                e(i, n) === f && (s[t] = s[s.length - 1], --s.length, this._onHandlerRemoved(i, n))
                            }
                    ...
                    _removeWithUrl(e, n, r, o) {
                        ...
                        for (let t = 0; t < s.length; ++t) {
                            const i = s[t];
                            i.matchesAllProvided(n, r, o) && (s[t] = s[s.length - 1], --s.length, this._onHandlerRemoved(e, i))
                        }
                        return this._prune(i), !0
                    }
                    remove(e, t, n, r) {
                        return e ? this._removeWithUrl(e, t, n, r) : this._removeWithoutUrl(t, n, r)
                    }
                    _sendErrorTelemetry(e) {
                        ...
                        const n = e.stack || "",
                            ...
                            o = n.match(u);
                        o && (r.filename = o[1], r.lineNumber = Number(o[2]), r.columnNumber = Number(o[3])), t.send(JSON.stringify(r))
                    }
                    _callHandlers(e, t, n) {
                        const r = e.length,
                            o = n[2].data;
                    ...
                    publish(e, r) {
                        for (var o = e.split("/").filter(s), i = o.length, a = [{
                            ...
                            if (l) {
                                var p = l[t];
                                p && p.length > 0 && (u || (u = JSON.parse(r)), this._callHandlers(p, e, u))
                            }
                        }
                    }
                },
            ...
            class c extends r {
                ...
                call(e, t, n) {
                    ...
                    return new Promise(((o, s) => {
                        this._resolvers[r] = [f(this, r, o), f(this, r, s)], u("sending CALL message", r, e, t, n), l(this, [i.CALL, r, e, t, n])
                    }))
                }
                close() {
            ...
            function y(e, t) {
                ...
                if (n === i.EVENT) {
                    ...
                    if (n === i.WELCOME)[e._wampSessionId, e._wampProtocolVersion, e._wampServerIdentity] = r.slice(1), e.ready(), l(e), l(e, [i.SUBSCRIBE, s]);
            ...
            "use strict";
            "undefined" == typeof window ? e.exports = n(26) : e.exports = window.WebSocket
        }, (e, t, n) => {
            "use strict";
            var r = e.exports = n(27);
            r.Server = n(78), r.Sender = n(62), r.Receiver = n(70), r.createServer = function(e, t) {
                var n = new r.Server(e);
                return "function" == typeof t && n.on("connection", t), n
            }, r.connect = r.createConnection = function(e, t) {
                var n = new r(e);
            ...
            function _(e, t, n) {
                ...
                g.call(this), t && !Array.isArray(t) && "object" == typeof t && (n = t, t = null), "string" == typeof t && (t = [t]), Array.isArray(t) || (t = []), this._socket = null, this._ultron = null, this._closeReceived = !1, this.bytesReceived = 0, this.readyState = null, this.supports = {}, this.extensions = {}, this._binaryType = "nodebuffer", Array.isArray(e) ? A.apply(this, e.concat(n)) : S.apply(this, [e, t, n])
            }

            function b(e, t, n) {
                this.type = "message", this.data = e, this.target = n, this.binary = t
            }

            function w(e, t, n) {
                this.type = "close", this.wasClean = void 0 === e || 1e3 === e, this.code = e, this.reason = t, this.target = n
            }
            ...
            function E(e, t, n) {
                var r = t;
                return t && (e && 443 != n || !e && 80 != n) && (r = r + ":" + n), r
            }
            ...
            function A(e, t, n, r) {
                r = new l({
                    ...
                    extensions: {},
                    maxPayload: 0
                }).merge(r), this.protocol = r.value.protocol, this.protocolVersion = r.value.protocolVersion, this.extensions = r.value.extensions, this.supports.binary = "hixie-76" !== this.protocolVersion, this.upgradeReq = e, this.readyState = _.CONNECTING, this._isServer = !0, this.maxPayload = r.value.maxPayload, "hixie-76" === r.value.protocolVersion ? P.call(this, d, p, t, n) : P.call(this, h, f, t, n)
            }
            ...
            function S(e, t, n) {
                if (8 !== (n = new l({
                        ...
                        perMessageDeflate: !0,
                        localAddress: null
                    }).merge(n)).value.protocolVersion && 13 !== n.value.protocolVersion) throw new Error("unsupported protocol version");
                var o = r.parse(e),
                ...
                var c, p = "wss:" === o.protocol || "https:" === o.protocol,
                    ...
                    b = o.auth,
                    w = {};
                n.value.perMessageDeflate && (c = new y(!0 !== typeof n.value.perMessageDeflate ? n.value.perMessageDeflate : {}, !1), w[y.extensionName] = c.offer()), this._isServer = !1, this.url = e, this.protocolVersion = n.value.protocolVersion, this.supports.binary = "hixie-76" !== this.protocolVersion;
                var x = new Buffer(n.value.protocolVersion + "-" + Date.now()).toString("base64"),
                    A = a.createHash("sha1");
                ...
                if (b && (T.headers.Authorization = "Basic " + new Buffer(b).toString("base64")), n.value.protocol && (T.headers["Sec-WebSocket-Protocol"] = n.value.protocol), n.value.host && (T.headers.Host = n.value.host), n.value.headers)
                    for (var N in n.value.headers) n.value.headers.hasOwnProperty(N) && (T.headers[N] = n.value.headers[N]);
                Object.keys(w).length && (T.headers["Sec-WebSocket-Extensions"] = v.format(w)), (n.isDefinedAndNonNull("pfx") || n.isDefinedAndNonNull("key") || n.isDefinedAndNonNull("passphrase") || n.isDefinedAndNonNull("cert") || n.isDefinedAndNonNull("ca") || n.isDefinedAndNonNull("ciphers") || n.isDefinedAndNonNull("rejectUnauthorized")) && (n.isDefinedAndNonNull("pfx") && (T.pfx = n.value.pfx), n.isDefinedAndNonNull("key") && (T.key = n.value.key), n.isDefinedAndNonNull("passphrase") && (T.passphrase = n.value.passphrase), n.isDefinedAndNonNull("cert") && (T.cert = n.value.cert), n.isDefinedAndNonNull("ca") && (T.ca = n.value.ca), n.isDefinedAndNonNull("ciphers") && (T.ciphers = n.value.ciphers), n.isDefinedAndNonNull("rejectUnauthorized") && (T.rejectUnauthorized = n.value.rejectUnauthorized), O || (O = new d.Agent(T))), T.path = o.path || "/", O && (T.agent = O), u && (T.socketPath = o.pathname), n.value.localAddress && (T.localAddress = n.value.localAddress), n.value.origin && (n.value.protocolVersion < 13 ? T.headers["Sec-WebSocket-Origin"] = n.value.origin : T.headers.Origin = n.value.origin);
                var I = this,
                    C = d.request(T);
                C.on("error", (function(e) {
                    ...
                    var t;
                    I.emit("unexpected-response", C, e) || (t = new Error("unexpected server response (" + e.statusCode + ")"), C.abort(), I.emit("error", t)), j.call(I, t)
                })), C.once("upgrade", (function(e, t, r) {
                    if (I.readyState === _.CLOSED) return I.emit("close"), I.removeAllListeners(), void t.end();
                    var o = e.headers["sec-websocket-accept"];
                    if (void 0 === o || o !== S) return I.emit("error", "invalid server key"), I.removeAllListeners(), void t.end();
                    var i = e.headers["sec-websocket-protocol"],
                        s = (n.value.protocol || "").split(/, */),
                        a = null;
                    if (!n.value.protocol && i ? a = "server sent a subprotocol even though none requested" : n.value.protocol && !i ? a = "server sent no subprotocol even though requested" : i && -1 === s.indexOf(i) && (a = "server responded with an invalid protocol"), a) return I.emit("error", a), I.removeAllListeners(), void t.end();
                    i && (I.protocol = i);
                    ...
                    if (c && u[y.extensionName]) {
                        try {
                            ...
                            return I.emit("error", "invalid extension parameter"), I.removeAllListeners(), void t.end()
                        }
                        I.extensions[y.extensionName] = c
                    }
                    P.call(I, h, f, t, r), C.removeAllListeners(), C = null, O = null
                })), C.end(), this.readyState = _.CONNECTING
            }
            ...
            function P(e, t, n, r) {
                ...
                function a(e) {
                    i || s.readyState === _.CLOSED || (i = !0, n.removeListener("data", a), o.on("data", u), r && r.length > 0 && (u(r), r = null), e && u(e))
                }

                function u(e) {
                    s.bytesReceived += e.length, s._receiver.add(e)
                }
                n.setTimeout(0), n.setNoDelay(!0), this._receiver = new e(this.extensions, this.maxPayload), this._socket = n, o.on("end", j.bind(this)), o.on("close", j.bind(this)), o.on("error", j.bind(this)), o.on("data", a), process.nextTick(a), s._receiver.ontext = function(e, t) {
                ...
                }, this._sender = new t(n, this.extensions), this._sender.on("error", (function(e) {
            ...
            o.inherits(_, g), ["CONNECTING", "OPEN", "CLOSING", "CLOSED"].forEach((function(e, t) {
                        ...
                        if (this.readyState !== _.CLOSING) {
                            ...
                            try {
                                ...
                                this._sender.close(e, t, r, (function(e) {
                                    e && n.emit("error", e), n._closeReceived && n._isServer ? n.terminate() : (clearTimeout(n._closeTimer), n._closeTimer = setTimeout(j.bind(n, !0), 3e4))
                                }))
                            } catch (e) {
                                this.emit("error", e)
                            }
                ...
                if ("function" == typeof t && (n = t, t = {}), this.readyState === _.OPEN)
                    if (e || (e = ""), this._queue) {
                        var r = this;
                        ...
                        if (e instanceof o) {
                            ...
                            ! function(e, t, n, r) {
                                t.on("data", (function(t) {
                                    e.readyState === _.OPEN ? (n.fin = !1, e._sender.send(t, n)) : "function" == typeof r ? r(new Error("not opened")) : (delete e._queue, e.emit("error", new Error("not opened")))
                                })), t.on("end", (function() {
                                    e.readyState === _.OPEN ? (n.fin = !0, e._sender.send(null, n), "function" == typeof r && r(null)) : "function" == typeof r ? r(new Error("not opened")) : (delete e._queue, e.emit("error", new Error("not opened")))
                                }))
                            }(this, e, t, (function(e) {
                ...
                if (this.readyState === _.OPEN) this._queue ? this._queue.push((function() {
                    n.stream(e, t)
                })) : (void 0 === (e = e || {}).mask && (e.mask = !this._isServer), void 0 === e.compress && (e.compress = !0), this.extensions[y.extensionName] || (e.compress = !1), O(this), process.nextTick(t.bind(null, null, (function r(o, i) {
                    try {
                        if (n.readyState !== _.OPEN) throw new Error("not opened");
                        e.fin = !0 === i, n._sender.send(o, e), i ? k(n) : process.nextTick(t.bind(null, null, r))
                    } catch (e) {
                        "function" == typeof t ? t(e) : (delete n._queue, n.emit("error", e))
                    }
                }))));
                else {
                ...
                function r(e, r) {
                    r.binary && "arraybuffer" === this.binaryType && (e = new Uint8Array(e).buffer), t.call(n, new b(e, !!r.binary, n))
                }
                ...
                "function" == typeof t && ("message" === e ? (r._listener = t, this.on(e, r)) : "close" === e ? (o._listener = t, this.on(e, o)) : "error" === e ? (i._listener = t, this.on(e, i)) : "open" === e ? (s._listener = t, this.on(e, s)) : this.on(e, t))
            }, e.exports = _, e.exports.buildHostHeader = E
        }, (e, t, n) => {
            "use strict";
            const r = n(29);
            ...
            o.prototype.parse = function(e, t, n) {
                ...
                if (!v[b] && (x || b && !y[b])) {
                    ...
                    } - 1 !== (A = -1 === S ? m.lastIndexOf("@") : m.lastIndexOf("@", S)) && (E = m.slice(0, A), m = m.slice(A + 1), this.auth = decodeURIComponent(E)), S = -1;
                    for (P = 0; P < l.length; P++) {
                        var O; - 1 !== (O = m.indexOf(l[P])) && (-1 === S || O < S) && (S = O)
                    ...
                    if (!k)
                        for (var j = this.hostname.split(/\./), T = (P = 0, j.length); P < T; P++) {
                            var N = j[P];
                            if (N && !N.match(h)) {
                                for (var I = "", C = 0, R = N.length; C < R; C++) N.charCodeAt(C) > 127 ? I += "x" : I += N[C];
                                if (!I.match(h)) {
                                    var L = j.slice(0, P),
                                        F = j.slice(P + 1),
                                        M = N.match(p);
                                    M && (L.push(M[1]), F.unshift(M[2])), F.length && (m = "/" + F.join(".") + m), this.hostname = L.join(".");
                                    break
                                }
                            }
                        }
                    ...
                    var D = this.port ? ":" + this.port : "",
                        B = this.hostname || "";
                    this.host = B + D, this.href += this.host, k && (this.hostname = this.hostname.substr(1, this.hostname.length - 2), "/" !== m[0] && (m = "/" + m))
                }
                if (!d[w])
                ...
                var H = m.indexOf("#"); - 1 !== H && (this.hash = m.substr(H), m = m.slice(0, H));
                var z = m.indexOf("?");
                if (-1 !== z ? (this.search = m.substr(z), this.query = m.substr(z + 1), t && (this.query = g.parse(this.query)), m = m.slice(0, z)) : t && (this.search = "", this.query = {}), m && (this.pathname = m), y[w] && this.hostname && !this.pathname && (this.pathname = "/"), this.pathname || this.search) {
                    D = this.pathname || "";
                    var q = this.search || "";
                    this.path = D + q
                }
                ...
                var m = n.pathname && "/" === n.pathname.charAt(0),
                    ...
                    E = (p = e.pathname && e.pathname.split("/") || [], n.protocol && !y[n.protocol]);
                if (E && (n.hostname = "", n.port = null, n.host && ("" === x[0] ? x[0] = n.host : x.unshift(n.host)), n.host = "", e.protocol && (e.hostname = null, e.port = null, e.host && ("" === p[0] ? p[0] = e.host : p.unshift(e.host)), e.host = null), b = b && ("" === p[0] || "" === x[0])), _) n.host = e.host || "" === e.host ? e.host : n.host, n.hostname = e.hostname || "" === e.hostname ? e.hostname : n.hostname, n.search = e.search, n.query = e.query, x = p;
                else if (p.length) x || (x = []), x.pop(), x = x.concat(p), n.search = e.search, n.query = e.query;
                else if (null != e.search) {
                    if (E) n.host = x.shift(), n.hostname = n.host, (k = !!(n.host && n.host.indexOf("@") > 0) && n.host.split("@")) && (n.auth = k.shift(), n.hostname = k.shift(), n.host = n.hostname);
                ...
                for (var A = x.slice(-1)[0], S = (n.host || e.host || x.length > 1) && ("." === A || ".." === A) || "" === A, P = 0, O = x.length; O >= 0; O--) "." === (A = x[O]) ? x.splice(O, 1) : ".." === A ? (x.splice(O, 1), P++) : P && (x.splice(O, 1), P--);
                if (!b && !w)
                    for (; P--; P) x.unshift("..");
                !b || "" === x[0] || x[0] && "/" === x[0].charAt(0) || x.unshift(""), S && "/" !== x.join("/").substr(-1) && x.push("");
                var k, j = "" === x[0] || x[0] && "/" === x[0].charAt(0);
                E && (n.hostname = j ? "" : x.length ? x.shift() : "", n.host = n.hostname, (k = !!(n.host && n.host.indexOf("@") > 0) && n.host.split("@")) && (n.auth = k.shift(), n.hostname = k.shift(), n.host = n.hostname));
                return (b = b || n.host && x.length) && !j && x.unshift(""), x.length > 0 ? n.pathname = x.join("/") : (n.pathname = null, n.path = null), null === n.pathname && null === n.search || (n.path = (n.pathname ? n.pathname : "") + (n.search ? n.search : "")), n.auth = e.auth || n.auth, n.slashes = n.slashes || e.slashes, n.href = n.format(), n
            ...
            e = n.nmd(e),
                function(o) {
                    ...
                    function S(e, t) {
                        var n = e.split("@"),
                            r = "";
                        return n.length > 1 && (r = n[0] + "@", e = n[1]), r + A((e = e.replace(m, ".")).split("."), t).join(".")
                    }
                    ...
                    function j(e, t, n) {
                        var r = 0;
                        for (e = n ? w(e / h) : e >> 1, e += w(e / t); e > b * l >> 1; r += u) e = w(e / b);
                        return w(r + (b + 1) * e / (e + f))
                    }

                    function T(e) {
                        var t, n, r, o, i, s, f, h, y, g, m, _ = [],
                            b = e.length,
                            x = 0,
                            A = d,
                            S = p;
                        for ((n = e.lastIndexOf(v)) < 0 && (n = 0), r = 0; r < n; ++r) e.charCodeAt(r) >= 128 && E("not-basic"), _.push(e.charCodeAt(r));
                        for (o = n > 0 ? n + 1 : 0; o < b;) {
                            for (i = x, s = 1, f = u; o >= b && E("invalid-input"), ((h = (m = e.charCodeAt(o++)) - 48 < 10 ? m - 22 : m - 65 < 26 ? m - 65 : m - 97 < 26 ? m - 97 : u) >= u || h > w((a - x) / s)) && E("overflow"), x += h * s, !(h < (y = f <= S ? c : f >= S + l ? l : f - S)); f += u) s > w(a / (g = u - y)) && E("overflow"), s *= g;
                            S = j(x - i, t = _.length + 1, 0 == i), w(x / t) > a - A && E("overflow"), A += w(x / t), x %= t, _.splice(x++, 0, A)
                        }
                        return O(_)
                    }

                    function N(e) {
                        var t, n, r, o, i, s, f, h, y, g, m, _, b, A, S, O = [];
                        for (_ = (e = P(e)).length, t = d, n = 0, i = p, s = 0; s < _; ++s)(m = e[s]) < 128 && O.push(x(m));
                        for (r = o = O.length, o && O.push(v); r < _;) {
                            for (f = a, s = 0; s < _; ++s)(m = e[s]) >= t && m < f && (f = m);
                            for (f - t > w((a - n) / (b = r + 1)) && E("overflow"), n += (f - t) * b, t = f, s = 0; s < _; ++s)
                                if ((m = e[s]) < t && ++n > a && E("overflow"), m == t) {
                                    for (h = n, y = u; !(h < (g = y <= i ? c : y >= i + l ? l : y - i)); y += u) S = h - g, A = u - g, O.push(x(k(g + S % A, 0))), h = w(S / A);
            ...
            e.exports = function(e, n, r, o) {
                ...
                a > 0 && u > a && (u = a);
                for (var c = 0; c < u; ++c) {
                    var l, f, h, p, d = e[c].replace(s, "%20"),
                        v = d.indexOf(r);
                    v >= 0 ? (l = d.substr(0, v), f = d.substr(v + 1)) : (l = d, f = ""), h = decodeURIComponent(l), p = decodeURIComponent(f), t(i, h) ? Array.isArray(i[h]) ? i[h].push(p) : i[h] = [i[h], p] : i[h] = p
                }
                return i
            }
        }, e => {
            ...
            t.format = function(e) {
                ...
                for (var r = arguments, i = r.length, s = String(e).replace(o, (function(e) {
                    ...
                    })), a = r[n]; n < i; a = r[++n]) y(a) || !w(a) ? s += " " + a : s += " " + u(a);
                return s
            ...
            function u(e, n) {
                ...
                return arguments.length >= 3 && (r.depth = arguments[2]), arguments.length >= 4 && (r.colors = arguments[3]), v(n) ? r.showHidden = n : n && t._extend(r, n), _(r.showHidden) && (r.showHidden = !1), _(r.depth) && (r.depth = 2), _(r.colors) && (r.colors = !1), _(r.customInspect) && (r.customInspect = !0), r.colors && (r.stylize = c), f(r, e, r.depth)
            }
            ...
            function f(e, n, r) {
                ...
                if (e.showHidden && (s = Object.getOwnPropertyNames(n)), E(n) && (s.indexOf("message") >= 0 || s.indexOf("description") >= 0)) return h(n);
                if (0 === s.length) {
                    if (A(n)) {
                        var u = n.name ? ": " + n.name : "";
                ...
                var c, l = "",
                    w = !1,
                    S = ["{", "}"];
                (d(n) && (w = !0, S = ["[", "]"]), A(n)) && (l = " [Function" + (n.name ? ": " + n.name : "") + "]");
                return b(n) && (l = " " + RegExp.prototype.toString.call(n)), x(n) && (l = " " + Date.prototype.toUTCString.call(n)), E(n) && (l = " " + h(n)), 0 !== s.length || w && 0 != n.length ? r < 0 ? b(n) ? e.stylize(RegExp.prototype.toString.call(n), "regexp") : e.stylize("[Object]", "special") : (e.seen.push(n), c = w ? function(e, t, n, r, o) {
                    for (var i = [], s = 0, a = t.length; s < a; ++s) k(t, String(s)) ? i.push(p(e, t, n, r, String(s), !0)) : i.push("");
            ...
            function p(e, t, n, r, o, i) {
                ...
                if ((u = Object.getOwnPropertyDescriptor(t, o) || {
                        value: t[o]
                    }).get ? a = u.set ? e.stylize("[Getter/Setter]", "special") : e.stylize("[Getter]", "special") : u.set && (a = e.stylize("[Setter]", "special")), k(r, o) || (s = "[" + o + "]"), a || (e.seen.indexOf(u.value) < 0 ? (a = y(n) ? f(e, u.value, null) : f(e, u.value, n - 1)).indexOf("\n") > -1 && (a = i ? a.split("\n").map((function(e) {
                        return "  " + e
                    })).join("\n").slice(2) : "\n" + a.split("\n").map((function(e) {
                        return "   " + e
            ...
            t.debuglog = function(e) {
                ...
                date: "magenta",
                regexp: "red"
            }, t.types = n(35), t.isArray = d, t.isBoolean = v, t.isNull = y, t.isNullOrUndefined = function(e) {
                return null == e
            }, t.isNumber = g, t.isString = m, t.isSymbol = function(e) {
                return "symbol" == typeof e
            }, t.isUndefined = _, t.isRegExp = b, t.types.isRegExp = b, t.isObject = w, t.isDate = x, t.types.isDate = x, t.isError = E, t.types.isNativeError = E, t.isFunction = A, t.isPrimitive = function(e) {
            ...
            t.log = function() {
                var e, n;
                console.log("%s - %s", (e = new Date, n = [P(e.getHours()), P(e.getMinutes()), P(e.getSeconds())].join(":"), [e.getDate(), O[e.getMonth()], n].join(" ")), t.format.apply(t, arguments))
            }, t.inherits = n(54), t._extend = function(e, t) {
                if (!t || !w(t)) return e;
            ...
            t.isArgumentsObject = r, t.isGeneratorFunction = o, t.isTypedArray = s, t.isPromise = function(e) {
                ...
                return b(e)
            }, w.working = "undefined" != typeof ArrayBuffer && w(new ArrayBuffer), t.isArrayBuffer = x, E.working = "undefined" != typeof ArrayBuffer && "undefined" != typeof DataView && E(new DataView(new ArrayBuffer(1), 0, 1)), t.isDataView = A;
            ...
            function O(e) {
                return void 0 !== S && (void 0 === P.working && (P.working = P(new S)), P.working ? P(e) : e instanceof S)
            }
            ...
            }, t.isNumberObject = k, t.isStringObject = j, t.isBooleanObject = T, t.isBigIntObject = N, t.isSymbolObject = I, t.isBoxedPrimitive = function(e) {
            ...
            var c = function() {
                ...
                O = function(e, t) {
                    ...
                    if (_(g, r) && (r = "%" + (n = g[r])[0] + "%"), _(v, r)) {
                        var i = v[r];
                        if (i === p && (i = y(r)), void 0 === i && !t) throw new s("intrinsic " + e + " exists, but is not available. Please file an issue!");
                        return {
                            alias: n,
                            name: r,
                            value: i
            ...
            e.exports = function(e, t) {
                ...
                for (var h = 1, p = !0; h < n.length; h += 1) {
                    ...
                    if ("constructor" !== d && p || (l = !0), _(v, a = "%" + (r += "." + d) + "%")) c = v[a];
                    else if (null != c) {
                        if (!(d in c)) {
            ...
            e.exports = function(e) {
                ...
                for (var o, i = t.call(arguments, 1), s = Math.max(0, r.length - i.length), a = [], u = 0; u < s; u++) a.push("$" + u);
            ...
            e.exports = function(e, t, n) {
                ...
                var s;
                arguments.length >= 3 && (s = n), "[object Array]" === o.call(e) ? function(e, t, n) {
                    for (var r = 0, o = e.length; r < o; r++) i.call(e, r) && (null == n ? t(e[r], r, e) : t.call(n, e[r], r, e))
                }(e, t, s) : "string" == typeof e ? function(e, t, n) {
            ...
            r.prototype.on = function(e, t, n) {
                ...
                var e, n = arguments;
                if (1 === n.length && "string" == typeof n[0]) n = n[0].split(/[, ]+/);
                else if (!n.length)
                    for (e in n = [], this.ee._events) t.call(this.ee._events, e) && n.push(e);
            ...
            e.exports = function(e) {
                ...
                Object.keys(e).forEach((function(r) {
                    t[r] = e[r], Object.defineProperty(n, r, {
                        get: function() {
                            return t[r]
                        },
                        configurable: !1,
                    ...
                    if (e = e || {}, "[object Array]" === Object.prototype.toString.call(n)) {
                    ...
                    return null != n[e]
                }, Object.freeze(n), Object.freeze(this)
            }
        }, () => {}, (e, t, n) => {
            var r = n(63),
                o = n(34),
            ...
            function c(e, t) {
                ...
                r.EventEmitter.call(this), this._socket = e, this.extensions = t || {}, this.firstFragment = !0, this.compress = !1, this.messageHandlers = [], this.processing = !1
            }
            ...
            function h(e) {
                for (var t = new Uint8Array(e.buffer || e), n = e.byteLength || e.length, r = e.byteOffset || 0, o = new Buffer(n), i = 0; i < n; ++i) o[i] = t[r + i];
                return o
            }
            o.inherits(c, r.EventEmitter), c.prototype.close = function(e, t, n, r) {
                ...
                var r = !t || !1 !== t.fin,
                    ...
                    i = t && t.compress,
                    s = t && t.binary ? 2 : 1;
                !1 === this.firstFragment ? (s = 0, i = !1) : (this.firstFragment = !1, this.compress = i), r && (this.firstFragment = !0);
                var a = this.compress,
                    u = this;
                this.messageHandlers.push((function() {
                    e && a ? (u.processing = !0, u.applyExtensions(e, r, a, (function(e, t) {
                        e ? "function" == typeof n ? n(e) : u.emit("error", e) : (u.frameAndSend(s, t, r, o, i, n), u.processing = !1, u.flush())
                ...
                if (t) {
                    ...
                    this._socket.write(new Buffer([e | (n ? 128 : 0), 0 | (r ? 128 : 0)].concat(r ? [0, 0, 0, 0] : [])), "binary", s)
                } catch (e) {
                    "function" == typeof s ? s(e) : this.emit("error", e)
                }
                ...
                (e.buffer || e) instanceof ArrayBuffer && (e = h(e)), this.extensions[u.extensionName].compress(e, t, r)
            }, e.exports = c
        }, e => {
            "use strict";
            ...
            t.BufferUtil = {
                ...
                unmask: function(e, t) {
                    for (var n = t.readUInt32LE(0, !0), r = e.length, o = 0; o < r - 3; o += 4) {
            ...
            function i(e, t, n) {
                ...
                this._options = e || {}, this._isServer = !!t, this._inflate = null, this._deflate = null, this.params = null, this._maxPayload = n || 0
            }
            i.extensionName = "permessage-deflate", i.prototype.offer = function() {
                ...
                return e.map((function(e) {
                    return Object.keys(e).forEach((function(t) {
                        var n = e[t];
                        if (n.length > 1) throw new Error("Multiple extension parameters for " + t);
                        switch (n = n[0], t) {
                            case "server_no_context_takeover":
                            case "client_no_context_takeover":
                                if (!0 !== n) throw new Error("invalid extension parameter value for " + t + " (" + n + ")");
                                e[t] = !0;
                                break;
                            case "server_max_window_bits":
                            case "client_max_window_bits":
                                if ("string" == typeof n && (n = parseInt(n, 10), !~o.indexOf(n))) throw new Error("invalid extension parameter value for " + t + " (" + n + ")");
                                if (!this._isServer && !0 === n) throw new Error("Missing extension parameter value for " + t);
                                e[t] = n;
                                break;
                            default:
                ...
                function f() {
                    s._inflate && (s._inflate.removeListener("error", c), s._inflate.removeListener("data", l), s._inflate.writeInProgress = !1, (t && s.params[o + "_no_context_takeover"] || s._inflate.pendingClose) && (s._inflate.close && s._inflate.close(), s._inflate = null))
                }
                this._inflate.on("error", c).on("data", l), this._inflate.write(e), t && this._inflate.write(new Buffer([0, 0, 255, 255])), this._inflate.flush((function() {
            ...
            e.exports = u, u.prototype.add = function(e) {
                if (!this.dead) {
                    ...
                    if (0 != t)
                        if (null != this.expectBuffer) {
                            var n = Math.min(t, this.expectBuffer.length - this.expectOffset);
                            for (f(n, e, this.expectBuffer, this.expectOffset), this.expectOffset += n, n < t && this.overflow.push(e.slice(n)); this.expectBuffer && this.expectOffset == this.expectBuffer.length;) {
                ...
                if (0 != e) {
                    ...
                    for (var n = e; n > 0 && this.overflow.length > 0;) {
                        ...
                        f(o, r, this.expectBuffer, this.expectOffset), this.expectOffset += o, n -= o
                    }
                } else t(null)
                ...
                if (0 === n) {
                    ...
                    if (n < 3 && null != this.state.activeFragmentedOperation) return void this.error("data frames after the initial data frame must have opcode 0", 1002);
                    if (n >= 8 && t) return void this.error("control frames cannot have the Per-message Compressed bits", 1002);
                    this.state.compressed = t, this.state.opcode = n, !1 === this.state.lastFragment ? (this.state.fragmentedOperation = !0, this.state.activeFragmentedOperation = n) : this.state.fragmentedOperation = !1
                }
                var r = p[this.state.opcode];
                void 0 === r ? this.error("no handler for opcode " + this.state.opcode, 1002) : r.start.call(this, e)
                ...
                return null != e && null != t && s.unmask(t, e), n ? t : null != t ? t.toString("utf8") : ""
                ...
                var o = this;
                n ? this.extensions[a.extensionName].decompress(e, t, (function(e, t) {
                    o.dead || (e ? r(new Error("invalid compressed data")) : r(null, t))
                })) : r(null, e)
            ...
            var p = {
                1: {
                    start: function(e) {
                        var t = this,
                            n = 127 & e[1];
                        if (n < 126) {
                            if (t.maxPayloadExceeded(n)) return void t.error("Maximumpayload exceeded in compressed text message. Aborting...", 1009);
                            p[1].getData.call(t, n)
                        } else 126 == n ? t.expectHeader(2, (function(e) {
                            var n = c.call(e, 0);
                            t.maxPayloadExceeded(n) ? t.error("Maximumpayload exceeded in compressed text message. Aborting...", 1009) : p[1].getData.call(t, n)
                        })) : 127 == n && t.expectHeader(8, (function(e) {
                            if (0 == l.call(e, 0)) {
                                var n = l.call(e, 4);
                                t.maxPayloadExceeded(n) ? t.error("Maximumpayload exceeded in compressed text message. Aborting...", 1009) : p[1].getData.call(t, l.call(e, 4))
                            } else t.error("packets with length spanning more than 32 bit is currently not supported", 1008)
                        }))
                    },
                    getData: function(e) {
                        var t = this;
                        t.state.masked ? t.expectHeader(4, (function(n) {
                            var r = n;
                    ...
                    finish: function(e, t) {
                        ...
                        this.messageHandlers.push((function(e) {
                            n.applyExtensions(o, i.lastFragment, i.compressed, (function(t, o) {
                                if (t) return 1009 === t.type ? n.error("Maximumpayload exceeded in compressed text message. Aborting...", 1009) : n.error(t.message, 1007);
                                if (null != o) {
                                    if (!(0 == n.maxPayload || n.maxPayload > 0 && n.currentMessageLength + o.length < n.maxPayload)) return n.currentMessage = null, n.currentMessage = [], n.currentMessageLength = 0, void n.error(new Error("Maximum payload exceeded. maxPayload: " + n.maxPayload), 1009);
                                    n.currentMessage.push(o), n.currentMessageLength += o.length
                                }
                                if (i.lastFragment) {
                                    var s = Buffer.concat(n.currentMessage);
                                    if (n.currentMessage = [], n.currentMessageLength = 0, !r(s)) return void n.error("invalid utf8 sequence", 1007);
                ...
                2: {
                    start: function(e) {
                        var t = this,
                            n = 127 & e[1];
                        if (n < 126) {
                            if (t.maxPayloadExceeded(n)) return void t.error("Max payload exceeded in compressed text message. Aborting...", 1009);
                            p[2].getData.call(t, n)
                        } else 126 == n ? t.expectHeader(2, (function(e) {
                            var n = c.call(e, 0);
                            t.maxPayloadExceeded(n) ? t.error("Max payload exceeded in compressed text message. Aborting...", 1009) : p[2].getData.call(t, n)
                        })) : 127 == n && t.expectHeader(8, (function(e) {
                            if (0 == l.call(e, 0)) {
                                var n = l.call(e, 4, !0);
                                t.maxPayloadExceeded(n) ? t.error("Max payload exceeded in compressed text message. Aborting...", 1009) : p[2].getData.call(t, n)
                    ...
                    finish: function(e, t) {
                        var n = this,
                            ...
                            o = h(this.state);
                        this.messageHandlers.push((function(e) {
                            n.applyExtensions(r, o.lastFragment, o.compressed, (function(t, r) {
                                if (t) return 1009 === t.type ? n.error("Max payload exceeded in compressed binary message. Aborting...", 1009) : n.error(t.message, 1007);
                                if (null != r) {
                                    if (!(0 == n.maxPayload || n.maxPayload > 0 && n.currentMessageLength + r.length < n.maxPayload)) return n.currentMessage = null, n.currentMessage = [], n.currentMessageLength = 0, void n.error(new Error("Maximum payload exceeded"), 1009);
                                    n.currentMessage.push(r), n.currentMessageLength += r.length
                                }
                                if (o.lastFragment) {
                                    var i = Buffer.concat(n.currentMessage);
                                    n.currentMessage = [], n.currentMessageLength = 0, n.onbinary(i, {
                                        masked: o.masked,
                                        buffer: i
                                    })
                                }
                ...
                8: {
                    start: function(e) {
                        ...
                        if (0 != t.state.lastFragment) {
                            var n = 127 & e[1];
                            n < 126 ? p[8].getData.call(t, n) : t.error("control frames cannot have more than 125 bytes of data", 1002)
                    ...
                    finish: function(e, t) {
                        ...
                        var i = h(this.state);
                        this.messageHandlers.push((function() {
                            if (t && 1 == t.length) n.error("close packets with data must be at least two bytes long", 1002);
                            else {
                                ...
                                if (o.isValidErrorCode(e)) {
                                    ...
                                    if (t && t.length > 2) {
                                        var a = t.slice(2);
                                        if (!r(a)) return void n.error("invalid utf8 sequence", 1007);
                                        s = a.toString("utf8")
                                    }
                                    n.onclose(e, s, {
                                        masked: i.masked
                ...
                9: {
                    start: function(e) {
                        ...
                        if (0 != t.state.lastFragment) {
                            var n = 127 & e[1];
                            n < 126 ? p[9].getData.call(t, n) : t.error("control frames cannot have more than 125 bytes of data", 1002)
                ...
                10: {
                    start: function(e) {
                        ...
                        if (0 != t.state.lastFragment) {
                            var n = 127 & e[1];
                            n < 126 ? p[10].getData.call(t, n) : t.error("control frames cannot have more than 125 bytes of data", 1002)
                        } else t.error("fragmented pong is not supported", 1002)
                    },
                    getData: function(e) {
                        var t = this;
                        this.state.masked ? this.expectHeader(4, (function(n) {
                            var r = n;
                            t.expectData(e, (function(e) {
            ...
            function r(e, t, n) {
                if (this instanceof r == !1) throw new TypeError("Classes can't be function-called");
                "function" == typeof e ? (n = t, t = e, e = 0) : void 0 === e && (e = 0), this._growStrategy = (t || function(e, t) {
                    return e.used + t
                }).bind(null, this), this._shrinkStrategy = (n || function(t) {
                    return e
            ...
            function i(e) {
                if (this instanceof i == !1) throw new TypeError("Classes can't be function-called");
                r.EventEmitter.call(this), this.socket = e, this.continuationFrame = !1, this.isClosed = !1
            }
            e.exports = i, o.inherits(i, r.EventEmitter), i.prototype.send = function(e, t, n) {
                if (!this.isClosed) {
                    var r = "string" == typeof e,
                        ...
                        c = s ? 1 : 0;
                    s && (t && t.binary ? (u.write("", "binary"), i > 1 && u.write(String.fromCharCode(128 + o / 128), c++, "binary"), u.write(String.fromCharCode(127 & o), c++, "binary")) : u.write("\0", "binary")), r ? u.write(e, c, "utf8") : e.copy(u, c, 0), a ? (t && t.binary || u.write("ÿ", c + o, "binary"), this.continuationFrame = !1) : this.continuationFrame = !0;
                    try {
                ...
                if (!this.isClosed) {
                    this.isClosed = !0;
                    try {
                        this.continuationFrame && this.socket.write(new Buffer([255], "binary")), this.socket.write(new Buffer([255, 0]), "binary", r)
                    } catch (e) {
                        this.error(e.toString())
                    }
                }
            ...
            e.exports = r, r.prototype.add = function(e) {
                if (!this.dead)
                    for (var t = this; e;) e = n();
                ...
                function n() {
                    ...
                    if (2 === t.state) {
                        for (var n = 0; n < e.length && 128 & e[n];) t.messageEnd = 128 * t.messageEnd + (127 & e[n]), ++n;
                        n < e.length && (t.messageEnd = 128 * t.messageEnd + (127 & e[n]), t.state = 3, ++n), n > 0 && (e = e.slice(n))
                    }
                    if (3 === t.state) {
                        var r = t.messageEnd - t.spanLength;
                        return e.length >= r ? (t.buffers.push(e), t.spanLength += r, t.messageEnd = r, t.parse()) : (t.buffers.push(e), void(t.spanLength += e.length))
                    }
                ...
                for (var e = new Buffer(this.spanLength), t = 0, n = 0, r = this.buffers.length; n < r - 1; ++n) {
                ...
                return (e = e || "").split(",").forEach((function(e) {
                    ...
                    n.forEach((function(e) {
                        var t = e.trim().split("="),
                            n = t[0],
                            r = t[1];
                        void 0 === r ? r = !0 : ('"' === r[0] && (r = r.slice(1)), '"' === r[r.length - 1] && (r = r.slice(0, r.length - 1))), void 0 === o[n] ? o[n] = [r] : o.hasOwnProperty(n) && o[n].push(r)
                    })), t[r].push(o)
                })), t
            }, t.format = function(e) {
                return Object.keys(e).map((function(t) {
                    var n = e[t];
                    return r.isArray(n) || (n = [n]), n.map((function(e) {
            ...
            function h(e, t) {
                ...
                this._server && (this._onceServerListening = function() {
                    ...
                    n.emit("error", e)
                }, this._server.on("error", this._onServerError), this._onServerUpgrade = function(e, t, r) {
                    var o = new Buffer(r.length);
                    r.copy(o), n.handleUpgrade(e, t, o, (function(t) {
                ...
                if (t.on("error", o), e.headers["sec-websocket-key"]) {
                    ...
                    if (-1 !== [8, 13].indexOf(a)) {
                        var l = e.headers["sec-websocket-protocol"],
                            f = a < 13 ? e.headers["sec-websocket-origin"] : e.headers.origin,
                            ...
                            d = function(i) {
                                ...
                                var d = ["HTTP/1.1 101 Switching Protocols", "Upgrade: websocket", "Connection: Upgrade", "Sec-WebSocket-Accept: " + (l = f.digest("base64"))];
                                ...
                                }))), t.removeListener("error", o), r(_)
                            },
                            g = function() {
                                if ("function" != typeof p.options.handleProtocols) void 0 !== l ? d(l.split(/, */)[0]) : d();
                                else {
                                    var e = (l || "").split(/, */),
                                        n = !1;
                        ...
                        if ("function" == typeof this.options.verifyClient) {
                            ...
                            if (2 == this.options.verifyClient.length) return void this.options.verifyClient(m, (function(e, n, r) {
                                void 0 === n && (n = 401), void 0 === r && (r = i.STATUS_CODES[n]), e ? g() : y(t, n, r)
                            }));
                ...
                if (t.on("error", o), this.options.disableHixie) y(t, 401, "Hixie support disabled");
                    ...
                    var a = e.headers.origin,
                        ...
                        l = function() {
                            ...
                            var l = ("https" === e.headers["x-forwarded-proto"] || t.encrypted ? "wss" : "ws") + "://" + i + e.url,
                                f = e.headers["sec-websocket-protocol"],
                                h = function() {
                                    var e = ["HTTP/1.1 101 Switching Protocols", "Upgrade: WebSocket", "Connection: Upgrade", "Sec-WebSocket-Location: " + l];
                                    return void 0 !== f && e.push("Sec-WebSocket-Protocol: " + f), void 0 !== a && e.push("Sec-WebSocket-Origin: " + a), new Buffer(e.concat("", "").join("\r\n"))
                                },
                                p = function(n, i, a) {
                                    ...
                                    [l, h].forEach((function(e) {
                                        ...
                                        0 !== r && n % r == 0 ? (n /= r, p.update(String.fromCharCode(n >> 24 & 255, n >> 16 & 255, n >> 8 & 255, 255 & n))) : y(t, 400, "Bad Request")
                                    })), p.update(n.toString("binary")), t.setTimeout(0), t.setNoDelay(!0);
                                    try {
                                        var d = new Buffer(p.digest("binary"), "binary"),
                                            v = new Buffer(a.length + d.length);
                                        a.copy(v, 0), d.copy(v, a.length), t.write(v, "binary", (function(n) {
                                            if (!n) {
                                                var s = new u([e, t, i], {
                            ...
                            if (n && n.length >= 8) {
                                ...
                                var g = n.length,
                                    m = (v = null, function(e) {
                                        ...
                                        0 !== n && (e.copy(d, g, 0, n), 8 == (g += n) && (t.removeListener("data", m), n < e.length && (v = e.slice(n)), p.call(c, d, v, new Buffer(0))))
                                    });
                                t.on("data", m),
                                    function() {
                    ...
                    if ("function" == typeof this.options.verifyClient) {
                        ...
                        if (2 == this.options.verifyClient.length) {
                            ...
                            return void this.options.verifyClient(f, (function(e, n, r) {
                                void 0 === n && (n = 401), void 0 === r && (r = i.STATUS_CODES[n]), e ? l.apply(c) : y(t, n, r)
                            }))
                        }
                        if (!this.options.verifyClient(f)) return void y(t, 401, "Unauthorized")
                    }
                    l()
                } else y(t, 400, "Bad Request")
            }
            ...
            r.inherits(h, o.EventEmitter), h.prototype.close = function(e) {
                var t = null;
                try {
                    for (var n = 0, r = this.clients.length; n < r; ++n) this.clients[n].terminate()
                } catch (e) {
                    t = e
                }
            ...
            function i(e, t, {
                ...
                if (!(n && (void 0 === t || "string" != typeof t) || e._filters.reduce(((e, n) => e || 0 === t.indexOf(n)), !1))) throw new Error(s`Given: ${t} Whitelisted: ${e._filters}`)
            }

            function s(e, ...t) {
                return ["This socket cannot interact with the given url because it is not whitelisted. "].concat(e.reduce(((e, n, r) => e.concat(n, t[r])), [])).join("")
            }
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                if (n) return;
                n = !0, window.addEventListener("error", (e => {
                    if (Math.random() > 1 - r) return;
                    const t = new XMLHttpRequest;
                    t.open("POST", "/telemetry/v1/events/javascript_errors", !0), t.setRequestHeader("Accept", "application/json"), t.setRequestHeader("Content-Type", "application/json"), t.setRequestHeader("X-Riot-Source", "rcp-fe-plugin-runner"), t.send(JSON.stringify({
                        message: e.message,
                        filename: e.filename,
    ...
    n.g = function() {
        ...
        u || r(["Dependency Graph linkage not found.", 'Please add link rel="' + i + '"'].join(" ")), c || r(["WebSocket linkage not found.", 'Please add link rel="' + s + '"'].join(" ")), l || r(["Plugin URL pattern meta not found.", 'Please add meta name="' + l + '"', 'content="/some/example/base/path/$name"'].join(" ")), o.configure({
