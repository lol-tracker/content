    ...
    var e = [, e => {
            ...
            var g = a.Ember.Controller.extend(s.default, {
                ...
                actions: {
                    ...
                    openTempVanguardFailModal: function() {
                        const e = {
                            tempLqaFailKey: 1
                        };
                        this.get("persistenceService").saveSetting(e, null, "local", "lol-vanguard", 1), this.get("modalManager").close()
