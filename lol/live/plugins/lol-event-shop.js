(() => {
  var e = [
        ...
        t.default = class {
          constructor() {
            (this.screenRoot = this.getScreenRoot()),
              ...
              (this.eventShopDataBinding = (0, s.dataBinding)(
                o.EVENT_SHOP_API,
                s.socket,
              ));
          }
          ...
          show() {
            return (
              this.applicationRegistered ||
                ((0, a.default)(), (this.applicationRegistered = !0)),
              this.screenRoot.bump().then(() => {
                this.application ||
                  ((this.application = s.ComponentFactory.create(a.APP_NAME)),
                  this.screenRoot
                    .getElement()
                    .appendChild(this.application.domNode)),
                  s.externalModel.set("isVisible", !0),
                  this.eventShopDataBinding
                    .get(o.EVENT_INFO_PATH)
                    .then(({ eventId: e }) => {
      ...
      (e, t, n) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.default = function () {
            const e = {
              ...
              EventShopMainViewComponent: v.default,
              ...
              TEMPLATES: {
                ...
                index: O.default,
                "components/event-shop-card-multi-purchase-modal": w.default,
                "components/event-shop-category-nav-bar-tab": A.default,
                "components/event-shop-category-nav-bar": D.default,
        ...
        const { RemainingTimeTextComponent: Y } = s.SharedComponents,
          G = "rcp-fe-lol-event-shop";
        t.APP_NAME = G;
      },
      (e, t, n) => {
        "use strict";
      ...
      (e, t, n) => {
        ...
        var o = s.Ember.Route.extend({
          model: () =>
            (0, s.dataBinding)(a.EVENT_SHOP_API, s.socket)
              .get("/pass-background-data")
              .then((e) => ({
      ...
      (e, t) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.default =
            ...
            t.PASS_BUNDLES_PATH =
            t.OFFER_STATES =
            t.EVENT_SHOP_SERVICE_OBSERVERS =
            t.EVENT_SHOP_OFFER_CARD_CONTAINER_CLASSNAME =
            t.EVENT_SHOP_API =
            t.EVENT_INFO_PATH =
            t.CLAIM_CURRENT_BONUS_REWARDS_PATH =
        ...
        t.TELEMETRY = {
          ...
          PURCHASE_PASS_UNLOCK_CLICK_EVENT:
            "event_shop_purchase_pass_unlock_click",
        };
        const c = [
          {
          ...
          { propertyName: "rewardTrackItems", path: "/reward-track-items" },
          {
          ...
          { propertyName: "tokenShopData", path: "/token-shop-data" },
          { propertyName: "unclaimedRewards", path: "/unclaimed-rewards" },
          { propertyName: "categoriesOffers", path: "/categories-offers" },
          {
            propertyName: "tokenBalance",
            path: "/token-balance",
            defaultValue: 0,
          },
          { propertyName: "eventDetailsData", path: "/event-details-data" },
          { propertyName: "isGracePeriod", path: "/is-grace-period" },
          {
          ...
          { propertyName: "rewardTrackXP", path: "/reward-track-xp" },
          { propertyName: "info", path: o },
          { propertyName: "tokenShopData", path: l },
        ];
          ...
          o = a.Ember.Service.extend({
            init() {
              this._super(...arguments),
                (this.eventShopDataBinding = (0, a.dataBinding)(
                  s.EVENT_SHOP_API,
                  a.socket,
                )),
                this.initObserveData();
            },
            initObserveData() {
              for (const {
                propertyName: e,
                path: t,
                defaultValue: n,
              } of s.EVENT_SHOP_SERVICE_OBSERVERS)
                this.eventShopDataBinding.observe(t, this, (t) => {
                  this.isDestroying ||
                    this.isDestroyed ||
                    (null == t && (t = n), this.setProperties({ [e]: t }));
                });
            },
            ...
            async purchaseItem(e) {
              return await this.eventShopDataBinding.post(
            ...
            claimCurrentBonusItems() {
              this.eventShopDataBinding.post(
                s.CLAIM_CURRENT_BONUS_REWARDS_PATH,
              );
            },
            async purchaseOffer(e, t) {
              return await this.eventShopDataBinding.post(
                s.PURCHASE_OFFER_PATH,
          ...
          updatePlayerSettings(e, t) {
            this.settingsDataBinding.observe("/ready", this, (n) => {
              n &&
                ...
                this.settingsDataBinding.patch(
                  "/account/LCUPreferences/event-shop",
                  {
                    data: {
      ...
      (e, t, n) => {
        ...
        var a = s.Ember.Service.extend({
          ...
          initConfigObservers() {
            this.observeConfig(
              "easierNavigationEnabled",
              "/lol.client_settings.event_shop.easier_navigation_enabled",
            ),
              this.observeConfig(
                "scrollingArrowsEnabled",
                "/lol.client_settings.reward_track.scrolling_arrows_enabled",
              );
          },
                ...
                (a.includes(t) ||
                  (s.logger.warning(
                    `Configuration: ${JSON.stringify(
                      t,
                    )} for ${e} is not an accepted value in ${JSON.stringify(
                      a,
                    )}. Using default value: ${JSON.stringify(n)}`,
                  ),
                  (t = n)),
                this.set(e, t));
            });
        ...
        var s = n(1),
          ...
          l = s.Ember.Component.extend({
            ...
            tokenImageSrc: s.Ember.computed.alias(
              "eventShopService.tokenShopData.tokenImage",
            ),
            currentTokenBalance: s.Ember.computed.alias(
              "eventShopService.tokenBalance",
            ),
            ...
            init() {
              this._super(...arguments),
                (this.notEnoughRp =
                  this.get("offer.offerState") === a.OFFER_STATES.UNAVAILABLE),
                (this.offerPurchased =
                  this.get("offer.offerState") === a.OFFER_STATES.OWNED),
                (this.disableButtonState =
                  this.notEnoughRp || this.offerPurchased),
                (this.purchaseInProgress =
                  this.get("offer.offerState") === a.OFFER_STATES.PURCHASING);
            },
            showPostPurchaseConfirmation() {
              ...
              s.UIKit.getModalManager().add({
                ...
                data: {
                  contents: e,
                  okText: this.get(
                    "tra.event_shop_card_purchase_confirmation_done",
                  ),
                },
              });
            },
            showGeneralErrorModal() {
              const e = s.UIKit.getTemplateHelper().contentBlockDialog(
                this.get("tra.event_shop_generic_purchase_error_header"),
                this.get("tra.event_shop_generic_purchase_error_body"),
              );
              s.UIKit.getModalManager().add({
                type: "DialogAlert",
                data: {
      ...
      (e, t) => {
        ...
        var a = { getCategoryOffersId: n, getOfferPurchaseConstraints: s };
        t.default = a;
      },
      (e, t, n) => {
        "use strict";
        ...
        var s = n(1),
          ...
          l = s.Ember.Component.extend({
            ...
            categoryTra: s.Ember.computed("category", function () {
              return this.get(
                `tra.${(0, o.getCategoryOffersId)(this.category)}_tooltip`,
              );
            }),
            click() {
        ...
        var s = n(1),
          ...
          l = s.Ember.Component.extend({
            ...
            categoryOffersId: s.Ember.computed(
              ...
              function () {
                return (0, o.getCategoryOffersId)(
            ...
            didInsertElement() {
              ...
              const e = this.element.querySelectorAll(
                `.${a.EVENT_SHOP_OFFER_CARD_CONTAINER_CLASSNAME}`,
              );
      ...
      (e, t, n) => {
        ...
        var l = s.Ember.Component.extend({
          ...
          classNameBindings: [
            "easierNavigationEnabled:event-shop-offer-card-resized",
          ...
          easierNavigationEnabled: s.Ember.computed.alias(
            "clientConfigService.easierNavigationEnabled",
          ),
          tooltipManager: s.UIKit.getTooltipManager(),
          isMouseOver: !1,
          tokenShopData: s.Ember.computed.alias(
            "eventShopService.tokenShopData",
          ),
            ...
            return (
              s.Telemetry.sendCustomData(a.TELEMETRY.TABLE, {
                ...
                tokenBalance: this.get(
                  "eventShopService.info.currentTokenBalance",
                ),
              }),
        ...
        e.exports = (s.default || s).template({
          ...
          main: function (e, t, n, s, a) {
            ...
            return (
              ...
              c(
                typeof (o =
                  null != (o = n.youNeedText || (null != t ? t.youNeedText : t))
                    ? o
                    : r) === i
                  ? o.call(l, { name: "youNeedText", hash: {}, data: a })
                  : o,
              ) +
              ...
              c(
                typeof (o =
                  null !=
                  (o = n.requiredTokens || (null != t ? t.requiredTokens : t))
                    ? o
                    : r) === i
                  ? o.call(l, { name: "requiredTokens", hash: {}, data: a })
                  : o,
              ) +
              " " +
              c(
                typeof (o =
                  null !=
                  (o = n.moreTokensText || (null != t ? t.moreTokensText : t))
                    ? o
                    : r) === i
                  ? o.call(l, { name: "moreTokensText", hash: {}, data: a })
                  : o,
              ) +
              " </span>" +
              c(
                typeof (o =
                  null != (o = n.unlockText || (null != t ? t.unlockText : t))
                    ? o
                    : r) === i
                  ? o.call(l, { name: "unlockText", hash: {}, data: a })
                  : o,
              ) +
      ...
      (e, t, n) => {
        ...
        var s,
          a = n(24),
          o = n(25),
          l = (s = o) && s.__esModule ? s : { default: s };
        (t.default = function (e) {
          e.registerHelper("each", function (e, t) {
            ...
            if (
              ...
              if (a.isArray(e))
                for (var d = e.length; o < d; o++)
                  o in e && p(o, o, o === e.length - 1);
              else {
                var u = void 0;
                for (var m in e)
                  e.hasOwnProperty(m) &&
                    (void 0 !== u && p(u, o - 1), (u = m), o++);
                void 0 !== u && p(u, o - 1, !0);
              }
          ...
          (t.template = function (e, t) {
            ...
            var n = {
              ...
              invokePartial: function (n, s, o) {
                o.hash &&
                  ((s = a.extend({}, s, o.hash)), o.ids && (o.ids[0] = !0)),
                  (n = t.VM.resolvePartial.call(this, n, s, o));
              ...
              program: function (e, t, n, s, a) {
                ...
                return (
                  t || a || s || n
                    ? (o = i(this, e, l, t, n, s, a))
                    : o || (o = this.programs[e] = i(this, e, l)),
                  o
                );
              },
              data: function (e, t) {
                ...
                e.useDepths &&
                  (l = a.depths
                    ? t != a.depths[0]
                      ...
                      : a.depths
                    : [t]),
                (c = p(e.main, c, n, a.depths || [], o, i))(t, a)
              );
            }
            return (
              (s.isTop = !0),
          ...
          function r(t) {
            ...
            return (
              ...
              n(
                ...
                e.partials,
                a.data || s,
                o && [a.blockParams].concat(o),
                r,
              )
            );
          }
          return (
            ((r = p(n, r, e, l, s, o)).program = t),
      ...
      (e, t, n) => {
        ...
        var l = s.Ember.Component.extend({
          ...
          eventDetailsData: s.Ember.computed.alias(
            "eventShopService.eventDetailsData",
          ),
          isGracePeriod: s.Ember.computed.alias(
            "eventShopService.isGracePeriod",
          ),
          clientConfigService: s.Ember.inject.service("client-config"),
          easierNavigationEnabled: s.Ember.computed.alias(
            "clientConfigService.easierNavigationEnabled",
          ...
          tokenBundlesCatalogEntry: s.Ember.computed.alias(
            "eventShopService.tokenShopData.tokenBundlesCatalogEntry",
          ),
          ...
          renderHelpContainer(e) {
            const t = e({
                ...
                introText: this.get(
                  "tra.event_shop_help_modal_text_description_intro",
                ),
                eventIconPath: this.get("eventDetailsData.eventIconPath"),
                eventName: this.get("eventDetailsData.eventName"),
                helpModalImagePath: this.get(
                  "eventDetailsData.helpModalImagePath",
                ),
                earnTokensText: this.get(
                  "tra.event_shop_help_modal_earn_tokens",
                ),
                earnTokensDescriptionText: this.get(
                  "tra.event_shop_help_modal_earn_tokens_description",
                ),
                redeemTokensText: this.get(
                  "tra.event_shop_help_modal_redeem_tokens",
                ),
                redeemTokensDescriptionText: this.get(
                  "tra.event_shop_help_modal_redeem_tokens_description",
                ),
                upgradePassText: this.get(
                  "tra.event_shop_help_modal_upgrade_pass",
                ),
                upgradePassDescriptionText: this.get(
                  "tra.event_shop_help_modal_upgrade_pass_description",
                ),
              }),
          ...
          getEndTimerTooltipText(e, t) {
            const n = new Date(e),
              a = n.toLocaleDateString(t, { dateStyle: "medium" }),
            ...
            navigateToStore() {
              s.Telemetry.sendCustomData(a.TELEMETRY.TABLE, {
                ...
                lockedTokens: this.get(
                  "eventShopService.info.lockedTokenCount",
                ),
                tokenBalance: this.get(
                  "eventShopService.info.currentTokenBalance",
                ),
        ...
        e.exports = (s.default || s).template({
          ...
          main: function (e, t, n, s, a) {
            var o,
              ...
              c = e.escapeExpression;
            return (
              '<lol-uikit-content-block type="dialog-large" id="event-shop-help-modal">\r\n  <div class="event-shop-help-modal-top">\r\n    <div class="event-shop-help-modal-event-name">\r\n      <img class="event-shop-help-modal-logo" src=' +
              c(
                typeof (o =
                  null !=
                  (o = n.eventIconPath || (null != t ? t.eventIconPath : t))
                    ? o
                    : r) === i
                  ? o.call(l, { name: "eventIconPath", hash: {}, data: a })
                  : o,
              ) +
              " />\r\n      " +
              c(
                typeof (o =
                  null != (o = n.eventName || (null != t ? t.eventName : t))
                    ? o
                    : r) === i
                  ? o.call(l, { name: "eventName", hash: {}, data: a })
                  : o,
              ) +
              '\r\n    </div>\r\n    <div class="event-shop-help-modal-title">' +
              c(
                typeof (o =
                  null !=
                  (o = n.helpModalTitle || (null != t ? t.helpModalTitle : t))
                    ? o
                    : r) === i
                  ? o.call(l, { name: "helpModalTitle", hash: {}, data: a })
                  : o,
              ) +
              '</div>\r\n    <hr class="heading-spacer" />\r\n  </div>\r\n  <div class="event-shop-help-modal-mid">\r\n    <img class="event-shop-help-modal-image" src=' +
              c(
                typeof (o =
                  null !=
                  (o =
                    n.helpModalImagePath ||
                    (null != t ? t.helpModalImagePath : t))
                    ? o
                    : r) === i
                  ? o.call(l, { name: "helpModalImagePath", hash: {}, data: a })
                  : o,
              ) +
              ' />\r\n  </div>\r\n  <div class="event-shop-help-modal-bot">\r\n    <div class="event-shop-help-modal-bot-containers">\r\n      <div class="event-shop-help-modal-icons event-shop-help-modal-icon-loot"></div>\r\n      <div class="event-shop-help-modal-topic">' +
              c(
                typeof (o =
                  null !=
                  (o = n.earnTokensText || (null != t ? t.earnTokensText : t))
                    ? o
                    : r) === i
                  ? o.call(l, { name: "earnTokensText", hash: {}, data: a })
                  : o,
              ) +
              '</div>\r\n      <div class="event-shop-help-description">' +
              c(
                typeof (o =
                  null !=
                  (o =
                    n.earnTokensDescriptionText ||
                    (null != t ? t.earnTokensDescriptionText : t))
                    ? o
                    : r) === i
                  ? o.call(l, {
              ...
              c(
                typeof (o =
                  null !=
                  (o =
                    n.redeemTokensText || (null != t ? t.redeemTokensText : t))
                    ? o
                    : r) === i
                  ? o.call(l, { name: "redeemTokensText", hash: {}, data: a })
                  : o,
              ) +
              '</div>\r\n      <div class="event-shop-help-description">' +
              c(
                typeof (o =
                  null !=
                  (o =
                    n.redeemTokensDescriptionText ||
                    (null != t ? t.redeemTokensDescriptionText : t))
                    ? o
                    : r) === i
                  ? o.call(l, {
              ...
              c(
                typeof (o =
                  null !=
                  (o = n.upgradePassText || (null != t ? t.upgradePassText : t))
                    ? o
                    : r) === i
                  ? o.call(l, { name: "upgradePassText", hash: {}, data: a })
                  : o,
              ) +
              '</div>\r\n      <div class="event-shop-help-description">' +
              c(
                typeof (o =
                  null !=
                  (o =
                    n.upgradePassDescriptionText ||
                    (null != t ? t.upgradePassDescriptionText : t))
                    ? o
                    : r) === i
                  ? o.call(l, {
        ...
        var s = n(1),
          ...
          o = s.Ember.Component.extend({
            ...
            failureLoadingRewardTrack: s.Ember.computed.alias(
              "eventShopService.failureLoadingRewardTrack",
            ),
            rewardTrackItems: s.Ember.computed.alias(
              "eventShopService.rewardTrackItems",
            ),
            eventShopProgressionData: s.Ember.computed.alias(
              "eventShopService.eventShopProgressionData",
            ),
            unclaimedRewards: s.Ember.computed.alias(
              "eventShopService.unclaimedRewards.rewardsCount",
            ),
            lockedTokens: s.Ember.computed.alias(
              "eventShopService.unclaimedRewards.lockedTokensCount",
            ),
      ...
      (e, t, n) => {
        ...
        var l = s.Ember.Component.extend({
          ...
          summarySubtitle: s.Ember.computed.alias(
            "tra.event_shop_purchase_modal_summary_pass_subtitle",
          ),
          ...
          optionsPointerClass: s.Ember.computed(
            ...
            function () {
              return this.get("isExecutingPurchase") ||
                ...
                ? ""
                : "event-shop-purchase-modal-option-pointer";
            },
          ),
          options: s.Ember.computed("bundles", function () {
            ...
            const t = o[e.length] || {},
              ...
              a = t.LOCATIONS || [],
              l = e
                .sort((e, t) => t.bundledItems.length - e.bundledItems.length)
                .map((e, t) => ({
                  ...e,
            ...
            if (1 === l.length) {
              ...
              this.set("selectedOption", e),
                s.Ember.set(
                  e,
                  "selectedCssClass",
                  "event-shop-purchase-modal-option-selected",
                );
            }
            return l;
          }),
          summaryTitle: s.Ember.computed("selectedOption", function () {
            ...
            return e
              ? e.details.name
              : this.get(
                  "tra.event_shop_purchase_modal_summary_default_pass_title",
                );
          }),
          newBalance: s.Ember.computed("selectedOption", function () {
            const e = this.get("selectedOption");
            return e && e.futureBalance
              ? s.tra.formatString("event_shop_purchase_modal_rp", {
          ...
          discountPercentage: s.Ember.computed("selectedOption", function () {
            ...
            return e && e.discountPercentage
              ? s.tra.formatString(
                  "event_shop_purchase_modal_discount_percentage",
          ...
          optionsExecutingPurchaseClass: s.Ember.computed(
            ...
            function () {
              return this.get("isExecutingPurchase")
                ? "event-shop-purchase-modal-option-executing-purchase"
                : "";
            },
          ),
          ...
          defineSeeMoreElementVisibility() {
            if (!this.get("selectedOption"))
              return void this.set(
                ...
                "event-shop-purchase-modal-description-see-more-display-none",
              );
            const e = document.getElementById(
              "event-shop-purchse-modal-summary-description-text",
            );
            e && e.offsetHeight < 72
              ? this.set(
                  "descriptionElementAdditionalClassName",
              ...
              this.get("eventShopService")
                ...
                .catch((e) => {
                  ...
                  const t = s.UIKit.getTemplateHelper().contentBlockDialog(
                    this.get("tra.event_shop_generic_error_header"),
                    this.get("tra.event_shop_generic_error_body"),
                  );
          ...
          setIsDescriptionExpanded(e) {
            ...
            const t = document.getElementById(
              "event-shop-purchse-modal-summary-description",
            );
            if (t)
              if (e) {
      ...
      (e, t, n) => {
        ...
        var s = n(1),
          a = n(45),
          o = n(7);
        const { TRACKER_SIZE: l } = a.REWARD_TRACKER;
        var r = s.Ember.Component.extend({
          ...
          rewardTrackProgress: s.Ember.computed.alias(
            "eventShopService.rewardTrackProgress",
          ),
          rewardTrackItems: s.Ember.computed.alias(
            "eventShopService.rewardTrackItems",
          ),
          rewardTrackBonusProgress: s.Ember.computed.alias(
            "eventShopService.rewardTrackBonusProgress",
          ),
          rewardTrackBonusItems: s.Ember.computed.alias(
            "eventShopService.rewardTrackBonusItems",
          ),
          isGracePeriod: s.Ember.computed.alias(
            "eventShopService.isGracePeriod",
          ),
          scrollingArrowsEnabled: s.Ember.computed.alias(
            "clientConfigService.scrollingArrowsEnabled",
          ),
          handleClickItem(e, t = !1) {
            this.trackItemHasUnclaimedRewards(e) &&
              ...
              t
                ? this.get("eventShopService").claimCurrentBonusItems()
                : this.get("eventShopService").claimAllPendingRewards());
          },
          trackItemHasUnclaimedRewards: ({ rewardOptions: e }) =>
            e.some(
              ({ state: e }) => e === o.REWARD_TRACK_ITEM_STATE.UNSELECTED,
            ),
          actions: {
            clickItem(e) {
      ...
      (e, t) => {
        ...
        var r = { TIME_UNITS: n, TIME_CONVERSIONS: l };
        t.default = r;
      },
      (e, t, n) => {
        "use strict";
      ...
      (e, t, n) => {
        ...
        var r = s.Ember.Component.extend({
          ...
          eventShopService: s.Ember.inject.service("event-shop"),
          failureLoadingTokenShop: s.Ember.computed.alias(
            "eventShopService.failureLoadingTokenShop",
          ),
          categoriesOffers: s.Ember.computed.alias(
            "eventShopService.categoriesOffers",
          ),
          clientConfigService: s.Ember.inject.service("client-config"),
          easierNavigationEnabled: s.Ember.computed.alias(
            "clientConfigService.easierNavigationEnabled",
          ...
          init() {
            ...
            (this.headerTxtObserver = new IntersectionObserver(
              ...
              this.observeTokenShopData();
          },
          observeTokenShopData() {
            this.eventShopDataBinding.observe(l, this, (e) => {
              if (this.isDestroying || this.isDestroyed || !e)
                return (
                  (this.tokenName = null),
                  (this.tokenImage = null),
                  void (this.tokenBundlesCatalogEntry = null)
                );
              this.setProperties({
                tokenName: e.tokenName,
                tokenImage: e.tokenImage,
                tokenBundlesCatalogEntry: e.tokenBundlesCatalogEntry,
              }),
                (this.storeItems = this.tokenBundlesCatalogEntry.map((e) => ({
                  itemId: e.itemId,
                  inventoryType: "BUNDLES",
                })));
            });
          ...
          setCurrentCategoryTra(e) {
            this.setProperties({
              currentCategory: e,
              currentCategoryTra: this.get(
                `tra.${(0, o.getCategoryOffersId)(e)}`,
              ),
            });
          },
          updateHeader(e) {
          ...
          willDestroyElement() {
            this._super(...arguments),
              this.eventShopDataBinding.removeObserver(l, this);
          },
          actions: {
            navigateToStore() {
              s.Telemetry.sendCustomData(a.TELEMETRY.TABLE, {
      ...
      (e, t, n) => {
        ...
        var a = s.Ember.Component.extend({
          ...
          rewardTrackXP: s.Ember.computed.alias(
            "eventShopService.rewardTrackXP",
          ),
          isGracePeriod: s.Ember.computed.alias(
            "eventShopService.isGracePeriod",
          ),
          ...
          levelLabel: s.Ember.computed("rewardTrackXP", function () {
            return this.get("rewardTrackXP.currentLevel") > 0
              ? `${this.get("tra.event_shop_xp_label_level")} ${this.get(
                  "rewardTrackXP.currentLevel",
                )}`
              : `${this.get("tra.event_shop_xp_label_level")} ${this.get(
                  "tra.event_shop_xp_label_level_start",
                )}`;
          }),
        ...
        var s = n(1),
          a = s.Ember.Controller.extend({
              ...
              function () {
                return s.Ember.String.htmlSafe(
                  `background-image: url(${this.get(
                    "backgroundData.backgroundImagePath",
                  )})`,
                );
              },
            ),
            ...
            tokenShopOffersVersion: s.Ember.computed.alias(
              "eventShopService.tokenShopData.offersVersion",
            ),
      ...
      (e, t, n) => {
        ...
        e.exports = s.HTMLBars.template({
          id: "P08Co+kA",
          block:
            '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_24\\\\LeagueClientContent_Release\\\\15690\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-event-shop\\\\src\\\\app\\\\templates\\\\components\\\\event-shop-token-shop.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_24\\\\LeagueClientContent_Release\\\\15690\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-event-shop\\\\src\\\\app\\\\styles\\\\components\\\\event-shop-token-shop.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_24\\\\LeagueClientContent_Release\\\\15690\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-event-shop\\\\src\\\\app\\\\components\\\\event-shop-token-shop.js\\" "],["text","\\n"],["block",["if"],[["get",["categoriesOffers","length"]]],null,6,0]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","  "],["append",["helper",["event-shop-fallback"],null,[["error"],[["get",["failureLoadingTokenShop"]]]]],false],["text","\\n"]],"locals":[]},{"statements":[["text","          "],["open-element","div",[]],["static-attr","class","event-shop-token-shop-section-divider"],["flush-element"],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","          "],["open-element","div",[]],["static-attr","class","event-shop-token-shop-section-header-title-text"],["flush-element"],["append",["helper",["get"],[["get",["tra"]],["helper",["concat"],["event_shop_offers_category_",["get",["categoryOffers","category"]]],null]],null],false],["close-element"],["text","\\n          "],["open-element","hr",[]],["static-attr","class","event-shop-token-shop-section-header-line"],["flush-element"],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["block",["if"],[["get",["easierNavigationEnabled"]]],null,2],["text","          "],["append",["helper",["event-shop-category-offers"],null,[["categoryOffers","headerTxtObserver"],[["get",["categoryOffers"]],["get",["headerTxtObserver"]]]]],false],["text","\\n"],["block",["unless"],[["get",["easierNavigationEnabled"]]],null,1]],"locals":["categoryOffers"]},{"statements":[["text","              "],["open-element","lol-uikit-content-block",[]],["static-attr","class","event-shop-token-shop-buy-tokens-tooltip"],["static-attr","type","tooltip-system"],["flush-element"],["text","\\n                "],["append",["unknown",["tra","event_shop_token_shop_buy_tokens_tooltip"]],false],["text","\\n              "],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","    "],["open-element","div",[]],["static-attr","class","event-shop-token-shop-header"],["flush-element"],["text","\\n      "],["open-element","div",[]],["static-attr","class","event-shop-token-shop-name"],["flush-element"],["text","\\n        "],["append",["unknown",["tra","event_shop_token_shop_name"]],false],["text","\\n      "],["close-element"],["text","\\n      "],["open-element","div",[]],["static-attr","class","event-shop-page-header-vertical-divider"],["flush-element"],["close-element"],["text","\\n      "],["open-element","div",[]],["static-attr","class","event-shop-token-shop-details"],["flush-element"],["append",["unknown",["currentCategoryTra"]],false],["close-element"],["text","\\n      "],["open-element","div",[]],["static-attr","class","event-shop-token-shop-balance"],["flush-element"],["text","\\n        "],["open-element","div",[]],["static-attr","class","event-shop-token-shop-balance-current"],["flush-element"],["text","\\n          "],["open-element","div",[]],["static-attr","class","event-shop-token-shop-balance-label"],["flush-element"],["text","\\n            "],["append",["unknown",["tra","event_shop_token_shop_balance_you_have"]],false],["text","\\n          "],["close-element"],["text","\\n          "],["open-element","img",[]],["static-attr","class","event-shop-token-shop-balance-icon"],["dynamic-attr","src",["unknown",["tokenImage"]],null],["flush-element"],["close-element"],["text","\\n          "],["append",["unknown",["event-shop-token-balance-amount"]],false],["text","\\n        "],["close-element"],["text","\\n        "],["open-element","div",[]],["static-attr","class","event-shop-token-shop-buy-tokens-link"],["flush-element"],["text","\\n          "],["open-element","lol-uikit-close-button",[]],["static-attr","button-type","plus"],["dynamic-attr","onclick",["helper",["action"],[["get",[null]],"navigateToStore"],null],null],["flush-element"],["text","\\n"],["block",["uikit-tooltip"],null,[["tooltipPosition","type"],["bottom","system"]],4],["text","          "],["close-element"],["text","\\n        "],["close-element"],["text","\\n      "],["close-element"],["text","\\n    "],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","  "],["append",["helper",["event-shop-category-nav-bar"],null,[["currentCategory","categoriesOffers","scrollToCategory"],[["get",["currentCategory"]],["get",["categoriesOffers"]],["helper",["action"],[["get",[null]],"scrollToCategory"],null]]]],false],["text","\\n  "],["open-element","lol-uikit-scrollable",[]],["static-attr","id","token-shop-scrollable-container"],["static-attr","class","event-shop-token-shop-scrollable-section"],["flush-element"],["text","\\n"],["block",["unless"],[["get",["easierNavigationEnabled"]]],null,5],["text","    "],["open-element","div",[]],["static-attr","class","event-shop-token-shop-content"],["flush-element"],["text","\\n      "],["open-element","div",[]],["static-attr","class","event-shop-token-shop-offers"],["flush-element"],["text","\\n"],["block",["each"],[["get",["categoriesOffers"]]],null,3],["text","      "],["close-element"],["text","\\n    "],["close-element"],["text","\\n  "],["close-element"],["text","\\n"]],"locals":[]}],"hasPartials":false}',
          meta: {},
        });
      },
      (e, t, n) => {
              ...
              .init(e, {
                ...
                dataBinding: (e) =>
                  e
                    ...
                    .getDataBinding("rcp-fe-lol-event-shop"),
