(() => {
  var e = [
      ...
      (e, t, n) => {
        ...
        var o,
          a = n(1),
          r = (o = n(4)) && o.__esModule ? o : { default: o };
        t.default = class {
          constructor() {
            (this.settingsBinding = (0, a.dataBinding)("/lol-settings")),
              (this.telemetryBinding = (0, a.dataBinding)("telemetry")),
              (this.isScreenRootBumped = !1),
              (this.application = void 0),
              (this.screenRoot = a.Viewport.main().getScreenRoot(
                "rcp-fe-lol-yourshop",
              )),
              this.initializeTra();
          }
          initializeTra() {
            this.tra = (0, a.getProvider)()
              .get("rcp-fe-lol-l10n")
              .tra()
              .overlay("/fe/lol-l10n/trans.json")
              .overlay("/fe/ember-libs/trans-icon-rarity.json")
              .overlay("/fe/lol-yourshop/trans.json");
          }
          show() {
            var e;
            this.application ||
              (this.application =
                ((e = (0, r.default)(a.Ember, this.tra)),
                a.emberApplicationFactory.setFactoryDefinition({
                  ...
                  RemainingTimeTextComponent:
                    a.SharedEmberComponents.RemainingTimeTextComponent,
                }),
                a.emberApplicationFactory.setFactoryDefinition({
                ...
                a.componentFactory.create("rcp-fe-lol-yourshop"))),
              this.screenRoot
                .getElement()
                .appendChild(this.application.domNode),
              this.isScreenRootBumped ||
                (this.screenRoot.bump(), (this.isScreenRootBumped = !0)),
              this.settingsBinding.patch(
                "/v2/account/LCUPreferences/yourshop",
                {
                  data: { lastViewedTimestamp: new Date().toISOString() },
                  schemaVersion: 1,
                },
              ),
          ...
          hide() {
            this.application &&
              ...
              this.isScreenRootBumped &&
                (this.screenRoot.release(), (this.isScreenRootBumped = !1)),
              this.sendTelemetryEvent("yourshop_event", {
                id: "YOURSHOP_HIDE_EVENT",
              });
          }
          sendTelemetryEvent(e, t) {
            (t = Object.assign(t, { plugin: "rcp-fe-lol-yourshop" })),
      ...
      (e) => {
        ...
        function n(e, t, n) {
          const { regions: o, region: a, locale: r } = e.metadata();
        ...
        e.exports = function (e, o, a) {
          ...
          return (
            ...
            r.set("service", r),
            r.addObserver("metadata.region", n.bind(null, o, "region")),
            r.addObserver("metadata.locale", n.bind(null, o, "locale")),
            a &&
              (console.warning(
                "deprecated: pass a traService as a property of your Ember application definition",
              ),
              a.register("tra:main", r, { instantiate: !1 }),
      ...
      (e, t, n) => {
        ...
        n(6),
          ...
          (e.exports = o.Ember.Component.extend({
            ...
            seasonalBackground: o.Ember.computed.readOnly(
              "yourshop.useThemedBackground",
            ),
            isTencentRegion: o.Ember.computed.readOnly(
              "yourshop.isTencentRegion",
            ),
            expirationDate: o.Ember.computed.readOnly(
              "yourshop.status.endTime",
            ),
            playerHasSetPermissions: o.Ember.computed.readOnly(
              "yourshop.playerHasSetPermissions",
            ),
            isDataAuthModalVisible: !1,
            shouldDisplayOffers: o.Ember.computed(
              "offers",
              "isDataAuthModalVisible",
              function () {
                return (
                  !!this.get("offers") && !this.get("isDataAuthModalVisible")
                );
              },
            ),
            ...
            settingsLoaded: o.Ember.computed(
              "isTencentRegion",
              "playerHasSetPermissions",
              function () {
                return (
                  void 0 !== this.get("isTencentRegion") &&
                  void 0 !== this.get("playerHasSetPermissions") &&
                  (this.get("isTencentRegion") &&
                  !1 === this.get("playerHasSetPermissions")
                    ? (this.get("yourshop").showDataAuthModal(
                        this.notifyModalVisible.bind(this),
                      ),
                      !1)
                    : (this.get("errorLookup").checkForOffersAndErrors(), !0))
                );
              },
            ),
      ...
      (e, t, n) => {
        ...
        n(10),
          (e.exports = o.Ember.Component.extend({
            ...
            shouldShowPricing: o.Ember.computed.and(
              "offer.revealed",
              "notOwned",
              "notPurchasing",
            ),
            originalPriceText: o.Ember.computed(
              "offer.originalPrice",
              "tra.yourshop_original_price_rp",
              function () {
      ...
      (e, t, n) => {
        ...
        n(13),
          (e.exports = o.Ember.Component.extend({
            ...
            classNameBindings: [
              "fadedOut:yourshop-offer-card-content-owned:yourshop-offer-card-content",
              "offer.purchasing:yourshop-offer-card-content-purchasing",
            ],
            layout: n(14),
            yourshop: o.Ember.inject.service(),
            ...
            onDidInsertElement: o.Ember.on("didInsertElement", function () {
              this.$(".offer-card-state-machine")[0].subscribeParameterChanged(
                (e, t, n) => {
              ...
              switch (e) {
                case "reveal-intro":
                  o.audioPlugin
                    .getChannel("sfx-ui")
                    .playSound(
                      "/fe/lol-static-assets/sounds/po-sfx-card-activate.ogg",
                    );
                  break;
                case "purchased":
                  o.Ember.run.next(() => {
            ...
            hasOfferRarity: o.Ember.computed("offer.rarity", function () {
              const e = this.get("offer.rarity");
              return e && "kNoRarity" !== e?.id && 0 !== e?.id;
            }),
            revealingState: null,
            ...
            click: function () {
              ...
              e &&
                !e.owned &&
                (e.revealed
                  ? this.get("yourshop").showOfferDetails(e)
                  : (this.get("yourshop").reveal(e, () => {
                      this.set("revealingState", "revealed");
                    }),
                    o.audioPlugin
                      .getChannel("sfx-ui")
                      .playSound(
                        "/fe/lol-static-assets/sounds/sfx-yourshop-reveal-click.ogg",
                      ),
                    this.set("revealingState", "revealing")));
            },
            mouseEnter: function () {
              o.audioPlugin
                .getChannel("sfx-ui")
                .playSound(
                  "/fe/lol-static-assets/sounds/po-sfx-uikit-button-gold-hover.ogg",
                );
            },
          }));
      },
      ...
      (e, t, n) => {
        ...
        e.exports = a.Ember.Service.extend(l, {
          ...
          reveal: function (e, t) {
            e &&
              !e.revealed &&
              (0, a.dataBinding)("/lol-yourshop")
                .post(`/v1/offers/${e.id}/reveal`)
                .then(() => {
          ...
          dataAuthModalHelper(e) {
            const t = {
                ...
                paragraphOne: this.get(
                  "tra.yourshop_tencent_data_usage_modal_text_1",
                ),
                paragraphTwo: this.get(
                  "tra.yourshop_tencent_data_usage_modal_text_2",
                ),
                dataUsageLink: this.get(
                  "tra.yourshop_tencent_data_usage_modal_link",
                ),
                dataUsageLinkText: this.get(
                  "tra.yourshop_tencent_data_usage_modal_link_text",
                ),
              },
          ...
          setDataUsage(e) {
            const t = { useData: e };
            return (0, a.dataBinding)("/lol-yourshop/v1").post(
              "/permissions",
              t,
            );
          },
              ...
              .then((t) => {
                if (t) {
                  const t = this.dataAuthModalHelper(s),
                    n = this.get(
                      "tra.yourshop_tencent_data_usage_modal_accept_button",
                    ),
                    o = this.get(
                      "tra.yourshop_tencent_data_usage_modal_reject_button",
                    ),
                    a = () => {
      ...
      (e, t, n) => {
        ...
        e.exports = o.Ember.Object.extend(a, {
          skin: o.Ember.computed(
            "champion.skins.@each.id",
            "skinId",
            function () {
          ...
          discountPercentage: o.Ember.computed(
            "originalPrice",
            "discountPrice",
            function () {
          ...
          discountPercentageText: o.Ember.computed(
            "discountPercentage",
            "root.tra.yourshop_discount_percentage",
            function () {
              const e = this.get("discountPercentage");
              if (e)
                return this.get("root.tra").formatString(
                  "yourshop_discount_percentage",
          ...
          isTencent: o.Ember.computed("regionLocale", function () {
            return (
              ...
              "TENCENT" === this.get("regionLocale").region
            );
          }),
          rarityId: o.Ember.computed(
            "isTencent",
            "skin.regionRarityId",
            "skin.rarity",
            function () {
              return this.get("isTencent")
                ? this.get("skin.regionRarityId")
                : this.get("skin.rarity");
            },
          ),
          rarity: o.Ember.computed("rarityId", function () {
            return o.RarityManager.agregatedSkinRarityInformationByTier[
              this.get("rarityId")
            ];
          }),
          rarityGemPath: o.Ember.computed("rarity", function () {
            const e = this.get("rarity");
            if (e) return e.gemIcon;
          }),
        ...
        e.exports = (o.default || o).template({
          ...
          main: function (e, t, n, o, a) {
            ...
            return (
              ...
              ' class="data-auth-link" target="_blank">\r\n    ' +
              c(
                typeof (r =
                  null !=
                  (r =
        ...
        (t.__esModule = !0),
          (t.default = function (e) {
            e.registerHelper("log", function () {
              for (
                var t = [void 0], n = arguments[arguments.length - 1], o = 0;
        ...
        (t.default = function (e) {
          e.registerHelper("with", function (e, t) {
            ...
            return (
              t.data &&
                t.ids &&
                ((a = o.createFrame(t.data)).contextPath = o.appendContextPath(
                  t.data.contextPath,
                  t.ids[0],
                )),
              n(e, {
                ...
                o.partial
                  ...
                  : ((n.helpers = n.merge(o.helpers, t.helpers)),
                    ...
                    (e.usePartial || e.useDecorators) &&
                      (n.decorators = n.merge(o.decorators, t.decorators)));
              }),
      ...
      (e, t, n) => {
        ...
        e.exports = o.Ember.Service.extend({
          ...
          checkForOffersAndErrors: function () {
            (0, o.dataBinding)("/lol-yourshop")
              .get("/v1/offers", { skipCache: !0 })
          ...
          handleOffersError: function (e) {
            ...
            (n =
              void 0 !== a[t]
                ? this.tra.get(a[t])
                : this.tra.get(a.GENERIC_CODE)),
              this.set("currentErrorText", n),
              this.set("currentErrorCode", t),
              this.get("telemetry").sendEvent({
      ...
      (e, t, n) => {
        ...
        n(46),
          (e.exports = o.Ember.Component.extend({
            ...
            endDateText: o.Ember.computed(
              "expirationDate",
              "tra.yourshop_end_date",
              "tra.metadata.locale",
              function () {
            ...
            endDateTextTooltip: o.Ember.computed(
              "expirationDate",
              "tra.yourshop_tencent_end_date_tooltip",
              "tra.metadata.locale",
              function () {
                const e = this.get("expirationDate");
                let t = this.get("tra.metadata.locale.id");
                ...
                return this.get("tra").formatString(
                  "yourshop_tencent_end_date_tooltip",
                  { dateString: n, timeString: o },
                );
              },
            ),
          }));
      ...
      (e, t, n) => {
        ...
        const a = (0, o.emberDataBinding)({
          ...
          boundProperties: {
            champion:
              "/lol-game-data/assets/v1/champions/{{offer.championId}}.json",
            purchaseConfirmationEnabled:
              "/lol-client-config/v3/client-config/lol.client_settings.store.lcu.personalizedOffersConfirmationEnabled",
          },
        });
        e.exports = o.Ember.Component.extend(a, {
          ...
          rarityText: o.Ember.computed("offer.rarity", function () {
            const e = this.get("offer.rarity");
            if (e && "kNoRarity" !== e.id) {
              const t = e.traKeySingular;
              return this.get(`tra.${t}`);
            }
          }),
          ...
          wallet: o.Ember.computed("yourshop.walletRP.RP", function () {
            ...
            return o.Ember.Object.create({ RP: e });
          }),
          includesChampion: o.Ember.computed.equal(
            "offer.type",
            "SkinWithChampion",
          ),
          newBalance: o.Ember.computed(
            "wallet.RP",
            "offer.discountPrice",
            function () {
          ...
          multipleDetailsclass: o.Ember.computed("hasOfferRarity", function () {
            return this.get("hasOfferRarity")
              ? "contains-multiple-detail"
              : "contains-single-detail";
          }),
          newBalanceText: o.Ember.computed(
            "newBalance",
            "tra.yourshop_details_new_balance_rp",
            function () {
              const e = this.get("newBalance") || 0;
              return this.get("tra").formatString(
                "yourshop_details_new_balance_rp",
                { newBalance: e },
              );
            },
          ),
          notEnoughRp: o.Ember.computed.lt("newBalance", 0),
          purchaseConfirmationNotChecked: o.Ember.computed.not(
            "purchaseConfirmationChecked",
          ),
          needsConfirmation: o.Ember.computed.and(
            "purchaseConfirmationEnabled",
            "purchaseConfirmationNotChecked",
          ),
          purchaseButtonDisabled: o.Ember.computed.or(
            "notEnoughRp",
            "needsConfirmation",
            "purchaseInProgress",
          ),
          displayPurchaseConfirmation: o.Ember.computed.readOnly(
            "purchaseConfirmationEnabled",
          ),
          confirmationText: o.Ember.computed(
            "tra.yourshop_details_purchase_confirmation_text",
            function () {
              const e = this.getConfirmationTextMatches(),
                t = this.element.querySelector(
                  ".offer-details-purchase-confirmation-label",
                );
              if (e && 3 === e.length && t) {
                const n = document.createElement("a"),
                  a = this.get(
                    "tra.yourshop_details_purchase_confirmation_link",
                  ),
                  r = this.get(
                    "tra.yourshop_details_purchase_confirmation_link_text",
                  );
                (n.target = "_blank"),
                  n.classList.add("yourshop-purchase-confirmation-link"),
                  (n.href = o.Ember.Handlebars.Utils.escapeExpression(a)),
                  (n.innerText = o.Ember.Handlebars.Utils.escapeExpression(r)),
          ...
          showGeneralErrorModal: function () {
            const e = o.lolUikitPlugin
              .getTemplateHelper()
              .contentBlockDialog(
                this.get("tra.yourshop_general_error_header"),
                this.get("tra.yourshop_general_error_body"),
              );
            o.lolUikitPlugin
              .getModalManager()
              .add({
          ...
          showPostPurchaseConfirmation: function () {
            const e = o.lolUikitPlugin
              ...
              .contentBlockDialog(
                this.get(
                  "tra.yourshop_details_post_purchase_confirmation_header",
                ),
                this.get(
                  "tra.yourshop_details_post_purchase_confirmation_body",
                ),
              );
            o.lolUikitPlugin
              .getModalManager()
              .add({
                ...
                data: {
                  contents: e,
                  okText: this.get(
                    "tra.yourshop_details_post_purchase_confirmation_done",
                  ),
                },
              });
          },
          executePurchase: function () {
            const e = this.get("offer");
            return (0, o.dataBinding)("/lol-yourshop")
              .post(`/v1/offers/${e.id}/purchase`)
              .then(() => {
                o.audioPlugin
                  .getChannel("sfx-ui")
                  .playSound(
                  ...
                  this.get("purchaseConfirmationEnabled") &&
          ...
          actions: {
            purchase: function () {
              const e = this.get("offer");
              !this.get("purchaseButtonDisabled") &&
                e &&
                (this.set("purchaseInProgress", !0),
                this.executePurchase().finally(() => {
              ...
              .init(e, {
                ...
                dataBinding: (e) =>
                  e
                    ...
                    .getDataBinding("rcp-fe-lol-yourshop"),
                Ember: (e) => e.get("rcp-fe-ember-libs").getEmber(),
                emberDataBinding: (e) =>
                  e
                    .get("rcp-fe-ember-libs")
                    .getEmberDataBinding("rcp-fe-lol-yourshop"),
