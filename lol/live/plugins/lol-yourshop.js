      ...
      (e, t, n) => {
        ...
        e.exports = o.Ember.Object.extend(a, {
          ...
          rarityGemPath: o.Ember.computed("rarity", function () {
            ...
            if (e)
              return `/lol-game-data/assets/v1/rarity-gem-icons/${e.gemIcon}.png`;
          }),
        ...
        const a = (0, o.emberDataBinding)({
          ...
          boundProperties: {
            ...
            purchaseConfirmationEnabled:
              "/lol-platform-config/v1/namespaces/LCUStore/PersonalizedOffersConfirmationEnabled",
          },
        });
