  ...
  var e = [
      ...
      (e, t, n) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.default = void 0);
        const o = new (
          (i = n(4)) && i.__esModule ? i : { default: i }
        ).default();
        var r = class {
          constructor() {
            o.initialise();
      ...
      (e, t, n) => {
        ...
        var i,
          o = n(1),
          r = (i = n(5)) && i.__esModule ? i : { default: i };
        const s = o.UiKitPlugin.getModalManager();
        var a = class {
          constructor(e) {
            (this._isObservingJmxToggle = !1),
              (this._rootElement = e),
              (this._isSkinsPickerEnabled = !1),
              (this._hasOngoingSession = !1),
              (this._hasInitialised = !1);
          }
          initialise() {
            (this._dataBinding = o.DataBinding.bindTo(
              (0, o.getProvider)().getSocket(),
            )),
              (this._loginSessionCallback = this._handleLoginSession.bind(
                this,
                this._dataBinding,
              )),
              this._dataBinding.addObserver(
                "/lol-login/v1/session",
                this._loginSessionCallback,
              ),
              (this._emberApplicationModel = o.Ember.Object.create()),
              (this._hasInitialised = !0);
          }
          getEmberApplication() {
            if (!this._isSkinsPickerEnabled)
              throw new Error("Skin Picker is not enabled");
            return (
              this._application ||
                (this._application = this._createEmberApplication()),
              this._application
            );
          }
          selectSkin(e, t, n) {
            if (!this._isSkinsPickerEnabled)
              return void o.logger.error("Skin Picker is not enabled");
            if ([e, t, n].some((e) => "function" != typeof e))
              throw new TypeError("selectSkin callbacks should be functions");
            this._emberApplicationModel.set("onSkinSelected", e),
              this._emberApplicationModel.set("onDefault", t),
              this._emberApplicationModel.set("selectedSkinId", null),
              this._emberApplicationModel.set(
                "onCloseButtonClicked",
                this._onCloseButtonClicked.bind(this),
              );
            ...
            this.getEmberApplication().renderPromise.then(() => {
              (this._modal = s.add({
                ...
                data: {
                  contents: i,
                  acceptText: this._tra.get(
                    "flyout_title_set_dynamic_background",
                  ),
                ...
                this._modal.acceptPromise.then(
                  ...
                  () => {
                    const t = this._emberApplicationModel.get("selectedSkinId"),
                      n = this._emberApplicationModel.get("selectedAugments");
                    Number.isInteger(t) && e(t, n),
                      this.removeCallbacks(),
                      this._endTelemetrySession();
                  },
                ),
                n(),
                (this._hasOngoingSession = !0),
                r.default.startTelemetrySession();
            });
          }
          removeCallbacks() {
            this._emberApplicationModel &&
              (this._emberApplicationModel.set("onSkinSelected", null),
              this._emberApplicationModel.set("onDefault", null),
              this._emberApplicationModel.set("selectedSkinId", null),
              this._emberApplicationModel.set("selectedAugments", null),
              this._emberApplicationModel.set("onCloseButtonClicked", null));
          }
          destroy() {
            this._hasInitialised ||
              o.logger.warning(
                "Trying to destroy an uninitialised API instance",
              ),
              this._application &&
                (this._application.onRemove(), delete this._application),
              this.removeCallbacks(),
              this._dataBinding.removeObserver(
                "/lol-login/v1/session",
                this._loginSessionCallback,
              );
          }
          _endTelemetrySession() {
            this._hasOngoingSession && r.default.endTelemetrySession(),
              (this._hasOngoingSession = !1);
          }
          _handleLoginSession(e, t) {
            ...
            n &&
              i &&
              !this._isObservingJmxToggle &&
              ((this._isObservingJmxToggle = !0),
              e.addObserver(
                "/lol-platform-config/v1/namespaces/Profiles/SkinsPickerEnabled",
                this._handleJmxToggle.bind(this),
              ));
          }
          _handleJmxToggle(e) {
            !1 !== e &&
              ((this._isSkinsPickerEnabled = !0), this._onPluginInit());
          }
          _onPluginInit() {
            (this._tra = o.l10n
              .tra()
              .overlay("/fe/lol-l10n/trans.json")
              .overlay("/fe/ember-libs/trans-icon-rarity.json")
              .overlay("/fe/lol-skins-picker/trans.json")),
              this._tra
                .ready()
                .then(
                  () =>
                    (this._traService = (0, o.EmberL10n)(o.Ember, this._tra)),
                  () => o.logger.error("Could not initialize l10n!"),
                )
                .then(
                  () => {
                    if (
                      (this._setEmberFactoryDefinitions(this._traService),
                      this._rootElement)
                    ) {
                      const e = this.getEmberApplication();
                      this._rootElement.appendChild(
                        o.ComponentFactory.getDOMNode(e),
                      );
                    }
                  },
      ...
      (e, t, n) => {
        ...
        var s = new (class {
          constructor() {
            (this._dataBinding = (0, i.DataBinding)(
              "/telemetry",
          ...
          startTelemetrySession() {
            (this._sessionStartTime = Date.now()),
              (this._userActivities = {}),
              this.sendEvent(
                o.TELEMETRY_EVENT_ID.SKINS_PICKER_SHOW,
                o.TELEMETRY_EVENT_SOURCE.SKINS_PICKER,
              );
          }
          endTelemetrySession() {
            this._sessionStartTime > 0
              ? this.sendEvent(
                  o.TELEMETRY_EVENT_ID.SKINS_PICKER_HIDE,
                  o.TELEMETRY_EVENT_SOURCE.SKINS_PICKER,
                  this._userActivities,
                )
              : i.logger.warning(
                  "Tried to end a telemetry session without having started it.",
                ),
              (this._sessionStartTime = 0),
              (this._userActivities = {});
          }
          sendEvent(e, t, n) {
            if (!o.TELEMETRY_EVENT_ID_SET.has(e))
              return (
                i.logger.warning(`Invalid telemetry event id ${e}`),
                Promise.reject(`Invalid telemetry event id ${e}`)
              );
            if (!o.TELEMETRY_EVENT_SOURCE_SET.has(t))
              return (
                i.logger.warning(`Invalid telemetry event source ${t}`),
          ...
          addUserBehaviorValue(e, t) {
            this._userActivities.hasOwnProperty(e) ||
              (this._userActivities[e] = []);
            const n = this._userActivities[e];
            n.push(t),
              n.length > o.MAX_VALUE_FOR_SAME_USER_BEHAVIOR &&
                n.splice(0, n.length - o.MAX_VALUE_FOR_SAME_USER_BEHAVIOR);
          }
      ...
      (e, t) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.USER_ACTIVITIES =
            ...
            t.MAX_VALUE_FOR_SAME_USER_BEHAVIOR =
              void 0),
          (t.getAllValues = n);
        ...
        const r = { SKINS_PICKER: "skins_picker" };
        ...
        var S = _.extend({
          ...
          availableGroups: l("groupingSortingState.grouping", function () {
            const e = u(this, "groupingSortingState.grouping"),
              t = u(this, "tra");
            return Object.entries(u(this, "availableGroupList")).map(
              function (n) {
                const i = n[1];
                return {
                  name: t.get(i.traKey),
          ...
          availableSorts: l(
            "groupingSortingState.grouping",
            "groupingSortingState.groupSortOrder",
            function () {
              const e = u(this, "groupingSortingState.grouping"),
          ...
          actions: {
            setSortOrder(e) {
              d(this, "sortOrder", e);
              const t = u(this, "groupingSortingState.grouping").sortOptions[
                e.name
              ];
              d(this, "groupingSortingState.groupSortOrder", t.name);
              u(this, "setGroupingAndSorting")(
                t.groupingConfig,
                t.sortingConfig,
              ),
                s.default.addUserBehaviorCount(
                  a.USER_ACTIVITIES.SWITCH_SORTING,
                  e.name,
                );
            },
            setGroupingKey(e) {
            ...
            setGrouping(e) {
              ...
              const t = e.sortOptions[e.defaultSortOptionName],
                ...
                i = t.sortingConfig;
              d(this, "groupingSortingState.groupSortOrder", t.name),
                p.scheduleOnce("afterRender", () =>
                  this._selectSortOption.bind(this)(i.name),
                );
              u(this, "setGroupingAndSorting")(n, i),
                s.default.addUserBehaviorCount(
                  a.USER_ACTIVITIES.SWITCH_GROUPING,
                  e.key,
                );
            },
          },
      ...
      (e, t, n) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.TIER_GROUPING_TYPE =
            t.DEFAULT_CONTROL_PANEL_SORTING =
            t.DEFAULT_CONTROL_PANEL_DROPDOWN_OPTION =
            t.CONTROL_PANEL_GROUP_DROPDOWN_OPTIONS =
            t.COLLECTION_GRID_NO_SKIN_SORTING_CONFIG =
            t.COLLECTION_GRID_NO_SKIN_DROPDOWN_OPTION =
              void 0);
        var i = n(12),
          o = n(14);
        const r = {
            groupingByMyCollectionPurchaseDateDescending: {
              ...
              groupingConfig:
                i.GROUPING_CONFIGS.BY_ACQUIRE_YEAR_AND_RECENT_DATE,
              sortingConfig:
                i.GROUPING_CONFIGS.BY_ACQUIRE_YEAR_AND_RECENT_DATE
                  .supportedSortingConfigs.recentAcquireFirst,
            },
            groupingByMyCollectionReleaseDateDescending: {
              ...
              sortingConfig:
                i.GROUPING_CONFIGS.BY_RELEASE_YEAR_OWNED_ONLY
                  .supportedSortingConfigs.releaseYearDescending,
            },
            groupingByMyCollectionAlphaAscending: {
              ...
              sortingConfig:
                i.GROUPING_CONFIGS.BY_SKIN_NAME_FIRST_LETTER
                  .supportedSortingConfigs.groupKeyAscending,
            },
            groupingByAllSkinsReleaseDateDescending: {
              ...
              sortingConfig:
                i.GROUPING_CONFIGS.BY_RELEASE_YEAR.supportedSortingConfigs
            ...
            groupingByAllSkinsAlphaAscending: {
              ...
              sortingConfig:
                i.GROUPING_CONFIGS.BY_CHAMPION_NAME_FIRST_LETTER
                  .supportedSortingConfigs.groupKeyAscending,
            },
            groupingByChampionMasteryDescending: {
              ...
              sortingConfig:
                i.GROUPING_CONFIGS.BY_CHAMPION_ID.supportedSortingConfigs
                  .championMasteryDescending,
            },
            ...
            groupingByChampionCompletionPercentageDescending: {
              ...
              sortingConfig:
                i.GROUPING_CONFIGS.BY_CHAMPION_ID.supportedSortingConfigs
                  .completionPercentageDescending,
            },
            ...
            groupingBySetOwnedSkinCountDescending: {
              ...
              sortingConfig:
                i.GROUPING_CONFIGS.BY_SKIN_LINE.supportedSortingConfigs
                  .ownedSkinCountDescending,
            },
            ...
            groupingByUniverseNameAscending: {
              ...
              sortingConfig:
                i.GROUPING_CONFIGS.BY_UNIVERSE.supportedSortingConfigs
                  .universeNameAscending,
            },
            groupingByTierGroupIdDescending: {
              ...
              sortingConfig:
                i.GROUPING_CONFIGS.BY_RARITY.supportedSortingConfigs
                  .rarityOrderDescending,
            },
          },
          s = {
            myCollection: {
              ...
              showUnownedFilter: !1,
              sortOptions: {
                purchaseDateDescending:
                  r.groupingByMyCollectionPurchaseDateDescending,
            ...
            groupByChampion: {
              ...
              sortOptions: {
                ...
                ownedSkinCountDescending:
                  r.groupingByChampionOwnedSkinCountDescending,
            ...
            groupBySet: {
              ...
              sortOptions: {
                ownedSkinCountDescending:
                  r.groupingBySetOwnedSkinCountDescending,
        ...
        const s = {
          BY_ACQUIRE_YEAR_AND_RECENT_DATE: {
            ...
            supportedSortingConfigs: {
              recentAcquireFirst:
                o.SORTING_CONFIGS.ACQUIRE_YEAR_AND_RECENT_DATE_SORTING,
            },
          },
          BY_SKIN_NAME_FIRST_LETTER: {
            ...
            supportedSortingConfigs: {
              groupKeyAscending:
                o.SORTING_CONFIGS.SKIN_NAME_FIRST_LETTER_ASCENDING,
            },
          },
          ...
          BY_CHAMPION_NAME_FIRST_LETTER: {
            ownershipFilter: r.COLLECTION_GRID_OWNERSHIP_FILTERS.OWNED,
            groupingStrategy:
              i.GROUPING_STRATEGIES.BY_CHAMPION_NAME_FIRST_LETTER,
            supportedSortingConfigs: {
              groupKeyAscending:
                o.SORTING_CONFIGS.CHAMPION_NAME_FIRST_LETTER_ASCENDING,
            },
          },
          BY_CHAMPION_ID: {
            ownershipFilter: r.COLLECTION_GRID_OWNERSHIP_FILTERS.OWNED,
            ...
            supportedSortingConfigs: {
              ...
              championMasteryDescending:
                o.SORTING_CONFIGS.CHAMPION_MASTERY_DESCENDING,
              ownedSkinCountDescending:
                o.SORTING_CONFIGS.CHAMPION_GROUP_OWNED_SKIN_COUNT_DESCENDING,
              completionPercentageDescending:
                o.SORTING_CONFIGS
          ...
          BY_SKIN_LINE: {
            ...
            supportedSortingConfigs: {
              ownedSkinCountDescending:
                o.SORTING_CONFIGS.SKIN_LINE_GROUP_OWNED_SKIN_COUNT_DESCENDING,
              completionPercentageDescending:
                o.SORTING_CONFIGS
      ...
      (e, t, n) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.GROUPING_STRATEGIES = void 0),
          (t.getFirstLetter = s),
          (t.getOwnedSkinCount = r);
        var i = n(1),
          o = n(14);
        function r(e) {
        ...
        const a = {
          ...
          BY_SKIN_LINE: {
            ...
            getGroupKeys: (e, t) =>
              e.ownership.owned && e.skinLines
                ? e.skinLines.reduce(
                    (e, n) => (
                      n &&
                        t.skinLinesById[n.id] &&
                        e.push(t.skinLinesById[n.id]),
                      e
                    ),
                    [],
                  )
          ...
          BY_RELEASE_YEAR: {
            ...
            getGroupKeys: (e) => [
              e.releaseDate ? new Date(e.releaseDate).getFullYear() : null,
            ],
            getGroupMetaData: (e) => ({ groupId: e, releaseYear: e }),
          },
          BY_CHAMPION_NAME_FIRST_LETTER: {
          ...
          BY_ACQUIRE_YEAR: {
            ...
            getGroupMetaData: (e) => ({ groupId: e, acquireYear: e }),
          },
          BY_SKIN_NAME_FIRST_LETTER: {
            groupingType: o.GROUPING_TYPES.GROUP_BY_SKIN_NAME_FIST_LETTER,
            getGroupKeys: (e) =>
              e.ownership.owned ? [s(e.name.toLocaleLowerCase())] : [],
            getGroupMetaData: (e) => ({ groupId: e, skinNameFirstLetter: e }),
          },
          ...
          BY_UNIVERSE: {
            ...
            getGroupKeys(e, t) {
              const { universeBySkinlineId: n } = t,
                i = e.skinLines ? e.skinLines[0].id : null;
              return n && i ? [n.get(i)] : [];
            },
            getGroupMetaData(e) {
              const t = e;
      ...
      (e, t, n) => {
        ...
        const o = {
          CHAMPION_NAME_ASCENDING: {
            groupSortingStrategy:
              i.GROUP_SORTING_STRATEGIES.CHAMPION_NAME_ASCENDING,
            contentSortingStrategy:
              i.CONTENT_SORTING_STRATEGIES
                .OWNED_BASE_RARITY_RELEASE_DATE_NAME_DESCENDING,
          },
          CHAMPION_MASTERY_DESCENDING: {
            groupSortingStrategy:
              i.GROUP_SORTING_STRATEGIES
                .CHAMPION_MASTERY_DESCENDING_AND_CHAMPION_NAME_ASCENDING,
            contentSortingStrategy:
              i.CONTENT_SORTING_STRATEGIES
                .OWNED_BASE_RARITY_RELEASE_DATE_NAME_DESCENDING,
          },
          CHAMPION_GROUP_OWNED_SKIN_COUNT_DESCENDING: {
            groupSortingStrategy:
              i.GROUP_SORTING_STRATEGIES
                .OWNED_SKIN_COUNT_DESCENDING_AND_CHAMPION_NAME_ASCENDING,
            contentSortingStrategy:
              i.CONTENT_SORTING_STRATEGIES
                .OWNED_BASE_RARITY_RELEASE_DATE_NAME_DESCENDING,
          },
          CHAMPION_GROUP_COMPLETION_PERCENTAGE_DESCENDING: {
            groupSortingStrategy:
              i.GROUP_SORTING_STRATEGIES
                .COMPLETION_PERCENTAGE_DESCENDING_AND_CHAMPION_NAME_ASCENDING,
            contentSortingStrategy:
              i.CONTENT_SORTING_STRATEGIES
                .OWNED_BASE_RARITY_RELEASE_DATE_NAME_DESCENDING,
          },
          RARITY_ORDER_DESCENDING: {
            groupSortingStrategy:
              i.GROUP_SORTING_STRATEGIES.RARITY_ORDER_DESCENDING,
            contentSortingStrategy:
              i.CONTENT_SORTING_STRATEGIES
                .OWNED_MASTERY_RELEASE_DATE_NAME_DESCENDING,
          },
          SKIN_LINE_NAME_ASCENDING: {
            groupSortingStrategy:
              i.GROUP_SORTING_STRATEGIES.SKIN_LINE_NAME_ASCENDING,
            contentSortingStrategy:
              i.CONTENT_SORTING_STRATEGIES
                .OWNED_RARITY_RELEASE_DATE_NAME_DESCENDING,
          },
          SKIN_LINE_GROUP_OWNED_SKIN_COUNT_DESCENDING: {
            groupSortingStrategy:
              i.GROUP_SORTING_STRATEGIES
                .OWNED_SKIN_COUNT_DESCENDING_AND_SKIN_LINE_NAME_ASCENDING,
            contentSortingStrategy:
              i.CONTENT_SORTING_STRATEGIES
                .OWNED_RARITY_RELEASE_DATE_NAME_DESCENDING,
          },
          SKIN_LINE_GROUP_COMPLETION_PERCENTAGE_DESCENDING: {
            groupSortingStrategy:
              i.GROUP_SORTING_STRATEGIES
                .COMPLETION_PERCENTAGE_DESCENDING_AND_SKIN_LINE_NAME_ASCENDING,
            contentSortingStrategy:
              i.CONTENT_SORTING_STRATEGIES
                .OWNED_RARITY_RELEASE_DATE_NAME_DESCENDING,
          },
          RELEASE_YEAR_DESCENDING: {
            groupSortingStrategy:
              i.GROUP_SORTING_STRATEGIES.RELEASE_YEAR_DESCENDING,
            contentSortingStrategy:
              i.CONTENT_SORTING_STRATEGIES.ALL_RELEASE_DATE_DESCENDING,
          },
          CHAMPION_NAME_FIRST_LETTER_ASCENDING: {
            groupSortingStrategy:
              i.GROUP_SORTING_STRATEGIES.GROUP_KEY_ASCENDING,
            contentSortingStrategy:
              i.CONTENT_SORTING_STRATEGIES.OWNED_CHAMPION_NAME_ASCENDING,
          },
          ACQUIRE_YEAR_AND_RECENT_DATE_SORTING: {
            ...
            subGroupSortingConfigs: [
              {
                groupSortingStrategy:
                  i.GROUP_SORTING_STRATEGIES.GROUP_KEY_DESCENDING,
                contentSortingStrategy:
                  i.CONTENT_SORTING_STRATEGIES.OWNED_PURCHASE_DATE_DESCENDING,
              },
            ],
          },
          SKIN_NAME_FIRST_LETTER_ASCENDING: {
            groupSortingStrategy:
              i.GROUP_SORTING_STRATEGIES.GROUP_KEY_ASCENDING,
            contentSortingStrategy:
              i.CONTENT_SORTING_STRATEGIES.OWNED_ALPHABETICAL_ASCENDING,
          },
          UNIVERSE_NAME_ASCENDING: {
            groupSortingStrategy:
              i.GROUP_SORTING_STRATEGIES.UNIVERSE_NAME_ASCENDING,
            subGroupSortingConfigs: [
              {
                groupSortingStrategy:
                  i.GROUP_SORTING_STRATEGIES.SKIN_LINE_NAME_ASCENDING,
      ...
      (e, t, n) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.NULL_VALUE_TRAILING =
            t.NULL_VALUE_LEADING =
            t.NON_SORTING_STRATEGY =
            t.GROUP_SORTING_STRATEGIES =
            t.DEFAULT_NULL_SORT_VALUE =
            t.CONTENT_SORTING_STRATEGIES =
              void 0),
          (t.compareBool = r),
          (t.compareData = s),
          (t.compareValue = a),
          (t.getCurrentLocale = _),
          (t.getPropertiesSortingStrategy = c),
          (t.smartSort = l);
        var i = n(1);
        ...
        function s(e, t, n) {
          return i.lodash.isNumber(e)
            ? e - t
            : i.lodash.isBoolean(e)
              ? r(e, t)
              : i.lodash.isString(e)
                ? n.compare(e, t)
                : 0;
        ...
        function l(e, t, n) {
          ...
          return e.sort((e, r) => {
            ...
            for (let l = 0; l < t.length; l++) {
              ...
              if (
                ((s = a(
                  i.lodash.get(e, _.property),
                  i.lodash.get(r, _.property),
                  _.ascending,
                  _.nullValue ? _.nullValue : o,
                  n,
                )),
                0 !== s)
              )
        ...
        const p = {
          CHAMPION_NAME_ASCENDING: c([
            { property: "groupMetaData.championName", ascending: !0 },
          ]),
          CHAMPION_MASTERY_DESCENDING_AND_CHAMPION_NAME_ASCENDING: c([
            { property: "groupMetaData.masteryPoint", ascending: !1 },
            { property: "groupMetaData.championName", ascending: !0 },
          ]),
          OWNED_SKIN_COUNT_DESCENDING_AND_CHAMPION_NAME_ASCENDING: c([
            { property: "groupMetaData.ownedSkinCount", ascending: !1 },
            { property: "groupMetaData.championName", ascending: !0 },
          ]),
          COMPLETION_PERCENTAGE_DESCENDING_AND_CHAMPION_NAME_ASCENDING: c([
            { property: "groupMetaData.ownedSkinPercentage", ascending: !1 },
            { property: "groupMetaData.championName", ascending: !0 },
          ]),
          RARITY_ORDER_DESCENDING: c([
            { property: "groupMetaData.rarity.order", ascending: !1 },
          ]),
          SKIN_LINE_NAME_ASCENDING: c([
            { property: "groupMetaData.skinLine.name", ascending: !0 },
          ]),
          ...
          UNIVERSE_NAME_ASCENDING: c([
            { property: "groupMetaData.universeName", ascending: !0 },
          ]),
          ...
          GROUP_KEY_ASCENDING: c([
            { property: "groupKey", ascending: !0, nullValue: 1 },
          ]),
          GROUP_KEY_DESCENDING: c([
            { property: "groupKey", ascending: !1, nullValue: 1 },
          ]),
        };
        t.GROUP_SORTING_STRATEGIES = p;
        const d = {
          OWNED_RARITY_RELEASE_DATE_NAME_DESCENDING: c([
            { property: "ownership.owned", ascending: !0 },
            { property: "rarity.order", ascending: !1 },
            { property: "releaseDate", ascending: !1 },
            { property: "name", ascending: !0 },
          ]),
          OWNED_BASE_RARITY_RELEASE_DATE_NAME_DESCENDING: c([
            { property: "ownership.owned", ascending: !0 },
            { property: "isBase", ascending: !0 },
            { property: "rarity.order", ascending: !1 },
            { property: "releaseDate", ascending: !1 },
            { property: "name", ascending: !0 },
          ]),
          OWNED_MASTERY_RELEASE_DATE_NAME_DESCENDING: c([
            { property: "ownership.owned", ascending: !0 },
            { property: "championPoints", ascending: !1 },
            { property: "releaseDate", ascending: !1 },
            { property: "name", ascending: !0 },
          ]),
          ALL_RELEASE_DATE_DESCENDING: c([
            { property: "ownership.owned", ascending: !0 },
            { property: "releaseDate", ascending: !1 },
            { property: "skinLines[0].id", ascending: !0 },
            { property: "name", ascending: !0 },
          ]),
          OWNED_CHAMPION_NAME_ASCENDING: c([
            { property: "ownership.owned", ascending: !0 },
            { property: "championName", ascending: !0 },
            { property: "name", ascending: !0 },
          ]),
          OWNED_PURCHASE_DATE_DESCENDING: c([
            { property: "ownership.owned", ascending: !0 },
            { property: "ownership.rental.purchaseDate", ascending: !1 },
            { property: "name", ascending: !0 },
          ]),
      ...
      (e, t) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.UNOWNED_SKIN_FILTER =
            ...
            t.SORT_ORDER =
            t.SKIN_WITH_SKINLINE_FILTER =
            t.SKIN_UNLOCK_TRANSACTION_TYPE =
            t.SKINS_VIEWER_PAW_SOURCE =
            ...
            t.COUNTING_STEPS =
            t.COUNTING_INTERVAL =
            t.COLLECTION_VIEW_VIDEO_BASE_PATH =
            ...
            t.COLLECTION_GRID_LAST_PURCHASES_GROUP_ID =
            t.COLLECTION_GRID_HEIGHT =
            t.COLLECTION_GRID =
        ...
        t.NO_SKINLINE_ID = 0;
        t.ALL_SKINLINE_ID = -1;
        t.SORT_ORDER = { ASCENDING: "asc", DESCENDING: "desc" };
        t.COLLECTION_GRID = {};
        t.COLLECTION_GRID_OWNERSHIP_FILTERS = {
          ALL: "none",
          OWNED: "owned",
        ...
        t.SKIN_UNLOCK_TRANSACTION_TYPE = {
          PURCHASE: { key: "PURCHASE", traKey: "purchase" },
          LOOT: { key: "LOOT", traKey: "loot" },
          GIFT: { key: "GIFT", traKey: "gift" },
          REWARD: { key: "REWARD", traKey: "reward" },
        };
        t.COLLECTION_GRID_WIDTH = 760;
        t.COLLECTION_GRID_HEIGHT = 478;
        t.COLLECTION_GRID_ROW_TYPES = {
          GROUP: { id: "GROUP", height: 38 },
          SKINS: { id: "SKINS", height: 216 },
          UNIVERSE_TITLE_ROW: { id: "universeTitleRow", height: 127 },
        ...
        const r = {
          37006: {
            ...
            showcaseView: { loopVideoPath: `${o}/37006.webm` },
          },
          99007: {
            collectionView: {
            ...
            showcaseView: { loopVideoPath: `${o}/99007.webm` },
          },
          81005: {
            collectionView: {
            ...
            showcaseView: { loopVideoPath: `${o}/81005.webm` },
          },
          77003: {
            collectionView: {
            ...
            showcaseView: { loopVideoPath: `${o}/77003.webm` },
          },
          21016: {
            collectionView: {
            ...
            showcaseView: { loopVideoPath: `${o}/21016.webm` },
          },
        };
      ...
      (e, t, n) => {
        ...
        var T = d.extend({
          ...
          style: n(31),
          skinsStore: I(),
          skinAugments: N("skinsStore.skinAugmentInventory.[]", function () {
            return (this.get("skinsStore.skinAugmentInventory") ?? []).reduce(
          ...
          init() {
            this._super(...arguments),
              S(this, "rowRendererMap", new Map()),
              S(
                this,
                "skinTileClickCallback",
                this._skinTileClickCallback.bind(this),
              );
          },
          didInsertElement() {
          ...
          _skinTileClickCallback(e, t) {
            const n = g(this, "selectedSkinId"),
              i = g(this, "virtualList");
            if (e && e !== n) {
              const n = g(this, "onSkinSelected");
              n &&
                (n(e),
                S(this, "selectedSkinId", e),
                S(this, "selectedAugments", t),
                i.refresh()),
                c.default.addUserBehaviorValue(
                  u.USER_ACTIVITIES.PREVIEW_SKIN,
                  e,
                ),
                c.default.setUserBehaviorValue(
                  u.USER_ACTIVITIES.SET_BACKGROUND_SKIN_ID,
                  e,
                );
            }
          },
          _refreshSkinsGroupingResult(e) {
            const t = (0, o.generateRowDataFromGroupingResult)(
              e,
              g(this, "tra"),
            );
          ...
          _initialiseVirtualList(e) {
            ...
            return (
              t ||
                ...
                (t.container = e),
                (t.containerHeightPx = r.COLLECTION_GRID_HEIGHT),
                (t.createElement = this._createRow.bind(this)),
                (t.updateElement = this._updateRow.bind(this)),
                (t.resetElement = this._resetRow.bind(this)),
                (t.deleteElement = this._deleteRow.bind(this)),
                e.appendChild(t)),
              t
            );
          },
      ...
      (e, t, n) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t._generateGroupTitleObject = p),
          (t._generateGroupTitleRowData = d),
          (t._generateSkinThumbnailRows = g),
          (t.generateRowDataFromGroupingResult = I);
        var i,
          o = n(14),
          r = n(17),
          s = n(22),
          a = (i = n(23)) && i.__esModule ? i : { default: i };
        const l = {
          groupTitle: "",
          groupSubtitle: "",
          ownedSkinCount: 0,
        ...
        const c = new a.default({
            ...
            height:
              r.COLLECTION_GRID_SEPARATOR_ROW_HEIGHTS.GROUP_SEPARATOR_HEIGHT,
            data: { separatorClass: "group-separator" },
          }),
          u = new a.default({
            type: r.COLLECTION_GRID_ROW_TYPES.SEPARATOR.id,
            height:
              r.COLLECTION_GRID_SEPARATOR_ROW_HEIGHTS.UNIVERSE_SEPARATOR_HEIGHT,
            data: { separatorClass: "universe-separator" },
          });
        function p(e) {
        ...
        function d(e, t, n) {
          if (!e)
            throw new Error(`groupTitleObject is null for group node ${t}`);
          let i = [];
          if (
            (t.subGroups.length > 0
              ? t.subGroups.forEach((e) => (i = i.concat(I(e, n))))
              : (i = i.concat(g(t.filteredGroupMembers))),
            i.length > 0)
          ) {
            ...
            e.groupNodes.forEach((e) => {
              if (e.filteredGroupMembers && e.filteredGroupMembers.length > 0) {
                const i = (function (e, t) {
                  ...
                  if (!n)
                    throw new Error(
                      `No row generator registered for grouping type ${e.groupingType}`,
                    );
                  return n(e, t);
                })(e, t);
                i && (n = n.concat(i));
        ...
        S.set(s.EMPTY_GROUPING_TYPE, E),
          S.set(o.GROUPING_TYPES.GROUP_BY_OWNERSHIP_OWNED_ONLY, E),
          S.set(o.GROUPING_TYPES.GROUP_BY_RECENT_ACQUIRE, function (e, t) {
            const n = p({
              groupTitle: t.get("skin_grid_purchase_year_most_recent"),
            });
            return (
              (e.filteredGroupMembers = e.filteredGroupMembers.slice(0, 10)),
              d(n, e, t)
            );
          }),
          S.set(o.GROUPING_TYPES.GROUP_BY_ACQUIRE_YEAR, function (e, t) {
            const { acquireYear: n } = e.groupMetaData;
            return d(
              p({
                groupTitle: _(n)
                  ? t.get("skin_grid_acquire_year_none")
                  : `${t.get("skin_grid_acquire_year_header")} ${n}`,
              }),
              e,
              t,
            );
          ...
          S.set(o.GROUPING_TYPES.GROUP_BY_RELEASE_YEAR, function (e, t) {
            const { releaseYear: n } = e.groupMetaData;
            return d(
              p({
                groupTitle: _(n)
                  ? t.get("skin_grid_acquire_year_none")
          ...
          S.set(
            o.GROUPING_TYPES.GROUP_BY_SKIN_NAME_FIST_LETTER,
            function (e, t) {
              const { skinNameFirstLetter: n } = e.groupMetaData;
              return d(p({ groupTitle: n }), e, t);
            },
          ),
          S.set(o.GROUPING_TYPES.GROUP_BY_CHAMPION_ID, function (e, t) {
            ...
            return d(
              p({
                ...
                showCompleteSet: !0,
                completeSetIcon:
                  "/fe/lol-skins-viewer/images/control-pane/icon-champion.png",
          ...
          S.set(
            o.GROUPING_TYPES.GROUP_BY_CHAMPION_NAME_FIRST_LETTER,
            function (e, t) {
              return d(
                p({ groupTitle: e.groupMetaData.championNameFirstLetter }),
                e,
                t,
              );
            },
          ...
          S.set(o.GROUPING_TYPES.GROUP_BY_RARITY, function (e, t) {
            ...
            return d(
              p({
                groupTitle: _(n.rarity)
                  ? t.get("skin_grid_rarity_none")
                  : t.get(n.rarity.traKey),
                groupSubtitle: `${n.ownedSkinCount} / ${n.totalSkinCount}`,
                ownedSkinCount: n.ownedSkinCount,
                totalSkinCount: n.totalSkinCount,
              }),
          ...
          S.set(o.GROUPING_TYPES.GROUP_BY_SKIN_LINE, function (e, t) {
            ...
            return d(
              p({
                ...
                showCompleteSet: !0,
                completeSetIcon:
                  "/fe/lol-skins-viewer/images/control-pane/icon-skin.png",
                groupingType: e.groupingType,
            ...
            if (
              ...
              if (n) {
                ...
                const e = new a.default({
                  type: r.COLLECTION_GRID_ROW_TYPES.SEPARATOR.id,
                  height:
                    r.COLLECTION_GRID_SEPARATOR_ROW_HEIGHTS
                      .UNKNOWN_UNIVERSE_SEPARATOR_HEIGHT,
                  data: { separatorClass: "non-universe-separator" },
                });
                i.unshift(e);
              }
              i.push(u);
      ...
      (e, t) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.GroupingResult =
            t.GroupNode =
            t.EMPTY_GROUPING_TYPE =
            t.EMPTY_GROUPING_STRATEGY =
              void 0),
          (t.group = function e(t, n, s) {
            if (!t)
              throw new Error("Grouping configuration should not be null");
            if (!n || !Array.isArray(n))
              throw new Error("Data for grouping must be an array.");
            const a = (function (e, t, n) {
              if (!e) throw new Error("Grouping strategy is null.");
              if (!e.groupingType || !e.getGroupKeys || !e.getGroupMetaData)
                throw new Error(
                  `Invalid grouping strategy. Grouping strategy needs to have valid groupType, getGroupKeys method and getGroupMetaData method. Group type: ${e.groupingType}, getGroupKeys: ${e.getGroupKeys} and getGroupMetaData: ${e.getGroupMetaData}`,
                );
              const { groupingType: s } = e,
                a = new r(s);
            ...
            t.subGroupingConfigs &&
              Array.isArray(t.subGroupingConfigs) &&
              a.groupNodes.forEach((n) => {
          ...
          (t.sortGroupResult = function e(t, n, i) {
            ...
            t.groupSortingStrategy.sort(n.groupNodes, i),
              n.groupNodes.forEach((n) => {
                if (n.subGroups && n.subGroups.length > 0)
                  n.subGroups.forEach((o, r) => {
                    if (r >= t.subGroupSortingConfigs.length)
                      throw new Error(
                        `No sub group sorting strategy for group with type ${n.groupingType}. Sub group index ${r}`,
                      );
                    e(t.subGroupSortingConfigs[r], o, i);
                  });
                else {
                  if (!t.contentSortingStrategy)
                    throw new Error(
                      `No content sorting strategy for group with type ${n.groupingType} and key ${n.groupKey}`,
                    );
        ...
        class o {
          constructor(e, t, n, i) {
            (this.groupingType = e),
              (this.groupKey = t),
              (this.groupMetaData = n),
              (this.groupMembers = i),
              (this.subGroups = []);
          }
          get filteredGroupMembers() {
            return this._filteredGroupMembers
              ? this._filteredGroupMembers
              : this.groupMembers;
          }
          set filteredGroupMembers(e) {
            if (!e || !Array.isArray(e))
              throw new Error(
                `FilteredGroupMembers must be an array. Get ${e}`,
              );
      ...
      (e, t) => {
        ...
        var n = class {
          constructor(e) {
            ...
            if (!t || !Number.isFinite(n) || !i)
              throw new Error(
                `Grid row data must contains valid type, valid float height and no null data. Get type: ${t}, height ${n} and data ${i}`,
              );
            (this.type = t),
              (this.height = n),
              (this.data = i),
      ...
      (e, t, n) => {
        ...
        var i,
          o = n(1),
          r = (i = n(25)) && i.__esModule ? i : { default: i };
        const { getWithDefault: s } = o.Ember;
        class a extends r.default {
          ...
          updateRow(e, t) {
            ...
            i.isSubGroup
              ? o.classList.add("subtitle")
              : o.classList.remove("subtitle");
          ...
          _createGroupTitleElement(e) {
            ...
            return (
              t.classList.add("group-title"), (t.textContent = e.groupTitle), t
            );
          }
        }
        var l = a;
      ...
      (e, t, n) => {
        ...
        var i = n(1),
          o = n(17),
          r = n(27);
        const { get: s, getWithDefault: a } = i.Ember;
        var l = class {
          constructor(e) {
            (this._renderContext = e),
              (this._skinTileClickHandler = this._onSkinTileClick.bind(this)),
              (this._skinTileHoverHandler = this._onMouseEnter.bind(this));
          }
          setRenderContext(e) {
            this._renderContext = e;
          }
          ...
          _balancingTileCount(e, t) {
            ...
            if (n.length < t.children.length)
              for (; n.length < t.children.length; )
                this._removeSkinTileListener(t.children[n.length]),
                  t.removeChild(t.children[n.length]);
            else if (n.length > t.children.length)
              for (let e = t.children.length; n.length > e; e++)
                t.appendChild(this._createSkinTile(n[e]));
          }
          _createSkinTile(e) {
            const t = document.createElement("div");
            ...
            n
              ...
              .classList.add("tile-image"),
              (n.dataset.skinId = e.id),
              n.addEventListener("click", this._skinTileClickHandler),
              n.addEventListener("mouseenter", this._skinTileHoverHandler),
              t.appendChild(n);
            const i = document.createElement("div");
            i.classList.add("tile-name");
            const o = document.createElement("div");
            o.classList.add("tile-label"),
              (o.textContent = e.name),
              i.appendChild(o),
              n.appendChild(i);
            const r = document.createElement("div");
            return r.classList.add("overlay-tile"), n.appendChild(r), t;
          }
          _updateSkinTile(e, t) {
            const n = e.querySelector(".skin-tile");
            (n.dataset.skinId = t.id),
              t.id === this._renderContext.get("selectedSkinId")
                ? n.classList.add("selected")
                : n.classList.remove("selected");
            n.querySelector("img").setAttribute("src", t.tilePath);
            const i = n.querySelector(".overlay-tile");
            if (i) {
              n.dataset.skinAugments = "";
              const e = [],
                o = [];
              t?.skinAugments?.augments?.forEach((t) => {
                this._renderContext.get("skinAugments")?.[t.contentId] &&
                  (o.push(`url(${t?.overlays?.[0].tileLCOverlayPath})`),
                  e.push(t.contentId));
              }),
                (i.style.backgroundImage = o.join(",")),
                (n.dataset.skinAugments = e.join(","));
            }
          ...
          _resetSkinTile(e) {
            ...
            const n = t.querySelector(".overlay-tile");
            n && (n.style.backgroundImage = "");
            t.querySelector(".tile-label").textContent = "";
          }
          _onSkinTileClick(e) {
            const t = e.currentTarget;
            this._getThumbnailClickCallback() &&
              this._getThumbnailClickCallback()(
                parseInt(t.dataset.skinId, o.PARSEINT_DEFAULT_RADIX),
                t.dataset.skinAugments,
              ),
              r.SFX.skinTileSelectSound.play();
          }
          _onMouseEnter() {
          ...
          _removeSkinTileListener(e) {
            const t = e.querySelector(".skin-tile");
            t &&
              (t.removeEventListener("click", this._skinTileClickHandler),
              t.removeEventListener("mouseenter", this._skinTileHoverHandler));
          }
        };
        t.default = l;
      },
      (e, t, n) => {
        ...
        const r = {
          ...
          skinTileSelectSound: o(
            "/fe/lol-skins-picker/audio/sfx-skin-tile-select.ogg",
          ),
        };
        t.SFX = r;
      },
      (e, t, n) => {
        ...
        n(1);
        var i,
          o = (i = n(25)) && i.__esModule ? i : { default: i };
        class r extends o.default {
          createRow() {
            ...
            const i = document.createElement("div");
            i.classList.add("universe-title"),
              i.appendChild(this._createArrowIcon()),
          ...
          updateRow(e, t) {
            const n = e.data;
            t.querySelector(".universe-title span").textContent = n
              ? n.name
              : "";
            t.querySelector(".universe-subtitle").textContent = n
              ? n.description
              : "";
            t.querySelector(".universe-background").style.backgroundImage =
              n && n.imagePath ? `url(${n.imagePath})` : "none";
          }
          _createArrowIcon() {
            const e = document.createElement("img");
            return (
              e.classList.add("icon"),
              (e.src = "/fe/lol-skins-viewer/images/universe/arrow-slider.png"),
              e
            );
          }
        ...
        class r extends o.default {
          ...
          updateRow(e, t) {
            ...
            i &&
              ...
              ((i.className = ""), i.classList.add("separator-div", n));
          }
        }
        var s = r;
        t.default = s;
      ...
      (e, t, n) => {
        ...
        e.exports = i.HTMLBars.template({
          id: "TuYObYa9",
          block:
            '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_14_10\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-skins-picker\\\\src\\\\components\\\\skins-grid-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\Releases_14_10\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-skins-picker\\\\src\\\\components\\\\skins-grid-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\Releases_14_10\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-skins-picker\\\\src\\\\components\\\\skins-grid-component\\\\index.js\\" "],["text","\\n"],["open-element","lol-uikit-scrollable",[]],["static-attr","class","skins-grid-content"],["static-attr","overflow-masks","enabled"],["flush-element"],["text","\\n"],["close-element"],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
          meta: {},
        });
      },
      (e, t, n) => {
      ...
      (e, t, n) => {
        ...
        var R = S.extend(s.default, {
          ...
          disableAllTelemetry: E.bool(
            "jmxSettings.SkinsViewer.DisableAllTelemetry",
          ),
          ...
          skinRarities: E("isTencentRegion", function () {
            return N(this, "isTencentRegion")
              ? i.RarityManager.tencentSkinRarityInformationByTier
              : i.RarityManager.skinRarityInformationByTier;
          }),
          platformSettings: E("disableAllTelemetry", function () {
            return { disableAllTelemetry: N(this, "disableAllTelemetry") };
          }),
          init() {
            this._super(...arguments),
              this._initFilters(),
              this._setDefaultGrouping(),
              h(this, "purchasedSkins", g()),
              h(this, "champions", g()),
              this._initSkinSearch(),
              d.addObserver(
                "/lol-game-data/assets/v1/champion-summary.json",
                this,
                this._updateChampionsData,
              );
          },
          skinFilter: E(
            "nameFilter",
            ...
            function () {
              ...
              if (t && t.length > 0) {
                ...
                e.push(
                  (0, a.getSkinNameFilter)(t, n, N(this, "currentLocale")),
                );
              }
              const n = N(this, "groupingConfig"),
                i = N(this, "unownedFilter");
              return (
                i === o.COLLECTION_GRID_OWNERSHIP_FILTERS.OWNED
                  ? e.push(o.OWNED_SKIN_FILTER)
                  : i === o.COLLECTION_GRID_OWNERSHIP_FILTERS.UNOWNED &&
                    e.push(o.UNOWNED_SKIN_FILTER),
                n.filters && e.push(...n.filters),
                new a.SkinFilter(e)
              );
            },
          ),
          ...
          championsById: E("champions", "playerChampionMastery", function () {
            ...
            if (I(e) && I(t)) {
              ...
              return e.reduce((e, t) => {
                ...
                return (
                  o.championPoints || (o.championPoints = 0),
                  delete o.championId,
                  (e[o.id] = o),
                  e
                );
          ...
          universeBySkinlineId: E("skinUniverseInfo", function () {
            ...
            return (
              e &&
                e.forEach((e) => {
                  e.skinSets &&
                    e.skinSets.forEach((n) => {
                      t.has(n)
                        ? i.logger.error(
                            `Ignoring linking skinline ${n} to universe ${t.get(n)}.It's been already linked to universe (${e.id}).`,
                          )
                        : t.set(n, e);
                    });
                }),
          ...
          sortedSkins: E("sortingConfig", "groupedSkins", function () {
            ...
            return (0, _.sortGroupResult)(e, t, { locale: n }), t;
          }),
          ...
          willDestroy() {
            d.unobserve("/lol-game-data/assets/v1/champion-summary.json", this),
              this._super(...arguments);
          },
          setNameFilter(e) {
          ...
          _initFilters() {
            h(this, "nameFilter", ""),
              h(this, "skinLineId", void 0),
              h(this, "chromaFilter", !1),
              h(this, "legacyFilter", !1),
              h(this, "showBaseSkin", !1),
              h(
                this,
                "unownedFilter",
                o.COLLECTION_GRID_OWNERSHIP_FILTERS.OWNED,
              );
          },
          ...
          _getAllSkinsInGroupNode(e, t, n) {
            e.subGroups.length > 0
              ? e.subGroups.forEach((e) =>
                  this._getAllSkinsInGroupResult(e, t, n),
                )
              : e.filteredGroupMembers.forEach((e) => {
                  n.has(e.id) || (n.add(e.id), t.push(e));
                });
          },
          _updateControlPanelGroupingAndSortingOption(e, t, n = !0) {
            h(this, "groupingSortingState.grouping", e),
              h(this, "groupingSortingState.groupSortOrder", t.name),
              this._updateGroupingAndSortingConfig(
                t.groupingConfig,
                t.sortingConfig,
                n,
              );
          ...
          _updateGroupingAndSortingConfig(e, t, n = !0) {
            N(this, "groupingConfig") !== e &&
              this._setUnownedFilter(e.ownershipFilter, n),
              h(this, "groupingConfig", e),
              h(this, "sortingConfig", t);
          },
          ...
          _filterGroupNode(e, t) {
            (e.filteredGroupMembers = t.filterSkins(e.groupMembers)),
              e.subGroups.forEach((e) => {
                this._filterGroupingResult(e, t);
              });
          },
          _setDefaultGrouping() {
            this._updateControlPanelGroupingAndSortingOption(
              c.DEFAULT_CONTROL_PANEL_DROPDOWN_OPTION,
              c.DEFAULT_CONTROL_PANEL_SORTING,
              !1,
            );
          },
          _initSkinSearch() {
          ...
          _assignSkinsToSkinLine(e, t) {
            ...
            for (const t in e)
              if (e.hasOwnProperty(t)) {
                const i = e[t];
                i.skinLines &&
                  i.skinLines.forEach((e) => {
                    const t = n[e.id];
                    let o = t.skins;
                    void 0 === o && ((o = []), (t.skins = o)),
                      o.find((e) => e.id === i.id) || o.push(i);
                  });
              }
          },
          _dataInitReady(e) {
            ...
            return (
              t.every((e) => Array.isArray(e) && e.length > 0) &&
              n.every((e) => e)
            );
          },
      ...
      (e, t, n) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.addUsageData =
            ...
            t.addPurchaseData =
            t.addProvenanceData =
            t.addOwnershipForBaseSkin =
            t.addMasteryData =
            t.addLootableProperty =
              void 0),
          (t.getSkinRarity = c);
        var i = n(1),
          o = n(17);
        const { set: r, get: s } = i.Ember,
          a = function (e) {
            (e.skinLineId = o.NO_SKINLINE_ID),
              e.skinLines && (e.skinLineId = e.skinLines[0].id);
          };
        t.addSkinlineData = a;
        ...
        t.addPurchaseData = function (e, t) {
          if (
            (i.lodash.keyBy(t, "id")[e.id] &&
              s(e, "ownership") &&
              !s(e, "ownership.owned") &&
              (r(e, "ownership.owned", !0),
              r(e, "ownership.rental.purchaseDate", Date.now())),
            s(e, "ownership.rental"))
          )
        ...
        t.addProvenanceData = function (e) {
          e.ownership &&
            e.ownership.owned &&
            (e.id === parseInt(`${e.championId}002`)
              ? (e.transactionType = o.SKIN_UNLOCK_TRANSACTION_TYPE.GIFT)
              : e.id === parseInt(`${e.championId}003`)
                ? (e.transactionType = o.SKIN_UNLOCK_TRANSACTION_TYPE.LOOT)
                : (e.transactionType =
                    o.SKIN_UNLOCK_TRANSACTION_TYPE.PURCHASE));
        };
        t.addReleaseData = function (e, t) {
          ...
          if (t.has(n)) {
            const i = t.get(n),
              ...
              r = o.getTime();
            (e.releaseYear = isNaN(r) || 0 === r ? 0 : o.getFullYear()),
              (e.releaseDate = isNaN(r) ? 0 : r);
          } else (e.releaseDate = 0), (e.releaseYear = 0);
        };
        const l = function (e, t) {
          const n = t[e.championId];
          (e.championPoints = n ? n.championPoints : 0),
            (e.championName = n ? n.name : void 0);
        };
        t.addMasteryData = l;
        const _ = function (e, t) {
          if (t) {
            ...
            n &&
              n.ownership &&
              ((e.champOwnership = n.ownership),
              e.isBase &&
                ((e.ownership.owned = n.ownership.owned),
                (e.ownership.rental.purchaseDate =
                  n.ownership.rental.purchaseDate)));
          }
        };
        ...
        function c(e, t) {
          ...
          return (
            (n = t
              ? i.RarityManager.agregatedSkinRarityInformationByTier[
                  e.regionRarityId
                ]
              : i.RarityManager.agregatedSkinRarityInformationByTier[e.rarity]),
            n || i.RarityManager.agregatedSkinRarityInformationByTier.kNoRarity
          );
        }
        t.addSkinStaticData = function ({
          ...
          return t && n
            ? (o) => {
                const r = t[o.id];
                return r
                  ? ((o.skinLines = r.skinLines),
                    (o.isLegacy = r.isLegacy),
                    (o.rarity = c(r, i)),
                    ...
                    _(o, e),
                    o)
                  : (t[o?.parentSkin] && (o.rarity = c(t[o?.parentSkin], i)),
                    o);
              }
            : (e) => e;
        };
      ...
      (e, t, n) => {
        ...
        var o = (0, i.EmberDataBinding)({
          ...
          boundProperties: {
            ...
            skinsGameData: { api: "gameData", path: "/assets/v1/skins.json" },
            skinlinesInfo: {
              api: "gameData",
            ...
            jmxSettings: { api: "platformConfig", path: "/v1/namespaces" },
            locale: { api: "riotclient", path: "/region-locale" },
      ...
      (e, t, n) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.default = t.SkinSearchTermManager = t.SkinFilter = void 0),
          (t.getSkinNameFilter = function (e, t, n, i = !1) {
            return function (o) {
        ...
        var s = class {
          constructor() {
            (this._filter = ""),
              (this._locale = o.DEFAULT_LOCALE),
              (this._ownership = o.COLLECTION_GRID_OWNERSHIP_FILTERS.ALL),
              (this._hasChroma = !1),
              (this._skinLineId = 0),
              (this._useFuzzy = !1),
              (this._showBaseSkin = !0);
          }
          set filter(e) {
            this._filter = e;
          }
          ...
          _filterSkins(e) {
            ...
            return (
              this._skinLineId &&
                (t =
                  this._skinLineId === o.ALL_SKINLINE_ID
                    ? t.filter(
                        (e) =>
                          e.skinLineId && e.skinLineId !== o.NO_SKINLINE_ID,
                      )
                    : t.filter((e) => e.skinLineId === this._skinLineId)),
              this._ownership === o.COLLECTION_GRID_OWNERSHIP_FILTERS.OWNED
                ? (t = t.filter((e) => e.ownership.owned))
                : this._ownership ===
                    o.COLLECTION_GRID_OWNERSHIP_FILTERS.UNOWNED &&
                  (t = t.filter((e) => !e.ownership.owned)),
              this._hasChroma && (t = t.filter((e) => e.chromaPath)),
              this._legacyOnly && (t = t.filter((e) => e.isLegacy)),
              this._showBaseSkin || (t = t.filter((e) => !e.isBase)),
              (t = t.filter((e) => {
                const t = `champion_local_search_colloq_${e.championId}`,
                  n = this._tra.exists(t) ? this._tra.get(t) : "";
                return this._isValidInFullTextSearch(
                  this._filter,
                  this._buildSearchTerms(n, e.name),
                );
              })),
              t
            );
          ...
          _isValidInFullTextSearch(e, t) {
            ...
            return this._useFuzzy
              ? r.filter(n, t).length > 0
              : t.filter((e) => e.includes(n)).length > 0;
          }
          _buildSearchTerms(e, t) {
            const n = (0, i.lodash)(e.split(";"))
                .filter((e) => e.length > 0)
            ...
            return (
              e &&
                ...
                this._filters &&
                  ...
                  (t = this._filters.reduce((e, t) => e.filter(t), t))),
              t
            );
          }
        };
        t.SkinSearchTermManager = class {
          constructor(e) {
            if (!e)
              throw new Error("Tra service could not be null or undefined.");
            (this._tra = e),
              (this._championSearchTermMap = new Map()),
              (this._skinSearchTermMap = new Map());
          }
          setLocale(e) {
            this._locale &&
              e !== this._locale &&
              (this._championSearchTermMap.clear(),
              this._skinSearchTermMap.clear()),
              (this._locale = e);
          }
          getSkinSearchTerms(e) {
            return (
              this._skinSearchTermMap.has(e.id) ||
                this._buildSkinSearchTerms(e),
              this._skinSearchTermMap.get(e.id)
            );
          }
          _buildSkinSearchTerms(e) {
            this._championSearchTermMap.has(e.championId) ||
              this._buildChampionSearchTerms(e.championId);
            const t = this._championSearchTermMap.get(e.championId),
              n = e.name.toLocaleLowerCase(this._locale),
              o = t.slice();
            i.lodash.includes(o, n) || o.push(n),
              this._skinSearchTermMap.set(e.id, o);
          }
          _buildChampionSearchTerms(e) {
            const t = `champion_local_search_colloq_${e}`,
              n = this._tra.exists(t) ? this._tra.get(t) : "",
              o = (0, i.lodash)(n.split(";"))
                .filter((e) => e.length > 0)
                .map((e) => e.toLocaleLowerCase(this._locale))
                .value();
          ...
          (t.match = function (e, t, n) {
            ...
            for (var p = 0; p < s; p++)
              (i = t[p]),
                ...
                (r[r.length] = i);
            return o === e.length
              ? ((a = u === e ? 1 / 0 : a), { rendered: r.join(""), score: a })
              : null;
          }),
              ...
              .init(t, {
                ...
                DataBinding: (e) =>
                  e
                    ...
                    .getDataBinding("rcp-fe-lol-skins-picker"),
                ...
                EmberDataBinding: (e) =>
                  e
                    ...
                    .getEmberDataBinding("rcp-fe-lol-skins-picker"),
