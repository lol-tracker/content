    ...
    var e = [, e => {
            ...
            var i = l.extend({
                ...
                pityText: o("pityCounter", "chasedContent.name", "chasedContent.status", (function() {
                    ...
                    n && n.owned && (t = this.get("tra.troves_promise_token"));
                    return this.get("chasedContent.isCollectorBounty") ? this.get("tra").formatString("troves_collectors_pity_text", {
                        pity_count: e,
                        max_roll: this.get("chasedContent.maxTotalRolls"),
                        name: t
                    }) : this.get("tra").formatString("troves_chased_content_pity_text", {
                        pity_count: e,
                        name: t
                    })
                })),
                ...
                actions: {
                    onMoreInfoClicked: function() {
                        this._sendMoreInfoClickedTelemetry(), s.navigation.toggleLootOddsModal(!0, null, this.get("chasedContent").id)
                    }
                }
            });
            t.default = i
            ...
            var u = o.extend({
                ...
                activeBanner: i("selectedChasedContentId", "activeBanners", "activeBannersById", "routedChasedContentId", (function() {
                    const e = this.get("selectedChasedContentId"),
                        t = this.get("routedChasedContentId"),
                        n = this.get("activeBannersById");
                    if (e) return n[e];
                    if (t) return n[t];
                    const s = this.get("activeBanners");
                    return s[0] ? s[0] : null
                })),
            ...
            var a = s.Ember.Controller.extend({
                ...
                showEventPass() {
                    ...
                    e && (e.set("isSubNavEnabled", !1), e.set("isHeaderButtonsEnabled", !1))
                },
                actions: {
                    toggleEventPass() {
                        this.toggleProperty("displayEventPass");
                        const e = this.get("tftService");
                        e && (e.toggleProperty("isSubNavEnabled"), e.toggleProperty("isHeaderButtonsEnabled"))
                    }
                }
            });
            t.default = a
            ...
            e.exports = s.HTMLBars.template({
                id: "63cuxCb7",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_23\\\\LeagueClientContent_Release\\\\15680\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-tft\\\\src\\\\app\\\\templates\\\\index.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["block",["if"],[["get",["model","isVisible"]]],null,0]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","    "],["open-element","div",[]],["flush-element"],["close-element"],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const s = n(1).Ember;
            e.exports = s.HTMLBars.template({
                id: "1UbHcC3l",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_23\\\\LeagueClientContent_Release\\\\15680\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-tft\\\\src\\\\app\\\\templates\\\\loading.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["append",["unknown",["uikit-spinner"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const s = n(1).Ember;
            ...
            e.exports = s.HTMLBars.template({
                id: "xt4EjPNM",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_23\\\\LeagueClientContent_Release\\\\15680\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-tft\\\\src\\\\app\\\\templates\\\\troves.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","rcp-fe-lol-tft-application-background"],["dynamic-attr","style",["concat",["background-image:url(",["unknown",["hubBackground"]],")"]]],["flush-element"],["text","\\n  "],["open-element","div",[]],["static-attr","class","rcp-fe-lol-tft-application"],["static-attr","style","height: 720px; width: 1055px;"],["flush-element"],["text","\\n    "],["append",["helper",["tft-troves"],null,[["routedChasedContentId"],[["get",["routedChasedContentId"]]]]],false],["text","\\n  "],["close-element"],["text","\\n"],["close-element"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
