  ...
  var e = [
      ...
      (e, t) => {
        ...
        const E = {
          ...
          format: (e, t, n, s = {}) => ({
            [E.KEY.NAME]: "tft-" + e + "-" + t + "-" + n,
            ...s,
          }),
          formatOpen: (e, t = {}) => E.format(e, E.TYPE.OPEN, e, t),
          formatClose: (e, t = {}) => E.format(e, E.TYPE.CLOSE, e, t),
          formatClick: (e, t, n = {}) => E.format(e, E.TYPE.CLICK, t, n),
          formatTimeSpent: (e, t, n = {}) =>
            E.format(e, E.TYPE.TIME_SPENT, e, { [E.KEY.TIME_SPENT]: t, ...n }),
        };
        t.TFT_TELEMETRY_EVENT = E;
      },
      (e, t, n) => {
        "use strict";
        n.r(t);
        ...
        t.default = class {
          constructor(e) {
            (this._screenRoot = e),
              ...
              (this._isInTFTGame = !1),
              (this._isBattlePassV2Claimable = !1),
            ...
            return this._screenRoot.bump().then(
              function () {
                return this._getLandingPage().then(
                  function (t) {
                    return this._getEmberComponentFactoryInstance(t).then(
                      (n) => (
                        (this._appRootElement = n.domNode),
                        this._screenRoot.getElement().appendChild(n.domNode),
                        this._screenRoot.on("hide", () => {
                          this._applicationComponentFactory &&
                            this._applicationComponentFactory.emberAppInstancePromise.then(
                              (e) => {
                            ...
                            this._indexModel.set("isVisible", !1),
                        ...
                        e && e.page
                          ? this._indexModel.set("page", e.page)
                          : this._indexModel.set("page", t),
                        this._indexModel.set("isVisible", !0),
                        this._applicationComponentFactory.emberAppInstancePromise.then(
                          (e) => {
                            const t = e.__container__.lookup("service:tft");
                            return (
          ...
          showTroves() {
            this.show().then((e) => {
              e.renderPromise.then((e) => {
                e.__container__
                  .lookup("router:main")
                  .transitionTo(a.TFT_TROVES_ROUTE);
              });
            });
          }
          showEventPass() {
            return this._getEmberComponentFactoryInstance(a.TFT_HOME_ROUTE)
          ...
          _registerEmberApplicationFactories(e) {
            if (!this._factoryRegistered) {
              const t = s.Ember.Object.create({ isVisible: !1, page: e });
              (this._indexModel = t),
                (function (e) {
                  const t = {
                      tra: s.traService,
                      ...
                      IndexRoute: s.Ember.Route.extend({
                        beforeModel() {
                          e.page.route && e.page.options
                            ? this.replaceWith(e.page.route, e.page.options)
                            : this.replaceWith(e.page);
                        },
                        model: () => e,
                      }),
            ...
            if (this._applicationComponentFactory) {
              return this._applicationComponentFactory.emberAppInstancePromise
                ...
                .then(
                  (t) => (
                    t &&
                      (this._registerEmberApplicationFactories(e),
                      (this._applicationComponentFactory =
      ...
      (e, t, n) => {
        ...
        var l = s.Ember.Component.extend({
          ...
          selectedPassRewardIsLastMainMilestone: s.Ember.computed(
            "selectedMilestone.internalName",
            "lastMainMilestone.internalName",
            function () {
              return (
                this.get("lastMainMilestone.internalName") ===
                this.get("selectedMilestone.internalName")
              );
            },
          ),
        ...
        var l = s.Ember.Component.extend({
          ...
          rewardFrameImageTag: s.Ember.computed(
            ...
            function () {
              ...
              return `reward-frame--${n}-${
                s ? "locked" : a ? "claimable" : l ? "claimed" : "available"
              }`;
            },
          ),
      ...
      (e, t, n) => {
        ...
        var l = s.Ember.Component.extend({
          ...
          isBattlePassV2Claimable: s.Ember.computed.alias(
            "tftService.isBattlePassV2Claimable",
          ),
          eventsData: s.Ember.computed.alias("tftService.eventsData"),
      ...
      (e, t, n) => {
        ...
        n(49);
        var l,
          o = (l = n(50)) && l.__esModule ? l : { default: l };
        const i = {
        ...
        var d = s.Ember.Component.extend(o.default, {
          ...
          homeFooter: s.Ember.computed.alias(
            "battlePass.info.media.home-footer-bg",
          ),
      ...
      (e, t, n) => {
        ...
        n(59);
        var l,
          o = (l = n(60)) && l.__esModule ? l : { default: l };
        var i = s.Ember.Component.extend(o.default, {
      ...
      (e, t, n) => {
        ...
        var s,
          a = n(1),
          l = (s = n(50)) && s.__esModule ? s : { default: s },
          o = n(2);
        const i = {
      ...
      (e, t, n) => {
        ...
        var o = s.Ember.Component.extend({
          ...
          tftService: s.Ember.inject.service("tft"),
          trovesService: s.Ember.inject.service("tftTroves"),
          isEnabled: s.Ember.computed.alias(
        ...
        var s = n(1),
          ...
          l = s.Ember.Component.extend({
            ...
            actions: {
              openEventUrlFaq() {
                this.get("hasUrlFaq") &&
                  (window.open(this.get("urlFaq", "_blank")),
                  s.Telemetry.sendCustomData(
                    a.DEFAULT_TELEMETRY_TABLE,
      ...
      (e, t, n) => {
        ...
        var s = n(1),
          ...
          l = s.Ember.Component.extend({
            ...
            selectedMission: s.Ember.computed(
      ...
      (e, t, n) => {
        ...
        var s,
          a = n(1),
          l = n(11),
          o = (s = n(97)) && s.__esModule ? s : { default: s },
          i = n(98);
        n(102);
            ...
            function () {
              return s.Ember.String.htmlSafe(
                `\n        background-image: url(${this.get(
                  ...
                  100 * this.get("backgroundPositionY")
                }%;\n        left: -${
                  100 * this.get("backgroundPositionX")
                }%;\n        width: ${
                  100 * this.get("numCols")
      ...
      (e, t, n) => {
        ...
        var l = s.Ember.Controller.extend({
          ...
          tftService: s.Ember.inject.service("tft"),
          trovesService: s.Ember.inject.service("tftTroves"),
          trovesV2Enabled: s.Ember.computed(
          ...
          _computeBackgroundPath(e, t) {
            return t && t.endsWith(".png")
              ...
              : e && e[a]
                ? e[a]
                : this.get("tftService.media.background--battlepass");
          },
          actions: {
            onBannerSelected(e) {
      ...
      (e, t, n) => {
        ...
        var l = s.Ember.Controller.extend({
          ...
          hubBackground: s.Ember.computed(
            ...
            "displayEventPass",
            function () {
              return this.displayEventPass
                ? this.get("media.background--eventpass")
                : this.get("media.background--loading");
            },
          ),
          ...
          actions: {
            toggleEventPass() {
              ...
              const e = this.get("tftService");
              e &&
                (e.toggleProperty("isSubNavEnabled"),
                e.toggleProperty("isHeaderButtonsEnabled")),
      ...
      (e, t, n) => {
        ...
        var s,
          a = n(1),
          l = (s = n(135)) && s.__esModule ? s : { default: s },
          o = n(2);
        ...
        var p = a.Ember.Service.extend({
          ...
          isBattlePassV2Claimable: a.Ember.computed.alias(
            "isMissionsBattlePassClaimable",
          ),
          isBattlePassXPBoosted: !1,
          ...
          willDestroy() {
            this._super(...arguments),
              d.removeObserver(u.BATTLE_PASS_V2, this),
              d.removeObserver(u.GENERIC_ASSETS, this),
              d.removeObserver(u.MAP_DATA, this),
              d.removeObserver(u.TFT_SETS_DATA_PATH, this),
              d.removeObserver(u.RP, this),
              d.removeObserver(u.SETTINGS_READY, this),
              d.removeObserver(u.STAR_SHARDS, this),
              d.removeObserver(u.STAR_SHARDS_TOGGLES, this),
              d.removeObserver(u.TFT_BATTLE_PASS_PAGE, this),
              d.removeObserver(u.TFT_HOME, this),
              d.removeObserver(u.TFT_NEWS, this),
              d.removeObserver(u.TFT_PASS_BATTLE_PASS, this),
              d.removeObserver(u.TFT_PASS_ENABLED, this),
              d.removeObserver(u.TFT_PASS_EVENT_PASS, this),
              d.removeObserver(u.TFT_PLAYER_PREFERENCES, this),
              d.removeObserver(u.TFT_TEST_PAGE, this),
            ...
            d.addObserver(u.STAR_SHARDS_TOGGLES, this, (e) => {
              ...
              d.addObserver(u.TFT_EVENTS, this, (e) => {
                e &&
                  ...
                  d.addObserver(u.TFT_EVENT_MISSIONS, this, (e) => {
              ...
              d.addObserver(u.TFT_TEST_PAGE, this, (e) => {
              ...
              d.addObserver(u.BATTLE_PASS_V2, this, (e) => {
                e &&
                  (this.set("missionsBattlePass", e),
                  this._handleBattlePassV2Change(
                    e,
                    "isMissionsBattlePassClaimable",
                  ));
              }),
              d.addObserver(u.TFT_PASS_BATTLE_PASS, this, (e) => {
                e &&
                  (this.set("tftPassBattlePass", e),
                  this._handleBattlePassV2Change(
                    e,
                    "isTftPassBattlePassClaimable",
                  ));
              }),
              d.addObserver(u.TFT_PASS_EVENT_PASS, this, (e) => {
                e &&
                  ...
                  this._handleBattlePassV2Change(
                    e,
                    "isTftPassEventPassClaimable",
                  ));
              });
          },
          getStorePromoAssets: () =>
            a.db.get(u.GENERIC_ASSETS).then((e) => (e ? e[m] : null)),
          ...
          claimRewards(e, t) {
            const { rewards: n, missionId: s } = e;
            if (1 === new Set(n.map((e) => e.rewardGroup)).size) {
              const e = { rewardGroups: [n[0].rewardGroup] };
              (0, a.dataBinding)("/lol-missions").put("/v1/player/" + s, e);
            }
            l.default.celebrate(e, t);
          },
          claimRewardsV2(e, t) {
            l.default.celebratePassReward({ rewards: e, backgroundImage: t });
          },
          celebratePassCompletion() {
            l.default.celebratePassCompletion(
              this.get("media.background--battlepass-completion"),
            );
          },
          ...
          dismissNotification(e) {
            if (e === o.TFT_BATTLE_PASS_ROUTE)
              this.set("isMissionsBattlePassClaimable", !1),
                this.set("isTftPassBattlePassClaimable", !1);
          },
      ...
      (e, t, n) => {
        ...
        var m = {
          celebrate: function (
            { id: e, titleSubtext: t, rewards: n, missionId: a },
            m,
          ) {
            const u = r(n),
              d = u
                    ...
                    s.db.addObserver(
                      ...
                      (e) => {
                        if (
                          ...
                          return;
                        if (e.hasPullError)
                          return void this.set("pullErrorModalShowing", !0);
      ...
      (e, t, n) => {
        ...
        e.exports = s.HTMLBars.template({
          id: "z1jIlt5V",
          block:
            '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_24\\\\LeagueClientContent_Release\\\\15690\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-tft\\\\src\\\\app\\\\templates\\\\index.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["block",["if"],[["get",["model","isVisible"]]],null,0]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","    "],["open-element","div",[]],["flush-element"],["close-element"],["text","\\n"]],"locals":[]}],"hasPartials":false}',
          meta: {},
        });
      },
      (e, t, n) => {
        ...
        e.exports = s.HTMLBars.template({
          id: "ZIpMYOm5",
          block:
            '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_24\\\\LeagueClientContent_Release\\\\15690\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-tft\\\\src\\\\app\\\\templates\\\\loading.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["append",["unknown",["uikit-spinner"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
          meta: {},
        });
      },
      (e, t, n) => {
      ...
      (e, t, n) => {
        ...
        var r = s.Ember.Component.extend({
          ...
          tokenPurchaseSuccessText: s.Ember.computed(
            "tokenQuantity",
            function () {
              return `<p class="purchase-success-quantity">${this.get(
                "tra",
              ).formatString("troves_tokens_quantity", {
                quantity: this.get("tokenQuantity"),
              })}</p><p class="purchase-success-message">${this.get(
                "tra",
              ).formatString("troves_tokens_granting", {
                quantity: this.get("tokenQuantity"),
              })}</p>`;
            },
          ),
