(() => {
  var t = [
      ...
      (t, e, n) => {
        ...
        const f = function () {
          (this.audioContext = new AudioContext()),
            ...
            this._initMasterGainNode(),
            this._initializeDefaultChannels(),
            this._initializeChannelInteraction(),
            (this._audioSettingsObserver = null);
        };
        Object.assign(f.prototype, {
          initDataBindings(t) {
            this._audioSettingsObserver &&
              this._audioSettingsObserver.disconnect(),
              (this._audioSettingsObserver = new a.default(t, this));
          },
          ...
          setMasterVolume(t) {
            Number.isFinite(t)
              ? (t < 0 ? (t = 0) : t > 1 && (t = 1),
                (this._masterGainNode.gain.value = t))
              : i.logger.warning(
                  "Attempted to set invalid volume for sound.",
                  t,
                );
          },
          _initMasterGainNode() {
            (this._masterGainNode = this.audioContext.createGain()),
              this._masterGainNode.connect(this.audioContext.destination);
          },
          _initializeDefaultChannels: function () {
            ...
            const r = { name: u.SFX_CHANNEL_NAME, volume: 1, maxConcurrent: 2 },
          ...
          _initializeChannelInteraction: function () {
            ...
            t.addDuckKeyChannel(e),
              t.addDuckKeyChannel(n),
              t.addDuckKeyChannel(i);
          },
          _createChannel: function (t, e) {
            return e
              ? e.createSubChannel(this.audioContext, t)
              : (((t = t || {}).parentGainNodeGetter = () =>
                  this._masterGainNode),
                new o.default(this.audioContext, t));
          },
      ...
      (t, e) => {
        ...
        var n = {
          ...
          on: function (t, e) {
            this.events().has(t) || this.events().set(t, new Map()),
              this.events().get(t).set(e, !0);
          },
          off: function (t, e) {
          ...
          get: function (t) {
            return this.options && void 0 !== this.options[t]
              ? this.options[t]
              : null;
          },
          set: function (t, e) {
            this.options &&
              ((this.options[t] = e), this.trigger("changed:" + t));
          },
        };
        e.default = n;
      },
      (t, e, n) => {
        ...
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.default =
            e.CULLING_STRATEGY_STOP =
            e.CULLING_STRATEGY_FADE =
              void 0);
        var i = n(1),
          r = a(n(3)),
          o = a(n(5)),
        ...
        const l = {
          ...
          h = function (t, e) {
            if (
              ...
              throw new Error(
                "this.audioContext must be an instance of AudioContext.",
              );
            }
            (this.options = Object.assign({}, l, e)),
              this.options.name && (this.name = this.options.name),
              (this.playingSounds = []),
              (this.duckKeyTriggered = !1),
              (this.duckCount = 0),
              (this._currentDuckVolume = 1),
              (this._duckVolumeTargetPercent = 1),
              (this._currentActiveConnectedChannels = new Set()),
              this.on("changed:volume", this._processDuckGain.bind(this)),
              this.set("gainNode", void 0),
              this._initVolume();
          };
        Object.assign(h.prototype, {
          ...
          _initAnalyser: function () {
            (this.analyser = this.audioContext.createAnalyser()),
              (this.analyser.fftSize = this.get("analyserFftSize")),
              (this.analyserDataArray = new Float32Array(
                this.analyser.frequencyBinCount,
              )),
              this.analyser.connect(this.get("gainNode"));
          },
          createSound: function (t, e = {}) {
            const n = { duckOtherChannels: !1 };
            (this.get("crossfade") || e.crossfade) &&
              ((n.fadeIn = !0), (n.fadeOut = !0)),
              (e = e ? Object.assign(n, e) : n);
            const i = this._createSoundObject(t, e);
            return this._attachListeners(i), i;
          },
          _attachListeners: function (t) {
            t.on("play", this._onSoundPlay.bind(this)),
              t.on("pause", this._onSoundHalt.bind(this)),
              t.on("stop", this._onSoundHalt.bind(this)),
              t.on("end", this._onSoundHalt.bind(this));
          },
          playSound: function (t, e, n) {
            return this.createSound(t, e)
              .play(n)
              .then(function (t) {
          ...
          addDuckKeyChannel: function (t) {
            t.on("duckTriggerStart", () => this.addDuck()),
              t.on("duckTriggerEnd", () => this.removeDuck());
          },
          addDuck: function () {
            return (
              this.duckCount++,
              1 === this.duckCount &&
                ((this._duckVolumeStartPercent = this._currentDuckVolume),
                (this._duckVolumeTargetPercent = this.get("duckVolumePercent")),
                (this._duckFadeStartTime = new Date().getTime()),
                (this._duckFadeEndTime =
                  this.get("duckAttackMilliseconds") + this._duckFadeStartTime),
          ...
          removeDuck: function () {
            return (
              ...
              0 === this.duckCount &&
                ...
                (this._duckFadeStartTime = new Date().getTime()),
                (this._duckFadeEndTime =
                  this.get("duckReleaseMilliseconds") +
                  this._duckFadeStartTime),
                this._processDuckGain()),
              this.duckCount
            );
          },
          createSubChannel: function (t, e) {
            (e = e || {}).parentGainNodeGetter = (t) => (
              this._currentActiveConnectedChannels.add(t),
              this._checkOrInitializeGainNode()
            );
            const n = new h(t, e);
            return (
              n.on("gainNodeDestroyed", (t) => {
                this._currentActiveConnectedChannels.delete(t),
                  this._cleanupGainNodeIfNoInputs();
              }),
              n
            );
          },
          _processDuckGain: function () {
            ...
            if (!e) return;
            let n = e.gain.value;
            if (!this._duckFadeEndTime || t > this._duckFadeEndTime)
              n = this.get("volume") * this._duckVolumeTargetPercent;
            else {
              const e =
                  (t - this._duckFadeStartTime) /
                  (this._duckFadeEndTime - this._duckFadeStartTime),
                i =
                  this._duckVolumeStartPercent +
                  e *
                    (this._duckVolumeTargetPercent -
                      this._duckVolumeStartPercent);
              (this._currentDuckVolume = i),
                (n = this.get("volume") * i),
                setTimeout(
                  this._processDuckGain.bind(this),
                  this.get("duckProcessingInterval"),
                );
            }
            return (
              (n = Math.min(1, n)),
          ...
          _multiplexCheck: function () {
            ...
            switch (n) {
              ...
              default:
                (r = !0),
                  i.logger.error(
                    `Invalid concurrentSoundCullingStrategy ${n}. Defaulting to stop.`,
                  );
            }
            let o = 0;
            for (let n = t - 1; n >= 0; n--)
              this.playingSounds[n].isFadingOut() ||
                (o < e
                  ? (o += 1)
                  : r
                    ? this.playingSounds[n].stop()
                    : this.playingSounds[n].fadeOut(void 0, { stop: !0 }));
          },
          _max: function (t) {
            if (!t) return null;
            let e = 0;
          ...
          _duckTriggerCheck: function () {
            ...
            const t =
              this._max(this.analyserDataArray) > this.get("duckThreshold");
            t && !this.duckKeyTriggered
              ? ((this.duckKeyTriggered = !0), this.trigger("duckTriggerStart"))
              : !t &&
                this.duckKeyTriggered &&
                ((this.duckKeyTriggered = !1), this.trigger("duckTriggerEnd")),
              this._checkDuckKeyInterval &&
                !this._doesAnySoundWantsToDuckOtherChannels(
                  this.playingSounds,
                ) &&
                clearInterval(this._checkDuckKeyInterval);
          },
          _onSoundPlay: function (t) {
            if (-1 !== this.playingSounds.indexOf(t)) return;
            const e = t.get("gainNode");
            this._checkOrInitializeGainNode(),
              t.options.duckOtherChannels && this.options.duckOtherChannels
                ? (e.connect(this.analyser),
                  this._duckTriggerCheck(),
                  this._checkDuckKeyInterval &&
                    clearInterval(this._checkDuckKeyInterval),
                  (this._checkDuckKeyInterval = setInterval(
                    this._duckTriggerCheck.bind(this),
                    this.get("duckProcessingInterval"),
                  )))
                : e.connect(this.get("gainNode")),
              this.playingSounds.push(t),
              1 === this.playingSounds.length && this.trigger("play", t),
              this._multiplexCheck();
          },
          _onSoundHalt: function (t) {
            const e = this.playingSounds.indexOf(t);
            -1 !== e && this.playingSounds.splice(e, 1),
              0 === this.playingSounds.length && this.trigger("end", t),
              t.options.duckOtherChannels && this._duckTriggerCheck(),
              this._cleanupGainNodeIfNoInputs();
          },
          _cleanupGainNodeIfNoInputs: function () {
            ...
            t &&
              (this.analyser &&
                0 === this.playingSounds.length &&
                (this.analyser.disconnect(), (this.analyser = null)),
              0 === this._currentActiveConnectedChannels.size &&
                0 === this.playingSounds.length &&
                (t.disconnect(),
                this.set("gainNode", void 0),
                this.trigger("gainNodeDestroyed", t)));
          },
          _createSoundObject: function (t, e) {
            ...
            switch (n) {
              ...
              default:
                return (
                  i.logger.warning(
                    "Invalid playbackStrategy, defaulting to small_file",
                    { channelPlaybackStrategy: n, url: t },
                  ),
          ...
          _checkOrInitializeGainNode: function () {
            if (!this.get("gainNode")) {
              ...
              this.set("gainNode", t),
                (t.gain.value = this.get("volume")),
                this.options.duckOtherChannels &&
                  (this._initAnalyser(), this._processDuckGain()),
                this.options.parentGainNodeGetter &&
                  t.connect(this.options.parentGainNodeGetter(this));
            }
      ...
      (t, e, n) => {
        ...
        const u = function (t, e, n) {
          ...
          (this.options = { url: "", isLoop: !1, allowConcurrency: !0 }),
            Object.assign(this.options, n),
            (this.audioBuffer = null),
            (this.audioBufferSourceNode = null),
            (this._isPlaybackPaused = !1),
            (this._pendingPlaybacks = 0),
            (this._playbackSettings = {}),
            (e = e || null),
            this.set("url", e),
            this.set("gainNode", this._createGainNode());
        };
        Object.assign(u.prototype, {
          _readyPromise: null,
          _bufferSoundFile: function (t) {
            return this.audioBuffer
              ? r.default.resolve(this)
              : this._loadAudioFile(t).then(
                  (t) => ((this.audioBuffer = t), this),
                );
          },
          ready: function () {
            return (
              this._readyPromise ||
                (this._readyPromise = this._bufferSoundFile(this.get("url"))),
              this._readyPromise
            );
          },
          isPlaying: function () {
          ...
          play: function (t) {
            ...
            return this.ready()
              .then(() =>
                !1 === this.options.allowConcurrency && this.isPlaying()
                  ? this.stop().then(() => this._play(e, n, i, o))
                  : this._play(e, n, i, o),
              )
              .catch((t) => (this.dispose(), r.default.reject(t)));
          },
          _play: function (t, e, n, i) {
            if (
              ((this._playbackSettings = { when: e, offset: n, duration: i }),
            ...
            return (
              (this.isPlaying = () => !0),
              (this._pendingPlaybacks = t),
              this._replaysQueue(e, n, i)
            );
          },
          _replaysQueue: function (t, e, n) {
            return this._pendingPlaybacks > 0
              ? this._playOnce(t, e, n)
              : ((this.isPlaying = () => !1), r.default.resolve(this));
          },
          _playOnce: function (t = this.audioContext.currentTime, e = 0, n) {
            return (
              (this._playbackStartTime = t),
              this.audioBufferSourceNode && this._destroyBufferSourceNode(),
              (this.audioBufferSourceNode = this._createBufferSourceNode()),
              new r.default((i) => {
                this.audioBufferSourceNode.loop ||
                  ((this.audioBufferSourceNode.onended = () => {
                    this._destroyBufferSourceNode(),
                      1 === this._pendingPlaybacks
                        ? this.trigger("end", this)
                        : this._pendingPlaybacks > 1 &&
                          this.trigger("endreplay", this),
                      (this._pendingPlaybacks = this._pendingPlaybacks - 1),
                      i(this._replaysQueue(t, e, n));
                  }),
                  (this.audioBufferResolve = i)),
                  null !== n && n >= 0
                    ? this.audioBufferSourceNode.start(t, e, n)
                    : this.audioBufferSourceNode.start(t, e),
          ...
          resume: function () {
            ...
            return this.ready().then(() => {
              const { offset: t, duration: e } = this._playbackSettings;
              let { when: n } = this._playbackSettings;
              (this._isPlaybackPaused = !1),
                n || (n = this.audioContext.currentTime);
              const i = n + this._playbackTimePassed;
              return (
                (this._playbackTimePassed = 0),
                (this._pendingPlaybacks = this._pendingPlaybacks + 1),
                this._playOnce(i, t, e).then(() => this._replaysQueue(n, t, e))
              );
            });
          },
          pause: function () {
            return this._stop()
              .then(() => {
                const { currentTime: t } = this.audioContext;
                return (
                  (this._playbackTimePassed = t - this._playbackStartTime),
                  (this._isPlaybackPaused = !0),
                  (this.isPlaying = () => !1),
              ...
              if (this.audioBufferSourceNode)
                try {
                  (this.audioBufferSourceNode.onended = null),
                    this.audioBufferResolve &&
                      (this.audioBufferResolve(),
                      (this.audioBufferResolve = null)),
          ...
          setVolume: function (t) {
            Number.isFinite(t)
              ? (this.get("gainNode").gain.value = t)
              : i.logger.warning(
                  "Attempted to set invalid volume for sound.",
                  t,
                );
          ...
          fadeOut: function (t) {
            ...
            return (
              (this._fadeOutStopTimer = setTimeout(() => this.stop(), i)),
              this.fade(e, n, i, o),
              r.default.delay(i, this)
            );
          },
          ...
          _computeFadeOptions: function (t, e) {
            ...
            if (
              ((t =
                "number" == typeof t
                  ? Object.assign({}, i, { fadeTime: t })
                  : "object" == typeof t
                    ? Object.assign({}, i, t)
                    : i),
              ["fadeTo", "fadeFrom"].forEach((e) => {
                "current" === t[e] && (t[e] = this.get("gainNode").gain.value);
              }),
              "exponential" === t.fadeShape && 0 === t.fadeFrom)
            )
              throw new Error(
                "when using exponential fadein start volume must be greater then 0",
              );
            if ("linear" === t.fadeShape) t.fadeShape = { isLinear: !0 };
            else {
              if ("exponential" !== t.fadeShape)
                throw new Error(
                  `Unknown fade shape '${t.fadeShape}'. Must be either 'linear' or 'exponential'`,
                );
              t.fadeShape = { isExponential: !0 };
            }
            return t;
          },
          fade: function (t, e, n, i) {
            const { isLinear: r = !0, isExponential: o = !1 } = i || {},
              s = this.get("gainNode").gain,
              { currentTime: a } = this.audioContext;
            s.setValueAtTime(t, a);
            const u = a + n / 1e3;
            r && !o
              ? s.linearRampToValueAtTime(e, u)
              : o && s.exponentialRampToValueAtTime(e, u);
          },
          _loadAudioFile: function (t) {
            return s.default
              .xmlHttpAudioRequest(t)
          ...
          _createBufferSourceNode: function () {
            if (!(this.audioBuffer instanceof AudioBuffer))
              throw new Error(
                "SoundAudioBuffer.audioBuffer is not an instance of AudioBuffer.",
              );
            const t = this.audioContext.createBufferSource();
            return (
              (t.buffer = this.audioBuffer),
              t.connect(this.get("gainNode")),
              (t.loop = this.get("isLoop")),
              t
            );
          },
          ...
          Object.defineProperty(u.prototype, "_isPlaying", {
            get: function () {
              return (
                i.logger.warning(
                  "_isPlaying has been depreciated, please use isPlaying instead",
                ),
                this.isPlaying()
              );
            },
              ...
              2: [
                function (t, e, n) {
                  ...
                  (a.prototype.enableTrampoline = function () {
                    ...
                    (a.prototype.invokeFirst = function (t, e, n) {
                  ...
                  e.exports = function (t, e, n, i) {
                    ...
                    (t.prototype.bind = function (o) {
                      ...
                      if ((l._setBoundTo(c), c instanceof t)) {
                        ...
                        h._then(e, s, void 0, l, f),
                          c._then(a, u, void 0, l, f),
                          l._setOnCancel(c);
                    ...
                    return function (t, s, a) {
                      return function (u) {
                        ...
                        t: for (var l = 0; l < t.length; ++l) {
                          ...
                          if (
                            h === Error ||
                            (null != h && h.prototype instanceof Error)
                          ) {
                  ...
                  e.exports = function (e, n) {
                    var i,
                      ...
                      g = !(
                        ...
                        (!_ && !c.env("BLUEBIRD_WARNINGS"))
                      ),
                      v = !(
                        0 == c.env("BLUEBIRD_LONG_STACK_TRACES") ||
                        (!_ && !c.env("BLUEBIRD_LONG_STACK_TRACES"))
                      ),
                      y =
                        0 != c.env("BLUEBIRD_W_FORGOTTEN_RETURN") &&
                        (g || !!c.env("BLUEBIRD_W_FORGOTTEN_RETURN"));
                    ...
                    (e.longStackTraces = function () {
                      if (a.haveItemsQueued() && !Q.longStackTraces)
                        throw new Error(
                      ...
                      b = c.isNode
                        ...
                        : c.global
                          ? function (t) {
                              ...
                              return (
                                !!n &&
                                (n.apply(c.global, [].slice.call(arguments, 1)),
                                !0)
                              );
                            }
                          : function () {
                    ...
                    (e.config = function (t) {
                      ...
                      if (
                        ...
                        (e.prototype._clearCancellationData = j),
                          (e.prototype._propagateFrom = P),
                          (e.prototype._onCancel = T),
                          (e.prototype._setOnCancel = F),
                          (e.prototype._attachCancellationCallback = A),
                          (e.prototype._execute = w),
                          (x = P),
                          (Q.cancellation = !0);
                      }
                      "monitoring" in t &&
                        (t.monitoring && !Q.monitoring
                          ? ((Q.monitoring = !0), (e.prototype._fireEvent = N))
                          : !t.monitoring &&
                            Q.monitoring &&
                            ((Q.monitoring = !1),
                            (e.prototype._fireEvent = k)));
                    }),
                      (e.prototype._fireEvent = k),
                    ...
                    function R(t, n, i) {
                      if (Q.warnings) {
                        ...
                        else if (Q.longStackTraces && (r = e._peekContext()))
                          r.attachExtraTrace(o);
                        else {
                          var s = L(o);
                          o.stack = s.message + "\n" + s.stack.join("\n");
                        }
                    ...
                    function V(t, e, n, i) {
                      ...
                      try {
                        "function" == typeof e &&
                          ((r = !0), "rejectionHandled" === t ? e(i) : e(n, i));
                      } catch (t) {
                        a.throwLater(t);
                      }
                      "unhandledRejection" === t
                        ? N(t, n, i) || r || H(n, "Unhandled rejection ")
                        : N(t, i);
                    }
                    function U(t) {
                      var e;
                      ...
                      v && e.longStackTraces(),
                      {
                        ...
                        checkForgottenReturns: function (t, e, n, i, r) {
                          if (void 0 === t && null !== e && y) {
                            if (void 0 !== r && r._returnedNonUndefined())
                              return;
                            n && (n += " ");
                            var o =
              ...
              12: [
                function (t, e, n) {
                  ...
                  try {
                    ...
                    (i = l("TypeError", "type error")),
                      (r = l("RangeError", "range error"));
                  }
                  for (
                    var _ =
                        ...
                        if (void 0 !== h) {
                          ...
                          if (f instanceof e) {
                            if (null != this.cancelPromise) {
                              ...
                              f.isPending() &&
                                f._attachCancellationCallback(new a(this));
                            }
                    ...
                    return (
                      ...
                      (e.prototype._passThrough = function (t, e, n, i) {
                        return "function" != typeof t
                          ? this.then()
                          : this._then(n, i, void 0, new s(this, e, t), void 0);
                      }),
                  ...
                  e.exports = function (e, n, i, r, o, s) {
                    ...
                    function f(t, n, r, o) {
                      ...
                      s._captureStackTrace(),
                        ...
                        (this._yieldHandlers =
                          "function" == typeof r ? [r].concat(h) : h),
                    ...
                    u.inherits(f, o),
                        ...
                        if (!this._isResolved()) {
                          ...
                          if (void 0 !== this._generator.return)
                            this._promise._pushContext(),
                              (t = l(this._generator.return).call(
                                this._generator,
                                void 0,
                              )),
                            ...
                            (e.coroutine.returnSentinel = n),
                              ...
                              this._promise._pushContext(),
                              (t = l(this._generator.throw).call(
                                this._generator,
                                n,
                              )),
                              this._promise._popContext(),
                          ...
                          var i = this._promise;
                          this._cleanup(),
                            t === c ? i._rejectCallback(t.e, !1) : i.cancel();
                        }
                      }),
                      ...
                      (f.prototype._continue = function (t) {
                        ...
                        var i = t.value;
                        if (!0 === t.done)
                          return this._cleanup(), n._resolveCallback(i);
                ...
                function (t, e, n) {
                  ...
                  e.exports = function (e, n, i, r, o, s) {
                    ...
                    function f(t, e, n, i) {
                      ...
                      var r = a();
                      (this._callback = null === r ? e : r.bind(e)),
                    ...
                    u.inherits(f, n),
                      ...
                      (f.prototype._promiseFulfilled = function (t, n) {
                        ...
                        return (
                          ...
                          (null !== a ? this._filter(i, a) : this._resolve(i),
                          !0)
                        );
                      }),
                    ...
                    (e.method = function (t) {
                      ...
                      return function () {
                        ...
                        var r = a(t).apply(this, arguments),
                          s = i._popContext();
                        return (
                          o.checkForgottenReturns(r, s, "Promise.method", i),
                      ...
                      (e.attempt = e.try =
                        function (t) {
                          ...
                          var h = u._popContext();
                          return (
                            o.checkForgottenReturns(i, h, "Promise.try", u),
                            u._resolveFromSyncValue(i),
                            u
                          );
                        }),
                ...
                function (t, e, n) {
                  ...
                  e.exports = function () {
                    ...
                    var u = t("./es5"),
                      c = t("./async"),
                      l = new c();
                    u.defineProperty(A, "_async", { value: l });
                    var h = t("./errors"),
                      f = (A.TypeError = h.TypeError);
                    A.RangeError = h.RangeError;
                    var p = (A.CancellationError = h.CancellationError);
                    (A.TimeoutError = h.TimeoutError),
                      (A.OperationalError = h.OperationalError),
                      (A.RejectionError = h.OperationalError),
                      (A.AggregateError = h.AggregateError);
                    var d = function () {},
                      _ = {},
                      g = {},
                      v = t("./thenables")(A, d),
                    ...
                    return (
                      ...
                      (A.prototype.spread = function (t) {
                        return "function" != typeof t
                          ...
                          : this.all()._then(t, void 0, void 0, _, void 0);
                      }),
                      ...
                      (A.prototype._then = function (t, e, n, i, r) {
                        ...
                        if (0 != (50397184 & c)) {
                          var f,
                            _,
                            g = u._settlePromiseCtx;
                          0 != (33554432 & c)
                            ? ((_ = u._rejectionHandler0), (f = t))
                            : 0 != (16777216 & c)
                              ? ((_ = u._fulfillmentHandler0),
                                (f = e),
                                u._unsetRejectionIsUnhandled())
                              : ((g = u._settlePromiseLateCancellationObserver),
                                (_ = new p("late cancellation observer")),
                                u._attachExtraTrace(_),
                                (f = e)),
                            l.invoke(g, u, {
                              handler:
                                null === h
                                  ? f
                                  : "function" == typeof f && h.bind(f),
                              promise: a,
                              receiver: i,
                              value: _,
                            });
                      ...
                      (A.prototype._addCallbacks = function (t, e, n, i, r) {
                        ...
                        if (
                          ...
                          (this[s + 2] = n),
                            (this[s + 3] = i),
                            "function" == typeof t &&
                              (this[s + 0] = null === r ? t : r.bind(t)),
                            "function" == typeof e &&
                              (this[s + 1] = null === r ? e : r.bind(e));
                        }
                          ...
                          i._pushContext(),
                            e === _
                              ? n && "number" == typeof n.length
                                ? (o = w(t).apply(this._boundValue(), n))
                                : ((o = k).e = new f(
                              ...
                              : (o = w(t).call(e, n));
                          var s = i._popContext();
                          0 == (65536 & (r = i._bitField)) &&
                            (o === g
                              ? i._reject(n)
                              : o === k
                                ? i._rejectCallback(o.e, !1)
                                : (b.checkForgottenReturns(o, s, "", i, this),
                      ...
                      (A.prototype._settlePromise = function (t, e, i, o) {
                        ...
                        0 != (65536 & a)
                          ? (s && t._invokeInternalOnCancel(),
                            i instanceof E && i.isFinallyHandler()
                              ? ((i.cancelPromise = t),
                                w(e).call(i, o) === k && t._reject(k.e))
                              : e === n
                                ? t._fulfill(n.call(i))
                                : i instanceof r
                      ...
                      (A.prototype._settlePromiseLateCancellationObserver =
                        function (t) {
                          ...
                          "function" == typeof e
                            ? n instanceof A
                              ? this._settlePromiseFromHandler(e, i, r, n)
                              : e.call(i, r, n)
                            : n instanceof A && n._reject(r);
                        }),
                      ...
                      (A.prototype._reject = function (t) {
                        ...
                        if (!((117506048 & e) >>> 16)) {
                          if (
                            ...
                            return l.fatalError(t, a.isNode);
                          (65535 & e) > 0
                            ? l.settlePromises(this)
                      ...
                      (A.defer = A.pending =
                        function () {
                          return (
                            ...
                            { promise: new A(d), resolve: T, reject: F }
                          );
                        }),
                      a.notEnumerableProp(A, "_makeSelfResolutionError", e),
                      t("./method")(A, d, v, i, b),
                      t("./bind")(A, d, v, b),
                      t("./cancel")(A, y, i, b),
                      t("./direct_resolve")(A),
                      ...
                      t("./join")(A, y, v, d, b),
                      (A.Promise = A),
                      t("./map.js")(A, y, i, v, d, b),
                      t("./using.js")(A, i, v, C, d, b),
                      t("./timers.js")(A, d, b),
                      t("./generators.js")(A, i, d, v, r, b),
                      t("./nodeify.js")(A),
                      t("./call_get.js")(A),
                      t("./props.js")(A, y, v, i),
                      t("./race.js")(A, d, v, i),
                      t("./reduce.js")(A, y, i, v, d, b),
                      t("./settle.js")(A, y, b),
                      t("./some.js")(A, y, i),
                      t("./promisify.js")(A, d),
                      t("./any.js")(A),
                      t("./each.js")(A, d),
                      t("./filter.js")(A, d),
                      a.toFastProperties(A),
                      a.toFastProperties(A.prototype),
                      j({ a: 1 }),
                      j({ b: 2 }),
                      j({ c: 3 }),
                      j(1),
                      ...
                      j(!1),
                      j(new A(d)),
                      b.setBounds(c.firstLineError, a.lastLineError),
                      A
                    );
                  };
                },
                      ...
                      (a.prototype._iterate = function (t) {
                        ...
                        (this._length = n),
                          (this._values = this.shouldCopyValues()
                            ...
                            : this._values);
                        for (
                          var r = this._promise, o = !1, s = null, a = 0;
                          a < n;
                          ++a
                        ) {
                          var u = i(t[a], r);
                          (s =
                            ...
                            o
                              ...
                              : null !== s
                                ? 0 == (50397184 & s)
                                  ? (u._proxy(this, a), (this._values[a] = u))
                                  : (o =
                                      0 != (33554432 & s)
                                        ? this._promiseFulfilled(u._value(), a)
                                        : 0 != (16777216 & s)
                                          ? this._promiseRejected(
                                              u._reason(),
                                              a,
              ...
              24: [
                function (t, e, n) {
                  ...
                  e.exports = function (e, n) {
                    ...
                    function g(t, e, n, i) {
                      for (
                        var o = r.inheritedDataKeys(t), s = [], a = 0;
                        a < o.length;
                        ++a
                      ) {
                        var u = o[a],
                    ...
                    function y(t, e, n, o, s) {
                      for (
                        ...
                        if (o === v) t[p] = v(h, i, h, f, e, s);
                          ...
                          r.notEnumerableProp(d, "__isPromisified__", !0),
                            (t[p] = d);
                        }
                      }
                    ...
                    (e.promisify = function (t, e) {
                      if ("function" != typeof t)
                        throw new c(
                          "expecting a function but got " + r.classString(t),
                        );
                      if (d(t)) return t;
                      var n = (function (t, e, n) {
                        ...
                        t,
                        void 0 === (e = Object(e)).context ? i : e.context,
                        !!e.multiArgs,
                      );
                      ...
                      (e.promisifyAll = function (t, e) {
                        ...
                        for (
                          var a = r.inheritedDataKeys(t), u = 0;
                          u < a.length;
                          ++u
                        ) {
                          var l = t[a[u]];
                          "constructor" !== a[u] &&
                            r.isClass(l) &&
                            (y(l.prototype, i, o, s, n), y(l, i, o, s, n));
                        }
                        return y(t, i, o, s, n);
                      });
                  };
                      ...
                      (l.prototype._promiseFulfilled = function (t, e) {
                        if (
                          ...
                          if (this._isMap)
                            n = (function (t) {
                              for (
                                var e = new o(), n = (t.length / 2) | 0, i = 0;
                                i < n;
                                ++i
                              ) {
                                var r = t[n + i],
                            ...
                            n = {};
                            for (
                              var i = this.length(), r = 0, s = this.length();
                              r < s;
                              ++r
                            )
                ...
                function (t, e, n) {
                  ...
                  e.exports = function (e, n, i, r) {
                    ...
                    function s(t, a) {
                      ...
                      for (
                        var h = l._fulfill, f = l._reject, p = 0, d = t.length;
                        p < d;
                        ++p
                      ) {
                        var _ = t[p];
                        (void 0 !== _ || p in t) &&
                          e.cast(_)._then(h, f, void 0, l, null);
                      }
                      return l;
                    }
                    (e.race = function (t) {
                  ...
                  e.exports = function (e, n, i, r, o, s) {
                    ...
                    function l(t, n, i, r) {
                      ...
                      (this._fn = null === s ? n : s.bind(n)),
                        void 0 !== i &&
                          (i = e.resolve(i))._attachCancellationCallback(this),
                        ...
                        (n =
                          void 0 !== i._eachValues
                            ...
                            : o.call(
                                ...
                                this.index,
                                this.length,
                              )) instanceof e && (i._currentCancellable = n);
                      var a = r._popContext();
                      return (
                        s.checkForgottenReturns(
                          n,
              ...
              32: [
                function (t, e, n) {
                  ...
                  e.exports = function (t) {
                    ...
                    (e.prototype.isCancelled = t.prototype._isCancelled =
                      function () {
                        ...
                        if ("function" == typeof u)
                          return (function (t) {
                            ...
                            : (function (t, o, s) {
                                ...
                                function f(t) {
                                  a &&
                                    (a._rejectCallback(t, c, !0), (a = null));
                                }
                                return (
                                  (c = !1),
                                  a &&
                                    l === r &&
                                    (a._rejectCallback(l.e, !0, !0),
                                    (a = null)),
                                  u
                                );
                              })(t, u, a);
                        ...
                        return (
                          void 0 !== r
                            ...
                            : ((o = new e(n)),
                              ...
                              i.cancellation() && o._setOnCancel(new s(u))),
                      ...
                      return (
                        (function o() {
                          ...
                          if (u instanceof e && u._isDisposable()) {
                            ...
                            if (u instanceof e)
                              return u._then(o, f, null, null, null);
                          }
                          o();
                        })(),
                        a
                    ...
                    (d.prototype.data = function () {
                      ...
                      (e.using = function () {
                        ...
                        if ("function" != typeof o)
                          return n(
                            "expecting a function but got " + a.classString(o),
                          );
                        var u = !0;
                        2 === t && Array.isArray(arguments[0])
                          ? ((t = (r = arguments[0]).length), (u = !1))
                          : ((r = arguments), t--);
                        ...
                        var b = e.all(C).then(function (t) {
                            ...
                            var i = u ? o.apply(void 0, t) : o(t),
                              r = E._popContext();
                            return (
                              s.checkForgottenReturns(i, r, "Promise.using", E),
                              i
                            );
                          }),
                          E = b.lastly(function () {
              ...
              36: [
                function (t, e, i) {
                  ...
                  var R =
                    ...
                    "[object process]" === x(process).toLowerCase();
                  function B(t, e) {
            ...
            const n = new Promise(function (n, i) {
              (e.onload = function () {
                200 !== e.status
                  ? i(
                      new Error(
                        `"Received non-ok status code ${e.status} for url ${t}."`,
                      ),
                    )
                  : n(e.response);
              }),
                (e.onerror = ({ loaded: e, total: n }) => {
                  i(
                    new Error(
                      `Error loading ${t}. Loaded ${e} bytes out of ${n}.`,
                    ),
                  );
                });
            });
      ...
      (t, e, n) => {
        ...
        Object.assign(a.prototype, {
          ...
          ready: function () {
            return (
              this._readyPromise ||
                (this._readyPromise = new r.default((t, e) => {
                  try {
                    (this.audioElement = new Audio(this.get("url"))),
                      (this.audioElement.controls = !0),
                      (this.audioElement.loop = this.get("isLoop")),
                      this._attachListeners(),
                      (this.audioElementSource =
                        this.audioContext.createMediaElementSource(
                          this.audioElement,
                        )),
                      this.audioElementSource.connect(this.get("gainNode")),
                      t(this);
                  } catch (t) {
                    e(t);
                  }
          ...
          play: function (t) {
            ...
            return new r.default((t, i) =>
              this.ready()
                ...
                .then(() => {
                  const e = () => (
                    !1 !== n && (this.audioElement.currentTime = n),
                    this._play().then(t)
                  );
                  return !1 === this.options.allowConcurrency &&
                    this.isPlaying()
                    ? this.stop().then(() => e())
                    : e();
                })
          ...
          _play: function () {
            return new r.default((t, e) => {
              try {
                if (this._shouldStop)
                  return t(this), void (this._shouldStop = !1);
                if ((this.audioElement.play(), this.options.fadeIn))
                  return this.fadeIn(this.options, !0);
                this.on("end", () => t(this));
              } catch (t) {
                e(t);
              }
          ...
          pause: function () {
            return new r.default((t) => {
              this.audioElement && this.isPlaying()
                ? (this.audioElement.pause(), t(this))
                : i.logger.warning("Start playback before trying to pause it.");
            });
          },
          _stop: function () {
            return new r.default((t) => {
              if (!this.audioElement || !this.isPlaying())
                return this._startingToPlay
                  ? ((this._shouldStop = !0), t(this))
                  : void 0;
          ...
          fadeOut: function (t) {
            if (!this.isPlaying())
              return (
                this._startingToPlay && (this._shouldStop = !0),
                r.default.resolve(this)
              );
            const {
              fadeFrom: e,
          ...
          dispose: function () {
            return (
              this.audioElement &&
                ...
                (this.audioElementSource = null)),
              this.get("gainNode") &&
                (this.get("gainNode").disconnect(), this.set("gainNode", null)),
              this.purgeEvents(),
              r.default.resolve(this)
            );
          },
          ...
          _onPause: function () {
            if (this.audioElement && !this.audioElement.ended) {
              const { currentTime: t } = this.audioElement;
      ...
      (t, e) => {
        ...
        e.default = class {
          constructor(t, e) {
            (this._name = t),
              (this._api = e),
              (this.soundByUrlMapByChannel = new Map()),
              (this._allSounds = new Set());
          }
          createSound(t, e, n) {
            const i = this._channelArg(t);
            this.soundByUrlMapByChannel.has(i) ||
              this.soundByUrlMapByChannel.set(i, new Map());
          ...
          dispose() {
            this._allSounds.forEach((t) => t.dispose()),
              delete this._allSounds,
              delete this.soundByUrlMapByChannel;
          }
          _channelArg(t) {
      ...
      (t, e, n) => {
        ...
        const o = "/lol-settings/v1/local/lol-audio",
          s = function (t, e) {
            (this._audioPlugin = e),
              (this._dataBinding = i.dataBinding.bindTo(t)),
              this._dataBinding.addObserver(
                o,
                this,
                this._changeSettings.bind(this),
              );
          };
        Object.assign(s.prototype, {
          ...
          _changeSettings: function (t) {
            if (!t || !t.data) return;
            const { data: e } = t;
            this._changeMasterGainNodeSettings(e),
              this._changeSFXSettings(e),
              this._changeMusicSettings(e),
              this._changeVoiceSettings(e);
          },
          ...
          _changeMasterGainNodeSettings(t) {
            !1 === t.masterSoundEnabled
              ? this._audioPlugin.muteAll()
              : void 0 !== t.masterVolume
                ? this._audioPlugin.setMasterVolume(t.masterVolume / 100)
                : this._audioPlugin.unmuteAll();
          },
          _changeSFXSettings(t) {
            !1 === t.sfxEnabled
              ? this._muteChannel(r.SFX_CHANNEL_NAME)
              : void 0 !== t.sfxVolume
                ? this._setChannelVolume(r.SFX_CHANNEL_NAME, t.sfxVolume / 100)
                : this._unmuteChannel(r.SFX_CHANNEL_NAME),
              this._changeAmbientSfxSettings(t);
          },
          _changeAmbientSfxSettings(t) {
            !1 === t.ambientSfxEnabled
              ? this._muteChannel(r.SFX_SUB_CHANNEL_AMBIENCE_NAME)
              : this._unmuteChannel(r.SFX_SUB_CHANNEL_AMBIENCE_NAME);
          },
          _changeMusicSettings(t) {
            !1 === t.musicEnabled
              ? this._muteChannel(r.MUSIC_CHANNEL_NAME)
              : (void 0 !== t.musicVolume
                  ? this._setChannelVolume(
                      r.MUSIC_CHANNEL_NAME,
                      t.musicVolume / 100,
                    )
                  : this._unmuteChannel(r.MUSIC_CHANNEL_NAME),
                this._changeChampionSelectSettings(t),
                this._changeLoginMusicSettings(t),
                this._changeAmbienceMusicSettings(t));
          },
          _changeChampionSelectSettings(t) {
            !1 === t.championSelectionMusicEnabled
              ? this._muteChannel(r.MUSIC_SUB_CHANNEL_CHAMPIONS_NAME)
              : this._unmuteChannel(r.MUSIC_SUB_CHANNEL_CHAMPIONS_NAME);
          },
          _changeLoginMusicSettings(t) {
            !1 === t.loginMusicEnabled
              ? this._muteChannel(r.MUSIC_SUB_CHANNEL_LOGIN_NAME)
              : this._unmuteChannel(r.MUSIC_SUB_CHANNEL_LOGIN_NAME);
          },
          _changeAmbienceMusicSettings(t) {
            !1 === t.ambienceMusicEnabled
              ? this._muteChannel(r.MUSIC_SUB_CHANNEL_AMBIENCE_NAME)
              : this._unmuteChannel(r.MUSIC_SUB_CHANNEL_AMBIENCE_NAME);
          },
          _changeVoiceSettings(t) {
            !1 === t.voiceEnabled
              ? this._muteChannel(r.VOICE_CHANNEL_NAME)
              : (void 0 !== t.voiceVolume
                  ? this._setChannelVolume(
                      r.VOICE_CHANNEL_NAME,
                      t.voiceVolume / 100,
                    )
                  : this._unmuteChannel(r.VOICE_CHANNEL_NAME),
                this._changePickChampVoSettings(t),
                this._changeBanChampVoSettings(t));
          },
          _changePickChampVoSettings(t) {
            !1 === t.pickChampVoEnabled
              ? this._muteChannel(r.VOICE_SUB_CHANNEL_PICK_CHAMP_NAME)
              : this._unmuteChannel(r.VOICE_SUB_CHANNEL_PICK_CHAMP_NAME);
          },
          _changeBanChampVoSettings(t) {
            !1 === t.banChampVoEnabled
              ? this._muteChannel(r.VOICE_SUB_CHANNEL_BAN_CHAMP_NAME)
              : this._unmuteChannel(r.VOICE_SUB_CHANNEL_BAN_CHAMP_NAME);
          },
        });
        var a = s;
        e.default = a;
      ...
      (t, e) => {
        "use strict";
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.VOICE_SUB_CHANNEL_PICK_CHAMP_NAME =
            e.VOICE_SUB_CHANNEL_BAN_CHAMP_NAME =
            e.VOICE_CHANNEL_NAME =
            e.SFX_SUB_CHANNEL_UI_NAME =
            e.SFX_SUB_CHANNEL_NOTIFICATIONS_NAME =
            e.SFX_SUB_CHANNEL_CHAMPIONS_NAME =
            e.SFX_SUB_CHANNEL_AMBIENCE_PERKS_NAME =
            e.SFX_SUB_CHANNEL_AMBIENCE_NAME =
            e.SFX_SUB_CHANNEL_AMBIENCE_INTERRUPTABLE_NAME =
            e.SFX_CHANNEL_NAME =
            e.MUSIC_SUB_CHANNEL_LOGIN_NAME =
            e.MUSIC_SUB_CHANNEL_CHAMPIONS_NAME =
            e.MUSIC_SUB_CHANNEL_AMBIENCE_NAME =
            e.MUSIC_CHANNEL_NAME =
              void 0);
  ...
  (() => {
    "use strict";
    var t,
      e = (t = n(1)) && t.__esModule ? t : { default: t };
        ...
        document.body.appendChild(a),
          o(function (t) {
            ...
            return e.default
              .init(t, {
                dataBinding: (t) =>
                  t.get("rcp-fe-common-libs").getDataBinding("rcp-fe-audio"),
