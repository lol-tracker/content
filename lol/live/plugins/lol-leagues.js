(() => {
  var e = [
      ...
      (e) => {
        ...
        function n(e, t, n) {
          const { regions: s, region: a, locale: i } = e.metadata();
        ...
        e.exports = function (e, s, a) {
          ...
          return (
            ...
            a &&
              ...
              a.register("tra:main", i, { instantiate: !1 }),
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.default = function (e, t, s) {
            const {
                ...
                ProfilesAPI: l,
                RewardTrackerEmberComponents: o,
              } = a.default,
              r = l.getRankedReferenceButton(),
              { PlayerNameComponent: c } = i;
            t.setFactoryDefinition({
              ...
              RankedReferenceModalButtonComponent:
                r.RankedReferenceModalButtonComponent,
            }),
              t.setFactoryDefinition({
              ...
              t.setFactoryDefinition({
                ...
                CareerStatsService:
                  a.default.CareerStatsAPI.getCareerStatsService(),
              });
          });
        var s,
          a = (s = n(1)) && s.__esModule ? s : { default: s };
      },
      (e, t, n) => {
        "use strict";
        var s = n(1),
        ...
        const r = 864e5,
          ...
          u = (0, s.emberDataBinding)({
            ...
            boundProperties: {
              ...
              currentYear: {
                api: "platformConfig",
                path: "/v1/namespaces/LeagueConfig/CurrentYear",
              },
              myRankedStats: {
                api: "ranked",
              ...
              splitsConfig: { api: "ranked", path: "/v1/splits-config" },
              currentSeason: { api: "seasons", path: "/v1/season/product/LOL" },
              ...
              tftSets: { api: "gameData", path: "/assets/v1/tftsets.json" },
        ...
        e.exports = s.Ember.Component.extend(u, {
          ...
          honorLevel: 0,
          rankedService: (0, s.dataBinding)(
            "/lol-ranked",
            (0, s.getProvider)().getSocket(),
          ),
          chatService: (0, s.dataBinding)(
            "/lol-chat",
            (0, s.getProvider)().getSocket(),
          ),
          ...
          init: function () {
            ...
            this.set(
              "leagues",
              s.Ember.Object.create({ apexQueueInfoByQueueAndTier: {} }),
            ),
              this.set("ratedLadderByQueueType", s.Ember.Object.create({})),
              this.set("selectedState", s.Ember.Object.create()),
              e.observe("/v1/friends", this, this._handleFriendsData);
          },
          ...
          summonerReadyChanged: s.Ember.observer("summonerReady", function () {
            ...
            if (!e) return;
            const l = this.get("currentSummoner");
            this.set("viewerId", l.summonerId),
              n && this.set("honorLevel", n.honorLevel),
              t && l.summonerId !== t
                ? a.observe(i, this, this._handleSummonerLeaguesData)
                : (this.set("summonerId", l.summonerId),
                  this.set("puuid", l.puuid),
                  a.observe(
                    "/v1/current-ranked-stats",
                    this,
                    this._handleCurrentRankedStatsUpdate,
                  ));
          }),
          ...
          _handleSummonerLeaguesData: function (e) {
            if (!e) return;
            if (
              !this.get("isViewingLocalSummoner") &&
              this.leagueTierNames.isApexForQueue(e[0])
            ) {
              let t = e[0];
              this._cacheApexQueueInfo(t, t.queueType, t.tier),
                (t = this._getCachedApexLeagues(t.queueType));
            }
            const t = this.enrichSummonerLeaguesData(e);
            e &&
              e[0].queueType &&
              this.set("highestRankedQueueType", e[0].queueType),
              this.set("leagues.summonerLeagues", t),
              this.set("isLoading", !1);
          },
          _handleApexQueueInfoData: function (e, t, n) {
            return e
              ? (this._cacheApexQueueInfo(e, t, n),
                (e.divisions = this._getCachedApexLeagues(t)),
                Promise.resolve(this.enrichSummonerLeaguesData([e], !0)).then(
                  (e) => e,
                ))
              : Promise.resolve();
          },
          _cacheApexQueueInfo: function (e, t, n) {
            if (this.get(`leagues.apexQueueInfoByQueueAndTier.${t}`))
              this.set(`leagues.apexQueueInfoByQueueAndTier.${t}.${n}`, e);
            else {
              const s = {};
              (s[n] = e),
                this.set(`leagues.apexQueueInfoByQueueAndTier.${t}`, s);
            }
          },
          _getCachedApexLeagues: function (e) {
            const t = this.get(`leagues.apexQueueInfoByQueueAndTier.${e}`);
            return Object.keys(t).map((e) =>
              (t[e].divisions || []).find((t) => t && t.tier === e),
            );
          },
          _handleFriendsData: function (e) {
            e &&
              this.set(
                "friendsIdSet",
                new Set(s.Lodash.map(e, (e) => e.summonerId)),
              );
          },
          defaultLeagueObserver: s.Ember.observer(
            "isLoading",
            ...
            function () {
              ...
              const e = this.get("leagues.summonerLeagues"),
                t =
                  this.get("highestRankedQueueType") ||
                  this.get("leaguesQueues.0"),
                n = s.Lodash.find(e, { queueType: t });
              n && this._selectLeague(n);
            },
          ),
          _selectLeague: function (e, t) {
            this.set("spectatableSummonerNames", []),
              this.set("spectatableSummonerIds", []);
            ...
            this.get("selectedState").setProperties({
              ...
              standing: a,
              isViewingTopPlayers:
                t || (n && !this.get("isViewingLocalSummoner")),
              isViewingApexTier: n,
            ...
            return (
              (n = t
                ? s.Lodash.find(e.divisions, {
                    tier:
                      (e.requestedRankedEntry && e.requestedRankedEntry.tier) ||
                      e.tier,
                  })
                : s.Lodash.find(e.divisions, {
                    division:
                      e.requestedRankedEntry && e.requestedRankedEntry.division,
                  })),
              n || (n = e.divisions[0]),
              n
            );
          ...
          _applyRelationship: function (e) {
            ...
            let a = null;
            s && s.has(t) && (a = i.StandingRelationship.FRIEND),
              e.set("relationship", n === t ? i.StandingRelationship.SELF : a);
          },
          _fillInDivisions: function (e, t) {
            ...
            return (
              t
                ? ((a = s.LeaguesConsts.APEX_TIERS.slice()), (i = "tier"))
                : ((a = s.LeaguesConsts.DIVISIONS.slice()), (i = "division")),
              a.forEach((a) => {
                let l,
                  o,
                  r = s.Lodash.filter(e.divisions, (e) => e && e[i] === a)[0];
                t ? ((o = a), (l = "I")) : ((o = e.tier), (l = a)),
                  r || (r = { division: l, tier: o, standings: [] }),
                  n.push(r);
              }),
              n
            );
          ...
          enrichSummonerLeaguesData: function (e, t) {
            const n = this.get("leaguesQueueOrders"),
              ...
              i = s.Lodash.each(a, (e) => {
                ...
                if (
                  ((e.queueTypeDisplay = t
                    ? this.get("tra").formatString("LEAGUES_DROPDOWN_APEX", {
                        queueType: this.leagueTierNames.getRankedQueueName(
                          e.queueType,
                        ),
                      })
                  ...
                  for (let t = 0; t < e.divisions.length; t++) {
                    ...
                    (n.position = t),
                      (n.standings = this.arrayToEmberObjects(n.standings)),
                      n.standings.forEach((e) => {
          ...
          arrayToEmberObjects: (e) =>
            s.Lodash.map(e, (e) => s.Ember.Object.create(e)),
          ...
          _enrichSpectateAvailability: function (e) {
            const t = this._getSummonerStandingsForSpecificApexTier(
              e.divisions,
              e.tier,
            );
            this.get("spectateBySummonerIdEnabled")
              ? this.get("spectatorService")
                  .availableForSpectateBySummonerIds(t.map((e) => e.summonerId))
                  .then((t) => {
                    const n = this.get("selectedState");
                    n.league.queueType === e.queueType &&
                      n.league.tier === e.tier &&
                      this.set("spectatableSummonerIds", t);
                  })
              : this.get("spectatorService")
                  .availableForSpectateBySummonerNames(
                    t.map((e) => e.summonerName),
                  )
                  .then((t) => {
                    const n = this.get("selectedState");
                    n.league.queueType === e.queueType &&
                      n.league.tier === e.tier &&
                      this.set("spectatableSummonerNames", t);
                  });
          },
          ...
          _animateLeagueChange: function () {
            ...
            e &&
              (this.set("animationClass", "popup"),
              e.on("animationend", () => {
                e.off("animationend"), this.set("animationClass", "");
              }));
          },
          isAnimationEnabled: s.Ember.computed(
            "uxSettings.data.potatoModeEnabled",
            function () {
              return !this.get("uxSettings.data.potatoModeEnabled");
            },
          ),
          bannerProperties: s.Ember.computed(
            "selectedState.standing.puuid",
            "selectedState.league.queueType",
            "selectedState.standing.wins",
            "selectedState.standing.losses",
            "selectedState.division.division",
            "selectedState.division.tier",
            "selectedState.standing.division",
            "selectedState.standing.tier",
            "selectedState.league.tier",
            "selectedState.league.provisionalGameThreshold",
            "selectedState.standing.provisionalGamesRemaining",
            "selectedState.standing.isProvisional",
            "selectedState.standing.points",
            "selectedState.standing.position",
            function () {
              const e =
                  this.get("selectedState.standing.wins") +
                  this.get("selectedState.standing.losses"),
                t = this.get("selectedState.standing.isProvisional"),
                n =
                  this.get("selectedState.standing.tier") ||
                  this.get("selectedState.division.tier") ||
                  this.get("selectedState.league.tier");
              return {
                puuid: this.get("selectedState.standing.puuid"),
                queueType: this.get("selectedState.league.queueType"),
                tier: n,
                division:
                  this.get("selectedState.standing.division") ||
                  this.get("selectedState.division.division"),
                leaguePoints: this.get("selectedState.standing.leaguePoints"),
                miniseries: this.get(
                  "selectedState.standing.miniseriesResults",
                ),
                ladderRank: this.get("selectedState.standing.position"),
                games: e,
                isProvisional: t,
                provisionalGameThreshold: this.get(
                  "selectedState.league.provisionalGameThreshold",
                ),
                provisionalGamesRemaining: this.get(
                  "selectedState.standing.provisionalGamesRemaining",
                ),
              };
            },
          ),
          showingPlayerNotRanked: s.Ember.computed(
            "selectedState.league",
            "selectedState.isViewingTopPlayers",
            "selectedState.isViewingRatedLadder",
            function () {
              ...
              return (
                !e ||
                (!this.get("selectedState.league.requestedRankedEntry") && !t)
              );
            },
          ),
          showingRewards: s.Ember.computed(
            "isViewingLocalSummoner",
            "splitsConfig.currentSplit",
            "rewardsProgress",
            "isViewingCherry",
            function () {
          ...
          isShowingSplitEndCountdown: s.Ember.computed(
            "showingRewards",
            "isViewingTft",
            function () {
          ...
          splitTimeRemainingText: s.Ember.computed(
            "splitsConfig.currentSplit.endTimeMillis",
            function () {
              const e =
                  this.get("splitsConfig.currentSplit.endTimeMillis") -
                  Date.now(),
                t = this.get("tra");
              if (!t) return "";
          ...
          isViewingTft: s.Ember.computed("selectedState.league", function () {
            return (0, l.isTftQueueType)(
              this.get("selectedState.league.queueType"),
            );
          }),
          isViewingCherry: s.Ember.computed(
            "selectedState.league",
            function () {
              return "CHERRY" === this.get("selectedState.league.queueType");
            },
          ),
          nextUpdateMillis: s.Ember.computed(
            "selectedState.league.nextApexUpdateMillis",
            "selectedState.league.nextRatedUpdateMillis",
            function () {
              const e = this.get("selectedState.league") || {};
              return e.nextApexUpdateMillis || e.nextRatedUpdateMillis;
            },
          ),
          seasonNameText: s.Ember.computed(
            "isViewingCherry",
            "isViewingTft",
            "tftSets",
            "currentYear",
            "currentSeason.metadata.currentSplit",
            function () {
              const e = this.get("tra");
              if (this.get("isViewingCherry"))
                return this.get("tra.QUEUE_NAME_CHERRY");
              if (this.get("isViewingTft"))
                return this.get("tftSets").LCTFTModeData.mDefaultSet
                  .SetDisplayName;
              {
                const t = this.get("currentYear"),
          ...
          viewedSummonerId: s.Ember.computed(
            "summonerId",
            "currentSummoner.summonerId",
            function () {
              return (
                this.get("summonerId") || this.get("currentSummoner.summonerId")
              );
            },
          ),
          isViewingLocalSummoner: s.Ember.computed(
            "currentSummoner.summonerId",
            "summonerId",
            function () {
              return (
          ...
          _selectLeagueType: function (e, t) {
            switch (
              (this.get("leagueTypeSelected") !== e &&
                this.set("leagueTypeSelected", e),
              e)
            ) {
              case "unranked":
              ...
              case "rated":
                ...
                break;
              case "summoner": {
                const e = this.get("leagues.summonerLeagues").find(
                  (e) => e.queueType === t,
                );
          ...
          _requestApexData: function (e, t) {
            ...
            return n
              ? Promise.resolve(this._handleApexQueueInfoData(n, e, t))
              : this.rankedService
                  .get(`/v1/apex-leagues/${e}/${t}`, { skipCache: !0 })
                  .then((n) => this._handleApexQueueInfoData(n, e, t));
          },
          _requestAndSelectApexLeague: function (
            e = "RANKED_SOLO_5x5",
            t = "CHALLENGER",
          ) {
          ...
          _requestRatedLadderInfo: function (e) {
            ...
            n && n > 0
              ? this._handleRatedLadderInfo(t, e)
              : this.rankedService
                  .get(`/v1/rated-ladder/${e}`, { skipCache: !0 })
                  .then((t) => {
                    const n = new Date().getTime();
                    (t.nextRatedUpdateMillis =
                      n +
                      (i.RATED_LADDER_REFRESH_TIME_MILLIS -
                        (n % i.RATED_LADDER_REFRESH_TIME_MILLIS))),
                      this._handleRatedLadderInfo(t, e);
                  });
          },
          ...
          faqText: s.Ember.computed("isViewingTft", function () {
            return this.get("isViewingTft")
              ? this.get("tra.LEAGUES_FAQ_LINK_LABEL_TFT")
              : this.get("tra.LEAGUES_FAQ_LINK_LABEL");
          }),
          faqUrl: s.Ember.computed("isViewingTft", function () {
            return this.get("isViewingTft")
              ? this.get("tra.LEAGUES_FAQ_LINK_URL_TFT")
              : this.get("tra.LEAGUES_FAQ_LINK_URL");
          }),
          actions: {
      ...
      (e, t) => {
        ...
        var _ = {
          ...
          ALL_RATED_QUEUE_TYPES: E,
          ALL_RANKED_AND_RATED_QUEUE_TYPES: [...f, ...E],
        };
        t.default = _;
      },
      (e, t) => {
      ...
      (e, t) => {
        ...
        var o = { TIME_UNITS: n, TIME_CONVERSIONS: l };
        t.default = o;
      },
      (e, t, n) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.StandingRelationship =
            t.SUMMONER_QUEUE_ORDER =
            t.SUMMONER_ICON_REWARD_TYPE =
            t.SEASON_YEAR_BASE =
            t.RATED_LADDER_REFRESH_TIME_MILLIS =
            t.PROMOTE_COUNTDOWN_INTERVAL_MS =
            t.PROFILE_STATS_SUBSECTION_ID =
            t.PROFILE_RANKED_SUBSECTION_ID =
            t.LP_SPLASH_LOSS_SCORE_REASON =
            t.LP_SPLASH_BONUS_REASONS =
            t.LOTTIE_JSON_PATH =
        ...
        t.LP_SPLASH_BONUS_REASONS = [
          "SPLASHING_SECONDARY_WIN",
          "SPLASHING_FILL_WIN",
          "SPLASHING_AUTOFILL_WIN",
        ];
      ...
      (e, t, n) => {
        ...
        n(28),
          (e.exports = s.Ember.Component.extend({
            ...
            layout: n(29),
            leagueTierNames: s.LeagueTierNames,
            isValidDaysUntilDecay: s.Ember.computed(
              "daysUntilDecay",
              function () {
            ...
            daysUntilDecay: s.Ember.computed(
              "league",
              "myRankedStats",
              "isViewingApexTier",
              function () {
                ...
                for (const e of t.queues)
                  if (
                    e.queueType === s &&
                    this.leagueTierNames.isApexForQueue(e) === n &&
                    e.warnings
                  )
                    return e.warnings.daysUntilDecay;
                return null;
              },
            ),
            shouldDisplayDecayWarningInDays: s.Ember.computed(
              "isValidDaysUntilDecay",
              "shouldDisplayDecayWarningInCountdownTimer",
              function () {
            ...
            decayWarningText: s.Ember.computed(
              "daysUntilDecay",
              "isViewingApexTier",
              function () {
                const e = this.get("daysUntilDecay");
                return this.get("isViewingApexTier") && e <= 0
                  ? this.get("tra.RANKED_DECAY_NEXT_UPDATE")
                  : this.get("tra.RANKED_DECAY_GENERIC");
              },
            ),
            decayWarningDaysRemaining: s.Ember.computed(
              "daysUntilDecay",
              function () {
                const e = this.get("daysUntilDecay");
                return e > 0
                  ? this.get("tra").formatString("RANKED_DAYS", { days: e })
                  : "";
              },
            ),
            shouldDisplayDecayWarningInCountdownTimer: s.Ember.computed(
              "isValidDaysUntilDecay",
              "daysUntilDecay",
              "isViewingApexTier",
              function () {
            ...
            countdownLabel: s.Ember.computed(
              "shouldDisplayDecayWarningInCountdownTimer",
              "decayWarningText",
              function () {
                return this.get("shouldDisplayDecayWarningInCountdownTimer")
                  ? this.get("decayWarningText")
                  : this.get("tra.RANKED_NEXT_LADDER_UPDATE_COUNTDOWN_LABEL");
              },
            ),
            isDecayUrgent: s.Ember.computed(
              "isValidDaysUntilDecay",
              "daysUntilDecay",
              function () {
                const e = this.get("isValidDaysUntilDecay"),
            ...
            shouldCountdownTimerBeUrgent: s.Ember.computed(
              "isDecayUrgent",
              "shouldDisplayDecayWarningInCountdownTimer",
              function () {
            ...
            shouldDisplayCountdownTimer: s.Ember.computed(
              "isViewingApexTier",
              "isViewingRatedLadder",
              "shouldDisplayDecayWarningInCountdownTimer",
              "nextUpdateMillis",
              function () {
      ...
      (e, t, n) => {
        ...
        n(34),
          (e.exports = s.Ember.Component.extend({
            ...
            init: function () {
              this._super(...arguments);
              this.get("rankedService").observe(
                "/v1/current-ranked-stats",
                this,
            ...
            didReceiveAttrs: function () {
              ...
              e
                ? (this.get("displayedPuuid") === e &&
                    this.get("displayedQueueType") === t) ||
                  (this.set("displayedPuuid", e),
                  this.set("displayedQueueType", t),
                  this.fetchRankedData())
                : (this.set("displayedPuuid", e),
                  this.set("displayedQueueType", t),
                  this.set("displayedTier", this.get("tier")),
                  this.set("displayedDivision", this.get("division")),
                  this.set("displayedRegaliaLevel", 0),
                  this.set("displayedPreviousTier", ""));
            },
            willDestroyElement: function () {
              this._super(...arguments);
            ...
            setRankedData(e, t, n) {
              e &&
                ...
                this.get("displayedPuuid") === e &&
                this.get("displayedQueueType") === t &&
                (n && n.rankedRegaliaLevel
                  ? this.set("displayedRegaliaLevel", n.rankedRegaliaLevel)
                  : this.set("displayedRegaliaLevel", 0),
                n.queueMap &&
                n.queueMap[t] &&
                n.queueMap[t].previousSeasonAchievedTier &&
                n.queueMap[t].previousSeasonAchievedTier !==
                  s.LeaguesConsts.TIER_NAME_NONE
                  ? this.set(
                      "displayedPreviousTier",
                      n.queueMap[t].previousSeasonAchievedTier,
                    )
                ...
                n.queueMap[t] &&
                n.queueMap[t].tier &&
                n.queueMap[t].tier !== s.LeaguesConsts.TIER_NAME_NONE
                  ? this.set("displayedTier", n.queueMap[t].tier)
                  : this.set("displayedTier", ""),
                n.queueMap && n.queueMap[t] && n.queueMap[t].division
                  ? this.set("displayedDivision", n.queueMap[t].division)
                  : this.set("displayedDivision", ""));
            },
            layout: n(35),
            unranked: s.Ember.computed("tier", "displayedTier", function () {
              ...
              return (
                !e ||
                e === s.LeaguesConsts.TIER_NAME_UNRANKED ||
                e === s.LeaguesConsts.TIER_NAME_NONE ||
                !t ||
                t === s.LeaguesConsts.TIER_NAME_UNRANKED ||
                t === s.LeaguesConsts.TIER_NAME_NONE
              );
            }),
            hasApexLadderRank: s.Ember.computed(
              "tier",
              "ladderRank",
              function () {
                return (
                  s.LeaguesConsts.APEX_TIERS.includes(this.get("tier")) &&
                  this.get("ladderRank")
                );
              },
            ),
            ...
            provisionalGamesProgressText: s.Ember.computed(
            ...
            apexLadderRank: s.Ember.computed(
              "tra",
              "hasApexLadderRank",
              "ladderRank",
              function () {
                return this.get("tra").formatString(
                  "LEAGUES_BANNER_APEX_LADDER_RANK",
                  { ladderRank: this.get("ladderRank") },
                );
              },
            ),
            showLeaguePoints: s.Ember.computed(
              "unranked",
              "leaguePoints",
              function () {
                return (
                  "number" == typeof this.get("leaguePoints") &&
                  !this.get("unranked")
                );
              },
            ),
            leaguePointsString: s.Ember.computed(
              "leaguePoints",
              "tier",
              function () {
                const e = s.LeaguesConsts.APEX_TIERS.includes(this.get("tier"))
                  ? this.get("leaguePoints")
                  : Math.min(100, this.get("leaguePoints"));
                return this.leagueTierNames.getLpLoc(e);
              },
            ),
            tierDivisionLabel: s.Ember.computed(
              "tier",
              "division",
              function () {
                const e = this.get("tier"),
      ...
      (e, t, n) => {
        ...
        e.exports = s.Ember.Component.extend({
          ...
          rankedIntroSections: s.Ember.computed(
            "queueType",
            "league.isPositionRanks",
            "tra",
            "tra.RANKED_INTRO_RANKED_SOLO_5x5_SECTION_1_TITLE",
            "tra.RANKED_INTRO_RANKED_SOLO_5x5_SECTION_1_BODY",
            "tra.RANKED_INTRO_RANKED_FLEX_SR_SECTION_1_TITLE",
            "tra.RANKED_INTRO_RANKED_FLEX_SR_SECTION_1_BODY",
            "tra.RANKED_INTRO_RANKED_FLEX_TT_SECTION_1_TITLE",
            "tra.RANKED_INTRO_RANKED_FLEX_TT_SECTION_1_BODY",
            "tra.RANKED_INTRO_SECTION_2_TITLE",
            "tra.RANKED_INTRO_SECTION_2_BODY",
            "tra.RANKED_INTRO_SECTION_3_TITLE",
            "tra.RANKED_INTRO_SECTION_3_BODY",
            function () {
              const e = this.get("queueType");
              return [
                {
                  titleString: this.get(
                    `tra.RANKED_INTRO_${e}_SECTION_1_TITLE`,
                  ),
                  bodyString: this.get(`tra.RANKED_INTRO_${e}_SECTION_1_BODY`),
                  imageSource:
                    a.ASSET_PATH + "images/ranked-intro-squad-up.jpg",
                },
                {
                  titleString: this.get("tra.RANKED_INTRO_SECTION_2_TITLE"),
                  bodyString: this.get("tra.RANKED_INTRO_SECTION_2_BODY"),
                  imageSource:
                    a.ASSET_PATH + "images/ranked-intro-earn-rank.png",
                },
                {
                  titleString: this.get("tra.RANKED_INTRO_SECTION_3_TITLE"),
                  bodyString: this.get("tra.RANKED_INTRO_SECTION_3_BODY"),
                  imageSource:
                    a.ASSET_PATH + "images/ranked-intro-epic-loot.jpg",
                },
              ];
            },
          ),
      ...
      (e, t, n) => {
        ...
        n(40),
          (e.exports = s.Ember.Component.extend({
            ...
            activeTabIndex: s.Ember.computed(
              "selectedState.division.position",
              function () {
                const e = this.get("selectedState.division.position");
                return e || 0;
              },
            ),
            leagueStandings: s.Ember.computed.readOnly(
              "selectedState.division.standings",
            ),
            isViewingRatedLadder: s.Ember.computed.readOnly(
              "selectedState.isViewingRatedLadder",
            ),
            ratedLadderStandings: s.Ember.computed.readOnly(
              "selectedState.league.standings",
            ),
            displayedStandings: s.Ember.computed(
              "leagueStandings",
              "isViewingRatedLadder",
              "ratedLadderStandings",
              function () {
                return this.get("isViewingRatedLadder")
                  ? this.get("ratedLadderStandings")
                  : this.get("leagueStandings");
              },
            ),
            ...
            _activateTab: function (e) {
              ...
              if (t !== e) {
                ...
                this.set(
                  "animationClass",
                  t > e ? "left-to-right-fade-out" : "right-to-left-fade-out",
                ),
                  n.on("animationend", () => {
                    const s = this._divisionAtIndex(e);
                    this.sendAction("selectDivision", s),
                      n.off("animationend"),
                      this.set(
                        "animationClass",
                        t > e
      ...
      (e, t, n) => {
        ...
        n(43),
          (e.exports = s.Ember.Component.extend({
            ...
            layout: n(44),
            containsPlayer: s.Ember.computed(
              "leagueDivisionInfo.standings",
              function () {
                return !s.Lodash.isEmpty(
                  s.Lodash.find(this.get("leagueDivisionInfo.standings"), {
            ...
            text: s.Ember.computed(
              "tra",
              "leagueDivisionInfo.tier",
              "leagueDivisionInfo.division",
              function () {
                return s.LeaguesConsts.APEX_TIERS.includes(
                  this.get("leagueDivisionInfo.tier"),
                )
                  ? s.LeagueTierNames.getTierName(
                      this.get("leagueDivisionInfo.tier"),
                    )
                  : s.LeagueTierNames.getDivisionName(
                      this.get("leagueDivisionInfo.division"),
                    );
              },
            ),
            ...
            playerDivisionStyle: s.Ember.computed(
              "containsPlayer",
              function () {
                return this.get("containsPlayer") ? "player-division" : null;
              },
            ),
            selectedStateDidChange: s.Ember.on(
              "init",
              s.Ember.observer("selectedDivision", function () {
                this.get("leagueDivisionInfo") &&
                  this.set(
                    "activeIndex",
                    this.get("selectedDivision.position"),
                  );
              }),
            ),
            click: function () {
              this.get("isViewingTopPlayers")
                ? (this.sendAction("playClickAudio"),
                  this.get("onSelectApexLeague")(
                    this.get("queueType"),
                    this.get("leagueDivisionInfo.tier"),
                  ))
                : this.sendAction("onBtnClick", this.get("btnIndex"));
            },
          }));
      },
      (e, t, n) => {
      ...
      (e, t, n) => {
        ...
        if (s.AudioPlugin) {
          ...
          i = e.createSound(
            `${a.ASSET_PATH}sounds/sfx-uikit-button-text-click.ogg`,
          );
        }
        e.exports = s.Ember.Component.extend({
          classNames: [
            "rank-standing-header-component",
            "lol-leagues-division-wrapper",
          ],
          layout: n(47),
          activeIndex: null,
          hasDivision: s.Ember.computed("league.tier", function () {
            return !s.LeaguesConsts.APEX_TIERS.includes(
              this.get("league.tier"),
            );
          }),
          divisionExistenceObserver: s.Ember.observer(
            "hasDivision",
            function () {
          ...
          localizedTier: s.Ember.computed(
            "selectedState.league.tier",
            function () {
              return s.LeagueTierNames.getTierName(
                this.get("selectedState.league.tier"),
              );
            },
          ),
      ...
      (e, t, n) => {
        ...
        e.exports = s.Ember.Component.extend({
          classNames: [
            "rank-standing-list-component",
            "lol-leagues-list-wrapper",
          ],
          layout: n(51),
          ...
          isRatedQueue: s.Ember.computed(
            "selectedState.league.queueType",
            function () {
              return l.QUEUES.ALL_RATED_QUEUE_TYPES.includes(
                this.get("selectedState.league.queueType"),
              );
            },
          ),
          ...
          isApexTierNotMaxSize: s.Ember.computed(
            "selectedState.isViewingApexTier",
            "standings.[]",
            "selectedState.division.maxLeagueSize",
            function () {
              const e = this.get("selectedState.isViewingApexTier"),
                t = this.get("selectedState.division.topNumberOfPlayers") > 0,
                n =
                  this.get("standings.length") <
                  this.get("selectedState.division.maxLeagueSize");
              return e && t && n;
            },
          ),
          isEmptyDivisionOrNotFullApexTier: s.Ember.computed.or(
            "divisionIsEmpty",
            "isApexTierNotMaxSize",
          ),
          hasApexUnlockTimeInTheFuture: s.Ember.computed(
            "selectedState.division.apexUnlockTimeMillis",
            function () {
              return (
                this.get("selectedState.division.apexUnlockTimeMillis") >
                Date.now()
              );
            },
          ),
          divisionOrTierEmptyText: s.Ember.computed(
            "divisionIsEmpty",
            "selectedState.isViewingApexTier",
            "selectedState.division.tier",
            "selectedState.division.apexUnlockTimeMillis",
            "selectedState.division.minLpForApexTier",
            "selectedState.division.topNumberOfPlayers",
            function () {
              if (!this.get("selectedState.isViewingApexTier"))
                return this.get("tra.LEAGUES_DIVISION_EMPTY_MSG");
              const e = this.get("selectedState.division.apexUnlockTimeMillis"),
                ...
                i = Date.now(),
                l = this.get("tra"),
                o = this.get("selectedState.division.tier"),
                r = s.LeagueTierNames.getTierName(o);
              if (e > i) {
                const t = (0, a.timeInMillisToDays)(e - i);
                return l.formatString("LEAGUES_APEX_TIER_LOCKED_UNTIL", {
                  tier: r,
                  daysUntilUnlock: t,
                });
              }
              return t && n
                ? l.formatString("LEAGUES_APEX_TIER_UNLOCKED_EMPTY_MIN_LP", {
                    minLpForTier: t,
                    topNumberOfPlayers: n,
                  })
                : n
                  ? l.formatString(
                      "LEAGUES_APEX_TIER_UNLOCKED_EMPTY_TOP_NUMBER_OF_PLAYERS",
                      { topNumberOfPlayers: n },
                    )
                  : l.formatString("LEAGUES_APEX_TIER_UNLOCKED_EMPTY", {
                      tier: r,
                    });
            },
          ),
          rows: s.Ember.computed(
            "standings",
            "downOneTierStandings",
            "upOneTierStandings",
            "leagueContext.tier",
            "selectedState.division.division",
            "selectedState.isViewingApexTier",
            function () {
              ...
              if (e)
                (t = this.addPromotionDemotionCutoffs(t)),
                  t.splice(0, 0, s.Ember.Object.create({ isHeader: !0 }));
              else {
                const e = s.Lodash.findIndex(
                  t,
                  (e) => !s.Lodash.get(e, "miniseriesResults.length") > 0,
                );
                e < 0
                  ? t.splice(0, 0, s.Ember.Object.create({ isHeader: !0 }))
                  : 0 === e
                    ? t.splice(
                        0,
                        0,
                        s.Ember.Object.create({ isSecondHeader: !0 }),
                      )
                    : (t.splice(0, 0, s.Ember.Object.create({ isHeader: !0 })),
                      t.splice(
                        e + 1,
          ...
          addPromotionDemotionCutoffs(e) {
            const { hasPromotionCutoff: t, promotionCutoffIndex: n } =
              this.findPromotionCutoffIndex(e);
            if (t) {
              const t = this.get(
                "tra.LEAGUES_PROFILE_TABLE_HEADER_PROMOTION_CUTOFF",
              );
              e.splice(
                n + 1,
                0,
            ...
            const { hasDemotionCutoff: a, demotionCutoffIndex: i } =
              this.findDemotionCutoffIndex(e);
            if (a) {
              const t = this.get(
                "tra.LEAGUES_PROFILE_TABLE_HEADER_DEMOTION_CUTOFF",
              );
              e.splice(
                i,
                0,
          ...
          findPromotionCutoffIndex(e) {
            let t = !1,
              n = 0;
            for (let s = 0; s < e.length && e[s].pendingPromotion; s++)
              (t = !0), (n = s);
            return { hasPromotionCutoff: t, promotionCutoffIndex: n };
          },
          findDemotionCutoffIndex(e) {
            let t = !1,
              n = e.length;
            for (let s = e.length - 1; s >= 0 && e[s].pendingDemotion; s--)
              (t = !0), (n = s);
            return { hasDemotionCutoff: t, demotionCutoffIndex: n };
          },
          ...
          headerData: s.Ember.computed("rows", function () {
            return s.Lodash.find(this.get("rows"), { isHeader: !0 });
          }),
          secondaryHeaderData: s.Ember.computed("rows", function () {
            return s.Lodash.find(this.get("rows"), { isSecondHeader: !0 });
          }),
          playerHeaderText: s.Ember.computed("isTft", function () {
            return this.get("isTft")
              ? this.get("tra.LEAGUES_PROFILE_TABLE_HEADER_TACTICIANS")
              : this.get("tra.LEAGUES_PROFILE_TABLE_HEADER_SUMMONERS");
          }),
      ...
      (e, t, n) => {
        ...
        if (s.AudioPlugin) {
          const e = s.AudioPlugin.getChannel("sfx-ui");
          o = e.createSound(
            `${a.ASSET_PATH}sounds/sfx-uikit-click-generic.ogg`,
          );
        }
        e.exports = s.Ember.Component.extend({
          tagName: "li",
          ...
          classNameBindings: [
            ...
            "selfStyle",
            "currentStyle",
            "data.isApexTierCutoff:apex-cutoff",
          ],
          ...
          isSecondaryHeader: s.Ember.computed(
            "data.isSecondHeader",
            function () {
              return Boolean(this.get("data.isSecondHeader"));
            },
          ),
          secondaryHeaderStyle: s.Ember.computed(
            "isSecondaryHeader",
            function () {
              return this.get("isSecondaryHeader")
                ? "lol-leagues-list-header second-header"
                : null;
            },
          ),
          ...
          currentStyle: s.Ember.computed(
            "selectedStanding.summonerId",
            "data.summonerId",
            function () {
              if (
                this.get("selectedStanding.summonerId") ===
                this.get("data.summonerId")
              )
                return "current";
            },
          ),
          isTopSummoner: s.Ember.computed(
            "data.miniseriesResults",
            "data.summonerName",
            "isViewingApexTier",
            function () {
              return (
                this.get("data.miniseriesResults.length") > 0 &&
                Boolean(this.get("data.summonerName")) &&
                !this.get("isViewingApexTier")
              );
            },
          ),
          isViewingApexTier: s.Ember.computed(
            "leagueDivisionInfo.tier",
            function () {
              return s.LeaguesConsts.APEX_TIERS.includes(
                this.get("leagueDivisionInfo.tier"),
          ...
          isTopTierStandingRow: s.Ember.computed(
            "isViewingApexTier",
            "isHeader",
            "isSecondaryHeader",
            "data.isApexTierCutoff",
            function () {
              return (
                this.get("isViewingApexTier") &&
                !this.get("isHeader") &&
                !this.get("isSecondaryHeader") &&
                !this.get("data.isApexTierCutoff")
              );
            },
          ),
          isNonTopTierStandingRow: s.Ember.computed(
            "data.puuid",
            "isTopSummoner",
            "isViewingApexTier",
            function () {
              return (
                Boolean(this.get("data.puuid")) &&
                !this.get("isTopSummoner") &&
                !this.get("isViewingApexTier")
              );
            },
          ),
          ...
          hasPositionDelta: s.Ember.computed("data.positionDelta", function () {
            return (
              this.get("data.positionDelta") &&
              0 !== this.get("data.positionDelta")
            );
          }),
          divisionChangeStyle: s.Ember.computed(
            "data.pendingDemotion",
            "data.pendingPromotion",
            function () {
              return this.get("data.pendingDemotion")
                ? "lol-leagues-icon-demotion"
                : this.get("data.pendingPromotion")
                  ? "lol-leagues-icon-promotion"
                  : "";
            },
          ),
          positionDeltaStyle: s.Ember.computed(
            "data.positionDelta",
            function () {
              return this.get("data.positionDelta") > 0
                ? "lol-leagues-list-up"
                : this.get("data.positionDelta") < 0
                  ? "lol-leagues-list-down"
                  : void 0;
            },
          ),
          ...
          isAvailableForSpectate: s.Ember.computed(
            "data.summonerName",
            "spectatableSummonerNames",
            "spectatableSummonerIds",
            "spectateBySummonerIdEnabled",
            "spectatorService.spectateEnabled",
            function () {
              ...
              if (this.get("spectateBySummonerIdEnabled")) {
                ...
                return (
                  e && e.includes && e.includes(this.get("data.summonerId"))
                );
              }
              {
                const e = this.get("spectatableSummonerNames");
                return (
                  e && e.includes && e.includes(this.get("data.summonerName"))
                );
              }
            },
          ),
          isFriend: s.Ember.computed("data.relationship", function () {
            return (
              this.get("data.relationship") === a.StandingRelationship.FRIEND
            );
          }),
          isSelf: s.Ember.computed("data.relationship", function () {
            return (
              this.get("data.relationship") === a.StandingRelationship.SELF
            );
          }),
          isSelectedSummoner: s.Ember.computed(
            "data.summonerId",
            "summonerId",
            function () {
          ...
          selfStyle: s.Ember.computed("data.relationship", function () {
            if (this.get("data.relationship") === a.StandingRelationship.SELF)
              return "me";
          }),
          miniseriesStyles: s.Ember.computed(
            "data.miniseriesResults",
            function () {
              return s.Lodash.map(
                this.get("data.miniseriesResults"),
                (e) => `lol-leagues-list-best-${e}`,
              );
            },
          ),
          isTft: s.Ember.computed("leagueContext.queueType", function () {
            ...
            this.get("modalManager")
              .add({
                ...
                data: {
                  contents: l({
                    title: this.get(
                      "tra.LEAGUES_SPECTATE_IS_NOT_AVAILABLE_TITLE",
                    ),
          ...
          click: function () {
            this.get("isSecondaryHeader") ||
              this.get("isHeader") ||
              (o && o.play(), this.sendAction("onRowClick", this.get("data")));
          },
          _setupContextMenu: function () {
            this.get("showContextMenu") &&
              this.$().on("contextmenu", (e) => {
                ...
                t.setMenuItems([
                  ...
                  },
                  {
                    ...
                    target: this,
                    disabled:
                      this.get("isSelf") || this.get("isSelectedSummoner"),
                    action: function () {
                  ...
                  },
                  {
                    ...
                    action: async function () {
                      ...
                      (await s.ProfilesAPI.hasPrivateProfile(e))
                        ? s.ProfilesAPI.showAlertSummonerIsPrivate(t)
                        : this.get("spectatorService")
                            .spectateGame(
                              this.get("data.summonerName"),
                              this.get("data.puuid"),
                              this.leagueContext.queueType,
                            )
                            .then((e) => {
        ...
        e.exports = (s.default || s).template({
          ...
          main: function (e, t, n, s, a) {
            ...
            return (
              ...
              c(
                typeof (i =
                  null != (i = n.title || (null != t ? t.title : t))
                    ? i
                    : o) === r
                  ? i.call(l, { name: "title", hash: {}, data: a })
                  : i,
              ) +
              '</h4>\r\n  <hr class="heading-spacer" />\r\n  <p>' +
              c(
                typeof (i =
                  null != (i = n.message || (null != t ? t.message : t))
                    ? i
                    : o) === r
                  ? i.call(l, { name: "message", hash: {}, data: a })
                  : i,
              ) +
              "</p>\r\n</div>\r\n\r\n"
            );
      ...
      (e, t) => {
        ...
        function s(e, t) {
          var a = t && t.loc,
            i = void 0,
            l = void 0;
          a && (e += " - " + (i = a.start.line) + ":" + (l = a.start.column));
          for (
        ...
        (t.default = function (e) {
          e.registerHelper("blockHelperMissing", function (t, n) {
            ...
            if (n.data && n.ids) {
              ...
              (l.contextPath = s.appendContextPath(n.data.contextPath, n.name)),
                (n = { data: l });
            }
            return i(t, n);
          });
      ...
      (e, t, n) => {
        ...
        var s,
          a = n(58),
          i = n(59),
          l = (s = i) && s.__esModule ? s : { default: s };
        (t.default = function (e) {
          e.registerHelper("each", function (e, t) {
            ...
            if (
              ...
              t.data && (r = a.createFrame(t.data)),
              e && "object" == typeof e)
            )
              if (a.isArray(e))
                for (var d = e.length; i < d; i++)
                  i in e && u(i, i, i === e.length - 1);
              else {
                var p = void 0;
                for (var m in e)
                  e.hasOwnProperty(m) &&
                    (void 0 !== p && u(p, i - 1), (p = m), i++);
                void 0 !== p && u(p, i - 1, !0);
              }
            return 0 === i && (o = s(this)), o;
          });
        }),
          (e.exports = t.default);
      },
      (e, t, n) => {
        ...
        var s,
          a = n(59),
          i = (s = a) && s.__esModule ? s : { default: s };
        (t.default = function (e) {
        ...
        (t.default = function (e) {
          e.registerHelper("if", function (e, t) {
            return (
              ...
              (!t.hash.includeZero && !e) || s.isEmpty(e)
                ? t.inverse(this)
                : t.fn(this)
            );
          }),
        ...
        (t.__esModule = !0),
          (t.default = function (e) {
            e.registerHelper("log", function () {
              for (
                var t = [void 0], n = arguments[arguments.length - 1], s = 0;
        ...
        (t.default = function (e) {
          e.registerHelper("with", function (e, t) {
            ...
            return (
              t.data &&
                t.ids &&
                ((a = s.createFrame(t.data)).contextPath = s.appendContextPath(
                  t.data.contextPath,
                  t.ids[0],
                )),
              n(e, {
          ...
          a = {
            ...
            log: function (e) {
              if (
                ...
                console[t] || (t = "log");
                for (
                  var n = arguments.length, s = Array(n > 1 ? n - 1 : 0), i = 1;
                  i < n;
                  i++
                )
                  s[i - 1] = arguments[i];
      ...
      (e, t, n) => {
          ...
          (t.template = function (e, t) {
            ...
            var n = {
              ...
              invokePartial: function (n, s, i) {
                i.hash &&
                  ((s = a.extend({}, s, i.hash)), i.ids && (i.ids[0] = !0)),
                  (n = t.VM.resolvePartial.call(this, n, s, i));
                var o = t.VM.invokePartial.call(this, n, s, i);
                if (
                  (null == o &&
                    t.compile &&
                    ((i.partials[i.name] = t.compile(n, e.compilerOptions, t)),
                    (o = i.partials[i.name](s, i))),
                  null != o)
                ) {
                  if (i.indent) {
                    for (
              ...
              program: function (e, t, n, s, a) {
                ...
                return (
                  t || a || s || n
                    ? (i = r(this, e, l, t, n, s, a))
                    : i || (i = this.programs[e] = r(this, e, l)),
                  i
                );
              },
              data: function (e, t) {
            ...
            function s(t) {
              ...
              function c(t) {
                return "" + e.main(n, t, n.helpers, n.partials, i, r, l);
              }
              return (
                e.useDepths &&
                  (l = a.depths
                    ? t != a.depths[0]
                      ...
                      : a.depths
                    : [t]),
                (c = u(e.main, c, n, a.depths || [], i, r))(t, a)
              );
            }
            return (
              (s.isTop = !0),
              (s._setup = function (s) {
                s.partial
                  ...
                  : ((n.helpers = n.merge(s.helpers, t.helpers)),
                    e.usePartial &&
                      (n.partials = n.merge(s.partials, t.partials)),
                    (e.usePartial || e.useDecorators) &&
                      (n.decorators = n.merge(s.decorators, t.decorators)));
              }),
          ...
          function o(t) {
            ...
            return (
              ...
              n(
                ...
                e.partials,
                a.data || s,
                i && [a.blockParams].concat(i),
                o,
              )
            );
          }
          return (
            ((o = u(n, o, e, l, s, i)).program = t),
            (o.depth = l ? l.length : 0),
            (o.blockParams = a || 0),
            o
          );
        }
        ...
        function u(e, t, n, s, i, l) {
          if (e.decorator) {
            var o = {};
            (t = e.decorator(t, o, n, s && s[0], i, l, s)), a.extend(t, o);
          }
          return t;
        }
      },
        ...
        n(76),
          (e.exports = s.Ember.Component.extend({
            ...
            wrapperStyle: s.Ember.computed("isPlayerUnranked", function () {
              return this.get("isPlayerUnranked")
                ? "lol-leagues-empty-filter-wrapper"
                : "lol-leagues-filter-wrapper";
            }),
            didInsertElement: function () {
              this._super(...arguments),
                this.$("lol-uikit-flat-dropdown")[0].addEventListener(
                  "selected",
                  (e) => {
                    this._onSelected(e);
                  },
            ...
            challengerQueues: s.Ember.computed(
              "challengerLaddersEnabled",
              function () {
                const e = this,
                ...
                return s.Lodash.map(t, (t) => ({
                  ...
                  queueTypeDisplay: e
                    .get("tra")
                    .formatString("LEAGUES_DROPDOWN_APEX", {
                      queueType: s.LeagueTierNames.getRankedQueueName(t),
                    }),
                }));
              },
            ),
            summonerLeagues: s.Ember.computed(
              "selectedLeague.queueType",
              "leagues",
              function () {
                const e = this.get("leagues.summonerLeagues"),
                ...
                return s.Lodash.map(e, (e) => ({
                  queue: e,
                  isSelected:
                    "summoner" === this.get("leagueTypeSelected") &&
                    t === e.queueType,
                })).filter(function (e) {
            ...
            topRatedLadderQueues: s.Ember.computed(
              "topRatedLaddersEnabled",
              function () {
                const e = this,
      ...
      (e, t, n) => {
        ...
        e.exports = s.Ember.Component.extend({
          ...
          didInsertElement: function () {
            this._super(...arguments),
              window.requestAnimationFrame(() => this.positionElements()),
              s.Ember.run.later(
                this,
                function () {
          ...
          didUpdateAttrs: function () {
            ...
            e !== this.prevVictoriousSkinId &&
              s.LeagueTierNames.asyncGetRewardImage(e, "splashPath").then(
                (e) => {
          ...
          victoriousSkinBackgroundStyle: s.Ember.computed(
            "victoriousSkinSplashPath",
            function () {
              const e = this.get("victoriousSkinSplashPath");
              return this.get("victoriousSkinSplashPath")
                ? `background-image: radial-gradient(54.18% 78.51% at 52.44% 21.49%, rgba(0, 0, 0, 0) 0%, #1A1C21 100%), url(${e})`
                : "background-image: url('/fe/lol-static-assets/victorious_before_reveal_background.png')";
            },
          ),
          ...
          setProgressBarScale: function (e) {
            const t = this.element.querySelector(
                ".ranked-rewards-progress-bar",
              ),
              n = this.get("currentSplit.rewardTrack"),
              s = this.get("currentSplit.splitId"),
              a = this.get("splitsRewardPositionData"),
              i = s && a && a[s - 1],
              l = this.get("spacingSize");
            if (!(n && t && i && l)) return;
            const o = this.get("lastEarnedReward"),
              r = this.get("nextReward"),
              c = this.calculateProgressBarPercentWidth(i, l, o, r);
            e
              ? this.animateProgressBar(t, c)
              : (t.style.transform = `scaleX(${c})`);
          },
            ...
            if (s) {
              if (n) {
                const a = s.splitPoints - n.splitPoints,
                  i = e[s.splitPoints],
                  l = this.get("playerPoints");
                if (!i || !l) return 0;
                const o = s.splitPoints - l;
                return (i.left - (o * t) / a) / 836;
              }
              return 0;
            }
            return 1;
          ...
          positionElements: function () {
            ...
            for (let e = 0; e < s.length; e++) {
              ...
              0 === e || e === s.length - 1 ? (i += n / 2) : (i += n),
                (a[t.splitPoints] = { size: n });
            }
            const l = s.length - 1,
              o = Math.floor((836 - i) / l);
            this.set("spacingSize", o);
            let r = 0;
            for (let e = 0; e < n.length; e++) {
              const t = n[e],
                s = t.getAttribute("data-required-points"),
                i = a[s].size;
              0 === e && (r -= Math.floor(i / 2)),
                (a[s].left = r),
                (t.style.left = `${r}px`),
                (r += i + o);
            }
          ...
          getRewardElements: function () {
            return [
              ...this.element.querySelectorAll(".ranked-reward-item-component"),
            ];
          },
          flattenedSplitRewards: s.Ember.computed(
            "currentSplit.rewardTrack.[]",
            function () {
          ...
          lastEarnedReward: s.Ember.computed(
            "currentSplit.rewardTrack.[]",
            "playerPoints",
            function () {
              ...
              return [...e]
                .sort((e, t) => t.splitPoints - e.splitPoints)
                .find((e) => e.splitPoints <= t);
            },
          ),
          nextReward: s.Ember.computed(
            "currentReward.rewardTrack.[]",
            "playerPoints",
            function () {
              const e = this.get("currentSplit.rewardTrack") || [],
                t = this.get("playerPoints");
              return (
                e.sort((e, t) => e.splitPoints - t.splitPoints),
                e.find((e) => e.splitPoints > t)
              );
            },
          ),
          getRewardSize: function (e) {
            const t = s.LeagueTierNames.getConstants().REWARD_TYPES,
              n =
                (e && e.rewards && e.rewards[0] && e.rewards[0].rewardType) ||
                t.HEXTECH_KEY;
            return n === t.EMOTE ||
              n === t.SUMMONER_ICON ||
              n === t.CHAMPION_TOKEN ||
              n === t.MASTERWORK_CHEST
              ? 52
              : 32;
          },
          currentSplit: s.Ember.computed.alias("splitsConfig.currentSplit"),
          getVictoriousPointsNeededForTier: (e, t) =>
            (t &&
              e &&
              e.victoriousSkinRewardGroup &&
              e.victoriousSkinRewardGroup.splitPointsByHighestAchievedTier &&
              e.victoriousSkinRewardGroup.splitPointsByHighestAchievedTier[
                t
              ]) ||
            1600,
          isVictoriousSkinUnlocked: s.Ember.computed(
            "victoriousPointsPercentageEarned",
            function () {
              return 100 === this.get("victoriousPointsPercentageEarned");
            },
          ),
          victoriousPointsPercentageEarned: s.Ember.computed(
            "currentSplit",
            "myRankedStats",
            "playerPoints",
            function () {
              ...
              if (!e || !t || !n) return 0;
              const s = this.getVictoriousPointsNeededForTier(
                e,
                t.highestCurrentSeasonReachedTierSR,
              );
              return s ? 100 * Math.min(n / s, 1) : 0;
            },
          ),
          victoriousPointsSilverBelow: s.Ember.computed(
            "victoriousPointsNeededSilverBelow",
            "playerPoints",
            "myRankedStats.highestCurrentSeasonReachedTierSR",
            function () {
              const e = this.get(
                "myRankedStats.highestCurrentSeasonReachedTierSR",
              );
              return e && s.LeagueTierNames.getConstants().TIERS.indexOf(e) <= 2
                ? `${this.get("playerPoints")} / ${this.get(
                    "victoriousPointsNeededSilverBelow",
                  )}`
                : `${this.get(
                    "victoriousPointsNeededSilverBelow",
                  )} / ${this.get("victoriousPointsNeededSilverBelow")}`;
            },
          ),
          victoriousPointsNeededSilverBelow: s.Ember.computed(
            "currentSplit",
            function () {
              return this.getVictoriousPointsNeededForTier(
                this.get("currentSplit"),
                s.LeagueTierNames.getConstants().TIERS[2],
              );
            },
          ),
          victoriousPointsNeededGoldAbove: s.Ember.computed(
            "currentSplit",
            function () {
              return this.getVictoriousPointsNeededForTier(
                this.get("currentSplit"),
                s.LeagueTierNames.getConstants().TIERS[3],
              );
            },
          ),
          showHonorWarning: s.Ember.computed(
            "honorLevel",
            "isVictoriousSkinUnlocked",
            function () {
              return (
                this.get("honorLevel") < 2 &&
                !this.get("isVictoriousSkinUnlocked")
              );
            },
          ),
        });
      ...
      (e, t, n) => {
        ...
        e.exports = s.Ember.Component.extend({
          ...
          classNameBindings: [
            "unlocked:unlocked:future-reward",
            "is32px:is-32-px",
            "is52px:is-52-px",
          ],
          ...
          didReceiveAttrs: function () {
            ...
            e !== this.get("previousRewardId") &&
              (this.set("previousRewardId", e),
              this.updateIconPath(e),
              this.updateRewardItemTooltipTitle(e));
          },
          updateIconPath(e) {
          ...
          pointsRequiredTooltipMessage: s.Ember.computed(
            "tra",
            "unlocked",
            "tra.RANK_REWARDS_ITEM_POINTS_REQUIRED",
            "playerPoints",
            "reward.splitPoints",
            function () {
              const e = this.get("tra");
          ...
          unlockedString: s.Ember.computed(
            "tra.RANK_REWARDS_UNLOCKED",
            "unlocked",
            function () {
              return this.get("unlocked")
                ? this.get("tra.RANK_REWARDS_UNLOCKED")
                : "";
            },
          ),
          nextRewardPointsRequired: s.Ember.computed(
            "nextReward.splitPoints",
            function () {
              return this.get("nextReward.splitPoints") || 0;
            },
          ),
          pointsNeededText: s.Ember.computed(
            "isNextReward",
            "reward.splitPoints",
            "playerPoints",
            function () {
              const e = this.get("isNextReward"),
                ...
                n = this.get("tra");
              return e
                ? n.formatString("RANK_REWARDS_IN_PROGRESS_POINTS_REQUIRED", {
                    pointsRequired: t,
                  })
          ...
          shouldShowPointProgress: s.Ember.computed.or(
            "isNextReward",
            "isHovered",
          ),
          ...
          isNextReward: s.Ember.computed(
            "nextRewardPointsRequired",
            "reward.splitPoints",
            function () {
              return (
                this.get("nextRewardPointsRequired") ===
                this.get("reward.splitPoints")
              );
            },
          ),
          ...
          (e.exports = s.Ember.Component.extend({
            ...
            ratedTier: s.Ember.computed("queue", "isTft", function () {
              const e = this.get("isTft"),
                t = this.get("queue");
              return t && t.ratedTier
                ? t.ratedTier
                : e
                  ? s.LeagueTierNames.getConstants().LOWEST_TFT_RATED_TIER
                  : s.LeagueTierNames.getConstants().LOWEST_CHERRY_RATED_TIER;
            }),
            ...
            displayedRatedRating: s.Ember.computed(
              "queue",
              "ratedTier",
              "isUnrated",
              function () {
        ...
        n(88),
          (e.exports = s.Ember.Component.extend({
            ...
            countdownChanged: s.Ember.observer("countdownToTime", function () {
              ...
              var t;
              this.set("nextCountdown", Math.max(e, 0)),
                this.clearTimer(),
                this.set(
                  "countdownTimer",
                  setInterval(
                    ...
                    () => {
                      ...
                      e >= a.PROMOTE_COUNTDOWN_INTERVAL_MS
                        ? ((e -= a.PROMOTE_COUNTDOWN_INTERVAL_MS),
                          t.set("nextCountdown", e))
                        : t.clearTimer();
                    }),
      ...
      (e, t, n) => {
        ...
        e.exports = s.Ember.Service.extend(a, {
          spectateEnabled: s.Ember.computed(
            "leagueSpectateToggleJMX.Enabled",
            "clashPlaymodeRestricted.isRestricted",
            function () {
          ...
          spectateGame: function (e, t, n) {
            return this.get("spectateEnabled")
              ? this.get("api.spectator").post("v1/spectate/launch", {
          ...
          availableForSpectateBySummonerNames: function (e) {
            return this.get("spectateEnabled")
              ? this.get("api.spectator")
                  .post("v1/buddy/spectate", e, { skipCache: !0 })
                  .then(
                    (e) =>
                      e.availableForWatching ? e.availableForWatching : [],
                    () => {},
                  )
              : Promise.resolve([]);
          },
          availableForSpectateBySummonerIds: function (e) {
            return this.get("spectateEnabled")
              ? this.get("api.spectator")
                  .post("v2/buddy/spectate", e, { skipCache: !0 })
                  .then(
                    (e) =>
                      e.availableForWatching ? e.availableForWatching : [],
                    () => {},
      ...
      (e, t, n) => {
        ...
        var s,
          a = n(1),
          i = n(23),
          l = (s = n(92)) && s.__esModule ? s : { default: s };
        n(93);
        ...
        e.exports = a.Ember.Component.extend(o, l.default, {
          ...
          didUpdateAttrs: function () {
            this._super(...arguments),
              this.get("shouldAnimate") &&
                this.get("introVideoPath") &&
                this.get("outroVideoPath") &&
                this.startAnimation();
          },
          willDestroyElement: function () {
            this._super(...arguments);
          ...
          shouldAnimate: a.Ember.computed(
            ...
            function () {
              return (
                !this.get("isLowSpec") &&
                this.get("isShowing") &&
                !this.get("animationStarted")
              );
            },
          ),
          introVideoPath: a.Ember.computed(
            "previousTier",
            "isCompletedProvisionals",
            function () {
              if (this.get("isCompletedProvisionals"))
                return `${i.ASSET_PATH}videos/ranked/tier-promotion-from-unranked.webm`;
              const e = this.get("previousTier");
              return e
                ? `${
                    i.ASSET_PATH
                  }videos/ranked/tier-promotion-from-${e.toLowerCase()}.webm`
                : "";
            },
          ),
          outroVideoPath: a.Ember.computed("currentTier", function () {
            ...
            return e
              ? `${
                  i.ASSET_PATH
                }videos/ranked/tier-promotion-to-${e.toLowerCase()}.webm`
              : "";
          }),
          introAudioPath: a.Ember.computed(
            "previousTier",
            "isCompletedProvisionals",
            function () {
              if (this.get("isCompletedProvisionals"))
                return `${i.ASSET_PATH}sounds/ranked/sfx-tier-wings-promotion-from-unranked.ogg`;
              const e = this.get("previousTier");
              return e
                ? `${
                    i.ASSET_PATH
                  }sounds/ranked/sfx-tier-wings-promotion-from-${e.toLowerCase()}.ogg`
                : "";
            },
          ),
          outroAudioPath: a.Ember.computed("currentTier", function () {
            ...
            return e
              ? `${
                  i.ASSET_PATH
                }sounds/ranked/sfx-tier-wings-promotion-to-${e.toLowerCase()}.ogg`
              : "";
          }),
          outroImagePath: a.Ember.computed("currentTier", function () {
            ...
            return e
              ? `${
                  i.ASSET_PATH
                }images/ranked-emblem/emblem-${e.toLowerCase()}.png`
              : "";
          }),
          startAnimation: function () {
            ...
            const s = this.get("introAudioPath"),
              ...
              l = this.createSound(i);
            this.set("animationStarted", !0),
              e.addEventListener("signal", () => {
                t.play(), this.playAudio(l);
              }),
          ...
          isApex: a.Ember.computed("tierUpperCase", function () {
            return a.LeaguesConsts.APEX_TIERS.includes(
              this.get("tierUpperCase"),
            );
          }),
          isTierPromotion: a.Ember.computed(
            "isCompletedProvisionals",
            "isApex",
            "division",
            function () {
          ...
          isCompletedProvisionals: a.Ember.computed(
            "notification.notifyReason",
            function () {
              return (
                "COMPLETED_PROVISIONALS" ===
                this.get("notification.notifyReason")
              );
            },
          ),
          ...
          headerText: a.Ember.computed(
            ...
            "leaguePoints",
            function () {
              return this.get("isCompletedProvisionals")
                ? this.get("tra").formatString(
                    "LEAGUES_COMPLETED_PROVISIONALS_VIGNETTE_HEADER",
                    {
                      tierDivisionLpLoc: a.LeagueTierNames.getTierDivisionLpLoc(
                        this.get("tierUpperCase"),
                        this.get("division"),
                        this.get("leaguePoints"),
                      ),
                ...
                : this.get("tra").formatString(
                    "LEAGUES_PROMOTION_VIGNETTE_HEADER",
                    {
                      tierDivisionLoc:
                        a.LeagueTierNames.getFullTierDivisionName(
                          this.get("tierUpperCase"),
                          this.get("division"),
                        ),
                    },
          ...
          subheaderText: a.Ember.computed(
            "isCompletedProvisionals",
            "queueType",
            function () {
              const e = this.get("queueType"),
              ...
              return this.get("isCompletedProvisionals")
                ? this.get("tra").formatString(
                    "LEAGUES_COMPLETED_PROVISIONALS_VIGNETTE_SUBHEADER",
                    { queueType: t },
                  )
                : this.get("tra").formatString(
                    "LEAGUES_PROMOTION_VIGNETTE_SUBHEADER",
                    { queueType: t },
                  );
            },
          ),
          labelText: a.Ember.computed(
            "currentSummoner.displayName",
            function () {
              return this.get("currentSummoner.displayName");
            },
          ),
          shouldShowProfileIcon: a.Ember.computed(
            "profileIconPath",
            function () {
              return !!this.get("profileIconPath");
            },
          ),
          profileIconPath: a.Ember.computed(
            "currentSummoner.profileIconId",
            function () {
              const e = this.get("currentSummoner.profileIconId");
              return e
                ? `/lol-game-data/assets/v1/profile-icons/${e}.jpg`
                : null;
            },
          ),
        });
      ...
      (e, t, n) => {
        ...
        n(96),
          (e.exports = s.Ember.Component.extend({
            ...
            showChromaBackground: s.Ember.computed(
              "notification.rewardEarnedType",
              function () {
                return (
                  this.get("notification.rewardEarnedType") ===
                  s.LeagueTierNames.getConstants().REWARD_TYPES
                    .CHAMPION_SKIN_CHROMA
                );
              },
            ),
            showGoldBackgroundGlow: s.Ember.computed(
              "notification.rewardEarnedType",
              function () {
      ...
      (e, t, n) => {
        ...
        e.exports = a.Ember.Component.extend(l.default, {
          ...
          didUpdateAttrs: function () {
            if (
              (this._super(...arguments),
              this.get("isShowing") && !this.get("animationStarted"))
            ) {
          ...
          audioPath: a.Ember.computed("ratedTier", function () {
            return "GRAY" === this.get("ratedTier")
              ? `${i.ASSET_PATH}sounds/tft-rated/sfx-celebrate-tft-rated-grayrating.ogg`
              : `${i.ASSET_PATH}sounds/tft-rated/sfx-celebrate-tft-rated-promote.ogg`;
          }),
          lottiePath: a.Ember.computed(
            "ratedTier",
            "notification.queueType",
            function () {
              const e = o[this.get("ratedTier")],
                t = this.get("notification.queueType");
      ...
      (e, t, n) => {
        ...
        var s,
          a = n(1),
          i = (s = n(92)) && s.__esModule ? s : { default: s };
        n(102);
        const l = {
            GRAY: void 0,
            GREEN: n(103),
        ...
        e.exports = a.Ember.Component.extend(i.default, {
          ...
          didInsertElement() {
            this._super(...arguments);
            this.element
              .querySelector("uikit-video")
              .addStateChangedHandler(
                this.playAudioOnVideoPlay.bind(this),
                "Playing",
              );
          },
          playAudioOnVideoPlay: function () {
            if (!this.get("videoStarted")) {
              const e = this.createSound(this.get("audioPath"));
              this.set("videoStarted", !0),
                e && setTimeout(() => e.play(), 500);
            }
          },
          cherryRatingVideoSrc: a.Ember.computed(
            "ratedTier",
            "notification.queueType",
            function () {
      ...
      (e, t, n) => {
        ...
        const a = (0, s.emberDataBinding)({
          ...
          boundProperties: {
            session: { api: "login", path: "/v1/session", default: {} },
            accountLeaguesSettings: {
              api: "settings",
              path: "/v2/account/LCUPreferences/lol-leagues",
              default: {},
            },
            settingsReady: { api: "settings", path: "/v2/ready", default: !1 },
            splitsConfig: {
              api: "ranked",
        ...
        e.exports = s.Ember.Component.extend(a, {
          ...
          layout: n(114),
          isDependenciesInitialized: s.Ember.computed(
            "session",
            "session.state",
            "accountLeaguesSettings",
            "settingsReady",
            ...
            function () {
              const e = this.get("session"),
                ...
                s = this.get("settingsReady"),
                a = this.get("currentRankedStats"),
                i = this.get("regionLocale"),
                l = this.get("currentSummoner"),
                o = this.get("currentSeason");
              this.get("isPreseason");
              return (
                !this._isLoginSessionInvalid(e) &&
                this._isNamedSummoner(l) &&
                o &&
                n &&
                s &&
                t &&
      ...
      (e, t, n) => {
        ...
        e.exports = a.Ember.Component.extend(o, {
          currentSeason: null,
          platformConfigObserver: a.Ember.observer(
            "currentSeason",
            "accountLeaguesSettings",
            "seasonModalEnabled",
            function () {
              ...
              this.get("seasonModalEnabled") &&
                void 0 !== e &&
                this._displayTakeovers(t, e);
            },
          ),
          ...
          _showSeasonStartToast(e) {
            const t = {
              ...
              data: { seasonYear: (l.SEASON_YEAR_BASE + e).toString() },
            };
            (0, a.dataBinding)("/player-notifications").post(
              "/v1/notifications",
              t,
            ),
              i.default.saveAccountSetting(r, { season: e });
          },
        });
      },
      (e, t, n) => {
        ...
        var a = {
          saveLocalSetting: (e, t) => {
            const n = { [e]: t };
            return (0, s.dataBinding)("/lol-settings").patch(
              "/v1/local/lol-leagues",
              { data: n, schemaVersion: 1 },
            );
          },
          saveAccountSetting: (e, t) => {
            const n = { [e]: t };
            return (0, s.dataBinding)("/lol-settings").patch(
              "/v2/account/LCUPreferences/lol-leagues",
              { data: n, schemaVersion: 1 },
            );
          },
        };
      ...
      (e, t, n) => {
        ...
        var s,
          ...
          i = n(23),
          l = n(50),
          o = (s = n(116)) && s.__esModule ? s : { default: s };
        n(119);
        const r = n(120),
        ...
        e.exports = a.Ember.Component.extend(c, {
          ...
          init: function () {
            this._super(...arguments);
            this.get("isPlayerNotificationsInitialized") ||
              this._initPlayerNotifications();
          },
          currentSplit: a.Ember.computed(
            "splitsConfig",
          ...
          platformConfigObserver: a.Ember.observer(
            ...
            "splitsConfig.currentSplitId",
            "currentRankedStats",
            "currentRankedStats.queues",
            "rewardsService",
            "rewardsService.emoteCatalog",
            ...
            function () {
              const e = this.get("accountLeaguesSettings"),
                ...
                a = this.get("currentSplit");
              if (!a) return;
              const i = parseFloat(t + "." + a.splitId),
                o = (0, l.getDaysBetweenDateMillis)(
                  Date.now(),
                  a.endTimeMillis,
                );
              this._shouldDisplaySplitEndNotification(i, o, e, s) &&
                this._displaySplitEndNotification(i, a, n);
            },
          ),
          ...
          _displaySplitEndNotification: function (e, t, n) {
            const s = {
              ...
              data: {
                ...
                endDate: (0, l.convertDateMillisToString)(
                  t.endTimeMillis - 1,
                  n,
            ...
            (0, a.dataBinding)("player-notifications").post(
              ...
              o.default.saveAccountSetting(g, e),
              this.set("hasSplitEndNotificationSentThisSession", !0);
          },
          _renderSplitEndNotification: function (e) {
            const t = document.createElement("div"),
              n = this.get("regionLocale"),
              s = isNaN(e.data.endDate)
                ? e.data.endDate
                : (0, l.convertDateMillisToString)(e.data.endDate - 1, n, {
                    month: "long",
                    day: "numeric",
                  }),
              a = r({
                ...
                detail: this.get("tra").formatString(m, { endDate: s }),
              });
            return (
              (t.innerHTML = a), t.classList.add("split-end-notification"), t
            );
          },
          _initPlayerNotifications() {
            a.Social.playerNotifications().registerToastRenderer(
              u,
              d,
              this._renderSplitEndNotification.bind(this),
            ),
              a.Social.playerNotifications().on(
                u,
                d,
                "click",
                this._navigateToProfileSubsection.bind(
                  this,
                  i.PROFILE_RANKED_SUBSECTION_ID,
                ),
              ),
              this.set("isPlayerNotificationsInitialized", !0);
          },
          ...
          _navigateToProfileSubsection: function (e) {
            return (
              a.ProfilesAPI.setActive(!0),
              a.ProfilesAPI.mainSection().show(e),
              !0
            );
          },
        });
        ...
        e.exports = (s.default || s).template({
          ...
          main: function (e, t, n, s, a) {
            ...
            return (
              ...
              c(
                typeof (i =
                  null != (i = n.detail || (null != t ? t.detail : t))
                    ? i
                    : o) === r
                  ? i.call(l, { name: "detail", hash: {}, data: a })
                  : i,
              ) +
              "</div>"
            );
      ...
      (e, t, n) => {
        ...
        var s,
          ...
          l = n(23),
          o = n(50),
          r = (s = n(116)) && s.__esModule ? s : { default: s },
          c = n(24);
        n(122);
        const u = n(123),
        ...
        e.exports = a.Ember.Component.extend(d, {
          ...
          platformConfigObserver: a.Ember.observer(
            ...
            function () {
              const e = this.get("accountLeaguesSettings"),
                ...
                l = this.get("hasSplitStartModalShownThisSession"),
                r = this.get("isSplitStartModalEnabled"),
                c = this.get("currentSplit");
              if (!c) return;
              const u = parseFloat(t + "." + c.splitId),
                d = (0, o.getDaysBetweenDateMillis)(
                  Date.now(),
                  c.endTimeMillis,
                ),
                p = this._getHighestRankedNonTFTEntryQueue(n);
              this._shouldTryToDisplaySplitStartModal(u, d, e, p, a, i, r, l) &&
                (this.set("hasSplitStartModalShownThisSession", !0),
                i.loadCurrentSeasonStatsGames(a.puuid).then((e) => {
                  this._tryToDisplaySplitStartModal(
                    u,
                    c,
                    n,
                    p,
          ...
          _shouldTryToDisplaySplitStartModal(e, t, n, s, a, i, l, o) {
            const r = t <= 14,
              c = n.data && n.data[p] >= e,
              u = Boolean(s),
              d = Boolean(a),
              m = Boolean(i);
            return l && !o && u && !r && !c && d && m;
          },
          _tryToDisplaySplitStartModal: function (e, t, n, s, a, i, l, o, r) {
            const c = this.get("allowSplitStartModalMockCareerStatsData");
            if ((!o || !o.games || o.games.length < 10) && !c) return;
            const u = this._getBestChampionStatsPanelData(
              o.games,
              n,
              s,
              i,
          ...
          _displaySplitStartModal: function (e, t, n, s, i, o) {
            ...
            return Promise.all([c, d]).then((c) => {
              ...
              return (
                a.ModalManager.add({
                  type: "DialogConfirm",
                  data: {
                    contents: this._renderSplitStartModal(
                      u,
                      t,
                      d,
                      n,
                    ...
                    acceptText: this.get(
                      "tra.SPLIT_START_TAKEOVER_SEE_STATS_BUTTON_TEXT",
                    ),
                    declineText: this.get(
                      "tra.SPLIT_START_TAKEOVER_CLOSE_BUTTON_TEXT",
                    ),
                    closeButton: !0,
                    acceptHandler: this._navigateToProfileSubsection.bind(
                      this,
                      l.PROFILE_STATS_SUBSECTION_ID,
                    ),
                  },
                }),
          ...
          _renderSplitStartModal: function (e, t, n, s, a, i, l, o) {
            const r = {
              titlesInfo: this._getSplitStartModalTitlesInfo(t, l),
              rewardsInfo: n,
              rankInfo: this._getSplitStartModalRankInfo(s, a, o),
              statsInfo: this._getSplitStartModalStatsInfo(i, l),
            };
            return this._renderModal(e, r);
          },
          _getSplitStartModalTitlesInfo: function (e, t) {
            return {
              seasonTitle: this.get("tra").formatString(
                "SPLIT_START_TAKEOVER_SEASON_TITLE",
                {
                  seasonYear: (0, o.convertDateMillisToString)(
                    e.endTimeMillis,
                    t,
                    { year: "numeric" },
                  ),
              ...
              splitTitle: this.get("tra").formatString(
                "SPLIT_START_TAKEOVER_SPLIT_TITLE",
                { split: e.splitId },
              ),
              splitDurationTitle: this.get("tra").formatString(
                "SPLIT_START_TAKEOVER_SPLIT_DURATION_TITLE",
                {
                  splitStartString: (0, o.convertDateMillisToString)(
                    e.startTimeMillis,
                    t,
                  ),
                  splitEndString: (0, o.convertDateMillisToString)(
                    e.endTimeMillis - 1,
                    t,
                  ),
                },
          ...
          _getSplitStartModalRewardsInfoPromise: function (e) {
            const t = [],
              ...
              l = [];
            return (
              a.Lodash.forEach(n, (e) => {
                a.Lodash.forEach(e.rewards, (e) => {
                  const n = e.rewardType;
                  if (!s[e.id]) {
                    const o = this.get(`tra.REWARD_TYPE_${n}_DESCRIPTION`),
                      r = `reward-image-${n.toLowerCase()}`,
                      c = {
                        description: this.get("tra").formatString(
                          "SPLIT_START_TAKEOVER_REWARD_DESCRIPTION",
                          { rewardTypeDescription: o },
                        ),
                        cssClass: r,
                      };
                    n === i.EMOTE ||
                    ...
                    n === i.SUMMONER_ICON
                      ? (t.unshift(c),
                        l.unshift(a.LeagueTierNames.asyncGetRewardImage(e.id)))
                      : (t.push(c),
                        l.push(a.LeagueTierNames.asyncGetRewardImage(e.id))),
                      (s[e.id] = !0);
                  }
                });
              }),
          ...
          _getSplitStartModalRankInfo: function (e, t, n) {
            const s = t.tier,
              i = t.division,
              l = a.LeagueTierNames.getUpOneDivision(s, i, n),
              o = l ? l.tier : null,
              r = l ? l.division : null;
            return {
              currentRankTitle: this.get(
                "tra.SPLIT_START_TAKEOVER_CURRENT_RANK_TEXT",
              ),
              currentRankTier: s,
              currentRankDivision: i,
              currentRankText: a.LeagueTierNames.getFullTierDivisionName(s, i),
              nextRankTitle: this.get("tra").formatString(
                "SPLIT_START_TAKEOVER_NEXT_RANK_TEXT",
                { nextRank: a.LeagueTierNames.getFullTierDivisionName(o, r) },
              ),
              nextRankTier: o,
              nextRankDivision: r,
              queueTypeText: this.get("tra").formatString(
                "SPLIT_START_TAKEOVER_QUEUE_TYPE_TEXT",
                {
              ...
              placementsProgressText: this.get("tra").formatString(
                "SPLIT_START_TAKEOVER_PLACEMENTS_PROGRESS_TEXT",
                {
                  placementGamesThreshold: t.provisionalGameThreshold,
                  placementGamesDone:
                    t.provisionalGameThreshold - t.provisionalGamesRemaining,
                },
              ),
              placementsText: this.get(
                "tra.SPLIT_START_TAKEOVER_PLACEMENTS_TEXT",
              ),
              lpProgressText: this.get("tra").formatString(
                "SPLIT_START_TAKEOVER_LP_PROGRESS_TEXT",
                { lpToGo: a.LeaguesConsts.LP_PER_DIVISION - t.leaguePoints },
              ),
              isInApex: a.LeagueTierNames.isApexForQueue(t),
              lpText: this.get("tra").formatString(
                "SPLIT_START_TAKEOVER_LP_TEXT",
                { lp: t.leaguePoints },
              ),
              isInMiniSeries: Boolean(t.miniSeriesProgress),
              miniSeriesProgressText: this.get("tra").formatString(
                "SPLIT_START_TAKEOVER_MINI_SERIES_PROGRESS_TEXT",
                {
                  miniSeriesWinsNeeded: this._getMiniSeriesWinsNeeded(
                    t.miniSeriesProgress,
                  ),
                },
              ),
              miniSeriesText: this.get(
                "tra.SPLIT_START_TAKEOVER_MINI_SERIES_TEXT",
              ),
            };
          },
          _getSplitStartModalStatsInfo: function (e, t) {
            ...
            if (e.dataType === m || e.dataType === g) {
              ...
              n = {
                statsTitle: this.get("tra").formatString(
                  "SPLIT_START_TAKEOVER_STATS_TITLE",
                  {
                    statsTitleAddition:
                      e.dataType === m
                        ? this.get(
                            "tra.SPLIT_START_TAKEOVER_STATS_RANKED_TITLE_ADDITION",
                          )
                        : this.get(
                            "tra.SPLIT_START_TAKEOVER_STATS_NORMALS_TITLE_ADDITION",
                          ),
                  },
                ),
                statsFooter:
                  e.dataType === m
                    ? this.get("tra.SPLIT_START_TAKEOVER_STATS_RANKED_FOOTER")
                    : this.get(
                        "tra.SPLIT_START_TAKEOVER_STATS_NONRANKED_FOOTER",
                      ),
                statsData: [
                  e.championGrades.combat,
                  e.championGrades.income,
                  e.championGrades.macro,
                ],
                statsText: [
                  t.get("career_stats_play_style_category_combat"),
                  t.get("career_stats_play_style_category_income"),
                  t.get("career_stats_play_style_category_macro"),
                ],
              ...
              n = {
                statsTitle: this.get(
                  "tra.SPLIT_START_TAKEOVER_STATS_CHAMP_MASTERY_TITLE",
                ),
                statsFooter: this.get(
                  "tra.SPLIT_START_TAKEOVER_STATS_NONRANKED_FOOTER",
                ),
                statsData: [
                  e.championMastery.championLevel,
                  this._formatNumber(e.championMastery.championPoints, t),
                  e.championMastery.highestGrade
                    ? e.championMastery.highestGrade
                    : this.get(
                        "tra.SPLIT_START_TAKEOVER_STATS_CHAMP_MASTERY_NO_GRADE_DATA",
                      ),
                ],
                statsText: [
                  this.get(
                    "tra.SPLIT_START_TAKEOVER_STATS_CHAMP_MASTERY_LEVEL_TEXT",
                  ),
                  this.get(
                    "tra.SPLIT_START_TAKEOVER_STATS_CHAMP_MASTERY_POINTS_TEXT",
                  ),
                  this.get(
                    "tra.SPLIT_START_TAKEOVER_STATS_CHAMP_MASTERY_GRADE_TEXT",
                  ),
                ],
                statContainerCSSClass: "stat-container-mastery",
              };
            return (
              (n.championName = e.championGameAssets.name),
              (n.championImagePath =
                e.championGameAssets.skins[0].uncenteredSplashPath),
              n
            );
          },
          _getBestChampionStatsPanelData(e, t, n, s, a, i, l) {
            if ((!e || (e && e.length < 10)) && l)
              return this._getChampionGameAssets(200).then((e) => ({
                dataType: m,
                championGrades: { combat: "F", income: "F", macro: "F" },
                championGameAssets: e,
              }));
            let o = this._getBestChampionInfoForRanked(e, t, n),
              r = m;
            return (
              o || ((o = this._getBestChampionInfoForNormals(e)), (r = g)),
              o
                ? this._getStatsPanelDataForChampion(o, s, a, r)
                : this._getStatsPanelDataForChampionMastery(i)
            );
          },
          _getBestChampionInfoForRanked(e, t, n) {
            ...
            return (
              i ||
                a.Lodash.forEach(t.queues, (t) => {
                  const n = t.queueType;
                  if (
                    n !== s &&
                    this._isRankedQueueValid(t) &&
                    this._isRankedQueueSR(t)
                  ) {
          ...
          _getBestChampionInfoForNormals(e) {
            ...
            return (
              a.Lodash.forEach(
                this.careerStatsAPI.getNormalGamesQueueTypes(),
                (n) => {
                  const s = this._getBestChampionInfoForQueue(
                    e,
                    n,
                    this.careerStatsAPI.getAllRanks(),
                  );
                  s &&
                    (!t ||
                      s.winrate > t.winrate ||
                      (s.winrate === t.winrate &&
                        s.games.length > t.games.length)) &&
                    (t = s);
                },
              ),
              t
          ...
          _getBestChampionInfoForFilteredQueueGames(e, t, n) {
            ...
            a.Lodash.forEach(e, (e) => {
              ...
              s[e.championId] && s[e.championId][t]
                ? s[e.championId][t].push(e)
                : s[e.championId] && !s[e.championId][t]
                  ? (s[e.championId][t] = [e])
                  : (s[e.championId] = { [t]: [e] });
            });
            let i = null;
            for (const [e, l] of a.Lodash.entries(s))
              for (const [s, o] of a.Lodash.entries(l)) {
                const a = o.length,
                  l = this.careerStatsAPI.getWinrate(o);
                a >= this.careerStatsAPI.getMinGamesToUnlockStats() &&
                  (!i || i.winrate <= l) &&
                  (i = {
          ...
          _getStatsPanelDataForChampion(e, t, n, s) {
            ...
            return t
              .getChampionStatPercentiles(e.championId, [
                {
                  position: e.position,
                  rankTier: e.rankTier,
                  queueType: a,
              ...
              .then((t) =>
                this._getChampionGameAssets(e.championId).then((n) => ({
                  championGameAssets: n,
                  championGrades: this.careerStatsAPI.getGradesForChampion(
                    e.games,
                    e.position,
                    a,
                    t,
          ...
          _getStatsPanelDataForChampionMastery(e) {
            return this._getBestChampionMastery(e).then((e) =>
              this._getChampionGameAssets(e.championId).then((t) => ({
          ...
          _getBestChampionMastery: function (e) {
            return this.get("api.collections")
              .get(`/v1/inventories/${e}/champion-mastery/top?limit=1`)
              .then((e) => e.masteries[0]);
          },
          _getChampionGameAssets: function (e) {
            return this.get("api.gameData").get(
              "/assets/v1/champions/" + e + ".json",
            );
          },
          _getHighestRankedNonTFTEntryQueue: function (e) {
            if (e && e.queues) {
              const t = a.Lodash.find(
                e.queues,
                (e) =>
                  this._isRankedQueueValid(e) && !this._isRankedQueueTFT(e),
              );
              if (t) return t;
            }
            return null;
          ...
          _isRankedQueueSR: function (e) {
            return (
              Boolean(e) &&
              Boolean(e.queueType) &&
              i.QUEUES.RANKED_SR_QUEUE_TYPES.includes(e.queueType)
            );
          },
          _isRankedQueueTFT: function (e) {
            return (
              Boolean(e) &&
              Boolean(e.queueType) &&
              (0, c.isTftQueueType)(e.queueType)
            );
          },
          _isRankedQueueValid: function (e) {
            return (
              ...
              Boolean(e.queueType) &&
              Boolean(e.tier) &&
              e.tier !== a.LeaguesConsts.TIER_NAME_NONE
            );
          },
          _getCurrentSplitData: function (e) {
            if (!e || !e.currentSplitId) return null;
        ...
        e.exports = (s.default || s).template({
          1: function (e, t, n, s, a, i) {
            ...
            return (
              ...
              r(o(null != (l = i[0][0]) ? l.imagePath : l, t)) +
              '" class="reward-image ' +
              r(o(null != (l = i[0][0]) ? l.cssClass : l, t)) +
              '">\r\n                <div class="reward-description">' +
              r(o(null != (l = i[0][0]) ? l.description : l, t)) +
              "</div>\r\n            </div>\r\n"
            );
          },
          3: function (e, t, n, s, a) {
            ...
            return (
              ...
              o(
                l(
                  null != (i = null != t ? t.statsInfo : t) ? i.statsTitle : i,
                  t,
                ),
              ) +
              '</div>\r\n                        <div class="stats-champion-name">' +
              o(
                l(
                  null != (i = null != t ? t.statsInfo : t)
                    ? i.championName
              ...
              o(
                l(
                  null != (i = null != t ? t.statsInfo : t) ? i.statsFooter : i,
                  t,
                ),
              ) +
              "</div>\r\n                </div>\r\n"
          ...
          7: function (e, t, n, s, a) {
            var i;
            return (
              '                        <lol-uikit-resizing-text-field class="next-rank-title" data-max-width="200">\r\n                            ' +
              e.escapeExpression(
                e.lambda(
                  null != (i = null != t ? t.rankInfo : t)
                    ? i.nextRankTitle
          ...
          13: function (e, t, n, s, a) {
            ...
            return (
              ...
              e.escapeExpression(
                e.lambda(
                  null != (i = null != t ? t.rankInfo : t) ? i.nextRankTier : i,
                  t,
                ),
              ) +
              "\r\n                "
          ...
          15: function (e, t, n, s, a) {
            var i,
              ...
              o = e.escapeExpression;
            return (
              '                    <div class="rank-text-wrapper">\r\n                        <lol-uikit-resizing-text-field class="placements-progress-text" data-max-width="200">' +
              o(
                l(
                  null != (i = null != t ? t.rankInfo : t)
                    ? i.placementsProgressText
                    : i,
                  t,
                ),
              ) +
              '</lol-uikit-resizing-text-field>\r\n                    </div>\r\n                    <div class="rank-text-wrapper">\r\n                        <lol-uikit-resizing-text-field class="placements-text" data-max-width="200">' +
              o(
                l(
                  null != (i = null != t ? t.rankInfo : t)
                    ? i.placementsText
          ...
          17: function (e, t, n, s, a) {
            ...
            return null !=
              (i = n.if.call(
                ...
                null != (i = null != t ? t.rankInfo : t) ? i.isInMiniSeries : i,
                {
                  name: "if",
                  hash: {},
                  fn: e.program(18, a, 0),
          ...
          18: function (e, t, n, s, a) {
            var i,
              ...
              o = e.escapeExpression;
            return (
              '                    <div class="rank-text-wrapper">\r\n                        <lol-uikit-resizing-text-field class="mini-series-progress-text" data-max-width="200">' +
              o(
                l(
                  null != (i = null != t ? t.rankInfo : t)
                    ? i.miniSeriesProgressText
                    : i,
                  t,
                ),
              ) +
              '</lol-uikit-resizing-text-field>\r\n                    </div>\r\n                    <div class="rank-text-wrapper">\r\n                        <lol-uikit-resizing-text-field class="mini-series-text" data-max-width="200">' +
              o(
                l(
                  null != (i = null != t ? t.rankInfo : t)
                    ? i.miniSeriesText
          ...
          20: function (e, t, n, s, a) {
            ...
            return null !=
              (i = n.if.call(
                null != t ? t : e.nullContext || {},
                null != (i = null != t ? t.rankInfo : t) ? i.isInApex : i,
                {
                  name: "if",
                  hash: {},
                  fn: e.program(21, a, 0),
          ...
          21: function (e, t, n, s, a) {
            var i;
            return (
              '                    <div class="rank-text-wrapper">\r\n                        <lol-uikit-resizing-text-field class="lp-text" data-max-width="200">' +
              e.escapeExpression(
                e.lambda(
                  null != (i = null != t ? t.rankInfo : t) ? i.lpText : i,
                  t,
                ),
              ) +
              "</lol-uikit-resizing-text-field>\r\n                    </div>\r\n"
          ...
          23: function (e, t, n, s, a) {
            var i;
            return (
              '                    <div class="rank-text-wrapper">\r\n                        <lol-uikit-resizing-text-field class="lp-progress-text" data-max-width="200">' +
              e.escapeExpression(
                e.lambda(
                  null != (i = null != t ? t.rankInfo : t)
                    ? i.lpProgressText
          ...
          main: function (e, t, n, s, a, i) {
            ...
            return (
              ...
              c(
                r(
                  null != (l = null != t ? t.titlesInfo : t) ? l.splitTitle : l,
                  t,
                ),
              ) +
              '</div>\r\n        <div class="split-duration-title">' +
              c(
                r(
                  null != (l = null != t ? t.titlesInfo : t)
                    ? l.splitDurationTitle
                    : l,
                  t,
                ),
              ) +
              ...
              (null !=
              (l = n.if.call(o, null != t ? t.statsInfo : t, {
                name: "if",
                hash: {},
              ...
              (l = n.if.call(
                o,
                null != (l = null != t ? t.rankInfo : t) ? l.isInApex : l,
                {
                  name: "if",
                  hash: {},
              ...
              (l = n.if.call(
                ...
                ? l
                : "") +
              '                <lol-uikit-resizing-text-field class="queue-type-text" data-max-width="200">' +
              c(
                r(
                  null != (l = null != t ? t.rankInfo : t)
                    ? l.queueTypeText
                    : l,
                  t,
                ),
              ...
              (l = n.if.call(
                o,
                null != (l = null != t ? t.rankInfo : t) ? l.isInPlacements : l,
                {
                  name: "if",
                  hash: {},
      ...
      (e, t, n) => {
        ...
        e.exports = s.Ember.Component.extend({
          ...
          init() {
            this._super(...arguments),
              this._initPlayerNotifications(),
              this._initDataBindings();
          },
          currentSplit: s.Ember.computed(
            "splitsConfig",
            "splitsConfig.currentSplitId",
            function () {
          ...
          willDestroy() {
            this._super(...arguments),
              this.rankedDataBinding.unobserve(
                "/lol-ranked/v1/eos-notifications",
                this,
              );
          },
          _initPlayerNotifications() {
            s.Social.playerNotifications().registerToastRenderer(
              r,
              "eos",
              this._renderEosNotification.bind(this),
            ),
              this.set("isPlayerNotificationsInitialized", !0);
          },
          _initDataBindings() {
            (this.rankedDataBinding = (0, s.dataBinding)(
              "/lol-ranked",
              (0, s.getProvider)().getSocket(),
            )),
              this.rankedDataBinding.observe(
                "/v1/eos-notifications",
                this._handleEoSNotifications.bind(this),
              );
          },
          ...
          _displayEosNotification(e) {
            ...
            let m = "",
              g = "";
            const h = (0, i.isTftQueueType)(u) ? "TFT" : "SR";
            switch (c) {
              case l.EOS_NOTIFICATION_TYPES.FIRST_WARNING:
              case l.EOS_NOTIFICATION_TYPES.SECOND_WARNING:
                (m = `ranked_eos_notification_last_day_warning_${h}_title`),
                  (g = `ranked_eos_notification_last_day_warning_${h}_description`);
                break;
              case l.EOS_NOTIFICATION_TYPES.SEASON_ENDED:
                (m = `ranked_eos_notification_ended_${h}_title`),
                  (g =
                    e.tier && "DEFAULT" !== e.tier
                      ? "ranked_eos_notification_ended_description"
                      : "ranked_eos_notification_ended_tier_DEFAULT");
                break;
              default:
                return;
            }
            const f = this.get("currentSplit");
            if (!f && !(0, i.isTftQueueType)(u)) return;
            const E = e.seasonEndTime - 36e5,
              _ = {
                source: r,
                type: "eos",
                titleKey: m,
                ...
                iconUrl: "/fe/lol-static-assets/images/ranked-emblem.png",
                data: {
                  date: (0, a.convertDateMillisToString)(E, o, {
                    month: "long",
                    day: "numeric",
                  }),
                  year: (0, a.convertDateMillisToString)(E, o, {
                    year: "numeric",
                  }),
                  split: f.toString(),
                  rank: s.LeagueTierNames.getFullTierDivisionName(d, p),
                  queue: s.LeagueTierNames.getRankedQueueName(u),
                },
              };
            n.push(t),
              (0, s.dataBinding)("player-notifications").post(
                "/v1/notifications",
                _,
              ),
              (0, s.dataBinding)("lol-ranked").post(
                `/v1/eos-notifications/${t}/acknowledge`,
                {},
              );
          },
          _renderEosNotification(e) {
            ...
            return (
              ...
              t.classList.add("eos-notification"),
              t
            );
          },
        });
      ...
      (e, t, n) => {
        ...
        const u = n(129),
          ...
          h = "CHAMPION_SKIN",
          f = new Map();
        f.set("RANKED_FLEX_SR", "FLEX"),
          f.set("RANKED_SOLO_5x5", "SOLODUO"),
          (e.exports = a.Ember.Component.extend(d, {
            ...
            splits: a.Ember.computed(
              ...
              function () {
                ...
                if (e && e.length)
                  return (
                    (e = a.Lodash.cloneDeep(e)),
                    e.sort((e, t) => parseInt(e.splitId) - parseInt(t.splitId)),
                    e
                  );
              },
            ),
            highestRankedNonTFTEntryQueue: a.Ember.computed.alias(
              "currentRankedStats.highestRankedEntrySR",
            ),
            eligibleNonTFTQueues: a.Ember.computed(
              "currentRankedStats",
              "currentRankedStats.queues.[]",
              function () {
                return this._getAllEligibleNonTFTQueues(
                  this.get("currentRankedStats"),
                );
              },
            ),
            isGameflowPhaseValid: a.Ember.computed(
              "gameflowSession",
            ...
            isConfigReady: a.Ember.computed(
              "rewardsService",
              "rewardsService.championSkinCatalog.[]",
              "rewardsService.emoteCatalog.[]",
              "rewardsService.summonerIconCatalog.[]",
              "careerStatsService",
              "isSeasonMemorialModalEnabled",
              "isPreseason",
              "eosRewardsConfig",
              "hasSeasonMemorialModalShownThisSession",
              "honorProfile",
              "honorProfile.honorLevel",
              "honorConfig",
              "isGameflowPhaseValid",
              function () {
                return this._isReady();
              },
            ),
            isConfigReadyObserver: a.Ember.observer(
              "isConfigReady",
              function () {
                this.get("isConfigReady") && this._initializeModal();
              },
            ),
            isHonorEligible: a.Ember.computed(
              "honorConfig.Enabled",
              "honorProfile.honorLevel",
              function () {
                return (
                  this.get("honorConfig.Enabled") &&
                  this.get("honorProfile.honorLevel") >=
                    this.get("seasonMemorialModalMinHonorLevel")
                );
              },
            ),
            _isReady() {
              const e = this.get("accountLeaguesSettings"),
                ...
                l = this.get("isPreseason"),
                o = this.get("rewardsService"),
                ...
                E = e.data && e.data[p] >= t,
                _ = Boolean(d),
                S = o && c && c.length && u && u.length && r && r.length,
                T = Boolean(n),
                v = Boolean(s);
              return (
                i &&
            ...
            _initializeModal() {
              ...
              this.get("careerStatsService")
                .loadCurrentSeasonStatsGames(e.puuid)
                .then((e) => {
                  this._tryToDisplaySeasonMemorialModal(e),
                    this.set("hasSeasonMemorialModalShownThisSession", !0);
                });
            },
            _tryToDisplaySeasonMemorialModal: function (e) {
              const t = this.get("currentSeason"),
                ...
                l = this._getBestChampionStatsPanelData(
                  e.games,
                  n,
                  a,
                  s,
            ...
            _renderSeasonMemorialModal: function (e, t) {
              ...
              return (
                t.length <= 4 && (i.spaceRewardsCss = "space-around"),
                this._renderModal(u, i)
              );
            },
              ...
              if (s)
                return {
                  ...
                  splitTitle: `${this.get("tra").formatString(
                    ...
                    "SEASON_MEMORIAL_TAKEOVER_SPLIT_NAME",
                    { splitNumber: s.splitId },
                  )}`,
                  splitDurationTitle: this.get("tra").formatString(
                    "SPLIT_START_TAKEOVER_SPLIT_DURATION_TITLE",
                    {
                  ...
                  rewardsTitle: this.get("tra").formatString(
                    "SEASON_MEMORIAL_TAKEOVER_REWARDS_TITLE",
                    {
                      seasonYear: (0, o.convertDateMillisToString)(
                        s.endTimeMillis,
                        e,
            ...
            _getSeasonMemorialModalRewardsInfoPromise: function () {
              const e = this.get("currentSeason"),
                ...
                o = this.get("eosSkinEligibilityMinimumTier"),
                r = (t.splitsProgress, []),
                c = [],
                u = n.seasons[e],
                d = u ? u.rewards : null,
                p =
                  a.LeaguesConsts.TIER_NAME_TO_ORDINAL[
                    s.previousSeasonAchievedTier
                  ];
              if (d) {
                const e = a.LeaguesConsts.TIER_NAME_TO_ORDINAL[o];
                if (p >= e) {
                    ...
                    const e = h,
                      n = {
                        description: this.get(
                          `tra.REWARD_TYPE_${e}_DESCRIPTION`,
                        ),
                        cssClass: `reward-image-${e}`,
                      };
                    c.push(a.LeagueTierNames.asyncGetRewardImage(t)), r.push(n);
                  }
                }
                const t = this.get("eosChromaEligibilityMinimumTier"),
                  n = this.get("eosChromaEligibilityMaximumTier"),
                  s = a.LeaguesConsts.TIER_NAME_TO_ORDINAL[t],
                  u = a.LeaguesConsts.TIER_NAME_TO_ORDINAL[n];
                i &&
                  i.length &&
                  i.forEach((e) => {
                    if (s && u && p >= s)
                      for (let e = s; e <= p; e++) {
                        const t = a.LeaguesConsts.TIERS[e],
                        ...
                        if (s) {
                          const e = h,
                            t = {
                              description: this.get(
                                "tra.REWARD_TYPE_CHROMA_DESCRIPTION",
                              ),
                              cssClass: `reward-image-${e}`,
                            };
                          c.push(a.LeagueTierNames.asyncGetRewardImage(s)),
                            r.push(t);
                        }
                      }
                    const t =
                        d[
                          `SUMMONER_ICON_${f.get(e.queueType)}_${
                            e.previousSeasonAchievedTier
                          }`
                        ],
                      n = t ? t.id : null;
                    if (n) {
                      const t = l.SUMMONER_ICON_REWARD_TYPE,
                        s = {
                          description: this.get(
                            `tra.SEASON_MEMORIAL_TAKEOVER_REWARD_TYPE_${t}_${e.queueType}_DESCRIPTION`,
                          ),
                          cssClass: `reward-image-${t}`,
                        };
                      c.push(a.LeagueTierNames.asyncGetRewardImage(n)),
                        r.push(s);
                    }
                  });
              }
            ...
            _getSeasonMemorialModalRankInfo: function () {
              const e = this.get("currentRankedStats"),
                ...
                s = t.previousSeasonAchievedDivision;
              return {
                currentRankTitle: this.get(
                  "tra.SEASON_MEMORIAL_TAKEOVER_FINAL_RANK_TEXT",
                ),
                currentRankTier: n,
                currentRankDivision: s,
                currentRankText: a.LeagueTierNames.getFullTierDivisionName(
                  n,
                  s,
                ),
                queueTypeText: this.get("tra").formatString(
                  "SPLIT_START_TAKEOVER_QUEUE_TYPE_TEXT",
                  {
                    queueType: a.LeagueTierNames.getRankedQueueName(
                      t.queueType,
                    ),
                  },
                ),
                ...
                winsText: this.get("tra").formatString(
                  "SEASON_MEMORIAL_TAKEOVER_WINS_TEXT",
                  { wins: t.wins },
                ),
              };
            },
            _getSeasonMemorialModalHonorInfo: function () {
              ...
              return {
                ...
                honorIneligibleText: this.get("tra").formatString(
                  "SEASON_MEMORIAL_TAKEOVER_HONOR_INELIGIBLE",
                  { level: t },
                ),
              };
            },
            _getSeasonMemorialModalStatsInfo: function (e) {
              ...
              if (e.dataType === m || e.dataType === g) {
                ...
                n = {
                  ...
                  statsData: [
                    e.championMastery ? e.championMastery.championLevel : 1,
                    this._formatNumber(
                      e.championMastery ? e.championMastery.championPoints : 0,
                      t,
                    ),
                    e.championMastery && e.championMastery.highestGrade
                      ? e.championMastery.highestGrade
                      : this.get(
                          "tra.SPLIT_START_TAKEOVER_STATS_CHAMP_MASTERY_NO_GRADE_DATA",
                        ),
            ...
            _getBestChampionStatsPanelData(e, t, n, s, a, i) {
              let l = this._getBestChampionInfoForRanked(e, t, n),
                o = m;
              return (
                l || ((l = this._getBestChampionInfoForNormals(e)), (o = g)),
                l
                  ? this._getStatsPanelDataForChampion(l, s, a, o)
                  : this._getStatsPanelDataForChampionMastery(i)
              );
            },
            _getBestChampionInfoForRanked(e, t, n) {
              const s = n.queueType;
              let i = this._getBestChampionInfoForQueue(
                e,
                s,
                n.previousSeasonAchievedTier,
              );
              return (
                i ||
                  a.Lodash.forEach(t.queues, (t) => {
            ...
            _getStatsPanelDataForChampion(e, t, n, s) {
              const a = this.careerStatsAPI.getCareerStatsQueueType(
                e.queueType,
              );
              return t
                .getChampionStatPercentiles(e.championId, [
            ...
            _getRankedSeasonEndTime(e) {
              if (e && e.seasons) {
                ...
                for (let n = 0; n < t.length; n++) {
                  const s = t[n];
                  if (!(0, c.isTftQueueType)(s))
                    return e.seasons[s].currentSeasonEnd;
                }
              }
              return null;
            },
            _getAllEligibleNonTFTQueues(e) {
              ...
              return (
                e &&
                  e.queues &&
                  e.queues.forEach((e) => {
                    this._isRankedQueueValid(e) &&
                      !this._isRankedQueueTFT(e) &&
                      t.push(e);
                  }),
                t
              );
            ...
            _isRankedQueueValid: function (e) {
              return (
                Boolean(e) &&
                Boolean(e.queueType) &&
                Boolean(e.previousSeasonAchievedTier) &&
                e.previousSeasonAchievedTier !== a.LeaguesConsts.TIER_NAME_NONE
              );
            },
            _getMiniSeriesWinsNeeded: function (e) {
              if (e) {
      ...
      (e, t, n) => {
        ...
        e.exports = (s.default || s).template({
          1: function (e, t, n, s, a) {
            var i;
            return (
              '      <div class="rewards-container-restricted">\r\n        <div class="honor-ineligible-panel">\r\n            <div class="honor-ineligible-text">' +
              e.escapeExpression(
                e.lambda(
                  null != (i = null != t ? t.honorInfo : t)
                    ? i.honorIneligibleText
                    : i,
                  t,
                ),
              ) +
          ...
          3: function (e, t, n, s, a, i) {
            var l,
              ...
              r = e.escapeExpression;
            return (
              '          <div class="rewards-container-column">\r\n              <img src="' +
              r(o(null != (l = i[0][0]) ? l.imagePath : l, t)) +
              '" class="rewards-image ' +
              r(o(null != (l = i[0][0]) ? l.cssClass : l, t)) +
              '">\r\n              <div class="reward-description">' +
          ...
          main: function (e, t, n, s, a, i) {
            ...
            return (
              '<div class="season-memorial-modal">\r\n  <div class="rewards-container">\r\n' +
              (null !=
              (l = n.unless.call(
                r,
                null != (l = null != t ? t.honorInfo : t)
                  ? l.isHonorEligible
                  : l,
                {
                  name: "unless",
                ...
                ? l
                : "") +
              '    <lol-uikit-scrollable id="rewards-scroll-container" class="' +
              u(
                c(
                  null != (l = null != t ? t.honorInfo : t)
                    ? l.rewardsContainerCss
                    : l,
                  t,
                ),
              ) +
              '">\r\n      <div class="rewards-images-container ' +
              u(
                "function" ==
                  typeof (o =
                    null !=
                    (o =
                      n.spaceRewardsCss || (null != t ? t.spaceRewardsCss : t))
                      ? o
                      : n.helperMissing)
                  ? o.call(r, {
              ...
              '">\r\n' +
              (null !=
              (l = n.each.call(r, null != t ? t.rewardsInfo : t, {
                name: "each",
                hash: {},
              ...
              u(
                c(
                  null != (l = null != t ? t.statsInfo : t) ? l.statsTitle : l,
                  t,
                ),
              ) +
              '</div>\r\n                    <div class="stats-champion-name">' +
              ...
              u(
                c(
                  null != (l = null != t ? t.statsInfo : t) ? l.statsFooter : l,
                  t,
                ),
              ) +
              '</div>\r\n            </div>\r\n        </div>\r\n        <div class="rank-panel">\r\n            <div class="rank-headers">\r\n                <div class="rank-text-wrapper">\r\n                    <lol-uikit-resizing-text-field class="current-rank-title" data-max-width="200">\r\n                        ' +
              ...
              '">\r\n                            </lol-regalia-emblem-element>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n            <div class="rank-progress-footnote">\r\n              <div class="rank-text-wrapper">\r\n                <lol-uikit-resizing-text-field class="lp-text" data-max-width="200">' +
              u(c(null != (l = null != t ? t.rankInfo : t) ? l.lpText : l, t)) +
              '</lol-uikit-resizing-text-field>\r\n              </div>\r\n              <div class="rank-text-wrapper">\r\n                <lol-uikit-resizing-text-field class="wins-text" data-max-width="200">' +
              u(
                c(null != (l = null != t ? t.rankInfo : t) ? l.winsText : l, t),
              ) +
              "</lol-uikit-resizing-text-field>\r\n              </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>"
            );
          },
      ...
      (e, t, n) => {
        ...
        const o = n(132),
          ...
          S = {
            ...
            [_]: "CherryRatedPromotionVignetteComponent",
          },
          T = { [c]: 500, [u]: 1e3, [d]: 500, [f]: 1e3, [E]: 1e3, [_]: 1e3 },
          v = {
            [c]: "LARGE",
            [u]: "SMALL",
            [d]: "LARGE",
        ...
        e.exports = s.Ember.Component.extend(r, {
          ...
          init: function () {
            this._super.apply(this, arguments),
              this.get("rankedService").observe(
                "/v1/current-ranked-stats",
                this,
                this._processRankedStats,
              ),
              this.get("settingsService").observe(
                "/v2/ready",
                this,
                this._handleSettingsReady,
              );
          },
          willDestroyElement: function () {
            this._super(...arguments),
              this.get("rankedService").unobserve(this),
              this.get("settingsService").unobserve(this);
          },
          _handleSettingsReady: function (e) {
            e &&
              this.settingsService
                .get("/v2/account/LCUPreferences/lol-leagues")
                .then((e) => {
                  this.set("accountLeaguesSettings", e);
                })
                .then(() => {
                  this.rankedService.observe(
                    "/v1/global-notifications",
                    this,
                    this._processGlobalNotifications,
                  );
                });
          },
          _processRankedStats: function (e) {
            e &&
              ...
              this.get("loadedRankedStats") ||
                (this.get("rankedService").observe(
                  "/v1/notifications",
                  this,
                  this._processNotifications,
                ),
                this.set("loadedRankedStats", !0)));
          },
          _processNotifications: function (e) {
            if (e)
              for (let t = 0; t < e.length; t++) {
                ...
                s.has(n.id) ||
                  (s.add(n.id), this._waitForUnlock(this._showNotification, n)),
                  this.set("displayedNotificationsIds", s);
              }
          },
          _processGlobalNotifications: function (e) {
            ...
            for (let s = 0; s < e.length; s++) {
              ...
              const l = `${a.notifyReason}-${a.queueType}`;
              n.has(l) ||
                (t[l] && !(t[l] < i)) ||
                (n.add(l),
                this._waitForUnlock(this._showGlobalNotification, a)),
                this.set("displayedGlobalNotifications", n);
            }
          },
          _showGlobalNotification: function (e) {
            ...
            n.setAttribute("ranked-tier", e.tier),
              t.appendChild(n),
              s.Ember.run.later(() => {
                this._getDisplayNames([e.participantId]).then((n) => {
                  ...
                  if (Array.isArray(n) && n[0]) {
                    const e = n[0];
                    a = s.playerNames.isUsingAlias
                      ? `${e.gameName} #${e.tagLine}`
                      : e.displayName;
                  }
                  const [i, l] = this._getGlobalNotificationText(e, a);
                  this.toastCelebrationManager.add({
                    data: { title: i, details: l, iconElement: t },
                    timing: "slow",
                    onClick: this._handleGlobalNotificationClicked.bind(
                      this,
                      e,
                    ),
                  });
          ...
          _getGlobalNotificationText(e, t) {
            ...
            return (
              e.notifyReason === g
                ? ((n = i.formatString("TOAST_FIRST_CHALLENGER_HEADER", {
                    name: t,
                  })),
                  (s = i.formatString("TOAST_FIRST_CHALLENGER_BODY", {
                    queue: i.get(`QUEUE_NAME_${l}`),
                    name: t,
                  })))
                : e.notifyReason === h &&
                  ((n = i.formatString("TOAST_FINAL_RANK_ONE_HEADER", {
                    seasonYear: this._getSeasonYear(l),
                  })),
          ...
          _handleGlobalNotificationClicked(e) {
            e.notifyReason === g
              ? s.Telemetry.sendEvent("leagues-first-challenger-toast-clicked")
              : e.notifyReason === h &&
                s.Telemetry.sendEvent("leagues-final-rank-one-toast-clicked");
          },
          _sendGlobalNotificationShownTelemetry(e) {
            e.notifyReason === g
              ? s.Telemetry.sendEvent("leagues-first-challenger-toast-shown")
              : e.notifyReason === h &&
                s.Telemetry.sendEvent("leagues-final-rank-one-toast-shown");
          },
          _showNotification: function (e) {
            "TOAST" === e.displayType
              ? this._showToastNotification(e)
              : "VIGNETTE" === e.displayType
                ? e.notifyReason === u && e.rewardEarnedId
                  ? this._showVignetteNotificationAfterLoadingRewardAssets(e)
                  : this._showVignetteNotification(e)
                : "MODAL" === e.displayType && this._showModalNotification(e);
          },
          _showVignetteNotificationAfterLoadingRewardAssets: function (e) {
            ...
            s.LeagueTierNames.asyncGetSplitRewardLocalization(t).then((n) => {
              ...
              a
                ? ((e.imagePath = a), this._showVignetteNotification(e))
                : s.LeagueTierNames.asyncGetRewardImage(t).then((t) => {
          ...
          _showVignetteNotification: function (e) {
            ...
            return s.LeagueTierNames.getTiersForQueue(e.queueType).then((r) => {
              const c = s.Ember.Object.create({
                ...
                u =
                  e.notifyReason === E &&
                  e.queueType === a.QUEUES.RANKED_CHERRY_QUEUE_TYPE;
              if (
                e.notifyReason === f &&
                e.queueType === a.QUEUES.RANKED_CHERRY_QUEUE_TYPE
              )
              ...
              const d = u ? S.CHERRY_RATED_TIER_PROMOTED : S[i],
                p = s.componentFactory.create({ type: d, data: c }),
                m = {
                  type: "VignetteCelebration",
                  data: { nextButtonText: t.get("LEAGUES_VIGNETTE_OK_BUTTON") },
                  height: o,
                  timing: "INFINITE",
                  content: p,
                  onClick: function () {
                    s.VignetteCelebrationManager.remove(this),
                      s.Ember.run.later(() => {
                        l(e);
                      }, 1e3);
                  },
          ...
          _showModalNotification: function (e) {
            ...
            const a = o({ header: t, body: n }),
              i = document.createElement("div");
            i.classList.add("leagues-modal-notification"), (i.innerHTML = a);
            const l = { contents: i.outerHTML, okText: s };
            this.get("modalManager")
              .add({ type: "DialogAlert", data: l })
              .okPromise.then(() => {
          ...
          _getModalNotificationText: function (e) {
            ...
            const l = e.notifyReason,
              o = e.changeReason,
              r = this._getQueueLoc(e);
            if (l === p)
              o === m
                ? ((n = t.get("LEAGUES_SYSTEM_DECAY_DEMOTION_TITLE")),
                  (s = t.formatString("LEAGUES_SYSTEM_DECAY_DEMOTION", {
                    tierDivisionLoc: this._getTierDivisionLoc(e),
                    queueType: r,
                  })))
                : !0 === e.eligibleForPromoHelper
                  ? ((n = t.get("LEAGUES_GENERAL_LEAGUE_UPDATE_TITLE")),
                    (s = t.formatString(
                      "LEAGUES_MESSAGE_PROMOHELPER_LEAGUE_DEMOTED",
                      {
                        tierDivisionLoc: this._getTierDivisionLoc(e),
                        queueType: r,
                      },
                  ...
                  : ((n = t.get("LEAGUES_GENERAL_LEAGUE_UPDATE_TITLE")),
                    (s = t.formatString("LEAGUES_MESSAGE_LEAGUE_DEMOTED", {
                      tierDivisionLoc: this._getTierDivisionLoc(e),
                      queueType: r,
                    })));
            else if ("MINISERIES_START" === l)
              (n = t.get("LEAGUES_GENERAL_LEAGUE_MINISERIES_TITLE")),
                (s = t.formatString("LEAGUES_MESSAGE_MINISERIES_START", {
                  miniseriesWins: e.miniseriesWins,
                  queueType: r,
                }));
            else if ("MINISERIES_LOST" === l)
              !0 === e.eligibleForPromoHelper
                ? ((n = t.get("LEAGUES_GENERAL_LEAGUE_MINISERIES_TITLE")),
                  (s = t.formatString(
                    "LEAGUES_MESSAGE_PROMOHELPER_MINISERIES_LOST",
                    { queueType: r },
                  )))
                : ((n = t.get("LEAGUES_GENERAL_LEAGUE_MINISERIES_TITLE")),
                  (s = t.formatString("LEAGUES_MESSAGE_MINISERIES_LOST", {
                    queueType: r,
                  })));
            else if ("MINISERIES_CANCEL" === l)
              o === m
                ? ((n = t.get("LEAGUES_SYSTEM_SERIES_ENDED_TITLE")),
                  (s = t.formatString("LEAGUES_SYSTEM_SERIES_ENDED_DECAY", {
                    queueType: r,
                  })))
                : ((n = t.get("LEAGUES_SYSTEM_SERIES_ENDED_TITLE")),
                  (s = t.formatString("LEAGUES_SYSTEM_SERIES_ENDED", {
                    queueType: r,
                  })));
            else if ("LEAGUE_DECAY_WARNING" === l)
              (n = t.get("LEAGUES_SYSTEM_DECAY_SOON_TITLE")),
                (s = t.formatString("LEAGUES_SYSTEM_DECAY_SOON", {
                  timeUntilInactivityStatusChangesDays: (0,
                  i.timeInMillisToDays)(e.timeUntilInactivityStatusChanges),
                  queueType: r,
                }));
            else if ("MINISERIES_DECAY_WARNING" === l)
              (n = t.get("LEAGUES_SYSTEM_PROMOTION_SERIES_DECAY_SOON_TITLE")),
                (s = t.formatString("LEAGUES_SYSTEM_SERIES_INACTIVITY", {
                  timeUntilInactivityStatusChangesDays: (0,
                  i.timeInMillisToDays)(e.timeUntilInactivityStatusChanges),
                  queueType: r,
                }));
            else if (o === m)
              (n = t.get("LEAGUES_SYSTEM_DECAY_TITLE")),
                (s = t.formatString("LEAGUES_SYSTEM_DECAY", { queueType: r }));
            else {
              const i = e.afkLpPenaltyAmount,
                l = e.afkLpPenaltyLevel;
              e.wasAfkOrLeaver &&
                i < 0 &&
                l > 0 &&
                ((n = t.get(
                  "player_behavior_afk_lp_penalty_notification_header",
                )),
                (s =
                  l > 1
                    ? t.formatString(
                        "player_behavior_afk_lp_penalty_notification_body",
                        { numGamesRemaining: l - 1 },
                      )
                    : this.get(
                        "tra.player_behavior_afk_lp_penalty_notification_no_games_remaining_body",
                      )),
                (a = t.get("player_behavior_afk_lp_penalty_notification_cta")));
            }
            return [n, s, a];
          },
          _showToastNotification: function (e) {
            const [t, n] = this._getToastNotificationText(e),
              a = this._isToastMuted(e),
              i = document.createElement("div");
            (i.style.height = "100%"),
              (i.style.width = "100%"),
              (i.style.transform = "scale(1)");
            const l = document.createElement("lol-regalia-emblem-element");
            l.setAttribute("ranked-tier", e.tier),
              i.appendChild(l),
              s.Ember.run.later(() => {
                this.toastCelebrationManager.add({
                  data: { title: t, details: n, iconElement: i, isMuted: a },
                  timing: "slow",
                });
              }, 1e3),
              this._acknowledgeNotification(e);
          ...
          _getToastNotificationText: function (e) {
            ...
            return (
              "LEAGUE_SEEDED" === a
                ? ((t = this._getTierDivisionLpLoc(e)),
                  (n = s.formatString("TOAST_PROVISIONAL_START_BODY", {
                    queueType: i,
                  })))
                : a === d
                  ? ((t = s.formatString("TOAST_DIVISION_PROMOTION_HEADER", {
                      tierDivisionLoc: this._getTierDivisionLoc(e),
                    })),
                  ...
                  : a === p &&
                    ((t = s.formatString("TOAST_DEMOTION_HEADER", {
                      tierDivisionLoc: this._getTierDivisionLoc(e),
                    })),
          ...
          _acknowledgeNotification: function (e) {
            this.get("rankedService").post(
              `/v1/notifications/${e.id}/acknowledge`,
            );
            const t = this.get("displayedNotificationsIds");
            t.delete(e.id), this.set("displayedNotificationsIds", t);
          },
          _getTierDivisionLoc: (e) =>
            s.LeagueTierNames.getFullTierDivisionName(e.tier, e.division),
          _getTierDivisionLpLoc: (e) =>
            s.LeagueTierNames.getTierDivisionLpLoc(
              e.tier,
              e.division,
              e.leaguePoints,
            ),
          _getQueueLoc: (e) =>
            s.LeagueTierNames.getRankedQueueName(e.queueType),
          _getSeasonId(e) {
            const t = this.get("rankedStats");
            return t && t.seasons && t.seasons[e]
              ? t.seasons[e].currentSeasonId
              : null;
          },
          _getSeasonYear(e) {
            const t = this.get("rankedStats");
          ...
          _getDisplayNames(e) {
            return this.get("api.summoner").get(
              `/v2/summoners?ids=${JSON.stringify(e)}`,
            );
          },
          _translate: function (e, t) {
            return this.get("tra.formatString")(e, t);
          ...
          _waitForUnlock: function (e, t) {
            ...
            if (s.LockAndLoad.getLockState()) {
              const e = function () {
                s.LockAndLoad.removeEventListener("unlock", e),
                  setTimeout(function () {
                    n(t);
                  }, 5e3);
              };
        ...
        e.exports = (s.default || s).template({
          ...
          main: function (e, t, n, s, a) {
            ...
            return (
              ...
              c(
                typeof (i =
                  null != (i = n.header || (null != t ? t.header : t))
                    ? i
                    : o) === r
                  ? i.call(l, { name: "header", hash: {}, data: a })
                  : i,
              ) +
              '</h4>\r\n<hr class="heading-spacer" />\r\n<p>' +
              c(
                typeof (i =
                  null != (i = n.body || (null != t ? t.body : t)) ? i : o) ===
                  r
                  ? i.call(l, { name: "body", hash: {}, data: a })
                  : i,
              ) +
              "</p>\r\n"
            );
      ...
      (e, t, n) => {
        ...
        e.exports = s.Ember.Service.extend(i, {
          getRewardData: function (e, t, n) {
            if (e === a.CHAMPION_REWARD_TYPE)
              return this.getRewardFromCatalog(
                e,
                t,
                this.get("championSkinCatalog"),
              );
            if (e === a.EMOTE_REWARD_TYPE)
              return this.getRewardFromCatalog(e, t, this.get("emoteCatalog"));
            if (e === a.SUMMONER_ICON_REWARD_TYPE)
              return this.getRewardFromCatalog(
                e,
                t,
                this.get("summonerIconCatalog"),
              );
            if (e === a.REGALIA_REWARD_TYPE) return this.getRegalia(e, t, n);
            if (e === a.ETERNALS_CAPSULE_REWARD_TYPE)
              return this.getEternalsCapsule(e);
          ...
          getRewardFromCatalog: function (e, t, n) {
            ...
            s || (s = {});
            const { imagePath: a } = s,
              i = this.getSplitNumber(t);
            return { imagePath: a, split: i, loc: this.getRewardLoc(e, i) };
          },
          getRegalia: function (e, t, n) {
            ...
            return (
              (i =
                n && n.transparent
                  ? `${a.ASSET_PATH}images/Split_Reward_Level_${s}_Transparent.png`
                  : n && n.small
                    ? `${a.ASSET_PATH}images/Split_Reward_Level_${s}_Small.png`
                    : `${a.ASSET_PATH}images/Split_Reward_Level_${s}.jpg`),
              { imagePath: i, loc: this.getRewardLoc(e, s) }
            );
          },
          getEternalsCapsule(e) {
            return {
              imagePath:
                "/lol-game-data/assets/ASSETS/Loot/Eternals/capsule.png",
          ...
          getRewardLoc: function (e, t) {
            ...
            return (
              e === a.EMOTE_REWARD_TYPE
                ? (n = "LEAGUES_REWARD_EMOTE")
                : e === a.REGALIA_REWARD_TYPE
                  ? (n = "LEAGUES_REWARD_REGALIA")
                  : e === a.ETERNALS_CAPSULE_REWARD_TYPE &&
                    (n = "LEAGUES_ETERNALS_CAPSULE"),
              this.get("tra").formatString(n, { number: t })
            );
          },
          ...
          getRegaliaLevelToShow: function (e) {
            ...
            return t && void 0 !== t[n.splitId - 1]
              ? n.splitId - t[n.splitId - 1]
              : 0;
          },
          regaliaRewards: s.Ember.computed(
            "splitsConfig.rewardInfoByRewardId",
            function () {
              const e = this.get("splitsConfig.rewardInfoByRewardId");
              return e
                ? Object.keys(e)
                    .map((t) => e[t])
                    .filter((e) => e.rewardType === a.REGALIA_REWARD_TYPE)
                : [];
            },
          ),
          numberOfNotEarnedRegalia: s.Ember.computed(
            "myRankedStats.splitsProgress",
            "regaliaRewards.[]",
            "splitsConfig.currentSplitId",
            function () {
      ...
      (e, t, n) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.default = function (e, t, n) {
            ...
            (a.className = "lol-leagues lol-leagues-full"),
              (a.type = "LeaguesRootComponent");
            const u = document.createElement("div");
            (u.className = "lol-leagues lol-leagues-modal"),
              (u.type = "LeaguesRootComponent");
            ...
            r(m, a, t, !1, null, h),
              ...
              (f = p),
              (E = g),
              f.addEventListener("showSubsection", (e, t) => {
                if (!t || !t.puuid) return;
                const n = l + t.puuid;
                (0, s.dataBinding)(i, (0, s.getProvider)().getSocket())
                  .get(n)
                  .then((e) => {
                    const t = null !== e && e.length > 0;
                    E.setEnabled(t), E.setTooltip(t ? null : s.Tra.get(o));
                  });
              }),
              s.Tra.observe(() => {
                E.tooltip && E.setTooltip(s.Tra.get(o));
              }),
        ...
        const i = "/lol-ranked",
          l = "/v1/league-ladders/",
          o = "LEAGUES_UNRANKED_FRIEND";
        function r(e, t, n, a, i, l) {
          e.addEventListener("selected", (o) => {
            let r = null,
              c = null;
            if (
              (s.Telemetry.startTracingEvent("profile-ranked-rendered"),
              !o || !o.summonerId)
            )
              return (
                l && l.set("refreshTopChamps", !0),
                i || (i = n.create("LeaguesRootComponent", l)),
                void i.componentPromise.then(() => {
                  t.appendChild(i.domNode);
                })
              );
            (r = o.summonerId), (c = o.puuid);
            const u = n.create(
              "LeaguesRootComponent",
              o
                ? s.Ember.Object.create({
                    summonerId: r,
                    puuid: c,
            ...
            e.addEventListener("deselected", () =>
              (function (e, t) {
                if (e.lastDisplayedLeagueComponent) {
                  const { lastDisplayedLeagueComponent: n } = e;
                  t.removeChild(n.domNode),
                    n.onRemove(),
                    delete e.lastDisplayedLeagueComponent;
                }
              })(e, t),
            );
        }
        function c(e, t, n) {
          ...
          (0, s.dataBinding)(
            "/lol-platform-config",
            (0, s.getProvider)().getSocket(),
          ).observe("v1/namespaces/ClientSystemStates", (e) => {
            (l = !e || e.leagueServiceEnabled), u(i, l, o, n);
          });
          return (
            (0, s.dataBinding)(
              "/lol-ranked",
              (0, s.getProvider)().getSocket(),
            ).observe("v1/signed-ranked-stats", (e) => {
              (o = Boolean(e)), u(i, l, o, n);
            }),
            i
          );
        }
        function u(e, t, n, s) {
          ...
          e &&
            (e.setEnabled(a),
            e.setTooltip(a ? null : s.get("LEAGUES_SERVICE_UNAVAILABLE")));
        }
      },
    ],
    t = {};
        ...
        function (s) {
          (0, s.registrationHandler)(function (s) {
            const i = s
              ...
              .overlay("/fe/lol-leagues/trans.json")
            ...
            return e.default
              .init(s, {
                ...
                dataBinding: (e) =>
                  e
                    ...
                    .getDataBinding("rcp-fe-lol-leagues"),
                Ember: (e) => e.get("rcp-fe-ember-libs").getEmber(),
                emberDataBinding: (e) =>
                  e
                    .get("rcp-fe-ember-libs")
                    .getEmberDataBinding("rcp-fe-lol-leagues"),
                LeaguesConsts: (e) =>
                  e
                ...
                SummonerIconManager: (e) =>
                  e.get("rcp-fe-lol-uikit").getSummonerIconManager(),
              ...
              .then(() => {
                const { Ember: s } = e.default,
                  { emberApplicationFactory: a, componentFactory: l } =
                    e.default,
                  o = (0, t.default)(s, i);
                e.default.tra = i;
                const r = n(3).default,
                  c = n(134).default;
                return r(l, a, o), c(e.default.getProvider(), l, i), {};
              });
          });
        },
        { once: !0 },
