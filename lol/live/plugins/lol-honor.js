  ...
  var e = [
      ...
      (e, t, o) => {
        ...
        t.default = class {
          constructor(e) {
            (this._screenRoot = e),
              (this._dataBinding = n.dataBinding.bindTo(
              ...
              (this._notificationObserver = new i.default());
          }
          _showHonor(e) {
            this._screenRoot.getElement().firstChild ||
              ...
              n.Telemetry.recordTracingStepEvent("UI_Honor: SHOW"),
              n.logger.info("rcp-fe-lol-honor: api: showHonor"));
          }
          _hideHonor() {
            ...
            n.Telemetry.recordTracingStepEvent("UI_Honor: HIDE"),
              n.logger.info("rcp-fe-lol-honor: api: hideHonor");
          }
          _waitForUnlock(e) {
          ...
          style: n.Ember.computed(
            ...
            function () {
              return `background-image: url(${this.get(
                "gameflowSession.map.assets.parties-background",
              )})`;
            },
          ),
          layout: i.default,
      ...
      (e, t, o) => {
        ...
        var s = n.Ember.Component.extend(a.default, {
          ...
          candidateClassName: n.Ember.computed(
            ...
            function () {
              return `candidate-${this.get("candidate.summonerName").replace(
                / /g,
                "_",
              )}`;
            },
        ...
        t.default = class {
          constructor() {
            (this._requirements = {
              ...
              (this._binding = n.dataBinding.bindTo(
                (0, n.getProvider)().getSocket(),
              )),
              this._binding.addObserver(p, this, this._handleSettingsReady),
              this._binding.addObserver(h, this, this._handleHonorConfig),
          ...
          _registerNotification() {
            n.Social.playerNotifications().registerToastRenderer(i, l, () => {
              ...
              return (
                ...
                e.classList.add("honor-recall-release-toast"),
                e
              );
            });
          }
          _handleSettingsReady(e) {
            (e = Boolean(e)),
              ...
              e &&
                this._binding.addObserver(u, this, this._handleSettingUpdate);
          }
          _handleSettingUpdate(e) {
            const t = Boolean(e && e.data && e.data.recallReleaseNotified);
            t
              ? this._removeObservers()
              : this._updateRequirements({ notificationSent: t });
          }
          _handleHonorConfig(e) {
            const t = Boolean(e && e.Enabled),
              o = Boolean(e && e.RecallRewardEnabled);
            this._updateRequirements({ honorEnabled: t, recallEnabled: o });
          }
          _updateRequirements(e) {
            Object.assign(this._requirements, e),
              this._trySendingRecallNotification();
          }
          _checkRequirements() {
            return (
              this._requirements.honorEnabled &&
              this._requirements.recallEnabled &&
              this._requirements.settingsReady &&
              !this._requirements.notificationSent
            );
          }
          _trySendingRecallNotification() {
            ...
            (0, n.dataBinding)("/player-notifications")
              .post("/v1/notifications", e)
              .then(() => {
                (0, n.dataBinding)("lol-settings").patch(
                  "/v2/account/LCUPreferences/lol-honor",
                  { data: { recallReleaseNotified: !0 }, schemaVersion: 1 },
                );
              });
          }
          _removeObservers() {
            this._binding.removeObserver(u, this),
              this._binding.removeObserver(p, this),
              this._binding.removeObserver(h, this);
          }
        };
      },
      (e, t, o) => {
      ...
      (e, t, o) => {
        ...
        e.exports = (n.default || n).template({
          ...
          main: function (e, t, o, n, r) {
            ...
            return (
              '<div class="honor-recall-release-toast">\r\n    <img class="honor-recall-release-toast-background" src="' +
              c(
                typeof (a =
                  null !=
                  (a = o.backgroundUrl || (null != t ? t.backgroundUrl : t))
                    ? a
                    : l) === s
                  ? a.call(i, { name: "backgroundUrl", hash: {}, data: r })
                  : a,
              ) +
              '"/>\r\n    <img class="honor-recall-release-toast-icon" src="' +
              c(
                typeof (a =
                  null != (a = o.iconUrl || (null != t ? t.iconUrl : t))
                    ? a
                    : l) === s
                  ? a.call(i, { name: "iconUrl", hash: {}, data: r })
                  : a,
              ) +
              '"/>\r\n    <div class="honor-recall-release-toast-text-container">\r\n        <div class="honor-recall-release-toast-title">' +
              c(
                typeof (a =
                  null != (a = o.title || (null != t ? t.title : t))
                    ? a
                    : l) === s
                  ? a.call(i, { name: "title", hash: {}, data: r })
                  : a,
              ) +
              '</div>\r\n        <div class="honor-recall-release-toast-detail">' +
              c(
                typeof (a =
                  null != (a = o.detail || (null != t ? t.detail : t))
                    ? a
                    : l) === s
                  ? a.call(i, { name: "detail", hash: {}, data: r })
                  : a,
              ) +
              "</div>\r\n    </div>\r\n</div>"
            );
        ...
        (t.default = function (e) {
          e.registerHelper("blockHelperMissing", function (t, o) {
            ...
            if (o.data && o.ids) {
              ...
              (i.contextPath = n.appendContextPath(o.data.contextPath, o.name)),
                (o = { data: i });
            }
            return a(t, o);
          });
        ...
        (t.default = function (e) {
          e.registerHelper("each", function (e, t) {
            ...
            if (
              (t.data &&
                t.ids &&
                (c = r.appendContextPath(t.data.contextPath, t.ids[0]) + "."),
              r.isFunction(e) && (e = e.call(this)),
              t.data && (s = r.createFrame(t.data)),
              e && "object" == typeof e)
            )
              if (r.isArray(e))
                for (var _ = e.length; a < _; a++)
                  a in e && d(a, a, a === e.length - 1);
              else {
                var h = void 0;
                for (var p in e)
                  e.hasOwnProperty(p) &&
                    (void 0 !== h && d(h, a - 1), (h = p), a++);
                void 0 !== h && d(h, a - 1, !0);
              }
        ...
        (t.__esModule = !0),
          (t.default = function (e) {
            e.registerHelper("log", function () {
              for (
                var t = [void 0], o = arguments[arguments.length - 1], n = 0;
              ...
              null != o.hash.level
                ? (r = o.hash.level)
                : o.data && null != o.data.level && (r = o.data.level),
                (t[0] = r),
                e.log.apply(e, t);
            });
          }),
        ...
        (t.default = function (e) {
          e.registerHelper("with", function (e, t) {
            ...
            return (
              t.data &&
                t.ids &&
                ((r = n.createFrame(t.data)).contextPath = n.appendContextPath(
                  t.data.contextPath,
                  t.ids[0],
                )),
              o(e, {
          ...
          r = {
            ...
            log: function (e) {
              if (
                ...
                console[t] || (t = "log");
                for (
                  var o = arguments.length, n = Array(o > 1 ? o - 1 : 0), a = 1;
                  a < o;
                  a++
                )
                  n[a - 1] = arguments[a];
      ...
      (e, t, o) => {
        ...
        (t.__esModule = !0),
          ...
          (t.template = function (e, t) {
            ...
            var o = {
              ...
              invokePartial: function (o, n, a) {
                a.hash &&
                  ((n = r.extend({}, n, a.hash)), a.ids && (a.ids[0] = !0)),
                  (o = t.VM.resolvePartial.call(this, o, n, a));
                var l = t.VM.invokePartial.call(this, o, n, a);
                if (
                  (null == l &&
                    t.compile &&
                    ((a.partials[a.name] = t.compile(o, e.compilerOptions, t)),
                    (l = a.partials[a.name](n, a))),
                  null != l)
                ) {
                  if (a.indent) {
                    for (
              ...
              program: function (e, t, o, n, r) {
                ...
                return (
                  t || r || n || o
                    ? (a = s(this, e, i, t, o, n, r))
                    : a || (a = this.programs[e] = s(this, e, i)),
                  a
                );
              },
              data: function (e, t) {
                ...
                e.useDepths &&
                  (i = r.depths
                    ? t != r.depths[0]
                      ...
                      : r.depths
                    : [t]),
                (c = d(e.main, c, o, r.depths || [], a, s))(t, r)
              );
            }
            return (
              (n.isTop = !0),
              (n._setup = function (n) {
                n.partial
                  ...
                  : ((o.helpers = o.merge(n.helpers, t.helpers)),
                    e.usePartial &&
                      (o.partials = o.merge(n.partials, t.partials)),
                    (e.usePartial || e.useDecorators) &&
                      (o.decorators = o.merge(n.decorators, t.decorators)));
              }),
          ...
          (t.wrapProgram = s),
          (t.resolvePartial = function (e, t, o) {
            e
              ? e.call || o.name || ((o.name = e), (e = o.partials[e]))
              : (e =
                  "@partial-block" === o.name
                    ? o.data["partial-block"]
                    : o.partials[o.name]);
            return e;
          }),
              ...
              (function () {
                ...
                (a = o.data["partial-block"] =
                  function (t) {
                    ...
                    return (
                      (o.data = l.createFrame(o.data)),
                      (o.data["partial-block"] = n),
                      e(t, o)
                    );
                  }),
                  e.partials &&
                    (o.partials = r.extend({}, o.partials, e.partials));
              })();
            void 0 === e && a && (e = a);
            if (void 0 === e)
              throw new i.default(
          ...
          function l(t) {
            ...
            return (
              ...
              o(
                ...
                e.partials,
                r.data || n,
                a && [r.blockParams].concat(a),
                l,
              )
            );
          }
          return (
            ((l = d(o, l, e, i, n, a)).program = t),
