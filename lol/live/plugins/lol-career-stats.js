(() => {
  var e = [
      ...
      (e, t, a) => {
        ...
        var d = s.Ember.Component.extend({
          ...
          queueFilters: s.Ember.computed("tra", "validQueues", function () {
            ...
            return s.Ember.A(
              s.Lodash.map(c.QUEUE_FILTERS, (t) =>
          ...
          champion: s.Ember.computed(
            ...
            function () {
              return this.get(
                `careerStatsService.indexedChampions.${this.get(
                  "data.championId",
                )}`,
              );
            },
          ...
          mostPlayedChampions: s.Ember.computed(
            ...
            "queueFilter.queueTypes.0",
            function () {
              const e = `${this.get("queueFilter.queueTypes.0")}.${this.get(
                  "currentSelectedPosition",
                )}`,
                t = this.get("tra"),
      ...
      (e, t) => {
        ...
        const s = [
          { queueTypes: ["rank5solo"], traKey: "rank5solo", isRanked: !0 },
          { queueTypes: ["rank5flex"], traKey: "rank5flex", isRanked: !0 },
          { queueTypes: [a[0]], traKey: a[0], isRanked: !1 },
          { queueTypes: [a[1]], traKey: a[1], isRanked: !1 },
        ];
        t.QUEUE_FILTERS = s;
        t.TIME_FILTERS = [
      ...
      (e, t, a) => {
        ...
        var c = s.Ember.Component.extend({
          ...
          statsDescriptionTooltipTitle: s.Ember.computed(
            ...
            function () {
              return this.get("tra").get(
                `career_stats_detail_stat_description_title_${this.get(
                  "data.name",
                )}`,
              );
            },
          ...
          statsDescriptionTooltipContent: s.Ember.computed(
            ...
            function () {
              return this.get("tra").get(
                `career_stats_detail_stat_description_content_${this.get(
                  "data.name",
                )}`,
              );
            },
          ...
          _drawAxes(e, t, a, n, o, l) {
            ...
            e.append("svg:g")
              ...
              .attr(
                "transform",
                `translate(${t.margin.left + t.axis.x.padding.x},${
                  t.height + t.margin.top + t.axis.x.padding.y
                })`,
              )
              .call(r);
            const i = s.d3.svg
            ...
            e.append("svg:g")
              ...
              .attr(
                "transform",
                `translate(${t.margin.left + t.axis.y.padding.x},${
                  t.margin.top + t.axis.y.padding.y
                })`,
              )
              .call(i);
        ...
        var c = s.Ember.Component.extend({
          ...
          queueFilters: s.Ember.computed(
            ...
            function () {
              ...
              return s.Ember.A(
                s.Lodash.map(o.QUEUE_FILTERS, (t) =>
                  s.Ember.Object.create(
                    s.Lodash.assign(
                      {
                        displayName: this.get("tra").get(
      ...
      (e, t, a) => {
        ...
        var c = s.Ember.Component.extend({
          ...
          _showSummonerGamesNotEnoughModal(e, t, a, n) {
            const o = `career_stats_summoner_not_enough_${
              n ? "champion" : "position"
            }_game_this_season`;
            return s.ModalManager.add({
              type: "DialogAlert",
                        ...
                        winRate:
                          a > 0
                            ? (0, o.getWinRateDisplay)(t.stats.victory / a, 0) +
                              "%"
                            : p.get("career_stats_stats_unavailable_number"),
