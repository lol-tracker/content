  ...
  var e = [
        ...
        t.default = class {
          ...
          _registerComponents() {
            const e = {
              ...
              TeamPlannerService: v.default.extend({ privateApi: this }),
      ...
      (e, t, n) => {
        ...
        var l = a.Ember.Component.extend({
          ...
          teamPlannerService: a.Ember.inject.service("TeamPlanner"),
          remindersFeatureEnabled: a.Ember.computed.alias(
            "teamPlannerService.remindersFeatureEnabled",
          ),
          championCount: a.Ember.computed(
      ...
      (e, t, n) => {
        ...
        var k = a.Ember.Service.extend({
            ...
            u.observe(i, this, (e) => {
              ...
              u.observe(d, this, (e) => {
                void 0 !== e &&
                  ...
                  this.get("remindersFeatureEnabled") &&
          ...
          _generateTraitData(e) {
            ...
            for (const l in e) {
              const s = e[l],
                ...
                r = {};
              (r.id = l),
                (r.displayName = i.display_name),
                (r.icon_path = i.icon_path),
                (r.tooltipText = this._replaceTokens(i.tooltip_text, i, s)),
                (r.currentCount = s),
                this._calculateTraitLevel(i, s, r);
              const o = a.Ember.Object.create(r);
              t.pushObject(o);
            }
            return t;
          },
          ...
          saveAndExit(e = "tft-teamPlanner") {
            this.get("remindersFeatureEnabled") && u.patch(r, !0),
              u.put(m),
              this.privateApi.hide(e);
          },
