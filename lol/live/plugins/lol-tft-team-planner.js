(() => {
  var e = [
        ...
        t.default = class {
          constructor() {
            (this._teamPlannerInstance = null),
              ...
              this._initObservers(),
              (this.tftChampionsByAlias = l.tftChampionsByAlias),
              (this.tftItemsByName = l.tftItemsByName),
              (this.cssSheet = l.cssSheet),
              (this.tftTraitsById = l.tftTraitsById),
              (this.tftGameVariationsByAlias = l.tftGameVariationsByAlias),
              (this.tftSets = l.tftSets),
          ...
          hide(e) {
            ...
            (t.team_planner_reminders_clicked_count =
              this.remindersClickedCount),
              (t.team_planner_reminders_enabled = this.remindersEnabled),
            ...
            l.FixDataBindingMixin,
            {
              ...
              tftSets() {
                return this.retrieveData(
                  ...
                  eventSet: e.LCTFTModeData.mActiveSets[0],
                }));
              },
              tftItemsByName() {
                return this.retrieveData(
      ...
      (e, t, n) => {
        ...
        e.exports = { FixDataBindingMixin: s, DataBindingMixin: l };
      },
      (e, t, n) => {
        "use strict";
        ...
        const s = {
          ...
          hoverRemindersToggle: l(
            "/fe/lol-static-assets/sounds/sfx-uikit-button-circlegold-hover.ogg",
          ),
          toggleRemindersEnabled: l(
      ...
      (e, t, n) => {
        ...
        var l = a.Ember.Component.extend({
          ...
          tierListData: a.Ember.computed(
            "teamPlannerService.tftChampionsByAlias",
            "tra",
            function () {
              const e = [],
                t = [],
                n = {};
              return (
                this.get("teamPlannerService").tftChampionsByAlias.forEach(
                  (e, a) => {
                    const l = e.tier;
                    l in n ||
                      ((n[l] = { tierLevel: l, tierCost: l, unitListData: [] }),
                      t.push(l)),
                      n[l].unitListData.push(e);
                  },
                ),
                t.sort(),
                t.forEach((t) => {
      ...
      (e, t, n) => {
        ...
        var k = a.Ember.Service.extend({
          ...
          init() {
            this._super(...arguments),
              this.set("tftChampionsByAlias", a.Ember.Map.create()),
              ...
              a.Ember.RSVP.hash({
                ...
                this.set("tftChampionsByAlias", e.tftChampionsByAlias),
                  ...
                  this.set(
                    "tftChampionsByTrait",
                    this._mapTraitsToChampions(e.tftChampionsByAlias),
                  ),
                  this._initObservers();
              });
          },
          ...
          _mapTraitsToChampions(e) {
            ...
            return (
              ...
              Object.values(t).forEach((e) => {
                e.sort(
                  (e, t) =>
                    this.tftChampionsByAlias.get(e).tier -
                    this.tftChampionsByAlias.get(t).tier,
                );
              }),
              t
            );
              ...
              (e.conditional_trait_sets.forEach((e) => {
                t >= e.min_units
                  ? (!e.max_units || t <= e.max_units) &&
                    ((a = e.style_name), (l = e.style_idx))
                  : s < 0 && "kChromatic" !== e.style_name && (s = e.min_units);
              }),
              -1 === s)
            ) {
            ...
            for (
              a.forEach((e) => {
                if (0 === e.indexOf(f))
                  ...
                  for (; i.didReplace; )
                    (e = i.replacedString), (i = this._replaceFirstToken(e, s));
                  let o = n >= a.min_units;
                  a.max_units && (o = o && n <= a.max_units),
                    (e = o
                      ? (e = e.replace(g, v)).replace(_, y)
                      : (e = e.replace(g, b)).replace(_, x)),
                    r++,
                    (l += e + h);
                } else {
              ...
              (l = l.slice(0, l.length - 4)), (l = l.trim());
            return l;
          },
          _replaceFirstToken(e, t) {
            ...
            return {
              replacedString:
                e.slice(0, n.start) + s + e.slice(n.end + 1, e.end),
              didReplace: !0,
              error: a,
            };
          },
          ...
          _getIconTokenInfo(e) {
            ...
            return -1 === n || -1 === a
              ? null
              : { start: n, end: a, token: e.substring(n + 3, l) };
          },
          _getTokenInfo(e) {
            const t = e.indexOf("@");
            if (-1 === t) return null;
            ...
            return { start: t, end: n, precision: c, multiplier: i, token: l };
          },
          ...
          saveAndExit(e = "tft-teamPlanner") {
            u.patch(r, !0), u.put(m), this.privateApi.hide(e);
          },
          ...
          s = a.Ember.Component.extend({
            ...
            actions: {
              remindersToggleClick() {
                l.SFX.toggleRemindersEnabled.play(),
