                ...
                _generateTraitData(e) {
                    ...
                    for (const l in e) {
                        const s = e[l],
                            i = n.get(l),
                            r = {};
                        r.id = l, r.displayName = i.display_name, r.icon_path = i.icon_path, r.tooltipText = this._replaceTokens(i.tooltip_text, i, s), r.currentCount = s, this._calculateTraitLevel(i, s, r);
