(() => {
    ...
    var e = [, e => {
            ...
            var o, i = (o = n(3)) && o.__esModule ? o : {
                default: o
            };

            function s(e) {
                const t = document.createElement("link");
                return t.setAttribute("type", "text/css"), t.setAttribute("rel", "stylesheet"), t.setAttribute("id", e), t
            }
            t.default = class {
                constructor() {
                    this.fontLinkElementMain = s("typekit-fonts"), this.fontLinkElement = s("typekit-fonts"), this.styleLinkElement = s("typekit-styles"), this.fontLoadTimeout = null, this.headerElements = [this.fontLinkElement, this.styleLinkElement], this.fontFaces = [], this.publicApi = new i.default(this.headerElements, this.fontFaces), this.onStyleLoad = this.onStyleLoad.bind(this), this.current = {
                        region: null,
                        locale: null,
                        lang: null
                    }
                ...
                setLocaleModifiers(e, t, n) {
                    ...
                    document.documentElement.setAttribute("lang", t), Object.keys(o).forEach((e => {
                        const t = this.current[e],
                            n = o[e];
                        document.body.setAttribute(`data-${e}`, n), t !== n && (document.body.classList.remove(`typekit-${e}-${t}`), document.body.classList.add(`typekit-${e}-${n}`), this.current[e] = n)
                    }))
                }
                isValidRegionAndLocale({
                    region: e,
                    locale: t
                }) {
            ...
            function o(e, t, n) {
                e.fonts.clear(), t.forEach((t => e.fonts.add(t))), n.forEach((t => {
                    if ("typekit-fonts" === t.id) return;
                    const n = e.getElementById(t.id);
                    n ? n.setAttribute("href", t.href) : e.head.appendChild(e.importNode(t, !0))
                }))
            }
            Object.defineProperty(t, "__esModule", {
                value: !0
            ...
            t.default = class {
                constructor(e, t) {
                    this._headerElements = e, this._fontFaces = t, this._listeners = [], this._documents = new Set
                }
                ...
                updateDocuments() {
                    this._documents.forEach((e => o(e, this._fontFaces, this._headerElements)))
                }
            }
        }],
        t = {};
    ...
    function n(o) {
        ...
        i.addEventListener(s, (function(e) {
            (0, e.registrationHandler)((e => t.default.init(e, {
                dataBinding: e => e.get("rcp-fe-common-libs").getDataBinding("rcp-fe-lol-typekit"),
                ...
                return i.head.appendChild(e.fontLinkElement), i.head.appendChild(e.styleLinkElement), o.observe("/region-locale", (function(n) {
                    if (e.isValidRegionAndLocale(n)) {
                        ...
                        t.default.logger.trace("Region/Locale switching", {
                            ...
                            locale: i,
                            lang: s
                        }), e.loadStyles(o, i), e.setLocaleModifiers(o, i, s)
                    } else t.default.logger.error("Region/Locale not valid, ignoring this locale change", n)
                })), e.publicApi
            }))))
        }), {
            once: !0
