        ...
        const { Component: u, computed: d } = a.Ember,
          ...
          _ = u.extend(l.default, {
            ...
            _handleRmsNotificationFailed() {
              const e = {
                error: `Purchase error: failed RMS notification for transaction: ${this.get(
                  "currentRmsNotificationTransactionId",
                )}`,
              };
          ...
          o = s.extend({
            ...
            warnings: l("itemPurchaseOption", function () {
              ...
              return e
                ...
                .map((e) => {
                  const n = `cat_paw_charity_${e
                    .substring(7)
                    .toLowerCase()}_disclaimer`;
                  return t.exists(n)
                    ? t.get(n)
              ...
              const e = -1 * this.get("cantAffordBalance").remaining,
                ...
                l = a.modalManager.add({
                  ...
                  data: {
                    ...
                    onAccept: () => {
                      (0, a.dataBinding)("lol-store")
                        .get("/v1/paymentDetails?action=RP_PURCHASE", {
                          skipCache: !0,
                        })
                        .then((e) => {
                          let t = "RP_PURCHASE";
                          "CODE_REDEMPTION" === t && (t = "CODES_REDEMPTION"),
      ...
      (e, t, n) => {
        ...
        const { Component: s, computed: l } = a.Ember,
          o = s.extend({
            ...
            description: l.readOnly(
              "catalogItemPurchaseOption.item.description",
            ),
          });
        e.exports = o;
      },
        ...
        const { Component: s, computed: l } = a.Ember,
          o = s.extend({
            ...
            descriptionExpandedClass: l("isDescriptionExpanded", function () {
              return this.get("isDescriptionExpanded")
                ? "expanded"
                : "collapsed";
            }),
            descriptionVisibilityClass: l(
              "catalogItemPurchaseOption.item.description",
              function () {
                return this.get("catalogItemPurchaseOption.item.description")
                  ? "visible"
                  : "hidden";
              },
            ),
      ...
      (e, t, n) => {
        ...
        const { Component: i, computed: c } = s.Ember,
          r = i.extend({
            ...
            style: n(127),
            imagePath: c(
              "item.assets.iconPath",
              "item.assets.tilePath",
              function () {
                return this.get("item.assets.iconPath")
                  ? this.get("item.assets.iconPath")
                  : this.get("item.assets.tilePath")
                    ? this.get("item.assets.tilePath")
            ...
            itemPriceOrOwned: c(
              "item.owned",
              "item.bundledItemPrice.discountPrices.0.cost",
              "item.bundledItemPrice.discountPrices.0.currency",
              function () {
                const e = this.get(
                    "item.bundledItemPrice.discountPrices.0.cost",
                  ),
                ...
                return this.get("item.owned")
                  ? this.get("tra.cat_paw_bundled_item_purchased")
                  : e && t
                    ? e + " " + t
                    : null;
              },
            ...
            itemBackgroundPath: c("item.inventoryType", function () {
              if (
                this.get("item.inventoryType") ===
                l.PAW.INVENTORY_TYPES.CHAMPION_SKIN
              )
                return 'url("/fe/lol-paw/images/bg-chroma-card.jpg")';
            }),
            itemSubtitle: c(
              "item.inventoryType",
              "item.subInventoryType",
              "item.description",
              function () {
                ...
                switch (e) {
                  case l.PAW.INVENTORY_TYPES.CHAMPION_SKIN:
                    return t === o.default.CHROMA
                      ? this.get("tra.cat_paw_bundled_type_chroma")
                      : this.get("tra.cat_paw_bundled_type_skin");
            ...
            itemRarity: c("item.inventoryType", "item.tags", function () {
              ...
              if (
                ...
                return e.includes("statstone_epic")
      ...
      (e, t, n) => {
        ...
        const { Component: l, computed: o } = a.Ember,
          i = l.extend({
            ...
            currencyTypeLocalized: o(
              "catalogItemPurchaseOption.purchaseOptions.0.priceDetails.0.price.currencyType",
              function () {
                const e = this.get(
                  "catalogItemPurchaseOption.purchaseOptions.0.priceDetails.0.price.currencyType",
                );
                ...
                return (
                  e === s.PAW.CURRENCY_TYPES.IP &&
                    (t = this.get("tra.cat_paw_modal_currency_ip")),
                  t
                );
              },
            ),
            adjustedTotalTitleLocalized: o.readOnly(
              "tra.cat_paw_bundled_discount_adjusted_title",
            ),
            adjustedTotalAmmount: o.readOnly(
              "catalogItemPurchaseOption.purchaseOptions.0.priceDetails.0.price.price",
            ),
            unadjustedTotalTitleLocalized: o.readOnly(
              "tra.cat_paw_bundled_discount_unadjusted_title",
            ),
            unadjustedTotalAmmount: o(
              "catalogItemPurchaseOption.purchaseOptions.0.priceDetails.0.price.price",
              "catalogItemPurchaseOption.sale.discount",
              function () {
                const e =
                  ...
                  (1 -
                    this.get("catalogItemPurchaseOption.sale.discount") / 100);
        ...
        const { Component: c } = a.Ember,
          ...
          p = c.extend({
            ...
            classNameBindings: [
              ...
              "displayDisclaimers:has-disclaimers",
              "purchaseEnabled:purchase-enabled",
              "purchaseRestricted:purchase-restricted",
            ],
            layout: n(132),
            style: n(133),
            displayDisclaimers: a.Ember.computed.or(
              "displayBundleNonRefundableDisclaimer",
              "alwaysShowPurchaseDisclaimer",
            ),
            disclaimersAccepted: !1,
            displayBundleNonRefundableDisclaimer: a.Ember.computed(
            ...
            purchaseRestricted: a.Ember.computed(
              "validationErrors",
              function () {
                return !!this.get("validationErrors").find(
                  (e) =>
                    e.id === o.default.ValidationErrorKeys.PARENT_NOT_OWNED,
                );
              },
            ),
            purchaseEnabled: a.Ember.computed(
              "displayDisclaimers",
              "disclaimersAccepted",
              function () {
                return (
            ...
            hasMultiplePrices: a.Ember.computed(
              "catalogItemPurchaseOption.purchaseOptions",
              function () {
                return (
                  this.get("catalogItemPurchaseOption.purchaseOptions").length >
                  1
                );
              },
            ),
