  ...
  var e = [
      ...
      (e, t, n) => {
        ...
        e.exports = s.Ember.Component.extend({
          ...
          activePackTitle: s.Ember.computed("activePack.itemId", function () {
            const e = `new_player_pack_panel_title_${this.get(
              "activePack.itemId",
            )}`;
      ...
      (e, t, n) => {
        ...
        var i = a.Ember.Component.extend({
          ...
          progressBarStyle: a.Ember.computed(
            ...
            function () {
              return `width: ${
                (this.get("currentProgress") / this.get("totalCount")) * 100
              }%;`;
            },
          ),
          actions: {
      ...
      (e, t, n) => {
        ...
        e.exports = s.HTMLBars.template({
          id: "/mILupli",
          block:
            '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_24\\\\LeagueClientContent_Release\\\\15690\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-npe-rewards\\\\src\\\\app\\\\templates\\\\application.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","rcp-fe-lol-npe-rewards"],["flush-element"],["text","\\n  "],["open-element","div",[]],["static-attr","class","lol-npe-rewards-content"],["flush-element"],["text","\\n    "],["append",["unknown",["outlet"]],false],["text","\\n  "],["close-element"],["text","\\n"],["close-element"],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
          meta: {},
        });
      },
      (e, t, n) => {
            ...
            rewardsCalendarHeaderTitle: s.Ember.computed(
              ...
              function () {
                const e = this.get("tra"),
                  t = `calendar_rewards_header_${this.get(
                    "rewardsType",
                  )}_title`;
                return e.get(t);
              },
