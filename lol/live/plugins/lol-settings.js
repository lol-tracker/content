(() => {
  var e = [
      ...
      (e, t, n) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.default = function () {
            return a.emberApplicationFactory
              ...
              .addController("GameHotkeys", n(55).default)
              .addController("GameSound", n(56).default)
              .addController("GameInterface", n(58).default)
              .addController("GameGameplay", n(59).default)
              .addController("Replays", n(60).default)
              .addController("PrivacyNotice", n(61).default)
              .addController("TermsOfUse", n(62).default)
              .addController("ThirdpartyLicenses", n(63).default)
              .addController("Version", n(64).default)
              .addController("LegalStatements", n(65).default)
              .addComponent("ModalHeader", n(66).default)
              .addComponent("ModalFooter", n(67).default)
              .addComponent("NavigationBarGroup", n(68).default)
              .addComponent("NavigationBarGroupItem", n(69).default)
              .addComponent("BlockedPlayer", n(70).default)
              .addComponent("BlockListError", n(71).default)
              .addComponent("GameSoundContent", n(72).default)
              .addComponent("GameInterfaceContent", n(73).default)
              .addComponent("GameGameplayContent", n(74).default)
              .addComponent("GameHotkeysAdditionalSection", n(75).default)
              .addComponent("GameHotkeysAdditional", n(76).default)
              .addComponent("GameHotkeysPrimaryButton", n(79).default)
              .addComponent("GameHotkeysPrimary", n(80).default)
              .addComponent("GameHotkeysQuickcast", n(82).default)
              .addComponent("GameHotkeysContent", n(83).default)
              .addComponent("RepairGameButton", n(84).default)
              .addComponent("PublishingLocale", n(85).default)
              .addComponent("AccountVerification", n(86).default)
              .addComponent("SettingsSlider", n(87).default)
              .addComponent("PushToTalkKey", n(88).default)
              .addService("ModalManager", n(91).default)
              .addService("Patch", n(92).default)
              .addService("Persistence", n(93).default)
              .addService("Voice", n(95).default)
              .addHelper(
                "FormatKeyBindings",
              ...
              .addTemplate("application", n(96))
              .addTemplate("index", n(97))
              .addTemplate("general", n(98))
              .addTemplate("notifications", n(99))
              .addTemplate("chat", n(100))
              .addTemplate("sound", n(101))
              .addTemplate("voice", n(102))
              .addTemplate("block-list", n(103))
              .addTemplate("game-hotkeys", n(104))
              .addTemplate("game-sound", n(105))
              .addTemplate("game-interface", n(106))
              .addTemplate("game-gameplay", n(107))
              .addTemplate("replays", n(108))
              .addTemplate("privacy-notice", n(109))
              .addTemplate("terms-of-use", n(110))
              .addTemplate("thirdparty-licenses", n(111))
              .addTemplate("loading", n(112))
              .addTemplate("version", n(113))
              .addTemplate("legal-statements", n(114))
              .addTemplate("components/modal-header", n(115))
              .addTemplate("components/modal-footer", n(116))
              .addTemplate("components/navigation-bar-group", n(117))
              .addTemplate("components/navigation-bar-group-item", n(118))
              .addTemplate("components/blocked-player", n(119))
              .addTemplate("components/block-list-error", n(120))
              .addTemplate("components/repair-game-button", n(121))
              .addTemplate("components/publishing-locale", n(122))
              .addTemplate("components/account-verification", n(123))
              .addTemplate("components/settings-slider", n(124))
              .addTemplate("components/push-to-talk-key", n(125))
              .addTemplate("components/game-sound-content", n(126))
              .addTemplate("components/game-interface-content", n(127))
              .addTemplate("components/game-gameplay-content", n(128))
              .addTemplate("components/game-hotkeys-additional-section", n(129))
              .addTemplate("components/game-hotkeys-additional", n(130))
              .addTemplate("components/game-hotkeys-primary-button", n(131))
              .addTemplate("components/game-hotkeys-primary", n(132))
              .addTemplate("components/game-hotkeys-quickcast", n(133))
              .addTemplate("components/game-hotkeys-content", n(134));
          });
        var l,
          a = n(1),
                ...
                n &&
                  ...
                  (function (e) {
                    i.observe("/lol-settings/v2/config", (t) => {
                      t
                        ? (c(e, o.GAME_HOTKEYS, t.isHotkeysEnabled),
                          c(e, o.GAME_SOUND, t.isSoundEnabled),
                          c(e, o.GAME_INTERFACE, t.isInterfaceEnabled),
                          c(e, o.GAME_GAMEPLAY, t.isGameplayEnabled),
                          c(e, o.REPLAYS, t.isReplaysEnabled),
                          c(e, o.TERMS_OF_USE, t.isTermsEnabled),
                          c(e, o.PRIVACY_NOTICE, t.isPrivacyNoticeEnabled),
                          c(e, o.LEGAL_STATEMENTS, t.isLegalStatementsEnabled))
      ...
      (e, t) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.fromSavedToArray = c),
          (t.getModifiersPrefix = r),
          ...
          setReloadTitle: function () {
            const e =
              ...
              t = this.get("tra").formatString(
                "lol_general_settings_reload_title",
                { shortcut: e },
              );
            this.set("reloadTitle", t);
          },
          resetToDefault: function () {
            this.set("isProfilePrivate", i.setting === r.PRIVATE),
      ...
      (e, t, n) => {
        ...
        var S = a.Ember.Controller.extend(s.default, {
          ...
          sfxVolumeLabel: a.Ember.computed(r.property, function () {
            const e = Number.isInteger(this.get(r.property))
              ? this.get(r.property)
              : r.defaultValue;
            return this.get("tra").formatString(
      ...
      (e, t, n) => {
        ...
        var r = l.Ember.Controller.extend({
          ...
          validateSummonerName: function (e) {
            if ("" === e)
              return new a.default(
                "blank_name",
                "block_system_message_blank_summoner_name",
              );
            if (e.length < 3)
              return new a.default(
                "short_name",
                "block_system_message_name_too_short",
              );
            if (l.playerNames.isUsingAlias) {
              ...
              if (t)
                return new a.default(
                  "blank_tagline",
                  "block_system_message_blank_tagline",
                );
            }
            if (e.toUpperCase() === this.get("me").name.toUpperCase())
              return new a.default(
                "cannot_invite_self",
                "block_system_message_cannot_block_self",
              );
          ...
          setTooltipByKeys(e, t, n) {
            this.clearErrorPacketTimer &&
              l.Ember.run.cancel(this.clearErrorPacketTimer),
              this.set("errorPacket", {
                title: l.tra.formatString(e),
                text: l.tra.formatString(t, n),
              }),
              (this.clearErrorPacketTimer = l.Ember.run.later(
                this,
          ...
          blockSummoner(e) {
            i.get(`/lol-summoner/v1/summoners?name=${encodeURIComponent(e)}`)
              .then((e) =>
                i
                  .post(c, { summonerId: e.summonerId })
                  .catch(() =>
                    this.setTooltipByKeys(
                      "block_system_message_error_title",
                      "block_system_message_server_error",
                    ),
                  ),
              )
              .then(() => i.get(c, { skipCache: !0 }))
              .then((e) => {
                this.set("model.blockedPlayers", e),
                  this.set("blockInput", ""),
                  this.setTooltipByKeys(
                    "block_system_message_success_title",
                    "block_system_message_success_text",
                  );
              })
              .catch(() => {
                this.setTooltipByKeys(
          ...
          actions: {
            block() {
              ...
              if (t)
                return void this.setTooltipByKeys(
                  "block_system_message_error_title",
                  t.translationKey,
                  t.params,
                );
              const n = l.templateHelper.contentBlockDialog(
                l.tra.formatString("blocked_summoners_block_confirm_title"),
                l.tra.formatString("blocked_summoners_block_confirm_text", {
                  name: e,
                }),
                "dialog-medium",
              ...
              a.domNode.querySelector(".confirm-friend-actions").style.width =
                "360px";
            },
            unblock(e) {
              return i
      ...
      (e, t, n) => {
        ...
        var l,
          a = n(1),
          s = (l = n(57)) && l.__esModule ? l : { default: l };
      ...
      (e, t, n) => {
        ...
        const a = "Volume",
          ...
          d = { propertyName: "ThemeMusic", dataSection: s, dataType: c };
        var p = l.Ember.Component.extend({
          classNames: ["lol-settings-game-sound-content-component"],
          persistenceService: l.Ember.inject.service("persistence"),
          init() {
            this._super(...arguments),
              this._registerSliderAndCheckbox(r),
          ...
          resetToDefault() {
            const e = {};
            this._resetSlider(r.slider, e),
              this._resetCheckbox(r.checkbox, e),
              m.forEach((t) => {
          ...
          _resetCheckbox(e, t) {
            const {
              ...
              c = this._getGameSettingSchemaKey(l, n);
            let r;
            void 0 !== this.get(c) && null !== this.get(c)
              ? (r = this._getDisplayValue(this.get(c), a))
              : void 0 !== o && (r = o),
              this._appendSaveData(t, e, r),
              !0 === s && (r = !r),
              this.set(i, r);
          ...
          _registerComputedProperty(e) {
            const {
              ...
              c = this._getGameSettingsKey(n, t),
              r = this._getGameSettingSchemaKey(n, t);
            this.set(
              t,
              l.Ember.computed(c, r, () => {
                let e;
                return (
                  void 0 !== this.get(c) && null !== this.get(c)
          ...
          _bindEventListeners: l.Ember.on("didInsertElement", function () {
            this._bindMasterVolumeSliderAndCheckboxListeners(r),
              l.lodash.forEach(m, (e) => {
          ...
          _checkMasterVolumeStatus() {
            ...
            m.forEach((e) => {
              ...
              ((a && !n.checked) || (!a && n.checked)) &&
                ...
                this._saveProperty(r.checkbox, n.checked),
                l.logger.trace(
      ...
      (e, t, n) => {
        ...
        const s = [
          ...
          o = [
            ...
            { section: "General", dataKey: "PreferDX9LegacyMode" },
        ...
        var i = l.Ember.Component.extend({
          ...
          resetGeneralContent() {
            ...
            return (
              ...
              (e.PreferDX9LegacyMode = this.get(
                "gameSettingsSchema.General.PreferDX9LegacyMode.default",
              )),
              this.set(
                "gameSettings.General.PreferDX9LegacyMode",
                e.PreferDX9LegacyMode,
              ),
              e
            );
          },
      ...
      (e, t, n) => {
        ...
        var l,
          a = n(1),
          s = (l = n(77)) && l.__esModule ? l : { default: l };
        ...
        var s = l.Ember.Mixin.create({
          ...
          _createDialogContentDiv: function (e, t, n, l) {
            ...
            (m[0] = this.get(`inputSettings.${e}.${t}`)),
              ...
              0 !== n && (m[1] = n),
              (r.textContent = (0, a.formatAdditionalKeyBindings)(m));
            ...
            return (
              ...
              r.textContent
                ? (r.setAttribute("empty", !1), (u.disabled = !1))
                : (r.setAttribute("empty", !0),
                  (r.textContent = this.get(
              ...
              c.appendChild(u),
              s.appendChild(c),
              { contentDiv: s, keybindDiv: r, unbindButton: u }
            );
          },
          showKeybindingDialog: function (e, t, n) {
            let s = "";
            ...
            const o = this._createDialogContentDiv(e, t, n, s),
              ...
              m = (e) => {
                ...
                this.set("tempSavedValue", n),
                  ...
                  (c.disabled = !1),
                  r.enableAcceptButton();
              };
            r.disableAcceptButton(),
              ...
              r.domNode.setAttribute("tabindex", 0),
              r.domNode.focus(),
              (c.onclick = () => {
      ...
      (e, t, n) => {
        ...
        const { DEFAULT_PROFILE_PRIVACY: o } = s.PROFILE_PRIVACY,
          ...
          c = "/lol-summoner/v1/current-summoner/profile-privacy",
          r =
      ...
      (e, t, n) => {
        ...
        e.exports = l.HTMLBars.template({
          id: "tc1htYDk",
          block:
            '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_24\\\\LeagueClientContent_Release\\\\15690\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-settings\\\\src\\\\app\\\\templates\\\\index.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
          meta: {},
        });
      },
      (e, t, n) => {
      ...
      (e, t, n) => {
        ...
        e.exports = l.HTMLBars.template({
          id: "ILeW4fQz",
          block:
            '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_24\\\\LeagueClientContent_Release\\\\15690\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-settings\\\\src\\\\app\\\\templates\\\\loading.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["open-element","div",[]],["static-attr","style","display: flex; align-items: center; height: 100%;"],["flush-element"],["text","\\n  "],["append",["helper",["uikit-spinner"],null,[["style"],["margin-left: auto; margin-right: auto;"]]],false],["text","\\n"],["close-element"],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
          meta: {},
        });
      },
      (e, t, n) => {
        ...
        function (t) {
          (0, t.registrationHandler)(async function (t) {
            ...
            try {
              (a = await e.default
                .getProvider()
                .getOptional("rcp-fe-lol-honeyfruit-account-claiming")),
                (e.default.hfSettingsComponent = a.getSettingsComponent());
            } catch (e) {}
            const o = (0, n(5).default)();
            a && a.registerComponents(o), await o.build();
            const i = await e.default.ComponentFactory.create(o.getName())
            ...
            m.resolveOpenSettingsHandler((...e) => r.show(...e)),
              m.resolveCloseSettingsHandler(() => r.close());
