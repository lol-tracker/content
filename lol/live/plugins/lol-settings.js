(() => {
    var e = [, e => {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                return a.emberApplicationFactory.factoryDefinitionBuilder().setName("rcp-fe-lol-settings").setRoot(document.createElement("div")).setComponentFactory(a.ComponentFactory).setRouter(s.default).setEmber(a.Ember).setL10n(a.emberL10n).setTra(a.tra).setFeatureFlag("EMBER_CLI_COMPAT", !0).addRoute("Application", n(10).default).addRoute("General", n(11).default).addRoute("Notifications", n(12).default).addRoute("Chat", n(13).default).addRoute("Sound", n(14).default).addRoute("Voice", n(15).default).addRoute("BlockList", n(16).default).addRoute("GameHotkeys", n(17).default).addRoute("GameSound", n(18).default).addRoute("GameInterface", n(20).default).addRoute("GameGameplay", n(21).default).addRoute("Replays", n(22).default).addRoute("PrivacyNotice", n(23).default).addRoute("TermsOfUse", n(24).default).addRoute("ThirdpartyLicenses", n(25).default).addRoute("Version", n(26).default).addRoute("LegalStatements", n(27).default).addController("Application", n(28).default).addController("General", n(29).default).addController("Notifications", n(49).default).addController("Chat", n(50).default).addController("Sound", n(51).default).addController("Voice", n(52).default).addController("BlockList", n(53).default).addController("GameHotkeys", n(55).default).addController("GameSound", n(56).default).addController("GameInterface", n(58).default).addController("GameGameplay", n(59).default).addController("Replays", n(60).default).addController("PrivacyNotice", n(61).default).addController("TermsOfUse", n(62).default).addController("ThirdpartyLicenses", n(63).default).addController("Version", n(64).default).addController("LegalStatements", n(65).default).addComponent("ModalHeader", n(66).default).addComponent("ModalFooter", n(67).default).addComponent("NavigationBarGroup", n(68).default).addComponent("NavigationBarGroupItem", n(69).default).addComponent("BlockedPlayer", n(70).default).addComponent("BlockListError", n(71).default).addComponent("GameSoundContent", n(72).default).addComponent("GameInterfaceContent", n(73).default).addComponent("GameGameplayContent", n(74).default).addComponent("GameHotkeysAdditionalSection", n(75).default).addComponent("GameHotkeysAdditional", n(76).default).addComponent("GameHotkeysPrimaryButton", n(79).default).addComponent("GameHotkeysPrimary", n(80).default).addComponent("GameHotkeysQuickcast", n(82).default).addComponent("GameHotkeysContent", n(83).default).addComponent("RepairGameButton", n(84).default).addComponent("PublishingLocale", n(85).default).addComponent("AccountVerification", n(86).default).addComponent("SettingsSlider", n(87).default).addComponent("PushToTalkKey", n(88).default).addService("ModalManager", n(91).default).addService("Patch", n(92).default).addService("Persistence", n(93).default).addService("Voice", n(95).default).addHelper("FormatKeyBindings", a.Ember.Helper.helper(o.formatAdditionalKeyBindings)).addHelper("GetKeyBindingsModifier", a.Ember.Helper.helper(o.getPrimaryModifierDisplay)).addHelper("GetKeyBindingsMainKey", a.Ember.Helper.helper(o.getPrimaryMainKeyDisplay)).addTemplate("application", n(96)).addTemplate("index", n(97)).addTemplate("general", n(98)).addTemplate("notifications", n(99)).addTemplate("chat", n(100)).addTemplate("sound", n(101)).addTemplate("voice", n(102)).addTemplate("block-list", n(103)).addTemplate("game-hotkeys", n(104)).addTemplate("game-sound", n(105)).addTemplate("game-interface", n(106)).addTemplate("game-gameplay", n(107)).addTemplate("replays", n(108)).addTemplate("privacy-notice", n(109)).addTemplate("terms-of-use", n(110)).addTemplate("thirdparty-licenses", n(111)).addTemplate("loading", n(112)).addTemplate("version", n(113)).addTemplate("legal-statements", n(114)).addTemplate("components/modal-header", n(115)).addTemplate("components/modal-footer", n(116)).addTemplate("components/navigation-bar-group", n(117)).addTemplate("components/navigation-bar-group-item", n(118)).addTemplate("components/blocked-player", n(119)).addTemplate("components/block-list-error", n(120)).addTemplate("components/repair-game-button", n(121)).addTemplate("components/publishing-locale", n(122)).addTemplate("components/account-verification", n(123)).addTemplate("components/settings-slider", n(124)).addTemplate("components/push-to-talk-key", n(125)).addTemplate("components/game-sound-content", n(126)).addTemplate("components/game-interface-content", n(127)).addTemplate("components/game-gameplay-content", n(128)).addTemplate("components/game-hotkeys-additional-section", n(129)).addTemplate("components/game-hotkeys-additional", n(130)).addTemplate("components/game-hotkeys-primary-button", n(131)).addTemplate("components/game-hotkeys-primary", n(132)).addTemplate("components/game-hotkeys-quickcast", n(133)).addTemplate("components/game-hotkeys-content", n(134))
            };
            var l, a = n(1),
                s = (l = n(6)) && l.__esModule ? l : {
                    default: l
                },
                o = n(9)
        }, (e, t, n) => {
            ...
            var l = n(1),
                a = n(7);
            const s = l.Ember.Router.extend({
                location: "none"
            });
            s.map((function() {
                this.route(a.Category.GENERAL), this.route(a.Category.NOTIFICATIONS), this.route(a.Category.CHAT), this.route(a.Category.SOUND), this.route(a.Category.VOICE), this.route(a.Category.BLOCK_LIST), this.route(a.Category.GAME_HOTKEYS), this.route(a.Category.GAME_SOUND), this.route(a.Category.GAME_INTERFACE), this.route(a.Category.GAME_GAMEPLAY), this.route(a.Category.REPLAYS), this.route(a.Category.PRIVACY_NOTICE), this.route(a.Category.TERMS_OF_USE), this.route(a.Category.THIRDPARTY_LICENSES), this.route(a.Category.VERSION), this.route(a.Category.LEGAL_STATEMENTS)
            }));
            var o = s;
            t.default = o
        }, (e, t, n) => {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.Category = void 0, t.default = function() {
                const e = function() {
                        const e = {
                            name: "client",
                        ...
                        e.categories = [new s.default(o.GENERAL, "lol-general", "lol_settings_nav_title_general", !0, !0, e), new s.default(o.NOTIFICATIONS, "lol-notifications", "lol_settings_nav_title_notifications", e), new s.default(o.CHAT, "lol-chat", "lol_settings_nav_title_chat_and_friends", !0, !0, e), new s.default(o.SOUND, "lol-sound", "lol_settings_nav_title_sound", !1, !0, e), new s.default(o.VOICE, "lol-premade-voice", "lol_settings_nav_title_voice", !1, !0, e), new s.default(o.BLOCK_LIST, "lol-block-list", "lol_settings_nav_title_block_list", !0, !1, e)];
                        const t = {
                            name: "ingame",
                        ...
                        t.categories = [new s.default(o.GAME_HOTKEYS, "lol-in-game-hotkeys", "lol_settings_nav_title_hotkeys", !0, !0, t), new s.default(o.GAME_SOUND, "lol-in-game-sound", "lol_settings_nav_title_in_game_sound", !0, !0, t), new s.default(o.GAME_INTERFACE, "lol-in-game-interface", "lol_settings_nav_title_interface", !0, !0, t), new s.default(o.GAME_GAMEPLAY, "lol-in-game-gameplay", "lol_settings_nav_title_game", !0, !0, t), new s.default(o.REPLAYS, "lol-in-game-replays", "lol_settings_nav_title_replays", !0, !0, t)];
                        const n = {
                            name: "about",
                        ...
                        n.categories = [new s.default(o.PRIVACY_NOTICE, "lol-privacy-notice", "lol_settings_nav_title_privacy_notice", !1, !1, n), new s.default(o.TERMS_OF_USE, "lol-tou", "lol_settings_nav_title_tou", !1, !1, n), new s.default(o.THIRDPARTY_LICENSES, "lol-third-party-license", "lol_settings_nav_title_third_party_license", !1, !1, n), new s.default(o.VERSION, "lol-version", "lol_settings_nav_title_version", !0, !0, n), new s.default(o.LEGAL_STATEMENTS, "lol-legal-statements", "lol_settings_nav_title_legal_statements", !1, !1, n)];
                        const l = [e, t, n],
                            a = new Map([...e.categories, ...t.categories, ...n.categories].map((e => [e.routeName, e])));
                        return {
                            list: l,
                            byRouteName: a
                        }
                    ...
                    t = n => {
                        n && (i.unobserve("/lol-platform-config/v1/initial-configuration-complete", t), function(e) {
                            i.observe("/lol-settings/v2/config", (t => {
                                t ? (c(e, o.GAME_HOTKEYS, t.isHotkeysEnabled), c(e, o.GAME_SOUND, t.isSoundEnabled), c(e, o.GAME_INTERFACE, t.isInterfaceEnabled), c(e, o.GAME_GAMEPLAY, t.isGameplayEnabled), c(e, o.REPLAYS, t.isReplaysEnabled), c(e, o.TERMS_OF_USE, t.isTermsEnabled), c(e, o.PRIVACY_NOTICE, t.isPrivacyNoticeEnabled), c(e, o.LEGAL_STATEMENTS, t.isLegalStatementsEnabled)) : a.logger.warning("Failed to receive settings config")
                            }))
                        }(e))
                    };
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                return u(c(e[0])[e[1] - 1])
            }, t.fromKeyToSaved = function(e) {
                let t;
                t = i() ? s[e.code] : a[e.code];
                return void 0 !== t ? r(e) + t : void 0
            }, t.fromSavedToArray = c, t.getModifiersPrefix = r, t.getPrimaryMainKeyDisplay = function(e) {
                const [t] = e || [];
            ...
            var s = l.Ember.Route.extend({
                ...
                model() {
                    const e = this.get("persistenceService"),
                        t = [];
                    return t.push(e.getDefaultSettingPromise("account", "lol-general")), t.push(e.getDefaultSettingPromise("local", "video")), t.push(l.SharedComponents.getApi_UXSettings().getUXSettingsReadyPromise()), t.push(e.getDefaultSettingPromise("account", "lol-publishing-content")), t.push(a.get("/lol-platform-config/v1/namespaces/PublishingContent")), t.push(a.get("/lol-platform-config/v1/namespaces/AccountVerification")), t.push(a.get("/lol-platform-config/v1/namespaces/PlayerBehavior/CodeOfConductEnabled")), Promise.all(t).then((e => ({
                        generalSettings: e[0],
                        videoSettings: e[1],
                        uxSettings: l.SharedComponents.getApi_UXSettings().getUXSettings(),
                        publishingContentSettings: e[3],
                        publishingContentConfig: e[4],
                        accountVerificationConfig: e[5],
                        codeOfConductEnabled: e[6],
                        potatoOverrides: l.SharedComponents.getApi_UXSettings().getPotatoModeOverrides()
                    })))
                }
            });
            t.default = s
            ...
            var s = {
                ...
                model() {
                    ...
                    return e.get("gameSettingsReadyPromise").then((() => {
                        const t = [];
                        return t.push(e.getSettingPromise("GamePreferences", "account", "game-settings")), t.push(a.get("/lol-game-settings/v1/game-settings-schema")), Promise.all(t).then((e => ({
            ...
            var s = l.Ember.Route.extend({
                ...
                model() {
                    const e = this.get("persistenceService"),
                        t = [];
                    return t.push(e.getDefaultSettingPromise("local", "lol-replays")), t.push(a.get("/lol-replays/v1/rofls/path/default")), t.push(a.get("/lol-highlights/v1/highlights-folder-path/default")), t.push(a.get("/lol-replays/v1/configuration")), Promise.all(t).then((e => ({
                        replaysSettings: e[0],
            ...
            var l, a = n(1),
                s = (l = n(30)) && l.__esModule ? l : {
                    default: l
                },
                o = n(31);
            const {
                DEFAULT_PROFILE_PRIVACY: i,
                ProfilePrivacyEnabledState: c,
            ...
            var g = a.Ember.Controller.extend(s.default, {
                hfSettingsComponent: a.hfSettingsComponent,
                ...
                profilePrivacyEnabled: a.Ember.computed.equal("persistenceService.profilePrivacy.enabledState", c.ENABLED),
                isProfilePrivate: a.Ember.computed.equal("persistenceService.profilePrivacy.setting", r.PRIVATE),
                profilePrivacyObserver: a.Ember.observer("isProfilePrivate", (async function(e, t) {
                    try {
                        const e = this.get(t) ? r.PRIVATE : r.PUBLIC;
                ...
                computedSizeInfos: a.Ember.computed("validWindowSizes", p.property, (function() {
                    const e = [],
                ...
                clientShutdownOptions: a.Ember.computed("tra", u.property, (function() {
                    const e = this.get("tra"),
                        t = this.get(u.property);
                    return [o.SETTINGS.ALWAYS, o.SETTINGS.AUTO, o.SETTINGS.NEVER].map((n => {
                        const l = e.get(`ux_settings_unload_in_game_setting_${n}`),
                            a = e.get(`ux_settings_unload_in_game_setting_tooltip_${n}`);
                        return {
                            value: n,
                            text: l,
                            selected: n === t,
                ...
                init() {
                    ...
                    "TENCENT" === this.get("regionLocale").region.toUpperCase() && (d.defaultValue = !1), this.bindSetting(m), this.bindSetting(u), this.bindSetting(d), this.bindSetting(p), this.bindSetting(_), a.WindowManager.getValidWindowSizes().then((e => {
                        this.set("validWindowSizes", e)
                    })), this.setReloadTitle()
                },
                setReloadTitle: function() {
                    const e = navigator.platform.toUpperCase().indexOf("MAC") >= 0 ? "⌘ + R" : "Ctrl + R",
                        t = this.get("tra").formatString("lol_general_settings_reload_title", {
                            shortcut: e
                        });
                    this.set("reloadTitle", t)
                },
                resetToDefault: function() {
                    this.set("isProfilePrivate", i.setting === r.PRIVATE), this.changeSetting(m.property, m.defaultValue), this.changeSetting(u.property, u.defaultValue), this.changeSetting(d.property, d.defaultValue), this.changeSetting(p.property, p.defaultValue), this.changeSetting(_.property, _.defaultValue)
                },
                actions: {
                    reload: function() {
                        a.Navigation.reload()
            ...
            var l = n(1),
                a = l.Ember.Mixin.create({
                    ...
                    doSaveSetting: function(e, t, n, l, a) {
                        const s = {};
                        s[e] = t, this.get("persistenceService").saveDefaultSetting(s, n, l, a)
                    },
            ...
            var r = a.Ember.Controller.extend(s.default, {
                ...
                persistenceService: a.Ember.inject.service("persistence"),
                init() {
                    this._super(...arguments), this.bindSetting(o), this.bindSetting(i), this.bindSetting(c)
                },
                resetToDefault() {
                    this.changeSetting(o.property, o.defaultValue), this.changeSetting(i.property, i.defaultValue), this.changeSetting(c.property, c.defaultValue)
                }
            });
            t.default = r
        }, (e, t, n) => {
            ...
            var m = a.Ember.Controller.extend(s.default, {
                ...
                persistenceService: a.Ember.inject.service("persistence"),
                init() {
                    this._super(...arguments), this.bindSetting(o), this.bindSetting(i), this.bindSetting(c), this.bindSetting(r), this.addObserver("negatedChatFilter", this, this.negatedChatFilterObserver)
                },
                ...
                resetToDefault: function() {
                    this.set("negatedChatFilter", !o.defaultValue), this.changeSetting(i.property, i.defaultValue), this.changeSetting(c.property, c.defaultValue), this.changeSetting(r.property, r.defaultValue)
                }
            });
            t.default = m
        }, (e, t, n) => {
            ...
            var S = a.Ember.Controller.extend(s.default, {
                ...
                masterVolumeLabel: a.Ember.computed(i.property, (function() {
                    const e = Number.isInteger(this.get(i.property)) ? this.get(i.property) : i.defaultValue;
                    return this.get("tra").formatString("lol_settings_sound_master_volume_label", {
                        value: e
                    })
                })),
                sfxVolumeLabel: a.Ember.computed(r.property, (function() {
                ...
                persistenceService: a.Ember.inject.service("persistence"),
                init() {
                    this._super(...arguments), this.bindSetting(o), this.bindSetting(i), this.bindSetting(c), this.bindSetting(r), this.bindSetting(m), this.bindSetting(u), this.bindSetting(d), this.bindSetting(p), this.bindSetting(_), this.bindSetting(g), this.bindSetting(E), this.bindSetting(h);
                    const e = this.get("currentSchemaVersion");
                    Number.isInteger(e) && e < 5 && this.resetToDefault()
                },
                resetToDefault: function() {
                    this.changeSetting(o.property, o.defaultValue), this.changeSetting(i.property, i.defaultValue), this.changeSetting(c.property, c.defaultValue), this.changeSetting(r.property, r.defaultValue), this.changeSetting(m.property, m.defaultValue), this.changeSetting(u.property, u.defaultValue), this.changeSetting(d.property, d.defaultValue), this.changeSetting(p.property, p.defaultValue), this.changeSetting(_.property, _.defaultValue), this.changeSetting(g.property, g.defaultValue), this.changeSetting(E.property, E.defaultValue), this.changeSetting(h.property, h.defaultValue)
                },
                onSaveSetting: function(e, t) {
                    if (e === c.property) {
                        const e = {};
                        e[c.voiceAliasProperty] = t, this.get("persistenceService").saveDefaultSetting(e, c.scope, c.namespace, c.schemaVersion)
                    } else if (e === r.property) {
                        const e = {};
                        e[r.voiceAliasProperty] = .5 * t, this.get("persistenceService").saveDefaultSetting(e, r.scope, r.namespace, r.schemaVersion)
                    }
                },
                actions: {
            ...
            var g = a.Ember.Controller.extend(s.default, {
                ...
                captureDevices: a.Ember.computed("voiceService.captureDevices", c.property, (function() {
                    const e = this.get("voiceService.captureDevices") || [],
                        t = this.get(c.property) || a.lodash.get(a.lodash.first(e.filter((e => e.is_current_device))), "handle");
                    return e.map((e => {
                        const n = e.handle === c.defaultValue ? this.get("tra.voice_settings_default_input_device") : e.name;
                        return {
                            handle: e.handle,
                            name: n,
                            selected: e.handle === t
                ...
                inputVolumeLabel: a.Ember.computed(r.property, (function() {
                    const e = Number.isInteger(this.get(r.property)) ? this.get(r.property) : r.defaultValue;
                ...
                init() {
                    this._super(...arguments), this.bindSetting(o), this.bindSetting(i), this.bindSetting(c), this.bindSetting(r), this.bindSetting(d), this.bindSetting(p), this.bindSetting(_)
                },
                willDestroy() {
                    this._super(...arguments)
                },
                resetToDefault: function() {
                    this.changeSetting(o.property, o.defaultValue), this.changeSetting(i.property, i.defaultValue), this.changeSetting(c.property, c.defaultValue), this.changeSetting(r.property, r.defaultValue), this.changeSetting(d.property, d.defaultValue), this.changeSetting(p.property, p.defaultValue), this.changeSetting(_.property, _.defaultValue)
                },
                ...
                actions: {
                    ...
                    selectCaptureDevice: function(e) {
                        this.changeSetting(c.property, e)
                    },
            ...
            const i = l.dataBinding.bindTo(l.socket),
                c = "/lol-chat/v1/blocked-players";
            var r = l.Ember.Controller.extend({
                blockedPlayers: l.Ember.computed.alias("model.blockedPlayers"),
                me: l.Ember.computed.alias("model.me"),
                blockInput: "",
                delay: 2e3,
                errorPacket: null,
                init() {
                    this._super(...arguments), this._playerNames = l.playerNames
                },
                validateSummonerName: function(e) {
                    if ("" === e) return new a.default("blank_name", "block_system_message_blank_summoner_name");
                    if (e.length < 3) return new a.default("short_name", "block_system_message_name_too_short");
                    if (l.playerNames.isUsingAlias) {
                        let t = !1;
                        if (e.includes("#")) {
                            t = !e.split("#", 2)[1].trim()
                        } else t = !0;
                        if (t) return new a.default("blank_tagline", "block_system_message_blank_tagline")
                    }
                    if (e.toUpperCase() === this.get("me").name.toUpperCase()) return new a.default("cannot_invite_self", "block_system_message_cannot_block_self");
                    return (this.get("blockedPlayers") || []).find((t => t.name && t.name.toUpperCase() === e.toUpperCase())) ? new a.default("name_exists", "block_system_message_already_blocked", {
                        name: e
                    }) : null
                },
                setTooltipByKeys(e, t, n) {
                    this.clearErrorPacketTimer && l.Ember.run.cancel(this.clearErrorPacketTimer), this.set("errorPacket", {
                        title: l.tra.formatString(e),
                        text: l.tra.formatString(t, n)
                    }), this.clearErrorPacketTimer = l.Ember.run.later(this, (() => this.set("errorPacket", null)), this.get("delay"))
                },
                blockSummoner(e) {
                    i.get(`/lol-summoner/v1/summoners?name=${encodeURIComponent(e)}`).then((e => i.post(c, {
                        summonerId: e.summonerId
                    }).catch((() => this.setTooltipByKeys("block_system_message_error_title", "block_system_message_server_error"))))).then((() => i.get(c, {
                        skipCache: !0
                    }))).then((e => {
                        this.set("model.blockedPlayers", e), this.set("blockInput", ""), this.setTooltipByKeys("block_system_message_success_title", "block_system_message_success_text")
                    })).catch((() => {
                        this.setTooltipByKeys("block_system_message_error_title", "block_system_message_summoner_dne", {
                            name: e
                        })
                    }))
                },
                actions: {
                    block() {
                        const e = this.get("blockInput").trim(),
                            t = this.validateSummonerName(e);
                        if (t) return void this.setTooltipByKeys("block_system_message_error_title", t.translationKey, t.params);
                        const n = l.templateHelper.contentBlockDialog(l.tra.formatString("blocked_summoners_block_confirm_title"), l.tra.formatString("blocked_summoners_block_confirm_text", {
                            name: e
                        }), "dialog-medium", "confirm-friend-actions");
                        this.set("errorPacket", null);
                        const a = l.ModalManager.add({
                            type: "DialogConfirm",
                            owner: this.namespace.rootElement,
                            data: {
                                contents: n,
                                acceptText: l.tra.get("blocked_summoners_block_button"),
                                declineText: l.tra.get("blocked_summoners_block_cancel"),
                                closeButton: !1
                            }
                        });
                        a.acceptPromise.then((() => this.blockSummoner(e))).catch((() => {}));
                        a.domNode.querySelector(".confirm-friend-actions").style.width = "360px"
                    },
                    unblock(e) {
                        return i.delete(c + "/" + e).then((() => i.get(c, {
                            skipCache: !0
                        }))).then((e => {
            ...
            e.exports = function(e, t, n) {
                this.name = e, this.translationKey = t, this.params = n
            }
        }, (e, t, n) => {
            "use strict";
            Object.defineProperty(t, "__esModule", {
            ...
            var c = a.Ember.Controller.extend(s.default, {
                ...
                replaysDefaultValue: a.Ember.computed.alias("model.replaysDefaultValue"),
                highlightsDefaultValue: a.Ember.computed.alias("model.highlightsDefaultValue"),
                replaysConfig: a.Ember.computed.alias("model.replaysConfig"),
                persistenceService: a.Ember.inject.service("persistence"),
                replaysPath: a.Ember.computed(o.property, "replaysDefaultValue", (function() {
                    return this.get(o.property) ? this.get(o.property) : this.get("replaysDefaultValue")
                })),
                highlightsPath: a.Ember.computed(i.property, "highlightsDefaultValue", (function() {
                    return this.get(i.property) ? this.get(i.property) : this.get("highlightsDefaultValue")
                })),
                isSettingsEnabled: a.Ember.computed("replaysConfig", (function() {
                    return a.lodash.get(this.get("replaysConfig"), "isReplaysEnabled", !1)
                })),
                init() {
                    this._super(...arguments), o.defaultValue = this.get("replaysDefaultValue"), i.defaultValue = this.get("highlightsDefaultValue"), this.bindSetting(o), this.bindSetting(i)
                },
                resetToDefault: function() {
            ...
            var a = l.Ember.Controller.extend({
                ...
                _getReleases() {
                    this.get("patchService").getSupportedGameReleases().then((e => {
                        this.set("supportedGameReleases", e.supported_game_releases)
                    }))
                },
                actions: {
                    onGameClienVersionClick() {
            ...
            var p = l.Ember.Component.extend({
                ...
                persistenceService: l.Ember.inject.service("persistence"),
                init() {
                    this._super(...arguments), this._registerSliderAndCheckbox(r), l.lodash.forEach(m, (e => {
                ...
                resetToDefault() {
                    const e = {};
                    this._resetSlider(r.slider, e), this._resetCheckbox(r.checkbox, e), m.forEach((t => {
                        this._resetSlider(t.slider, e), this._resetCheckbox(t.checkbox, e)
                    })), this._resetCheckbox(u, e), this._saveGameSettings(e)
                },
                _resetSlider(e, t) {
                    const {
                        propertyName: n,
                ...
                _resetCheckbox(e, t) {
                    const {
                        ...
                        reverse: s,
                        defaultValue: o
                    } = e, i = this._getCurrentValueKey(n), c = this._getGameSettingSchemaKey(l, n);
                    let r;
                    void 0 !== this.get(c) && null !== this.get(c) ? r = this._getDisplayValue(this.get(c), a) : void 0 !== o && (r = o), this._appendSaveData(t, e, r), !0 === s && (r = !r), this.set(i, r);
                    this.$(`input[name='${n}']`)[0].checked = r
                },
                ...
                _registerComputedProperty(e) {
                    const {
                        ...
                        dataType: a,
                        reverse: s
                    } = e, o = this._getCurrentValueKey(t), c = this._getGameSettingsKey(n, t), r = this._getGameSettingSchemaKey(n, t);
                    this.set(t, l.Ember.computed(c, r, (() => {
                        let e;
                        return void 0 !== this.get(c) && null !== this.get(c) ? e = this._getDisplayValue(this.get(c), a) : void 0 !== this.get(r) && null !== this.get(r) && (e = this._getDisplayValue(this.get(r), a)), a === i && !0 === s && (e = !e), this.set(o, e), l.logger.trace(`set ${t} value to ${e}`), e
                    })))
                },
                _bindEventListeners: l.Ember.on("didInsertElement", (function() {
                    this._bindMasterVolumeSliderAndCheckboxListeners(r), l.lodash.forEach(m, (e => {
                ...
                _bindSRThemeMusicDropdown(e) {
                    ...
                    null != s && a.select && a.select(s.toString()), this.addObserver(`gameSettings.${t}.${n}`, this, (() => {
                        const e = 0 | this.get(`gameSettings.${t}.${n}`);
                        null != e && a.select && a.select(e.toString())
                    })), a.addEventListener("selected", (t => {
                        this._saveProperty(e, Number(t.selected.attributes.value.value))
                    }))
                },
                _checkMasterVolumeStatus() {
                    const e = r.checkbox.propertyName,
                        t = this._getCurrentValueKey(e),
                        n = this.$(`input[name='${e}']`)[0];
                    let a = !0;
                    m.forEach((e => {
                        this.$(`input[name='${e.checkbox.propertyName}']`)[0].checked || (a = !1)
                    })), (a && !n.checked || !a && n.checked) && (n.checked = !n.checked, this.set(t, n.checked), this._saveProperty(r.checkbox, n.checked), l.logger.trace(`Update overall volume to ${n.checked}, because should disable is ${a}`))
                },
                _saveProperty(e, t) {
                ...
                _getSaveValue: (e, t) => t === i ? e ? 1 : 0 : t === o ? e / 100 : t === c ? e : void l.logger.error(`Unknown data type ${t} with value ${e}`),
            ...
            const s = [{
                ...
                o = [{
                    ...
                    section: "General",
                    dataKey: "PreferDX9LegacyMode"
                }, {
                    section: "General",
                    dataKey: "PreferOpenGLLegacyMode"
                }, {
                    section: "General",
            ...
            var i = l.Ember.Component.extend({
                ...
                addListenersOnInserted: l.Ember.on("didInsertElement", (function() {
                    ...
                    null != t && e.select && e.select(t.toString()), l.Ember.addObserver(this, "gameSettings.HUD.CameraLockMode", this, (() => {
                        const t = this.get("gameSettings.HUD.CameraLockMode");
                        null != t && e.select && e.select(t.toString())
                    })), e.addEventListener("selected", (e => {
                        this.set("gameSettings.HUD.CameraLockMode", e.selected.attributes.value.value), this.saveSetting("HUD", "CameraLockMode", Number(e.selected.attributes.value.value))
                    }))
                })),
                setUpSlider(e) {
                    const t = this.get(`gameSettings.${e.section}.${e.dataKey}`);
            ...
            var s = l.Ember.Mixin.create({
                ...
                _createDialogContentDiv: function(e, t, n, l) {
                    ...
                    c.appendChild(o), c.appendChild(i);
                    const r = document.createElement("div");
                    r.classList.add("lol-settings-ingame-keybind-dialog-key-label");
                    const m = [];
                    m[0] = this.get(`inputSettings.${e}.${t}`), null === m[0] && (m[0] = "[<Unbound>]"), 0 !== n && (m[1] = n), r.textContent = (0, a.formatAdditionalKeyBindings)(m);
                    const u = document.createElement("button");
                    return u.classList.add("lol-settings-ingame-keybind-dialog-unbind-button"), u.innerHTML = this.get("tra.LOL_SETTINGS_INGAME_HOTKEYS_UNBIND_BUTTON"), r.textContent ? (r.setAttribute("empty", !1), u.disabled = !1) : (r.setAttribute("empty", !0), r.textContent = this.get("tra.LOL_SETTINGS_INGAME_HOTKEYS_EMPTY"), u.disabled = !0), c.appendChild(r), c.appendChild(u), s.appendChild(c), {
                        contentDiv: s,
                        keybindDiv: r,
                        unbindButton: u
                    }
                ...
                showKeybindingDialog: function(e, t, n) {
                    ...
                    const o = this._createDialogContentDiv(e, t, n, s),
                        ...
                        m = e => {
                            ...
                            this.set("tempSavedValue", n), i.textContent = (0, a.formatAdditionalKeyBindings)([n]), i.setAttribute("empty", !1), c.disabled = !1, r.enableAcceptButton()
                        };
                    r.disableAcceptButton(), r.acceptPromise.then((() => {
                    ...
                    })), r.domNode.setAttribute("tabindex", 0), r.domNode.focus(), c.onclick = () => {
                        this.set("tempSavedValue", "[<Unbound>]"), i.setAttribute("empty", !0), i.textContent = this.get("tra.LOL_SETTINGS_INGAME_HOTKEYS_EMPTY"), c.disabled = !0, r.enableAcceptButton(), r.domNode.focus()
                    }, r.domNode.onkeydown = e => {
                        const t = (0, a.fromKeyToSaved)(e);
                        void 0 !== t && (e.preventDefault(), this.set("tempSavedValue", t), i.setAttribute("empty", !1), i.textContent = (0, a.formatAdditionalKeyBindings)([t]), c.disabled = !1, r.enableAcceptButton())
            ...
            var c = a.Ember.Component.extend(s.default, {
                persistenceService: a.Ember.inject.service("persistence"),
                init() {
            ...
            var r = l.Ember.Component.extend({
                ...
                resetToDefault: function() {
                    const e = {};
                    e[s] = this.resetEventsContent(s), e[o] = this.resetEventsContent(o), e[i] = this.resetEventsContent(i), e[c] = this.resetEventsContent(c), this.initialiseKeyToActionMap(), this._saveInputSettings(e), this.get("quickcastComponent") && this.get("quickcastComponent").resetToDefault()
                },
                resetEventsContent: function(e) {
                    const t = {},
                        n = this.get(`inputSettingsSchema.${e}`);
                    for (const l in n) n.hasOwnProperty(l) && (t[l] = n[l].default, this.set(`inputSettings.${e}.${l}`, t[l]));
                    return t
                },
            ...
            var i = a.Ember.Service.extend({
                ...
                _setDefaultDisplayCategory(e, t) {
                    ...
                    let l = null;
                    Boolean(e) && (l = n.find((t => t.name === e))), l && l.isEnabled() || (l = a.lodash.find(n, (e => e.isEnabled()))), l && this.updateCurrentCategory(l, t)
                },
            ...
            var s = l.Ember.Service.extend({
                ...
                init() {
                    a.observe("/lol-patch/v1/game-version", this, (e => {
                        e ? this.set("gameClientVersion", e) : this.set("gameClientVersion", this.get("tra.lol_settings_version_game_client_pending"))
                    })), a.observe("/lol-patch/v1/checking-enabled", this, (e => {
                        this.set("checkingForPatchesEnabled", e)
                    }))
                },
                getSupportedGameReleases: () => a.get("/lol-patch/v1/products/league_of_legends/supported-game-releases", {
                    skipCache: !0
                }),
                putGamePatchUrl: e => a.put(`/lol-patch/v1/game-patch-url?url=${e}`)
            });
            t.default = s
        }, (e, t, n) => {
            "use strict";
            ...
            } = s.PROFILE_PRIVACY, i = l.dataBinding.bindTo(l.socket), c = "/lol-summoner/v1/current-summoner/profile-privacy", r = "/lol-client-config/v3/client-config/lol.client_settings.full_repair_enabled";
            var m = l.Ember.Service.extend({
                isLoggedIn: !1,
                regionLocale: null,
                settingsReady: !1,
                gameSettingsReady: !1,
                ...
                willDestroy() {
                    i.unobserve("/lol-login/v1/session", this), i.unobserve("/riotclient/region-locale", this), i.unobserve("/lol-settings/v2/ready", this), i.unobserve("/lol-game-settings/v1/ready", this), i.unobserve(c, this), i.unobserve(r, this)
                },
            ...
            e.exports = l.HTMLBars.template({
                id: "NRIP311w",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_23\\\\LeagueClientContent_Release\\\\15680\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-settings\\\\src\\\\app\\\\templates\\\\index.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const l = n(1).Ember;
            ...
            e.exports = l.HTMLBars.template({
                id: "ZxePnoOq",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_23\\\\LeagueClientContent_Release\\\\15680\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-settings\\\\src\\\\app\\\\templates\\\\block-list.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","lol-blocked-summoners"],["flush-element"],["text","\\n  "],["open-element","div",[]],["static-attr","class","block-summoner-text"],["flush-element"],["text","\\n    "],["append",["unknown",["tra","blocked_players_block_text"]],false],["text","\\n  "],["close-element"],["text","\\n  "],["open-element","div",[]],["static-attr","class","block-summoner-input-group"],["flush-element"],["text","\\n    "],["open-element","lol-uikit-flat-input",[]],["static-attr","class","flat-input block-summoner-input"],["flush-element"],["text","\\n      "],["append",["helper",["input"],null,[["class","type","maxlength","value","enter","placeholder","autofocus"],["block-list-settings-summoner-input","search","22",["get",["blockInput"]],"block",["get",["tra","blocked_summoners_input_placeholder"]],"true"]]],false],["text","\\n    "],["close-element"],["text","\\n    "],["open-element","lol-uikit-flat-button-secondary",[]],["static-attr","class","block-summoner-button"],["dynamic-attr","onclick",["helper",["action"],[["get",[null]],"block"],null],null],["flush-element"],["text","\\n      "],["append",["unknown",["tra","blocked_summoners_block_button"]],false],["text","\\n    "],["close-element"],["text","\\n  "],["close-element"],["text","\\n\\n"],["block",["if"],[["get",["blockedPlayers","length"]]],null,2,0],["text","\\n  "],["append",["helper",["block-list-error"],null,[["delay","errorPacket"],[["get",["delay"]],["get",["errorPacket"]]]]],false],["text","\\n\\n"],["close-element"]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","  "],["open-element","div",[]],["static-attr","class","no-blocked-summoners"],["flush-element"],["append",["unknown",["tra","blocked_summoners_empty"]],false],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","      "],["append",["helper",["blocked-player"],null,[["player","unblock"],[["get",["summoner"]],["helper",["action"],[["get",[null]],"unblock"],null]]]],false],["text","\\n"]],"locals":["summoner"]},{"statements":[["text","  "],["open-element","div",[]],["static-attr","class","blocked-summoners-info"],["flush-element"],["text","\\n    "],["append",["unknown",["tra","lol_block_list_settings_label_blocked_players"]],false],["text","\\n  "],["close-element"],["text","\\n  "],["open-element","div",[]],["static-attr","class","blocked-summoners-list"],["flush-element"],["text","\\n"],["block",["each"],[["get",["blockedPlayers"]]],[["key"],["summonerId"]],1],["text","  "],["close-element"],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const l = n(1).Ember;
            ...
            e.exports = l.HTMLBars.template({
                id: "cW3hkJai",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_23\\\\LeagueClientContent_Release\\\\15680\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-settings\\\\src\\\\app\\\\templates\\\\loading.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["open-element","div",[]],["static-attr","style","display: flex; align-items: center; height: 100%;"],["flush-element"],["text","\\n  "],["append",["helper",["uikit-spinner"],null,[["style"],["margin-left: auto; margin-right: auto;"]]],false],["text","\\n"],["close-element"],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const l = n(1).Ember;
            ...
            var o = class {
                ...
                show(e) {
                    e && !s.has(e) && l.logger.error("Invalid category name", e), this._modalManager.show(e)
                }
                close() {
    ...
    n.r = e => {
        ...
        o.addEventListener(i, (function(t) {
            (0, t.registrationHandler)((async function(t) {
                ...
                await e.default.init(t, {
                    ...
                    tra: t => async function(t) {
                        let n = t.get("rcp-fe-lol-l10n").tra().overlay("/fe/lol-l10n/trans.json").overlay("/fe/lol-settings/trans.json");
                        !0 === await e.default.db.get("/lol-client-config/v3/client-config/lol.client_settings.legal_statements") && (n = n.overlay("/fe/lol-settings/trans-legal-statements.json"));
                        return n
                    }(t)
                }), await e.default.tra.ready(), await e.default.add({
                ...
                try {
                    a = await e.default.getProvider().getOptional("rcp-fe-lol-honeyfruit-account-claiming"), e.default.hfSettingsComponent = a.getSettingsComponent()
                } catch (e) {}
                const o = (0, n(5).default)();
                a && a.registerComponents(o), await o.build();
                const i = await e.default.ComponentFactory.create(o.getName()).emberAppInstancePromise,
                    c = i.__container__.lookup("service:modal-manager"),
                    r = new(0, n(135).default)(c);
                e.default.api = r;
                const m = e.default.SharedComponents.getApi_HomeRegistry();
                m.resolveOpenSettingsHandler(((...e) => r.show(...e))), m.resolveCloseSettingsHandler((() => r.close()));
                const u = i.__container__.lookup("router:main"),
                    d = i.__container__.lookup("route:general"),
                    p = {
                        syncToRoute: (e, t) => {
                ...
                try {
                    await c.initialize(i.rootElement, p)
                } catch (t) {
                    e.default.logger.error("Settings error during plugin initialization")
                }
