    ...
    var e = [, e => {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                let a = !1,
                    ...
                    c = null;
                const g = function(n) {
                    a !== n && (a = n, h ? (h.setEnabled(n), !n && c && t.showHome()) : n && (h = i.default.profilesApi.mainSection().registerSection({
                        id: "profile-main-highlights",
                        title: i.default.tra.get("lol_highlights_profile_tab"),
                        priority: "5",
                        render: () => (o || ((0, l(3).default)(), o = !0), c = e.create("rcp-fe-lol-highlights", {}), c.domNode),
                        enabled: !0
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                n.emberApplicationFactory.setFactoryDefinition("rcp-fe-lol-highlights", {
                    name: "rcp-fe-lol-highlights",
                    ComponentFactory: n.ComponentFactory,
                    Router: n.Ember.Router.extend({
                        location: "none"
                    }),
            ...
            var n = l(1).Ember.Component.extend({
                classNames: ["lol-highlights-default-layout", "lol-highlights-panel-fade-in"],
                sanitizerConfig: {
                    allowedTags: ["p", "img"],
                    allowedAttributes: {
                        "*": ["class", "src"]
            ...
            var s = n.Ember.Component.extend({
                highlights: null,
                classNames: ["lol-highlights-main-layout", "lol-highlights-panel-fade-in"],
                selectedHighlight: null,
                selectedHighlightLastModDateStr: n.Ember.computed.alias("selectedHighlight.lastModDateString"),
                validHighlightSelected: n.Ember.computed("selectedHighlight", (function() {
                ...
                activeHighlightVideoSrc: n.Ember.computed("validHighlightSelected", "selectedHighlight", (function() {
                ...
                syncSelectedHighlight() {
                    const e = this.get("highlights") || [],
                        t = this.get("selectedHighlight");
                    e.length && -1 === e.indexOf(t) && (t ? this.set("selectedHighlight", e.find((e => e.id === t.id)) || e[0]) : this.set("selectedHighlight", e[0]))
                },
                actions: {
                    selectHighlight(e) {
            ...
            var a = i.Ember.Component.extend({
                ...
                isSelected: i.Ember.computed("selectedHighlightId", "highlightId", (function() {
                ...
                actions: {
                    ...
                    viewHighlightInFolder() {
                        ...
                        this.get("highlights").viewHighlightInFolder(t).catch((() => {
                            const {
                                filepath: t
                            } = e, l = this.get("tra").formatString("lol_highlights_toast_error_show_in_file_browser", {
                                filepath: t
                            });
                    ...
                    deleteHighlight() {
                        ...
                        i.UIKit.getModalManager().add({
                            type: "DialogConfirm",
                            data: {
                                contents: this.get("tra.lol_highlights_delete_dialog_contents"),
                                acceptText: this.get("tra.lol_highlights_delete_dialog_accept_text"),
                                declineText: this.get("tra.lol_highlights_delete_dialog_decline_text"),
                                closeButton: !1
                            },
                            show: !0
                        }).acceptPromise.then((() => this.get("highlights").deleteHighlight(e))).catch((() => {}))
                    }
                }
            });
            t.default = a
            ...
            var l = (...e) => e.reduce(((e, t) => {
                return "string" == typeof t ? e.push(t) : e.push(...(l = t, Object.keys(l).filter((e => l[e])))), e;
                var l
            }), []).join(" ");
            t.default = l
        }, (e, t, l) => {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                const l = (e && e.data && e.data.httpStatus || -1) === i && e && e.data && e.data.message || n.tra.get("lol_highlights_unknown_error_text");
                s(n.tra.formatString(t, {
                    message: l
                }))
            ...
            function s(e) {
                const t = function(e) {
                        ...
                        t.style.maxWidth = "40em", t.style.padding = "1em", t.style.marginBottom = "2em";
                        const l = document.createElement("p");
                        return t.appendChild(l), l.style.overflowWrap = "break-word", l.appendChild(document.createTextNode(e)), t
                    }(e),
            ...
            var n = l(1),
                i = n.Ember.Component.extend({
                    classNames: ["lol-highlights-selected-highlight-name", "lol-highlights-details-no-margin-bottom"],
                    highlights: n.Ember.inject.service(),
                    selectedHighlight: null,
                    isEditingName: !1,
                    actions: {
                        editName() {
                            this.set("editingHighlightName", this.get("selectedHighlight.name")), this.set("isEditingName", !0)
                        },
                        exitEditingName() {
            ...
            var o = i.Ember.Component.extend({
                ...
                init() {
                    this._super(...arguments), this.set("editingHighlightName", this.get("highlight.name"))
                },
                didInsertElement() {
                    this._super(...arguments);
                    const e = this.element.querySelector("input.lol-highlights-name-edit-input");
                    e.focus(), e.setSelectionRange(0, e.value.length)
                },
                badFilenameCharSet: i.Ember.computed("highlights.config.invalidHighlightNameCharacters", (function() {
                    const e = this.get("highlights.config.invalidHighlightNameCharacters");
                    return new Set(e)
                })),
                badFilenameCharsForDisplay: i.Ember.computed("highlights.config.invalidHighlightNameCharacters", (function() {
                    const e = this.get("highlights.config.invalidHighlightNameCharacters");
                    return e ? [...e].join(" ") : ""
                })),
                actions: {
                    ...
                    saveHighlight() {
                        const e = this.get("highlights"),
                            ...
                            i = [...t].find((e => l.has(e)));
                        null == i ? (this.set("savingDisabled", !0), e.updateHighlight({
                            ...this.get("highlight"),
                            name: this.get("editingHighlightName")
                        }).then((() => {
                            this.set("savingDisabled", !1), this.get("cancelEdit")()
                        }))) : (0, s.showErrorModalWithMessage)(this.get("tra").formatString("lol_highlights_toast_error_save_name_bad_character", {
                            foundBadChar: i,
                            allBadChars: n
                        }))
                    }
            ...
            var s = n.Ember.Component.extend({
                ...
                disableAnimations: n.Ember.computed.alias("uxSettingsService.disableAnimations"),
                tooltipOptions: n.Ember.computed("direction", "restrictArea", "disableAnimations", (function() {
                ...
                setUpTooltip() {
                    this.targetElement = this.element.parentElement, this.tooltipElement = this.element.querySelector("lol-uikit-tooltip");
                    const {
                        disableAnimations: e,
                        tooltipOptions: t
                    } = this.get("tooltipOptions");
                    Object.assign(t, i[t.direction]), e && (t.transitionSpeed = 0), n.tooltipManager.assign(this.targetElement, this.tooltipElement, null, t), this.get("clearOnClick") && this.targetElement.addEventListener("click", this.clearTooltip)
                },
                actions: {
                    clickHandler(e) {
                ...
                didInsertElement() {
                    this._super(...arguments), this.clearTooltip = this.clearTooltip.bind(this), this.setUpTooltip()
                },
                willDestroyElement() {
                    this._super(...arguments), n.tooltipManager.unassign(this.targetElement), this.get("clearOnClick") && this.targetElement.removeEventListener("click", this.clearTooltip)
                }
            });
            t.default = s
        }, (e, t, l) => {
            ...
            e.exports = n.HTMLBars.template({
                id: "LtMZMzsK",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_23\\\\LeagueClientContent_Release\\\\15680\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-highlights\\\\src\\\\app\\\\templates\\\\application.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["append",["unknown",["outlet"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, l) => {
            const n = l(1).Ember;
            e.exports = n.HTMLBars.template({
                id: "ky/0ihV4",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_23\\\\LeagueClientContent_Release\\\\15680\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-highlights\\\\src\\\\app\\\\templates\\\\index.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["append",["unknown",["highlights-panel"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, l) => {
            const n = l(1).Ember;
            ...
            const {
                ...
                return {
                    ...e,
                    lastModDateString: 0 === t ? "" : s(new Date(t)).format(n.tra.get("lol_highlights_modified_date_format"))
                }
            })), a = n.dataBinding, h = "/lol-highlights/v1/highlights", c = "/lol-highlights/v1/config";
            var g = n.Ember.Service.extend({
                ...
                init() {
                    this._super(...arguments), this.set("highlights", []), this._initObservers()
                },
                _initObservers() {
                    a.post(h), a.observe(h, this, (e => {
                        this.setProperties({
                            highlights: o(e || []),
                            highlightsLoading: !1
                        })
                ...
                updateHighlight: e => a.put(`/lol-highlights/v1/highlights/${e.id}`, e),
                viewHighlightInFolder: e => a.post(`/lol-highlights/v1/file-browser/${e}`),
                deleteHighlight: e => a.delete(`${h}/${e}`),
                willDestroy() {
                    this._super(...arguments), a.unobserve(h, this), a.unobserve(c, this)
                }
            });
            t.default = g
        }, (e, t) => {
        ...
        i.addEventListener(s, (function(e) {
            (0, e.registrationHandler)((function(e) {
                return t.default.init(e, {
                    ...
                    dataBindingLib: e => e.get("rcp-fe-common-libs").getDataBinding("rcp-fe-lol-highlights"),
                    ...
                    tra: e => e.get("rcp-fe-lol-l10n").tra().overlay("/fe/lol-l10n/trans.json").overlay("/fe/lol-highlights/trans.json"),
                    UIKit: e => e.get("rcp-fe-lol-uikit")
                }).then((function() {
                    return t.default.dataBinding = t.default.dataBindingLib.bindTo(t.default.socket), t.default.tra.ready()
                })).then((() => {
