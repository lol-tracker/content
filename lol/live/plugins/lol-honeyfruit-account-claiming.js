(() => {
  var e = [
      ...
      (e, t, n) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.default = void 0);
        const l = n(1).Ember.Router.extend({ location: "none" });
        l.map(function () {
          this.route("welcome"),
            this.route("welcome-to-league"),
            this.route("link-on-web"),
            this.route("link-complete"),
            this.route("review-account-changes", function () {
              this.route("error");
            }),
            this.route("migration-in-progress"),
            this.route("migration-complete"),
            this.route("error-migration");
        });
        var a = l;
        t.default = a;
      },
      (e, t, n) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.default = void 0);
        var l = n(1).Ember.Controller.extend({ RIOT_PUBLIC: Boolean(!0) });
        t.default = l;
      },
      (e, t, n) => {
        "use strict";
      ...
      (e, t, n) => {
        ...
        var l = n(1),
          a = l.Ember.Controller.extend({
            ...
            account: l.Ember.computed.alias(
              "happState.garenaRegionLeagueAccount",
            ),
            init() {
              this._super(...arguments);
            },
            successBodyString: l.Ember.computed(
      ...
      (e, t, n) => {
        ...
        var a = l.Ember.Controller.extend({
          ...
          isLinked: l.Ember.computed("model", function () {
            const { eligible: e, reason_code: t } = this.get("model");
            return !1 === e && "ALREADY_LINKED" === t;
          }),
          init() {
            this._super(...arguments),
              this._updateBody(),
              l.dataBinding.get("/riotclient/region-locale").then((e) => {
                this.set("region", e.region);
              });
          },
          _updateBody() {
            this.set("pageBodyLocKey", "link_on_web_body_1"),
              setTimeout(() => {
      ...
      (e, t, n) => {
        ...
        var a = l.Ember.Controller.extend({
          ...
          init() {
            this._super(...arguments),
              (this._migrationTextInterval = setInterval(() => {
          ...
          migrationTextList: l.Ember.computed("tra", function () {
            return [
              this.get("tra.data_migration_in_progress_sub_title_1"),
              this.get("tra.data_migration_in_progress_sub_title_2"),
              this.get("tra.data_migration_in_progress_sub_title_3"),
              this.get("tra.data_migration_in_progress_sub_title_4"),
          ...
          actions: {
            modalOkayPressed() {
              this.get("model").startMigrationComplete.then(() => {
                l.logger.trace(
                  "Migration complete and summoner-name in-use acknowledged.",
                ),
                  this.transitionToRoute("migration-complete");
              });
            },
          },
        });
      ...
      (e, t, n) => {
        ...
        var l,
          a = n(1),
          s = (l = n(13)) && l.__esModule ? l : { default: l };
        ...
        var r = a.Ember.Controller.extend({
          ...
          account: a.Ember.computed.alias(
            "happState.garenaRegionLeagueAccount",
          ),
          hasPlayedAGame: a.Ember.computed.alias(
            "happState.garenaRegionLeagueAccount.has_played_a_game",
          ),
          isReservedSummonerName: a.Ember.computed.alias(
            "happState.garenaRegionLeagueAccount.is_reserved_summoner_name",
          ),
          importedItems: a.Ember.computed(
            "hasPlayedAGame",
            "isReservedSummonerName",
            function () {
              ...
              return t
                ? e
                  ? [
                      this.buildBox(
                        o.PROGRESS_AND_RANKED_HISTORY,
                        i.OVERWRITTEN,
                      ),
                      this.buildBox(o.IDENTITY_AND_FRIENDS, i.OVERWRITTEN),
                      this.buildBox(o.LOOT_INVENTORY, i.OVERWRITTEN),
                    ]
                  : [
                      this.buildBox(o.PROGRESS_AND_RANKED_HISTORY),
                      this.buildBox(o.IDENTITY_AND_FRIENDS),
                      this.buildBox(o.LOOT_INVENTORY),
                      this.buildBox(o.CONTENT),
                      this.buildBox(o.RP_BALANCE),
                ...
                : t
                  ...
                  : e
                    ? [
                        ...
                        this.buildBox(o.IDENTITY_AND_FRIENDS, i.NOT_GUARANTEED),
                        this.buildBox(o.LOOT_INVENTORY, i.OVERWRITTEN),
                      ]
                    : [
                        this.buildBox(o.PROGRESS_AND_RANKED_HISTORY),
          ...
          buildBox: (e, t = null) => ({ type: e, warning: t }),
          mergedItems: a.Ember.computed(
            "hasPlayedAGame",
            "isReservedSummonerName",
            function () {
              return this.get("hasPlayedAGame")
                ? [
                    this.buildBox(o.RP_BALANCE),
                    this.buildBox(o.ESSENCE_BALANCES),
                    this.buildBox(o.CONTENT, i.POSSIBLE_DUPLICATES),
                  ]
                : [];
            },
          ),
          changedItems: a.Ember.computed(
            "hasPlayedAGame",
            "isReservedSummonerName",
            function () {
              return [
                this.buildBox(o.NEW_SEASON_START),
                this.buildBox(o.FRESH_MATCH_HISTORY),
              ];
            },
          ),
        });
      ...
      (e, t) => {
        ...
        t.default = {
          ...
          REVIEW_ACCOUNT_COLUMNS: { IMPORT: "IMPORTED", MERGE: "MERGED" },
      ...
      (e, t, n) => {
        ...
        var l = n(1),
          a = l.Ember.Controller.extend({
            actions: {
              closeHApp() {
                l.honeyfruitAccountClaiming.confirmIsNewPlayer(),
                  l.honeyfruitAccountClaiming.hide();
              },
            },
          });
      ...
      (e, t, n) => {
        ...
        var l = n(1).Ember.Component.extend({
          ...
          classNameBindings: [
            "isHover:border-yellow-200",
            "isHover:bg-yellow-100",
      ...
      (e, t, n) => {
        ...
        var l = n(1),
          ...
          s = l.Ember.Component.extend({
            ...
            isTryAgainSelected: l.Ember.computed.equal(
              "selectedActionName",
              a.ACTIONS_NAMES.TRY_AGAIN,
            ),
            isComeBackSelected: l.Ember.computed.equal(
              "selectedActionName",
              a.ACTIONS_NAMES.COME_BACK_LATER,
            ),
            isStartOverSelected: l.Ember.computed.equal(
              "selectedActionName",
              a.ACTIONS_NAMES.START_OVER,
            ),
            actions: {
              optionClicked(e) {
      ...
      (e, t, n) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.QUESTION_TYPES = t.DEV_STATES = t.ACTIONS_NAMES = void 0),
          (t.fetchAccountStatus = function (e) {
            if (a) return o(a, e);
            const t = "/lol-summoner/v1/current-summoner";
            let n;
            const i = function (r) {
              r.puuid &&
                (l.dataBinding.unobserve(t, i),
                (a = r.puuid),
                s ||
                  ((s = !0),
                  o(a, e).then(function (e) {
                    n(e);
                  })));
            };
      ...
      (e, t, n) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.default = void 0);
        var l = n(1).Ember.Component.extend({ tagName: "" });
        t.default = l;
      },
      (e, t, n) => {
        "use strict";
          ...
          a = l.Ember.Component.extend({
            ...
            actions: {
              buttonClick() {
                ...
                if (t) {
                  const e = l.Ember.getOwner(this).lookup(
      ...
      (e, t, n) => {
        ...
        var l = n(1),
          a = l.Ember.Component.extend({
            ...
            modalRootSelector: l.Ember.computed(
              "modalRootClassName",
              function () {
                return (
                  "." +
                  this.get("modalRootClassName").trim().split(" ").join(".")
                );
              },
            ),
            didInsertElement() {
              ...
              if (
                ((this.modalRoot = this.element.querySelector(e)),
                !this.modalRoot)
              )
                throw new Error("Could not find a DOM root for the modal.");
            ...
            _hide() {
              this.modalRoot &&
                this.modalRoot.parentElement &&
                document
                  .querySelector(".rcp-fe-viewport-overlay")
                  .removeChild(this.modalRoot);
            },
            _open() {
              (this.element || this.modalRoot) &&
                document
                  .querySelector(".rcp-fe-viewport-overlay")
                  .appendChild(this.modalRoot);
            },
            actions: {
              open() {
                this._open();
      ...
      (e, t, n) => {
        ...
        var l = n(1),
          ...
          s = l.Ember.Component.extend({
            ...
            selectedAnswer: null,
            selectAnswer: null,
            isSummonerNameQuestion: l.Ember.computed.equal(
              "question.questionType",
              a.QUESTION_TYPES.SUMMONER_NAME,
            ),
            init() {
              this._super(...arguments);
              this.get("isSummonerNameQuestion") &&
                this._redefineSelectAnswer();
            },
      ...
      (e, t, n) => {
        ...
        l.reopenClass({ positionalParams: ["route", "model"] });
        var a = l;
        t.default = a;
      },
      (e, t, n) => {
      ...
      (e, t, n) => {
        ...
        var l = n(1),
          a = l.Ember.Component.extend({
            ...
            init() {
              this._super(...arguments);
              l.dataBinding.observe(
                "/lol-client-config/v3/client-config/lol.client_settings.honeyfruit.redirect_url",
                (e) => {
        ...
        const o = s.default.REVIEW_ACCOUNT_CHANGE_WARNINGS,
          ...
          c = {
            PROGRESS_AND_RANKED_HISTORY: {
              [o.OVERWRITTEN]: {
                tooltipBody:
                  "tooltip_progress_and_ranked_history_body_overwritten",
              },
            },
            IDENTITY_AND_FRIENDS: {
              [o.OVERWRITTEN]: {
          ...
          u = {
            RP_BALANCE: {
              [i.IMPORT]: { tooltipBody: "tooltip_rp_balance_body_import" },
              [i.MERGE]: { tooltipBody: "tooltip_rp_balance_body_merge" },
            },
            ESSENCE_BALANCES: {
              [i.IMPORT]: {
                tooltipBody: "tooltip_essence_balances_body_import",
              },
              [i.MERGE]: { tooltipBody: "tooltip_essence_balances_body_merge" },
            },
          };
        var m = a.Ember.Component.extend({
          ...
          init() {
            ...
            t
              ? this._setBoxData(t)
              : a.logger.error(
                  `Type [${e}] is not a valid type to create a ReviewAccountChangeBoxComponent`,
                );
          },
          overwritten: a.Ember.computed.equal("warning", o.OVERWRITTEN),
          notGuaranteed: a.Ember.computed.equal("warning", o.NOT_GUARANTEED),
          possibleDupes: a.Ember.computed.equal(
            "warning",
            o.POSSIBLE_DUPLICATES,
          ),
          hasWarning: a.Ember.computed.or(
            "overwritten",
            "notGuaranteed",
            "possibleDupes",
          ),
          ...
          warningMessage: a.Ember.computed(
            "warning",
            "hasWarning",
            function () {
          ...
          tooltipWarningMessage: a.Ember.computed(
            "warning",
            "hasWarning",
            function () {
          ...
          _setBoxData(e) {
            this.set("icon", "/fe/lol-static-assets/images/icon-rp-24.png"),
              this._loadData(e),
              this.get("hasWarningOverrides") &&
                this._loadData(this.get("warningOverrides")),
              this.get("hasColumnOverride") &&
                this._loadData(this.get("columnOverride"));
          },
          _loadData(e) {
            const t = this.get("tra");
            for (const [n, l] of Object.entries(e))
              if ("icon" === n) this.set(n, l);
                ...
                const e = [];
                l.forEach((n) => e.push({ icon: n.icon, text: t.get(n.text) })),
                  this.set(n, e);
          ...
          a = l.Ember.Component.extend({
            ...
            actions: {
              ...
              setMockHAppState(e, t) {
                ...
                this.set(
                  "mockGarenaRegionLeagueAccount.is_reserved_summoner_name",
                  e,
                ),
                  this.set(
                    "mockGarenaRegionLeagueAccount.has_played_a_game",
                    t,
                  );
                const l = this.get("happState");
                l.set("garenaRegionLeagueAccount", n),
                  l.set("email", "dev*****@rio*******.com");
              },
            },
          });
        t.default = a;
      ...
      (e, t, n) => {
        ...
        var l = n(1),
          a = l.Ember.Component.extend({
            ...
            link_type: "FULL",
            accountsString:
              "lcudev_16614467243_ci1\tlcudev_16614467243_ci2\t5a893223-327e-52a5-bce4-f6c3bd0c1873\t17cc1dd1-12aa-5a34-a1e2-92d047ea011a\t3052435555943770\t3052435726566750\tci1\tci2\taccountcreation@riotgames.com\t2022TestHF02!!",
            ...
            init() {
              this._super(...arguments),
                ...
                this._getRsoToken(),
                this._getRsoUserInfoToken();
            },
            _getRsoToken() {
              return l.dataBinding
            ...
            _getStatus() {
              this.get("honeyfruitPlugin")
                .fetchAccountStatus({ skipCache: !0 })
                .then((e) => {
                  const t = e.linking_status;
                  l.logger.info("accountStatus", t),
                    this.set("accountStatus", t);
                });
            },
            accountStringList: l.Ember.computed("accountsString", function () {
              return (this.get("accountsString") || "")
                .replaceAll(/\s+/g, " ")
                .split(" ");
            }),
      ...
      (e, t, n) => {
        ...
        var l = n(1),
          a = l.Ember.Service.extend({
            ...
            email: null,
            summonerIconUrl: l.Ember.computed(
              "garenaRegionLeagueAccount.summoner_icon_id",
              function () {
                const e = this.get(
                  "garenaRegionLeagueAccount.summoner_icon_id",
                );
            ...
            reset() {
              this.set("garenaRegionLeagueAccount", null),
                this.set("email", null);
            },
          });
        t.default = a;
      ...
      (e, t, n) => {
        ...
        var l,
          ...
          s = (l = n(13)) && l.__esModule ? l : { default: l },
          o = n(19);
        const { MIGRATION_RESULT_CODE: i } = s.default;
        var r = a.Ember.Service.extend({
          ...
          isAccountMigrated() {
            return this.fetchAccountStatus().then((e) => {
              const { migration_status: t } = e;
              return t === i.COMPLETED_SUCCESSFULLY;
            });
          },
          isAccountEligible(e) {
            return e
              ? this._isAccountEligible(e)
              : this.fetchAccountStatus().then((e) =>
                  this._isAccountEligible(e.linking_status),
                );
          },
          observeUntilLinked: () =>
            new Promise((e) => {
              const t = "/lol-honeyfruit/v1/account-claim/account-status",
                n = (l) => {
                  const s =
                    l && l.linking_status
                      ? l.linking_status.account_details
                      : null;
                  if (!s) return null;
          ...
          _isAccountEligible(e) {
            ...
            const { reason_code: t, eligible: n } = e;
            return (
              n ||
                a.logger.info(
                  `linking status eligibility: <${n}> reason: <${t}>`,
                ),
              n
            );
          },
      ...
      (e, t, n) => {
        ...
        var l = n(1),
          ...
          s = l.Ember.Service.extend({
            ...
            _waitForMigrationComplete: () =>
              l.dataBinding
                .post("/lol-honeyfruit/v1/account-claim/migration")
                .then(function () {
                  return new Promise(function (e, t) {
                    l.dataBinding.observe(
                      ...
                      (n) => {
                        switch (
                          (l.logger.warning(
                            "waitForMigrationComplete, Migration status updated:",
                            n,
                          ),
                          l.dataBinding.unobserve(
                            "/lol-honeyfruit/v1/account-claim/migration",
                          ),
                          n)
                        ) {
                          ...
                          default:
                            l.logger.warning(
                              "waitForMigrationComplete, Migration still pending",
                            );
                        }
                      },
                    );
            ...
            waitForMigrationComplete() {
              return (
                this._migrationInProgress ||
                  ((this._migrationInProgress =
                    this._waitForMigrationComplete()),
                  this._migrationInProgress.finally(() => {
      ...
      (e, t, n) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.default = void 0);
        var l = n(1);
        const { Service: a, computed: s } = l.Ember,
          { readOnly: o, or: i } = s;
        (function (e, t) {
          const n = e.split(".");
          return `${n.shift()}.${n.shift()}` >= t;
        })(l.Ember.VERSION, 2.15) &&
          l.logger.error(
            `services/router :: this version of ember (${l.Ember.VERSION}) now supports services.router, please remove this file`,
          );
        const r = a.extend({
          ...
          transitionTo(...e) {
            let t;
            const n = e[0];
            if ("string" == typeof (l = n) && ("" === l || "/" === l[0]))
              return this._router._doURLTransition("transitionTo", n);
            var l;
          ...
          isActive() {
            const {
              ...
              l = this._router._routerMicrolib || this._router.router,
              a = l.state;
            if (!l.isActiveIntent(e, t, null)) return !1;
            return (
              !(Object.keys(n).length > 0) ||
              (this._router._prepareQueryParams(e, t, n, !0),
              (function (e, t) {
                let n;
                for (n in e)
          ...
          _extractArguments(e, ...t) {
            ...
            return { routeName: e, models: t, queryParams: l };
          },
        });
        l.Ember.Application.reopenClass({
          buildRegistry() {
            ...
            return (
              e.register("service:router", r),
              e.injection("service:router", "_router", "router:main"),
              e
            );
          },
        });
      ...
      (e, t, n) => {
        ...
        var l = n(1),
          a = l.Ember.Route.extend({
            ...
            honeyfruitPlugin: l.Ember.inject.service(),
            model() {
              return this.get("honeyfruitPlugin")
                .isAccountMigrated()
                .then((e) => {
          ...
          a = l.Ember.Route.extend({
            ...
            model() {
              ...
              return e.fetchAccountStatus().then((t) => {
                ...
                const { email: n, account_details: l } = t,
                  a = this.get("happState");
                return (
                  a.set("garenaRegionLeagueAccount", l),
                  a.set("email", n),
                  e.isAccountEligible(t) || this.transitionTo("link-complete"),
                  t
                );
              });
            },
            activate() {
              this.get("honeyfruitPlugin")
                ...
                .then((e) => {
                  if (!e) return;
                  this.get("happState").set("garenaRegionLeagueAccount", e),
                    this.transitionTo("link-complete");
                });
            },
          });
        t.default = a;
      ...
      (e, t, n) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.default = void 0);
        var l = n(1).Ember.Route.extend({ model: (e) => e });
        t.default = l;
      },
      (e, t, n) => {
        "use strict";
      ...
      (e, t, n) => {
        ...
        e.exports = l.HTMLBars.template({
          id: "tSETkimW",
          block:
            '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_24\\\\LeagueClientContent_Release\\\\15690\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-honeyfruit-account-claiming\\\\src\\\\app\\\\templates\\\\application.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["text","\\n"],["block",["unless"],[["get",["RIOT_PUBLIC"]]],null,0],["text","\\n"],["append",["unknown",["outlet"]],false],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","  "],["append",["unknown",["dev-cheats"]],false],["text","\\n"]],"locals":[]}],"hasPartials":false}',
          meta: {},
        });
      },
      (e, t, n) => {
      ...
      (e, t, n) => {
        ...
        e.exports = l.HTMLBars.template({
          id: "qDOr5AYM",
          block:
            '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_24\\\\LeagueClientContent_Release\\\\15690\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-honeyfruit-account-claiming\\\\src\\\\app\\\\templates\\\\loading.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["open-element","h1",[]],["static-attr","class",""],["flush-element"],["text","\\n  Loading...\\n  "],["append",["unknown",["uikit-spinner"]],false],["text","\\n"],["close-element"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
          meta: {},
        });
      },
      (e, t, n) => {
      ...
      (e, t, n) => {
        ...
        e.exports = l.HTMLBars.template({
          id: "oSFCY5fl",
          block:
            '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_24\\\\LeagueClientContent_Release\\\\15690\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-honeyfruit-account-claiming\\\\src\\\\app\\\\templates\\\\account-changes\\\\index.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
          meta: {},
        });
      },
      (e, t, n) => {
      ...
      (e, t, n) => {
        ...
        e.exports = l.HTMLBars.template({
          id: "5WawYZQC",
          block:
            '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_24\\\\LeagueClientContent_Release\\\\15690\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-honeyfruit-account-claiming\\\\src\\\\app\\\\templates\\\\components\\\\blank-template.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["yield","default"],["text","\\n"]],"locals":[],"named":[],"yields":["default"],"blocks":[],"hasPartials":false}',
          meta: {},
        });
      },
      (e, t, n) => {
      ...
      (e, t, n) => {
        ...
        e.exports = l.HTMLBars.template({
          id: "P7LH4A6m",
          block:
            '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_24\\\\LeagueClientContent_Release\\\\15690\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-honeyfruit-account-claiming\\\\src\\\\app\\\\templates\\\\components\\\\kba-q-option.hbs\\" style-path=\\"null\\" js-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_24\\\\LeagueClientContent_Release\\\\15690\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-honeyfruit-account-claiming\\\\src\\\\app\\\\components\\\\kba-q-option.js\\" "],["text","\\n"],["append",["unknown",["option"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
          meta: {},
        });
      },
      (e, t, n) => {
      ...
      (e, t, n) => {
        ...
        e.exports = l.HTMLBars.template({
          id: "4k+RjM44",
          block:
            '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_24\\\\LeagueClientContent_Release\\\\15690\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-honeyfruit-account-claiming\\\\src\\\\app\\\\templates\\\\components\\\\next-back-buttons.hbs\\" style-path=\\"null\\" js-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_24\\\\LeagueClientContent_Release\\\\15690\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-honeyfruit-account-claiming\\\\src\\\\app\\\\components\\\\next-back-buttons.js\\" "],["text","\\n"],["block",["link-to-button"],[["get",["backRoute"]],["get",["backModel"]]],[["class","disabled"],["back",["get",["backDisabled"]]]],1],["block",["link-to-button"],[["get",["nextRoute"]],["get",["nextModel"]]],[["disabled","class","primary"],[["get",["nextDisabled"]],"next",true]],0]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","  "],["append",["unknown",["tra","button_next"]],false],["text","\\n"]],"locals":[]},{"statements":[["text","  <\\n"]],"locals":[]}],"hasPartials":false}',
          meta: {},
        });
      },
      (e, t, n) => {
      ...
      (e, t, n) => {
        ...
        t.default = class {
          ...
          constructor(e, t) {
            (this._screenRoot = e),
              (this._privateApi = t),
              (this._rootElement = e.getElement());
          }
          show() {
            this._privateApi.createEmberApp(),
              this._screenRoot.bump(),
              l.navigation.hide(),
              l.navigation.hidePlayButton(),
              l.navigation.hideHome();
          }
          hide() {
            this._screenRoot.release(),
              l.navigation.show(),
              l.navigation.showPlayButton(),
              l.navigation.showHome();
          }
          confirmIsNewPlayer() {
          ...
          async mockLinkingStatus({
            ...
            if (!this.getPossibleStates().includes(e))
              throw new Error(`Invalid linking status state: ${e}`);
            if (!this.getPossibleErrors().includes(t))
              throw new Error(`Invalid linking status error: ${t}`);
          ...
          registerGlobalComponent(e) {
            (e.HoneyfruitService = this._privateApi.emberHoneyfruitService()),
              (e.VngAgeRatingComponent = n(95).default),
              (e.TEMPLATES["components/vng-age-rating"] = n(97));
          }
          ...
          registerComponents(e) {
            return e
              .addComponent("HoneyfruitSettings", n(98).default)
              .addComponent("HoneyfruitSettingsError", n(99).default)
              .addComponent("LinkingSettings", n(101).default)
              .addComponent("VngPublisherSettings", n(103).default)
              .addService(
                "Honeyfruit",
                this._privateApi.emberHoneyfruitService(),
              )
              .addService(
                "HoneyfruitLogger",
                this._privateApi.emberLoggerService(),
              )
              .addTemplate("components/honeyfruit-settings", n(105))
              .addTemplate("components/honeyfruit-settings-error", n(106))
              .addTemplate("components/linking-settings", n(107))
              .addTemplate("components/vng-publisher-settings", n(108))
              .addTranslations(
                "/fe/lol-honeyfruit-account-claiming/trans-addon.json",
              );
          }
        };
      },
      (e, t) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.pluginName =
            t.linkingVisibleStates =
            t.defaultVNGPublisherSettings =
            t.defaultLinkingStatus =
            t.TelemetryEventNames =
            t.LinkingStatusError =
            t.LinkingState =
            t.LinkingModalState =
            t.ActionType =
              void 0);
        ...
        const a = { error: l.NO_ERROR, linked_account: "", state: n.HIDDEN };
        ...
        t.TelemetryEventNames = {
          directLinkingPromptModalDisplayed:
            "direct-linking-prompt-modal-displayed",
          directLinkingConfirmSnoozeModalDisplayed:
            "direct-linking-confirm-snooze-modal-displayed",
          directLinkingInProgressModalDisplayed:
            "direct-linking-in-progress-modal-displayed",
          directLinkingConfirmSnoozeModalLinkLaterClicked:
            "direct-linking-confirm-snooze-modal-link-later-clicked",
          directLinkingConfirmSnoozeModalDoNotShowMeAgainChecked:
            "direct-linking-confirm-snooze-modal-do-not-show-me-again-checked",
          directLinkingInProgressModalContinueWithoutLinkingClicked:
            "direct-linking-in-progress-modal-continue-without-linking-clicked",
          directLinkingPromptModalLinkLaterClicked:
            "direct-linking-prompt-modal-link-later-clicked",
          directLinkingConfirmSnoozeModalLinkNowClicked:
            "direct-linking-confirm-snooze-modal-link-now-clicked",
          directLinkingPromptModalLinkNowClicked:
            "direct-linking-prompt-modal-link-now-clicked",
        };
        t.defaultVNGPublisherSettings = { isVisible: !1 };
      },
      (e, t, n) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        var a = l.Ember.Component.extend({
          ...
          initializeProperties() {
            this.setProperties({
              overlayScreenRoot: l.Viewport.overlay().getScreenRoot(
                "lol-vng-rating-overlay",
              ),
              fullScreenViewport: l.Viewport.fullScreen(),
              updateOverlayBound: this.updateOverlay.bind(this),
            });
          },
          isVisible: l.Ember.computed(
          ...
          updateFullScreenViewportListeners(e) {
            ...
            t.off("remove", this.updateOverlayBound),
              t.off("push", this.updateOverlayBound),
              e &&
                (t.on("remove", this.updateOverlayBound),
                t.on("push", this.updateOverlayBound));
          },
          didRender() {
            this._super(...arguments);
            const e = this.get("isVisible");
            this.get("wasVisible") !== e &&
              (this.set("wasVisible", e),
              this.prepareOverlayElement(),
              this.updateOverlayBound());
          },
          prepareOverlayElement() {
            this.get("overlayScreenRoot")
              .getElement()
              .replaceChildren(this.element.cloneNode(!0));
          },
          updateOverlay() {
            const e = this.get("fullScreenViewport");
            this.get("isVisible") && !e.isEmpty()
              ? this.get("overlayScreenRoot").bump()
              : this.get("overlayScreenRoot").release();
          },
          willDestroyElement: function () {
            this._super(...arguments),
              this.updateFullScreenViewportListeners(!1);
          },
        });
        t.default = a;
      },
      ...
      (e, t, n) => {
        ...
        var l = n(1),
          ...
          s = l.Ember.Component.extend({
            honeyfruit: l.Ember.inject.service("honeyfruit"),
            isLinkingVisible: l.Ember.computed(
              "honeyfruit.linkingStatus.state",
              "honeyfruit.linkingSettingsButtonAvailable",
              function () {
                const e = this.get("honeyfruit.linkingStatus.state");
                return (
                  this.get("honeyfruit.linkingSettingsButtonAvailable") ||
                  e !== a.LinkingState.HIDDEN
                );
              },
            ),
          });
      ...
      (e, t, n) => {
        ...
        var l,
          a = n(1),
          s = n(94),
          o = (l = n(93)) && l.__esModule ? l : { default: l };
        n(102);
        var i = a.Ember.Component.extend({
          ...
          isError: a.Ember.computed(
            "honeyfruit.linkingStatus.error",
            "isLoading",
            function () {
              return (
                !this.get("isLoading") &&
                this.get("honeyfruit.linkingStatus.error") !==
                  s.LinkingStatusError.NO_ERROR
              );
            },
          ),
          isLoading: !1,
          linkingState: a.Ember.computed.alias(
            "honeyfruit.linkingStatus.state",
          ),
          logger: a.Ember.inject.service("honeyfruit-logger"),
          isLinkingVisible: a.Ember.computed(
            "honeyfruit.linkingStatus.state",
            function () {
              return (
                this.get("honeyfruit.linkingStatus.state") !==
                s.LinkingState.HIDDEN
              );
            },
          ),
          isGarenaLinkingVisible: a.Ember.computed(
            "honeyfruit.linkingSettingsButtonAvailable",
            function () {
              ...
              if (!this.get("isDisabled"))
                try {
                  this.set("isLoading", !0),
                    await this.get("honeyfruit").putAction(
                      s.ActionType.LINK,
                      e,
                    ),
                  ...
                  this.get("logger").error(
                    `Error launching honeyfruit linking ${e.message}`,
                  ),
                    this.set("isLoading", !1);
                }
            },
      ...
      (e, t, n) => {
        ...
        t.default = class {
          ...
          constructor({ rootElement: e }) {
            (this.honeyfruitDataBinding = l.dataBinding.dataBinding(
              "/lol-honeyfruit",
              l.websocket,
            )),
              (this._rootElement = e);
          ...
          createEmberApp() {
            return (
              this._emberApp ||
                ((this._emberApp = this._createEmberApp(this._rootElement)),
                (this._rootElement = void 0)),
              this._emberApp
            );
          }
          confirmIsNewPlayer() {
            this.honeyfruitDataBinding.put(
              "/v1/account-claim/auto-dismiss",
              !0,
            );
          }
          _createEmberApp(e) {
            ...
            return l.componentFactory.create(s.EMBER_APP_NAME)
          ...
          clearMockedLinkingStatus() {
            return this.honeyfruitDataBinding.delete(
              "/v1/debug-linking-status",
            );
          }
          mockLinkingStatus(e) {
            return this.honeyfruitDataBinding.put(
              "/v1/debug-linking-status",
              e,
            );
          }
          observeLinkingStatus(e) {
            return (
              this.honeyfruitDataBinding.observe("/v1/linking-status", e),
              () =>
                this.honeyfruitDataBinding.unobserve("/v1/linking-status", e)
            );
          }
          emberHoneyfruitService() {
            return (0, l.getDataBoundEmberService)({
              ...
              serviceMethods: {
                putAction: (e, t) =>
                  this.honeyfruitDataBinding.put("/v1/linking-status", {
                    action: e,
                    target: t,
                  }),
                postVNGSettingsAction: () =>
                  this.honeyfruitDataBinding.post("/v1/vng-publisher-settings"),
              },
            });
          }
          emberLoggerService() {
  ...
  (n.r = (e) => {
    ...
    (() => {
      ...
      n(92);
      const { MIGRATION_RESULT_CODE: s, LINKING_STATUS: o } = l.default,
          ...
          (0, l.registrationHandler)(function (l) {
            ...
            return e.default
              .init(l, {
                ...
                dataBinding: (e) =>
                  e.get("rcp-fe-common-libs").getDataBinding(t.pluginName),
                Ember: (e) => e.get("rcp-fe-ember-libs").getEmber(),
                emberl10n: (e) => e.get("rcp-fe-ember-libs").getEmberL10n(1),
                getDataBoundEmberService: (e) =>
                  e.get("rcp-fe-lol-shared-components")
                    .getDataBoundEmberService,
                l10n: (e) => e.get("rcp-fe-lol-l10n"),
                logger: (e) =>
                  e.get("rcp-fe-common-libs").logging.create(t.pluginName),
              ...
              .then(() => {
                const t = l
                    ...
                    .overlay("/fe/lol-honeyfruit-account-claiming/trans.json"),
                  n = e.default.emberl10n(e.default.Ember, t);
                return e.default.add({
                  dataBinding: e.default.dataBinding.bindTo(
                    e.default.websocket,
                  ),
                  tra: t,
                  traService: n,
              ...
              .then(function () {
                const l = n(93).default,
                  ...
                  u = c.getElement(),
                  m = new l(c, new a({ rootElement: u }));
                e.default.add({ honeyfruitAccountClaiming: m });
                const p =
                    "/lol-client-config/v3/client-config/lol.client_settings.honeyfruit.account_claiming_enabled",
                  d = e.default.dataBinding,
                  h = n(19).fetchAccountStatus,
                  g = function (e) {
                    e &&
                      (d.unobserve(p, g),
                      h().then(async function (e) {
                        const { linking_status: t, migration_status: n } = e,
                          l = t && t.eligible;
                        if (n === s.COMPLETED_SUCCESSFULLY || n === s.SUCCESS);
                        else {
                          if (!l && t.reason_code === o.ALREADY_LINKED)
                            m.show();
                          else {
