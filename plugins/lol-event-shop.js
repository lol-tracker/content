(() => {
    var e = [, e => {
            ...
            const {
                RemainingTimeTextComponent: Y
            } = s.SharedComponents, G = "rcp-fe-lol-event-shop";
            t.APP_NAME = G
        }, (e, t, n) => {
            "use strict";
            Object.defineProperty(t, "__esModule", {
            ...
            var a = s.Ember.Service.extend({
                ...
                initConfigObservers() {
                    this.observeConfig("easierNavigationEnabled", "/lol.client_settings.event_shop.easier_navigation_enabled"), this.observeConfig("scrollingArrowsEnabled", "/lol.client_settings.reward_track.scrolling_arrows_enabled")
                },
            ...
            var l = s.Ember.Component.extend({
                ...
                classNameBindings: ["easierNavigationEnabled:event-shop-offer-card-resized", "offer.highlighted:event-shop-token-shop-highlighted-card", "isOfferOwned:event-shop-token-shop-card-owned", "isOfferAvailable:event-shop-token-shop-card-available", "isOfferUnavailable:event-shop-token-shop-card-unavailable"],
                offer: null,
                eventShopService: s.Ember.inject.service("event-shop"),
                clientConfigService: s.Ember.inject.service("client-config"),
                easierNavigationEnabled: s.Ember.computed.alias("clientConfigService.easierNavigationEnabled"),
                ...
                renderTooltipContainer(e) {
                    const t = e({
                            ...
                            tokensText: this.get("tra.event_shop_progression_label_tokens"),
            ...
            e.exports = (s.default || s).template({
                ...
                main: function(e, t, n, s, a) {
                    ...
                    return '<lol-uikit-tooltip>\r\n  <lol-uikit-content-block class="event-shop-xp-tooltip-content" type="tooltip-system">\r\n    <div class="event-shop-progression-tooltip-block">\r\n      <p>\r\n        ' + c(typeof(o = null != (o = n.youNeedText || (null != t ? t.youNeedText : t)) ? o : r) === i ? o.call(l, {
                        ...
                        hash: {},
                        data: a
                    }) : o) + " " + c(typeof(o = null != (o = n.tokensText || (null != t ? t.tokensText : t)) ? o : r) === i ? o.call(l, {
                        name: "tokensText",
                        hash: {},
                        data: a
            ...
            var r = s.Ember.Component.extend({
                ...
                observeTokenShopData() {
                    this.eventShopDataBinding.observe(l, this, (e => {
                        if (this.isDestroying || this.isDestroyed || !e) return this.tokenName = null, this.tokenImage = null, void(this.tokenBundlesCatalogEntry = null);
                        this.setProperties({
                ...
                willDestroyElement() {
                    this._super(...arguments), this.eventShopDataBinding.removeObserver(l, this)
                },
                actions: {
                    navigateToStore() {
                        s.Telemetry.sendCustomData(a.TELEMETRY.TABLE, {
    ...
    n.g = function() {
        ...
        a.addEventListener(o, (function(e) {
            (0, e.registrationHandler)((e => t.default.init(e, {
                ...
                const n = e.get("rcp-fe-lol-l10n").tra().overlay("/fe/lol-l10n/trans.json").overlay("/fe/lol-loot/trans.json").overlay("/fe/lol-event-shop/trans.json"),
