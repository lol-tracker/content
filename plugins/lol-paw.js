(() => {
    var e = [, e => {
            ...
            function o(e, t) {
                return "number" != typeof e.itemId || "string" != typeof e.inventoryType ? (s.default.logger.error("Purchase Anywhere Widget expects a number itemId and string inventoryType"), !1) : "string" == typeof t || (s.default.logger.error("Purchase Anywhere Widget expects a source to indicate who is the caller"), !1)
            }

            function i(e, t, n) {
                if (!e) return s.default.logger.error("Create Paw Template expects a offer id."), !1;
                if (!n) return s.default.logger.error("Create Paw Template expects a source."), !1;
                if (!t) return s.default.logger.error("Create Paw Template expects a template."), !1;
                if (!t.templateType) return s.default.logger.error("Create Paw Template expects a template to contain a template type"), !1;
                if (t.components)
                    for (let e = 0; e < t.components.length; e++)
                        if (t.components[e].componentType === l.PAW.COMPONENT_TYPES.PURCHASE && t.components[e].currencyType === l.PAW.CURRENCY_TYPES.IP) return s.default.logger.error("Create Paw Template does not support currency type IP, this is deprecated, use BE"), !1;
                return !0
            }
            t.default = class {
                constructor(e) {
                ...
                createPAWChoiceModal(e, t, n, a = null, s = null, l = null) {
                    if (function(e, t) {
                        ...
                        if (n.createPAWChoiceModal(e, t, a, s)) return n.onClosed = l, !0
                    }
                    return !1
                }
                ...
                createPawTemplateModal(e, t, n, a) {
                    return !!i(e, t, n) && this.privateAPI.createPawTemplateModal(e, t, n, a, !1)
                }
                createPawTemplateModalAsync(e, t, n, a) {
                    return !!i(e, t, n) && this.privateAPI.createPawTemplateModal(e, t, n, a, !0)
                }
                populatePawTemplateModal(e) {
                    return !! function(e) {
                        return e ? !!e.templateType || (s.default.logger.error("Populate Paw Template expects a template to contain a template type"), !1) : (s.default.logger.error("Populate Paw Template expects a template."), !1)
                    }(e) && this.privateAPI.populatePawTemplateModal(e)
                }
                getBaseSkinLineData(e) {
                    return function(e) {
                        return !!e || (s.default.logger.error("Get Template Data expects offer id."), !1)
                    }(e) ? this.privateAPI.getBaseSkinLineData(e) : Promise.reject("failed parameter sanitization")
                }
            }
        }, (e, t, n) => {
            "use strict";
            ...
            class l {
                constructor() {
                    this.receiveConfiguration = this.receiveConfiguration.bind(this), this.privateAPI = a.privateAPI, this.pawBinding = (0, a.dataBinding)("/lol-purchase-widget", (0, a.getProvider)().getSocket()), this.pawBinding.observe("/v1/configuration", this, this.receiveConfiguration)
                }
            ...
            var a, s = n(1),
                l = (a = n(23)) && a.__esModule ? a : {
                    default: a
                };
            let o;
            class i {
                constructor() {
                    this.handleGameFlowUpdate = this.handleGameFlowUpdate.bind(this), this.privateAPI = s.privateAPI, this.gameFlowBinding = (0, s.dataBinding)("/lol-gameflow", (0, s.getProvider)().getSocket()), this.gameFlowBinding.observe("/v1/session", this, this.handleGameFlowUpdate)
                }
                handleGameFlowUpdate(e) {
                    ...
                    t && (t !== l.default.READY_CHECK && t !== l.default.GAME_START || this.privateAPI.removePAWModal())
                }
            }
            var c = {
                init: function() {
            ...
            t.default = class {
                constructor() {
                    this.bindings = {
                        champions: (0, a.dataBinding)("/lol-champions", (0, a.getProvider)().getSocket()),
                        login: (0, a.dataBinding)("/lol-login", (0, a.getProvider)().getSocket()),
                        paw: (0, a.dataBinding)("/lol-purchase-widget", (0, a.getProvider)().getSocket()),
                        store: (0, a.dataBinding)("/lol-store", (0, a.getProvider)().getSocket())
                    }, this.tra = this.traService(), this.setUpComponents(this.tra), this.createPAWModal = this.createPAWModal.bind(this), this.removePAWModalBinded = this.closePAWModal.bind(this), this.enabled = !0, this.pawModal = null
                }
                get isEnabled() {
                    return this.enabled
                }
                traService() {
                    const e = (0, a.getProvider)().get("rcp-fe-lol-l10n").tra().overlay("/fe/lol-l10n/trans.json").overlay("/fe/lol-paw/trans.json");
                    return (0, s.default)(a.Ember, e)
                }
                showPAWModal(e, t, n) {
                    return a.Telemetry.sendCustomData(l.TELEMETRY_EVENT_NAME, n), t = {
                        items: null,
                        itemId: null,
                        inventoryType: null,
                    ...
                    }), this.pawModal.domNode.addEventListener(o.PAW_MODAL_CLOSE_EVENT_NAME, this.removePAWModalBinded), !0
                }
                ...
                removePAWModal() {
                    this.pawModal && (this.onClosed && this.onClosed(), this.pawModal.domNode.removeEventListener(o.PAW_MODAL_CLOSE_EVENT_NAME, this.removePAWModalBinded), a.modalManager.remove(this.pawModal), this.onClosed = null, this.pawModal.componentPromise.then((e => a.Ember.run((() => {
                        e && e.app && e.app.destroy()
                    })))), this.pawModal = null, this.source = null, a.Telemetry.sendCustomData(l.TELEMETRY_EVENT_NAME, {
                ...
                setUpComponents(e) {
                    a.emberApplicationFactory.setFactoryDefinition({
                        ...
                        BundleHeaderComponent: n(119),
                        BundleItemsComponent: n(122),
                        BundleItemComponent: n(125),
                        BundleDiscountComponent: n(128),
                        BundleBottomComponent: n(131),
                        BundleBottomDisclaimersComponent: n(134),
                        ChromaBundleDetailsComponent: n(137),
                        ChromaBundleOverlayImageComponent: n(139),
                        ChromaButtonComponent: n(142),
                        ChromaBundleContentItemsComponent: n(145),
                        PurchaseWidgetService: n(146),
                        ...
                        tra: e,
                        ComponentFactory: a.componentFactory,
                        PAWRPTopUpModalComponent: n(147)
                    })
                }
                enable() {
                    this.enabled = !0
                ...
                populatePawTemplateModal(e) {
                    return this.pawModal ? !!this.enabled && (this.pawModal.data.pawTemplateData ? (this.pawModal.data.pawTemplateData.service.populateModal(e), !0) : (a.logger.error("Cannot update template data on a non PAW Template presentation"), !1)) : (a.logger.error("Cannot update template data no PAW Template modal created"), !1)
                }
                getBaseSkinLineData(e) {
            ...
            e.exports = function(e, a, s) {
                ...
                return a = a.observe((() => {
                    if (l) {
                        ...
                        l.set("metadata", e), l.beginPropertyChanges(), Object.keys(o).forEach((e => {
                ...
                }).create(), l.set("service", l), l.addObserver("metadata.region", n.bind(null, a, "region")), l.addObserver("metadata.locale", n.bind(null, a, "locale")), s && (console.warning("deprecated: pass a traService as a property of your Ember application definition"), s.register("tra:main", l, {
                    instantiate: !1
            ...
            var p = a.Ember.Service.extend(i.default, {
                ...
                componentNames: r("pawTemplateDataCache.template.components.[]", "isWaitingToPresent", (function() {
                    const e = [];
                    if (this.get("isWaitingToPresent")) return e;
                    for (let t = 0; t < this.get("pawTemplateDataCache.template.components").length; t++) {
                        const n = this.get("pawTemplateDataCache.template.components." + t + ".componentType");
                        e.push(this._getComponentNameFromComponentType(n))
                    }
                    return e
                })),
                genericError: !1,
                nonRefundableDisclaimerEnabled: r.readOnly("pawConfig.nonRefundableDisclaimerEnabled"),
                init() {
                    this._super(...arguments), this._dataBinding = (0, a.dataBinding)(s.PURCHASE_WIDGET_BINDING_URL, (0, a.getProvider)().getSocket()), this._dataBinding.observe(s.PURCHASE_OFFER_STATUSES_URL, this, (e => {
                        this._updateOfferPurchaseProgress(e)
                    }))
                },
                willDestroy() {
                    this._super(...arguments), this._dataBinding.unobserve(this), this._dataBinding = null
                },
                initializeWithData(e) {
                    this.get("pawTemplateDataCache.service") ? a.logger.error("pawTemplateDataCache.service reference already exists, initializeWithData() should only be called once") : (e.service = this, this.set("offerValidationProgress", {
                        state: o.PAW.OFFER_VALIDATION_STATES.NOT_STARTED,
                        errorKey: void 0
                        ...
                        state: o.PAW.OFFER_PURCHASE_STATES.NOT_STARTED,
                        errorKey: void 0
                    }), this.set("genericError", !1), this.set("isWaitingToPresent", !0), this.set("pawTemplateDataCache", e), this.set("isWaitingForAsyncPopulate", e.async), e.async && this.set("asyncWithoutPopulateTimeout", setTimeout((() => {
                        this.get("isWaitingToPresent") && this.set("genericError", !0)
                    }), s.MAX_WAITING_TIME_IN_MS)))
                },
                populateModal(e) {
                    this.set("pawTemplateDataCache.template", e), this.set("isWaitingForAsyncPopulate", !1), this._checkIfReadyToPresent()
                },
                ...
                validateOffer() {
                    this.set("offerValidationProgress.state", o.PAW.OFFER_VALIDATION_STATES.IN_PROGRESS);
                    const e = {
                        offerId: this.get("pawTemplateDataCache.offerId")
                    };
                    Promise.race([this._getTimeoutPromise(s.MAX_WAITING_TIME_IN_MS, "paw-template.validateOffer"), this._dataBinding.post(s.VALIDATE_OFFER_URL, e)]).then((e => {
                ...
                purchaseOffer(e) {
                    this._updateOfferPurchaseProgressState(o.PAW.OFFER_PURCHASE_STATES.IN_PROGRESS);
                    const t = e.currencyType === o.PAW.CURRENCY_TYPES.CUSTOM ? e.currencyPaymentOption : e.currencyType,
                    ...
                    this.get("pawTemplateDataCache.template").onPurchaseInitiated && this.get("pawTemplateDataCache.template").onPurchaseInitiated(e), this.set("purchaseOptionSourceInProgress", e), Promise.race([this._getTimeoutPromise(s.MAX_WAITING_TIME_IN_MS, "paw-template.purchaseOffer"), this._dataBinding.post(s.PURCHASE_OFFER_URL, a)]).then((e => {
                        e.legacy ? this._updateOfferPurchaseProgressState(o.PAW.OFFER_PURCHASE_STATES.SUCCESS) : this.set("offerPurchaseProgress.orderId", e.orderDto.data.id)
                    })).catch((e => {
                        this._updateOfferPurchaseProgressState(o.PAW.OFFER_PURCHASE_STATES.FAIL), this.set("offerPurchaseProgress.errorKey", "cat_paw_error_generic")
                    }))
                },
                notifySourceConnections(e, t) {
                    const n = this.get("pawTemplateDataCache.template.componentConnections");
                    if (n)
                        for (let a = 0; a < n.length; a++)
                            if (n[a].source === e)
                                for (let e = 0; e < n[a].connections.length; e++) this.set("pawTemplateDataCache.template.components." + n[a].connections[e] + ".sourceConnectionData", t)
                },
                getMediaPathFromPurchaseOption(e) {
                    ...
                    switch (e.currencyType) {
                        ...
                        case o.PAW.CURRENCY_TYPES.CUSTOM:
                            return e.currencyImage ? this.getMediaPath(e.currencyImage) : null;
                        default:
                            return a.logger.warning(e.currencyType + " not handled in getMediaPathFromPurchaseOption"), null
                    }
                },
                getValidateErrorStringFromKey(e, t) {
                    switch (t) {
                        ...
                        case l.default.MISSING_REQUIRED_ITEMS_LOYALTY:
                            return e.get("cat_paw_error_validation_item_loyalty_parent_not_owned");
                        case l.default.NOT_ENOUGH_CURRENCY:
                            return e.get("cat_paw_error_validation_item_not_enough_currency");
                        case l.default.GENERIC_ERROR:
                        default:
                            return e.get("cat_paw_error_generic")
                    }
                },
                getErrorIcon: e => e === l.default.MISSING_REQUIRED_ITEMS_LOYALTY ? "/fe/lol-static-assets/images/xbox-game-pass-loyalty-hint.svg" : "/fe/lol-static-assets/svg/alert-info-red.svg",
                _checkIfReadyToPresent() {
                    const e = this.get("offerValidationProgress.state") === o.PAW.OFFER_VALIDATION_STATES.COMPLETED;
                    !this.get("isWaitingForAsyncPopulate") && e && this.set("isWaitingToPresent", !1)
                },
                _getComponentNameFromComponentType(e) {
                    ...
                    switch (e) {
                        ...
                        default:
                            return a.logger.warning(e + " not handled in getComponentNameFromComponentType"), null
                    }
                },
                _getTimeoutPromise: (e, t) => new Promise((function(n, a) {
                    setTimeout((function() {
                ...
                _updateOfferPurchaseProgress(e) {
                    if (e) {
                        ...
                        if (e.statuses[t]) {
                            ...
                            this._updateOfferPurchaseProgressState(n), n === o.PAW.OFFER_PURCHASE_STATES.FAIL && this.set("offerPurchaseProgress.errorKey", "cat_paw_error_generic")
                        }
                    }
                },
                _updateOfferPurchaseProgressState(e) {
                    this.set("offerPurchaseProgress.state", e), e !== o.PAW.OFFER_PURCHASE_STATES.FAIL && e !== o.PAW.OFFER_PURCHASE_STATES.SUCCESS || this.get("pawTemplateDataCache.template").onPurchaseComplete && this.get("pawTemplateDataCache.template").onPurchaseComplete(this.get("purchaseOptionSourceInProgress"), e === o.PAW.OFFER_PURCHASE_STATES.SUCCESS)
                },
                _handleValidationResponse(e) {
                    this.set("offerValidationProgress.state", o.PAW.OFFER_VALIDATION_STATES.COMPLETED), e ? e.validationErrors.length > 0 && (e.validationErrors[0].errorKey === l.default.GENERIC_ERROR && this.set("genericError", !0), e.validationErrors[0].errorKey, l.default.NOT_ENOUGH_CURRENCY, this.set("offerValidationProgress.errorKey", e.validationErrors[0].errorKey)) : this.set("offerValidationProgress.errorKey", l.default.GENERIC_ERROR), this._checkIfReadyToPresent()
                }
            });
            t.default = p
        }, (e, t) => {
            ...
            t.default = {
                ...
                MISSING_REQUIRED_ITEMS_LOYALTY: "validate.missing_required_items_loyalty",
            ...
            var o = a.Ember.Component.extend({
                ...
                componentData2: l.readOnly("pawTemplateService.pawTemplateDataCache.template.components.2"),
                componentData3: l.readOnly("pawTemplateService.pawTemplateDataCache.template.components.3"),
                componentData4: l.readOnly("pawTemplateService.pawTemplateDataCache.template.components.4"),
                ...
                isWaitingToPresent: l.readOnly("pawTemplateService.isWaitingToPresent"),
                genericError: l.readOnly("pawTemplateService.genericError"),
                purchaseSuccess: l.equal("pawTemplateService.offerPurchaseProgress.state", s.PAW.OFFER_PURCHASE_STATES.SUCCESS),
                successImagePath: l("pawTemplateService.pawTemplateDataCache.template.purchaseSuccessInfo.purchaseSuccessImage", (function() {
                    const e = this.get("pawTemplateService.pawTemplateDataCache.template.purchaseSuccessInfo.purchaseSuccessImage");
                    return this.get("pawTemplateService").getMediaPath(e)
                })),
                successItemName: l.readOnly("pawTemplateService.pawTemplateDataCache.template.purchaseSuccessInfo.purchaseSuccessItemName"),
                successItemDescription: l.readOnly("pawTemplateService.pawTemplateDataCache.template.purchaseSuccessInfo.purchaseSuccessItemDescription"),
                successDeepLinkConextPrefix: l("pawTemplateService.pawTemplateDataCache.template.purchaseSuccessInfo", (function() {
                    return this.get("tra.cat_pawt_celebration_deep_link_context").split("{{icon}}")[0]
                })),
                successDeepLinkConextSuffix: l("pawTemplateService.pawTemplateDataCache.template.purchaseSuccessInfo", (function() {
                    return this.get("tra.cat_pawt_celebration_deep_link_context").split("{{icon}}")[1]
                })),
                actions: {
                    onCloseButton() {
                    ...
                    onCollectionsButton() {
                        a.privateAPI.removePAWModal(), a.Router.navigateTo("rcp-fe-lol-collections")
                    }
                }
            });
            t.default = o
            ...
            var l = a.Ember.Component.extend({
                ...
                thumbnailsToDisplay: s("componentData.images.[]", (function() {
                    const e = [];
                    for (let t = 0; t < this.get("componentData.images").length; t++) e.push({
                        displayIndex: t,
                        imagePath: this.get("pawTemplateService").getMediaPath(this.get("componentData.images." + t + ".thumbnail"))
                    });
                    return e
                })),
                thumbnails: s("selectedDisplayIndex", "thumbnailsToDisplay", (function() {
                    for (let e = 0; e < this.get("thumbnailsToDisplay").length; e++) this.set("thumbnailsToDisplay." + e + ".selected", e === this.get("selectedDisplayIndex"));
                    return this.get("thumbnailsToDisplay")
                })),
                init() {
                    this._super(...arguments), this._snapToIndex(0), this.set("autoScrollInterval", setInterval((() => {
                        this._changeScrollPosition(1)
                    }), 1e4))
                },
                actions: {
                    onThumbnailButton(e) {
                        this.set("selectedDisplayIndex", e.displayIndex), this._notifyConnections(e.displayIndex), this._snapToIndex(this.get("selectedDisplayIndex")), this._clearIntervalHelper()
                    },
                    onLeftArrowButton() {
                ...
                _snapToIndex(e) {
                    const t = this.get("thumbnailWidth"),
                        n = (this.get("componentData.images") ? this.get("componentData.images").length : 0) * t / 2 - t / 2 - e * t;
                ...
                _notifyConnections(e) {
                    const t = this.get("componentData.images." + e + ".large"),
                        ...
                        a = {
                            media: this.get("componentData.images." + e + ".video") || t || n,
                            associatedText: this.get("componentData.localizedAssociatedTextData." + e),
                            index: e + 1
                        };
                    this.get("pawTemplateService").notifySourceConnections(this.get("areaIndex"), a)
                },
                _changeScrollPosition(e) {
                    let t = 0;
                    e > 0 ? this.get("selectedDisplayIndex") < this.get("componentData.images").length - 1 && (t = this.get("selectedDisplayIndex") + 1) : (t = this.get("componentData.images").length - 1, this.get("selectedDisplayIndex") > 0 && (t = this.get("selectedDisplayIndex") - 1)), this.set("selectedDisplayIndex", t), this._notifyConnections(t), this._snapToIndex(this.get("selectedDisplayIndex"))
                },
                _clearIntervalHelper() {
                    this.get("autoScrollInterval") && (clearInterval(this.get("autoScrollInterval")), this.set("autoScrollInterval", null))
                }
            });
            t.default = l
        }, (e, t, n) => {
            ...
            var o = a.Ember.Component.extend({
                ...
                captionText: l("componentData.caption.total", "componentData.sourceConnectionData", (function() {
                    const e = this.get("componentData.sourceConnectionData.index") || 1;
                    return this.get("tra").formatString("cat_paw_skin_line_caption", {
                        index: e,
                        total: this.get("componentData.caption.total")
                    })
                })),
                media: l("componentData.media", "componentData.sourceConnectionData", (function() {
                    const e = this.get("componentData.sourceConnectionData.media"),
                        t = e || this.get("componentData.media");
                    return {
                        isVideo: e && e.type === s.PAW.MEDIA_TYPES.VIDEO || this.get("componentData.media.type") === s.PAW.MEDIA_TYPES.VIDEO,
            ...
            var o = a.Ember.Component.extend({
                ...
                validateError: l("pawTemplateService.offerValidationProgress.errorKey", (function() {
                    ...
                    return e ? this.get("pawTemplateService").getValidateErrorStringFromKey(this.get("tra"), e) : void 0
                })),
                validationIcon: l("pawTemplateService.offerValidationProgress.errorKey", (function() {
                    const e = this.get("pawTemplateService.offerValidationProgress.errorKey");
                    return this.get("pawTemplateService").getErrorIcon(e)
                })),
                purchaseNotStarted: l.equal("pawTemplateService.offerPurchaseProgress.state", s.PAW.OFFER_PURCHASE_STATES.NOT_STARTED),
                purchaseInProgress: l.equal("pawTemplateService.offerPurchaseProgress.state", s.PAW.OFFER_PURCHASE_STATES.IN_PROGRESS),
                purchaseSuccess: l.equal("pawTemplateService.offerPurchaseProgress.state", s.PAW.OFFER_PURCHASE_STATES.SUCCESS),
                purchaseError: l("pawTemplateService.offerPurchaseProgress.state", "pawTemplateService.offerPurchaseProgress.errorKey", (function() {
                    return this.get("pawTemplateService.offerPurchaseProgress.state") === s.PAW.OFFER_PURCHASE_STATES.FAIL && this.get(`tra.${this.get("pawTemplateService.offerPurchaseProgress.errorKey")}`)
                })),
                purchaseOptions: l("componentData.purchaseOptions", "validateError", "purchaseError", (function() {
                    const e = [];
                    for (let t = 0; t < this.get("componentData.purchaseOptions").length; t++) e.push({
                        currencyImagePath: this.get("pawTemplateService").getMediaPathFromPurchaseOption(this.get(`componentData.purchaseOptions.${t}`)),
                        currencyName: this.get(`componentData.purchaseOptions.${t}.currencyName`),
                        price: this.get(`componentData.purchaseOptions.${t}.price`),
                        source: this.get(`componentData.purchaseOptions.${t}`),
                        disabled: this.get("validateError") || this.get("purchaseError") || this.get(`componentData.purchaseOptions.${t}.disabled`)
                    });
                    return e
                })),
                disclaimerAcknowledged: !1,
                showNonRefundableDisclaimer: l("pawTemplateService.nonRefundableDisclaimerEnabled", "disclaimerAcknowledged", (function() {
                    return this.get("pawTemplateService.nonRefundableDisclaimerEnabled") && !this.get("disclaimerAcknowledged")
                })),
                showError: l("validateError", "purchaseError", (function() {
                    return this.get("validateError") || this.get("purchaseError")
                })),
                disclaimerTextPrefix: l("tra.cat_paw_purchase_non_refundable_disclaimer", (function() {
                    return this.get("tra.cat_paw_purchase_non_refundable_disclaimer").split("{{confirmationLink}}")[0]
                })),
                disclaimerTextSuffix: l("tra.cat_paw_purchase_non_refundable_disclaimer", (function() {
                    return this.get("tra.cat_paw_purchase_non_refundable_disclaimer").split("{{confirmationLink}}")[1]
                })),
                actions: {
                    onPurchaseButton(e) {
                        e.disabled || this.get("pawTemplateService").purchaseOffer(e.source)
                    },
                    onDisclaimerButton() {
            ...
            var o = a.Ember.Component.extend({
                ...
                scrollListSections: l("componentData.sections", (function() {
                    const e = [];
                    for (let t = 0; t < this.get("componentData.sections").length; t++) {
                        const n = [];
                        for (let e = 0; e < this.get(`componentData.sections.${t}.items`).length; e++) {
                            const a = this.get(`componentData.sections.${t}.items.${e}.thumbnail`),
                                s = this.get(`componentData.sections.${t}.items.${e}.image`);
                            n.push({
                                sectionIndex: t,
                                itemIndex: e,
                                localizedTitle: this.get(`componentData.sections.${t}.items.${e}.localizedTitle`),
                                localizedSubtitle: this.get(`componentData.sections.${t}.items.${e}.localizedSubtitle`),
                                localizedRightText: this.get(`componentData.sections.${t}.items.${e}.localizedRightText`),
                                imagePath: a ? this.get("pawTemplateService").getMediaPath(a) : null,
                                imageData: s || a
                            })
                        }
                        e.push({
                            isCompact: this.get(`componentData.sections.${t}.displayType`) === s.PAW.SCROLL_LIST_DISPLAY_TYPES.COMPACT,
                            isExpanded: this.get(`componentData.sections.${t}.displayType`) === s.PAW.SCROLL_LIST_DISPLAY_TYPES.EXPANDED,
                            isDetailed: this.get(`componentData.sections.${t}.displayType`) === s.PAW.SCROLL_LIST_DISPLAY_TYPES.DETAILED,
                            localizedTitle: this.get(`componentData.sections.${t}.localizedTitle`),
                            items: n
                        })
                    }
                    return e
                ...
                actions: {
                    onItemSelected(e) {
                        this.get("componentData.onItemSelected") && this.get("componentData.onItemSelected")(e)
                    }
                }
            });
            t.default = o
            ...
            e.exports = a.HTMLBars.template({
                id: "R+7knVJu",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\paw-template\\\\text-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\paw-template\\\\text-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\paw-template\\\\text-component\\\\index.js\\" "],["text","\\n"],["append",["unknown",["text"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            var l = a.Ember.Component.extend({
                ...
                items: s("componentData.items.[]", (function() {
                    ...
                    for (let t = 0; t < this.get("componentData.items").length; t++) {
                        let n, a, s;
                        this.get("componentData.items." + t + ".image") && (n = this.get("pawTemplateService").getMediaPath(this.get("componentData.items." + t + ".image"))), this.get("componentData.items." + t + ".localizedName") && (a = this.get("componentData.items." + t + ".localizedName")), this.get("componentData.items." + t + ".localizedDescription") && (s = this.get("componentData.items." + t + ".localizedDescription")), e.push({
                            imagePath: n,
                            name: a,
                            description: s
                        })
            ...
            e.exports = a.HTMLBars.template({
                id: "ViIycBMR",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\paw-template\\\\window-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\paw-template\\\\window-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\paw-template\\\\window-component\\\\index.js\\" "],["text","\\n"],["block",["if"],[["get",["isLargeTwoColumnLandscapeTemplate"]]],null,0]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","    "],["append",["unknown",["paw-template-large-two-column-landscape-template"]],false],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
                ...
                return {
                    ...
                    components: [{
                        ...
                        sections: [{
                            ...
                            localizedTitle: t.get("cat_paw_skin_line_purchase_summary"),
                            items: c(e, t)
                        }]
                    }, {
            ...
            function s(e) {
                const t = [];
                for (let n = 0; n < e.items.length; n++) t.push(e.items[n].localizedShortName);
                return t
            }

            function l(e, t) {
                return t.formatString("cat_pawt_celebration_unlocked_message_skin_line", {
            ...
            function o(e) {
                const t = [];
                for (let n = 0; n < e.items.length; n++) t.push({
                    thumbnail: {
                        type: a.PAW.MEDIA_TYPES.IMAGE,
                        loadType: a.PAW.MEDIA_LOAD_TYPES.GAME_DATA,
                        location: e.items[n].largeImagePath || e.items[n].thumbnailImagePath
                    },
                    large: {
                        type: a.PAW.MEDIA_TYPES.IMAGE,
                        loadType: a.PAW.MEDIA_LOAD_TYPES.GAME_DATA,
            ...
            function i(e) {
                const t = [];
                for (let n = 0; n < e.skinLineDescriptions.length; n++) t.push({
            ...
            function c(e, t) {
                const n = [];
                for (let s = 0; s < e.items.length; s++) n.push({
                    localizedTitle: e.items[s].localizedLongName,
                    localizedSubtitle: 0 === s ? t.get("cat_paw_skin_line_purchase_summary_base") : t.get("cat_paw_skin_line_purchase_summary_extras"),
                    thumbnail: {
                        type: a.PAW.MEDIA_TYPES.IMAGE,
                        loadType: a.PAW.MEDIA_LOAD_TYPES.GAME_DATA,
            ...
            function r(e) {
                const t = [];
                for (let n = 0; n < e.pricingOptions.length; n++) t.push({
            ...
            const {
                Component: u,
                computed: d
            } = a.Ember, h = [i.default.Errors.NOT_ENOUGH_CURRENCY], g = [i.default.Errors.NOT_ENOUGH_CURRENCY, i.default.Errors.PARENT_NOT_OWNED], _ = u.extend(l.default, {
                ...
                nonRefundableDisclaimerEnabled: d.readOnly("pawConfig.nonRefundableDisclaimerEnabled"),
                alwaysShowPurchaseDisclaimer: d.readOnly("pawConfig.alwaysShowPurchaseDisclaimer"),
                isPotatoModeEnabled: d.readOnly("userExperience.data.potatoModeEnabled"),
                ...
                purchaseOptions: d.readOnly("catalogItemPurchaseOption.purchaseOptions"),
                sale: d.readOnly("catalogItemPurchaseOption.sale"),
                validationErrors: d.readOnly("catalogItemPurchaseOption.validationErrors"),
                pawTemplateService: a.Ember.inject.service("paw-template"),
                isPawTemplateModal: d.notEmpty("pawTemplateData"),
                pendingRmsNotification: d("purchaseWidgetService.orderNotifications.[]", "currentRmsNotificationTransactionId", (function() {
                    const e = this.get("currentRmsNotificationTransactionId");
                    if (!e) return !1;
                    const t = (this.get("purchaseWidgetService.orderNotifications") || []).filter((t => t.eventTypeId === e)),
                        n = t.find((e => "COMPLETE" === e.status)),
                        a = t.find((e => "FAILED" === e.status));
                    return n ? (this._clearTimeoutTimer(), this.set("currentRmsNotificationTransactionId", ""), this._handlePurchaseCompleted({
                        transactionId: e
                    })) : a && (this._clearTimeoutTimer(), this._handleRmsNotificationFailed()), !n && !a
                })),
                purchaseSuccess: d("purchaseRequestFinished", "pendingRmsNotification", (function() {
                    return this.get("purchaseRequestFinished") && !this.get("pendingRmsNotification")
                })),
                showCelebrationVideo: d("isPotatoModeEnabled", "purchaseSuccess", "supportsMultipleItems", (function() {
                    return !this.get("isPotatoModeEnabled") && this.get("purchaseSuccess") && !this.get("supportsMultipleItems")
                })),
                ...
                contentRendererComponent: d("itemPurchaseOption", (function() {
                    const e = this.get("itemPurchaseOption");
                    return e && e.inventoryType === s.PAW.INVENTORY_TYPES.BUNDLES && e.subInventoryType === o.default.CHROMA_BUNDLE ? "chroma-bundle-details" : "item-details"
                })),
                ...
                bundleErrorMessage: d("validationErrors", (function() {
                    return this._findErrorMessageForBundle(this.get("validationErrors"))
                })),
                init() {
                    this._super(...arguments), this.get("isPawTemplateModal") && this.get("pawTemplateService").initializeWithData(this.get("pawTemplateData"))
                },
                didInsertElement() {
                    this._super(...arguments), this.get("isPawTemplateModal") ? this.get("pawTemplateService").validateOffer() : this._loadCatalogItemInfo()
                },
                actions: {
                    purchase(e) {
                        this._purchase(e)
                ...
                willDestroy() {
                    this.set("onPurchased", null), this._clearTimeoutTimer(), this._super(...arguments)
                },
                _purchase(e) {
                    this.set("isPurchasing", !0);
                    const t = this.get("purchaseWidgetService"),
                        n = this.get("source");
                    return t.purchaseItem(e, n).then(this._handlePurchaseRequestFinished.bind(this)).catch(this._handlePurchaseError.bind(this))
                },
                _extractPurchaseResultInfo(e) {
                    const t = e && e.items && e.items.length > 0,
                        n = e && e.transactions && e.transactions.length > 0;
                    return {
                        itemIds: t ? e.items.filter((e => e.itemKey)).map((e => e.itemKey.itemId)) : [],
                        inventoryTypes: t ? e.items.filter((e => e.itemKey)).map((e => e.itemKey.inventoryType)) : [],
                        sources: t ? e.items.filter((e => e.source)).map((e => e.source)) : [],
                        transactionIds: n ? e.transactions.filter((e => e.transactionId)).map((e => e.transactionId)) : []
                    }
                },
                _handlePurchaseRequestFinished(e) {
                    if (this.set("purchaseRequestFinished", !0), e && e.useRMSConfirmation) {
                        const t = e.transactions && e.transactions[0] && e.transactions[0].transactionId;
                        if (!t) return void this._handlePurchaseError({
                            data: {
                                errorDetails: {
                                    error: "Purchase error: received useRMSConfirmation=true but could not find a transactionId"
                                }
                            }
                        });
                ...
                _handlePurchaseError(e) {
                    if (this.set("isPurchasing", !1), a.privateAPI.removePAWModal(), e instanceof Error) return a.Telemetry.sendCustomData(c.TELEMETRY_EVENT_NAME, {
                ...
                _loadSingleCatalogItemInfo() {
                    ...
                    a.Telemetry.sendCustomData(c.TELEMETRY_EVENT_NAME, s), Promise.race([this._getTimeoutPromise(r.MAX_WAITING_TIME_IN_MS), e.getItem(t, n)]).then(this._handleCatalogItemPurchaseOption.bind(this)).catch(this._handleCatalogItemInfoError.bind(this))
                },
                _loadMultipleCatalogItemInfo() {
                    ...
                    a.Telemetry.sendCustomData(c.TELEMETRY_EVENT_NAME, s), Promise.race([this._getTimeoutPromise(r.MAX_WAITING_TIME_IN_MS), e.getItems(t, n)]).then(this._handleCatalogItemPurchaseOption.bind(this)).catch(this._handleCatalogItemInfoError.bind(this))
                },
                _loadCatalogItemInfo() {
                    this._showLoadingSpinner();
                    this.get("supportsMultipleItems") ? this._loadMultipleCatalogItemInfo() : this._loadSingleCatalogItemInfo()
                },
                _handleCatalogItemPurchaseOption(e) {
                    if (e) {
                        ...
                        const e = this._getCatalogPurchaseOptionWithValidationErrors([i.default.Errors.UNKNOWN_ITEM]);
                        this.set("catalogItemPurchaseOption", e)
                    }
                    this._hideLoadingSpinner(), a.Telemetry.sendCustomData(c.TELEMETRY_EVENT_NAME, {
                        id: c.TELEMETRY_EVENT_ID.LOAD_ITEM_SUCCESS
                    })
                },
                _handleCatalogItemInfoError(e) {
                    a.logger.error("Purchasable item retrieval error or timeout: ", e);
                    let t = e;
                    e instanceof Error || e instanceof TypeError ? (t = this._getCatalogPurchaseOptionWithValidationErrors([i.default.Errors.GENERIC_ERROR]), a.Telemetry.sendCustomData(c.TELEMETRY_EVENT_NAME, {
                    ...
                    }), this.set("catalogItemPurchaseOption", t), this._hideLoadingSpinner()
                },
                _transformCatalogItemMetadata(e) {
                    const t = e.item;
                    if (t && t.metadata && t.metadata.length) {
                        const n = t.metadata.map((e => {
                            ...
                            return t && t.tag && (0, p.isNowWithinActivationDates)(t.activeDate, t.inactiveDate) ? t.tag : null
                        })).filter((e => !!e));
                        return n.length ? {
                            ...e,
                            item: {
                                ...t,
                                tags: t.tags.concat(n)
                            }
                        } : e
                    }
                    return e
                ...
                _getCatalogPurchaseOptionWithValidationErrors: e => a.Ember.Object.create({
                    purchaseOptions: [],
                    dependencies: [],
                    bundledItems: [],
                    validationErrors: e
            ...
            const {
                ...
                extraDecoratorBadges: o("itemPurchaseOption", (function() {
                    const e = this.get("itemPurchaseOption");
                    return e && e.metadata && e.metadata.length ? e.metadata.map((e => {
                        ...
                        return t && t.icon && t.position && (0, s.isNowWithinActivationDates)(t.activeDate, t.inactiveDate) ? {
            ...
            const {
                ...
                layout: n(69),
                style: n(70),
                showOverlayImage: o("itemPurchaseOption.assets.iconPath", "itemPurchaseOption.inventoryType", "itemPurchaseOption.subInventoryType", (function() {
                    return this.get("itemPurchaseOption.assets.iconPath") && (this.get("itemPurchaseOption.inventoryType") !== s.PAW.INVENTORY_TYPES.CHAMPION_SKIN || this.get("itemPurchaseOption.subInventoryType"))
                })),
                isItemDependencyLoyaltyUnlocked: o("itemPurchaseOption", "dependencies.[]", (function() {
                    let e = !1;
                    return this.get("dependencies").forEach((t => {
            ...
            const {
                ...
                layout: n(72),
                style: n(73),
                purchaseEnabled: l("alwaysShowPurchaseDisclaimer", "purchaseDisclaimerChecked", (function() {
            ...
            const {
                ...
                warnings: l("itemPurchaseOption", (function() {
                    const e = this.get("itemPurchaseOption.tags") || [],
                        t = this.get("tra");
                    return e.filter((e => 0 === e.indexOf("charity"))).map((e => {
            ...
            e.exports = a.HTMLBars.template({
                id: "+i5X/mcf",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\purchase-warnings-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\purchase-warnings-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\purchase-warnings-component\\\\index.js\\" "],["text","\\n"],["block",["each"],[["get",["warnings"]]],null,0]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","  "],["open-element","div",[]],["static-attr","class","paw-warning"],["flush-element"],["append",["get",["warning"]],false],["close-element"],["text","\\n"]],"locals":["warning"]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                ...
                backgroundImageUrl: l("itemPurchaseOption.assets.splashPath", (function() {
                    return this.get("itemPurchaseOption.assets.splashPath") || "/fe/lol-paw/images/paw-splash-bg.jpg"
                })),
            ...
            const {
                ...
                showChromaIcon: c("itemPurchaseOption", (function() {
                    ...
                    if (e) {
                        ...
                        return t === l.PAW.INVENTORY_TYPES.CHAMPION_SKIN && n === o.default.CHROMA
                    }
                    return !1
                })),
                overlayBackgroundPath: c("itemPurchaseOption.assets.iconBackgroundPath", (function() {
                    return this.get("itemPurchaseOption.assets.iconBackgroundPath") || 'url("/fe/lol-paw/images/bg-chroma-card.jpg")'
                })),
                inventoryTypeSpecialStyle: c("itemPurchaseOption.inventoryType", (function() {
                ...
                itemSubtitle: l("itemPurchaseOption", "tra.metadata", (function() {
                    ...
                    if (t && t.inventoryType) {
                        ...
                        if (e = o(n, `cat_paw_subtitle_${a.toLowerCase()}`, e), s) {
                            e = o(n, `cat_paw_subtitle_${a.toLowerCase()}_${s.toLowerCase()}`, e)
                        }
                        return e ? n.get(e) : ""
                    }
                    return ""
                })),
                subtitle: l("itemSubtitle", "purchaseSuccess", "tra.cat_paw_modal_item_unlocked_title", (function() {
                    return this.get("purchaseSuccess") ? this.get("tra.cat_paw_modal_item_unlocked_title") : this.get("itemSubtitle")
                }))
            });
            e.exports = i
        }, (e, t, n) => {
            ...
            const {
                ...
                dependentItems: l("tra.cat_paw_dependency_includes", "dependencies", (function() {
                    const e = (this.get("dependencies") || []).filter((e => !e.owned));
                    return o(e.map((e => ({
                        tilePath: e.assets.tilePath,
                        description: this._getDependencyDescription(e.inventoryType)
                    }))))
                })),
                _getDependencyDescription(e) {
                    return this.get("tra").formatString("cat_paw_dependency_includes", {
                        inventoryType: this.get(`tra.cat_paw_inventory_type_${e.toLowerCase()}`)
                    })
                }
            });
            e.exports = i
            ...
            const {
                Component: s,
                computed: l
            } = a.Ember, o = "/lol-client-config/v3/client-config/", i = o + "lol.client_settings.paw.enableRPTopUp", c = o + "lol.client_settings.payments.paymentsMode", r = a.dataBinding.bindTo((0, a.getProvider)().getSocket()), p = s.extend({
                ...
                initDataBindings() {
                    r.observe(c, this, (function(e) {
                        this.set("PMCPaymentsMode", e)
                ...
                closeRpTopUpModal() {
                    ...
                    t && (t.componentPromise.then((e => {
                        e.app.destroy()
                    })), e && a.modalManager.remove(e), this.set("RPTopUpModal", null), this.set("RPTopUpModalComponent", null))
                },
                openPAWErrorModal() {
                    const e = a.UiKitPlugin.getTemplateHelper(),
                        ...
                        n = e.contentBlockDialog(this.get("tra.cat_paw_rp_error_title"), t);
                    a.modalManager.add({
                        type: "DialogAlert",
                        data: {
                            contents: n,
                ...
                PMCPaymentsMode: "RIOT",
                isRPTopUpEnabled: !1,
                aggregatedPriceDetails: l("purchaseOption.priceDetails", (function() {
                ...
                newBalance: l("tra.cat_paw_purchase_cant_afford_message", "aggregatedPriceDetails", "wallet", (function() {
                    ...
                    return e.forEach((e => {
                        ...
                        t.hasOwnProperty(a) ? n.push({
                            currencyType: a,
                            remaining: t[a] - s,
                            currencyName: this.get(`tra.cat_paw_modal_currency_${a.toLowerCase()}`),
                            cantAffordMessage: this.get("tra").formatString("cat_paw_purchase_cant_afford_message", {
                                currency: this.get(`tra.cat_paw_modal_currency_${a.toLowerCase()}`)
                            })
                        }) : n.push({
                            currencyType: a,
                            remaining: -s,
                ...
                purchaseDisabled: l("isRPTopUpEnabled", "cantAffordBalance", "purchaseEnabled", (function() {
                    if (this.get("isRPTopUpEnabled")) {
                        const e = this.get("cantAffordBalance");
                        return !this.get("purchaseEnabled") || !!e && "RP" !== e.currencyType
                    }
                    return Boolean(this.get("cantAffordBalance") || !this.get("purchaseEnabled"))
                })),
                    ...
                    const e = -1 * this.get("cantAffordBalance").remaining,
                        ...
                        l = a.modalManager.add({
                            ...
                            data: {
                                ...
                                onAccept: () => {
                                    (0, a.dataBinding)("lol-store").get("/v1/paymentDetails?action=RP_PURCHASE", {
                                        skipCache: !0
                                    }).then((e => {
                                        let t = "RP_PURCHASE";
                                        "CODE_REDEMPTION" === t && (t = "CODES_REDEMPTION"), a.sharedPayments.openPayments({
                                            payload: JSON.parse(e).encryptedParameters,
                                            action: t,
                                            mode: this.get("PMCPaymentsMode"),
                                            openedFrom: n
                                        })
                                    })).catch((e => {
                ...
                actions: {
                    startPurchase: function() {
                        if (this.get("isRPTopUpEnabled")) {
                            ...
                            if (e && "RP" === e.currencyType) return void this.showRPTopUpModal();
            ...
            const {
                ...
                confirmationTextPrefix: s("tokenizedConfirmationText", "tra.cat_paw_purchase_disclaimer", (function() {
                    const e = this.get("tokenizedConfirmationText");
                    return e && 3 === e.length ? a.Ember.Handlebars.Utils.escapeExpression(e[1]) : this.get("tra.cat_paw_purchase_disclaimer")
                })),
                confirmationTextPostfix: s("tokenizedConfirmationText", "tra.cat_paw_purchase_disclaimer", (function() {
                    const e = this.get("tokenizedConfirmationText");
                    return e && 3 === e.length ? a.Ember.Handlebars.Utils.escapeExpression(e[2]) : ""
                })),
                confirmationLinkText: s("tokenizedConfirmationText", "tra.cat_paw_purchase_disclaimer", (function() {
                    const e = this.get("tokenizedConfirmationText");
                    if (e && 3 === e.length) {
                ...
                didInsertElement() {
                    ...
                    this.element.querySelector(".paw-purchase-confirmation-link").onclick = function(e) {
                        e.stopPropagation()
                    }
                },
                actions: {
            ...
            const c = l.extend({
                ...
                layout: n(98),
                style: n(99),
                unlockSuccessMessage: o("itemPurchaseOption.{inventoryType,subInventoryType,name}", "tra.cat_paw_modal_item_unlocked_details", (function() {
                    ...
                    if (n && n.inventoryType) {
                        ...
                        if (e = i(t, `cat_paw_unlock_message_${a.toLowerCase()}`, e), s) {
                            e = i(t, `cat_paw_unlock_message_${a.toLowerCase()}_${s.toLowerCase()}`, e)
                        }
                    }
                    return a ? t.formatString(e, {
                        itemName: a
            ...
            const {
                ...
                actions: {
                    triggerDetails(e) {
                        const t = this.element.querySelector(`.paw-choice-window-details.option${e}`),
                            n = this.element.querySelectorAll(".paw-choice-window-details"),
                            a = this.element.querySelector(".paw-choice-content-wrapper");
                        for (let e = 0; e < n.length; ++e) n[e].classList.remove("active");
                        t.classList.add("active"), a.style.transform = "translateX(-756px)"
                    },
                    goBack() {
                        const e = this.element.querySelectorAll(".paw-choice-window-details");
                        this.element.querySelector(".paw-choice-content-wrapper").style.transform = "translateX(0px)";
            ...
            const {
                ...
                discountFormatted: r("discount", (function() {
                    ...
                    return this.get("tra").formatString("cat_paw_choice_sale_value_off", {
                        amount: e
                    })
                })),
                subTitleWithDefault: r("subTitle", "inventoryType", (function() {
                    ...
                    const t = this.get("inventoryType"),
                        n = this.get("tra");
                    return "" === e && (e = n.get(`cat_paw_choice_default_subtitle_${t}`)), e
                })),
                ...
                safeChoiceOption: s.Ember.computed("index", "inventoryType", (function() {
                    const e = this.get("index"),
                        t = this.get("inventoryType");
                    return o.default[t] && o.default[t][e] ? o.default[t][e] : e.toString()
                })),
                mouseEnter() {
            ...
            const {
                ...
                additionalSaleDiscount: o("sales", "adjustedPrice", (function() {
                    ...
                    return this.get("tra").formatString("cat_paw_modal_details_formatted_discount", {
                        amount: t - e.cost
                    })
                })),
                ...
                sortedContents: o("contents", (function() {
                    return this.get("contents").sort(((e, t) => e.title > t.title ? 1 : -1))
                })),
                ...
                overflowTextFirstLine: o("limitedContents", "contents", (function() {
                    const e = this.get("firstColumnContents"),
                        t = this.get("secondColumnContents"),
                        n = this.get("contents").length - e.length - t.length;
                    return this.get("tra").formatString("cat_paw_choice_list_extra_items", {
                        extraContent: n
                    })
                })),
                ...
                adjustedDiscountAmount: o("fullPrice", "adjustedPrice", (function() {
                    const e = this.get("fullPrice"),
                        t = this.get("adjustedPrice");
                    return this.get("tra").formatString("cat_paw_modal_details_formatted_discount", {
                        amount: e - t
                ...
                currencyType: o("purchaseOptions", (function() {
                    return this.get("purchaseOptions")[0].priceDetails[0].price.currencyType
                })),
                mainCurrency: o("currencyType", (function() {
                    const e = this.get("currencyType");
                    return this.get("tra").get(`cat_paw_modal_currency_${e.toLowerCase()}`)
                })),
                getPriceForCurrency(e, t) {
                    for (const n of e)
                        if (n.currency === t) return n.cost
                },
                actions: {
                    goBackToMain() {
                        this.get("goBack")()
            ...
            const {
                ...
                iconUrl: null,
                inventoryType: null,
                subTitleForInventoryType: o("subTitle", "inventoryType", (function() {
                    const e = this.get("subTitle");
                    return this.get("inventoryType") === s.PAW.INVENTORY_TYPES.STATSTONE ? this.get("tra").get(`cat_paw_bundled_eternal_rarity_${e}`) : (a.logger.warning("Bundle item type not yet supported, setting subtitle to null"), null)
                }))
            });
            e.exports = i
        }, (e, t, n) => {
            ...
            const {
                ...
                layout: n(117),
                style: n(118),
                hasDiscount: l("catalogItemPurchaseOption.sale.discount", (function() {
            ...
            e.exports = a.HTMLBars.template({
                id: "Qg4SN7Ug",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-root-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-root-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-root-component\\\\index.js\\" "],["text","\\n"],["append",["helper",["bundle-header"],null,[["catalogItemPurchaseOption"],[["get",["catalogItemPurchaseOption"]]]]],false],["text","\\n\\n"],["open-element","div",[]],["static-attr","class","paw-bundle-separator"],["flush-element"],["close-element"],["text","\\n\\n"],["append",["helper",["bundle-items"],null,[["catalogItemPurchaseOption"],[["get",["catalogItemPurchaseOption"]]]]],false],["text","\\n\\n"],["block",["if"],[["get",["hasDiscount"]]],null,0],["text","\\n"],["open-element","div",[]],["static-attr","class","paw-bundle-separator"],["flush-element"],["close-element"],["text","\\n\\n"],["append",["helper",["bundle-bottom"],null,[["catalogItemPurchaseOption","wallet","purchase","isPurchasing","purchaseSuccess","alwaysShowPurchaseDisclaimer","errorMessage","validationErrors"],[["get",["catalogItemPurchaseOption"]],["get",["wallet"]],"purchase",["get",["isPurchasing"]],["get",["purchaseSuccess"]],["get",["alwaysShowPurchaseDisclaimer"]],["get",["errorMessage"]],["get",["validationErrors"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","    "],["open-element","div",[]],["static-attr","class","paw-bundle-separator"],["flush-element"],["close-element"],["text","\\n    "],["append",["helper",["bundle-discount"],null,[["catalogItemPurchaseOption"],[["get",["catalogItemPurchaseOption"]]]]],false],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                ...
                classNames: ["paw-bundle-header-component"],
                layout: n(120),
                style: n(121),
                itemPurchaseOption: l.readOnly("catalogItemPurchaseOption.item"),
                title: l.readOnly("catalogItemPurchaseOption.item.name"),
                description: l.readOnly("catalogItemPurchaseOption.item.description")
            });
            e.exports = o
        }, (e, t, n) => {
            const a = n(1).Ember;
            e.exports = a.HTMLBars.template({
                id: "w/HXJSIT",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-header-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-header-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-header-component\\\\index.js\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","paw-bundle-header-title"],["flush-element"],["text","\\n    "],["append",["helper",["sanitize"],[["get",["title"]]],null],false],["text","\\n"],["close-element"],["text","\\n"],["append",["helper",["top-banner"],null,[["sale","itemPurchaseOption","message"],[false,["get",["itemPurchaseOption"]],""]]],false],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                ...
                classNames: ["paw-bundle-items-component"],
                classNameBindings: ["isOverflowing:can-scroll"],
                layout: n(123),
                style: n(124),
                items: l.readOnly("catalogItemPurchaseOption.bundledItems"),
                isDescriptionExpanded: !1,
                isOverflowing: !1,
                descriptionExpandedClass: l("isDescriptionExpanded", (function() {
                    return this.get("isDescriptionExpanded") ? "expanded" : "collapsed"
                })),
                descriptionVisibilityClass: l("catalogItemPurchaseOption.item.description", (function() {
                    return this.get("catalogItemPurchaseOption.item.description") ? "visible" : "hidden"
                })),
                bundleDescriptionTitle: l((function() {
                    return this.get("tra.cat_paw_bundled_items_description_title")
                })),
                actions: {
                    toggleDescriptionText: function() {
                        const e = this.get("isDescriptionExpanded");
                        this.set("isDescriptionExpanded", !e)
                    }
                },
                didRender() {
                    const e = this.get("element"),
                        t = e && e.children && e.children[0];
                    t && this.set("isOverflowing", t.scrollHeight > t.clientHeight)
                }
            });
            e.exports = o
        }, (e, t, n) => {
            ...
            e.exports = a.HTMLBars.template({
                id: "ZH7Wos1j",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-items-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-items-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-items-component\\\\index.js\\" "],["text","\\n"],["open-element","lol-uikit-scrollable",[]],["static-attr","class","paw-bundle-items-scrollable"],["flush-element"],["text","\\n    "],["open-element","div",[]],["dynamic-attr","class",["concat",["paw-bundle-description ",["unknown",["descriptionVisibilityClass"]]," ",["unknown",["descriptionExpandedClass"]]]]],["flush-element"],["text","\\n        "],["open-element","button",[]],["static-attr","class","paw-bundle-description-header"],["modifier",["action"],[["get",[null]],"toggleDescriptionText"]],["flush-element"],["text","\\n            "],["open-element","div",[]],["static-attr","class","paw-bundle-description-title"],["flush-element"],["text","\\n                "],["append",["unknown",["bundleDescriptionTitle"]],false],["text","\\n            "],["close-element"],["text","\\n            "],["open-element","div",[]],["static-attr","class","paw-bundle-description-expand-indicator"],["flush-element"],["close-element"],["text","\\n        "],["close-element"],["text","\\n        "],["open-element","div",[]],["static-attr","class","paw-bundle-description-text"],["flush-element"],["text","\\n            "],["append",["unknown",["catalogItemPurchaseOption","item","description"]],false],["text","\\n        "],["close-element"],["text","\\n    "],["close-element"],["text","\\n    "],["open-element","div",[]],["static-attr","class","paw-bundle-items"],["flush-element"],["text","\\n"],["block",["each"],[["get",["items"]]],null,0],["text","    "],["close-element"],["text","\\n"],["close-element"],["text","\\n\\n"],["open-element","div",[]],["static-attr","class","paw-bundle-items-scroll-fade"],["flush-element"],["text","\\n"],["close-element"],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","            "],["append",["helper",["bundle-item"],null,[["item"],[["get",["item"]]]]],false],["text","\\n"]],"locals":["item"]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                ...
                layout: n(126),
                style: n(127),
                imagePath: c("item.assets.iconPath", "item.assets.tilePath", (function() {
                    return this.get("item.assets.iconPath") ? this.get("item.assets.iconPath") : this.get("item.assets.tilePath") ? this.get("item.assets.tilePath") : "/fe/lol-paw/images/not-found.png"
                })),
                itemPriceOrOwned: c("item.owned", "item.bundledItemPrice.discountPrices.0.cost", "item.bundledItemPrice.discountPrices.0.currency", (function() {
                    const e = this.get("item.bundledItemPrice.discountPrices.0.cost"),
                        t = this.get("item.bundledItemPrice.discountPrices.0.currency");
                    return this.get("item.owned") ? this.get("tra.cat_paw_bundled_item_purchased") : e && t ? e + " " + t : null
                })),
                itemBackgroundPath: c("item.inventoryType", (function() {
                    if (this.get("item.inventoryType") === l.PAW.INVENTORY_TYPES.CHAMPION_SKIN) return 'url("/fe/lol-paw/images/bg-chroma-card.jpg")'
                })),
                itemSubtitle: c("item.inventoryType", "item.subInventoryType", "item.description", (function() {
                    const e = this.get("item.inventoryType"),
                        t = this.get("item.subInventoryType");
                    switch (e) {
                        case l.PAW.INVENTORY_TYPES.CHAMPION_SKIN:
                            return t === o.default.CHROMA ? this.get("tra.cat_paw_bundled_type_chroma") : this.get("tra.cat_paw_bundled_type_skin");
                        case l.PAW.INVENTORY_TYPES.CHAMPION:
                            return this.get("tra.cat_paw_bundled_type_champion");
                        case l.PAW.INVENTORY_TYPES.STATSTONE:
                            return this.get("item.description");
                        default:
                            return s.logger.warning("Bundle item type not yet supported, setting subtitle to null"), null
                    }
                })),
                itemRarity: c("item.inventoryType", "item.tags", (function() {
                    const e = this.get("item.tags");
                    if (this.get("item.inventoryType") === l.PAW.INVENTORY_TYPES.STATSTONE) {
                        return e.includes("statstone_epic") ? this.get("tra.cat_paw_bundled_eternal_rarity_epic") : this.get("tra.cat_paw_bundled_eternal_rarity_common")
                    }
                    return null
                }))
            });
            ...
            e.exports = a.HTMLBars.template({
                id: "KfEIfiJI",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-item-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-item-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-item-component\\\\index.js\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","paw-bundle-item-overlay"],["flush-element"],["text","\\n    "],["open-element","div",[]],["static-attr","class","paw-bundle-overlay-image"],["dynamic-attr","style",["concat",["background-image: ",["unknown",["itemBackgroundPath"]]]]],["flush-element"],["text","\\n        "],["open-element","img",[]],["static-attr","class","paw-bundle-overlay-image"],["dynamic-attr","src",["unknown",["imagePath"]],null],["flush-element"],["close-element"],["text","\\n    "],["close-element"],["text","\\n"],["close-element"],["text","\\n\\n"],["open-element","div",[]],["static-attr","class","paw-bundle-item-content"],["flush-element"],["text","\\n    "],["open-element","div",[]],["static-attr","class","paw-bundle-item-title"],["flush-element"],["text","\\n        "],["append",["unknown",["item","name"]],false],["text","\\n    "],["close-element"],["text","\\n    "],["open-element","div",[]],["static-attr","class","paw-bundle-item-type"],["flush-element"],["text","\\n        "],["append",["unknown",["itemRarity"]],false],["text","\\n    "],["close-element"],["text","\\n    "],["open-element","div",[]],["static-attr","class","paw-bundle-item-subtitle"],["flush-element"],["text","\\n        "],["append",["unknown",["itemSubtitle"]],false],["text","        \\n    "],["close-element"],["text","\\n"],["close-element"],["text","\\n\\n"],["open-element","div",[]],["static-attr","class","paw-bundle-item-price"],["flush-element"],["text","\\n    "],["append",["unknown",["itemPriceOrOwned"]],false],["text","\\n"],["close-element"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                ...
                classNames: ["paw-bundle-discount-component"],
                layout: n(129),
                style: n(130),
                discountPercentage: o("catalogItemPurchaseOption.sale.discount", (function() {
                    const e = this.get("catalogItemPurchaseOption.sale.discount");
                    return "-" + Math.ceil(e) + "%"
                })),
                currencyTypeLocalized: o("catalogItemPurchaseOption.purchaseOptions.0.priceDetails.0.price.currencyType", (function() {
                    const e = this.get("catalogItemPurchaseOption.purchaseOptions.0.priceDetails.0.price.currencyType");
                    let t = this.get("tra.cat_paw_modal_currency_rp");
                    return e === s.PAW.CURRENCY_TYPES.IP && (t = this.get("tra.cat_paw_modal_currency_ip")), t
                })),
                adjustedTotalTitleLocalized: o.readOnly("tra.cat_paw_bundled_discount_adjusted_title"),
                adjustedTotalAmmount: o.readOnly("catalogItemPurchaseOption.purchaseOptions.0.priceDetails.0.price.price"),
                unadjustedTotalTitleLocalized: o.readOnly("tra.cat_paw_bundled_discount_unadjusted_title"),
                unadjustedTotalAmmount: o("catalogItemPurchaseOption.purchaseOptions.0.priceDetails.0.price.price", "catalogItemPurchaseOption.sale.discount", (function() {
                    const e = this.get("catalogItemPurchaseOption.purchaseOptions.0.priceDetails.0.price.price") / (1 - this.get("catalogItemPurchaseOption.sale.discount") / 100);
            ...
            e.exports = a.HTMLBars.template({
                id: "jzrmkqXZ",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-discount-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-discount-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-discount-component\\\\index.js\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","paw-bundle-discount-percentage"],["flush-element"],["text","\\n    "],["append",["unknown",["discountPercentage"]],false],["text","\\n"],["close-element"],["text","\\n\\n"],["open-element","div",[]],["static-attr","class","paw-bundle-discount-total"],["flush-element"],["text","\\n    "],["open-element","div",[]],["static-attr","class","paw-bundle-discount-unadjusted-total"],["flush-element"],["text","\\n        "],["open-element","div",[]],["static-attr","class","paw-bundle-discount-unadjusted-total-title"],["flush-element"],["text","\\n            "],["append",["unknown",["unadjustedTotalTitleLocalized"]],false],["text","\\n        "],["close-element"],["text","\\n\\n        "],["open-element","div",[]],["static-attr","class","paw-bundle-discount-unadjusted-total-ammount"],["flush-element"],["text","\\n            "],["append",["unknown",["unadjustedTotalAmmount"]],false],["text"," "],["append",["unknown",["currencyTypeLocalized"]],false],["text","\\n        "],["close-element"],["text","\\n    "],["close-element"],["text","\\n\\n    "],["open-element","div",[]],["static-attr","class","paw-bundle-discount-adjusted-total"],["flush-element"],["text","\\n        "],["open-element","div",[]],["static-attr","class","paw-bundle-discount-adjusted-total-title"],["flush-element"],["text","\\n            "],["append",["unknown",["adjustedTotalTitleLocalized"]],false],["text"," \\n        "],["close-element"],["text","\\n\\n        "],["open-element","div",[]],["static-attr","class","paw-bundle-discount-adjusted-total-ammount"],["flush-element"],["text","\\n            "],["append",["unknown",["adjustedTotalAmmount"]],false],["text"," "],["append",["unknown",["currencyTypeLocalized"]],false],["text","\\n        "],["close-element"],["text","\\n    "],["close-element"],["text","\\n"],["close-element"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                ...
                subInventoryType: l.default.STATSTONES_BUNDLE
            }], p = c.extend({
                classNames: ["paw-bundle-bottom-component"],
                classNameBindings: ["hasMultiplePrices:has-multiple-prices", "displayDisclaimers:has-disclaimers", "purchaseEnabled:purchase-enabled", "purchaseRestricted:purchase-restricted"],
                layout: n(132),
                style: n(133),
                displayDisclaimers: a.Ember.computed.or("displayBundleNonRefundableDisclaimer", "alwaysShowPurchaseDisclaimer"),
                disclaimersAccepted: !1,
                displayBundleNonRefundableDisclaimer: a.Ember.computed("catalogItemPurchaseOption.item.inventoryType", "catalogItemPurchaseOption.item.subInventoryType", "alwaysShowPurchaseDisclaimer", (function() {
                    if (this.get("alwaysShowPurchaseDisclaimer")) return !1;
                    const e = this.get("catalogItemPurchaseOption.item.inventoryType") || "",
                        t = this.get("catalogItemPurchaseOption.item.subInventoryType") || "";
                    return -1 === r.findIndex((n => n.inventoryType === e && n.subInventoryType === t))
                })),
                purchaseRestricted: a.Ember.computed("validationErrors", (function() {
                    return !!this.get("validationErrors").find((e => e.id === o.default.ValidationErrorKeys.PARENT_NOT_OWNED))
                })),
                purchaseEnabled: a.Ember.computed("displayDisclaimers", "disclaimersAccepted", (function() {
                    return !this.get("displayDisclaimers") || this.get("disclaimersAccepted")
                })),
                hasMultiplePrices: a.Ember.computed("catalogItemPurchaseOption.purchaseOptions", (function() {
                    return this.get("catalogItemPurchaseOption.purchaseOptions").length > 1
                })),
                actions: {
                    purchase: function(e) {
                        this.sendAction("purchase", e)
            ...
            e.exports = a.HTMLBars.template({
                id: "TazewgwE",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-bottom-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-bottom-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-bottom-component\\\\index.js\\" "],["text","\\n"],["block",["if"],[["get",["purchaseSuccess"]]],null,8,7]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","            "],["open-element","div",[]],["static-attr","class","paw-bundle-bottom-disclaimers-wrapper"],["flush-element"],["text","\\n                "],["append",["helper",["bundle-bottom-disclaimers"],null,[["catalogItemPurchaseOption","disclaimersAccepted","displayBundleNonRefundableDisclaimer","alwaysShowPurchaseDisclaimer"],[["get",["catalogItemPurchaseOption"]],["get",["disclaimersAccepted"]],["get",["displayBundleNonRefundableDisclaimer"]],["get",["alwaysShowPurchaseDisclaimer"]]]]],false],["text","\\n            "],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","    "],["append",["helper",["purchase-warnings"],null,[["itemPurchaseOption"],[["get",["catalogItemPurchaseOption","item"]]]]],false],["text","\\n    "],["open-element","div",[]],["static-attr","class","paw-bundle-bottom-inner"],["flush-element"],["text","\\n"],["block",["if"],[["get",["displayDisclaimers"]]],null,0],["text","\\n        "],["open-element","div",[]],["static-attr","class","paw-bundle-bottom-purchase-wrapper"],["flush-element"],["text","\\n            "],["open-element","div",[]],["static-attr","class","paw-bundle-bottom-purchase"],["flush-element"],["text","\\n                "],["append",["helper",["price-details"],null,[["purchaseOptions","wallet","purchaseEnabled","purchase"],[["get",["catalogItemPurchaseOption","purchaseOptions"]],["get",["wallet"]],["get",["purchaseEnabled"]],"purchase"]]],false],["text","\\n            "],["close-element"],["text","\\n        "],["close-element"],["text","\\n    "],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","    "],["open-element","div",[]],["static-attr","class","paw-bundle-bottom-generic-error"],["flush-element"],["text","\\n        "],["open-element","p",[]],["flush-element"],["append",["unknown",["errorMessage"]],false],["close-element"],["text","\\n    "],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["block",["if"],[["get",["errorMessage"]]],null,2,1]],"locals":[]},{"statements":[["text","    "],["open-element","div",[]],["static-attr","class","paw-bundle-bottom-purchase-error"],["flush-element"],["text","\\n        "],["open-element","p",[]],["flush-element"],["append",["unknown",["errorMessage"]],false],["close-element"],["text","\\n    "],["close-element"],["text","\\n    "],["open-element","div",[]],["static-attr","class","paw-bundle-bottom-purchase"],["flush-element"],["text","\\n        "],["append",["helper",["price-details"],null,[["purchaseOptions","wallet","purchaseEnabled","purchase"],[["get",["catalogItemPurchaseOption","purchaseOptions"]],["get",["wallet"]],false,"purchase"]]],false],["text","\\n    "],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["block",["if"],[["get",["purchaseRestricted"]]],null,4,3]],"locals":[]},{"statements":[["text","  "],["open-element","div",[]],["static-attr","class","spinner-wrapper"],["flush-element"],["text","\\n    "],["append",["helper",["uikit-spinner"],null,[["src"],["/fe/lol-paw/images/spinner.png"]]],false],["text","\\n  "],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["block",["if"],[["get",["isPurchasing"]]],null,6,5]],"locals":[]},{"statements":[["text","      "],["append",["helper",["item-unlocked"],null,[["itemPurchaseOption"],[["get",["itemPurchaseOption"]]]]],false],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                ...
                classNames: ["paw-bundle-bottom-disclaimers-component"],
                layout: n(135),
                style: n(136),
                tokenizedConfirmationText: l("tra.cat_paw_purchase_disclaimer", (function() {
                    const e = this.get("tra.cat_paw_purchase_disclaimer");
                    return /(.*){{confirmationLink}}(.*)/.exec(e)
                })),
                confirmationTextPrefix: l("tokenizedConfirmationText", "tra.cat_paw_purchase_disclaimer", (function() {
                    const e = this.get("tokenizedConfirmationText");
                    return e && 3 === e.length ? a.Ember.Handlebars.Utils.escapeExpression(e[1]) : this.get("tra.cat_paw_purchase_disclaimer")
                })),
                confirmationTextPostfix: l("tokenizedConfirmationText", "tra.cat_paw_purchase_disclaimer", (function() {
                    const e = this.get("tokenizedConfirmationText");
                    return e && 3 === e.length ? a.Ember.Handlebars.Utils.escapeExpression(e[2]) : ""
                })),
                confirmationLinkText: l("tokenizedConfirmationText", "tra.cat_paw_purchase_disclaimer", (function() {
                    const e = this.get("tokenizedConfirmationText");
                    if (e && 3 === e.length) {
                        return this.get("tra.cat_paw_purchase_disclaimer_link_text")
                    }
                ...
                actions: {
                    acceptDisclaimer: function() {
                        this.set("disclaimersAccepted", !0)
                    }
                }
            });
            e.exports = o
            ...
            e.exports = a.HTMLBars.template({
                id: "MJ/KbHnV",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-bottom-disclaimers-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-bottom-disclaimers-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-bottom-disclaimers-component\\\\index.js\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","paw-bottom-disclaimers-text-wrapper"],["flush-element"],["text","\\n    "],["open-element","div",[]],["static-attr","class","paw-bottom-disclaimers-text"],["flush-element"],["text","\\n"],["block",["if"],[["get",["displayBundleNonRefundableDisclaimer"]]],null,3],["block",["if"],[["get",["alwaysShowPurchaseDisclaimer"]]],null,2],["text","    "],["close-element"],["text","\\n"],["close-element"],["text","\\n\\n"],["open-element","div",[]],["static-attr","class","paw-bottom-disclaimers-accept"],["flush-element"],["text","\\n"],["block",["if"],[["get",["disclaimersAccepted"]]],null,1,0],["close-element"]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","        "],["open-element","lol-uikit-flat-button",[]],["dynamic-attr","onclick",["helper",["action"],[["get",[null]],"acceptDisclaimer"],null],null],["flush-element"],["append",["unknown",["tra","cat_paw_bundled_disclaimers_ok"]],false],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","        "],["open-element","div",[]],["static-attr","class","paw-bottom-disclaimers-accepted-checkmark"],["flush-element"],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","            "],["append",["unknown",["confirmationTextPrefix"]],false],["text","\\n            "],["open-element","a",[]],["static-attr","target","_blank"],["dynamic-attr","class",["concat",["paw-purchase-confirmation-link ",["helper",["unless"],[["get",["confirmationLinkText"]],"hidden"],null]]]],["dynamic-attr","href",["concat",[["unknown",["tra","cat_paw_purchase_disclaimer_link"]]]]],["flush-element"],["text","\\n            "],["append",["unknown",["confirmationLinkText"]],false],["text","\\n            "],["close-element"],["text","\\n            "],["append",["unknown",["confirmationTextPostfix"]],false],["text","\\n"]],"locals":[]},{"statements":[["text","            "],["append",["unknown",["tra","cat_paw_bundled_disclaimer_bundle_non_refundable"]],false],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                ...
                skin: i("bundledItems", (function() {
                    const e = this.get("bundledItems");
                    return e ? e.find((e => e.inventoryType === o.PAW.INVENTORY_TYPES.CHAMPION_SKIN && !e.subInventoryType)) : null
                })),
                itemSubtitle: i("champion.owned", "skin.owned", (function() {
                    const e = this.get("champion.owned") ? this.get("skin.owned") ? "cat_paw_modal_chroma_bundles_subtitle" : "cat_paw_modal_chroma_bundles_with_skin_subtitle" : "cat_paw_modal_chroma_bundles_with_champion_subtitle";
            ...
            const {
                ...
                unownedChromas: c("bundledItems", (function() {
                    return this.get("bundledItems") ? this.get("bundledItems").filter((e => !e.owned && e.inventoryType === l.PAW.INVENTORY_TYPES.CHAMPION_SKIN && e.subInventoryType === o.default.CHROMA)) : []
                })),
                didInsertElement() {
                ...
                _setDefaultShowingChroma() {
                    ...
                    this.set("showingChroma", e && e.owned ? t.length > 0 ? t[0] : null : e)
                }
            });
            e.exports = r
        }, (e, t, n) => {
            ...
            e.exports = a.HTMLBars.template({
                id: "BzdZMQU9",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\chroma-bundle\\\\chroma-button-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\chroma-bundle\\\\chroma-button-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\chroma-bundle\\\\chroma-button-component\\\\index.js\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","contents"],["dynamic-attr","style",["concat",["background:",["unknown",["color"]]]]],["flush-element"],["close-element"],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                computed: c
            } = a.Ember, r = a.Ember.A, p = s.default.extend({
                ...
                containedItems: c("tra.metadata", "bundledItems", (function() {
                    ...
                    return t && (this._checkChampion(t, e), this._checkSkinAndChromas(t, e)), e
                })),
                _checkChampion(e, t) {
                    const n = e.find((e => e.inventoryType === l.PAW.INVENTORY_TYPES.CHAMPION));
                    n && !n.owned && t.pushObject({
                        tilePath: n.assets.tilePath,
                        description: this.get("tra").formatString("cat_paw_dependency_includes", {
                            inventoryType: this.get(`tra.cat_paw_inventory_type_${l.PAW.INVENTORY_TYPES.CHAMPION.toLowerCase()}`)
                        })
                    })
                },
                _checkSkinAndChromas(e, t) {
                    const n = e.find((e => e.inventoryType === l.PAW.INVENTORY_TYPES.CHAMPION_SKIN && !e.subInventoryType)),
                        a = e.filter((e => e.inventoryType === l.PAW.INVENTORY_TYPES.CHAMPION_SKIN && e.subInventoryType === o.default.CHROMA && !e.owned)),
                        s = {};
                    ...
                    const i = n && !n.owned ? "cat_paw_bundle_content_skin_and_chromas" : "cat_paw_bundle_content_chromas";
            ...
            const c = (0, s.emberDataBinding)({
                ...
                r = s.Ember.Service.extend(c, {
                    init() {
                        this._super(...arguments), this._dataBinding = (0, s.dataBinding)("lol-purchase-widget")
                    },
                    getItem(e, t) {
    ...
    n.r = e => {
        ...
        s.addEventListener(l, (function(e) {
            (0, e.registrationHandler)((e => t.default.init(e, {
                ...
                dataBinding: e => e.get("rcp-fe-common-libs").getDataBinding("rcp-fe-lol-paw"),
                Ember: e => e.get("rcp-fe-ember-libs").getEmber(),
                emberApplicationFactory: e => e.get("rcp-fe-ember-libs").getEmberApplicationFactory(),
                emberDataBinding: e => e.get("rcp-fe-ember-libs").getEmberDataBinding("rcp-fe-lol-paw"),
