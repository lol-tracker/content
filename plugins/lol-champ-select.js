    ...
    var e = [, e => {
            ...
            var v = new class {
                constructor() {
                    ...
                    this.champSelectVideoCache = p.UiKitPlugin.getVideoCache().createCache("rcp-fe-lol-champ-select");
                    const t = p.l10n.tra().overlay("/fe/lol-champ-select/trans.json");
                    Promise.all([t.getAsync("dodge_header"), t.getAsync("dodge_body"), t.getAsync("clash_dodge_body")]).then(function(e) {
                        this._dodgeMessage = {
                            header: e[0],
                            body: e[1]
                    ...
                    }.bind(this)), this._isShown = !1, this.uxSettingsObserver = function(e) {
                        e && (this.largeAreaAnimationsEnabled = e.largeAreaAnimationsEnabled)
                    }.bind(this), this.showPromise = Promise.resolve(), this.appControls = e.get("rcp-fe-lol-navigation"), this.screenRoot = d.fullScreen().getScreenRoot("rcp-fe-lol-champ-select"), this.champSelectHandlers = [{
                        show: this.champSelectShowHandler.bind(this),
                        hide: this.champSelectHideHandler.bind(this),
                        shouldShow: () => !0
                    }], g.addObserver(this.uxSettingsObserver), this.gameflowBinding = h("/lol-gameflow", e.getSocket()), this.gameflowBinding.observe("/v1/session", this, function(e) {
                        this._changePhase(e && e.phase);
                        const t = e && e.gameData;
                        this._isCustomGame = t && e.gameData.isCustomGame, this._isClashGame = t && e.gameData.queue && "CLASH" === e.gameData.queue.type
                    }.bind(this)), this.champSelectBinding = h("/lol-champ-select", e.getSocket()), this.champSelectBinding.observe("/v1/session", this, function(e) {
                        this._champSelectSession = e
                    }.bind(this));
                    const n = d.getApiKey("rcp-fe-lol-champ-select-skip - bump/release champ-select-skip"),
                        i = d.fullScreen().getScreenRoot(n, "rcp-fe-lol-champ-select-skip");
                ...
                _changePhase(e) {
                    this.previousPhase = this.phase, this.phase = e, e && "None" !== e && (this._perksPreloaded || (this._perksPreloaded = !0, (0, a.usePerksApi)((e => e.preload())))), "Lobby" === e && this.preload(), "ChampSelect" === e && "ChampSelect" !== this.previousPhase ? this.show() : "ChampSelect" !== e && "ChampSelect" === this.previousPhase && this.hide(), this._handleVideoCache(e, this.previousPhase), !this.previousPhase || e && "None" !== e || this.champSelectVideoCache.release()
                }
                champSelectShowHandler() {
                    return this.showPromise = this.showPromise.then(function() {
                        return b.startTracingEvent("champ-select-init"), this.preload(), this.applicationDataPromise
                    }.bind(this)).then((function(e) {
                        return e.emberAppInstancePromise
                    })).then((function(e) {
                        return S.afterRender(e.app)
                    })).then(function() {
                        this._isClashGame ? this.appControls.addMessage(this._clashDodgeMessage) : this._isCustomGame || this.appControls.addMessage(this._dodgeMessage), this.screenRoot.bump(), this._isShown = !0, b.endTracingEvent("champ-select-init"), Promise.all([this.gameflowBinding.get("/v1/session"), this.champSelectBinding.get("/v1/session"), h("/lol-summoner/v1/current-summoner").get(), h("/lol-inventory/v2/inventory/WARD_SKIN").get(), h("/lol-inventory/v2/inventory/CHAMPION").get()]).then((([e, t, n, s, o]) => {
                            ...
                            const {
                                ...
                                id: p,
                                category: d
                            } = e.gameData.queue, h = u && r !== l.TIMER_PHASES.planning, g = c - (Date.now() - m), f = c - g >= .2 * c, {
                                accountId: S,
                                puuid: y,
                                summonerId: v
                            } = n, _ = Array.isArray(s) ? s.length : 0, x = Array.isArray(o) ? o.filter((e => e.owned)).length : 0, k = JSON.stringify({
                                internalNowInEpochMs: m,
                            ...
                            "GAME_STARTING" === r ? (b.recordTracingStepEvent("UI_entered-champ-select-in-phase-game-starting"), b.invokeWithLowProbability((function() {
                                i.captureEvent({
                                    message: "entered-champ-select-in-phase-game-starting"
                                }), b.sendEvent("entered-champ-select-in-phase-game-starting", k), b.recordNonTimingTracingEvent("entered-champ-select-in-phase-game-starting", 1, "event")
                            }))) : "" === r ? (b.recordTracingStepEvent("UI_entered-champ-select-in-phase-empty-string"), b.invokeWithLowProbability((function() {
                                i.captureEvent({
                                    message: "entered-champ-select-in-phase-empty-string"
                                }), b.sendEvent("entered-champ-select-in-phase-empty-string", k), b.recordNonTimingTracingEvent("entered-champ-select-in-phase-empty-string", 1, "event")
                            }))) : h ? (b.recordTracingStepEvent("UI_entered-ranked-champ-select-after-initial-phase"), b.invokeWithLowProbability((function() {
                                i.captureEvent({
                                    message: "entered-ranked-champ-select-after-initial-phase"
                                }), b.sendEvent("entered-ranked-champ-select-after-initial-phase", k), b.recordNonTimingTracingEvent("entered-ranked-champ-select-after-initial-phase", 1, "event")
                            }))) : f && (b.recordTracingStepEvent("UI_entered-champ-select-late"), b.invokeWithLowProbability((function() {
                                i.captureEvent({
                                    message: "entered-champ-select-late"
                                }), b.sendEvent("entered-champ-select-late", k), b.recordNonTimingTracingEvent("entered-champ-select-late", 1, "event")
                            })))
                        }))
                    }.bind(this)), !0
                }
                champSelectHideHandler() {
                    return this.showPromise = this.showPromise.then((() => {
                        if (this._isShown) return this._isClashGame ? this.appControls.removeMessage(this._clashDodgeMessage) : this._isCustomGame || this.appControls.removeMessage(this._dodgeMessage), this.screenRoot.release({
                            animate: !1
                        }).then((() => {
                            this._isShown = !1
                        }))
                ...
                preload() {
                    ...
                    this.applicationDataPromise = Promise.resolve().then((function() {
                        return t
                    })), h("/lol-summoner/v1/current-summoner").get(), h("/lol-inventory/v2/inventory/WARD_SKIN").get(), h("/lol-inventory/v2/inventory/CHAMPION").get();
                    const n = t.renderPromise;
                    p.getProvider().get("rcp-fe-lol-lock-and-load").lockAndLoad({
                        promise: n,
                ...
                unload() {
                    this.applicationDataPromise && (this.applicationDataPromise.then(function(e) {
                        this.screenRoot.getElement().removeChild(e.domNode), Promise.all([e.emberAppInstancePromise, e.renderPromise]).then(function(e) {
                            e[0].app.destroy(), this.applicationDataPromise = void 0, s.default.dispose()
                        }.bind(this))
                    }.bind(this)), g.removeObserver(this.uxSettingsObserver))
                }
            ...
            var i = n(8),
                ...
                l = function() {
                    ...
                    return e.clone = function(t) {
                        var n = new e;
                        return t && (n._breadcrumbs = (0, i.__spread)(t._breadcrumbs), n._tags = (0, i.__assign)({}, t._tags), n._extra = (0, i.__assign)({}, t._extra), n._contexts = (0, i.__assign)({}, t._contexts), n._user = t._user, n._level = t._level, n._span = t._span, n._session = t._session, n._transactionName = t._transactionName, n._fingerprint = t._fingerprint, n._eventProcessors = (0, i.__spread)(t._eventProcessors)), n
                        ...
                        return this._tags = (0, i.__assign)((0, i.__assign)({}, this._tags), e), this._notifyScopeListeners(), this
                    }, e.prototype.setTag = function(e, t) {
                        var n;
                        return this._tags = (0, i.__assign)((0, i.__assign)({}, this._tags), ((n = {})[e] = t, n)), this._notifyScopeListeners(), this
                    }, e.prototype.setExtras = function(e) {
                        return this._extra = (0, i.__assign)((0, i.__assign)({}, this._extra), e), this._notifyScopeListeners(), this
                    }, e.prototype.setExtra = function(e, t) {
                        var n;
                        return this._extra = (0, i.__assign)((0, i.__assign)({}, this._extra), ((n = {})[e] = t, n)), this._notifyScopeListeners(), this
                        ...
                        var n;
                        return null === t ? delete this._contexts[e] : this._contexts = (0, i.__assign)((0, i.__assign)({}, this._contexts), ((n = {})[e] = t, n)), this._notifyScopeListeners(), this
                    }, e.prototype.setSpan = function(e) {
                        return this._span = e, this._notifyScopeListeners(), this
                    }, e.prototype.getSpan = function() {
                        return this._span
                    }, e.prototype.getTransaction = function() {
                        var e, t, n, i, s = this.getSpan();
                        return (null === (e = s) || void 0 === e ? void 0 : e.transaction) ? null === (t = s) || void 0 === t ? void 0 : t.transaction : (null === (i = null === (n = s) || void 0 === n ? void 0 : n.spanRecorder) || void 0 === i ? void 0 : i.spans[0]) ? s.spanRecorder.spans[0] : void 0
                        ...
                        return t instanceof e ? (this._tags = (0, i.__assign)((0, i.__assign)({}, this._tags), t._tags), this._extra = (0, i.__assign)((0, i.__assign)({}, this._extra), t._extra), this._contexts = (0, i.__assign)((0, i.__assign)({}, this._contexts), t._contexts), t._user && Object.keys(t._user).length && (this._user = t._user), t._level && (this._level = t._level), t._fingerprint && (this._fingerprint = t._fingerprint)) : (0, s.isPlainObject)(t) && (this._tags = (0, i.__assign)((0, i.__assign)({}, this._tags), t.tags), this._extra = (0, i.__assign)((0, i.__assign)({}, this._extra), t.extra), this._contexts = (0, i.__assign)((0, i.__assign)({}, this._contexts), t.contexts), t.user && (this._user = t.user), t.level && (this._level = t.level), t.fingerprint && (this._fingerprint = t.fingerprint)), this
                        ...
                        return this._breadcrumbs = void 0 !== t && t >= 0 ? (0, i.__spread)(this._breadcrumbs, [n]).slice(-t) : (0, i.__spread)(this._breadcrumbs, [n]), this._notifyScopeListeners(), this
                    }, e.prototype.clearBreadcrumbs = function() {
                        return this._breadcrumbs = [], this._notifyScopeListeners(), this
                    }, e.prototype.applyToEvent = function(e, t) {
                        var n;
                        if (this._extra && Object.keys(this._extra).length && (e.extra = (0, i.__assign)((0, i.__assign)({}, this._extra), e.extra)), this._tags && Object.keys(this._tags).length && (e.tags = (0, i.__assign)((0, i.__assign)({}, this._tags), e.tags)), this._user && Object.keys(this._user).length && (e.user = (0, i.__assign)((0, i.__assign)({}, this._user), e.user)), this._contexts && Object.keys(this._contexts).length && (e.contexts = (0, i.__assign)((0, i.__assign)({}, this._contexts), e.contexts)), this._level && (e.level = this._level), this._transactionName && (e.transaction = this._transactionName), this._span) {
                            e.contexts = (0, i.__assign)({
                                trace: this._span.getTraceContext()
                            }, e.contexts);
                            var s = null === (n = this._span.transaction) || void 0 === n ? void 0 : n.name;
                            s && (e.tags = (0, i.__assign)({
                                transaction: s
                            }, e.tags))
                        }
                        return this._applyFingerprint(e), e.breadcrumbs = (0, i.__spread)(e.breadcrumbs || [], this._breadcrumbs), e.breadcrumbs = e.breadcrumbs.length > 0 ? e.breadcrumbs : void 0, this._notifyEventProcessors((0, i.__spread)(c(), this._eventProcessors), e, t)
                    }, e.prototype._notifyEventProcessors = function(e, t, n, o) {
                        var r = this;
                        return void 0 === o && (o = 0), new a.SyncPromise((function(a, l) {
                            var c = e[o];
                            if (null === t || "function" != typeof c) a(t);
                            else {
                                var m = c((0, i.__assign)({}, t), n);
                                (0, s.isThenable)(m) ? m.then((function(t) {
                                    return r._notifyEventProcessors(e, t, n, o + 1).then(a)
                                })).then(null, l): r._notifyEventProcessors(e, m, n, o + 1).then(a).then(null, l)
                            }
                        }))
            ...
            function r(e, t, n, i) {
                ...
                if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) a = Reflect.decorate(e, t, n, i);
                    ...
                    for (var r = e.length - 1; r >= 0; r--)(s = e[r]) && (a = (o < 3 ? s(a) : o > 3 ? s(t, n, a) : s(t, n)) || a);
            ...
            function y(e, t, n) {
                ...
                function r(e, t) {
                    try {
                        (n = s[e](t)).value instanceof b ? Promise.resolve(n.value.v).then(l, c) : m(o[0][2], n)
                    } catch (e) {
                        m(o[0][3], e)
                    }
                    var n
            ...
            function _(e) {
                ...
                return n ? n.call(e) : (e = h(e), t = {}, i("next"), i("throw"), i("return"), t[Symbol.asyncIterator] = function() {
                    return this
                }, t);
            ...
            function a() {
                return (0, i.isNodeEnv)() ? n.g : "undefined" != typeof window ? window : "undefined" != typeof self ? self : o
            }
            ...
            function b(e, t, n) {
                ...
                })), t.context_line = (0, s.snipLine)(e[Math.min(o - 1, a)], t.colno || 0), t.post_context = e.slice(Math.min(a + 1, o), a + 1 + n).map((function(e) {
                    return (0, s.snipLine)(e, 0)
                }))
            }
            ...
            function l(t, n) {
                if (void 0 === n && (n = r), !o()) throw new Error("Can't get node request data outside of a node environment");
                var l = {},
                    c = t.headers || t.header || {},
                    m = t.method,
                    u = t.hostname || t.host || c.host || "<no host>",
                    p = "https" === t.protocol || t.secure || (t.socket || {}).encrypted ? "https" : "http",
                ...
                return n.forEach((function(n) {
                    switch (n) {
                        ...
                        case "data":
                            ...
                            void 0 !== t.body && (l.data = (0, i.isString)(t.body) ? t.body : JSON.stringify((0, s.normalize)(t.body)));
                            break;
                        default:
            ...
            function u(e) {
                ...
                if ((0, o.isEvent)(e)) {
                    ...
                    r.type = a.type;
                    try {
                        r.target = (0, o.isElement)(a.target) ? (0, s.htmlTreeAsString)(a.target) : Object.prototype.toString.call(a.target)
                    } catch (e) {
                        r.target = "<unknown>"
                    }
                    try {
                        r.currentTarget = (0, o.isElement)(a.currentTarget) ? (0, s.htmlTreeAsString)(a.currentTarget) : Object.prototype.toString.call(a.currentTarget)
                    } catch (e) {
                        r.currentTarget = "<unknown>"
                    }
                    for (var i in "undefined" != typeof CustomEvent && (0, o.isInstanceOf)(e, CustomEvent) && (r.detail = a.detail), a) Object.prototype.hasOwnProperty.call(a, i) && (r[i] = a);
                    return r
                }
                return e
            }
            ...
            function h(e, t) {
                return "domain" === t && e && "object" == typeof e && e._events ? "[Domain]" : "domainEmitter" === t ? "[DomainEmitter]" : void 0 !== n.g && e === n.g ? "[Global]" : "undefined" != typeof window && e === window ? "[Window]" : "undefined" != typeof document && e === document ? "[Document]" : (0, o.isSyntheticEvent)(e) ? "[SyntheticEvent]" : "number" == typeof e && e != e ? "[NaN]" : void 0 === e ? "[undefined]" : "function" == typeof e ? "[Function: " + (0, r.getFunctionName)(e) + "]" : "symbol" == typeof e ? "[" + String(e) + "]" : "bigint" == typeof e ? "[BigInt: " + String(e) + "]" : e
            }

            function g(e, t, n, i) {
                if (void 0 === n && (n = 1 / 0), void 0 === i && (i = new a.Memo), 0 === n) return function(e) {
                ...
                for (var c in r) Object.prototype.hasOwnProperty.call(r, c) && (l[c] = g(c, r[c], n - 1, i));
            ...
            function S(e, t) {
                ...
                for (var i = n.length; i > 0; i--) {
                    ...
                    if (!(s.length > t)) return i === n.length ? s : (0, l.truncate)(s, t)
                }
                return ""
            }
            ...
            function b(e) {
                ...
                if ((0, o.isPlainObject)(e)) {
                    var s = e,
                        a = {};
                    try {
                        for (var r = (0, i.__values)(Object.keys(s)), l = r.next(); !l.done; l = r.next()) {
                            var c = l.value;
                            void 0 !== s[c] && (a[c] = b(s[c]))
                        }
                    } catch (e) {
                        t = {
                            error: e
            ...
            function s(e) {
                try {
                    for (var t = e, n = [], i = 0, s = 0, a = void 0; t && i++ < 5 && !("html" === (a = o(t)) || i > 1 && s + 3 * n.length + a.length >= 80);) n.push(a), s += a.length, t = t.parentNode;
            ...
            function o(e) {
                ...
                if (l.push(r.tagName.toLowerCase()), r.id && l.push("#" + r.id), (t = r.className) && (0, i.isString)(t))
                    for (n = t.split(/\s+/), a = 0; a < n.length; a++) l.push("." + n[a]);
                var c = ["type", "name", "title", "alt"];
                for (a = 0; a < c.length; a++) s = c[a], (o = r.getAttribute(s)) && l.push("[" + s + '="' + o + '"]');
                return l.join("")
            }
        }, (e, t, n) => {
            "use strict";
            ...
            function o(e, t) {
                ...
                return o > i - 5 && (o = i), o === i && (s = Math.max(o - 140, 0)), n = n.slice(s, o), s > 0 && (n = "'{snip} " + n), o < i && (n += " {snip}"), n
            }
            ...
            function r(e, t) {
                return !!(0, i.isString)(e) && ((0, i.isRegExp)(t) ? t.test(e) : "string" == typeof t && -1 !== e.indexOf(t))
            }
        }, (e, t, n) => {
            "use strict";
            n.r(t), n.d(t, {
            ...
            var o = function() {
                function e(e) {
                    ...
                    this._state = i.PENDING, this._handlers = [], this._resolve = function(e) {
                        ...
                        t._state === i.PENDING && ((0, s.isThenable)(n) ? n.then(t._resolve, t._reject) : (t._state = e, t._value = n, t._executeHandlers()))
                        ...
                        if (t._state !== i.PENDING) {
                            ...
                            t._handlers = [], e.forEach((function(e) {
                                e.done || (t._state === i.RESOLVED && e.onfulfilled && e.onfulfilled(t._value), t._state === i.REJECTED && e.onrejected && e.onrejected(t._value), e.done = !0)
                            }))
                        }
                    };
                    try {
            ...
            function r(e, t) {
                ...
                return o("captureMessage", e, "string" == typeof t ? t : void 0, (0, i.__assign)({
                    originalException: e,
                    syntheticException: n
                }, s))
            }
            ...
            var i = n(8),
                ...
                u = function() {
                    function e(e, t, n) {
                        void 0 === t && (t = new l.Scope), void 0 === n && (n = m), this._version = n, this._stack = [{}], this.getStackTop().scope = t, this.bindClient(e)
                    }
                    return e.prototype.isOlderThan = function(e) {
                        ...
                        return this._invokeClient("captureException", e, (0, i.__assign)((0, i.__assign)({}, o), {
                            event_id: n
                        })), n
                        ...
                        return this._invokeClient("captureMessage", e, t, (0, i.__assign)((0, i.__assign)({}, a), {
                            event_id: o
                        })), o
                    }, e.prototype.captureEvent = function(e, t) {
                        var n = this._lastEventId = (0, s.uuid4)();
                        return this._invokeClient("captureEvent", e, (0, i.__assign)((0, i.__assign)({}, t), {
                            event_id: n
                        })), n
                        ...
                        if (a && r) {
                            ...
                            if (!(p <= 0)) {
                                var d = (0, o.dateTimestampInSeconds)(),
                                    ...
                                    g = m ? (0, s.consoleSandbox)((function() {
                                        return m(h, t)
                                    })) : h;
                        ...
                        var t = this.getStackTop(),
                            ...
                            a = o.release,
                            r = o.environment,
                            l = new c.Session((0, i.__assign)((0, i.__assign)({
                                release: a,
                                environment: r
                            }, n && {
                                user: n.getUser()
                        ...
                        for (var t, n = [], s = 1; s < arguments.length; s++) n[s - 1] = arguments[s];
            ...
            function h() {
                var e = p();
                return f(e) && !S(e).isOlderThan(m) || b(e, new u), (0, r.isNodeEnv)() ? function(e) {
                    try {
                        var t = g();
                        if (!t) return S(e);
                        if (!f(t) || S(t).isOlderThan(m)) {
                            var n = S(e).getStackTop();
                            b(t, new u(n.client, l.Scope.clone(n.scope)))
                        }
                        return S(t)
                    } catch (t) {
                        return S(e)
            ...
            var i = n(11),
                ...
                a = function() {
                    ...
                    return e.prototype.disable = function() {
                        ...
                        this._enabled && (0, i.consoleSandbox)((function() {
            ...
            var i = n(8),
                ...
                u = function(e) {
                    function t(t) {
                        return void 0 === t && (t = {}), e.call(this, r.BrowserBackend, t) || this
                    }
                    return (0, i.__extends)(t, e), t.prototype.showReportDialog = function(e) {
                        void 0 === e && (e = {}), (0, o.getGlobalObject)().document && (this._isEnabled() ? (0, l.injectReportDialog)((0, i.__assign)((0, i.__assign)({}, e), {
                            dsn: e.dsn || this.getDsn()
                        })) : a.logger.error("Trying to call showReportDialog with Sentry Client disabled"))
                    }, t.prototype._prepareEvent = function(t, n, s) {
                        return t.platform = t.platform || "javascript", t.sdk = (0, i.__assign)((0, i.__assign)({}, t.sdk), {
                            name: m.SDK_NAME,
            ...
            var i = n(8),
                ...
                m = function(e) {
                    ...
                    return (0, i.__extends)(t, e), t.prototype.eventFromException = function(e, t) {
                        return (0, r.eventFromException)(this._options, e, t)
                    }, t.prototype.eventFromMessage = function(e, t, n) {
                        return void 0 === t && (t = o.Severity.Info), (0, r.eventFromMessage)(this._options, e, t, n)
                    }, t.prototype._setupTransport = function() {
                        if (!this._options.dsn) return e.prototype._setupTransport.call(this);
                        var t = (0, i.__assign)((0, i.__assign)({}, this._options.transportOptions), {
                            dsn: this._options.dsn
                        });
                        return this._options.transport ? new this._options.transport(t) : (0, a.supportsFetch)() ? new l.FetchTransport(t) : new c.XHRTransport(t)
                    }, t
                }(s.BaseBackend)
        }, (e, t, n) => {
            "use strict";
            ...
            function m(e, t, n) {
                ...
                return (0, o.addExceptionMechanism)(i, {
                    handled: !0,
                    type: "generic"
                }), i.level = s.Severity.Error, n && n.event_id && (i.event_id = n.event_id), a.SyncPromise.resolve(i)
            }
            ...
            function u(e, t, n, i) {
                ...
                return o.level = n, i && i.event_id && (o.event_id = i.event_id), a.SyncPromise.resolve(o)
            }

            function p(e, t, n) {
                var s;
                if (void 0 === n && (n = {}), (0, r.isErrorEvent)(e) && e.error) return e = e.error, s = (0, l.eventFromStacktrace)((0, c.computeStackTrace)(e));
                if ((0, r.isDOMError)(e) || (0, r.isDOMException)(e)) {
                    var a = e,
                        m = a.name || ((0, r.isDOMError)(a) ? "DOMError" : "DOMException"),
                        u = a.message ? m + ": " + a.message : m;
                    return s = d(u, t, n), (0, o.addExceptionTypeValue)(s, u), "code" in a && (s.tags = (0, i.__assign)((0, i.__assign)({}, s.tags), {
                        "DOMException.code": "" + a.code
                    })), s
                }
                if ((0, r.isError)(e)) return s = (0, l.eventFromStacktrace)((0, c.computeStackTrace)(e));
                if ((0, r.isPlainObject)(e) || (0, r.isEvent)(e)) {
                    var p = e;
                    return s = (0, l.eventFromPlainObject)(p, t, n.rejection), (0, o.addExceptionMechanism)(s, {
                        synthetic: !0
                    }), s
                }
                return s = d(e, t, n), (0, o.addExceptionTypeValue)(s, "" + e, void 0), (0, o.addExceptionMechanism)(s, {
                    synthetic: !0
                }), s
            }
                ...
                var a = {
                    exception: {
                        values: [{
                            ...
                            value: "Non-Error " + (n ? "promise rejection" : "exception") + " captured with keys: " + (0, s.extractExceptionKeysForMessage)(e)
                        }]
                    },
                    extra: {
                        __serialized__: (0, s.normalizeToSize)(e)
                    }
                };
                if (t) {
            ...
            function m(e) {
                ...
                var t = e,
                    n = t[0].func || "",
                    i = t[t.length - 1].func || "";
                return -1 === n.indexOf("captureMessage") && -1 === n.indexOf("captureException") || (t = t.slice(1)), -1 !== i.indexOf("sentryWrapped") && (t = t.slice(0, -1)), t.slice(0, a).map((function(e) {
                    return {
            ...
            function u(e) {
                var t = null,
                    n = 0;
                e && ("number" == typeof e.framesToPop ? n = e.framesToPop : m.test(e.message) && (n = 1));
                try {
                    if (t = function(e) {
                            if (!e || !e.stacktrace) return null;
                            for (var t, n = e.stacktrace, i = / line (\d+).*script (?:in )?(\S+)(?:: in function (\S+))?$/i, o = / line (\d+), column (\d+)\s*(?:in (?:<anonymous function: ([^>]+)>|([^)]+))\((.*)\))? in (.*):\s*$/i, a = n.split("\n"), r = [], l = 0; l < a.length; l += 2) {
                                var c = null;
                                (t = i.exec(a[l])) ? c = {
                                    url: t[2],
                                    func: t[3],
                ...
                try {
                    if (t = function(e) {
                            ...
                            for (var t, n, i, m = [], u = e.stack.split("\n"), p = 0; p < u.length; ++p) {
                                if (n = o.exec(u[p])) {
                                    var h = n[2] && 0 === n[2].indexOf("native");
                                    n[2] && 0 === n[2].indexOf("eval") && (t = c.exec(n[2])) && (n[2] = t[1], n[3] = t[2], n[4] = t[3]), i = {
                                    ...
                                    n[3] && n[3].indexOf(" > eval") > -1 && (t = l.exec(n[3])) ? (n[1] = n[1] || "eval", n[3] = t[1], n[4] = t[2], n[5] = "") : 0 !== p || n[5] || void 0 === e.columnNumber || (m[0].column = e.columnNumber + 1), i = {
                                        url: n[3],
                                        func: n[1] || s,
                                        args: n[2] ? n[2].split(",") : [],
                                        line: n[4] ? +n[4] : null,
            ...
            function m() {
                ...
                if (n && "function" == typeof n.createElement) try {
                    ...
                    o.hidden = !0, n.head.appendChild(o), o.contentWindow && o.contentWindow.fetch && (t = c(o.contentWindow.fetch)), n.head.removeChild(o)
                } catch (e) {
            ...
            var i = n(8),
                ...
                m = function(e) {
                    ...
                    return (0, i.__extends)(t, e), t.prototype.sendEvent = function(e) {
                        return this._sendRequest((0, s.eventToSentryRequest)(e, this._api), e)
                    }, t.prototype.sendSession = function(e) {
                        return this._sendRequest((0, s.sessionToSentryRequest)(e, this._api), e)
                        ...
                        var i = {
                            body: e.body,
                            method: "POST",
                            referrerPolicy: (0, a.supportsReferrerPolicy)() ? "origin" : ""
                        };
                        return void 0 !== this.options.fetchParameters && Object.assign(i, this.options.fetchParameters), void 0 !== this.options.headers && (i.headers = this.options.headers), this._buffer.add(new r.SyncPromise((function(t, s) {
                            c.fetch(e.url, i).then((function(i) {
                                var o = {
            ...
            function o(e, t) {
                var n = e.tags || {},
                    ...
                    a = (0, i.__rest)(n, ["__sentry_samplingMethod", "__sentry_sampleRate"]);
                e.tags = a;
                var r = "transaction" === e.type,
                    l = {
                        body: JSON.stringify(e),
                        type: e.type || "event",
                        url: r ? t.getEnvelopeEndpointWithUrlEncodedAuth() : t.getStoreEndpointWithUrlEncodedAuth()
                    };
                if (r) {
            ...
            var i = n(8),
                ...
                m = function() {
                    function e(e) {
                        this.options = e, this._buffer = new a.PromiseBuffer(30), this._rateLimits = {}, this._api = new s.API(this.options.dsn), this.url = this._api.getStoreEndpointWithUrlEncodedAuth()
                    }
                    return e.prototype.sendEvent = function(e) {
                        throw new r.SentryError("Transport Class has to implement `sendEvent` method")
                    }, e.prototype.close = function(e) {
                        ...
                        this._handleRateLimit(i) && l.logger.warn("Too many requests, backing off until: " + this._disabledUntil(t)), r !== o.Status.Success ? a(n) : s({
                            status: r
                        })
                        ...
                        var t, n, s, o, a = Date.now(),
                            r = e["x-sentry-rate-limits"],
                            l = e["retry-after"];
                        if (r) {
                            try {
                                for (var m = (0, i.__values)(r.trim().split(",")), u = m.next(); !u.done; u = m.next()) {
                                    var p = u.value.split(":", 2),
                                        d = parseInt(p[0], 10),
                                        h = 1e3 * (isNaN(d) ? 60 : d);
                                    try {
                                        for (var g = (s = void 0, (0, i.__values)(p[1].split(";"))), f = g.next(); !f.done; f = g.next()) {
                                            var S = f.value;
                        ...
                        return !!l && (this._rateLimits.all = new Date(a + (0, c.parseRetryAfterHeader)(a, l)), !0)
                    }, e
                }()
        }, (e, t, n) => {
            "use strict";
            ...
            var i = n(34),
                ...
                o = function() {
                    ...
                    return e.prototype.isReady = function() {
                        ...
                        })), e) : s.SyncPromise.reject(new i.SentryError("Not adding Promise due to buffer limit reached."))
                        ...
                        return new s.SyncPromise((function(n) {
                            ...
                            s.SyncPromise.all(t._buffer).then((function() {
                                clearTimeout(i), n(!0)
                            })).then(null, (function() {
                                n(!0)
                            }))
            ...
            var i = n(8),
                ...
                o = function(e) {
                    function t(t) {
                        ...
                        return i.message = t, i.name = n.prototype.constructor.name, (0, s.setPrototypeOf)(i, n.prototype), i
                    }
                    ...
                    return e.prototype.getDsn = function() {
                        ...
                        for (var s in i.push("dsn=" + t.toString()), e)
                            if ("dsn" !== s)
                                ...
                                } else i.push(encodeURIComponent(s) + "=" + encodeURIComponent(e[s]));
                ...
                r = function() {
                    ...
                    return e.prototype.toString = function(e) {
                        ...
                        var t = this,
                            ...
                            o = t.port,
                            a = t.projectId;
                        return t.protocol + "://" + t.user + (e && s ? ":" + s : "") + "@" + n + (o ? ":" + o : "") + "/" + (i ? i + "/" : i) + a
                        ...
                        var n = (0, i.__read)(t.slice(1), 6),
                            ...
                            g = n[5],
                            f = g.split("/");
                        if (f.length > 1 && (h = f.slice(0, -1).join("/"), g = f.pop()), g) {
                            var S = g.match(/^\d+/);
                            S && (g = S[0])
                        }
                        ...
                        if (["protocol", "user", "host", "projectId"].forEach((function(t) {
                                if (!e[t]) throw new s.SentryError(a + ": " + t + " missing")
                            })), !this.projectId.match(/^\d+$/)) throw new s.SentryError(a + ": Invalid projectId " + this.projectId);
                        if ("http" !== this.protocol && "https" !== this.protocol) throw new s.SentryError(a + ": Invalid protocol " + this.protocol);
                        if (this.port && isNaN(parseInt(this.port, 10))) throw new s.SentryError(a + ": Invalid port " + this.port)
                    }, e
                }()
        }, (e, t, n) => {
            "use strict";
                ...
                a = function(e) {
                    ...
                    return (0, i.__extends)(t, e), t.prototype.sendEvent = function(e) {
                        ...
                        return this._isRateLimited(e.type) ? Promise.reject({
                            ...
                            reason: "Transport locked till " + this._disabledUntil(e.type) + " due to too many requests.",
                            status: 429
                        }) : this._buffer.add(new o.SyncPromise((function(t, i) {
                            ...
                            for (var o in s.onreadystatechange = function() {
                                ...
                                }, s.open("POST", e.url), n.options.headers) n.options.headers.hasOwnProperty(o) && s.setRequestHeader(o, n.options.headers[o]);
                            s.send(e.body)
                        })))
                    }, t
                }(n(32).BaseTransport)
            ...
            var i = n(21),
                ...
                a = function() {
                    function e(e) {
                        this._options = e, this._options.dsn || i.logger.warn("No DSN provided, backend will not do anything."), this._transport = this._setupTransport()
                    }
                    return e.prototype.eventFromException = function(e, t) {
                        throw new s.SentryError("Backend has to implement `eventFromException` method")
                    }, e.prototype.eventFromMessage = function(e, t, n) {
                        throw new s.SentryError("Backend has to implement `eventFromMessage` method")
                        ...
                        })) : i.logger.warn("Dropping session because custom transport doesn't implement sendSession")
            ...
            function u(e, t, n) {
                ...
                var o = function() {
                    ...
                    try {
                        ...
                        throw m(), (0, s.withScope)((function(n) {
                            n.addEventProcessor((function(e) {
                                var n = (0, i.__assign)({}, e);
                                return t.mechanism && ((0, a.addExceptionTypeValue)(n, void 0, void 0), (0, a.addExceptionMechanism)(n, t.mechanism)), n.extra = (0, i.__assign)((0, i.__assign)({}, n.extra), {
                                    arguments: o
                                }), n
            ...
            function p(e) {
                if (void 0 === e && (e = {}), e.eventId)
                    ...
                    } else r.logger.error("Missing dsn option in showReportDialog call");
                else r.logger.error("Missing eventId option in showReportDialog call")
            }
        }, (e, t, n) => {
            "use strict";
            n.r(t), n.d(t, {
            ...
            var i = n(8),
                ...
                m = function() {
                    function e(t) {
                        this.name = e.id, this._options = (0, i.__assign)({
                            console: !0,
                            dom: !0,
                            fetch: !0,
                            history: !0,
                    ...
                    return e.prototype.addSentryBreadcrumb = function(e) {
                        this._options.sentry && (0, s.getCurrentHub)().addBreadcrumb({
                        ...
                        var e = this;
                        this._options.console && (0, r.addInstrumentationHandler)({
                            callback: function() {
                                for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
                                e._consoleBreadcrumb.apply(e, (0, i.__spread)(t))
                            },
                            type: "console"
                        }), this._options.dom && (0, r.addInstrumentationHandler)({
                            callback: function() {
                                for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
                                e._domBreadcrumb.apply(e, (0, i.__spread)(t))
                            },
                            type: "dom"
                        }), this._options.xhr && (0, r.addInstrumentationHandler)({
                            callback: function() {
                                for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
                                e._xhrBreadcrumb.apply(e, (0, i.__spread)(t))
                            },
                            type: "xhr"
                        }), this._options.fetch && (0, r.addInstrumentationHandler)({
                            callback: function() {
                                for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
                                e._fetchBreadcrumb.apply(e, (0, i.__spread)(t))
                            },
                            type: "fetch"
                        }), this._options.history && (0, r.addInstrumentationHandler)({
                            callback: function() {
                                for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
                        ...
                        if ("assert" === e.level) {
                            ...
                            t.message = "Assertion failed: " + ((0, l.safeJoin)(e.args.slice(1), " ") || "console.assert"), t.data.arguments = e.args.slice(1)
                        ...
                        var t;
                        try {
                            t = e.event.target ? (0, c.htmlTreeAsString)(e.event.target) : (0, c.htmlTreeAsString)(e.event)
                        } catch (e) {
                            t = "<unknown>"
                        }
                        0 !== t.length && (0, s.getCurrentHub)().addBreadcrumb({
                            category: "ui." + e.name,
                            message: t
                        }, {
                            event: e.event,
                        ...
                        e.endTimestamp && (e.fetchData.url.match(/sentry_key/) && "POST" === e.fetchData.method || (e.error ? (0, s.getCurrentHub)().addBreadcrumb({
                            category: "fetch",
                            data: e.fetchData,
                            ...
                            category: "fetch",
                            data: (0, i.__assign)((0, i.__assign)({}, e.fetchData), {
                        ...
                        var t = (0, a.getGlobalObject)(),
                            ...
                            r = (0, a.parseUrl)(n),
                            l = (0, a.parseUrl)(i);
                        r.path || (r = o), o.protocol === l.protocol && o.host === l.host && (i = l.relative), o.protocol === r.protocol && o.host === r.host && (n = r.relative), (0, s.getCurrentHub)().addBreadcrumb({
                            category: "navigation",
                            data: {
                                from: n,
                                to: i
                ...
                if (!d[e]) switch (d[e] = !0, e) {
                    case "console":
                        ! function() {
                            ...
                            ["debug", "info", "warn", "error", "log", "assert"].forEach((function(e) {
                                e in u.console && (0, l.fill)(u.console, e, (function(t) {
                                    return function() {
                    ...
                    case "dom":
                        ! function() {
                            ...
                            u.document.addEventListener("click", k("click", f.bind(null, "dom")), !1), u.document.addEventListener("keypress", E(f.bind(null, "dom")), !1), ["EventTarget", "Node"].forEach((function(e) {
                                var t = u[e] && u[e].prototype;
                                t && t.hasOwnProperty && t.hasOwnProperty("addEventListener") && ((0, l.fill)(t, "addEventListener", (function(e) {
                                    return function(t, n, i) {
                                        return n && n.handleEvent ? ("click" === t && (0, l.fill)(n, "handleEvent", (function(e) {
                                            return function(t) {
                                                return k("click", f.bind(null, "dom"))(t), e.call(this, t)
                                            }
                                        })), "keypress" === t && (0, l.fill)(n, "handleEvent", (function(e) {
                                            return function(t) {
                                                return E(f.bind(null, "dom"))(t), e.call(this, t)
                                            }
                                        }))) : ("click" === t && k("click", f.bind(null, "dom"), !0)(this), "keypress" === t && E(f.bind(null, "dom"))(this)), e.call(this, t, n, i)
                                    }
                            ...
                            (0, l.fill)(n, "open", (function(n) {
                                return function() {
                                    ...
                                    var a = this,
                                        r = i[1];
                                    a.__sentry_xhr__ = {
                                        method: (0, o.isString)(i[0]) ? i[0].toUpperCase() : i[0],
                                        url: i[1]
                                    }, (0, o.isString)(r) && "POST" === a.__sentry_xhr__.method && r.match(/sentry_key/) && (a.__sentry_own_request__ = !0);
                                    var c = function() {
                                        if (4 === a.readyState) {
                                            try {
                                            ...
                                            try {
                                                ...
                                                if (-1 !== n) {
                                                    e.splice(n);
                                                    var s = t.splice(n)[0];
                                                    a.__sentry_xhr__ && void 0 !== s[0] && (a.__sentry_xhr__.body = s[0])
                                                }
                                            } catch (e) {}
                                            f("xhr", {
                                                args: i,
                                    ...
                                    return "onreadystatechange" in a && "function" == typeof a.onreadystatechange ? (0, l.fill)(a, "onreadystatechange", (function(e) {
                                        return function() {
                                            for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
                                            return c(), e.apply(a, t)
                                        }
                                    })) : a.addEventListener("readystatechange", c), n.apply(a, i)
                                }
                            })), (0, l.fill)(n, "send", (function(n) {
                                return function() {
                                    for (var i = [], s = 0; s < arguments.length; s++) i[s] = arguments[s];
                                    return e.push(this), t.push(i), f("xhr", {
                                        args: i,
                                        startTimestamp: Date.now(),
                                        xhr: this
                                    }), n.apply(this, i)
                        ...
                        ! function() {
                            ...
                            (0, l.fill)(u, "fetch", (function(e) {
                                return function() {
                                    ...
                                    return f("fetch", (0, s.__assign)({}, i)), e.apply(u, t).then((function(e) {
                                        return f("fetch", (0, s.__assign)((0, s.__assign)({}, i), {
                                            endTimestamp: Date.now(),
                                            response: e
                                        })), e
                                    }), (function(e) {
                                        throw f("fetch", (0, s.__assign)((0, s.__assign)({}, i), {
                                            endTimestamp: Date.now(),
                                            error: e
                                        })), e
                                    }))
                    ...
                    case "history":
                        ! function() {
                            ...
                            }, (0, l.fill)(u.history, "pushState", t), (0, l.fill)(u.history, "replaceState", t)
                        }();
                        break;
                    case "error":
                        T = u.onerror, u.onerror = function(e, t, n, i, s) {
                            return f("error", {
                                column: i,
                                error: s,
                                line: n,
                    ...
                    case "unhandledrejection":
                        w = u.onunhandledrejection, u.onunhandledrejection = function(e) {
                            return f("unhandledrejection", e), !w || w.apply(this, arguments)
                        };
                        break;
                    default:
            ...
            function f(e, t) {
                var n, i;
                if (e && p[e]) try {
                    for (var o = (0, s.__values)(p[e] || []), r = o.next(); !r.done; r = o.next()) {
                        var l = r.value;
                        try {
                            l(t)
                        } catch (t) {
            ...
            function S(e) {
                return void 0 === e && (e = []), "Request" in u && (0, o.isInstanceOf)(e[0], Request) && e[0].method ? String(e[0].method).toUpperCase() : e[1] && e[1].method ? String(e[1].method).toUpperCase() : "GET"
            }

            function b(e) {
                return void 0 === e && (e = []), "string" == typeof e[0] ? e[0] : "Request" in u && (0, o.isInstanceOf)(e[0], Request) ? e[0].url : String(e[0])
            }
            var y, v, _ = 1e3,
                x = 0;
            ...
            function k(e, t, n) {
                return void 0 === n && (n = !1),
                    function(i) {
                        y = void 0, i && v !== i && (v = i, x && clearTimeout(x), n ? x = setTimeout((function() {
                            t({
                                event: i,
                                name: e
                            })
            ...
            function E(e) {
                return function(t) {
                    ...
                    var i = n && n.tagName;
                    i && ("INPUT" === i || "TEXTAREA" === i || n.isContentEditable) && (y || k("input", e)(t), clearTimeout(y), y = setTimeout((function() {
                        y = void 0
                    }), _))
                }
            }
            ...
            var i = n(8),
                ...
                f = function() {
                    function e(e, t) {
                        this._integrations = {}, this._processing = 0, this._backend = new e(t), this._options = t, t.dsn && (this._dsn = new a.Dsn(t.dsn))
                    }
                    return e.prototype.captureException = function(e, t, n) {
                        ...
                        var s = this,
                            o = n && n.event_id,
                            a = (0, r.isPrimitive)(e) ? this._getBackend().eventFromMessage(String(e), t, n) : this._getBackend().eventFromException(e, n);
                        ...
                        e.release ? this._sendSession(e) : l.logger.warn("Discarded session because of missing release")
                        ...
                        this._isEnabled() && (this._integrations = (0, g.setupIntegrations)(this._options))
                    }, e.prototype.getIntegration = function(e) {
                        try {
                        ...
                        if (c) {
                            l = !0;
                            try {
                                for (var m = (0, i.__values)(c), u = m.next(); !u.done; u = m.next()) {
                        ...
                        e.update((0, i.__assign)((0, i.__assign)({}, r && {
                            status: o.SessionStatus.Crashed
                        }), {
                            user: d,
                            userAgent: a,
                        ...
                        return new c.SyncPromise((function(n) {
                            var i = 0,
                                s = setInterval((function() {
                                    0 == t._processing ? (clearInterval(s), n(!0)) : (i += 1, e && i >= e && (clearInterval(s), n(!1)))
                                }), 1)
                        }))
                        ...
                        var o = this,
                            ...
                            l = (0, i.__assign)((0, i.__assign)({}, e), {
                                event_id: e.event_id || (n && n.event_id ? n.event_id : (0, m.uuid4)()),
                                timestamp: e.timestamp || (0, u.dateTimestampInSeconds)()
                            });
                        this._applyClientOptions(l), this._applyIntegrationsMetadata(l);
                        var p = t;
                        n && n.captureContext && (p = s.Scope.clone(p).update(n.captureContext));
                        var d = c.SyncPromise.resolve(l);
                        return p && (d = p.applyToEvent(l, n)), d.then((function(e) {
                            return "number" == typeof r && r > 0 ? o._normalizeEvent(e, r) : e
                        }))
                    }, e.prototype._normalizeEvent = function(e, t) {
                        if (!e) return null;
                        var n = (0, i.__assign)((0, i.__assign)((0, i.__assign)((0, i.__assign)((0, i.__assign)({}, e), e.breadcrumbs && {
                            breadcrumbs: e.breadcrumbs.map((function(e) {
                                return (0, i.__assign)((0, i.__assign)({}, e), e.data && {
                                    data: (0, p.normalize)(e.data, t)
                                })
                            }))
                        }), e.user && {
                            user: (0, p.normalize)(e.user, t)
                        }), e.contexts && {
                            contexts: (0, p.normalize)(e.contexts, t)
                        }), e.extra && {
                            extra: (0, p.normalize)(e.extra, t)
                        });
                        ...
                        var t = this.getOptions(),
                            ...
                            o = t.maxValueLength,
                            a = void 0 === o ? 250 : o;
                        "environment" in e || (e.environment = "environment" in t ? n : "production"), void 0 === e.release && void 0 !== i && (e.release = i), void 0 === e.dist && void 0 !== s && (e.dist = s), e.message && (e.message = (0, d.truncate)(e.message, a));
                        var r = e.exception && e.exception.values && e.exception.values[0];
                        ...
                        var i = this,
                            ...
                            o = s.beforeSend,
                            a = s.sampleRate;
                        if (!this._isEnabled()) return c.SyncPromise.reject(new h.SentryError("SDK not enabled, will not send event."));
                        var l = "transaction" === e.type;
                        return !l && "number" == typeof a && Math.random() > a ? c.SyncPromise.reject(new h.SentryError("Discarding event because it's not included in the random sample (sampling rate = " + a + ")")) : this._prepareEvent(e, n, t).then((function(e) {
                            if (null === e) throw new h.SentryError("An event processor returned null, will not send event.");
                            if (t && t.data && !0 === t.data.__sentry__ || l || !o) return e;
                            var n = o(e, t);
                            if (void 0 === n) throw new h.SentryError("`beforeSend` method has to return `null` or a valid event.");
                            return (0, r.isThenable)(n) ? n.then((function(e) {
                                return e
                            }), (function(e) {
                                throw new h.SentryError("beforeSend rejected with " + e)
                            })) : n
                        })).then((function(e) {
                            if (null === e) throw new h.SentryError("`beforeSend` returned `null`, will not send event.");
                            var t = n && n.getSession && n.getSession();
                            return !l && t && i._updateSessionFromEvent(t, e), i._sendEvent(e), e
            ...
            function l(e) {
                var t = e.defaultIntegrations && (0, i.__spread)(e.defaultIntegrations) || [],
                    n = e.integrations,
                    s = [];
                if (Array.isArray(n)) {
                    ...
                    t.forEach((function(e) {
                        -1 === o.indexOf(e.name) && -1 === a.indexOf(e.name) && (s.push(e), a.push(e.name))
                    })), n.forEach((function(e) {
                        -1 === a.indexOf(e.name) && (s.push(e), a.push(e.name))
                    }))
                } else "function" == typeof n ? (s = n(t), s = Array.isArray(s) ? s : [s]) : s = (0, i.__spread)(t);
                var r = s.map((function(e) {
                        return e.name
                    })),
                    l = "Debug";
                return -1 !== r.indexOf(l) && s.push.apply(s, (0, i.__spread)(s.splice(r.indexOf(l), 1))), s
            }

            function c(e) {
                -1 === r.indexOf(e.name) && (e.setupOnce(s.addGlobalEventProcessor, o.getCurrentHub), r.push(e.name), a.logger.log("Integration installed: " + e.name))
            }
            ...
            var i = n(48),
                ...
                h = n(52),
                g = n(53),
                f = [new i.InboundFilters, new s.FunctionToString, new u.TryCatch, new p.Breadcrumbs, new d.GlobalHandlers, new h.LinkedErrors, new g.UserAgent];
            ...
            function S(e) {
                ...
                void 0 === e.autoSessionTracking && (e.autoSessionTracking = !1), (0, o.initAndBind)(c.BrowserClient, e), e.autoSessionTracking && function() {
                    var e = (0, r.getGlobalObject)(),
                        t = (0, a.getCurrentHub)(),
                    ...
                    try {
                        var l = new PerformanceObserver((function(e, t) {
                                e.getEntries().forEach((function(e) {
                                    "first-contentful-paint" === e.name && e.startTime < c && (t.disconnect(), i = !0, s())
                                }))
                            })),
            ...
            function b(e) {
                void 0 === e && (e = {}), e.eventId || (e.eventId = (0, a.getCurrentHub)().lastEventId());
            ...
            var i = n(8),
                ...
                m = function() {
                    ...
                    return e.prototype.setupOnce = function() {
                        ...
                        return void 0 === e && (e = {}), {
                            allowUrls: (0, i.__spread)(this._options.whitelistUrls || [], this._options.allowUrls || [], e.whitelistUrls || [], e.allowUrls || []),
                            denyUrls: (0, i.__spread)(this._options.blacklistUrls || [], this._options.denyUrls || [], e.blacklistUrls || [], e.denyUrls || []),
                            ignoreErrors: (0, i.__spread)(this._options.ignoreErrors || [], e.ignoreErrors || [], c),
                        ...
                        if (e.exception) try {
                            ...
                            return a.logger.error("Cannot extract message for event " + (0, r.getEventDescription)(e)), []
                        }
                        return []
                        ...
                        try {
                            ...
                            return a.logger.error("Cannot extract url for event " + (0, r.getEventDescription)(e)), null
                        }
                ...
                c = function() {
                    ...
                    return e.prototype.setupOnce = function() {
                        ...
                        return function() {
                            for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
                            var i = t[0];
                            return t[0] = (0, r.wrap)(i, {
                                mechanism: {
                                    data: {
                                        function: (0, a.getFunctionName)(e)
                                    },
                                    handled: !0,
                                    type: "instrument"
                                }
                        ...
                        n && n.hasOwnProperty && n.hasOwnProperty("addEventListener") && ((0, o.fill)(n, "addEventListener", (function(t) {
                            return function(n, i, s) {
                                try {
                                    "function" == typeof i.handleEvent && (i.handleEvent = (0, r.wrap)(i.handleEvent.bind(i), {
                                        mechanism: {
                                            data: {
                                ...
                                return t.call(this, n, (0, r.wrap)(i, {
                                    mechanism: {
                                        data: {
                            ...
                            return function(t, n, i) {
                                var s, o = n;
                                try {
                                    var a = null === (s = o) || void 0 === s ? void 0 : s.__sentry_wrapped__;
                                    a && e.call(this, t, a, i)
                                } catch (e) {}
                        ...
                        return function() {
                            ...
                            return ["onload", "onerror", "onprogress", "onreadystatechange"].forEach((function(e) {
                                e in i && "function" == typeof i[e] && (0, o.fill)(i, e, (function(t) {
                                    var n = {
                                        mechanism: {
                                            data: {
                                                function: e,
                                    ...
                                    return t.__sentry_original__ && (n.mechanism.data.handler = (0, a.getFunctionName)(t.__sentry_original__)), (0, r.wrap)(t, n)
                                }))
                            })), e.apply(this, t)
                        }
                    }, e.id = "TryCatch", e
            ...
            var i = n(8),
                ...
                p = function() {
                    function e(t) {
                        this.name = e.id, this._onErrorHandlerInstalled = !1, this._onUnhandledRejectionHandlerInstalled = !1, this._options = (0, i.__assign)({
                            onerror: !0,
                            onunhandledrejection: !0
                        }, t)
                    }
                    return e.prototype.setupOnce = function() {
                        Error.stackTraceLimit = 50, this._options.onerror && (a.logger.log("Global Handler attached: onerror"), this._installGlobalOnErrorHandler()), this._options.onunhandledrejection && (a.logger.log("Global Handler attached: onunhandledrejection"), this._installGlobalOnUnhandledRejectionHandler())
                    }, e.prototype._installGlobalOnErrorHandler = function() {
                        var t = this;
                        this._onErrorHandlerInstalled || ((0, r.addInstrumentationHandler)({
                            callback: function(n) {
                                var i = n.error,
                                    o = (0, s.getCurrentHub)(),
                                ...
                                if (a && !(0, u.shouldIgnoreOnError)() && !r) {
                                    var p = o.getClient(),
                                        d = (0, l.isPrimitive)(i) ? t._eventFromIncompleteOnError(n.msg, n.url, n.line, n.column) : t._enhanceEventWithInitialFrame((0, m.eventFromUnknownInput)(i, void 0, {
                        ...
                        var t = this;
                        this._onUnhandledRejectionHandlerInstalled || ((0, r.addInstrumentationHandler)({
                            callback: function(n) {
                                var i = n;
                                try {
                                ...
                                var d = a.getClient(),
                                    h = (0, l.isPrimitive)(i) ? t._eventFromRejectionWithPrimitive(i) : (0, m.eventFromUnknownInput)(i, void 0, {
                                        attachStacktrace: d && d.getOptions().attachStacktrace,
                                        rejection: !0
                                    });
                                h.level = o.Severity.Error, (0, c.addExceptionMechanism)(h, {
                                    handled: !1,
                        ...
                        var s, o = (0, l.isErrorEvent)(e) ? e.message : e;
                        if ((0, l.isString)(o)) {
                        ...
                        var s = isNaN(parseInt(i, 10)) ? void 0 : i,
                            ...
                            a = (0, l.isString)(t) && t.length > 0 ? t : (0, c.getLocationHref)();
            ...
            var i = n(8),
                ...
                c = function() {
                    ...
                    return e.prototype.setupOnce = function() {
                        ...
                        if (!(e.exception && e.exception.values && t && (0, a.isInstanceOf)(t.originalException, Error))) return e;
                        var n = this._walkErrorTree(t.originalException, this._key);
                        return e.exception.values = (0, i.__spread)(n, e.exception.values), e
                    }, e.prototype._walkErrorTree = function(e, t, n) {
                        if (void 0 === n && (n = []), !(0, a.isInstanceOf)(e[t], Error) || n.length + 1 >= this._limit) return n;
                    ...
                    return e.prototype.setupOnce = function() {
                        (0, s.addGlobalEventProcessor)((function(t) {
                            ...
                            if ((0, o.getCurrentHub)().getIntegration(e)) {
                                ...
                                var l = (null === (n = t.request) || void 0 === n ? void 0 : n.url) || (null === (s = a.location) || void 0 === s ? void 0 : s.href),
                                    c = (a.document || {}).referrer,
                                    m = (a.navigator || {}).userAgent,
                                    u = (0, i.__assign)((0, i.__assign)((0, i.__assign)({}, null === (r = t.request) || void 0 === r ? void 0 : r.headers), c && {
                                        Referer: c
                                    }), m && {
                                        "User-Agent": m
                                    }),
                                    p = (0, i.__assign)((0, i.__assign)({}, l && {
                                        url: l
                                    }), {
                                        headers: u
                                    });
            ...
            var c = i.Ember.Component.extend(o, {
                ...
                classNameBindings: ["isOnRedSide:top-right:bottom-left", "shouldPlayVideos:animation-enabled", "splashDefocus:defocussed:focussed", "hidePins"],
                layout: n(62),
                ...
                startPositionAssignment: function() {
                    ...
                    this.schedulePinDropSounds(e), this.get("shouldPlayVideos") && this.element.querySelector(".map-intro-video").play(), e.forEach((e => {
                        if (!e.get("isPlaceholder")) {
                            const t = e.get("slotId"),
                                n = e.get("lane"),
                                i = (t + 1) * s.DURATIONS.pinAnimation + 130,
                                o = (t + 1) * s.DURATIONS.pinAnimation;
                            this._laneVideoTimeouts.push(this.runTask((() => this.playLaneVideo(n)), o)), this._pinIntroVideoTimeouts.push(this.runTask((() => this.playPinIntroVideo(t)), i))
                        }
                    }))
                },
                ...
                playPinIntroVideo(e) {
                    ...
                    const t = this.element.querySelector(`.position-assignment-pin.slot-${e} .pin-position-icon`);
                    t && (t.style.visibility = "visible")
                },
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.skinProductTypes = t.VOTE_MAJORITY_THRESHOLD = t.TIMER_PHASES = t.SUMMONER_OBJECT_SIZE = t.STANDARD_MAX_TEAM_SIZE = t.SOUNDS_PATH = t.SFX_CHANNEL = t.SCREENS = t.RUNES = t.RANDOM_CHAMP = t.QUEST_SKIN_TAG = t.POSITION_TOP = t.POSITION_SUPPORT = t.POSITION_NONE = t.POSITION_MIDDLE = t.POSITION_JUNGLE = t.POSITION_BOTTOM = t.POSITION_ANY = t.POSITIONS = t.NONE_CHAMP_ID = t.NEXUS_BLITZ_QUEUE_IDS = t.NAME_VISIBILITY_TYPE = t.MINUTE_SECOND_TIME_DISPLAY_THRESHOLD_MS = t.INVALID_SPELL_ID = t.GAME_MODES_WITH_SUBTEAMS = t.GAME_MODES_WITH_NO_BAN_DELAY_TIMERS = t.GAME_MODES_WITH_COMPANIONS = t.GAME_MODES_WITH_CHEST_AVAILABILITY_ENABLED = t.GAMEFLOW_PHASE_CHAMP_SELECT = t.FINALIZATION_PHASE_CEREMONIES = t.DURATIONS = t.DRAFT_PICK_MODES = t.DISCONNECT_ERROR_INDICATORS = t.DEFAULT_DISCONNECT_SHOULD_EXIT_DELAY_MS = t.DEFAULT_DISCONNECT_DELAY_MS = t.CHAMP_SELECT_PAW_SOURCE = t.CHAMPION_BENCH_SWAP_COOLDOWN_MS = t.CHAMPION_BENCH_SOUND_COOLDOWN_MS = t.CHAMPION_BENCH_SIZE = t.CHAMPION_BENCH_NON_PRIORITISED_PREFILL_COOLDOWN_MS = t.CHAMPION_BENCH_ALLY_SWAP_COOLDOWN_MS = t.CEREMONIES = void 0;
            t.SCREENS = {
                pick: "pick-screen",
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.createRootComponent = l, t.default = function(e) {
                const t = s.default.getProvider().get("rcp-fe-lol-l10n").tra().overlay("/fe/lol-l10n/trans.json").overlay("/fe/lol-champ-select/trans.json"),
            ...
            function l(e, t) {
                ...
                return s.default.EmberApplicationFactory.create(a.EMBER_APP_NAME, null, n, e, {
                    EMBER_CLI_COMPAT: !0
                })
            }
        }, (e, t, n) => {
            ...
            var r = new class {
                ...
                _requestErrorHandler(e, t, n) {
                    if (e = e || "error_generic", !this._errorsShown[e]) {
                        ...
                        if (n && n.get) {
                            let i = n.get(e);
                            0 === t.statusCode().readyState ? i += " " + n.get("error_network_try_again") : i += " " + n.get("error_unknown_try_again");
                            a.add({
                                type: "DialogAlert",
                                data: {
                                    contents: i,
                ...
                _run(e, t) {
                    let n;
                    "object" == typeof t[0] ? (o.trace("_run request", t[0]), n = t[0].errorMessage, delete t[0].errorMessage) : "object" == typeof t[1] && (o.trace("_run request", t[1]), n = t[1].errorMessage, delete t[1].errorMessage);
                    ...
                    return Promise.resolve(s.$.when(e(...t)).then((function(e, t, n) {
                        ...
                        2 !== Math.floor(e.status / 100) ? i(e, this) : o.trace("_run response fail", {
                            url: this.url,
                            status: e.status
                        })
                    })))
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                return function(e, t = null) {
                    ...
                    return h = i.SharedEmberComponents.EmberCollectionApi.registerToFactoryDefinition(h), h
                }(e, t)
            };
            var i = n(1),
                s = l(n(68)),
            ...
            const {
                ...
                PerkPageTooltipComponent: u,
                PlayerNameComponent: p
            } = i.SharedComponents.getSharedEmberComponents(), d = "rcp-fe-lol-champ-select";
            t.EMBER_APP_NAME = d
        }, (e, t, n) => {
            "use strict";
            Object.defineProperty(t, "__esModule", {
            ...
            const {
                RunMixin: m,
                DomMixin: u
            } = i.EmberAddons.EmberLifeline, p = i.UiKitPlugin.getModalManager(), d = i.PremadeVoice.voiceButton({
                position: "left"
            }), h = i.ViewportPlugin.fullScreen().getScreenRoot("rcp-fe-lol-champ-select");
            n(87), n(88);
            const g = n(89),
                f = i.Lodash,
                S = [0, 1, 2, 3, 4],
                b = S.concat([5, 6, 7, 8, 9]),
                y = ["name_visibility_type_team_hidden_gromp", "name_visibility_type_team_hidden_krug", "name_visibility_type_team_hidden_murk_wolf", "name_visibility_type_team_hidden_raptor", "name_visibility_type_team_hidden_scuttle_crab"];
            var v = i.Ember.Component.extend(m, u, s.default, a.default, {
                classNames: ["champion-select"],
                classNameBindings: ["showEntryAnimation:entry-animation", "showPreAnimation:pre-animation", "champSelectScreen", "sessionActions.hasBans:has-bans", "currentSummoner.isActingNow:is-acting-now", "currentSummoner.isPickingNow:is-picking-now", "currentSummoner.isExclusivelyPickIntenting:is-pick-intenting-now", "showCurrentSummonerBanning:is-banning-now", "sessionActions.currentBanAction:is-current-action", "isShowingGrid:is-showing-grid", "isSpectating", "session.timer.timerLessThan11Seconds:timer-less-than-11-seconds", "uxSettings.largeAreaAnimationsEnabled:large-area-animations:no-large-area-animations"],
                layout: n(90),
                isShown: !1,
                isAnimatingIntro: !1,
                ...
                init: function() {
                    ...
                    this.set("sessionActions", n(91).create({
                        root: this
                    })), i.Telemetry.startTracingEvent("champ-select-init-ember-app-settle"), this.get("chatPublisherService").registerSessionChangeCallback("game-starting", this.gameStartDelayedSysMessage.bind(this)), this.get("champSelectSfxService").initDataBindings(), this.initChatBindings(), this.initChampSelectBindings()
                },
                didReceiveAttrs() {
                    this._super(...arguments)
                },
                ...
                willDestroyElement: function() {
                    this._super(...arguments), this.uxSettingsDestroy(), this.set("isShown", !1), this._hideDisconnectNotification(), this._deleteDelayedShowDisconnectNotificationIfExists(), h.off("show", this._showHandler), h.off("hide", this._hideHandler)
                },
                ...
                initChatBindings: function() {
                    this._chatBinding = (0, i.DataBinding)("/lol-chat", (0, i.getProvider)().getSocket()), this._chatBinding.observe("v1/obfuscated-summoner-ids", this, this.handleChatObfuscatedSummonerIds)
                },
                initChampSelectBindings: function() {
                    this._champSelectBinding = (0, i.DataBinding)("/lol-champ-select", (0, i.getProvider)().getSocket()), this._champSelectBinding.observe("/v1/ongoing-trade", this, this.handleOngoingTrade), this._champSelectBinding.observe("/v1/ongoing-swap", this, this.handleOngoingSwap), this._champSelectBinding.observe("/v1/pin-drop-notification", this, this.handlePinDropNotification), this._champSelectBinding.observe("/v1/all-grid-champions", this, this.handleGridChampionsUpdated), this._initSummonerObservers()
                },
                handleChatObfuscatedSummonerIds(e) {
                    i.logger.info("champSelect received chatObfuscatedSummonerIds: " + e), this.set("chatObfuscatedSummonerIds", (e || []).map((e => e.toString()))), this._checkIfShouldShowChatRoom()
                },
                _initSummonerObservers: function() {
                    this.summonerBySlotId = {}, b.forEach((e => {
                ...
                myTeamSummoners: i.Ember.computed("gameModeSubteamData", (function() {
                    const e = b.filter((e => this._isSummonerSlotIdInMyTeam(e))).map((e => this.summonerBySlotId[e]));
                    return i.Ember.A(e)
                })),
                theirTeamSummoners: i.Ember.computed("gameModeSubteamData", (function() {
                    const e = b.filter((e => !this._isSummonerSlotIdInMyTeam(e))).map((e => this.summonerBySlotId[e]));
                    return i.Ember.A(e)
                })),
                ...
                _getHiddenName: function(e, t, n) {
                    ...
                    if (t === r.NAME_VISIBILITY_TYPE.HIDDEN || t === r.NAME_VISIBILITY_TYPE.UNHIDDEN) {
                ...
                handleSummoner: function(e, t) {
                    if (e) {
                        ...
                        const n = this._isSummonerSlotIdInMyTeam(t, this.get("session.localPlayerCellId")),
                            i = e.nameVisibilityType && e.nameVisibilityType.length > 0 ? e.nameVisibilityType : r.NAME_VISIBILITY_TYPE.VISIBLE,
                            s = this._getDisplayNamePromise(e, n, i),
                            o = this._getHiddenName(e, i, n),
                            a = this._getPuuidPromise(e, n, i);
                        this.summonerBySlotId[t].set("isSummonerInMyTeam", n), this.summonerBySlotId[t].set("nameVisibilityType", i), this.summonerBySlotId[t].set("hiddenName", o), Promise.all([s, a]).then((s => {
                            const o = s[0],
                                a = s[1];
                            if (this.summonerBySlotId[t].set("displayName", o), this.summonerBySlotId[t].set("puuid", a), n) {
                                if (!e.obfuscatedSummonerId && !e.summonerId) return;
                                e.obfuscatedSummonerId ? (this.myTeamObfuscatedSummonerIdsSet[e.obfuscatedSummonerId] = !0, this.myTeamSummonerIdsToNames[e.obfuscatedSummonerId] = o) : this.myTeamSummonerIdsToNames[e.summonerId] = o, this._checkIfShouldShowChatRoom(i)
                            }
                        }))
                    }
                },
                _getDisplayNamePromise: async function(e, t, n) {
                    const i = this.get("tra"),
                        s = this.myTeamSummonerIdsToNames[e.obfuscatedSummonerId] || this.myTeamSummonerIdsToNames[e.summonerId];
                    if (s && s.length > 0) return s;
                    if (!t) {
                        return this._getEnemyName(i, e.slotId)
                    }
                    if (n !== r.NAME_VISIBILITY_TYPE.HIDDEN && n !== r.NAME_VISIBILITY_TYPE.UNHIDDEN) {
                        let t;
                        if (e.summonerId) {
                            const n = await this.get("_playerNames").getDisplayNameBySummonerId(e.summonerId);
                            t = n?.playerNameFull
                        }
                        return t
                    } {
                ...
                _getPuuidPromise: function(e) {
                    return new Promise((t => e.puuid ? t(e.puuid) : this.get("summonerInfoService").getSummonerInfo(e.summonerId).then((({
                        puuid: e
                    }) => t(e)))))
                },
                ...
                _checkIfShouldShowChatRoom: function(e) {
                    ...
                    if (!t) return;
                    if (e === r.NAME_VISIBILITY_TYPE.VISIBLE) return void this._showChatRoomIfNotShownYet();
                    if (Object.keys(this.myTeamSummonerIdsToNames).length !== t.numPlayersPerTeam) return;
                ...
                _showChatRoomIfNotShownYet: function() {
                    this.get("showChatRoom") || (Object.keys(this.myTeamSummonerIdsToNames).length > 0 && this.set("myTeamSummonerIdsToNameOverridesJson", JSON.stringify(this.myTeamSummonerIdsToNames)), this.set("showChatRoom", !0))
                },
                ...
                setupShowHandler: function() {
                    this._showHandler = () => {
                        if (!this.isDestroyed && !this.isDestroying && (this.set("isShown", !0), this.resetBanAnimations(), this.get("showEntryAnimation"))) {
                        ...
                        this.isDestroyed || this.isDestroying || (this.set("isShown", !1), this._hideChatRoom())
                    }, h.on("hide", this._hideHandler), this.set("isShown", document.contains(this.get("element")))
                },
                _hideChatRoom: function() {
                    this.myTeamSummonerIdsToNames = {}, this.myTeamObfuscatedSummonerIdsSet = {}, this.set("myTeamSummonerIdsToNameOverridesJson", ""), this.set("chatObfuscatedSummonerIds"), this.set("showChatRoom", !1)
                },
                ...
                pickOrderSwapDisabledConfigurationInSeconds: i.Ember.computed("jmxSettings.LcuChampionSelect.timeLeftToDisablePickOrderSwap", (function() {
                    const e = this.get("jmxSettings.LcuChampionSelect.timeLeftToDisablePickOrderSwap");
                    return e || 5
                })),
                timerDisabledPickOrderSwap: i.Ember.computed("session.timer.timeRemaining", "session.timer.isInfinite", "session.timer.inPlanningPhase", "pickOrderSwapDisabledConfigurationInSeconds", (function() {
                    return !this.get("session.timer.inPlanningPhase") && (this.get("session.timer.timeRemaining") < this.get("pickOrderSwapDisabledConfigurationInSeconds") && !this.get("session.timer.isInfinite"))
                })),
                delayedLastCompletedActionId: i.EmberHelpers.delayed("sessionActions.lastCompletedAction.id", r.DURATIONS.showLockedInSplash),
                ...
                splashPath: i.Ember.computed("showSkinSelectComponent", "skinSplashPath", "showPositionAssignmentBackground", "session.timer.inPlanningPhase", "pickSplashPath", "showPickPhaseComponent", "champSelectBackground", "isShowingVoteReveal", (function() {
                    return this.get("isShowingVoteReveal") && this.get("currentSummoner.champion.skins.length") ? this.get("currentSummoner.champion.skins")[0].splashPath : this.get("showSkinSelectComponent") ? this.get("skinSplashPath") : this.get("showPositionAssignmentBackground") ? this.get("session.timer.inPlanningPhase") ? null : this.get("pickSplashPath") : this.get("showPickPhaseComponent") && this.get("pickSplashPath") || this.get("champSelectBackground")
                })),
                ...
                shouldShowChestFilter: i.Ember.computed("queue.queueRewards.isChampionPointsEnabled", "queue.isRanked", (function() {
                    return this.get("queue.queueRewards.isChampionPointsEnabled") && !this.get("queue.isRanked")
                })),
                shouldShowChestAvailability: i.Ember.computed("shouldShowChestFilter", "queue.gameMode", "session.timer.inFinalizationPhase", "gameflow.gameData.isCustomGame", (function() {
                    return this.get("session.timer.inFinalizationPhase") && this.get("shouldShowChestFilter") && r.GAME_MODES_WITH_CHEST_AVAILABILITY_ENABLED.indexOf(this.get("queue.gameMode")) > -1 && !this.get("gameflow.gameData.isCustomGame")
                })),
                ...
                isUILockedForGameStart: i.Ember.computed.equal("session.timer.phase", r.TIMER_PHASES.gameStarting),
                rerollsDisabled: i.Ember.computed.or("isUILockedForGameStart", "hasSentOrReceivedTradeProposal"),
                showRerollButton: i.Ember.computed.and("session.allowRerolling", "session.timer.inFinalizationPhase"),
                showChampionBench: i.Ember.computed.and("session.benchEnabled", "session.timer.inFinalizationPhase"),
                ...
                gameStartDelayedSysMessage: function(e) {
                    ...
                    t === r.TIMER_PHASES.gameStarting && s !== n && (this.sendDelayedChatMessage(this.get("tra.system_message_starting_soon"), 4e3), this.set("sentGameStartingMessageId", n))
                },
                ...
                hasSentOrReceivedTradeProposal: i.Ember.computed("session.trades.@each.state", (function() {
                    return !!(this.get("session.trades") || []).find((e => e.state === l.TRADE_SENT || e.state === l.TRADE_RECEIVED))
                })),
                showQuitButton: i.Ember.computed("gameflow.gameData.isCustomGame", "isNotSpectating", (function() {
                    return this.get("gameflow.gameData.isCustomGame") && this.get("isNotSpectating")
                })),
                ...
                showPositionAssignment: i.EmberHelpers.computedGate.immediate("session.timer.inPlanningPhase", "session.timer.inBanPickPhase", "session.timer.timeRemaining", "session.timer.totalTimeInPhase", "currentSummoner.hasPosition", "isBlindWithBans", "isNexusBlitz", (function() {
                    if (this.get("isNexusBlitz")) return this._shouldShowPositionAssignmentNexusBlitz();
                    if (this.get("session.timer.inPlanningPhase") && this.get("currentSummoner.hasPosition")) {
                        const e = this.get("jmxSettings.LcuChampionSelect.MinPickIntentDuration") || r.DURATIONS.pickIntentSeconds;
                ...
                showSkinSelectComponent: i.Ember.computed("isShown", "champSelectScreen", "isSpectating", "isShowingVoteCeremonies", (function() {
                    return !this.get("isShown") || this.get("champSelectScreen") === r.SCREENS.selected && !this.get("isSpectating") && !this.get("isShowingVoteCeremonies")
                })),
                ...
                teamSizeText: i.Ember.computed("queue.numPlayersPerTeam", "queue.gameMode", (function() {
                ...
                shouldShowDisconnectNotification: i.Ember.computed("login", "login.connected", "jmxSettings.LcuChampionSelect.IsDisconnectNotificationEnabled", "champSelectDisconnectService.isDisconnected", "isShown", "session.timer.inGameStartingPhase", (function() {
                    const e = this.get("login"),
                        t = !e || !0 !== e.connected,
                        n = this.get("jmxSettings.LcuChampionSelect.IsDisconnectNotificationEnabled"),
                        i = this.get("champSelectDisconnectService.isDisconnected"),
                        s = this.get("isShown"),
                        o = this.get("session.timer.inGameStartingPhase");
                    return n && i && s && !t && !o
                })),
                isSpectating: i.Ember.computed("currentSummoner", "session.myTeam.length", "session.theirTeam.length", (function() {
                    return !(this.get("currentSummoner") || !this.get("session.myTeam.length") && !this.get("session.theirTeam.length"))
                })),
                ...
                selectedWardSkin: i.Ember.computed("jmxSettings.WardSkinConfig.UseLoadouts", "accountLoadout.loadout.WARD_SKIN_SLOT.itemId", "currentSummoner.selectedWardSkin", "wardSkins", (function() {
                    if (this.get("jmxSettings.WardSkinConfig.UseLoadouts")) {
                        const e = 0,
                            t = this.get("accountLoadout.loadout.WARD_SKIN_SLOT.itemId") || e;
                ...
                wardSkins: i.Ember.computed("wardSkinsInventory.@each.itemId", "wardSkinsCatalog.@each.id", (function() {
                    ...
                    if (!f.isEmpty(e) || !f.isEmpty(t)) {
                        const n = e.map((e => ({
                            ...
                            s = f.intersectionBy(t, n, "id").map((e => (e.ownership = {
                                owned: !0
                            }, e)));
                ...
                gameModeSubteamData: i.Ember.computed("gameMode", "session.localPlayerCellId", (function() {
                ...
                disabledSpellIds: i.Ember.computed("queue.gameMode", "jmxSettings.ClientSystemStates.gameModeToInactiveSpellIds", (function() {
                    const e = this.get("queue.gameMode"),
                        t = this.get("jmxSettings.ClientSystemStates.gameModeToInactiveSpellIds");
                    if (!e || !t) return [];
                    let n = i.Ember.get(t, "ALL_GAME_MODES_DISABLED_SPELLS_KEY") || [];
                    return n = n.concat(i.Ember.get(t, e) || []), n.map((function(e) {
                        return parseInt(e)
                    }))
                })),
            ...
            var i = n(1);
            const s = i.Ember.Object.extend({
                summonerIdObserver: i.EmberHelpers.observeChange("summonerId", (function() {
                    const e = this.get("summonerId");
                    e && (0, i.DataBinding)("/lol-summoner").get(`/v1/summoners/${e}`).then((e => {
                        if (!e) return;
                        const {
                            playerNameFull: t,
                            gameName: n,
                        ...
                        this.isDestroying && this.isDestroyed || (this.set("displayName", t), this.set("gameName", n), this.set("tagLine", s))
                    }))
                })),
                name: i.Ember.computed("displayName", "summonerIndex", (function() {
                    if (this.get("displayName")) return this.get("displayName");
                    let e;
                    e = void 0 === this.get("summonerIndex") ? 1 : this.get("summonerIndex") + 1;
                    const t = this.get("root.tra");
                    return t ? t.formatString("obfuscated_summoner_name", {
                        summonerNumber: e
                    }) : ""
                })),
                ...
                selectedWardSkin: i.Ember.computed("root.wardSkins.@each.id", "wardSkinId", (function() {
                    return (this.get("root.wardSkins") || i.Ember.A()).findBy("id", this.get("wardSkinId"))
                })),
            ...
            const s = n(1),
                ...
                c = o.Object.extend(l, {
                    timeRemaining: r.computedGate.immediate("timeRemainingInMs", (function() {
            ...
            const a = n(1),
                ...
                {
                    EmberHelpers: l
                } = (a.UiKitPlugin.getToastManager(), a);
            n(80);
            const c = r.Object.extend({
                    summonerName: r.computed.alias("parentComponent.computedDisplayName"),
                    tra: r.computed.alias("parentComponent.root.tra"),
                    boostedSkinsMessage: r.computed.alias("parentComponent.toastBodyText")
                }),
                m = r.Object.extend({
                    ...
                    computedDisplayName: r.computed("root.session.myTeam.@each.gameName", "root.session.myTeam.@each.displayName", "root._playerNames", "summonerId", (function() {
                    ...
                    onPhaseChange: l.observer("root.session.timer.inFinalizationPhase", (function() {
                    ...
                    displayBoostNotification: function() {
                        this.setProperties({
                            boostToastData: c.create({
                                parentComponent: this
                            }),
                            boostToastOpen: !0
                        })
                    },
                    boostPurchaserIsSelf: r.computed("root.currentSummoner.summonerId", "summonerId", (function() {
                        return this.get("root.currentSummoner.summonerId") === this.get("summonerId")
                    })),
                    boostableSkinCount: r.computed.readOnly("root.session.boostableSkinCount"),
                    boostedSkins: r.computed("boostedSkinIds.[]", "root.currentSummoner.champion.skins.@each.id", (function() {
                        const e = this.get("boostedSkinIds"),
                            t = this.get("root.currentSummoner.champion.skins") || [];
                        return r.A(t.filter((function(t) {
                            return e.indexOf(r.get(t, "id")) >= 0
                        })))
                    })),
                    boostedSkinIds: r.computed("availableSkins.[]", "root.currentSummoner.champion.id", (function() {
                        return r.A(this.get("availableSkins"))
                    })),
                    toastBodyText: r.computed("boostedSkins.[]", "computedDisplayName", "ipAmount", "root.tra", "root.tra.boost_you_unlocked_message", "boostPurchaserIsSelf", (function() {
                    ...
                    skinsChatText: r.computed("boostedSkins.[]", "computedDisplayName", "ipAmount", "root.tra", "root.tra.boost_success_skin_chat_message", (function() {
                    ...
                    ipAmount: r.computed("ipReward", "ipRewardForPurchaser", "boostPurchaserIsSelf", (function() {
                    ...
                    conversationId: r.computed("root.conversations.@each.id", "root.conversations.@each.type", (function() {
            ...
            const s = n(1),
                ...
                u = ["/fe/lol-champ-select/sounds/music-cs-draft-pick-base-layer-01.ogg", "/fe/lol-champ-select/sounds/music-cs-draft-pick-intensity-layer-01.ogg", "/fe/lol-champ-select/sounds/music-cs-draft-pick-intensity-layer-02.ogg", "/fe/lol-champ-select/sounds/music-cs-draft-pick-intensity-layer-03.ogg", "/fe/lol-champ-select/sounds/music-cs-draft-pick-intensity-layer-04.ogg"];
            var p = o.Mixin.create(l, {
                ...
                isDraftMode: o.computed("queue.gameTypeConfig.pickMode", (function() {
                    return i.DRAFT_PICK_MODES.includes(this.get("queue.gameTypeConfig.pickMode"))
                })),
                ...
                preloadDraftPickPhaseMusicTracks: function() {
                    this.draftMusicTracks && u.forEach((e => {
                ...
                processDraftMusicChange: function() {
                    const e = this.get("sessionActions.activeAction"),
                        ...
                        r = this.get("sessionActions.finalizationPhaseActions.length") > 0,
                        l = this.get("session.timer.inFinalizationPhase") && (!r || r && !t),
                        c = [];
                    ...
                    let u = [];
                    return c.length && (u = this.startOrContinueDraftMusicTracks(c)), this.stopDraftMusicTracks(u), c
                },
                ...
                stopDraftMusicTracks: function(e) {
                    this.draftPlayingTracks && (this.draftPlayingTracks = this.draftPlayingTracks.filter((t => {
                        if (-1 === e.indexOf(t)) {
                            const e = this.draftMusicTracks.get(t);
                            this.draftMusicTracks.delete(t);
                            const n = () => {
                                    e.ready().then((() => (e.audioElement.src = "", setTimeout((() => {
                                        e && e.dispose()
                                    }), 5e3), null)))
                                },
                                i = () => {
                                    e.options.fadeOut ? (e.fadeOut(e.options.fadeOut, {
                                        stop: !0
                                    }), e.on("stop", (() => {
                                        n()
                                    }))) : (e.setVolume(0), e.ready().then((() => (e.stop(), null))).then((() => (n(), null))))
                                };
                            return e.options.delayBeforeStop ? window.setTimeout((() => {
                                i()
                            }), e.options.delayBeforeStop) : i(), this.draftMasterTrack === t && (this.draftMasterTrack = null), !1
                        }
                        return !0
                    })))
                },
                startChampSelectMusic: o.observer("champSelectMusicFile", "queue.gameTypeConfig.pickMode", "isDraftMode", "isBlindWithBans", "isShown", o.on("init", (function() {
                    o.run.once(this, (function() {
                        if (!this.get("isShown") || !this.get("queue.gameTypeConfig.pickMode") || this.get("musicStarted")) return;
                        const e = this.get("champSelectMusicFile");
                        this.get("isDraftMode") || this.get("isBlindWithBans") || this.get("isRandomWithBans") ? (this.startDraftMusic(), this.set("musicStarted", !0)) : e && (this.set("champSelectMusic", c.createSound(e, {
                            ...
                            return this.get("champSelectMusicFile") === e && this.get("isShown") ? ("AllRandomPickStrategy" === this.get("queue.gameTypeConfig.pickMode") ? this.startMusicSyncedToEndOfChampSelect(76831) : this.get("champSelectMusic").play(), null) : null
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.default = t.TRADE_STATES = t.TRADE_RESOLVED_STATES = t.TRADE_CREATED_STATES = t.TRADE_CLEAR_TIMEOUT_MS = t.TRADE_CANCEL_TIMEOUT_MS = t.ACCEPTED_TIMEOUT_MS = void 0;
            var i = function(e, t) {
                    if (!t && e && e.__esModule) return e;
                    if (null === e || "object" != typeof e && "function" != typeof e) return {
                        default: e
            ...
            var S = i.Ember.Component.extend(l, {
                ...
                didRender: function() {
                    this._super(...arguments), this.cancelTask(this._tradeCancelTimeout), this.cancelTask(this._tradeClearTimeout);
                    const e = this.get("trade");
                    e.state === c.SENT && this.scheduleTradeCancel(e.id), u.includes(e.state) && (this.set("isDisplayed", !0), this.setSummonerName(e.otherSummonerIndex), this.positionTradeDialog(e.otherSummonerIndex)), m.includes(e.state) && this.scheduleTradeClear(e.id, e.state), this.prevTradeState !== e.state && this.playTradeSfx(e.state), this.prevTradeState = e.state
                },
                positionTradeDialog: function(e) {
                    const t = [...document.querySelectorAll(".your-party .champion-icon-container")][e].getBoundingClientRect(),
                        n = this.element.querySelector(".trade-dialog");
                    n.style.top = t.top - 5 + "px", n.style.left = `${t.left+t.width+15}px`
                },
                setSummonerName: function(e) {
                    const t = this.get("summoners");
                    t && e >= 0 && t[e] && t[e].displayName && this.set("otherSummonerName", t[e].displayName)
                },
                playTradeSfx: function(e) {
                    ...
                    switch (e) {
                        case c.SENT:
                        case c.RECEIVED:
                            t = "/fe/lol-champ-select/sounds/sfx-cs-notif-traderequest-rcvd.ogg";
                            break;
                        case c.ACCEPTED:
                            t = "/fe/lol-champ-select/sounds/sfx-cs-notif-traderequest-accepted.ogg";
                            break;
                        case c.DECLINED:
                            t = "/fe/lol-champ-select/sounds/sfx-cs-notif-traderequest-declined.ogg"
                    }
                    t && this.audioPool.playSound("sfx-notifications", t)
                },
                scheduleTradeCancel: function(e) {
                    this._tradeCancelTimeout = this.runTask((() => this.tradeServiceCall(e, p, d)), 15e3)
                },
                scheduleTradeClear: function(e, t) {
                    const n = t === c.ACCEPTED ? 200 : 1700;
                    this._tradeClearTimeout = this.runTask((() => (this.set("isDisplayed", !1), this.tradeServiceCall(e, "ongoing-trade", f))), n)
                },
                showCancelTradeButton: i.Ember.computed.equal("trade.state", c.SENT),
                showAcceptTradeButton: i.Ember.computed.equal("trade.state", c.RECEIVED),
                ...
                tradeMessageString: i.Ember.computed("trade.state", "tradeWaitingString", "tradeCanceledString", "tradeDeclinedString", "tradeErrorString", (function() {
                ...
                tradeWaitingString: i.Ember.computed("trade.initiatedByLocalPlayer", "trade.requesterChampionName", "otherSummonerName", "tra.pregame_trade_requested", "tra.pregame_trade_waiting", (function() {
                    const e = this.get("trade.initiatedByLocalPlayer"),
                        t = this.get("otherSummonerName");
                    return e ? this.get("tra.service").formatString("pregame_trade_waiting", {
                        actor: t
                    }) : this.get("tra.service").formatString("pregame_trade_requested", {
                        actor: t,
                        entity1: this.get("trade.requesterChampionName"),
                        entity2: this.get("trade.responderChampionName")
                    })
                })),
                tradeBusyString: i.Ember.computed("otherSummonerName", "tra.pregame_trade_error", (function() {
                    return this.get("tra.service").formatString("pregame_trade_busy", {
                ...
                tradeServiceCall: function(e, t, n) {
                    ...
                    return s.default.ajax({
                        ...
                        this.recordDidRequestSucceed && this.recordDidRequestSucceed(!0), i.Telemetry.invokeWithLowProbability((function() {
                            switch (n) {
                                case h:
                                    i.Telemetry.recordNonTimingTracingEvent("champ-trade-accept-success", 1, "event");
                                    break;
                                case d:
                                    i.Telemetry.recordNonTimingTracingEvent("champ-trade-cancel-success", 1, "event");
                                    break;
                                case g:
                                    i.Telemetry.recordNonTimingTracingEvent("champ-trade-decline-success", 1, "event");
                                    break;
                                case f:
                                    i.Telemetry.recordNonTimingTracingEvent("champ-trade-clear-success", 1, "event")
                            }
                        }))
                    })).catch((e => {
                        ...
                        i.DataBinding.bindTo(i.default.getProvider().getSocket()).get("/lol-summoner/v1/current-summoner").then((function(t) {
                            ...
                            i.Telemetry.invokeWithLowProbability((function() {
                                ...
                                switch (n) {
                                    case h:
                                        i.Telemetry.sendEvent("champ-trade-accept-fail", r), i.Telemetry.recordNonTimingTracingEvent("champ-trade-accept-fail", 1, "event");
                                        break;
                                    case d:
                                        i.Telemetry.sendEvent("champ-trade-cancel-fail", r), i.Telemetry.recordNonTimingTracingEvent("champ-trade-cancel-fail", 1, "event");
                                        break;
                                    case g:
                                        i.Telemetry.sendEvent("champ-trade-decline-fail", r), i.Telemetry.recordNonTimingTracingEvent("champ-trade-decline-fail", 1, "event");
                                        break;
                                    case f:
                                        i.Telemetry.sendEvent("champ-trade-clear-fail", r), i.Telemetry.recordNonTimingTracingEvent("champ-trade-clear-fail", 1, "event")
                                }
                            }))
                        }))
                    }))
                ...
                actions: {
                    acceptTrade: function(e) {
                        return i.Telemetry.startTracingEvent("champ-select-trade-accept"), this.tradeServiceCall(e, p, h).finally((() => {
                    ...
                    closeTrade: function(e, t) {
                        return t === c.SENT ? this.tradeServiceCall(e, p, d) : t === c.RECEIVED ? this.tradeServiceCall(e, p, g) : void 0
                    }
                }
            });
            t.default = S
            ...
            const s = n(1),
                ...
                l = a.Object.extend({
                    ...
                    pickActionSet: a.computed("root.session.actions.[]", "allActions.@each.isPick", (function() {
                        const e = this.get("root.session.actions");
                    ...
                    voteActionSet: a.computed("root.session.actions.[]", "allActions.@each.isVote", (function() {
                        const e = this.get("root.session.actions");
                    ...
                    currentActions: a.computed("allActions.@each.completed", "root.session.actions.[]", "currentPhaseHasActions", (function() {
                        const e = this.get("root.session.actions"),
                    ...
                    currentActingCells: a.computed("currentActions.@each.actorCellId", (function() {
                        const e = this.get("currentActions");
                        return e ? [...e.reduce(((e, t) => (e.add(t.get("actorCellId")), e)), new Set)] : []
                    })),
                    nextActions: a.computed("root.session.actions.[]", "currentActions", "currentActionSetIndex", (function() {
                        if (!this.get("root.session.actions")) return a.A();
                        const e = this.get("currentActions") ? this.get("currentActionSetIndex") : -1;
                        return -1 === e ? a.A() : this.get("root.session.actions")[e + 1] || a.A()
                    })),
                    nextAction: a.computed("nextActions.[]", "nextActions.@each.actor", (function() {
                        const e = this.get("nextActions");
                        return e ? e.findBy("actor.isSelf", !0) || e.get("firstObject") : null
                    })),
                    activeActions: a.computed("currentActions.@each.completed", "currentPhaseHasActions", (function() {
                        return this.get("currentPhaseHasActions") ? a.A(this.get("currentActions").filterBy("completed", !1)) : a.A()
                    })),
                    activeAction: a.computed("activeActions.[]", "activeActions.@each.actor", (function() {
                    ...
                    completedActions: a.computed("allActions.@each.completed", (function() {
                    ...
                    banActions: a.computed("allActions.@each.id", "allActions.@each.type", (function() {
                        return a.A(this.get("allActions").filterBy("type", "ban"))
                    })),
                    completedBanActions: a.computed("banActions.@each.completed", (function() {
                        return a.A(this.get("banActions").filterBy("completed", !0))
                    })),
                    lastCompletedBanAction: a.computed("completedBanActions.@each.id", (function() {
                        return this.get("completedBanActions.lastObject")
                    })),
                    pickActions: a.computed("allActions.@each.id", "allActions.@each.type", (function() {
                        return a.A(this.get("allActions").filterBy("type", "pick"))
                    })),
                    completedPickActions: a.computed("pickActions.@each.completed", (function() {
                        return a.A(this.get("pickActions").filterBy("completed", !0))
                    })),
                    pickActionsHaveBegun: a.computed("activeAction.type", "completedPickActions", (function() {
                        return "pick" === this.get("activeAction.type") || this.get("completedPickActions").length
                    })),
                    voteActions: a.computed("allActions.@each.id", "allActions.@each.type", (function() {
                    ...
                    completedVoteRevealActions: a.computed("voteRevealActions.@each.completed", (function() {
                        return a.A(this.get("voteRevealActions").filterBy("completed", !0))
                    })),
                    myTeamVoteActions: a.computed("allActions.@each.id", "voteActions.@each.actor", (function() {
                        return a.A(this.get("voteActions").filterBy("actor.isOnLeftSide", !0))
                    })),
                    enemyTeamVoteActions: a.computed("allActions.@each.id", "voteActions.@each.actor", (function() {
                        return a.A(this.get("voteActions").filterBy("actor.isOnLeftSide", !1))
                    })),
                    currentPhaseHasActions: a.computed("root.session.timer.inBanPickPhase", "root.session.timer.inFinalizationPhase", "finalizationPhaseActions.length", (function() {
                    ...
                    leftSideFirstPick: a.computed("pickActions.@each.isOnLeftSide", (function() {
                        const e = this.get("pickActions");
                        return !(!e || !e[0]) && e[0].get("isOnLeftSide")
                    })),
                    myTeamBanActions: a.computed("banActions.@each.id", "banActions.@each.actor", "root.queue.gameMode", "root.session.localPlayerCellId", (function() {
                        const e = this.get("banActions"),
                            t = i.GAME_MODES_WITH_SUBTEAMS[this.get("root.queue.gameMode")];
                        if (t) {
                            const n = this.get("root.session.localPlayerCellId"),
                                i = t.subteams.find((e => e.cellIds.includes(n)));
                            return a.A(e.filter((e => !!i && i.cellIds.includes(e.actorCellId))))
                        }
                        return a.A(e.filterBy("actor.isOnLeftSide", !0))
                    })),
                    myTeamUncompletedBanActions: a.computed("myTeamBanActions.@each.id", "myTeamBanActions.@each.completed", (function() {
                        return a.A(this.get("myTeamBanActions").filterBy("completed", !1))
                    })),
                    theirTeamBanActions: a.computed("banActions.@each.id", "banActions.@each.actor", "root.queue.gameMode", "root.session.localPlayerCellId", (function() {
                        const e = this.get("banActions"),
                            t = i.GAME_MODES_WITH_SUBTEAMS[this.get("root.queue.gameMode")];
                        if (t) {
                            const n = this.get("root.session.localPlayerCellId"),
                    ...
                    someoneIsBanning: o.computedGate("activeActions.@each.type", (function() {
                        return this.get("activeActions") && !!this.get("activeActions").find((function(e) {
                            return "ban" === e.get("type")
                        }))
                    })),
                    isSimultaneousBans: o.computedGate("currentActions.@each.isBan", (function() {
                        const e = this.get("currentActions");
                        return !(!e || !e.length || e.length <= 1) && e.filterBy("isBan", !0).length > 1
                    })),
                    areSimultaneousBans: a.computed("root.sessionActions.allActions.[]", (function() {
                        const e = this.get("root.session.actions");
                        let t;
                        if (e)
                    ...
                    currentBanAction: a.computed("currentActions.@each.type", "someoneIsBanning", (function() {
                        return this.get("someoneIsBanning") ? this.get("currentActions").findBy("type", "ban") : null
                    })),
                    numBanActionsCompleted: a.computed.readOnly("completedBanActions.length"),
                    numPickActionsCompleted: a.computed.readOnly("completedPickActions.length"),
                    allPlayersPickTogether: a.computed("pickActionSet.length", "root.session.myTeam.length", "root.session.theirTeam.length", "root.queue.gameTypeConfig.pickMode", (function() {
                        const e = this.get("root.session.myTeam.length"),
                            t = this.get("root.session.theirTeam.length"),
                    ...
                    allPlayersVoteTogether: a.computed("voteActionSet.length", "root.session.myTeam.length", "root.session.theirTeam.length", (function() {
                        return this.get("root.session.myTeam.length") + this.get("root.session.theirTeam.length") === this.get("voteActionSet.length")
                    })),
                    allPlayersActTogether: a.computed("currentActions.length", "root.session.myTeam.length", "root.session.theirTeam.length", (function() {
                        return this.get("currentActions.length") === this.get("root.session.myTeam.length") + this.get("root.session.theirTeam.length")
                    })),
                    phaseTransitionStringsByActionId: a.computed("allActions.[]", (function() {
                        ...
                        for (let n = 0; n < e.length; n++)
                            if (t = e[n], t.get("isPhaseTransition")) {
                                if (l = "", r = null, n + 1 < e.length && (r = e[n + 1]), !r || !r.get("type")) {
                                    a[t.get("id")] = "finalization";
                                    break
                                }
                                l = r.get("type"), 1 === s[l] ? a[t.get("id")] = "one_" + l + "_phase" : (o[l] = o[l] + 1, a[t.get("id")] = l + "_" + o[l])
                            } return a
                    }))
                });
            e.exports = l
            ...
            e.exports = a.Component.extend({
                ...
                audioPool: s.default,
                mouseEnter: function() {
                    this.get("disabled") || this.audioPool.playSound(r, "/fe/lol-champ-select/sounds/sfx-cs-lockin-button-hover.ogg")
                },
                click: function() {
                    this.get("disabled") || this.audioPool.playSound(r, "/fe/lol-champ-select/sounds/sfx-cs-lockin-button-click.ogg")
                },
                actions: {
                    click: function() {
            ...
            e.exports = a.Component.extend(l, {
                ...
                classNameBindings: ["visible::removed", "waitingForBans::enemy-team-visible", "hideWaitingForTheirBansLabel::waiting-for-their-team-bans"],
                layout: n(98),
            ...
            n(100), e.exports = i.Ember.Component.extend({
                ...
                gameModeClass: i.Ember.computed("gameMode", (function() {
                    return "CHERRY" === this.get("gameMode") ? "left-anchored-combined-bans" : null
                }))
            })
        }, (e, t, n) => {
            "use strict";
            ...
            e.exports = i.Ember.Component.extend(m, {
                ...
                classNameBindings: ["showChestAvailabilityHintedPortraits:show-chest-availability-hinted-portraits"],
                layout: n(109),
                pendingRequest: !1,
                isPlayingSound: !1,
            ...
            e.exports = i.Ember.Component.extend(r, {
                ...
                layout: n(112),
                classNameBindings: ["isEmpty:empty-bench-item", "benchSwapOnCooldown:on-cooldown", "onCooldownFromNonPrioritizedBenchPrefill:on-cooldown", "onCooldownFromNonPrioritizedBenchPrefill:from-non-prioritized-prefill", "canPlay::grayed-out"],
                ...
                pickableChampionSet: i.Ember.computed.alias("champSelectInventory.pickableChampionSet"),
                init: function() {
                    this._super(...arguments);
                    const e = this.get("index"),
                        t = this.get("benchChampions");
                    e < t.length && !t[e].isPriority && (this.set("onCooldownFromNonPrioritizedBenchPrefill", !0), this.runTask((function() {
                ...
                allySwapCooldownObserver: a.observer("champion.id", (function() {
                    ...
                    t && t !== e && (-1 !== e && (this.set("onCooldownFromAllySwap", !0), this.runTask((function() {
                ...
                tooltipText: i.Ember.computed("championName", (function() {
                    return this.get("tra.service").formatString("champion_bench_item_tooltip", {
                        championName: this.get("championName")
                    })
                })),
                showChampionChestAvailable: i.Ember.computed("shouldShowChestAvailability", "champion.id", "championChestAvailabilityMap", (function() {
                    const e = this.get("champion.id"),
                        t = this.get("championChestAvailabilityMap");
                    return !!(this.get("shouldShowChestAvailability") && e && t) && t.get(e + "")
                })),
                click() {
                    this.get("isEmpty") || !this.get("canPlay") || this.get("onCooldownFromAllySwap") || this.get("onCooldownFromNonPrioritizedBenchPrefill") || this.sendAction("championClicked", this.get("champion.id"))
                },
                backgroundStyle: i.Ember.computed("champion.squarePortraitPath", (function() {
                    return "background-image: url('" + this.get("champion.squarePortraitPath") + "');"
                }))
            })
        }, (e, t, n) => {
            "use strict";
            ...
            n(114), e.exports = i.Ember.Component.extend({
                ...
                chestAvailable: i.Ember.computed("championId", "championChestAvailabilityMap", (function() {
                    const e = this.get("championId"),
                        t = this.get("championChestAvailabilityMap");
                    return !(!e || !t) && t.get(e + "")
                })),
                anyChampionsChestAvailable: i.Ember.computed("myTeamSummoners.@each.championId", "benchChampions.[]", "championChestAvailabilityMap", (function() {
                    ...
                    for (let t = 0; t < this.get("myTeamSummoners.length"); t++)
                        if (e.get(this.get(`myTeamSummoners.${t}.championId`) + "")) return !0;
                    for (let t = 0; t < this.get("benchChampions.length"); t++)
                        if (e.get(this.get(`benchChampions.${t}.championId`) + "")) return !0;
                    return !1
                }))
            })
        }, (e, t, n) => {
            ...
            const {
                RunMixin: p,
                DomMixin: d
            } = i.EmberAddons.EmberLifeline, h = "championFilterPreferenceKey";
            n(122), n(123), n(124), e.exports = i.Ember.Component.extend(p, d, {
                ...
                chestFilterDisabled: i.Ember.computed.bool("jmxSettings.LcuChampionSelect.DisableChestFilter"),
                ...
                champSelectInventory: i.Ember.inject.service("champ-select-inventory"),
                pickableChampionSet: i.Ember.computed.alias("champSelectInventory.pickableChampionSet"),
                bannableChampionSet: i.Ember.computed.alias("champSelectInventory.bannableChampionSet"),
                init: function() {
                    this._super(...arguments), this.set("isAnimating", !1), this.set("gridChampionLayout", new m.default(101, 96)), this.set("randomChampionConfiguration", this.createRandomViewChampion()), this.csBinding = (0, i.DataBinding)("/lol-champ-select", (0, i.getProvider)().getSocket()), this.csBinding.observe("/v1/all-grid-champions", this, this.handleGridChampionsUpdated), this.getPreferredSortingMethod()
                },
                didInsertElement: function() {
                ...
                bindChampIconSounds: function() {
                    const e = (e, t) => {
                        !t.target.classList.contains("champion-grid-champion-thumbnail") || t.target.classList.contains("waiting") || t.target.getAttribute("disabled") || s.default.playSound(a.SFX_CHANNEL, a.SOUNDS_PATH + "/sfx-uikit-grid-" + e + ".ogg")
                    };
                ...
                createChampionConfiguration: function(e) {
                    return this.csBinding.observe(`/v1/grid-champions/${e.id}`, this, this.handleGridChampionUpdated), l.ViewChampionClass.create({
                        champion: e,
                        grid: this,
                        tra: this.get("tra")
                    })
                ...
                clearFiltersAfterPickOrBan: i.EmberHelpers.observeMultiChange("summoner.banActions.@each.completed", "summoner.pickAction.completed", (function() {
                    this.clearFilters()
                })),
                ...
                positionFilters: i.Ember.computed((function() {
                    const e = a.POSITIONS.map((e => r.PositionFilter.create({
                        name: e,
                        tra: this.get("tra")
                    })));
                    return i.Ember.A(e)
                ...
                chestFilter: i.Ember.computed((function() {
                    return i.Ember.Object.create({
                        name: "chest",
                        value: !1,
                        displayName: this.get("tra.service").formatString("filter_by_chest"),
                        favoriteName: this.get("tra.service").formatString("favorite_by_chest"),
                        unfavoriteName: this.get("tra.service").formatString("unfavorite_by_chest"),
                        canFavorite: !1,
                        matches: function(e) {
                            return !!e && (e.id === a.RANDOM_CHAMP.championId || !e.masteryChestGranted && e.owned)
                        }
                    })
                })),
                filters: i.Ember.computed("positionFilters", "chestFilter", "chestFilterDisabled", "shouldShowChestFilter", (function() {
                    const e = [].concat(this.get("positionFilters") || []);
                    return !this.get("chestFilterDisabled") && this.get("shouldShowChestFilter") && e.push(this.get("chestFilter")), i.Ember.A(e)
                })),
                ...
                filterAndSortChampionConfigurations: i.EmberHelpers.observeMultiChange("selectedFilter", "canPlayFilter", "debouncedSearchText", "currentLocale", "pickableChampionSet", "championConfigurations", "championConfigurations.@each.favorite", "isRandomChampionEnabled", (function(e, t, n) {
                    const i = e && Object.keys(e) || [],
                        s = this.get("championConfigurations");
                    if (!s || 0 === i.length) return;
                    const o = i.some((e => "selectedFilter" === e || "debouncedSearchText" === e));
                ...
                _filterAndSortChampionConfigurations: function(e, t) {
                    const n = this.get("sortByMastery"),
                        ...
                        l = e.filter((e => {
                            ...
                            return !(t < 0) && (o.set(e, t), r.set(e, e.get("champion")), !0)
                        }));
                    if (l.sort(((e, t) => {
                            const l = o.get(e),
                                c = o.get(t),
                            ...
                            if (l === c) {
                                ...
                                if (n) {
                                    ...
                                    {
                                        const e = (u.masteryPoints || 0) - (m.masteryPoints || 0);
                                        if (0 !== e) return e > 0 ? 1 : -1
                                    }
                                }
                ...
                _selectableRandomChampions: function(e) {
                    ...
                    return e.filter((e => e.get("searchScore") > -1 && !e.get("champion.selectionStatus.pickedByOtherOrBanned") && !e.get("champion.disabled") && e.get("champion.id") !== a.RANDOM_CHAMP.championId && (!t || e.get("champion.id") !== t)))
                },
                ...
                actions: {
                    ...
                    sort: function(e) {
                        this.setProperties({
                            ...
                            sortByName: "name" === e
                        }), "mastery" !== e && "favorite" !== e || i.Telemetry.sendEvent("champ-select-grid-sort", e), (0, c.saveAccountSetting)(h, e), this._filterAndSortChampionConfigurations(this.get("championConfigurations").toArray(), !0)
                    },
                    ...
                    select: function(e) {
                        if (e.get("champion.id") === a.RANDOM_CHAMP.championId && !(e = this._findRandomChampion())) return;
                        const t = e.get("champion.id"),
                            n = e.get("champion.disabled");
                        if (e.get("champion.selectionStatus.pickedByOtherOrBanned") || n) return;
                        const s = this.get("summoner.changingAction");
                        if (!s || void 0 === s.get("id") || t === s.get("championId")) return;
                        (!this._lastSelectChampionTelemetrySample || Date.now() - 1e4 > this._lastSelectChampionTelemetrySample) && (i.Telemetry.startTracingEvent("champ-select-select-champion-v2"), i.Telemetry.startTracingEvent("champ-select-pick-intent"), this._isRecordingSelectChampionTime = !0, this._isRecordingPickIntentTime = !0, this._lastSelectChampionTelemetrySample = Date.now());
                        const r = o.default.ajax({
                            ...
                            this.recordDidRequestSucceed && this.recordDidRequestSucceed(!1, e), this.get("pendingRequest") === r && (this.set("summoner.requestedChampionId", s.get("championId")), i.Telemetry.sendEvent("champ-select-could-not-select-champion"), this._isRecordingSelectChampionTime && (i.Telemetry.endTracingEvent("champ-select-select-champion-v2"), this._isRecordingSelectChampionTime = !1), this._isRecordingPickIntentTime && (i.Telemetry.endTracingEvent("champ-select-pick-intent"), this._isRecordingPickIntentTime = !1))
                        }));
                        this.set("pendingRequest", r), this.set("summoner.requestedChampionId", t)
                    },
                    handleFilterMouseOver: function() {
                        s.default.playSound(a.SFX_CHANNEL, a.SOUNDS_PATH + "/sfx-uikit-grid-hover.ogg")
                    },
                    toggleFilter: function(e) {
                        s.default.playSound(a.SFX_CHANNEL, a.SOUNDS_PATH + "/sfx-uikit-generic-click-small.ogg"), this.get("filters").forEach((t => {
                    ...
                    showDisabledTooltip: function(e) {
                        ...
                        if (!e.get("disabledAttr")) return void(s && s.hasOwnProperty(t) && (i.TooltipManager.disable(s[t]), delete s[t]));
                        const o = {
                            gridComponent: this,
            ...
            t = {}, e.exports = t, t.simpleFilter = function(e, n) {
                ...
                for (var p = 0; p < a; p++) i = t[p], u[p] === e[s] ? (i = c + i + m, s += 1, l += 1 + l) : l = 0, r += l, o[o.length] = i;
                return s === e.length ? (r = u === e ? 1 / 0 : r, {
                    rendered: o.join(""),
                    score: r
                }) : null
            ...
            t.getAccountSetting = function(e) {
                return (0, i.DataBinding)("/lol-settings").get(s).then((t => {
            ...
            n(130), e.exports = a.Component.extend(c, {
                classNames: ["champion-splash-background"],
                classNameBindings: ["champSelectScreen", "largeAreaAnimationsEnabled:large-area-animations-enabled:large-area-animations-disabled", "isAnimating:is-animating:is-pending", "lastCompletedBanIsPlayerTeam:is-player-team:is-enemy-team", "isRotating:is-rotating:is-not-rotating", "isShowingGrid:is-showing-grid:is-not-showing-grid", "newOutroLeft:new-pick-outro-left", "newOutroRight:new-pick-outro-right", "isNotPickingAndNotSelectedScreen:mask-splash", "currentNotification"],
                layout: n(131),
                ...
                backgroundSwitcherClasses: a.computed("splashUnlocked", (function() {
                    return "champ-select-bg " + (this.get("splashUnlocked") ? "unlocked" : "locked")
                })),
                ...
                playLowSpecBanLockedInAnimation: l.observeChange("lowSpecBanLockedInAnimationState", (function() {
                ...
                playBanLockedInAnimation: l.observeChange("banLockedInAnimationState", (function() {
                ...
                playBanOutroAnimation: l.observeChange("banOutroAnimationState", (function() {
            ...
            e.exports = s.Component.extend({
                ...
                classNameBindings: ["champSelectScreen", "actingSummonerCellClass", "largeAreaAnimationsEnabled:animation-enabled", "shouldPlayIntroAnimation:should-play-intro", "isHeaderExpanded:expanded-header"],
                layout: n(134),
            ...
            const s = i.Ember.Component.extend({
                ...
                doesSkinHaveForms: i.Ember.computed("doesSkinHaveChromas", (function() {
                    return !this.get("doesSkinHaveChromas") && "kQuestSkin" === this.get("baseSkin.productType")
                })),
            ...
            const {
                DomMixin: c
            } = s.EmberAddons.EmberLifeline, m = s.UiKitPlugin.getLayerManager(), u = s.ViewportPlugin.fullScreen().getScreenRoot("rcp-fe-lol-champ-select");
            e.exports = s.Ember.Component.extend(c, {
                ...
                actions: {
                    onEmotesButtonHover: function() {
                        this.get("disabled") || o.default.playSound(l.SFX_CHANNEL, l.SOUNDS_PATH + "/sfx-uikit-grid-hover.ogg")
                    },
                ...
                initEmotePanel: function() {
                    return (0, r.useEmotesApi)((e => e.getCurrentPlayerEmotePanel().then((e => {
                ...
                showEmoteModal: function() {
                    this.get("showingEmotes") || (m.addLayer(this.get("emotesModalComponent")), this.set("showingEmotes", !0), this.set("_screenRootHideCallback", (() => {
                        this.get("showingEmotes") && this.get("emotesModalComponent") && this.hideEmoteModal(!1), u.off("hide", this.get("_screenRootHideCallback"))
            ...
            n(150), e.exports = s.Ember.Component.extend(r, l, {
                layout: n(151),
                ...
                actions: {
                    ...
                    toggleFlyout: function() {
                        this.get("disabled") || this.get("temporarilyDisabled") || (this.set("animateButton", !0), this.toggleFlyout(this))
                    }
                }
            })
        }, (e, t, n) => {
            ...
            var l = s.Component.extend(a, {
                ...
                didInsertElement: function() {
                    ...
                    this.animationTimeline || (this.animationTimeline = new r.TimelineMax({
                        paused: !0
                    }), this.animationTimeline.to(e, 1, {
                        x: 0,
                        ease: r.Power3.easeInOut
                    }).to(t, .3, {
                        autoAlpha: 0,
            ...
            n(156), e.exports = s.Component.extend({
                layout: n(157),
                ...
                pickModeText: s.computed("mutatorName", (function() {
                    const e = "custom_game_mutator_type_" + o[this.get("mutatorName")];
            ...
            e.exports = i.HTMLBars.template({
                id: "k9AYr8YS",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\game-info-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\game-info-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\game-info-component\\\\index.js\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","team-size"],["flush-element"],["text","\\n  "],["append",["unknown",["teamSizeText"]],false],["text","\\n"],["close-element"],["text","\\n"],["open-element","div",[]],["static-attr","class","pick-mode"],["flush-element"],["text","\\n  "],["append",["unknown",["pickModeText"]],false],["text","\\n"],["close-element"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            n(159);
            const r = "sfx-ui",
                l = s.default.createSound(r, "/fe/lol-champ-select/sounds/sfx-cs-draft-ban-button-hover.ogg"),
                c = s.default.createSound(r, "/fe/lol-champ-select/sounds/sfx-cs-lockin-button-hover.ogg"),
                m = [l, c],
            ...
            e.exports = i.Ember.Component.extend({
                ...
                layout: n(160),
                requestPending: !1,
                disabled: i.EmberHelpers.computedGate("summoner.activeAction.championId", "requestPending", (function() {
                    if (!this.get("summoner.activeAction.championId") || this.get("requestPending")) return !0
                })),
                ...
                mouseEnter: function() {
                    !this.get("disabled") && this.get("visible") && (m.forEach((function(e) {
                ...
                lockInCompletedObserver: i.Ember.observer("summoner.isActingNow", (function() {
                    !this._isRecordingLockInTime && !this._isRecordingBanTime || this.get("summoner.isActingNow") || requestAnimationFrame((() => {
                        this.isDestroying || this.isDestroyed || (this._isRecordingBanTime ? (i.Telemetry.endTracingEvent("champ-select-ban"), this._isRecordingBanTime = !1) : this._isRecordingLockInTime && (i.Telemetry.endTracingEvent("champ-select-lock-in"), this._isRecordingLockInTime = !1))
                    }))
                })),
                sendLCUReqeust: function(e, t) {
                    this.set("requestPending", !0);
                    const n = this.get("summoner.isBanningNow");
                    n ? (i.Telemetry.startTracingEvent("champ-select-ban"), this._isRecordingBanTime = !0) : (i.Telemetry.startTracingEvent("champ-select-lock-in"), this._isRecordingLockInTime = !0), o.default.ajax({
                        type: "PATCH",
                        ...
                        this.recordDidRequestSucceed && this.recordDidRequestSucceed(!1, e);
                        const t = e && e.responseText ? e.responseText : "";
                        this._isRecordingLockInTime ? (i.Telemetry.endTracingEvent("champ-select-lock-in"), i.Telemetry.sendEvent("champ-select-lock-in-failure", t), i.Telemetry.recordNonTimingTracingEvent("champ-select-lock-in-failure", 1, "event"), this._isRecordingLockInTime = !1) : this._isRecordingBanTime && (i.Telemetry.endTracingEvent("champ-select-ban"), i.Telemetry.sendEvent("champ-select-ban-failure", t), i.Telemetry.recordNonTimingTracingEvent("champ-select-ban-failure", 1, "event"), this._isRecordingBanTime = !1)
                    })).finally(function() {
                        this.set("requestPending", !1)
                    }.bind(this)), n ? s.default.playSound(r, "/fe/lol-champ-select/sounds/sfx-cs-draft-ban-button-click.ogg") : s.default.playSound(r, "/fe/lol-champ-select/sounds/sfx-cs-lockin-button-click.ogg")
                },
                summonerInfoService: i.Ember.inject.service("summoner-info"),
                buildBanIntentModal: function(e, t) {
                    const n = i.UiKitPlugin.getModalManager(),
                        ...
                        r = o ? this.get("tra.ban_intent_modal_description_self") : this.get("tra").formatString("ban_intent_modal_description", {
                    ...
                    const c = () => {
                        n.remove(l), this.removeObserver("summoner.isBanSniping", this, c)
                    };
                    this.addObserver("summoner.isBanSniping", this, c), l.acceptPromise.then((() => {
                        this.sendLCUReqeust(e, t);
                        const n = this.get("summoner.summonerId"),
                            s = e.get("champion.selectedBy.summonerId");
                        let o, a;
                        this.get("summonerInfoService").getSummonerInfo(n).then((e => (o = e.puuid, this.get("summonerInfoService").getSummonerInfo(s)))).then((e => {
                            a = e.puuid;
                            const t = {
                            ...
                            i.Telemetry.sendCustomData("champ-select-ban-intent-modal-confirm", t)
                        }))
                    }), (() => {
                ...
                actions: {
                    lockIn: function() {
                        ...
                        const e = this.get("summoner.activeAction"),
                            t = e.get("championId");
                        this.get("summoner.isBanSniping") ? (i.Telemetry.sendEvent("champ-select-ban-intent-modal-generate"), this.buildBanIntentModal(e, t)) : this.sendLCUReqeust(e, t)
                    }
                }
            })
        }, (e, t, n) => {
            ...
            var l = i.Ember.Component.extend({
                ...
                init: function() {
                    this._super(...arguments), this.retrieveRuneRecommenderTutorialSetting()
                },
                didUpdateAttrs: function() {
                ...
                actions: {
                    ...
                    showPerksModal() {
                        ...
                        (0, o.usePerksApi)((t => t.edit(this.get("currentPerksPage.id"), !0, (() => this.hidePerksModal()), e))), this.sendAction("showingPerksModalChanged", !0)
                    },
            ...
            const r = n(1),
                ...
                h = r.ViewportPlugin.fullScreen().getScreenRoot("rcp-fe-lol-champ-select"),
                {
                    RunMixin: g
                } = m.EmberLifeline,
                f = l("/lol-perks", p().getSocket());
            n(165), e.exports = c.Component.extend(g, {
                layout: n(166),
                ...
                init: function() {
                    this._super(...arguments), this.set("_screenRootHideHandler", (() => {
                        this.get("tutorialTooltipNotification") && d.remove(this.get("tutorialTooltipNotification")), this.set("tutorialTooltipShown", !1), this.set("shouldShowDropdownHighlight", !1), this.dropdownHighlightTimer && this.cancelTask(this.dropdownHighlightTimer)
                ...
                displayTutorialTooltipNotification: function(e) {
                    ...
                    const t = r.UiKitPlugin.getTemplateHelper().contentBlockNotification(this.get("tra." + e), "champ-select-runes-tutorial-tooltip"),
                        n = d.add(t, {
                            target: {
                                domNode: this.element,
                                anchor: {
                ...
                checkShouldShowNotifications: u.observer("timer.inBanPickPhase", "timer.inFinalizationPhase", (function() {
                    if (this.get("showPerksSelectionControls") && (this.get("timer.inBanPickPhase") || this.get("timer.inFinalizationPhase"))) {
                        l("/lol-perks").get("/v1/show-auto-modified-pages-notification").then((e => {
                            e && this.runTask((() => {
                ...
                actions: {
                    dropdownClicked: function() {
                        this.get("shouldShowDropdownHighlight") && (this.set("shouldShowDropdownHighlight", !1), this.setTooltipSeenCount(this.get("runesTutorialSeenCount") + s.RUNES.tutorialHighlightActionSeenCountIncrement)), this.get("runeSwapNotification") && d.remove(this.get("runeSwapNotification")), this.get("tutorialTooltipNotification") && d.remove(this.get("tutorialTooltipNotification"))
                    },
            ...
            e.exports = l.Component.extend(u, {
                ...
                layout: n(175),
                isAnimating: l.computed.equal("banSlashAnimationState", o.ANIMATION_STATES.STARTED),
                banSlashAnimating: !1,
                isInit: !1,
                isTeamBan: l.computed.alias("sessionActions.lastCompletedBanAction.actor.isOnLeftSide"),
                slashRotationDegrees: 0,
                animationDispatcher: l.inject.service("animation-dispatcher"),
                banSlashAnimationState: l.computed.alias("animationDispatcher.states.banSlashAnimation"),
                banRotationAnimationState: l.computed.alias("animationDispatcher.states.banRotationAnimation"),
                largeAreaAnimationsEnabled: l.computed.equal("uxSettings.largeAreaAnimationsEnabled", !0),
                isShowingSelectedScreen: l.computed.equal("champSelectScreen", a.SCREENS.selected),
                listenForStateMachineState: m.observer("largeAreaAnimationsEnabled", l.on("didInsertElement", (function() {
                ...
                actionsToPointTo: l.computed("allPlayersActTogether", "activeAction.actor.isSelf", "activeAction", "activeActions.[]", (function() {
                    return this.get("allPlayersActTogether") ? this.get("activeAction.actor.isSelf") ? l.A([this.get("activeAction")]) : l.A() : this.get("activeActions")
                })),
                ...
                playBanSlashAnimation: m.observeChange("banSlashAnimationState", (function() {
            ...
            e.exports = o.Component.extend(l, {
                ...
                lockedInSplash: o.computed("shouldShowLockedSplash", "sessionActions.lastCompletedAction.champion.skins.firstObject.splashPath", (function() {
                    return this.get("shouldShowLockedSplash") ? this.get("sessionActions.lastCompletedAction.champion.skins.firstObject.splashPath") : null
                })),
                currentBackground: o.computed("selectedChampSplash", "lockedInSplash", "shouldShowSplashBackground", "summoner.isPickingNow", (function() {
                ...
                shouldShowGrid: o.computed("shouldShow", "summoner.isActingNow", "sessionActions.isSimultaneousBans", "isPlayingCeremony", "waitingForBanAnimation", "gridRequested", "timer.inPlanningPhase", "timer.inFinalizationPhase", (function() {
                ...
                dispatchLockinEvent: r.observeChange("shouldShowLockedSplash", (function() {
                ...
                shouldShowLockIn: r.computedGate.immediate("summoner.isActingNow", "shouldShowGrid", (function() {
                ...
                shouldShow: r.computedGate.immediate("champSelectScreen", "timer.inFinalizationPhase", (function() {
                    const e = this.get("champSelectScreen");
                    return e === i.SCREENS.pick || e === i.SCREENS.banShowcase || e === i.SCREENS.selected && !this.get("timer.inFinalizationPhase")
                })),
                gridIsToggleable: o.computed("summoner.isActingNow", "timer.inFinalizationPhase", "isPlayingCeremony", "isNotSpectating", "transitioningToSelectedScreen", "showVoteShowcase", (function() {
                    return !this.get("summoner.isActingNow") && !this.get("timer.inFinalizationPhase") && !this.get("isPlayingCeremony") && this.get("isNotSpectating") && !this.get("transitioningToSelectedScreen") && !this.get("showVoteShowcase")
                })),
                setPropertiesForMediaFader: r.observeMultiChange("shouldShow", "activeAction.champion", "activeAction.champion.skins.firstObject.splashPath", "currentBackground", "shouldShowGrid", "shouldShowPhaseTransition", "showVoteShowcase", (function() {
                ...
                onActiveActionChanged: r.observeMultiChange("sessionActions.activeAction", (function(e, t) {
            ...
            e.exports = i.Ember.Component.extend({
                ...
                isNameUnhidden: i.Ember.computed("nameVisibilityType", (function() {
                    return this.get("nameVisibilityType") === s.NAME_VISIBILITY_TYPE.UNHIDDEN
                })),
                shouldShowDisplayName: i.Ember.computed("isSummonerInMyTeam", "nameVisibilityType", (function() {
                    return !this.get("isSummonerInMyTeam") || this.get("nameVisibilityType") === s.NAME_VISIBILITY_TYPE.HIDDEN
                }))
            })
        }, (e, t, n) => {
            const i = n(1).Ember;
            ...
            n(182), e.exports = a.Component.extend({
            ...
            n(185);
            const r = i.ViewportPlugin.fullScreen().getScreenRoot("rcp-fe-lol-champ-select"),
                l = "sfx-ui";
            e.exports = i.Ember.Component.extend({
                layout: n(186),
                ...
                mouseEnter: function() {
                    this.get("rerollsDisabled") || o.default.playSound(l, "/fe/lol-champ-select/sounds/sfx-cs-button-reroll-hover.ogg")
                },
                actions: {
                    reroll: function() {
                        if (!this.get("rerollInProgress") && !this.get("rerollsDisabled")) {
                            o.default.playSound(l, "/fe/lol-champ-select/sounds/sfx-cs-button-reroll-click.ogg"), this.set("rerollInProgress", !0);
                            const e = Date.now();
                            this.set("rerollId", e), this.get("timerId") && i.Telemetry.cancelTimer(this.get("timerId")), this.set("timerId", i.Telemetry.startTimer("champ-select-reroll")), s.default.ajax({
                                type: "POST",
                                ...
                                this.recordDidRequestSucceed && this.recordDidRequestSucceed(!1, t), this.isDestroyed || this.isDestroying || this.get("rerollId") === e && this.set("rerollInProgress", !1)
                            }))
                        }
                    }
                }
            ...
            e.exports = i.HTMLBars.template({
                id: "0axulb75",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\reroll-button-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\reroll-button-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\reroll-button-component\\\\index.js\\" "],["text","\\n"],["block",["action-button"],null,[["disabled","click"],[["get",["rerollsDisabled"]],"reroll"]],0],["text","\\n\\n"]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","  "],["open-element","h4",[]],["flush-element"],["append",["unknown",["rerolls"]],false],["close-element"],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            e.exports = a.Component.extend(l, {
                ...
                purchaseDisabled: r.computedGate("jmxSettings.LcuChampionSelect.SkinPurchaseEnabled", "meetsChampionRequirement", "meetsBaseSkinRequirement", "timeRemaining", "jmxSettings.LcuChampionSelect.SkinPurchaseTime", "inFinalizationPhase", "skinInfo.active", "invalidPriceData", (function() {
            ...
            const c = s.Ember.Object.extend({
                    ...
                    selectedChildSkin: s.Ember.computed("selectedChildSkinId", "skin.childSkins.[]", (function() {
                        return (this.get("skin.childSkins") || []).find((e => e.id === this.get("selectedChildSkinId")))
                    })),
                    showSelected: s.Ember.computed("skin.id", "skinCarousel.selectedSkinId", "selectedChildSkin", (function() {
                        return this.get("skinCarousel.selectedSkinId") === this.get("skin.id") || this.get("selectedChildSkin")
                    })),
                    selectedChromaStyle: s.Ember.computed("selectedChildSkin.colors", (function() {
                ...
                m = s.Ember.Object.extend({
                    skin: null,
                    skinCarousel: null,
                    isViewed: s.Ember.computed("skin.id", "skinCarousel.viewSkin.id", "skinCarousel.viewSkin.parentSkinId", (function() {
            ...
            e.exports = s.Ember.Component.extend(l, {
                ...
                isFlyoutOpen: !1,
                init: function() {
                    this._super(...arguments), this.set("skinCarouselItems", new s.Ember.A);
                ...
                inFinalizationPhase: s.Ember.computed.alias("timer.inFinalizationPhase"),
                currentMapChromaPath: s.Ember.computed.alias("map.assets.champ-select-flyout-background"),
                largeAreaAnimationsEnabled: s.Ember.computed.readOnly("uxSettings.largeAreaAnimationsEnabled"),
                skinPips: s.Ember.computed("carouselSkins.[]", (function() {
                    const e = this.get("carouselSkins");
                    return e && e.length ? s.Ember.A(e.map((e => m.create({
                        skin: e,
                        skinCarousel: this
                    })))) : []
                })),
                ...
                sanitizedSkinName: s.Ember.computed("viewSkin", "championName", (function() {
                    let e = this.get("viewSkin.name") || "";
                    const t = this.get("championName");
                    return e = e.replace(" " + t, ""), e = e.replace(t, ""), e
                })),
                viewSkinIndex: s.Ember.computed("carouselSkins.[]", "viewSkin.parentSkinId", "viewSkin.id", (function() {
                    const e = this.get("viewSkin.parentSkinId") || this.get("viewSkin.id"),
                        t = this.get("carouselSkins") || [];
                    return this.getIndexBySkinId(t, e)
                })),
                disabledChromas: s.Ember.computed.readOnly("jmxSettings.DisabledChampionSkins.DisabledChromas"),
                ...
                setSkinCarouselItems: s.Ember.observer("viewSkin.id", "isShowingGrid", "carouselSkins.@each.unlocked", "disabledChromas", (function() {
                    ...
                    if (t && e > -1) {
                        ...
                        for (let r = -2; r < this.maxSkinsToDisplay + 2; r++) {
                            ...
                            let h, g, f = !u && s.Ember.get(m, "childSkins.length");
                            f && d && (f = void 0 !== m.childSkins.find((e => !d.includes(e.id)))), m?.productType === a.skinProductTypes.kTieredSkin && (h = m.childSkins?.reduce(((e, t) => t.ownership.owned ? t : e), m.childSkins[0]), g = h?.tilePath), this.get("skinCarouselItems").objectAt(l).setProperties({
                                placeholder: u,
                                offsetClass: "skin-carousel-offset-" + p,
                                offset: p,
                                hasChildSkins: f,
                                alternativeTilePath: g,
                                isTieredSkin: m?.productType === a.skinProductTypes.kTieredSkin,
                                skin: m,
                                selectedChildSkinId: this.parentSkinIdToSelectedChromaIdMap[m.id],
                                unlocked: m.unlocked,
                                unclickable: this._isOffsetHidden(r, !0, e),
                                faded: this._isOffsetHidden(p, !i, e)
                            })
                        }
                        i && (this.set("willTransition", !0), this.runTask((() => {
                            this._resolveSkinCarouselTransition(e)
                        }), 1))
                    }
                })),
                _resolveSkinCarouselTransition: function(e) {
                    this.set("willTransition", !1), (this.get("skinCarouselItems") || s.Ember.A()).forEach((function(t, n) {
                        const i = n - 2;
                ...
                hideChromaFlyout: function() {
                    r.isActive() && this.$(".skin-selection-item .chroma-button").each(((e, t) => {
            ...
            n(199), e.exports = s.Component.extend({
                classNames: ["champion-skin-name"],
                layout: n(200),
                skinName: o.throttled("skin.name", 300),
                showChampionChestAvailable: s.computed("skin.championId", "shouldShowChestAvailability", "championChestAvailabilityMap", (function() {
            ...
            n(205), e.exports = s.Ember.Component.extend(r, {
                ...
                handleSkinCarouselSkins: function(e) {
                    this.set("carouselSkins", (e || []).filter((e => !e.disabled)));
                    const t = this.get("viewSkin.id") ? this.get("viewSkin.id") : this.get("selectedSkinId");
                    let n = this.getSkin(t);
                    n?.productType === a.skinProductTypes.kTieredSkin && (n = this.getMostProgressedSkin(n)), this.setViewSkin(n), this.updateParentSkinIdToSelectedChromaIdMap(n)
                },
                ...
                requestSetSkin: function(e) {
                    o.default.ajax({
                        ...
                        this.recordDidRequestSucceed && this.recordDidRequestSucceed(!0), s.Telemetry.endTracingEvent("champ-select-skin-select")
                    })).catch((e => {
                        this.recordDidRequestSucceed && this.recordDidRequestSucceed(!1, e)
                    }))
                },
                ...
                setSkin: function(e) {
                    this.get("allowSkinSelection") && (s.Telemetry.startTracingEvent("champ-select-skin-select"), this.setViewSkin(e), e.unlocked && e.id !== this.get("selectedSkinId") && this.debounceTask("requestSetSkin", e, 500))
                },
                getMostProgressedSkin: function(e) {
                    return e?.childSkins?.reduce?.(((e, t) => t.ownership.owned ? t : e), e.childSkins[0])
                },
                actions: {
                    setSkinThroughChromaModal: function(e) {
                        e.productType === a.skinProductTypes.kTieredSkin ? e = this.getMostProgressedSkin(e) : this.updateParentSkinIdToSelectedChromaIdMap(e), this.setSkin(e)
                    },
                    setSkinThroughScroll: function(e) {
                        e = e.productType === a.skinProductTypes.kTieredSkin ? this.getMostProgressedSkin(e) : this.getSelectedChromaForSkin(e), this.setSkin(e)
                    }
                }
            })
        }, (e, t, n) => {
            ...
            const {
                RunMixin: a
            } = i.EmberAddons.EmberLifeline, r = i.UiKitPlugin.getTemplateHelper(), l = "championTradeToggleTooltipSeen", c = ".summoner-object.left:not(.is-self) .champion-icons .svg-icon", m = "positionSwapToggleTooltipSeen", u = ".position-swap-button";
            e.exports = i.Ember.Component.extend(a, {
                layout: n(209),
                classNames: ["summoner-array"],
                classNameBindings: ["isLeft:your-party:enemy-party", "showChestAvailabilityHintedPortraits:show-chest-availability-hinted-portraits", "shouldAlignTop:align-summoners-top"],
                ...
                didUpdateAttrs: function() {
                    this._super(...arguments), this.tooltipSettingsReady && this.shouldShowReportAndMutingTooltip() && this.maybeShowReportAndMutingTooltip(), this.tooltipSettingsReady && this.shouldShowChampTradeTooltip() && this.initChampTradeTooltip(), this.tooltipSettingsReady && this.get("pickOrderSwappingEnabled") && this.shouldShowPickOrderSwapTooltip() && this.initPickOrderSwapTooltip()
                },
                shouldShowChampTradeTooltip: function() {
                    return this.get("isLeft") && !this.champTradeTooltipShown && this.get("timer.inFinalizationPhase") && !this.get("isCustomGame") && !this.get("showPositionAssignment") && this.get("ChampTradingTooltipEnabled") && this.get("team.length") > 1
                },
                shouldShowPickOrderSwapTooltip: function() {
                    return this.get("isLeft") && !this.positionSwapTooltipShown && this.get("timer.inBanPickPhase") && !this.get("isCustomGame") && !this.get("showPositionAssignment") && this.get("PickOrderSwappingTooltipEnabled") && this.get("team.length") > 1
                },
                ...
                initChampTradeTooltip: function() {
                    return (0, s.getAccountSetting)(l).then((e => {
                        ...
                        if (this.assignChampTradeTooltip(), this.champTradeTooltipShown = !0, !t) return this.showChampTradeTooltip(), (0, s.saveAccountSetting)(l, !0)
                    }))
                },
                ...
                assignChampTradeTooltip: function() {
                    ...
                    const t = document.createElement("lol-uikit-tooltip"),
                        n = r.contentBlockTooltipAttention(this.get("tra.champ_trade_new_tooltip")),
                        s = document.createElement("div");
                    s.innerHTML = this.get("tra.champ_trade_tooltip_header"), s.className = ".champ-trade-tooltip-title", this.set("tooltipTitleElement", s), n.prepend(s), t.appendChild(n), i.TooltipManager.assign(e, t, null, {
                        type: "attention",
                        targetAnchor: {
                            x: "right",
                            y: "center"
                ...
                initPickOrderSwapTooltip: function() {
                    return (0, s.getAccountSetting)(m).then((e => {
                        const t = Boolean(e && e.value);
                        if (this.assignPickOrderSwapTooltip(), this.positionSwapTooltipShown = !0, !t) return this.showPickOrderSwapTooltip(), (0, s.saveAccountSetting)(m, !0)
                    }))
                },
                ...
                assignPickOrderSwapTooltip: function() {
                    ...
                    this.set("tooltipContainerElement", e);
                    const t = document.createElement("lol-uikit-tooltip"),
                        n = r.contentBlockTooltipAttention(this.get("tra.position_swap_new_tooltip")),
                        s = document.createElement("div");
                    s.innerHTML = this.get("tra.pick_order_swap_tooltip_header"), s.className = ".pick-order-swapping-tooltip-title", this.set("tooltipTitleElement", s), n.prepend(s), t.appendChild(n), i.TooltipManager.assign(e, t, null, {
                        type: "attention",
                        targetAnchor: {
                            x: "right",
                            y: "center"
                ...
                maybeShowReportAndMutingTooltip() {
                    return (0, s.getAccountSetting)("reportAndMutingTooltipShown").then((e => {
                        if (this._reportAndMutingTooltipShown = !0, !e) return window.requestAnimationFrame((() => this.showReportAndMutingTooltip())), (0, s.saveAccountSetting)("reportAndMutingTooltipShown", !0)
                    }))
                },
                shouldShowReportAndMutingTooltip: function() {
                    const e = this.get("timer.totalTimeInPhase") / 1e3 - this.get("timer.timeRemaining") > this.get("timeBeforeShowingReportingTooltipSeconds");
                    return this.get("isLeft") && !this._reportAndMutingTooltipShown && (this.get("timer.inBanPickPhase") || this.get("timer.inPlanningPhase") || this.get("timer.inFinalizationPhase")) && e && !this.get("isCustomGame") && !this.get("showPositionAssignment") && this.get("team.length") > 1 && this.get("jmxSettings.LcuChampionSelect.ChampSelectMutingEnabled") && this.get("jmxSettings.LcuChampionSelect.ReportingEnabled")
                },
                showReportAndMutingTooltip: function() {
                    const e = this.element.querySelector(".summoner-object.left:not(.is-self) .summoner-overlay-buttons-container");
                    if (!e) return;
                    const t = document.createElement("lol-uikit-tooltip");
                    t.appendChild(r.contentBlockTooltipAttention(this.get("tra.csr_report_and_mute_in_cs_tooltip")));
                ...
                timeBeforeShowingReportingTooltipSeconds: i.Ember.computed("jmxSettings.LcuChampionSelect.TimeBeforeShowingReportingTooltipSeconds", (function() {
                    const e = this.get("jmxSettings.LcuChampionSelect.TimeBeforeShowingReportingTooltipSeconds");
                    return e || o.DURATIONS.timeBeforeShowingReportingTooltipSec
                })),
                timeBeforeHidingReportingTooltipSeconds: i.Ember.computed("jmxSettings.LcuChampionSelect.TimeBeforeHidingReportingTooltipSeconds", (function() {
                    const e = this.get("jmxSettings.LcuChampionSelect.TimeBeforeHidingReportingTooltipSeconds");
                ...
                pickOrderSwappingEnabled: i.Ember.computed("timer.inPlanningPhase", "timer.inBanPickPhase", "timerDisabledPickOrderSwap", "showPositionAssignment", "currentSummoner.isDonePicking", (function() {
                    return (this.get("timer.inPlanningPhase") || this.get("timer.inBanPickPhase")) && !this.get("timerDisabledPickOrderSwap") && !this.get("showPositionAssignment") && !this.get("currentSummoner.isDonePicking")
                })),
                ...
                hideSummonerTimer: i.Ember.computed("showPositionAssignment", "isPlayingSimulBanOutro", "timer.inBanPickPhase", "timer.inPlanningPhase", "inPlanningButNotMyTeam", "inBanPickSimulButNotMyTeam", "thisTeamHasNoActiveAction", "simulActAndMyActionComplete", (function() {
                    return this.get("showPositionAssignment") || this.get("isPlayingSimulBanOutro") || !(this.get("timer.inBanPickPhase") || this.get("timer.inPlanningPhase")) || this.get("inPlanningButNotMyTeam") || this.get("inBanPickSimulButNotMyTeam") || this.get("thisTeamHasNoActiveAction") || this.get("simulActAndMyActionComplete") || !!this.get("gameModeSubteamData")
                })),
                shouldAlignTop: i.Ember.computed("summoners.length", "summoners.@each.isPlaceholder", (function() {
                    return this.get("summoners").filter((e => !e.isPlaceholder)).length > o.STANDARD_MAX_TEAM_SIZE
                }))
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                DomMixin: r
            } = i.EmberAddons.EmberLifeline, l = "COMMS_ABUSE_TEXT", c = [l, "SABOTAGING_TEAM", "DISRESPECTFUL_BEHAVIOR", "OTHER"], m = n(212)[0][1], u = i.UiKitPlugin.getContextMenuManager();
            e.exports = i.Ember.Component.extend(r, o.default, {
                ...
                init: function() {
                    this._super(...arguments), this._contextMenuCloseListener = () => this.set("isContextMenuOpened", !1), u.addCloseListener(this._contextMenuCloseListener)
                },
                willDestroyElement() {
                    this._super(...arguments), u.removeCloseListener(this._contextMenuCloseListener)
                },
                didReceiveAttrs: function() {
                    this._super(...arguments);
                ...
                reportMenuItems: i.Ember.computed("displayName", "puuid", "obfuscatedPuuid", "jmxSettings.LcuChampionSelect.ReportCategories", (function() {
                    const e = [],
                        t = this.get("jmxSettings.LcuChampionSelect.ReportCategories") || c;
                    e.push({
                ...
                actions: {
                    ...
                    showReportContextMenu() {
                        ...
                        e && e.length && (u.setCustomMenuItems(e, {
                            css: m,
                            menuClass: "champ-select-reporting-menu"
                        }), u.openAtEvent(event), this.set("isContextMenuOpened", !0))
                    },
                    submitReport(e) {
                        ...
                        t.sendPlayerReport(s).then((() => {
                            this.recordDidRequestSucceed && this.recordDidRequestSucceed(!0), this.get("chatPublisherService").sendChatMessage(i), this.set("hasReported", !0)
                        }), (e => {
                            this.recordDidRequestSucceed && this.recordDidRequestSucceed(!1, e)
            ...
            e.exports = s.Ember.Component.extend({
                ...
                showIntroAnimation: s.Ember.computed("summoner.isPlaceholder", "isLeft", "showPositionAssignment", (function() {
                    return this.get("isLeft") && !this.get("summoner.isPlaceholder") && this.get("showPositionAssignment")
                })),
                ...
                summonerHasActiveSwap: s.Ember.computed("activeSwap", "summoner.swapId", (function() {
                    const e = this.get("activeSwap");
                    return e && e.id && -1 !== e.id && e.id === this.get("summoner.swapId")
                })),
                summonerHasActiveTrade: s.Ember.computed("activeTrade", "summoner.tradeId", (function() {
                    const e = this.get("activeTrade");
                    return e && e.id && -1 !== e.id && e.id === this.get("summoner.tradeId")
                })),
                showPickOrderSwapButton: s.Ember.computed("pickOrderSwappingEnabled", "summoner.showSwaps", "summoner.isDonePicking", "summonerHasActiveSwap", "isLeft", (function() {
                    return this.get("pickOrderSwappingEnabled") && this.get("summoner.showSwaps") && !this.get("summoner.isDonePicking") && this.get("isLeft") || this.get("summonerHasActiveSwap")
                })),
                showChampionTradeButton: s.Ember.computed("summoner.isSelf", "inFinalizationPhase", (function() {
                    return !this.get("summoner.isSelf") && this.get("inFinalizationPhase")
                })),
                ...
                shouldShowOverlay: s.Ember.computed("jmxSettings.LcuChampionSelect.ChampSelectMutingEnabled", "isReportingEnabled", "summoner.isSelf", "summoner.isOnPlayersTeam", "summoner.cellId", "gameModeSubteamData", (function() {
                    ...
                    const n = this._getSubteamData(this.get("gameModeSubteamData"), this.get("summoner.cellId"));
                    return n && (t &= n && n.isLocalSubteam), t
                })),
                championIconStyle: s.Ember.computed("summoner.championIconStyle", (function() {
                    return this.get("summoner.championIconStyle")
                })),
                showTeamBoostIcon: s.Ember.computed("summonerId", "boosterSummonerId", (function() {
                    return this.get("boosterSummonerId") && this.get("summonerId") === this.get("boosterSummonerId")
                })),
                showChampionChestAvailable: s.Ember.computed("shouldShowChestAvailability", "summoner.championId", "championChestAvailabilityMap", (function() {
                ...
                showSubteamSeparator: s.Ember.computed("summoner.cellId", "gameModeSubteamData", (function() {
                    const e = this.get("summoner.cellId"),
                        t = this._getSubteamData(this.get("gameModeSubteamData"), e);
                    return !!t && 0 === t.cellIds.indexOf(e)
                })),
                showSubteamIcon: s.Ember.computed("summoner.cellId", "gameModeSubteamData", (function() {
                    const e = this.get("summoner.cellId"),
                        t = this._getSubteamData(this.get("gameModeSubteamData"), e);
                    return !!t && t.cellIds.indexOf(e) === t.cellIds.length - 1
                })),
                subteamIconPath: s.Ember.computed("summoner.cellId", "gameModeSubteamData", (function() {
                    const e = this._getSubteamData(this.get("gameModeSubteamData"), this.get("summoner.cellId"));
            ...
            const {
                ...
                Telemetry: m
            } = i.default, u = i.UiKitPlugin.getFlyoutManager(), {
                RunMixin: p
            } = i.EmberAddons.EmberLifeline, d = i.UiKitPlugin.getContextualNotificationManager();
            e.exports = i.Ember.Component.extend(p, {
                ...
                didUpdateAttrs: function() {
                    ...
                    if (!t || e || this.smiteAssignmentNotificationAlreadyShown) n && this.smiteAssignmentNotification && d.remove(this.smiteAssignmentNotification);
                    else {
                ...
                filteredSpells: i.Ember.computed("spells", "requiredSummonerSpells", "disallowedSummonerSpells", (function() {
                    ...
                    return t && t.length > 0 ? this.get("spells").filter((e => !t.includes(e.id))) : this.get("spells")
                })),
                ...
                _setSpells: function(e) {
                    ...
                    (void 0 !== e.spell1Id && e.spell1Id !== t[0] || void 0 !== e.spell2Id && e.spell2Id !== t[1]) && (m.startTimer("champ-select-spell-selected"), this._sendSpellRequestData(e))
                },
                ...
                actions: {
                    onFlyoutSpellSelected(e) {
                        ...
                        o === t[0] ? (c = t[1], m = {
                            spell1Id: a
                        }, o === l && (m.spell2Id = l, c = l)) : (c = t[0], m = {
                            spell2Id: a
                        }, o === l && (m.spell1Id = l, c = l)), a === c && (m = {
                            spell1Id: t[1],
                            spell2Id: t[0]
            ...
            e.exports = i.Ember.Component.extend({
                ...
                layout: n(233),
                indexClass: i.Ember.computed("actionIndex", "isMyTeam", "hasSimultaneousBans", "gameMode", (function() {
                ...
                bannedChampIconPath: i.Ember.computed("banAction.completed", "banAction.champion", (function() {
                    return this.get("banAction.completed") ? this.get("banAction.champion.squarePortraitPath") : ""
                })),
            ...
            const o = n(1),
                ...
                r = (o.ViewportPlugin.fullScreen().getScreenRoot("rcp-fe-lol-champ-select"), o.EmberDataBinding({
                    Ember: a,
                    websocket: o.getProvider().getSocket(),
                    basePaths: {
            ...
            e.exports = r.Component.extend({
                ...
                inPlanningOrFinalization: r.computed.or("timer.inPlanningPhase", "timer.inFinalizationPhase"),
                alliedTeamActive: r.computed("alliedActiveAction", "inPlanningOrFinalization", "isTeamBuilderGame", (function() {
                    return this.get("isTeamBuilderGame") && (this.get("alliedActiveAction") || this.get("inPlanningOrFinalization"))
                })),
                enemyTeamActive: r.computed("enemyActiveAction", "inPlanningOrFinalization", "isTeamBuilderGame", (function() {
                    return this.get("isTeamBuilderGame") && (this.get("enemyActiveAction") || this.get("inPlanningOrFinalization"))
                })),
                displayAlternateTimer: r.computed.and("isHeaderExpanded", "isShowingPerksModal"),
                useBurnoutAnimation1: !0,
                burnoutBarAnimationTriggerObserver: l.observer("currentActions.[]", "isShowingPositionAssignment", (function() {
                ...
                playActionTypeTransitionSounds: l.observeChange("activeAction.type", r.on("init", (function() {
                ...
                localPlayerActive: r.computed("activeAction.actor.isSelf", "champSelectScreen", "timer.inPlanningPhase", "summoner.champion", (function() {
            ...
            n(244), e.exports = i.Ember.Component.extend({
                layout: n(245),
                ...
                tradeTooltipText: i.Ember.computed("displayName", "tradeId", "showValidTrade", "summonerToTradeChampionName", "currentSummonerChampionName", (function() {
                    return this.get("showValidTrade") ? this.get("tra.service").formatString("pregame_trade_tooltip", {
                ...
                actions: {
                    trade: function() {
                        return o.default.playSound("sfx-ui", "/fe/lol-champ-select/sounds/sfx-cs-button-trade-click.ogg"), i.Telemetry.startTracingEvent("champ-select-trade-propose"), this.set("requestInProgress", !0), s.default.ajax({
                            type: "POST",
                            url: "/lol-champ-select/v1/session/trades/" + this.get("tradeId") + "/request",
                            errorMessage: "error_could_not_request_trade"
                        }).then((() => {
                            this.recordDidRequestSucceed && this.recordDidRequestSucceed(!0), i.Telemetry.invokeWithLowProbability((function() {
                                i.Telemetry.recordNonTimingTracingEvent("champ-trade-propose-success", 1, "event")
                            }))
                        })).catch((e => {
                            this.recordDidRequestSucceed && this.recordDidRequestSucceed(!1, e), i.Telemetry.invokeWithLowProbability((function() {
                                ...
                                i.DataBinding.bindTo(i.default.getProvider().getSocket()).get("/lol-summoner/v1/current-summoner").then((function(e) {
                                    ...
                                    i.Telemetry.sendEvent("champ-trade-propose-fail", a), i.Telemetry.recordNonTimingTracingEvent("champ-trade-propose-fail", 1, "event")
                                }))
                            }))
                        })).finally((() => {
                            window.requestAnimationFrame((() => {
                                i.Telemetry.endTracingEvent("champ-select-trade-propose")
            ...
            n(247), e.exports = i.Ember.Component.extend({
                layout: n(248),
                ...
                swapTooltipText: i.Ember.computed("displayName", (function() {
                    return this.get("tra.service").formatString("pregame_swap_tooltip", {
                        actor: this.get("displayName")
                    })
                })),
                actions: {
                    swap: function() {
                        return o.default.playSound("sfx-ui", "/fe/lol-champ-select/sounds/sfx-cs-button-swap-click.ogg"), i.Telemetry.startTracingEvent("postition-swap-propose"), this.set("requestInProgress", !0), s.default.ajax({
                            type: "POST",
                            url: "/lol-champ-select/v1/session/swaps/" + this.get("swapId") + "/request",
                            errorMessage: "error_could_not_request_swap"
                        }).then((() => {
                            this.recordDidRequestSucceed && this.recordDidRequestSucceed(!0), i.Telemetry.invokeWithLowProbability((function() {
                                i.Telemetry.recordNonTimingTracingEvent("postition-swap-propose-success", 1, "event")
                            }))
                        })).catch((e => {
                            this.recordDidRequestSucceed && this.recordDidRequestSucceed(!1, e), i.Telemetry.invokeWithLowProbability((function() {
                                const t = e && e.responseText ? e.responseText : "";
                                i.DataBinding.bindTo(i.default.getProvider().getSocket()).get("/lol-summoner/v1/current-summoner").then((function(e) {
                                    ...
                                    i.Telemetry.sendEvent("postition-swap-propose-fail", a), i.Telemetry.recordNonTimingTracingEvent("postition-swap-propose-fail", 1, "event")
                                }))
                            }))
                        })).finally((() => {
                            window.requestAnimationFrame((() => {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.default = t.SWAP_STATES = t.SWAP_RESOLVED_STATES = t.SWAP_CREATED_STATES = t.SWAP_CLEAR_TIMEOUT_MS = t.SWAP_CANCEL_TIMEOUT_MS = t.SWAP_ACCEPTED_TIMEOUT_MS = void 0;
            var i = function(e, t) {
                    if (!t && e && e.__esModule) return e;
                    if (null === e || "object" != typeof e && "function" != typeof e) return {
                        default: e
            ...
            const d = "session/swaps",
                ...
                f = "decline",
                S = "clear";
            var b = i.Ember.Component.extend(l, {
                layout: n(251),
                init: function() {
                    this._super(...arguments), this.audioPool = o.default, this.set("isAnimated", !0)
                },
                didRender: function() {
                    ...
                    this.prevSwapState !== e.state ? (this.cancelTask(this._swapCancelTimeout), this.cancelTask(this._swapClearTimeout), e.state === c.SENT && this.scheduleSwapCancel(e.id), u.includes(e.state) && (this.set("isDisplayed", !0), this.setSummonerName(this.get("swapRequestorIndex"), "requestor"), this.setSummonerName(this.get("swapResponderIndex"), "responder"), this.positionSwapDialog(this.get("swapOtherSummonerIndex"))), m.includes(e.state) && this.scheduleSwapClear(e.id, e.state), this.playSwapSfx(e.state)) : t && t[this.get("swapRequestorIndex")] && t[this.get("swapResponderIndex")] && (t[this.get("swapRequestorIndex")].isDonePicking || t[this.get("swapResponderIndex")].isDonePicking) && this.swapServiceCall(e.id, d, h), this.prevSwapState = e.state
                },
                swapRequestorIndex: i.Ember.computed("swap.requestorIndex", "gameModeSubteamData", (function() {
                    return this.getCellIndex(this.get("swap.requestorIndex"), this.get("gameModeSubteamData"))
                })),
                swapResponderIndex: i.Ember.computed("swap.responderIndex", "gameModeSubteamData", (function() {
                    return this.getCellIndex(this.get("swap.responderIndex"), this.get("gameModeSubteamData"))
                })),
                swapOtherSummonerIndex: i.Ember.computed("swap.otherSummonerIndex", "gameModeSubteamData", (function() {
                    return this.getCellIndex(this.get("swap.otherSummonerIndex"), this.get("gameModeSubteamData"))
                })),
                getCellIndex(e, t) {
                    if (!t) return e;
                ...
                setSummonerName: function(e, t) {
                    ...
                    n && e >= 0 && n[e] && n[e].displayName && this.set(t, n[e].displayName)
                },
                ...
                playSwapSfx: function(e) {
                    ...
                    switch (e) {
                        case c.SENT:
                        case c.RECEIVED:
                            t = "/fe/lol-champ-select/sounds/sfx-cs-notif-swaprequest-rcvd.ogg";
                            break;
                        case c.ACCEPTED:
                ...
                pickOrderSwapTimeRemaining: i.Ember.computed("pickOrderSwapDisabledConfigurationInSeconds", "timeRemaining", "inPlanningPhase", (function() {
                    return this.get("inPlanningPhase") ? p : Math.min(1e3 * (this.get("timeRemaining") - this.get("pickOrderSwapDisabledConfigurationInSeconds")), p)
                })),
                scheduleSwapCancel: function(e) {
                    const t = this.get("pickOrderSwapTimeRemaining") > 0 ? this.get("pickOrderSwapTimeRemaining") : 0;
                    this._swapCancelTimeout = this.runTask((() => this.swapServiceCall(e, d, h)), t)
                },
                scheduleSwapClear: function(e, t) {
                    const n = t === c.ACCEPTED ? 200 : 1700;
                    this._swapClearTimeout = this.runTask((() => (this.set("isDisplayed", !1), this.swapServiceCall(e, "ongoing-swap", S))), n)
                },
                showAcceptSwapButton: i.Ember.computed.equal("swap.state", c.RECEIVED),
                ...
                swapMessageString: i.Ember.computed("swap.state", "swapWaitingString", "swapCanceledString", "swapDeclinedString", "swapErrorString", (function() {
                ...
                swapDeclinedString: i.Ember.computed("responder", "tra.pregame_swap_declined", (function() {
                    return this.get("tra.service").formatString("pregame_swap_declined", {
                        actor: this.get("responder")
                    })
                })),
                swapWaitingString: i.Ember.computed("swap.initiatedByLocalPlayer", "requestor", "responder", "tra.pregame_swap_requested", "tra.pregame_swap_waiting", (function() {
                    const e = this.get("swap.initiatedByLocalPlayer"),
                        t = this.get("requestor"),
                        n = this.get("responder");
                    return e ? this.get("tra.service").formatString("pregame_swap_waiting", {
                        actor: n
                    }) : this.get("tra.service").formatString("pregame_swap_requested", {
                        actor: t
                    })
                })),
                swapBusyString: i.Ember.computed("responder", "tra.pregame_swap_error", (function() {
                ...
                actions: {
                    acceptSwap: function(e) {
                        return i.Telemetry.startTracingEvent("champ-select-swap-accept"), this.swapServiceCall(e, d, g).finally((() => {
                            window.requestAnimationFrame((() => {
                    ...
                    closeSwap: function(e, t) {
                        return t === c.SENT ? this.swapServiceCall(e, d, h) : t === c.RECEIVED ? this.swapServiceCall(e, d, f) : void 0
                    }
                }
            });
            t.default = b
            ...
            const s = i.Ember.Component.extend({
                ...
                contextWardSkin: i.Ember.computed("hoveredWardSkin", "selectedWardSkin", (function() {
                    return this.get("hoveredWardSkin") || this.get("selectedWardSkin")
                })),
                imageStyle: i.Ember.computed("map.assets.champ-select-flyout-background", (function() {
                    return 'background-image: url("' + this.get("map.assets.champ-select-flyout-background") + '")'
                })),
                actions: {
                    onFlyoutWardHover(e) {
            ...
            e.exports = i.Ember.Component.extend({
                ...
                isFlyoutOpen: !1,
                didUserChangeItem: !1,
                flyoutImageStyle: i.Ember.computed("map.assets.champ-select-flyout-background", (function() {
                    return 'background-image: url("' + this.get("map.assets.champ-select-flyout-background") + '")'
                })),
                wardSkinDisabledTooltipText: i.Ember.computed("isDonePicking", (function() {
                    return this.get("isDonePicking") ? this.get("tra.ward_skin_button_disabled") : this.get("tra.ward_skin_button_disabled_not_done_picking")
                })),
                init: function() {
                    this._super(...arguments);
                    this.set("flyoutOptions", {
                ...
                actions: {
                    toggleFlyout(e) {
                        const t = this.get("wardSkins").indexOf(e.selectedItem); - 1 === t ? this.set("isFlyoutOpen", !1) : (l.repositionCaret(0), this.get("isFlyoutOpen") || o.default.playSound(s.SFX_CHANNEL, `${s.SOUNDS_PATH}/sfx-cs-spells-open.ogg`), this.set("wardSkinIndex", t), this.set("isFlyoutOpen", !this.get("isFlyoutOpen")))
                    },
                    onWardSkinConfirmed(e) {
                        i.Ember.get(e, "locked") || (i.Telemetry.startTimer("champ-select-ward-skin-selected"), i.Telemetry.sendEvent("champ-select-ward-skin-selected"), o.default.playSound(s.SFX_CHANNEL, `${s.SOUNDS_PATH}/sfx-cs-ward-select.ogg`), this.get("useLoadouts") ? this.get("loadoutsService").setWardSkinViaLoadouts(e, this.get("accountLoadout.id"), this.recordDidRequestSucceed) : this.setWardSkinViaPlatform(e), this.set("isFlyoutOpen", !1), this.set("didUserChangeItem", !0))
                    },
                    afterUserChangedItemAnimation() {
                        this.set("didUserChangeItem", !1)
                    }
            ...
            e.exports = i.HTMLBars.template({
                id: "HW1Qi5h0",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\missions-tracker-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\missions-tracker-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\missions-tracker-component\\\\index.js\\" "],["text","\\n"],["block",["if"],[["get",["missionsButtonEnabled"]]],null,0]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","  "],["append",["unknown",["missions-button"]],false],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                RunMixin: r
            } = s.EmberAddons.EmberLifeline, l = new Set(["champion-ban-vo", "champion-pick-vo", "champion-stinger-sfx"]);
            var c = s.Ember.Service.extend(r, {
                ...
                willDestroy() {
                    this._super(...arguments), this._champSelectBinding.unobserve("/v1/sfx-notifications", this), this.stopAllAudio()
                },
                initDataBindings() {
                    this._champSelectBinding = (0, s.DataBinding)("/lol-champ-select", (0, s.getProvider)().getSocket()), this._champSelectBinding.observe("/v1/sfx-notifications", this, this.handleSfxNotifications.bind(this))
                },
                ...
                playChampSelectSfx(e) {
                    const {
                        ...
                        path: i,
                        playOptions: s
                    } = o.soundOptionsByEventType[n];
                    this._sfxTimeoutByPath[i] = this.runTask((() => {
                        this.audioPool.playSound(o.defaultSfxChannel, i, s), delete this._sfxTimeoutByPath[i]
                    }), t)
                },
                playChampionSfx(e) {
                    const {
                        ...
                        channelName: s,
                        playOptions: a
                    } = o.soundOptionsByEventType[n], r = this.getChampVoChannel(s);
                    this._sfxTimeoutByPath[t] = this.runTask((() => {
                        a.shouldStopChannelAudio && this.stopChannelAudio(r), r.playSound(t, a), delete this._sfxTimeoutByPath[t]
                    }), i)
                },
            ...
            var i = n(1),
                s = i.Ember.Service.extend({
                    init: function() {
                        this._super(...arguments), this.champSelectBinding = (0, i.DataBinding)("/lol-champ-select", (0, i.getProvider)().getSocket()), this.champSelectBinding.observe("/v1/pickable-champion-ids", this, this.handlePickableChampionIds), this.champSelectBinding.observe("/v1/bannable-champion-ids", this, this.handleBannableChampionIds)
                    },
            ...
            var l = a.Service.extend({
                ...
                updateLoadout: function({
                    ...
                    s.default.ajax({
                        ...
                        i && i(!1, e), this.isDestroying || this.isDestroyed || this.set("setSelectedError", !0)
                    })).then((() => {
                ...
                createNewAccountLoadout: function({
                    ...
                    s.default.ajax({
                        ...
                        n && n(!1, e), this.isDestroying || this.isDestroyed || this.set("setSelectedError", !0)
                    })).then((() => {
            ...
            var i, s = n(1),
                o = n(60),
                a = (i = n(66)) && i.__esModule ? i : {
                    default: i
                },
                r = n(271);
            var l = s.Ember.Service.extend({
                init: function() {
                    this._super(...arguments), this.binding = s.DataBinding.bindTo((0, s.getProvider)().getSocket()), this.binding.observe("/lol-inventory/v2/inventory/CHAMPION_SKIN", this, this.handleSkinInventoryUpdate), this.binding.observe("/lol-gameflow/v1/session", this, this.handleGameflowSessionUpdate)
                },
                getSkinPurchaseCallback(e) {
                    return () => {
                        s.logger.trace(`Skin purchase successful. Setting last purchased skin to: ${e}`), this._lastPurchasedSkinId = e
                    }
                },
                openPAWModal: function(e, t) {
                    ...
                    if (e && e.tags && e.tags.includes(o.QUEST_SKIN_TAG)) {
                        ...
                        s.PurchaseAnywhereApi.createPawTemplateModalAsync(e.offerId, t, o.CHAMP_SELECT_PAW_SOURCE).then((() => {
                            s.PurchaseAnywhereApi.getBaseSkinLineData(e.offerId).then((e => {
                                e.onPurchaseComplete = n, s.PurchaseAnywhereApi.populatePawTemplateModal(e)
                            }))
                        }))
                    } else s.PurchaseAnywhereApi.createPAWModal({
                        itemId: e.itemId,
                        inventoryType: r.PAW.INVENTORY_TYPES.CHAMPION_SKIN
                    }, o.CHAMP_SELECT_PAW_SOURCE, r.PAW.MODAL_TYPES.CHROMA_MODAL, null, n)
                },
                handleSkinInventoryUpdate: function(e) {
                    if (this.gameflowPhase === o.GAMEFLOW_PHASE_CHAMP_SELECT && this._lastPurchasedSkinId) {
                        const t = (e || []).find((e => e.itemId === this._lastPurchasedSkinId));
                        return t ? this.updateInventoryAndSelectSkin(t.itemId) : (s.logger.trace(`Inventory update did not contain skin that was purchased in champ select ${this._lastPurchasedSkinId}`), this.updateSimpleInventory())
                    }
                },
                handleGameflowSessionUpdate: function(e) {
                    ...
                    t !== o.GAMEFLOW_PHASE_CHAMP_SELECT && (this._lastPurchasedSkinId = void 0), this.gameflowPhase = t
                },
                ...
                updateSimpleInventory: function() {
                    return s.logger.trace("Updating inventory."), this.binding.post("/lol-champ-select/v1/session/simple-inventory")
                },
                setSkin: function(e) {
            ...
            var i = n(1),
                s = i.Ember.Service.extend({
                    ...
                    getSummonerInfo: function(e) {
                        return e ? this.summonerInfoById.has(e) ? Promise.resolve(this.summonerInfoById.get(e)) : this._fetchSummonerInfo(e) : Promise.resolve({})
                    },
                    _fetchSummonerInfo: function(e) {
                        return (0, i.DataBinding)("/lol-summoner").get(`/v1/summoners/${e}`).then((t => {
                            if (!t) return {
                                summonerName: void 0,
                                gameName: void 0,
                                tagLine: void 0,
            ...
            e.exports = i.HTMLBars.template({
                id: "nI8pjM0O",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\templates\\\\application.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["append",["helper",["champ-select-root"],null,[["model"],[["get",["model"]]]]],false],["text","\\n\\n"],["append",["unknown",["outlet"]],false],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const i = n(1).Ember;
            e.exports = i.HTMLBars.template({
                id: "gk3PsZAA",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\templates\\\\index.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }],
        t = {};
