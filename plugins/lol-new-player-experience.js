(() => {
    var e = [, e => {
            ...
            e.exports = class {
                constructor(e) {
                    this.screenRoot = e, this.isShowing = !1, this.application = null, this.binding = d
                }
                show() {
                    d.get(m).then((e => {
                ...
                hide() {
                    this.screenRoot && this.isShowing && (a.logger.trace("NPE: Releasing new player experience viewport."), this.screenRoot.release(), this.isShowing = !1, this._deleteParty(), a.Navigation.show(), o.default.hideNewPlayerTutorial(), this.screenRoot.getElement().removeChild(this.application.domNode), this.application.onRemove(), this.application = null, this.binding.unobserve(p, this))
                }
                _addFirstTimeNPE() {
                ...
                _addNewPlayerExperience() {
                    !this.isShowing && this.screenRoot && (a.logger.trace("NPE: Bumping new player experience viewport."), this.screenRoot.bump(), this.isShowing = !0, (0, s.default)((e => e.hasSeenTutorialPath = !0)), a.Navigation.hide(), o.default.showNewPlayerTutorial(), a.Telemetry.invokeWithLowProbability((() => {
                ...
                _playFirstTutorial() {
                    ...
                    return new Promise(((t, n) => {
                        this.binding.observe(p, e, (a => {
                            a && 0 !== a.length && (this.binding.unobserve(p, e), l.TutorialLauncher.playTutorial(a[0]).then((() => {
            ...
            e.exports = a.Ember.Service.extend(i, {
                tutorials: null,
                init() {
                    this._super(...arguments), this.binding = a.dataBinding.bindTo(a.socket), this.initObservers()
                },
                willDestroy() {
                    this._super(...arguments), this.binding.unobserve("/lol-npe-tutorial-path/v1/tutorials", this)
                },
                initObservers() {
                    this.binding.observe("/lol-npe-tutorial-path/v1/tutorials", this, (e => {
                        if (e && !this.isDestroying && !this.isDestroyed && !this.isTutorialsEqual(e)) {
                            for (let t = 0; t < e.length; ++t) e[t].isCard = "CARD" === e[t].type, e[t] = a.Ember.Object.create(e[t]);
            ...
            "use strict";
            var a, i = n(1),
                o = (a = n(23)) && a.__esModule ? a : {
                    default: a
                },
                l = n(24);
            n(25), e.exports = i.Ember.Component.extend({
                ...
                actions: {
                    playTutorial: function() {
                        ...
                        l.TutorialLauncher.playTutorial(e), o.default.logButtonClick("launch_tutorial", e.queueId)
                    },
            ...
            e.exports = a.Ember.Component.extend({
                ...
                playButtonEnabled: a.Ember.computed("isTutorialDataReady", "isNotInGameFlow", "isReconnecting", "selectedTutorialIsCard", "selectedTutorialPlayable", "isInQueue", "gameflowService.isInBasicTutorial", "optimisticLock", "patcherService.isPlayable", (function() {
                    ...
                    return t && c ? this.set("exitButtonDisabled", null) : this.set("exitButtonDisabled", "disabled"), o || i || t && c ? this.set("playButtonCloseDisabled", null) : this.set("playButtonCloseDisabled", "disabled"), e && n && (t || a) && l && !s && !r && c
                })),
                playButtonLocText: a.Ember.computed("isReconnecting", "isInQueue", "isInGame", "isInEog", "patcherService.isPlayable", (function() {
                    ...
                    return e ? l = "tra.npe_tutorial_path_button_text_RECONNECT" : t ? l = "tra.npe_tutorial_path_button_text_IN_GAME" : a ? l = "tra.npe_tutorial_path_button_text_IN_QUEUE" : o ? l = "tra.npe_tutorial_path_button_text_CONCLUDING" : n || i || (l = "tra.npe_tutorial_path_button_text_PATCHING"), this.get(l)
                })),
            ...
            e.exports = a.Ember.Component.extend({
                ...
                triggerTutorialRewardCelebration(e) {
                    ...
                    a.Ember.run.later((() => {
                        o.data.nextButtonEnabled || (o.data.nextButtonEnabled = !0, a.VignetteCelebrationManager.update(o))
                    }), 3600)
                },
                exitTutorialScreen() {
                ...
                actions: {
                    ...
                    onRightArrowClicked() {
                        const e = this.get("selectedIndex"),
                            t = this.get("tutorials");
                        t && e !== t.length - 1 && (a.tutorialSounds.getSound("MODULE_CLICKED").play(), this.setSelected(e + 1))
                    },
            ...
            n(38), e.exports = i.Ember.Component.extend({
            ...
            n(41), e.exports = i.Ember.Component.extend({
            ...
            "use strict";
            var a = n(1);
            n(48), e.exports = a.Ember.Component.extend({
                layout: n(49),
            ...
            e.exports = a.HTMLBars.template({
                id: "S8fH3sww",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_23\\\\LeagueClientContent_Release\\\\15680\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-new-player-experience\\\\src\\\\components\\\\missions-tracker-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_23\\\\LeagueClientContent_Release\\\\15680\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-new-player-experience\\\\src\\\\components\\\\missions-tracker-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_23\\\\LeagueClientContent_Release\\\\15680\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-new-player-experience\\\\src\\\\components\\\\missions-tracker-component\\\\index.js\\" "],["text","\\n"],["block",["if"],[["get",["missionsButtonEnabled"]]],null,0]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","  "],["append",["unknown",["missions-button"]],false],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
