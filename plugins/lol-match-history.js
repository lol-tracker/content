(() => {
    var e = [, e => {
            ...
            var n, s = (n = a(1)) && n.__esModule ? n : {
                default: n
            };
            class l {
                constructor() {
                    const e = s.default.getProvider();
                    this.tra = e.get("rcp-fe-lol-l10n").tra().overlay("/fe/lol-l10n/trans.json").overlay("/fe/lol-match-history/trans.json");
                    const t = a(3);
            ...
            class o {
                ...
                displayMatchSummary(e = {}) {
                    l.Telemetry.startTracingEvent("profile-match-history-rendered"), new Promise((e => {
                        ...
                        t(this._provider, this._traService, a, e.rootElement).then((t => e.matchHistorySection.component = t))
                    }))
                }
                hideMatchSummary(e = {}) {
                    e.matchHistorySection.component && e.rootElement && (e.rootElement.removeChild(e.matchHistorySection.component.domNode), e.matchHistorySection.component.componentPromise.then((e => e.app.destroy())), e.matchHistorySection.component = null)
                }
            }
            ...
            e.exports = function(e, t, i, o) {
                return n.logger.trace("Creating Match Summary Ember application"), l = o, n.EmberApplicationFactory.setFactoryDefinition({
                    ...
                    RenderTelemetrySenderComponent: n.SharedEmberComponents.RenderTelemetrySenderComponent,
                ...
                }), i ? n.logger.trace(`Updating match summary summoner ID to ${i}`) : (n.logger.trace("Updating match summary without summoner ID"), i = !1), n.Ember.RSVP.hash({
            ...
            var n = a(1),
                s = a(6);
            const l = n.Ember.Object.extend(s.DataBindingMixin, s.FixDataBindingMixin, {
                    champions() {
                        return this.retrieveData("api.gameData", "/assets/v1/champion-summary.json").then((e => this._indexEntities(e)))
                    },
                    championsByAlias() {
                        return this.retrieveData("api.gameData", "/assets/v1/champion-summary.json").then((e => e.reduce(((e, t) => e.set(t.alias, t)), n.Ember.Map.create())))
                    },
                    tftChampionsByAlias() {
                        return this.retrieveData("api.gameData", "/assets/v1/tftchampions.json").then((e => e.reduce(((e, t) => t.name ? e.set(t.name.toLowerCase(), t) : e.set(t.character_id.toLowerCase(), t)), n.Ember.Map.create())))
                    },
                    tftTraitsById() {
                        return this.retrieveData("api.gameData", "/assets/v1/tfttraits.json").then((e => e.reduce(((e, t) => e.set(t.trait_id.toLowerCase(), t)), n.Ember.Map.create())))
                    },
                    ...
                    runes() {
                        return this.retrieveData("api.gameData", "/assets/v1/perks.json").then((e => this._indexEntities(e)), (() => n.Ember.Map.create()))
                    },
                    runesStyles() {
                        return this.retrieveData("api.gameData", "/assets/v1/perkstyles.json").then((e => e.styles ? this._indexEntities(e.styles) : this._indexEntities(e)), (() => n.Ember.Map.create()))
                    },
                    maps() {
                        return this.retrieveData("api.maps", "/v2/maps").then((e => n.Ember.A(e)))
                    },
                    queues() {
            ...
            const {
                ...
                observer: h,
                computed: u
            } = n.Ember, g = "REMAKE", f = "EARLY_SURRENDER_LEAVER", y = "EARLY_SURRENDER_ACCOMPLICE", _ = "VICTORY";
            e.exports = p.extend(s.DataBindingMixin, s.FixDataBindingMixin, l.default, {
                ...
                atLeastOneMatch: u.or("atLeastOneGeneralMatch", "allTftMatchesLoaded"),
                gameCount: u("generalMatches.[]", (function() {
                    const e = this.get("generalMatches");
                    return e ? e.length : 0
                })),
                maxChampMasteryLevel: u.readOnly("platformConfig.ChampionMasteryConfig.MaxChampionLevel"),
                ...
                fullMatchHistoryUrl: u("matchHistoryWebURL", "acsAccountInfo", (function() {
                ...
                masteries: u("isThirdPersonView", "targetMasteries", "myMasteries", (function() {
                    let e;
                    return e = this.get("isThirdPersonView") ? this.get("targetMasteries") : this.get("myMasteries"), n.Lodash.keyBy(e, "championId")
                })),
                summoner: u("isThirdPersonView", "targetSummoner", "mySummoner", (function() {
                    return this.get("isThirdPersonView") ? this.get("targetSummoner") : this.get("mySummoner")
                })),
                activeMatchList: u("activeMatchListName", "generalMatches.[]", "tftMatches.[]", (function() {
                    return "general" === this.get("activeMatchListName") ? this.get("generalMatches") : this.get("tftMatches")
                })),
                championPortrait: u("participant.championId", (function() {
                    const e = this.get("participant.championId");
                    return this.get("champions").get(e)
                })),
                thirdPersonAccessibleGameQueues: u.readOnly("platformConfig.Replays.ThirdPersonAccessibleGameQueues"),
                isTftReplaysEnabled: u.readOnly("platformConfig.Replays.TftReplaysEnabled"),
                puuid: u("summoner.puuid", "session.puuid", "isThirdPersonView", (function() {
                    return this.get("isThirdPersonView") ? this.get("summoner.puuid") : this.get("session.puuid")
                })),
                augmentContainer: u("tftDefaultSet", (function() {
                    const e = this.get("tftDefaultSet");
                    return {
                ...
                didRender() {
                    this._super(...arguments), this._addGeneralReplaysButtons(), this._addTftReplayButtons()
                },
                init() {
                    this._super(...arguments), this.set("allGeneralMatches", n.Ember.A()), this.set("generalMatches", n.Ember.A()), this.set("tftMatches", n.Ember.A()), this.set("matchListTypes", n.Ember.A()), this.set("deltas", new Map)
                },
                didInsertElement() {
                    this._super(...arguments), this.set("replayButtons", n.Ember.A()), this.set("tftReplayButtons", n.Ember.A()), this._updateSummoner()
                },
                willDestroyElement() {
                    this._super(...arguments), this.destroyReplayButtons(), this.set("summonerId", ""), (0, n.dataBinding)("/lol-end-of-game", (0, n.getProvider)().getSocket()).removeObserver("/v1/state", this)
                },
                _addTftReplayButtons: function() {
                    ...
                    if (0 === e.length) {
                        ...
                        if (t.length > 0) {
                            const a = (Boolean(this.get("thirdPersonAccessibleGameQueues")) ? this.get("thirdPersonAccessibleGameQueues").split(",") : []).map((function(e) {
                                return parseInt(e, 10)
                            }));
                            this.$(".tft-player-history-accessory-game-action").toArray().forEach(((s, l) => {
                                const i = t[l];
                                if (this.get("isThirdPersonView") && !a.includes(i.json.queue_id)) return void n.logger.trace("Queue id for this game is not whitelisted, not adding replay button");
                                ...
                                o ? (this.$(s).html(o.domNode), e.push(o)) : n.logger.error("Unable to create replay button for match", i)
                            }))
                        }
                    }
                },
                _addGeneralReplaysButtons: function() {
                    ...
                    if (!(e.length > 0))
                        if (n.Replays.isGeneralReplaysEnabled() && this.get("areAllGeneralMatchesLoaded") && this.get("atLeastOneMatch")) {
                            const t = this.$(".player-history-accessory-game-action").toArray();
                            if (t.length > 0) {
                                const a = this.get("allGeneralMatches"),
                                    s = (Boolean(this.get("thirdPersonAccessibleGameQueues")) ? this.get("thirdPersonAccessibleGameQueues").split(",") : []).map((function(e) {
                                        return parseInt(e, 10)
                                    }));
                                t.forEach(((t, l) => {
                                    const i = a[l];
                                    if (this.get("isThirdPersonView") && !s.includes(i.queueId)) return void n.logger.trace("Queue id for this game is not whitelisted, not adding replay button");
                                    const o = n.Replays.createReplayButton({
                                        gameId: i.get("gameId"),
                                    ...
                                    o ? (this.$(t).html(o.domNode), e.push(o)) : n.logger.error("Unable to create replay button for match", i)
                                }))
                            }
                        } else n.logger.trace("Not adding Replay buttons"), n.logger.trace("replaysEnabled", n.Replays.isGeneralReplaysEnabled()), n.logger.trace("areAllGeneralMatchesLoaded()", this.get("areAllGeneralMatchesLoaded")), n.logger.trace("atLeastOneGeneralMatch", this.get("atLeastOneGeneralMatch"))
                },
                destroyReplayButtons() {
                    n.Lodash.forEach(this.get("replayButtons"), (e => e.destroy())), this.get("replayButtons").length = 0, n.Lodash.forEach(this.get("tftReplayButtons"), (e => e.destroy())), this.get("tftReplayButtons").length = 0
                },
                actions: {
                ...
                _updateSummoner() {
                    this.isDestroying || this.isDestroyed || this.get("api.platformConfig").get("v1/namespaces/NewMatchHistory/TftMatchHistoryEnabled").then((e => {
                        ...
                        this.get("isTftMatchHistoryEnabled") && t ? this._loadTftPlayerData(t) : this.set("tftMatchesLoading", !1)
                    })).finally((() => {
                        this.get("isThirdPersonView") ? this.get("summoner") && this._loadFriendData() : (this._loadCurrentPlayerData(this.get("session.summonerId")), this.destroyReplayButtons())
                    }))
                },
                ...
                _endOfGameStateObserver: n.Ember.on("init", (function() {
                    (0, n.dataBinding)("/lol-end-of-game", (0, n.getProvider)().getSocket()).observe("/v1/state", this, (e => {
                        e && "BeforeEndOfGame" === e.state && (this.get("generalMatchesLoading") || this.get("isThirdPersonView") || this._loadCurrentPlayerData(this.get("summoner.summonerId"), !0))
                    }))
                })),
                calculateMatchResult: function(e) {
                    const t = n.Lodash.get(e, "participant.win"),
                        a = n.Lodash.get(e, "participant.stats.gameEndedInEarlySurrender"),
                        s = n.Lodash.get(e, "participant.stats.causedEarlySurrender"),
                        l = n.Lodash.get(e, "participant.stats.earlySurrenderAccomplice"),
                        i = n.Lodash.get(e, "participant.stats.teamEarlySurrendered");
                    return a && !s && !l ? g : a && i && s ? f : a && l ? y : t ? _ : "DEFEAT"
                },
                calculateTitleClass: function(e) {
                    const t = "defeat";
                    return e === g ? "earlySurrender" : e === f || e === y ? t : e === _ ? "victory" : t
                },
                calculateMatchResultTitle: function(e) {
                    return e === g ? this.get("tra.MATCH_HISTORY_MATCH_RESULT_REMAKE") : e === f ? this.get("tra.MATCH_HISTORY_MATCH_RESULT_REMAKE_LEAVER") : e === y ? this.get("tra.MATCH_HISTORY_MATCH_RESULT_REMAKE_RESTRICTED") : e === _ ? this.get("tra.MATCH_HISTORY_MATCH_RESULT_VICTORY") : this.get("tra.MATCH_HISTORY_MATCH_RESULT_DEFEAT")
                },
                _formatChampMasteryIpXpDescription(e) {
                    const t = [];
                    return e.champMastery && t.push(e.champMastery), e.ipDelta && t.push(e.ipDelta + " " + this.get("tra.postgame_progress_ip")), e.xpDelta && t.push(e.xpDelta + " " + this.get("tra.postgame_progress_xp")), t.length > 0 ? t.join(" / ") : null
                },
                _enrichSummary(e, t, a, s) {
                    const l = this.calculateMatchResult(e);
                    let r = "";
                    if (e.gameType === o.CUSTOM_GAME_TYPE) r = this.get("tra.MATCH_HISTORY_QUEUE_MODE_CUSTOM");
                    else {
                        const t = a.get(n.Lodash.get(e, "queueId"));
                        r = n.Lodash.get(t, "detailedDescription"), r || (r = n.Lodash.get(t, "description"))
                    }
                    e.titleInfo = {
                        ...
                        creationTime: i.default.formatDate(e.gameCreation, this.get("tra.MATCH_DETAILS_GAME_CREATION_DATE_FORMAT"), this.get("tra"))
                    };
                    ...
                    if (c && c.platformDelta) {
                        ...
                        }), c.champMastery && n.Lodash.assign(e.additionalInfo, {
                            champMastery: c.champMastery.grade
                        });
                        const t = this._formatChampMasteryIpXpDescription(e.additionalInfo);
                        n.Lodash.assign(e.additionalInfo, {
                            champMasteryIpXpDesc: t
                        })
                    }
                    return e
                },
                _loadCurrentPlayerData(e, t = !1) {
                    return d.hashSettled({
                        matchListData: this.retrieveData("api.matchHistory", "/v1/products/lol/current-summoner/matches", {
                            skipCache: !0
                        }),
                        ...
                        this.get("isDestroyed") || (t || "fulfilled" === e.matchListData.state || "fulfilled" === e.deltas.state ? "fulfilled" === e.deltas.state && this._updateDeltas(e.deltas.value) : 404 === e.matchListData.reason.status || 404 === e.deltas.reason.status ? this.set("generalMatchesLoading", !1) : this.showModal({
                            type: "DialogAlert",
                            data: {
                        ...
                        }), this._updateMatches(e.matchListData.value), e.matchListData.value && e.matchListData.value.platformId && this.set("acsAccountInfo", {
                            platformId: e.matchListData.value.platformId,
                            accountId: e.matchListData.value.accountId
                        }), this._updateMatchTypeSubnavigation(), this.set("generalMatchesLoading", !1))
                    }))
                },
                _loadTftPlayerData(e, t = !1) {
                    const a = this.get("tftDefaultSet"),
                        n = a ? `/v1/products/tft/${e}/matches?begin=0&count=20&tag=${a.SetCoreName}` : `/v1/products/tft/${e}/matches?begin=0&count=20`;
                    return d.hashSettled({
                        ...
                        if ("fulfilled" !== e.tftMatchListData.state) return t || 404 === e.tftMatchListData.reason.status || this.showModal({
                            type: "DialogAlert",
                            data: {
                                contents: this.get("tra.MATCH_DETAILS_LOADING_ERROR"),
                                okText: this.get("tra.MATCH_DETAILS_LOADING_ERROR_CONFIRMATION"),
                        ...
                        }), this._updateMatchTypeSubnavigation(), void this.set("tftMatchesLoading", !1);
                        const a = this._enrichTftGames(e.tftMatchListData.value.games);
                        this.set("tftMatches", a), this.set("tftMatchesLoading", !1)
                    }))
                },
                _enrichTftGames(e) {
                    return n.Lodash.forEach(e, (e => {
                        e && e.json && e.json.participants && (this._enrichGameVariation(e), n.Lodash.forEach(e.json.participants, (t => {
                ...
                _enrichUnits(e) {
                    ...
                    n.Lodash.forEach(e.units, (e => {
                        ...
                        if (l) l.character_record ? (e.iconPath = l.character_record.squareIconPath, e.championName = l.character_record.display_name) : (e.iconPath = l.squareIconPath, e.championName = l.display_name);
                            ...
                            l = s.get(t), l ? (e.iconPath = l.squarePortraitPath, e.championName = l.name) : n.logger.trace("Unknown champion: " + e)
                        }
                        n.Lodash.forEach(e.itemNames, (t => {
                            const s = a.get(t);
                            s && (e.equippedItems || (e.equippedItems = n.Ember.A([])), e.equippedItems.pushObject(s))
                        }))
                    })), e.units.sort(((e, t) => e.tier > t.tier ? -1 : e.tier < t.tier ? 1 : e.itemNames && (!t.itemNames || e.itemNames.length > t.itemNames.length) ? -1 : t.itemNames && (!e.itemNames || e.itemNames.length < t.itemNames.length) ? 1 : e.rarity > t.rarity ? -1 : e.rarity < t.rarity ? 1 : e.name.localeCompare(t.name)))
                },
                _enrichTraits(e, t) {
                    const a = this.get("tftTraitsById");
                    "object" == typeof t.traits && t.traits.length && (n.Lodash.forEach(t.traits, (t => {
                        if ("object" == typeof t) {
                            const n = a.get(t.name.toLowerCase());
                            n && (t.name = n.display_name, t.iconPath = n.icon_path), e.metadata.data_version >= 3 ? t.rank = t.style : t.tier_current === t.tier_total ? t.rank = 3 : 0 === t.tier_current ? t.rank = 0 : 1 === t.tier_current ? t.rank = 1 : t.rank = 2
                        }
                ...
                _enrichGameVariation(e) {
                    ...
                    a && (e.json.gameVariation = {}, e.json.gameVariation.displayName = a.game_variation_display_name, e.json.gameVariation.iconPath = a.icon_path, e.json.gameVariation.description = a.game_variation_description)
                },
                _loadFriendData() {
                    return d.hash({
                        matchListData: this.retrieveData("api.matchHistory", `/v1/products/lol/${this.get("summoner.puuid")}/matches`, {
                            skipCache: !0
                        })
                    }).then((e => {
                        this._updateMatches(e.matchListData), this.set("acsAccountInfo", {
                            platformId: e.matchListData.platformId,
                            accountId: e.matchListData.accountId
                        }), this._updateMatchTypeSubnavigation(), this.set("generalMatchesLoading", !1)
                    }), (e => {
                        n.logger.error(`Could not load your friend data because of ${JSON.stringify(e)}`), 404 !== e.status ? this.showModal({
                            type: "DialogAlert",
                            data: {
                                contents: this.get("tra.MATCH_DETAILS_LOADING_ERROR"),
                                okText: this.get("tra.MATCH_DETAILS_LOADING_ERROR_CONFIRMATION"),
                ...
                _updateDeltas(e) {
                    const t = n.Lodash.get(e, "deltas", []).reduce(((e, t) => e.set(t.gameId, t)), new Map);
                    this.set("deltas", t), n.logger.trace(`Setting deltas to ${JSON.stringify(t)}`)
                },
                _updateMatches(e) {
                    const t = this.get("maps"),
                        ...
                        i = r.default.create({
                            games: l
                        }).get("matchSummaries").map((e => this._enrichSummary(e, t, a, s)));
                    this.set("allGeneralMatches", n.Ember.A(i)), this.set("generalMatches", n.Ember.A(i.slice(0, 6))), this._updateGoldEarned(), n.Ember.run.scheduleOnce("afterRender", this, (() => {
                        (this.get("generalMatches") || n.Ember.A()).pushObjects(i.slice(6)), this.set("areAllGeneralMatchesLoaded", !0)
                    }))
                },
                _updateGoldEarned() {
                    this.get("allGeneralMatches").forEach((e => {
                        const {
                            goldEarned: t
                        } = e.participant, a = this.get("tra.metadata.locale.id");
            ...
            e.exports = n.Ember.Mixin.create({
                ModalManager: (0, n.getProvider)().get("rcp-fe-lol-uikit").getModalManager(),
                showModal: function(e) {
                    const t = this.get("ModalManager").add(e);
                    return n.Ember.get(t, "data.onOk") && t.okPromise ? t.okPromise.then(e.data.onOk) : t.acceptPromise && t.acceptPromise.then((() => {
            ...
            var i = s.Ember.Object.extend({
                ...
                participant: null,
                init() {
                    if (this._super(this, arguments), 0 === arguments.length || !arguments[0]) return;
                    const e = arguments[0];
                    this.set("gameId", e.gameId), this.set("gameCreation", e.gameCreation), this.set("gameDuration", e.gameDuration), this.set("queueId", e.queueId), this.set("mapId", e.mapId), this.set("seasonId", e.seasonId), this.set("gameVersion", e.gameVersion), this.set("gameMode", e.gameMode), this.set("gameType", e.gameType);
                    const t = new l.default(e.participants[0], e.participantIdentities[0]);
            ...
            var l = n.Ember.Object.extend({
                spellIds: n.Ember.computed("spell1Id", "spell2Id", (function() {
                    const e = [];
                    return n.Lodash.range(1, 3).forEach((t => {
                        e.push(this.get("spell" + t + "Id"))
                    })), n.Ember.A(e)
                })),
                itemIds: n.Ember.computed("item0", "item1", "item2", "item3", "item4", "item5", "item6", (function() {
                    const e = [];
                    return n.Lodash.range(0, 7).forEach((t => {
                        e.push(this.get("item" + t))
                    })), n.Ember.A(e)
                })),
                minionsPlusNeutralMonstersCount: n.Ember.computed("totalMinionsKilled", "neutralMinionsKilled", (function() {
                    return this.get("totalMinionsKilled") + this.get("neutralMinionsKilled")
                })),
                init() {
                    if (this._super(this, arguments), 2 === arguments.length && arguments[0] && arguments[1]) {
                        const [e, t] = arguments;
                        this.set("puuid", e.puuid), this.set("participantId", e.participantId), this.set("teamId", e.teamId), this.set("championId", e.championId), this.set("spell1Id", e.spell1Id), this.set("spell2Id", e.spell2Id), this.set("highestAchievedSeasontier", e.highestAchievedSeasontier), this.set("player", t.player);
                        const a = n.Lodash.defaults({}, e.stats, s);
                        n.Lodash.assign(this, a)
                    } else n.logger.warning(`Could not create Participant instance - invalid arguments: ${arguments}`)
                }
            });
            t.default = l
        }, e => {
            "use strict";
            e.exports = JSON.parse('{"kills":"0","deaths":"0","assists":"0","largestKillingSpree":"0","largestMultiKill":"0","firstBloodKill":"0","totalDamageDealtToChampions":"0","physicalDamageDealtToChampions":"0","magicDamageDealtToChampions":"0","trueDamageDealtToChampions":"0","physicalDamageDealt":"0","totalDamageDealt":"0","magicDamageDealt":"0","trueDamageDealt":"0","largestCriticalStrike":"0","totalHeal":"0","totalHealsOnTeammates":"0","totalDamageShieldedOnTeammates":"0","totalDamageTaken":"0","physicalDamageTaken":"0","magicalDamageTaken":"0","trueDamageTaken":"0","damageSelfMitigated":"0","damageDealtToObjectives":"0","damageDealtToTurrets":"0","visionScore":"0","timeCCingOthers":"0","wardsPlaced":"0","wardsKilled":"0","sightWardsBoughtInGame":"0","visionWardsBoughtInGame":"0","goldEarned":"0","goldSpent":"0","totalMinionsKilled":"0","neutralMinionsKilled":"0","neutralMinionsKilledTeamJungle":"0","neutralMinionsKilledEnemyJungle":"0"}')
        }, (e, t, a) => {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            ...
            a(21);
            var s, l = a(22),
                i = (s = a(23)) && s.__esModule ? s : {
                    default: s
                };
            e.exports = n.Ember.Component.extend({
                layout: a(24),
                champRoleList: n.Ember.A(["fighter", "tank", "mage", "assassin", "support", "marksman"]),
                classNames: ["match-summary-recently-played-champions-component"],
                didRender() {
                    this._super(...arguments), this._setupRecentActivityTooltips()
                },
                showHighLightClass: n.Ember.computed("lowSpecModeSettings", (function() {
                ...
                champRoles: n.Ember.computed("matches", (function() {
                    ...
                    return e.forEach((e => {
                        const {
                            championId: a
                        } = e.participant, s = this.get("champions").get(a);
                        s ? t[s.roles[0]] ? t[s.roles[0]]++ : t[s.roles[0]] = 1 : n.logger.error("Cannot find champ summary for id " + a)
                    })), t
                })),
                recentlyPlayedChamps: n.Ember.computed("masteries", "matches", "champions", "areAllMatchesLoaded", "atLeastOneMatch", (function() {
                    const e = this.get("matches"),
                    ...
                    if (e && 0 !== e.length) {
                        ...
                        const o = (0, n.Lodash)(l).orderBy(["count"], ["desc"]).take(3).map((t => {
                        ...
                        return o.map((e => e.mastery ? {
                            ...e,
                            championName: e.name,
                            roleTitle: i.default.roleTitle([e, this.get("tra")]),
                            score: i.default.scoreDisplay([e, this.get("finalPointDrivenLevel"), this.get("tra")]),
                            masteryProgress: i.default.masteryProgress([e]),
                            masteryLevel: i.default.championLevel([e])
                        } : e))
                    }
                    return n.logger.warning("return empty recent champ list"), n.Ember.A([{}, {}, {}])
                })),
                recentlyPlayedChampsBottomLabel: n.Ember.computed("matches", (function() {
                    const e = this.get("matches");
                    return e && e.length > 0 ? this.get("tra.MATCH_HISTORY_SUMMARY_PERCENTAGE_OF_GAME_PLAYED_LABEL") : this.get("tra.MATCH_HISTORY_SUMMARY_GO_PLAY_SOME_GAMES_LABEL")
                })),
                tooltipConfig: {
                    targetAnchor: {
                        x: "center",
                ...
                _setupRecentActivityTooltips() {
                    if (this.get("areAllMatchesLoaded") && this.get("atLeastOneMatch")) {
            ...
            function l(e) {
                ...
                return n && n.formatString && s ? s.championLevel < a ? n.formatString("MATCH_HISTORY_SUMMARY_RECENT_MASTERY_TOOLTIP_POINTS", {
                    current: s.championPoints,
                    next: s.championPoints + s.championPointsUntilNextLevel
                }) : n.formatString("MATCH_HISTORY_SUMMARY_RECENT_MASTERY_TOOLTIP_POINTS_MAX", {
            ...
            function i(e) {
                const [t] = e;
                if (t.mastery) return Math.round(t.mastery.championPointsSinceLastLevel / (t.mastery.championPointsSinceLastLevel + t.mastery.championPointsUntilNextLevel) * 100)
            }
            ...
            e.exports = n.Ember.Component.extend({
                ...
                modeText: n.Ember.computed("matchData.queue_id", "metadata.tags.[]", "queues", (function() {
                ...
                placement: n.Ember.computed("currentPlayer.placement", "isPair", (function() {
                ...
                matchLength: n.Ember.computed("matchData.game_length", "matchData.game_datetime", (function() {
                    const e = this.get("matchData.game_length"),
                        t = ~~(e / 3600),
                        a = ~~(e % 3600 / 60),
                        n = ~~e % 60;
                    let s = "";
                    return t > 0 && (s += t + ":" + (a < 10 ? "0" : "")), s += a + ":" + (n < 10 ? "0" : ""), s += "" + n, s
                })),
                ...
                matchCompanion: n.Ember.computed("companions", "currentPlayer.companion.content_ID", (function() {
                    const e = this.get("companions"),
                        t = this.get("currentPlayer.companion.content_ID");
                    if (!e || !t) return null;
                    let a;
                    return e.groups.every((e => e.items.every((e => e.contentId === t ? (a = [e], !1) : (a = e.upgrades.filter((function(e) {
                        return e.contentId === t
                    })), 0 === a.length))))), a.length > 0 ? a[0] : null
                })),
                currentPlayer: n.Ember.computed("matchData.participants", "puuid", (function() {
            ...
            const l = n.Ember.Component.extend({
                ...
                localizedRoleName: n.Ember.computed("tra.metadata", "roleName", (function() {
                    const e = this.get("roleName").toUpperCase();
                    return this.get(`tra.MATCH_HISTORY_SUMMARY_RECENT_ROLE_${e}`)
                })),
                localizedChampRolePercentage: n.Ember.computed("tra.metadata", "champRolePercentage", (function() {
                    const e = this.get("champRolePercentage");
                    return this.get("tra").formatString("MATCH_HISTORY_SUMMARY_PLAYED_GAMES_PERCENTAGE", {
                        percentage: e
                    })
                }))
            });
            n.default && n.default.EmberApplicationFactory.setFactoryDefinition({
            ...
            e.exports = n.Ember.Component.extend({
                layout: a(38),
                champRolePercentage: n.Ember.computed("roleName", "champRoleMap", "gameCount", (function() {
            ...
            var i = n.Ember.Component.extend({
                ...
                attachTooltip: function() {
                    ...
                    n.TooltipManager.assign(this.tooltipHoverElement, this.tooltipElement, null, e)
                },
            ...
            function t(e) {
                const a = {};
                for (const n in e) "object" == typeof e[n] ? a[n] = t(e[n]) : a[n] = e[n];
                return a
            }
            ...
            e.exports = function(e, n, s) {
                ...
                return n = n.observe((() => {
                    if (l) {
                        ...
                        l.set("metadata", e), l.beginPropertyChanges(), Object.keys(i).forEach((e => {
                ...
                }).create(), l.set("service", l), l.addObserver("metadata.region", a.bind(null, n, "region")), l.addObserver("metadata.locale", a.bind(null, n, "locale")), s && (console.warning("deprecated: pass a traService as a property of your Ember application definition"), s.register("tra:main", l, {
                    instantiate: !1
                }), s.inject("component", "tra", "tra:main"), s.inject("controller", "tra", "tra:main"), s.inject("view", "tra", "tra:main"), s.inject("model", "tra", "tra:main"), s.inject("route", "tra", "tra:main"), s.inject("service", "tra", "tra:main")), l
            }
        }, (e, t, a) => {
            "use strict";
            var n, s = (n = a(41)) && n.__esModule ? n : {
            ...
            class i {
                constructor(e, t) {
                    ...
                    const a = t.overlay("/fe/lol-l10n/trans.json").overlay("/fe/lol-shared-components/trans.json"),
                        n = (0, s.default)(l.Ember, a);
                    this._tra = a, this._traService = n, this._provider = e
                }
                displayMatchDetails(e) {
                    this._matchDetailsApi ? this._matchDetailsApi.showMatchDetails(e) : this._initMatchDetailsApi((t => t.showMatchDetails(e)))
                }
                hideMatchDetails() {
                    this._matchDetailsApi && this._matchDetailsApi.hideMatchDetails()
                }
                _initMatchDetailsApi(e) {
                    if (this._matchDetailsApi) return e && e(this._matchDetailsApi), this._matchDetailsApi;
                    new Promise((e => {
                        Promise.resolve().then((() => {
                            e(a(43))
                        }).bind(null, a)).catch(a.oe)
                    })).then((t => {
                        this._matchDetailsApi = new t(this._provider, this._traService), e(this._matchDetailsApi)
                    }))
                }
            }
            let o;
            ...
            function f() {
                r.release(), p && s.Lodash.isFunction(p) && !g && (p("closeButtonClick"), g = !0), c && c.onRemove()
            }

            function y() {
                r.release(), p && s.Lodash.isFunction(p && !g) && (p("closeMatchDetailModalOnly"), g = !0)
            }
            e.exports = class {
                constructor(e, t) {
                    s.logger.trace("Creating Match Details Ember application"), u || function(e, t) {
                        r = s.Viewport.overlay().getScreenRoot("rcp-fe-lol-match-details-overlay"), d = r.getElement(), h = document.createElement("lol-uikit-full-page-modal"), h.className = "rcp-fe-lol-match-details-overlay-content", d.appendChild(h), h.addEventListener("closeButtonClick", f), h.addEventListener("closeMatchDetailModalOnly", y), s.EmberApplicationFactory.setFactoryDefinition({
                            ...
                            MatchDetailsTimelineChartComponent: a(56).TimelineChartComponent,
                            ...
                            GameIdClipboardCopyComponent: s.SharedEmberComponents.GameIdClipboardCopyComponent,
                            StatsService: a(171),
                            PlayerReportsService: i.default
                        }), s.Viewport.main().getScreenRoot("rcp-fe-lol-profiles-main").on("hide", (function() {
                            f()
                        })), s.Viewport.overlay().on("remove", (function(e, t) {
                            t && "rcp-fe-lol-match-details-overlay" === t.name && p && s.Lodash.isFunction(p) && !g && (p("closeButtonClick"), g = !0)
                ...
                showMatchDetails(e) {
                    this.hideMatchDetails(),
                        function(e) {
                            let t = !1;
                            e.closeModalCallback && s.Lodash.isFunction(e.closeModalCallback) ? (p = e.closeModalCallback, t = !0) : p = null;
                            g = !1;
                            ...
                            s.Ember.RSVP.hash({
                                ...
                                s.logger.trace(`Displaying match details for gameId ${e.gameId} and summoner ${e.summonerId}`), c && (h.removeChild(h.childNodes[0]), c.componentPromise.then((function(e) {
                                    e.app.destroy()
                                }))), m = {
                                    dataSource: d,
            ...
            var n = a(1),
                s = n.Ember.Service.extend({
                    ...
                    initDataBindings() {
                        this.playerReportSenderBinding = (0, n.dataBinding)(this.get("playerReportSenderBasePath"), n.socket)
                    },
                    removeObservers() {
                    ...
                    reportedPlayerObserver: n.Ember.observer("gameId", (function() {
                        ...
                        e && (this.playerReportSenderBinding.removeObserver(this.get("playerReportSenderBasePath"), this), this.playerReportSenderBinding.observe(`/v1/reported-players/gameId/${e}`, this, this.handleReportedPlayersUpdate))
                    })),
            ...
            e.exports = n.Ember.Component.extend(c, i.DataBindingMixin, i.FixDataBindingMixin, l.default, {
                classNames: ["match-details-root-component"],
                classNameBindings: ["hideHeader:match-details-no-header"],
                layout: a(48),
                isLoading: !0,
                isTransitioning: !1,
                matchHistoryConfig: n.Ember.computed.alias("platformConfig.NewMatchHistory"),
                ...
                getNameFallback(e, t) {
                    return void 0 === e || "" === e ? this.get("tra.MATCH_DETAILS_SUMMONER_NAME") + t : e
                },
                loadData() {
                    ...
                    const a = this.retrieveData("api.matchHistory", `/v1/games/${e}`),
                        l = this.retrieveData("api.matchHistory", `/v1/game-timelines/${e}`);
                    return n.Ember.RSVP.hashSettled({
                        ...
                        if (t.participants && t.participantIdentities && (t.participantIdentities.forEach(((e, a) => {
                                const {
                                    summonerName: n,
                                    gameName: s,
                                    tagLine: l
                                ...
                                let i;
                                i = s && l ? this.get("_playerNames")?.formatPlayerName({
                                    summonerName: n,
                                    gameName: s,
                                    tagLine: l
                                })?.playerName : n, t.participantIdentities[a].player.displayName = i
                            })), t.participants = t.participants.map((e => {
                                const a = n.Lodash.find(t.participantIdentities, (t => t.participantId === e.participantId));
                                return a.player.summonerName = this.getNameFallback(a.player.summonerName, e.participantId), a.player.displayName = this.getNameFallback(a.player.displayName, e.participantId), n.Lodash.set(a.player, "participantId", a.participantId), new s.default(e, a)
                            }))), this.get("baseSummonerId")) {
                            const e = n.Lodash.find(t.participants, (e => e.player.summonerId === this.get("baseSummonerId")));
                            t.participants = n.Lodash.sortBy(t.participants, ["teamId", function(t) {
                                return t.player.summonerId === e.player.summonerId ? -1 : 0
                            }]), this.set("baseCurrentParticipant", e)
                        }
                        this.set("baseGameData", t), "fulfilled" === e.gameTimeline.state ? this.set("baseGameTimeline", e.gameTimeline.value) : this.set("baseGameTimeline", null), this.set("isLoading", !1)
                    }), (e => {
                        404 !== e.status && (n.logger.error("Could not load match details data", e), this.showModal({
                            type: "DialogAlert",
                            data: {
                                contents: this.get("tra.MATCH_DETAILS_LOADING_ERROR"),
                                okText: this.get("tra.MATCH_DETAILS_LOADING_ERROR_CONFIRMATION"),
                                onOk: () => {
                                    this.element.dispatchEvent(new Event("closeMatchDetailModalOnly", {
                                        bubbles: !0
                                    }))
                                }
                            }
                ...
                currentParticipant: n.Ember.computed("baseCurrentParticipant", (function() {
                    return this.get("baseCurrentParticipant") || {}
                })),
                addNavigationListenersOnInserted: n.Ember.on("didInsertElement", (function() {
                    this.$("lol-uikit-navigation-bar").get(0).addEventListener("lol-uikit-navigation-item-attr-set-event", (e => {
                        const t = e.detail.node;
                        this.showSection(t.dataset.name)
                    }))
                })),
                sectionName: n.Ember.computed("displaySections", "currentSelectedSectionName", (function() {
                    return "match-" + this.get("displaySections")[this.get("selectedSectionIndex")].name
                })),
                selectedSectionIndex: n.Ember.computed("displaySections.[]", "displaySections.@each.selected", (function() {
                ...
                isGameModeWithSubteams: n.Ember.computed("baseGameData", "subteamGameModeData", (function() {
                    return !!this.get("subteamGameModeData")[this.get("baseGameData.gameMode")]
                })),
                displaySections: n.Ember.computed("tra.metadata", "sections.@each.sectionName", "currentSelectedSectionName", "matchHistoryConfig", "isGameModeWithSubteams", "subteamGameModeData", (function() {
                    ...
                    this.get("isGameModeWithSubteams") && (l = this.get("subteamGameModeData")[i].disabledSections), e = n.Lodash.sortBy(e, ["priority"]);
                    let o = !1;
                    return e.forEach((e => {
                        ...
                        m && (o = !0), i.set("name", e.sectionName), i.set("displayName", this.get(`tra.${e.locKey}`)), i.set("selected", m), i.set("disabled", !e.enabled || r), i.set("display", (e.display || !c) && !p), s.push(i)
                    })), !o && s.length > 0 && s[0].set("selected", !0), n.Ember.A(s)
                })),
                didRender() {
                    this._super(...arguments), this.get("isTransitioning") && this.set("isTransitioning", !1)
                },
                showSection: function(e) {
                    this.get("currentSelectedSectionName") === e || this.get("isTransitioning") || (this.set("currentSelectedSectionName", e), this.set("isTransitioning", !0))
                }
            })
        }, (e, t) => {
            "use strict";
            ...
            t.GAME_MODES_WITH_SUBTEAMS = {
                CHERRY: {
                    disabledSections: ["overview", "runes"]
                }
            }
        }, (e, t, a) => {
            "use strict";
            ...
            var n = a(1),
                s = a(6),
                l = a(5);
            a(50), e.exports = n.Ember.Component.extend(s.DataBindingMixin, {
                layout: a(51),
                classNames: ["match-details-layer-header"],
                animationDisabled: n.Ember.computed.bool("potatoModeSetting.data.potatoModeEnabled"),
                map: n.Ember.computed("maps", "gameData.mapId", "gameData.gameMode", (function() {
                    const e = n.Lodash.find(this.get("maps"), {
                        gameMode: this.get("gameData.gameMode"),
                        id: this.get("gameData.mapId")
                    });
                    return e || n.Lodash.find(this.get("maps"), {
                        id: l.DEFAULT_MAP_ID
                    })
                })),
                createdAt: n.Ember.computed("gameData", "tra.MATCH_DETAILS_GAME_CREATION_DATE_FORMAT", (function() {
                    const e = this.get("gameData").gameCreation;
                    return (0, n.moment)(new Date(e)).format(this.get("tra.MATCH_DETAILS_GAME_CREATION_DATE_FORMAT"))
                })),
                ...
                type: n.Ember.computed("gameData.gameType", "gameData.queueId", "queues", "tra.MATCH_HISTORY_QUEUE_MODE_CUSTOM", (function() {
                    if (this.get("gameData.gameType") === l.CUSTOM_GAME_TYPE) return this.get("tra.MATCH_HISTORY_QUEUE_MODE_CUSTOM");
                    const e = this.get("queues").get(this.get("gameData.queueId"));
                    return e ? e.detailedDescription ? e.detailedDescription : e.description : ""
                })),
                outcome: n.Ember.computed("currentParticipant.win", "tra.postgame_progress_victory", "tra.postgame_progress_defeat", "tra.MATCH_HISTORY_MATCH_RESULT_REMAKE", "currentParticipant.stats.gameEndedInEarlySurrender", (function() {
                    const e = this.get("currentParticipant").win;
                    return this.get("currentParticipant.stats.gameEndedInEarlySurrender") ? this.get("tra.MATCH_HISTORY_MATCH_RESULT_REMAKE") : this.get("tra." + (e ? "postgame_progress_victory" : "postgame_progress_defeat"))
                })),
                mapIcon: n.Ember.computed("currentParticipant.win", "gameData.mapId", "animationDisabled", (function() {
                    const e = this.get("map");
                    return this.get("animationDisabled") ? this.get("currentParticipant.win") ? n.Lodash.get(e, "assets.icon-victory") : n.Lodash.get(e, "assets.icon-defeat") : this.get("currentParticipant.win") ? n.Lodash.get(e, "assets.icon-victory-video") : n.Lodash.get(e, "assets.icon-defeat-video")
                })),
                isThirdPersonView: !1,
                thirdPersonAccessibleGameQueues: n.Ember.computed.readOnly("platformConfig.Replays.ThirdPersonAccessibleGameQueues"),
                whitelistedQueueIds: n.Ember.computed("thirdPersonAccessibleGameQueues", (function() {
                    return n.Ember.A((this.get("thirdPersonAccessibleGameQueues") || "").split(",").map((function(e) {
                        return parseInt(e, 10)
                    })))
                })),
                replayButton: null,
                shouldShowReplayButton: n.Ember.computed("gameData", "isThirdPersonView", "whitelistedQueueIds", (function() {
                    const e = this.get("gameData");
                    return !(!e || !n.Replays.isGeneralReplaysEnabled()) && (!(this.get("isThirdPersonView") && !this.get("whitelistedQueueIds").includes(e.queueId)) || (n.logger.trace("Queue id for this game is not whitelisted, not adding replay button"), !1))
                })),
                onDidRender: n.Ember.on("didRender", (function() {
                    this._addReplayButton()
                })),
                _addReplayButton: n.Ember.observer("shouldShowReplayButton", (function() {
                    if (this.get("replayButton")) return;
                    if (!this.get("shouldShowReplayButton")) return;
                    const e = this.element ? this.element.querySelector(".match-layer-header-replay") : null;
                    if (!e) return;
                    ...
                    } else n.logger.error("Unable to create replay button for match")
                })),
            ...
            const i = ["DARKSTAR", "STARGUARDIAN"],
                o = n.Ember.Component.extend({
                    ...
                    chartTitle: n.Ember.computed("displayedChart", (function() {
                        return this.get("tra").get(l.default.CHART_TITLES_KEYS[this.get("displayedChart")])
                    })),
                    hasTimelineData: n.Ember.computed("gameTimeline", (function() {
                        const e = this.get("gameTimeline");
                        return e.frames && e.frames.length > 0 && !this.shouldSkipTimelineData()
                    })),
                    ...
                    overviewData: n.Ember.computed("gameData", "gameTimeline", "currentParticipant.player.currentAccountId", "champions", (function() {
                        return m(this.get("gameData"), this.get("gameTimeline"), this.get("currentParticipant.player.currentAccountId"), this.get("champions"))
                    })),
                    actions: {
                        selectTimelineChart: function(e) {
                            this.set("displayed.teamGoldAdvantage", !1), this.set("displayed.teamGold", !1), this.set("displayed.championGold", !1), this.set("displayed." + e, !0), this.set("displayedChart", e)
                        }
                    },
                    didInsertElement: function() {
                        const e = n.Ember.$(this.element).find(".match-details-overview-container")[0];
                        e.addEventListener("webkitAnimationEnd", (function(t) {
                            t.target === e && "fade-in" === t.animationName && e.classList.remove("match-details-loading-fade-in")
                        }))
                    }
                });
            ...
            function c(e, t) {
                const a = {};
                return n.Lodash.each(e.participants, (e => {
            ...
            function m(e, t, a, s) {
                const l = n.Lodash.filter(e.participantIdentities, (e => e.player.currentAccountId === a))[0],
                    i = c(e, s);
                return {
                    participants: i,
            ...
            function p(e, t, a) {
                ...
                return n.Lodash.each(e, (e => {
                    ...
                    y[l.default.TEAM_BLUE_ID] = g.teamGolds[l.default.TEAM_BLUE_ID], y[l.default.TEAM_RED_ID] = g.teamGolds[l.default.TEAM_RED_ID], i.push({
                        gold: g.teamGolds[p] - g.teamGolds[u],
                        timestamp: r
                    }), s.push(y), o.push({
                        champions: g.championGolds,
                        timestamp: r
                    }), c.push(n.Lodash.extend(f, {
                        timestamp: r
                    }))
                })), {
                    teamGoldAdvantage: i,
            ...
            function d(e, t, a, s) {
                const i = {},
                    o = {};
                i[l.default.TEAM_BLUE_ID] = i[l.default.TEAM_RED_ID] = 0, o[l.default.TEAM_BLUE_ID] = o[l.default.TEAM_RED_ID] = null;
                let c = {};
                c[l.default.TEAM_RED_ID] = {}, c[l.default.TEAM_BLUE_ID] = {};
                const m = e.filter((e => !!n.Lodash.includes(l.default.RELEVANT_EVENT_TYPES, e.type) && (e.type !== l.default.CHAMP_KILL_EVENT_TYPE || 0 !== e.victimId))),
                ...
                n.Lodash.each(m, (e => {
                    ...
                    switch (e.type) {
                        ...
                        case l.default.BUILD_KILL_EVENT_TYPE:
                            ...
                            o[s] = f(o[s], d, l.default.OBJECTIVE_GREATENESS_MAP), r.push({
                                isChampion: !1,
                                class: `${d}-${g(s)}`
                        ...
                        case l.default.ELITE_MONSTER_KILL_TYPE:
                            ...
                            o[s] = f(o[s], h, l.default.OBJECTIVE_GREATENESS_MAP), e.monsterSubType && l.default.OBJECTIVE_TYPE_DISPLAY_MAP[e.monsterSubType] && (h = l.default.OBJECTIVE_TYPE_DISPLAY_MAP[e.monsterSubType]), r.push({
                                isChampion: !1,
                                class: `${h}-${s}`
                            })
                    }
                }));
                const d = n.Lodash.reduce(i, ((e, t, a) => (t > 0 && e.push({
                        teamId: a,
                        count: t
                    }), e)), []),
                    h = n.Lodash.reduce(o, ((e, t, a) => (t && e.push({
                        teamId: a,
                        objective: t
                    }), e)), []);
                return c = n.Lodash.fromPairs(n.Lodash.map(c, ((e, a) => [a, {
            ...
            function h(e, t) {
                ...
                const a = [],
                    s = n.Lodash.reduce(e.participantFrames, ((e, n) => {
                        const {
                            teamId: s
                        } = t[n.participantId];
                        return e.teamGolds[s] || (e.teamGolds[s] = 0, a.push(s)), e.championGolds[n.participantId] = n.totalGold, e.teamGolds[s] += n.totalGold, e
                    }), {
                        teamGolds: {},
                        championGolds: {}
                    });
            ...
            function u(e, t) {
                switch (e.type) {
                    ...
                    default:
                        return n.logger.warning("Cannot infer teamId from event: ", e), -1
                }
            }
            ...
            var a = {
                ...
                get RELEVANT_EVENT_TYPES() {
                    return [this.CHAMP_KILL_EVENT_TYPE, this.BUILD_KILL_EVENT_TYPE, this.ELITE_MONSTER_KILL_TYPE]
                },
                CHART_TITLES_KEYS: {
                    teamGoldAdvantage: "MATCH_HISTORY_OVERVIEW_TIMELINE_GOLD_ADVANTAGE_TITLE",
                ...
                r = n.Ember.Component.extend({
                    ...
                    draw: function(e, t) {
                        const a = e.timelines[t],
                            ...
                            p = this.get("tra.MATCH_HISTORY_OVERVIEW_TIMELINE_GOLD_ADVANTAGE_TOOLTIP_TEAM_ONE"),
                            d = this.get("tra.MATCH_HISTORY_OVERVIEW_TIMELINE_GOLD_ADVANTAGE_TOOLTIP_TEAM_TWO");
                        a.ownerId = e.ownerId + "", a.participants = e.participants;
                        const h = n.d3.select(this.$().get(0)).append("svg:svg").attr("width", r.w).attr("height", r.h).attr("class", "match-details-timeline-chart");
                        h.append("svg:g").attr("class", "match-details-timeline-axis-y").attr("transform", _(r.margin.left, r.margin.top)).call(r.axis.y).selectAll("g").filter((e => 0 === e)).classed("zero-line", !0), h.append("svg:g").attr("class", "match-details-timeline-axis-x").attr("transform", _(r.margin.left, r.innerH + r.margin.top)).call(r.axis.x);
                        const u = h.append("svg:g").attr("transform", _(r.margin.left, r.margin.top)).attr("class", "match-details-timeline-chart-interact");
                        u.append("svg:line").attr("class", "vertical-rule-sync").attr("y1", 0).attr("y2", r.innerH + r.margin.bottom).style("display", "none"), u.on("mouseover", (() => n.d3.selectAll(".vertical-rule-sync").style("display", "block"))).on("mouseout", (() => n.d3.selectAll(".vertical-rule-sync").style("display", "none"))).on("mousemove", (function() {
                            const e = n.d3.mouse(this)[0];
                            n.d3.selectAll(".vertical-rule-sync").attr("x1", e).attr("x2", e)
                        })), u.append("svg:rect").attr("width", r.innerW).attr("height", r.innerH + r.margin.bottom).attr("class", "background-rect"), o[t]({
                            chartSvg: u,
                            outerSvg: h,
                            chart: r,
                            data: a,
                    ...
                    createTooltip: function() {
                        ...
                        n.Lodash.each(e, (e => {
                            n.TooltipManager.assign(e, i({
                                text: e.attributes.tooltip.value
                            }), {}, {
                                targetAnchor: {
                                    x: "center",
                                    y: "top"
                    ...
                    didInsertElement: function() {
                        ...
                        if (e) {
                            ...
                            let s = n.Lodash.sortBy(e.participants, (function(e) {
                                ...
                                l = 1;
                            s = n.Lodash.keyBy(s, (() => l++)), this.set("chartData.participants", s), this.draw(e, this.get("chartType"))
                        }
                    }
                });
            ...
            function c(e, t, a, s, l) {
                const i = a.width,
                    ...
                    m = i - r.left - r.right;
                let p, d = 0;
                if ("teamGoldAdvantage" === t) p = Math.max(n.d3.max(e, (e => e.gold)), Math.abs(n.d3.min(e, (e => e.gold)))), d = -p;
                else if ("teamGold" === t) {
                    const t = e[e.length - 1];
                    p = n.Lodash.max(n.Lodash.values(n.Lodash.omit(t, "timestamp")))
                } else "championGold" === t && (p = n.Lodash.max(n.Lodash.values(e[e.length - 1].champions)));
                p = 1e3 * Math.ceil(p / 1e3), d = 1e3 * Math.floor(d / 1e3);
                const h = n.d3.scale.linear().range([0, m]).domain([0, e[e.length - 1].timestamp]),
                    u = n.d3.scale.linear().range([c, 0]).domain([d, p]),
                    g = n.d3.svg.axis().scale(h).ticks(a.ticks.x).tickPadding(a.tickPadding.x).tickSize(0).tickFormat(n.l10nDuration.formatMilliseconds),
                    f = n.d3.svg.axis().scale(u).orient("left").tickSize(-m).tickPadding(a.tickPadding.y).tickFormat((e => {
            ...
            function m(e) {
                const {
                    ...
                    blue: o,
                    red: r
                } = e, c = u(s), m = t.append("svg:g");
                m.selectAll("line").data(c).enter().append("line").attr("class", (e => 0 === e.y1 && 0 === e.y2 ? "data-line data-stroke-even" : e.y1 > 0 || e.y2 > 0 ? "data-line data-stroke-100" : "data-line data-stroke-200")).attr("x1", (e => a.scale.x(e.x1))).attr("y1", a.scale.y(0)).attr("x2", (e => a.scale.x(e.x2))).attr("y2", a.scale.y(0)), m.selectAll("line").data(c).transition().delay(200).duration(430).ease("cubic-out").attr("y1", (e => a.scale.y(e.y1))).attr("y2", (e => a.scale.y(e.y2)));
                const p = n.d3.svg.area().interpolate("linear").x((e => a.scale.x(e.x))).y0(a.scale.y(0)).y1((e => a.scale.y(e.y))),
                    d = n.d3.svg.area().interpolate("linear").x((e => a.scale.x(e.x))).y0(a.scale.y(0)).y1(a.scale.y(0)),
                    h = g(c),
                    y = t.append("svg:g");
                y.selectAll("path").data(h).enter().append("path").attr("class", (e => "data-area data-fill-" + e.teamId)).attr("d", (e => d(e.data))), y.selectAll("path").data(h).transition().delay(200).duration(430).ease("cubic-out").attr("d", (e => p(e.data)));
                const _ = t.append("svg:g");
                _.selectAll(".timeline-data-point").data(s).enter().append("circle").attr("class", (e => e.gold > 0 ? "timeline-data-point data-fill-100" : e.gold < 0 ? "timeline-data-point data-fill-200" : "timeline-data-point data-fill-even")).attr("cx", (e => a.scale.x(e.timestamp))).attr("cy", a.scale.y(0)).attr("r", (() => a.pointRarius)).attr("tooltip", (e => f(e, l, i, e.gold > 0 ? o : r))), _.selectAll(".timeline-data-point").data(s).transition().delay(200).duration(430).ease("cubic-out").attr("cy", (e => a.scale.y(e.gold)))
            }
            ...
            function p(e) {
                ...
                n.Lodash.each([100, 200], (e => {
                    const r = n.d3.svg.line().x((e => a.scale.x(e.timestamp))).y((t => a.scale.y(t[e]))).interpolate("linear");
                    t.append("svg:g").selectAll(".data-line").data([s]).enter().append("svg:path").attr("class", "data-line data-stroke-" + (e === o ? "100" : "200")).attr("d", r(s)), t.append("svg:g").selectAll(".timeline-data-point").data(s).enter().append("svg:circle").attr("class", "timeline-data-point data-fill-" + (e === o ? "100" : "200")).attr("cx", (e => a.scale.x(e.timestamp))).attr("cy", (t => a.scale.y(t[e]))).attr("r", (() => a.pointRarius)).attr("tooltip", (t => y(t[e], t.timestamp, l, i)))
                }))
            }
            ...
            function d(e) {
                ...
                c.classList.add("match-details-champ-gold-toggle-container"), o.appendChild(c);
                const m = document.createElement("div");
                m.classList.add("champ-gold-toggles", "champ-gold-toggles-100");
                const p = document.createElement("div");
                p.classList.add("champ-gold-toggles", "champ-gold-toggles-200"), c.appendChild(m), c.appendChild(p);
                const d = {
                        100: m,
                        200: p
                    },
                ...
                n.Lodash.each(r, (e => {
                    const o = e.participantId + "" === s.ownerId,
                        ...
                        c = o ? "" : "none",
                        m = t.append("svg:g").attr("class", "data-champ-gold-" + e.participantId).style("display", c).selectAll(".data-champ-gold"),
                        p = n.d3.svg.line().x((e => a.scale.x(e.timestamp))).y((t => a.scale.y(t.champions[e.participantId]))).interpolate("linear");
                    m.data([s]).enter().append("svg:path").attr("class", `data-line data-stroke-${r}`).attr("d", p(s)), m.data(s).enter().append("svg:circle").attr("class", `timeline-data-point data-fill-${r}`).attr("cx", (e => a.scale.x(e.timestamp))).attr("cy", (t => a.scale.y(t.champions[e.participantId]))).attr("r", (() => a.pointRarius)).attr("tooltip", (t => y(t.champions[e.participantId], t.timestamp, l, i)));
                    const h = d[e.teamId === u ? 100 : 200],
                        g = document.createElement("div");
                    g.classList.add(`gold-toggle-${r}`, "champ-gold-toggle-icon"), g.setAttribute("status", o ? "shown" : "hidden");
                    const f = document.createElement("img");
                    f.classList.add("champ-gold-toggle-img"), f.src = e.imgSrc, g.appendChild(f), h.appendChild(g), g.addEventListener("click", (() => {
                        const a = t.select(".data-champ-gold-" + e.participantId),
                            n = "none" === a.style("display");
                        a.style("display", n ? "" : "none"), g.setAttribute("status", n ? "shown" : "hidden")
                    }))
                }))
            }
            ...
            function h(e) {
                let t = 100;
                return n.Lodash.each(e.participants, (a => {
                    a.participantId + "" === e.ownerId && (t = a.teamId)
                })), t
            }

            function u(e) {
                return n.Lodash.reduce(e, ((t, a, n) => {
                    const s = e[n + 1];
                    if (s)
                        if (a.gold * s.gold < 0) {
                            const e = a.timestamp + Math.abs((s.timestamp - a.timestamp) * a.gold / (s.gold - a.gold));
                            t.push({
                                x1: a.timestamp,
                                y1: a.gold,
                                x2: e,
            ...
            function g(e) {
                if (e.length) {
                    ...
                    return n.Lodash.reduce(e, ((e, t) => {
                        const a = {
                            x: t.x2,
                            y: t.y2
                        };
                        return a.y >= 0 && e[0].data.push(a), a.y <= 0 && e[1].data.push(a), e
                    }), [{
                        teamId: 100,
                        data: [t]
                    }, {
            ...
            function f(e, t, a, s) {
                ...
                return 0 === e.gold ? t("MATCH_HISTORY_OVERVIEW_TIMELINE_GOLD_ADVANTAGE_TOOLTIP_EVEN", {
                    time: i
                }) : t("MATCH_HISTORY_OVERVIEW_TIMELINE_GOLD_ADVANTAGE_TOOLTIP_AHEAD", {
                    team: s,
            ...
            e.exports = (n.default || n).template({
                ...
                main: function(e, t, a, n, s) {
                    var l;
                    return '<lol-uikit-tooltip>\r\n  <div class="match-details-timeline-tooltip">\r\n    <span class="match-details-timeline-tooltip-text">' + e.escapeExpression("function" == typeof(l = null != (l = a.text || (null != t ? t.text : t)) ? l : a.helperMissing) ? l.call(null != t ? t : e.nullContext || {}, {
                        name: "text",
                        hash: {},
                        data: s
                    }) : l) + "</span>\r\n  </div>\r\n</lol-uikit-tooltip>"
            ...
            function p() {
                ...
                return r.extend(e, l), e.SafeString = i.default, e.Exception = o.default, e.Utils = r, e.escapeExpression = r.escapeExpression, e.VM = c, e.template = function(t) {
                    return c.template(t, e)
                }, e
            }
            var d = p();
            d.create = p, m.default(d), d.default = d, t.default = d, e.exports = t.default
        }, (e, t, a) => {
            "use strict";
            ...
            function m(e, t, a) {
                this.helpers = e || {}, this.partials = t || {}, this.decorators = a || {}, i.registerDefaultHelpers(this), o.registerDefaultDecorators(this)
            }
            m.prototype = {
                constructor: m,
                logger: r.default,
            ...
            function i(e) {
                for (var t = 1; t < arguments.length; t++)
                    for (var a in arguments[t]) Object.prototype.hasOwnProperty.call(arguments[t], a) && (e[a] = arguments[t][a]);
                return e
            }
            ...
            function n(e, t) {
                ...
                for (var o = Error.prototype.constructor.call(this, e), r = 0; r < a.length; r++) this[a[r]] = o[a[r]];
            ...
            t.__esModule = !0, t.registerDefaultHelpers = function(e) {
                s.default(e), l.default(e), i.default(e), o.default(e), r.default(e), c.default(e), m.default(e)
            };
            var s = n(a(65)),
                l = n(a(66)),
                i = n(a(67)),
            ...
            t.default = function(e) {
                e.registerHelper("blockHelperMissing", (function(t, a) {
                    ...
                    if (n.isArray(t)) return t.length > 0 ? (a.ids && (a.ids = [a.name]), e.helpers.each(t, a)) : s(this);
                    if (a.data && a.ids) {
                        var i = n.createFrame(a.data);
                        i.contextPath = n.appendContextPath(a.data.contextPath, a.name), a = {
                            data: i
                        }
                    }
                    return l(t, a)
            ...
            t.default = function(e) {
                e.registerHelper("each", (function(e, t) {
                    ...
                    function m(t, n, l) {
                        r && (r.key = t, r.index = n, r.first = 0 === n, r.last = !!l, c && (r.contextPath = c + t)), o += a(e[t], {
                            data: r,
                    ...
                    if (t.data && t.ids && (c = s.appendContextPath(t.data.contextPath, t.ids[0]) + "."), s.isFunction(e) && (e = e.call(this)), t.data && (r = s.createFrame(t.data)), e && "object" == typeof e)
                        if (s.isArray(e))
                            for (var p = e.length; l < p; l++) l in e && m(l, l, l === e.length - 1);
                        else {
                            var d = void 0;
                            for (var h in e) e.hasOwnProperty(h) && (void 0 !== d && m(d, l - 1), d = h, l++);
                            void 0 !== d && m(d, l - 1, !0)
            ...
            t.__esModule = !0, t.default = function(e) {
                e.registerHelper("log", (function() {
                    for (var t = [void 0], a = arguments[arguments.length - 1], n = 0; n < arguments.length - 1; n++) t.push(arguments[n]);
                    var s = 1;
                    null != a.hash.level ? s = a.hash.level : a.data && null != a.data.level && (s = a.data.level), t[0] = s, e.log.apply(e, t)
                }))
            }, e.exports = t.default
        }, (e, t) => {
            "use strict";
            ...
            t.default = function(e) {
                e.registerHelper("with", (function(e, t) {
                    ...
                    var s = t.data;
                    return t.data && t.ids && ((s = n.createFrame(t.data)).contextPath = n.appendContextPath(t.data.contextPath, t.ids[0])), a(e, {
                        data: s,
                ...
                s = {
                    ...
                    log: function(e) {
                        if (e = s.lookupLevel(e), "undefined" != typeof console && s.lookupLevel(s.level) <= e) {
                            var t = s.methodMap[e];
                            console[t] || (t = "log");
                            for (var a = arguments.length, n = Array(a > 1 ? a - 1 : 0), l = 1; l < a; l++) n[l - 1] = arguments[l];
            ...
            t.__esModule = !0, t.checkRevision = function(e) {
                ...
                if (t !== a) {
                    if (t < a) {
                        ...
                        throw new i.default("Template was precompiled with an older version of Handlebars than the current runtime. Please update your precompiler to a newer version (" + n + ") or downgrade your runtime to an older version (" + s + ").")
                    }
                ...
                var a = {
                    ...
                    invokePartial: function(a, n, l) {
                        l.hash && (n = s.extend({}, n, l.hash), l.ids && (l.ids[0] = !0)), a = t.VM.resolvePartial.call(this, a, n, l);
                        var o = t.VM.invokePartial.call(this, a, n, l);
                        if (null == o && t.compile && (l.partials[l.name] = t.compile(a, e.compilerOptions, t), o = l.partials[l.name](n, l)), null != o) {
                            if (l.indent) {
                                for (var r = o.split("\n"), c = 0, m = r.length; c < m && (r[c] || c + 1 !== m); c++) r[c] = l.indent + r[c];
                                o = r.join("\n")
                            }
                            return o
                        }
                        throw new i.default("The partial " + l.name + " could not be compiled when running in runtime-only mode")
                    },
                    fn: function(t) {
                        var a = e[t];
                    ...
                    program: function(e, t, a, n, s) {
                        var l = this.programs[e],
                            i = this.fn(e);
                        return t || s || n || a ? l = r(this, e, i, t, a, n, s) : l || (l = this.programs[e] = r(this, e, i)), l
                    },
                    data: function(e, t) {
                        for (; e && t--;) e = e._parent;
                        return e
                ...
                function n(t) {
                    var s = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1],
                        l = s.data;
                    n._setup(s), !s.partial && e.useData && (l = function(e, t) {
                    ...
                    return e.useDepths && (i = s.depths ? t != s.depths[0] ? [t].concat(s.depths) : s.depths : [t]), (c = m(e.main, c, a, s.depths || [], l, r))(t, s)
                }
            ...
            }, t.wrapProgram = r, t.resolvePartial = function(e, t, a) {
                ...
                var l = void 0;
                a.fn && a.fn !== c && function() {
                    a.data = o.createFrame(a.data);
                    var e = a.fn;
                    l = a.data["partial-block"] = function(t) {
                        var a = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1];
                        return a.data = o.createFrame(a.data), a.data["partial-block"] = n, e(t, a)
                    }, e.partials && (a.partials = s.extend({}, a.partials, e.partials))
                }();
                void 0 === e && l && (e = l);
                if (void 0 === e) throw new i.default("The partial " + a.name + " could not be found");
            ...
            function r(e, t, a, n, s, l, i) {
                function o(t) {
                    var s = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1],
                        o = i;
                    return !i || t == i[0] || t === e.nullContext && null === i[0] || (o = [t].concat(i)), a(e, t, e.helpers, e.partials, s.data || n, l && [s.blockParams].concat(l), o)
                }
                return (o = m(a, o, e, i, n, l)).program = t, o.depth = i ? i.length : 0, o.blockParams = s || 0, o
            }
            ...
            e.exports = n.HTMLBars.template({
                id: "5pZ8gaQy",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-match-history\\\\src\\\\components\\\\overview\\\\match-details-timeline-chart-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-match-history\\\\src\\\\components\\\\overview\\\\match-details-timeline-chart-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-match-history\\\\src\\\\components\\\\overview\\\\match-details-timeline-chart-component\\\\index.js\\" "],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, a) => {
            "use strict";
            ...
            e.exports = n.Ember.Component.extend({
                ...
                draw: function(e) {
                    const {
                        events: t
                    } = e.timelines, a = this.get("specs"), s = function(e, t) {
                        const a = t.width,
                            s = t.height,
                            {
                                margin: l
                            ...
                            c = n.d3.scale.linear().range([0, o]).domain([0, e[e.length - 1].timestamp]),
                            m = n.d3.scale.linear().range([t.pointRadius.min, t.pointRadius.max]).domain([0, r]);
                        return {
                            w: a,
                            h: s,
                            innerW: o,
                    ...
                    }(t, a), l = n.d3.select(this.$().get(0)).append("svg:svg").attr("width", s.w).attr("height", s.h).attr("class", "match-details-event-chart"), i = l.append("svg:g").attr("transform", `translate(${s.margin.left}, ${s.margin.top})`).attr("class", "match-details-event-chart-interact");
                    i.append("svg:line").attr("class", "vertical-rule-sync").attr("y1", -s.margin.top).attr("y2", s.innerH + s.margin.top).style("display", "none"), i.on("mouseover", (() => n.d3.selectAll(".vertical-rule-sync").style("display", "block"))).on("mouseout", (() => n.d3.selectAll(".vertical-rule-sync").style("display", "none"))).on("mousemove", (function() {
                        const e = n.d3.mouse(this)[0];
                        n.d3.selectAll(".vertical-rule-sync").attr("x1", e).attr("x2", e)
                    })), i.append("svg:rect").attr("width", s.innerW).attr("height", s.innerH).attr("class", "background-rect");
                    const o = i.append("svg:g").selectAll(".match-details-event-frame").data(t).enter().append("svg:g").filter((e => e.kills.length + e.objectives.length > 0)).attr("class", "match-details-event-frame").attr("transform", (e => "translate(" + s.scale.x(e.timestamp) + ", 0)")).attr("tooltipData", (e => JSON.stringify(e.details))).on("mouseover", (function() {
                        n.d3.select(this).style("filter", 'url("#match-details-brightness-filter")')
                    })).on("mouseout", (function() {
                        n.d3.select(this).style("filter", "none")
                    }));
                    o.append("svg:rect").attr("x", -s.frameW / 2).attr("y", 0).attr("width", s.frameW).attr("height", s.frameH).attr("class", "background-rect"), o.selectAll(".match-details-event-kills").data((e => e.kills)).enter().append("svg:circle").attr("class", (e => "match-details-event-kills data-point data-fill-" + e.teamId)).attr("cx", 0).attr("cy", (e => a.killDotsTransition.y(e.teamId))).attr("r", (e => s.scale.radius(e.count))), o.selectAll(".match-details-event-objectives").data((e => e.objectives)).enter().append("svg:foreignObject").attr("x", 0).attr("y", (e => a.objectiveIconTransition.y(e.teamId))).append("xhtml:div").attr("class", (e => `match-details-event-objectives event-icon-${e.objective}-${e.teamId}`));
                    const r = this.get("tra.MATCH_HISTORY_OVERVIEW_EVENT_OBJECTIVES_LABEL") + " / " + this.get("tra.MATCH_HISTORY_OVERVIEW_EVENT_KILLS_LABEL");
                    for (let e = 0; e < 4; e++) l.append("svg:text").attr("x", a.textPositions.x).attr("y", a.textPositions.y[e]).attr("class", "match-details-event-label").text(e % 2 == 0 ? r : "");
                    this.createTooltip()
                },
                createTooltip: function() {
            ...
            e.exports = (n.default || n).template({
                1: function(e, t, a, n, s, l) {
                    var i;
                    return null != (i = a.unless.call(null != t ? t : e.nullContext || {}, null != (i = l[0][0]) ? i.isEmpty : i, {
                        name: "unless",
                        hash: {},
                ...
                2: function(e, t, a, n, s, l) {
                    ...
                    return '      <div class="event-tooltip-container-' + p(typeof(o = null != (o = a.key || s && s.key) ? o : c) === m ? o.call(r, {
                        name: "key",
                        hash: {},
                        data: s,
                        blockParams: l
                    }) : o) + '">\r\n        <hr class="event-tooltip-line event-tooltip-line-' + p(typeof(o = null != (o = a.key || s && s.key) ? o : c) === m ? o.call(r, {
                        name: "key",
                        hash: {},
                        data: s,
                        blockParams: l
                    }) : o) + '">\r\n        <div class="event-tooltip-rows">\r\n' + (null != (i = a.each.call(r, null != (i = l[1][0]) ? i.rows : i, {
                        name: "each",
                        hash: {},
                ...
                3: function(e, t, a, n, s, l) {
                    ...
                    return '          <div class="event-tooltip-row">\r\n            <div class="event-tooltip-icon event-tooltip-killer event-icon-' + r(o(null != (i = null != (i = l[0][0]) ? i.killer : i) ? i.class : i, t)) + '">\r\n              <div class="event-tooltip-icon-champion">\r\n                <div class="event-tooltip-icon-cover">\r\n                  <img src="' + r(o(null != (i = null != (i = l[0][0]) ? i.killer : i) ? i.imgSrc : i, t)) + '" class="event-tooltip-icon-img ' + r(o(null != (i = null != (i = l[0][0]) ? i.killer : i) ? i.imgClass : i, t)) + '"></img>\r\n                </div>\r\n              </div>\r\n            </div>\r\n            <div class="event-tooltip-kill-sign"></div>\r\n' + (null != (i = a.each.call(null != t ? t : e.nullContext || {}, null != (i = l[0][0]) ? i.victims : i, {
                        name: "each",
                        hash: {},
                ...
                4: function(e, t, a, n, s, l) {
                    var i;
                    return '              <div class="event-tooltip-icon event-tooltip-victim event-icon-' + e.escapeExpression(e.lambda(null != (i = l[0][0]) ? i.class : i, t)) + '">\r\n' + (null != (i = a.if.call(null != t ? t : e.nullContext || {}, null != (i = l[0][0]) ? i.isChampion : i, {
                        name: "if",
                        hash: {},
                ...
                5: function(e, t, a, n, s, l) {
                    var i;
                    return '                <div class="event-tooltip-icon-champion">\r\n                  <div class="event-tooltip-icon-cover">\r\n                    <img src="' + e.escapeExpression(e.lambda(null != (i = l[1][0]) ? i.imgSrc : i, t)) + '" class="event-tooltip-icon-img"></img>\r\n                  </div>\r\n                </div>\r\n'
                },
                compiler: [7, ">= 4.0.0"],
                main: function(e, t, a, n, s, l) {
                    var i;
                    return '<lol-uikit-tooltip>\r\n  <div class="match-details-event-tooltip">\r\n' + (null != (i = a.each.call(null != t ? t : e.nullContext || {}, null != t ? t.data : t, {
                        name: "each",
                        hash: {},
            ...
            function i(e, t, a, s, l) {
                n.TooltipManager.assign(e, "MapTooltip", {
                    timestamp: t,
                    killerImgSrc: a,
                    victimImgSrc: s,
                    killerTeam: l
            ...
            e.exports = n.Ember.Component.extend({
                ...
                playerImgSrcMap: n.Ember.computed("teams", (function() {
                    const e = {};
                    return this.get("teams").forEach((t => {
                        t.forEach((t => {
                ...
                draw: function(e) {
                    const {
                        mapsInfo: t
                    } = e.timelines, a = n.Lodash.extend(this.get("specs"), {
                        mapBg: this.get("mapBg"),
                        images: s
                    }), l = a.mapDomains[e.mapId], i = n.d3.select(this.$(".map-svg-wrapper").get(0)).append("svg").attr("width", a.mapW).attr("height", a.mapH), o = n.d3.scale.linear().domain([l.min.x, l.max.x]).range([0, a.mapW]), r = n.d3.scale.linear().domain([l.min.y, l.max.y]).range([a.mapH, 0]);
                    i.append("image").attr("xlink:href", a.mapBg).attr("x", "0").attr("y", "0").attr("width", a.mapW).attr("height", a.mapH), i.append("svg:g").attr("class", "champion-kills").selectAll("champion-kill").data(t.championKills).enter().append("svg:circle").attr("id", (e => "champkill_" + e.timestamp + "_" + e.victimId)).attr("cx", (e => o(e.position.x))).attr("cy", (e => r(e.position.y))).attr("r", a.circleR).attr("class", (e => `map-data champion-event champion-kill player-${e.playerId} data-fill-${e.teamId}`)).attr("display", "none"), i.append("svg:g").attr("class", "champion-deaths").selectAll("champion-death").data(t.championDeaths).enter().append("svg:image").attr("id", (e => "championDeath_" + e.timestamp + "_" + e.playerId)).attr("xlink:href", (e => a.images.death[e.teamId])).attr("x", (e => o(e.position.x) - a.iconW / 2)).attr("y", (e => r(e.position.y) - a.iconH / 2)).attr("width", a.iconW).attr("height", a.iconH).attr("class", (e => `map-data champion-event champion-death player-${e.playerId}`)).attr("display", "none"), i.append("svg:g").attr("class", "building-kills").selectAll("building-kill").data(t.buildingKills).enter().append("svg:image").attr("id", (e => "buildingKill_" + e.timestamp + "_" + e.playerId)).attr("xlink:href", (e => a.images[e.display][e.teamId])).attr("x", (e => o(e.position.x) - a.iconW / 2)).attr("y", (e => r(e.position.y) - a.iconH / 2)).attr("width", a.iconW).attr("height", a.iconH).attr("class", (e => `map-data building-kill player-${e.playerId}`)).attr("display", "none"), this.addTooltips(t)
                },
                addTooltips: function(e) {
                    ...
                    e.championKills.forEach((e => {
                        const {
                            ...
                            victimId: s
                        } = e, l = this.get("playerImgSrcMap")[e.playerId], i = this.get("playerImgSrcMap")[e.victimId], o = this.$().find(`#champkill_${a}_${s}`)[0];
                        ...
                        const {
                            ...
                            playerId: s
                        } = e, l = this.get("playerImgSrcMap")[e.killerId], i = this.get("playerImgSrcMap")[e.playerId], o = this.$().find(`#championDeath_${a}_${s}`)[0];
                        t(o, e.timestamp, l, i, e.killerTeamId), n.TooltipManager.disable(o)
                    })), e.buildingKills.forEach((e => {
                        const {
                            timestamp: a
                        } = e, {
                            playerId: s
                        } = e, l = this.get("playerImgSrcMap")[e.playerId], i = this.$().find(`#buildingKill_${a}_${s}`)[0];
                        t(i, e.timestamp, l, void 0, e.killerTeamId), n.TooltipManager.disable(i)
                    }))
                },
                resetVisibility: function() {
                    const e = function(e, t) {
                            const a = "champion" === e;
                            return t ? `.player-${t}${a?".champion-event":".building-kill"}` : a ? ".champion-kill" : ".building-kill"
                        }(this.get("displayType"), this.get("displayPlayer")),
                        t = this.$().find(".map-show");
                    for (let e = 0; e < t.length; e++) n.TooltipManager.disable(t[e]);
                    n.d3.selectAll(this.$(".map-show")).classed("map-show", !1).style("display", "none");
                    const a = this.$().find(e);
                    for (let e = 0; e < a.length; e++) n.TooltipManager.enable(a[e]);
                    n.d3.selectAll(this.$(e)).classed("map-show", !0).style("display", "inline")
                },
                actions: {
                ...
                didInsertElement: function() {
                    ...
                    if (e && this.get("mapBg")) {
                        ...
                        })), this.set("ownerTeamId", a[0][0].teamId), this.set("teams", a), this.draw(e), this.resetVisibility(), this.$(".map-type-selector")[0].refreshSelected()
                    }
                }
            })
        }, (e, t, a) => {
            ...
            const l = n.Ember.Component.extend({
                ...
                formattedTime: n.Ember.computed("timestamp", (function() {
                    ...
                    return 60 === t ? e + 1 + ":00" : t < 10 ? e + ":0" + t : e + ":" + t
                }))
            });
            n.default && n.default.EmberApplicationFactory.setFactoryDefinition({
                name: "MapTooltip",
            ...
            function i(e) {
                ...
                return n.Lodash.each(e, (e => {
                    n.Lodash.each(["kills", "assists", "minionsPlusNeutralMonstersCount", "goldEarned"], (a => {
                        e[a] > t[a] && (t[a] = e[a])
                    }))
                })), t
            }
            a(105), e.exports = n.Ember.Component.extend({
                classNames: ["match-details-scoreboard-component"],
                layout: a(106),
                subteams: n.Ember.computed("currentParticipant", "gameData", "hasObjectives", (function() {
                    const e = this.get("champions"),
                        t = this.get("gameData"),
                    ...
                    return n.Lodash.each(c, (s => {
                        s.hasBansOrObjectives = s.hasBans || a, s.placementDisplayText = r.formatString(l.MODE_PLACEMENT_TRA_KEY + s.placement);
                        const o = l.GAME_MODES_WITH_SUBTEAMS[t.gameMode].subteams.find((e => e.subteamId === s.subteamId));
                        if (o) {
                            const e = o.display;
                            s.teamNameDisplayText = r.get(e.label), s.teamIcon = e.icon
                        }
                        const c = i(s.participants);
                        n.Lodash.each(s.participants, (e => {
                            e.mostKills = e.kills === c.kills, e.mostAssists = e.assists === c.assists, e.mostMinionKills = e.minionsPlusNeutralMonstersCount === c.minionsPlusNeutralMonstersCount, e.mostGoldEarned = e.goldEarned === c.goldEarned
                        })), n.Lodash.each(s.bans, (t => t.squarePortraitPath = e.get(t.championId).squarePortraitPath))
                    })), c = c.sort((function(e, t) {
                        return e.placement - t.placement
                    })), c
                })),
                platformTeams: n.Ember.computed("currentParticipant", "gameData", "hasObjectives", (function() {
                    const e = this.get("champions"),
                        t = this.get("gameData"),
                        a = this.get("hasObjectives"),
                    ...
                    return n.Lodash.each(o, (t => {
                        t.hasBansOrObjectives = t.hasBans || a;
                        const s = i(t.participants);
                        n.Lodash.each(t.participants, (e => {
                            e.mostKills = e.kills === s.kills, e.mostAssists = e.assists === s.assists, e.mostMinionKills = e.minionsPlusNeutralMonstersCount === s.minionsPlusNeutralMonstersCount, e.mostGoldEarned = e.goldEarned === s.goldEarned
                        })), n.Lodash.each(t.bans, (t => t.squarePortraitPath = e.get(t.championId).squarePortraitPath))
                    })), o = n.Lodash.sortBy(o, (function(e) {
                        return e.teamId === l.teamId ? -1 : 0
                    })), o
                })),
                teams: n.Ember.computed("isGameModeWithSubteams", (function() {
                    return this.get("isGameModeWithSubteams") ? this.get("subteams") : this.get("platformTeams")
                })),
                subteamGameModeData: n.Ember.computed((function() {
                    return l.GAME_MODES_WITH_SUBTEAMS
                })),
                isGameModeWithSubteams: n.Ember.computed("gameData.gameMode", "subteamGameModeData", (function() {
                    return !!this.get("subteamGameModeData")[this.get("gameData.gameMode")]
                })),
                ...
                hasBans: n.Ember.computed((function() {
                    return this.get("teams").length > 0 && this.get("teams")[0].bans.length > 0
                })),
                hasObjectives: n.Ember.computed("gameData.gameMode", (function() {
                    return !l.GAME_MODES_WITHOUT_OBJECTIVES.includes(this.get("gameData.gameMode"))
                })),
                rightTitleText: n.Ember.computed("gameData.gameMode", (function() {
                    const e = this.get("tra"),
                        ...
                        a = this.get("hasObjectives");
                    let n = "";
                    return t && a ? n = "MATCH_DETAILS_BAN_AND_OBJECTIVES" : a ? n = "MATCH_DETAILS_OBJECTIVES" : t && (n = "MATCH_DETAILS_BAN"), e.get(n)
                })),
                removeAnimationWhenDone: n.Ember.on("didInsertElement", (function() {
                    const e = this.get("isHexakill") ? ".match-details-team-container-hexakill" : ".match-details-team-container",
                        t = n.Ember.$(this.element).find(e)[0];
                    t.addEventListener("webkitAnimationEnd", (function(e) {
                        e.target === t && "fade-in" === e.animationName && t.classList.remove("match-details-loading-fade-in")
                    }))
                }))
            })
        }, (e, t, a) => {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                })) : (n.logger.error(`Could not load details for game ID ${s} - details are empty or incomplete`), n.logger.trace(`Details fo game ID ${s}: ${JSON.stringify(e)}`));
                return c = c.filter((e => e.participants.length > 0)), n.Ember.A(c)
                ...
                o ? (o.forEach((function(e) {
                    ...
                    if (!c.find((t => t.subteamId === e.playerSubteamId))) {
                        const a = {};
                        a.subteamId = t, a.teamId = t, a.placement = e.subteamPlacement, a.hasBans = !1, a.placement <= 1 && (a.bans = i[0].bans, a.hasBans = !0), c.push(a)
                    }
                })), c = c.map((e => {
                    const n = (0, s.fromJson)(e, o, r, t);
                    return n.subteamId === a.playerSubteamId && n.set("isFirstTeam", !0), n
                }))) : (n.logger.error(`Could not load details for game ID ${l} - details are empty or incomplete`), n.logger.trace(`Details fo game ID ${l}: ${JSON.stringify(e)}`));
                return c = c.filter((e => e.participants.length > 0)), n.Ember.A(c)
            };
            var n = a(1),
                s = a(102),
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                const o = t.filter((t => t.playerSubteamId === e.subteamId)).map((e => {
            ...
            const i = s.Ember.Object.extend({
                ...
                kills: s.Ember.computed("participants.[]", (function() {
                    return s.Lodash.sum(this.get("participants").map((e => e.stats.kills)))
                })),
                deaths: s.Ember.computed("participants.[]", (function() {
                    return s.Lodash.sum(this.get("participants").map((e => e.stats.deaths)))
                })),
                assists: s.Ember.computed("participants.[]", (function() {
                    return s.Lodash.sum(this.get("participants").map((e => e.stats.assists)))
                })),
                gold: s.Ember.computed("participants.[]", (function() {
                    return s.Lodash.sum(this.get("participants").map((e => e.stats.goldEarned)))
                })),
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.default = void 0, t.fromJson = function(e, t, a, n) {
                const o = t.filter((t => t.teamId === e.teamId)).map((e => {
                        const t = a.find((t => t.participantId === e.participantId)),
                            i = new l.default(e, t),
                            o = n.get(i.championId);
                        return i.titleInfo = {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.MODE_PLACEMENT_TRA_KEY = t.GAME_MODES_WITH_SUBTEAMS = t.GAME_MODES_WITHOUT_OBJECTIVES = void 0;
            ...
            function p(e, t) {
                n.TooltipManager.assign(e, "ScoreboardTooltip", {
                    traString: t,
                    tra: this.get("tra")
                }, {
                    ComponentFactory: n.ComponentFactory,
            ...
            e.exports = n.Ember.Component.extend({
                ...
                isGameModeWithCS: n.Ember.computed("gameMode", (function() {
                    return !l.default.GAME_MODES_WITHOUT_CS.includes(this.get("gameMode"))
                })),
                teamScore: n.Ember.computed("team.participants.0.stats.playerScore0", "teamKdaOverride.scoreStat", "tra.metadata.locale.id", (function() {
                    const e = this.get("teamKdaOverride.scoreStat");
                    if (!e) return;
                    const t = this.get(`team.participants.0.stats.${e}`) || 0;
                    return s.default.formatGold(t, this.get("tra.metadata.locale.id"))
                })),
                teamScoreGrade: n.Ember.computed("team.participants.0.stats.playerScore1", "teamKdaOverride.gradeStat", (function() {
                    const e = this.get("teamKdaOverride.gradeStat");
                    if (e) {
                        const t = this.get(`team.participants.0.stats.${e}`) || o.length;
                        return o[t - 1]
                    }
                })),
                formattedTeamGold: n.Ember.computed("team", "tra.metadata.locale.id", (function() {
                ...
                setupTooltip: n.Ember.on("didInsertElement", (function() {
                    ...
                    if (this.get("teamKdaOverride")) {
                        e(n.Ember.$(this.element).find("." + this.get("teamKdaOverride.styleClass"))[0], this.get("teamKdaOverride.traKey"))
                    } else {
                        e(n.Ember.$(this.element).find(".match-details-team-kill")[0], "MATCH_HISTORY_SCOREBOARD_TEAM_KDA")
                    }
                    const t = n.Ember.$(this.element).find(".match-details-team-gold")[0],
                        a = n.Ember.$(this.element).find(".match-details-team-kill-icon")[0];
                    if (this.get("playerCSOverride")) {
                        e(n.Ember.$(this.element).find("." + this.get("playerCSOverride.styleClass")), this.get("playerCSOverride.traKey"))
                    } else {
                        e(n.Ember.$(this.element).find(".match-details-team-cs-icon")[0], "MATCH_HISTORY_SCOREBOARD_CS_ICON")
                    }
                    if (this.get("playerGoldOverride")) {
                        e(n.Ember.$(this.element).find("." + this.get("playerGoldOverride.styleClass")), this.get("playerGoldOverride.traKey"))
                    } else {
                        e(n.Ember.$(this.element).find(".match-details-team-gold-icon")[0], "MATCH_HISTORY_SCOREBOARD_GOLD_ICON")
                    }
                    e(t, "MATCH_HISTORY_SCOREBOARD_TEAM_GOLD"), e(a, "MATCH_HISTORY_SCOREBOARD_KDA_ICON")
                }))
            })
        }, (e, t, a) => {
            "use strict";
            ...
            e.exports = n.Ember.Component.extend({
                ...
                showRiftHerald: n.Ember.computed("mapId", "team.riftHeraldKills", (function() {
                    return 11 === this.get("mapId") && void 0 !== this.get("team.riftHeraldKills")
                })),
                participantMap: n.Ember.computed("team.participants", (function() {
                    const e = {};
                    return this.get("team.participants").forEach((t => {
                        e[t.participantId] = !0
                    })), e
                })),
                elementalData: n.Ember.computed("gameTimeline", (function() {
                    const e = [];
                    if (this.get("team.dragonKills") > 0 && this.get("gameTimeline.frames")) {
                        ...
                        for (let n = 0; n < a.length; n++) {
                            ...
                            if (s)
                                for (let a = 0; a < s.length; a++) {
                                    const n = s[a];
                                    l[n.monsterSubType] && t[n.killerId] && e.push(l[n.monsterSubType])
                                }
                        }
                    }
                    return e
                ...
                setupTooltip: n.Ember.on("didInsertElement", (function() {
                    const e = s.bind(this);
                    e(n.Ember.$(this.element).find(".tower-icon")[0], "MATCH_HISTORY_SCOREBOARD_OBJECTIVE_TOWER");
                    if (e(n.Ember.$(this.element).find(".inhibitor-icon")[0], "MATCH_HISTORY_SCOREBOARD_OBJECTIVE_INHIBITOR"), this.get("showBaron")) {
                        e(n.Ember.$(this.element).find(".baron-icon")[0], "MATCH_HISTORY_SCOREBOARD_OBJECTIVE_BARON")
                    }
                    if (this.get("showDragon")) {
                        e(n.Ember.$(this.element).find(".dragon-icon")[0], "MATCH_HISTORY_SCOREBOARD_OBJECTIVE_DRAGON", "ElementalTooltip", this.get("elementalData"))
                    }
                    if (this.get("showRiftHerald")) {
                        e(n.Ember.$(this.element).find(".rift-herald-icon")[0], "MATCH_HISTORY_SCOREBOARD_OBJECTIVE_RIFT_HERALD")
                    }
                    if (this.get("showVilemaw")) {
                        e(n.Ember.$(this.element).find(".vilemaw-icon")[0], "MATCH_HISTORY_SCOREBOARD_OBJECTIVE_VILEMAW")
                    }
                }))
            })
        }, (e, t, a) => {
            ...
            e.exports = r.extend(l.DataBindingMixin, {
                ...
                classNameBindings: ["selectable", "isCurrentParticipant:me", "showHighLightClass:high-spec-highlight"],
                isThirdPersonView: !1,
                displayTooltip: !1,
                hasAssignedTooltip: !1,
                playerReportsService: s.Ember.inject.service("player-reports"),
                goldEarnedDisplay: c("participant.stats", "tra.metadata.locale.id", (function() {
                ...
                isCurrentParticipant: s.Ember.computed("currentParticipant", "participant", (function() {
                ...
                spellDTOs: c("participant.spellIds.[]", d("spells", "participant.spellIds")),
                ...
                itemDTOs: c("participant.itemIds.[]", d("items", "participant.itemIds")),
                ...
                playerNames: c("summonerName", "gameName", "tagLine", (function() {
                    const e = this.get("summonerName"),
                        t = this.get("gameName"),
                        a = this.get("tagLine");
                    return t && a ? this.get("_playerNames").formatPlayerName({
                        summonerName: e,
                        gameName: t,
                        tagLine: a
                    }) : e
                ...
                squarePortraitPath: c("champions", "participant.championId", (function() {
                    const e = this.get("champions"),
                        t = this.get("participant.championId");
                    return e && t ? e.get(t).squarePortraitPath : ""
                })),
                isSummonerBlocked: s.Ember.computed("blockedPlayers.[]", "summonerId", (function() {
                    return s.Lodash.findIndex(this.get("blockedPlayers"), {
                        summonerId: this.get("summonerId")
                    }) > -1
                })),
                isSummonerFriend: s.Ember.computed("friends.[]", "summonerId", (function() {
                    return s.Lodash.findIndex(this.get("friends"), {
                        summonerId: this.get("summonerId")
                    }) > -1
                })),
                showHighLightClass: s.Ember.computed("lowSpecModeSettings", (function() {
                    const e = this.get("lowSpecModeSettings");
                    return !Boolean(e && e.data && !0 === e.data.potatoModeEnabled)
                })),
                ...
                playerCSDisplay: c("queueId", "participant", (function() {
                    ...
                    return e ? this.get(`participant.${e}`) : this.get("participant.minionsPlusNeutralMonstersCount")
                })),
                playerGoldDisplay: c("queueId", "goldEarnedDisplay", (function() {
                    const e = m[this.get("queueId")];
                    return e ? this.get(`participant.${e}`) : this.get("goldEarnedDisplay")
                })),
                init() {
                ...
                addContextMenu() {
                    this.$()[0].addEventListener("contextmenu", (e => {
                        ...
                        t.length > 0 && (s.ContextMenuManager.setMenuItems(t), s.ContextMenuManager.openAtEvent(e))
                    }))
                },
                isLocalPlayerInGame: c("currentParticipant.player.puuid", "localPuuid", (function() {
                    return this.get("currentParticipant.player.puuid") === this.get("localPuuid")
                })),
                ...
                isPlayerReported: c("playerReportsService.reportedPlayers.[]", "participant.player.puuid", (function() {
                    const e = this.get("participant.player.puuid"),
                        t = this.get("playerReportsService.reportedPlayers") || [];
                    return !!(t && t.length > 0) && t.includes(e)
                })),
                cannotReportPlayer: c("hasGameReportWindowExpired", "isLocalPlayerInGame", "isPlayerReported", (function() {
                ...
                getMenuItemModel: function() {
                    ...
                    if (this.get("itemSetsEnabled")) {
                        const t = this.get("champion"),
                            ...
                            l = void 0 !== s && void 0 !== s.itemSets && s.itemSets.length >= a,
                            i = {
                                label: this.get("tra.MATCH_HISTORY_SCOREBOARD_MENU_IMPORT_ITEM_SET"),
                                target: this,
                                disabled: l,
                                action: function() {
                    ...
                    let i;
                    this.get("isSummonerBlocked") ? i = this.get("blockedPlayers").findBy("summonerId", l).id : this.get("isFriend") && (i = this.get("friends").findBy("summonerId", l).id);
                    const o = this.get("session.summonerId");
                    if (l === o) return e;
                    const r = {
                            label: this.get("tra.MATCH_HISTORY_SCOREBOARD_MENU_VIEW_PROFILE"),
                            target: this,
                            action: function() {
                                (0, s.getProvider)().get("rcp-fe-lol-profiles").showOverlay({
                                    summonerId: this.get("summonerId")
                                })
                            }
                        },
                        c = {
                            label: this.get("tra.MATCH_HISTORY_SCOREBOARD_MENU_BLOCK_PLAYER"),
                            target: this,
                            action: function() {
                        ...
                        m = {
                            label: this.get("tra.MATCH_HISTORY_SCOREBOARD_MENU_UNBLOCK_PLAYER"),
                            target: this,
                            action: function() {
                                this.get("api.bindings.chat").delete(`/v1/blocked-players/${i}`)
                            }
                        },
                        p = {
                            ...
                            target: this,
                            action: function() {
                                this.get("api.bindings.chat").post("/v1/friend-requests/", {
                                    name: this.get("summonerName")
                                })
                            }
                        },
                        d = {
                            label: this.get("tra.MATCH_HISTORY_SCOREBOARD_MENU_REMOVE_FRIEND"),
                            target: this,
                            action: function() {
                        ...
                        g = {
                            label: this.get("tra.MATCH_HISTORY_SCOREBOARD_MENU_BLOCK_BTN_REPORT"),
                            target: this,
                            disabled: this.get("cannotReportPlayer"),
                            action: function() {
                                s.SharedReportModalApps.showReportModal(h, u, "LOL", "MATCH_HISTORY")
                            }
                        };
                    return e = e.concat([r, this.get("isSummonerBlocked") ? m : c, this.get("isSummonerFriend") ? d : p, g]), e
                },
                confirmBlockPlayer(e, t, a) {
                    const n = (0, s.getProvider)().get("rcp-fe-lol-uikit"),
                        l = n.getTemplateHelper(),
                        i = n.getModalManager(),
                        o = l.contentBlockDialog(this.get("tra.MATCH_HISTORY_SCOREBOARD_MENU_BLOCK_CONFIRM_TITLE"), this.get("tra").formatString("MATCH_HISTORY_SCOREBOARD_MENU_BLOCK_CONFIRM_TEXT", {
                            name: a
                        ...
                        r = i.add({
                            ...
                            data: {
                                contents: o,
                                acceptText: this.get("tra.MATCH_HISTORY_SCOREBOARD_MENU_BLOCK_BTN_BLOCK"),
                                declineText: this.get("tra.MATCH_HISTORY_SCOREBOARD_MENU_BLOCK_BTN_CANCEL"),
                                closeButton: !1
                            }
                        }),
                        c = r.domNode.querySelector(".confirm-friend-actions");
                    c.style.width = "360px", c.querySelector("p").style.textAlign = "left", r.acceptPromise.then((() => {
                ...
                confirmImportItemSet(e, t) {
                    const a = {
                        ...
                        name: this.get("tra").formatString("MATCH_HISTORY_ITEM_SETS_IMPORT_NAME", {
                            champion: e.name,
                            summoner: t
                        }),
                        maps: [this.get("mapId")],
                ...
                assignAllTooltips() {
                    ...
                    l.each((function(t) {
                        const a = e.get(i[t]);
                        a && s.TooltipManager.assign(this, "SpellTooltip", {
                            spell: a,
                            tra: n
                        }, {
                            ComponentFactory: s.ComponentFactory,
                    ...
                    o.each((function(e) {
                        const t = a.get(r);
                        t && s.TooltipManager.assign(this, "KeystoneTooltip", {
                            keystone: t,
                            tra: n
                        }, {
                            ComponentFactory: s.ComponentFactory,
                    ...
                    if (c.each((function(e) {
                            const a = t.get(m[e]);
                            a && s.TooltipManager.assign(this, "ItemTooltip", {
                                item: a
                            }, {
                                ComponentFactory: s.ComponentFactory,
                                targetAnchor: {
                ...
                didRender() {
                    !this.get("hasAssignedTooltip") && this.get("displayTooltip") && this.assignAllTooltips()
                }
            })
        }, (e, t) => {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.NUMBER_OF_AUGMENTS = t.MAP_IDS_WITH_AUGMENTS = t.MAP_IDS_WITHOUT_CS = void 0;
            ...
            a(135), e.exports = n.Ember.Component.extend({
                ...
                sortProperty: ["teamId"],
                sortedParticipants: n.Ember.computed.sort("stats.participants", (function(e, t) {
                ...
                removeAnimationWhenDone: n.Ember.on("didInsertElement", (function() {
                    const e = n.Ember.$(this.element).find(".match-stats-container")[0];
                    e.addEventListener("webkitAnimationEnd", (function(t) {
                        t.target === e && "fade-in" === t.animationName && e.classList.remove("match-details-loading-fade-in")
                    }))
                })),
                ...
                didInsertElement() {
                    this._super(...arguments), this.element.addEventListener("selectHoverColumnIndex", (e => {
                        this.hoverColumn(e.columnIndex)
                    })), this.element.addEventListener("deselectHoverColumnIndex", (e => {
            ...
            a(139), e.exports = n.Ember.Component.extend({
                ...
                validParticipants: n.Ember.computed("participants", "participants.[]", "teamId", (function() {
            ...
            e.exports = n.Ember.Component.extend({
                ...
                currentParticipantIndex: n.Ember.computed("participants", "participant", (function() {
                    return this.get("participants").indexOf(this.get("participant"))
                })),
                avatarSrc: n.Ember.computed("participant.championId", (function() {
                    return this.get("champions").get(this.get("participant.championId")).squarePortraitPath
                })),
                mouseEnter: function() {
                    const e = new Event("selectHoverColumnIndex", {
                        bubbles: !0
                    });
                    e.columnIndex = this.get("currentParticipantIndex"), this.element.dispatchEvent(e)
                },
                mouseLeave: function() {
                    const e = new Event("deselectHoverColumnIndex", {
                        bubbles: !0
                    });
                    e.columnIndex = this.get("currentParticipantIndex"), this.element.dispatchEvent(e)
                },
                isCurrent: n.Ember.computed("currentSummonerId", "summonerId", (function() {
                    return !!this.get("currentSummonerId") && this.get("currentSummonerId") === this.get("summonerId")
                }))
            })
        }, (e, t, a) => {
            const n = a(1).Ember;
            ...
            e.exports = n.Ember.Component.extend({
                ...
                actions: {
                    toggle: function() {
                        s.SFX.genericClickSm.play(), this.set("isOpen", !this.get("isOpen"))
                    }
                }
            })
        }, (e, t, a) => {
            ...
            e.exports = n.Ember.Component.extend({
                ...
                index: null,
                participants: null,
                cellContents: n.Ember.computed("participants", "tra.metadata.locale.id", (function() {
                    ...
                    return this.get("participants").map((function(i) {
                        ...
                        switch (t) {
                            case "concatKDA":
                                o = s.default.concatKDA(i.stats[e[0]], i.stats[e[1]], i.stats[e[2]]);
                                break;
                ...
                isParticipantsPopulated: n.Ember.computed("participants", (function() {
                    const e = this.get("participants");
                    return !(!e || Array.isArray(e) && !e[0])
                })),
                isAttrWithData: n.Ember.computed("attr", "isParticipantsPopulated", (function() {
                    if (!this.get("isParticipantsPopulated")) return !1;
                    const e = this.get("attr"),
                        t = this.get("participants");
                    if (e && Array.isArray(e.key)) e.key.forEach((function(e) {
                        if (void 0 === t[0].stats[e]) return !1
                    }));
                    else if (e && void 0 === t[0].stats[e.key]) return !1;
                    return !0
                })),
                showStat: n.Ember.computed("attr.hideOnMurderBridge", "mapId", (function() {
                ...
                actions: {
                    columnHovered: function(e) {
                        const t = new Event("selectHoverColumnIndex", {
                            bubbles: !0
                        });
                        t.columnIndex = e, this.element.dispatchEvent(t)
                    },
                    columnLoseHover: function(e) {
                        const t = new Event("deselectHoverColumnIndex", {
                            bubbles: !0
                        });
                        t.columnIndex = e, this.element.dispatchEvent(t)
                    }
            ...
            a(150), e.exports = n.Ember.Component.extend({
                ...
                myTeamId: n.Ember.computed.alias("statsCurrentParticipant.teamId"),
                columnContents: n.Ember.computed("players", "myTeamId", (function() {
            ...
            e.exports = n.Ember.Component.extend({
                ...
                stats: n.Ember.inject.service(),
                mapId: null,
                statsCategories: n.Ember.computed("tra.metadata", "stats.participants", "mapId", (function() {
                    const e = s,
                        t = n.Ember.A([]),
                        a = this.get("mapId");
                    return e.forEach((e => {
                        const s = n.Ember.Object.create();
                        s.set("name", e.name), s.set("selected", !1), s.set("attributes", n.Ember.A([])), s.set("locString", this.get(`tra.${e.name}`)), e.attributes.forEach((e => {
                            const t = n.Ember.Object.create();
                            t.set("name", e.name), t.set("key", e.key), t.set("locString", this.get(`tra.${e.name}`)), t.set("selected", !1), t.set("disabled", !1);
                            const l = e.hideOnMurderBridge;
                            (void 0 === l || !0 === l && 12 !== a && 14 !== a) && void 0 !== this.get(`stats.participants.0.stats.${e.key}`) && s.attributes.push(t)
                        })), t.push(s)
                    })), t
                })),
                selectFirstCategory: n.Ember.on("didInsertElement", n.Ember.observer("stats.participants", (function() {
                    this.get("statsCategories.0.attributes.0") && (this.set("statsCategories.0.attributes.0.selected", !0), this.send("selectAttribute", this.get("statsCategories.0.attributes.0")))
                }))),
                ...
                _setDisableValues: function() {
                    ...
                    t.forEach((function(t) {
                        ...
                        t.attributes.forEach((function(t) {
                            const a = e >= 6;
                            !t.get("selected") && a ? t.set("disabled", !0) : t.set("disabled", !1)
                        }))
                    }))
                },
                actions: {
                    selectCategory: function(e) {
                        const t = this.get("statsCategories");
                        e.selected ? t.forEach((function(t) {
                            t.name === e.name ? (t.set("selected", !0), t.attributes.forEach((function(e) {
                                e.set("selected", !0)
                            }))) : (t.set("selected", !1), t.attributes.forEach((function(e) {
                                e.set("selected", !1)
                            })))
                        })) : t.forEach((function(t) {
                            t.name === e.name && (t.set("selected", !1), t.attributes.forEach((function(e) {
                                e.set("selected", !1), e.set("disabled", !1)
                            })))
                        })), this._setDisableValues(), this._setSelectedAttributes()
                    },
                    selectAttribute: function(e) {
                        this.get("statsCategories").forEach((function(t) {
                            let a = 0;
                            t.attributes.forEach((function(n) {
                                n.name === e.get("name") && e.get("selected") && t.set("selected", !0), n.get("selected") && a++
            ...
            e.exports = n.Ember.Component.extend({
                ...
                layout: a(161),
                stats: n.Ember.inject.service(),
                graphData: n.Ember.computed("selectedAttributes", "stats.participants", "stats.currentSummonerId", (function() {
                    ...
                    let s = 1,
                        l = !1;
                    return a && 0 !== a.length ? (a.forEach((function(a) {
                        const i = {},
                            o = a.summonerId === t;
                        o && (l = !0), i.isCurrent = o, i.isLocalPlayer = o, i.teamId = a.teamId, i.championId = a.championId, i.graphYAxisIndex = s++, i.stats = [], e.forEach((function(e) {
                            const t = {};
                            t.id = e.key, t.value = a.stats[e.key], t.name = e.locString, t.teamId = a.teamId, i.stats.push(t)
                        })), n.push(i)
                    })), l || (n[0].isCurrent = !0), this._applyTeamColors(n)) : n
                })),
                fetchChampionData: n.Ember.on("didInsertElement", (function() {
                    s.champions.then((e => this.set("championData", e)))
                })),
                generateRerenderGraphData: n.Ember.on("didInsertElement", n.Ember.observer("graphData", "championData", (function() {
                    this.get("graphData.length") && this.get("championData") && (this.get("isInitialGraphRendered") || (this.renderInitialGraph(), this.set("isInitialGraphRendered", !0)), this.rerenderGraph())
                }))),
                renderInitialGraph: function() {
                    const e = this.get("graphData"),
                        ...
                        m = n.d3.scale.ordinal().rangeBands([0, r], .4),
                        p = n.d3.scale.ordinal(),
                        d = n.d3.svg.axis().scale(c).orient("bottom").tickFormat(n.d3.format("d")).innerTickSize(-r).outerTickSize(0),
                        h = n.d3.svg.axis().scale(m).orient("left"),
                        u = n.d3.select(".match-graph-display .match-main-graph").append("svg").attr("width", o + i + a).attr("height", r + t + s),
                        g = u.append("g").attr("transform", "translate(" + i + "," + t + ")");
                    c.domain([0, 0]), m.domain(e.map((function(e) {
                        return e.graphYAxisIndex
                    }))), this._appendAxis(d, h, g, r), this._initialAvatarsRender(e, u, m), this.set("x", c), this.set("y0", m), this.set("y1", p), this.set("xAxis", d), this.set("yAxis", h), this.set("svg", g)
                },
                rerenderGraph: function() {
                    ...
                    t.domain([0, n.d3.max(e, (function(e) {
                        return n.d3.max(e.stats, (function(e) {
                            return e.value
                        }))
                    }))]), s.domain(o).rangeRoundBands([0, a.rangeBand()]), l.selectAll(".match-graph-x-axis").call(i);
                ...
                _renderChampions: function(e) {
                    const t = this.get("y0");
                    e.enter().append("g").attr("class", "match-graph-champion").attr("transform", (function(e) {
                        const a = e.teamColor === i ? 0 : 16;
                        return `translate(0, ${t(e.graphYAxisIndex)+a-8})`
                    }))
                },
                _renderStats: function(e, t) {
                    const a = n.d3.scale.ordinal().range(["#1ba9bd", "#098c9e", "#06535d", "#04434a"]),
                        s = n.d3.scale.ordinal().range(["#ec2040", "#be1e37", "#8c1728", "#721220"]),
                        l = this.get("y1"),
                        o = this.get("x");
                    e.enter().append("rect").attr("width", 0), e.attr("x", 1).attr("id", (function(e) {
                        return e.id
                    ...
                    })).transition().attr("y", (function(e, a) {
                ...
                _applyTooltips: function(e) {
                    e.on("mouseover", (e => {
                        ...
                        this.$(`.${e.id}-tooltip`).remove(), this.$(".match-main-graph-tooltip-hint").remove()
                    }))
                },
                _applyTeamColors: function(e) {
                    const t = e.find((e => e.isCurrent)),
                        a = [],
                        n = [];
                    return t && (t.teamColor = i, t.stats.forEach((e => e.teamColor = i)), a.push(t)), e.forEach((function(e) {
                        e.teamId === t.teamId && !e.isCurrent ? (e.teamColor = i, e.stats.forEach((e => e.teamColor = i)), a.push(e)) : e.isCurrent || (e.teamColor = "red", e.stats.forEach((e => e.teamColor = "red")), n.push(e))
                    })), a.concat(n)
                },
                _appendAxis(e, t, a, n) {
                    a.append("g").attr("class", "match-graph-axis match-graph-x-axis").attr("transform", "translate(0," + n + ")").classed("grid", !0).call(e), a.append("g").attr("class", "match-graph-axis match-graph-y-axis").call(t)
                },
                _initialAvatarsRender: function(e, t, a) {
                    t.select(".match-graph-y-axis").selectAll("text").remove(), t.append("clipPath").attr("id", "avatar-clip").append("circle").attr("cx", 21).attr("cy", 20).attr("r", 13);
                    const n = t.selectAll(".match-graph-y-axis").selectAll(".tick").data(e).attr("class", (function(e) {
                        const t = e.isLocalPlayer ? "local-player" : "";
                        return `tick team-${e.teamColor} ${t}`
                    })).attr("transform", (function(e) {
                        const t = e.teamColor === i ? 0 : 16;
                        return `translate(0, ${a(e.graphYAxisIndex)+t-8+a.rangeBand()/2-15})`
                    }));
                    n.append("circle").attr("class", "avatar-border");
                    const s = this.get("championData");
                    n.append("svg:image").attr("class", "avatar").attr("xlink:href", (function(e) {
            ...
            e.exports = n.HTMLBars.template({
                id: "TI95IucQ",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-match-history\\\\src\\\\components\\\\graph\\\\graph-display\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-match-history\\\\src\\\\components\\\\graph\\\\graph-display\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-match-history\\\\src\\\\components\\\\graph\\\\graph-display\\\\index.js\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","match-main-graph"],["flush-element"],["close-element"],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, a) => {
            "use strict";
            ...
            e.exports = n.Ember.Component.extend({
                ...
                selectedAttributes: n.Ember.A([]),
                stats: n.Ember.inject.service(),
                statsCurrentParticipant: n.Ember.computed("stats.participants", "stats.currentSummonerId", "currentParticipant.summonerId", (function() {
                    const e = this.get("stats.participants"),
                ...
                playerStats: n.Ember.computed.readOnly("statsCurrentParticipant.stats"),
                runesPrimaryStyle: n.Ember.computed("playerStats.perkPrimaryStyle", "runesStyles", (function() {
                    const e = this.get("playerStats.perkPrimaryStyle");
                    return (this.get("runesStyles") || n.Ember.Map.create()).get(e)
                })),
                runesSubStyle: n.Ember.computed("playerStats.perkSubStyle", "runesStyles", (function() {
            ...
            e.exports = n.Ember.Component.extend({
                ...
                statStrings: n.Ember.computed("stats.rune.endOfGameStatDescs", "stats.vars", (function() {
                    const e = this.get("stats.vars") || [];
                    let t = this.get("stats.rune.endOfGameStatDescs") || [];
                    return t.length <= 0 && (t = ["--"]), t.map((t => this.fillInPlaceholders(t, e)))
                })),
            ...
            e.exports = o.extend(l.DataBindingMixin, {
                ...
                goldEarnedDisplay: r("participant.goldEarned", "tra.metadata.locale.id", (function() {
                    const e = this.get("participant.goldEarned"),
                        t = this.get("tra.metadata.locale.id");
                    return i.default.formatGold(e, t)
                })),
                kdaDisplay: r("participant.kills", "participant.deaths", "participant.assists", (function() {
                    return `${this.get("participant.kills")} / ${this.get("participant.deaths")} / ${this.get("participant.assists")}`
                })),
                spellDTOs: r("participant.spellIds.[]", c("spells", "participant.spellIds")),
                itemDTOs: r("participant.itemIds.[]", c("items", "participant.itemIds")),
                ...
                assignAllTooltips() {
                    ...
                    n.each((function(t) {
                        const n = e.get(l[t]);
                        n && s.TooltipManager.assign(this, "SpellTooltip", {
                            spell: n,
                            tra: a
                        }, {
                            ComponentFactory: s.ComponentFactory,
            ...
            e.exports = n.Ember.Service.extend(i, {
                _eogParticipants: n.Ember.computed("eogStatsBlock", (function() {
                    ...
                    t.forEach((function(e) {
                        const t = {};
                        t.teamId = e.teamId, t.championId = e.championId, t.summonerId = e.summonerId, t.champLevel = e.stats.LEVEL, t.goldEarned = e.stats.GOLD_EARNED, t.championId = e.championId, t.player = {}, t.player.summonerName = e.summonerName, t.player.summonerId = e.summonerId, t.spellIds = [], t.spellIds[0] = e.spell1Id, t.spellIds[1] = e.spell2Id, t.itemIds = e.items, t.stats = {}, Object.keys(s).forEach((function(a) {
                            t.stats[s[a]] = e.stats[a]
                        })), Object.keys(l).forEach((function(a) {
                            t.stats[l[a]] = e.stats[a]
                        })), t.minionsPlusNeutralMonstersCount = t.stats.totalMinionsKilled + t.stats.neutralMinionsKilled, t.kills = t.stats.kills, t.deaths = t.stats.deaths, t.assists = t.stats.assists, a.push(t)
                    }));
                    const i = this.get("currentSummonerId");
                    return a = n.Lodash.sortBy(a, ["teamId", function(e) {
                ...
                _legsParticipants: n.Ember.computed("legsGameData", (function() {
                    ...
                    return t.forEach((function(t) {
                        const n = {},
                            s = e.participantIdentities.find((e => e.participantId === t.participantId));
                        n.summonerId = s.player.summonerId, n.teamId = t.teamId, n.championId = t.championId, n.stats = t.stats, a.push(n)
                    })), a
                })),
                setSourceOptions: function(e) {
                    if (this.get("dataSource")) throw "rcp-fe-lol-match-history: you should only use setSourceOptions once.";
                    this.set("dataSource", e.dataSource), this.set("baseGameId", e.baseGameId), this.set("baseSummonerId", e.baseSummonerId)
                },
                currentSummonerId: n.Ember.computed("dataSource", "session.summonerId", "baseSummonerId", (function() {
                    return "eogStats" === this.get("dataSource") ? this.get("session.summonerId") : "legs" === this.get("dataSource") ? this.get("baseSummonerId") : -1
                })),
                gameId: n.Ember.computed("dataSource", "eogStatsBlock", "baseGameId", (function() {
                    return "eogStats" === this.get("dataSource") ? this.get("eogStatsBlock.reportGameId") : "legs" === this.get("dataSource") ? this.get("baseGameId") : void 0
                })),
                participants: n.Ember.computed("dataSource", "_eogParticipants", "_legsParticipants", (function() {
                    return "eogStats" === this.get("dataSource") ? this.get("_eogParticipants") : "legs" === this.get("dataSource") ? this.get("_legsParticipants") : n.Ember.A([])
                }))
            })
        }],
        t = {};
        ...
        s.addEventListener(l, (function(e) {
            (0, e.registrationHandler)((function(e) {
                return t.default.init(e, {
                    ...
                    dataBinding: e => e.get("rcp-fe-common-libs").getDataBinding("rcp-fe-lol-match-history"),
                    Ember: e => e.get("rcp-fe-ember-libs").getEmber(),
                    EmberDataBinding: e => e.get("rcp-fe-ember-libs").getEmberDataBinding("rcp-fe-lol-match-history"),
