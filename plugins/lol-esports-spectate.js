    ...
    var e = [, e => {
            ...
            var a = new class {
                ...
                init() {
                    ...
                    this.initialized || (this.initialized = !0, this._isShown = !1, this.screenRoot = s.fullScreen().getScreenRoot("lol-esports-spectate"), this.gameflowBinding = o("/lol-gameflow", e.getSocket()), i.ChampSelectPlugin.registerReplacementChampSelectHandler((e => e && e.isSpectating), this.show.bind(this), this.hide.bind(this)))
                }
                show() {
            ...
            e.exports = i.Ember.Component.extend({
                ...
                setSideColors: i.Ember.on("didInsertElement", (function() {
                    this.element.style.setProperty("--left-side-color", s), this.element.style.setProperty("--right-side-color", o)
                })),
                actions: {
                    updateColors: function() {
                        i.Ember.run.next((() => {
                            s = this.get("leftColor"), o = this.get("rightColor"), this.setSideColors()
                        }))
                    }
                }
            })
            ...
            const i = n(1),
                ...
                c = s.Object.extend({
                    ...
                    selectedBy: s.computed("root.summoners.@each.champion.id", "root.summoners.@each.isSelf", "id", (function() {
                    ...
                    disabledByPlatform: s.computed("active", "root.queue.gameMode", "disabledQueues.[]", (function() {
                        return !this.get("active") || (this.get("disabledQueues") || []).indexOf(this.get("root.queue.gameMode")) >= 0
                    })),
                    banned: s.computed("id", "root.sessionActions.completedBanActions.@each.championId", (function() {
                    ...
                    picked: s.computed("selected", "selectedBy.pickAction.completed", (function() {
                        return this.get("selected") && this.get("selectedBy.pickAction.completed")
                    })),
                    unselectable: s.computed("picked", "selectedByMe", "disabledByPlatform", "banned", (function() {
                        return this.get("picked") && !this.get("selectedByMe") || this.get("disabledByPlatform") || this.get("banned")
                    })),
                    canPlay: s.computed("root.pickableChampions.championIds.[]", (function() {
            ...
            const i = n(1),
                ...
                o = s.Object.extend({
                    ...
                    isSelected: s.computed("championSelectRoot.currentSummoner.selectedSkinId", "id", "chroma.isSelected", (function() {
                        return this.get("championSelectRoot.currentSummoner.selectedSkinId") === this.get("id") || this.get("chroma.isSelected")
                    })),
                    isViewed: s.computed("championSelectRoot.view.viewSkinId", (function() {
                    ...
                    chroma: s.computed("championSelectRoot.currentSummoner.selectedSkinId", "chromas.@each.id", (function() {
                        return s.A(this.get("chromas") || []).findBy("id", this.get("championSelectRoot.currentSummoner.selectedSkinId"))
                    })),
                    chromaIds: s.computed("chromas.@each.id", "chromas.[]", (function() {
                        return s.A(this.get("chromas") || []).mapBy("id")
                    })),
                    ownsChroma: s.computed("chromas.@each.id", "chromas.[]", "chromas.@each.ownership.owned", (function() {
                        const e = s.A(this.get("chromas") || []);
                        return e.mapBy("ownership.owned").reduce((function(e, t) {
                            return t && e
                        }), e.length > 0)
                    })),
                    unlocked: s.computed("ownership.owned", "ownership.rental.rented", "ownership.loyaltyReward", "championSelectRoot.teamBoost.boostedSkinIds", (function() {
            ...
            const i = n(1),
                ...
                o = s.Object.extend({
                    available: s.computed("gameModes.[]", "root.queue.gameMode", (function() {
                    ...
                    canUse: s.computed("summonerLevel", "root.localSummoner.summonerLevel", (function() {
            ...
            const i = n(1),
                ...
                a = s.Object.extend({
                    ...
                    champion: s.computed("root.inventory.@each.id", "championId", "pickAction.championId", (function() {
                        const e = this.get("championId") || this.get("pickAction.championId");
                        return (this.get("root.inventory") || s.A()).findBy("id", e)
                    })),
                    isSelf: s.computed("root.session.localPlayerCellId", "cellId", (function() {
                    ...
                    isOnPlayersTeam: s.computed("team", "root.currentSummoner.team", (function() {
                        return this.get("team") === this.get("root.currentSummoner.team")
                    })),
                    isOnLeftSide: s.computed("root.isSpectating", "isOnPlayersTeam", "isOnBlueSide", (function() {
                    ...
                    uncompletedAction: s.computed("actions.@each.completed", (function() {
                    ...
                    nextAction: s.computed("root.sessionActions.nextActions.@each.id", "actions.@each.isNext", (function() {
                        return this.get("actions").findBy("isNext", !0)
                    })),
                    isExclusivelyPickIntenting: s.computed.readOnly("root.session.timer.inPlanningPhase"),
                    isPickIntenting: s.computed("isExclusivelyPickIntenting", "pickAction", "pickAction.completed", "isPickingNow", "isBanningNow", (function() {
                    ...
                    actions: s.computed("root.sessionActions.allActions.@each.actorCellId", "cellId", (function() {
                    ...
                    hasUncompletedBanAction: s.computed("actions.@each.type", "actions.@each.completed", (function() {
                    ...
                    spell1: s.computed("root.spells.@each.id", "spell1Id", (function() {
                        return (this.get("root.spells") || s.A()).findBy("id", this.get("spell1Id"))
                    })),
                    spell2: s.computed("root.spells.@each.id", "spell2Id", (function() {
                        return (this.get("root.spells") || s.A()).findBy("id", this.get("spell2Id"))
                    })),
                    selectedWardSkin: s.computed("root.wardSkins.@each.id", "wardSkinId", (function() {
                        return (this.get("root.wardSkins") || s.A()).findBy("id", this.get("wardSkinId"))
                    })),
                    trade: s.computed("cellId", "root.session.trades.@each.cellId", (function() {
                        return (this.get("root.session.trades") || s.A()).findBy("cellId", this.get("cellId"))
                    }))
                });
            e.exports = a
        }, (e, t, n) => {
            ...
            const i = n(1),
                ...
                o = s.Object.extend({
                    ...
                    timeRemainingInMs: s.computed("internalNowInEpochMs", "adjustedTimeLeftInPhase", (function() {
                    ...
                    updateTimer: function() {
                        this.isDestroyed || this.isDestroying || this.timerRunning || (this.timerRunning = !0, this.get("timeRemainingInMs") > 0 ? (this.notifyPropertyChange("timeRemainingInMs"), s.run.later(this, (function() {
                    ...
                    displayedPhase: s.computed("inBanPickPhase", "root.sessionActions.activeAction.type", "root.sessionActions.banActions.length", "root.sessionActions.numBanActionsCompleted", "root.sessionActions.numPickActionsCompleted", (function() {
            ...
            const i = n(1),
                ...
                o = s.Object.extend({
                    champion: s.computed("root.inventory.@each.id", "championId", (function() {
                        return (this.get("root.inventory") || s.A()).findBy("id", this.get("championId"))
                    })),
                    delayedChampionSetter: s.observer("completed", "champion", s.on("init", (function() {
                        if (!this.get("completed") || !this.get("champion")) return void this.set("delayedChampion", null);
                        const e = this.get("champion");
                        s.run.later(function() {
                            this.isDestroyed || this.isDestroying || this.set("delayedChampion", e)
                        }.bind(this), 1)
                    }))),
                    actor: s.computed("actorCellId", "root.summoners.@each.cellId", (function() {
                        return (this.get("root.summoners") || s.A()).findBy("cellId", this.get("actorCellId"))
                    })),
                    ...
                    isActive: s.computed("root.sessionActions.activeActions.@each.id", "id", (function() {
                        return !!this.get("root.sessionActions.activeActions").findBy("id", this.get("id"))
                    })),
                    isCurrent: s.computed("root.sessionActions.currentActions.@each.id", "id", (function() {
                        return !!this.get("root.sessionActions.currentActions").findBy("id", this.get("id"))
                    })),
                    isNext: s.computed("root.sessionActions.nextActions.@each.id", "id", (function() {
            ...
            const i = n(1),
                ...
                c = s.Object.extend({
                    ...
                    currentActions: s.computed("allActions.@each.completed", "root.session.actions.[]", (function() {
                        const e = this.get("root.session.actions");
                        if (e)
                            for (let t = 0; t < e.length; t++) {
                                const n = e[t];
                                if (n && n.length && !o.every(n.mapBy("completed"))) return n
                            }
                        return s.A()
                    })),
                    nextActions: s.computed("root.session.actions.[]", "currentActions", (function() {
                        if (!this.get("root.session.actions")) return s.A();
                        const e = this.get("root.session.actions").indexOf(this.get("currentActions"));
                        return -1 === e ? s.A() : this.get("root.session.actions")[e + 1] || s.A()
                    })),
                    nextAction: s.computed("nextActions.[]", "nextActions.@each.actor.isSelf", (function() {
                        const e = this.get("nextActions");
                        return e ? e.findBy("actor.isSelf", !0) || e.get("firstObject") : null
                    })),
                    activeActions: s.computed("root.session.timer.inBanPickPhase", "currentActions.@each.completed", (function() {
                        return this.get("root.session.timer.inBanPickPhase") ? s.A(this.get("currentActions").filterBy("completed", !1)) : s.A()
                    })),
                    activeAction: s.computed("activeActions.[]", "activeActions.@each.actor.isSelf", (function() {
                        const e = this.get("activeActions");
                        return e ? e.findBy("actor.isSelf", !0) || e.get("firstObject") : null
                    })),
                    banActions: s.computed("allActions.id", "allActions.type", (function() {
                        return s.A(this.get("allActions").filterBy("type", "ban"))
                    })),
                    completedBanActions: s.computed.filterBy("banActions.@each.completed", "completed", !0),
                    pickActions: s.computed("allActions.id", "allActions.type", (function() {
                    ...
                    myTeamBanActions: s.computed("banActions.id", "banActions.actor.isOnLeftSide", (function() {
                        return s.A(this.get("banActions").filterBy("actor.isOnLeftSide", !0))
                    })),
                    theirTeamBanActions: s.computed("banActions.id", "banActions.actor.isOnLeftSide", (function() {
                        return s.A(this.get("banActions").filterBy("actor.isOnLeftSide", !1))
                    })),
                    ...
                    someoneIsBanning: s.computed("activeActions.@each.type", (function() {
                        return this.get("activeActions") && !!this.get("activeActions").find((function(e) {
                            return "ban" === e.get("type")
                        }))
                    })),
                    currentBan: s.computed("currentActions.@each.type", "someoneIsBanning", (function() {
                        return this.get("someoneIsBanning") ? this.get("currentActions").findBy("type", "ban") : null
                    })),
                    numBanActionsCompleted: s.computed("banActions.@each.completed", (function() {
                        return this.get("banActions").filterBy("completed", !0).length
                    })),
                    numPickActionsCompleted: s.computed("pickActions.@each.completed", (function() {
