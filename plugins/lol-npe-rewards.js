(() => {
    var e = [, e => {
            ...
            t.default = class {
                ...
                _traService() {
                    const e = s.l10n.tra().overlay("/fe/lol-l10n/trans.json").overlay("/fe/lol-npe-rewards/trans.json");
                    return (0, a.default)(s.Ember, e)
                }
                getEmberApplication(e) {
                    return new Promise((t => {
                        (!this.application || this.application.isDestroyed || this.application.isDestroying) && ((0, l.default)(this._traService(), e.abTestGroupId), this.application = s.ComponentFactory.create(r.PLUGIN_NAME)), t(this.application)
                    }))
                }
                getRootElement(e) {
                ...
                detach() {
                    this.application && (this.application.onRemove(), this.application = null)
                }
            }
        }, e => {
            "use strict";
            ...
            e.exports = function(e, s, a) {
                ...
                return s = s.observe((() => {
                    if (l) {
                        ...
                        l.set("metadata", e), l.beginPropertyChanges(), Object.keys(r).forEach((e => {
                ...
                }).create(), l.set("service", l), l.addObserver("metadata.region", n.bind(null, s, "region")), l.addObserver("metadata.locale", n.bind(null, s, "locale")), a && (console.warning("deprecated: pass a traService as a property of your Ember application definition"), a.register("tra:main", l, {
                    instantiate: !1
                }), a.inject("component", "tra", "tra:main"), a.inject("controller", "tra", "tra:main"), a.inject("view", "tra", "tra:main"), a.inject("model", "tra", "tra:main"), a.inject("route", "tra", "tra:main"), a.inject("service", "tra", "tra:main")), l
            }
        }, (e, t, n) => {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                ...
                s.emberApplicationFactory.setFactoryDefinition(l), s.emberApplicationFactory.setFactoryDefinition(r)
            };
            var s = n(1),
                a = n(5)
        }, (e, t) => {
            ...
            s.map((function() {
                this.route("splash"), this.route("rewardsV2"), this.route("rewardsV3"), this.route("rewardsV4")
            }));
            var a = s;
            t.default = a
        }, (e, t, n) => {
            ...
            var a = s.Ember.Route.extend({
                ...
                beforeModel() {
                    return this.get("layoutService").getInitialRouteName().then((e => this.replaceWith(e)))
                }
            });
            t.default = a
        }, (e, t, n) => {
            ...
            var l = s.Ember.Controller.extend({
                ...
                actions: {
                    openCalendar(e, t) {
                        const n = s.ComponentFactory.create("rcp-fe-lol-npe-rewards-calendar", {
                                rewards: e,
                                rewardsType: t
                            }),
                            l = () => {
                                s.fullPageModalManager.removeEventListener("fullPageModalClose", l)
                            };
                        s.fullPageModalManager.addEventListener("fullPageModalClose", l), s.fullPageModalManager.open({
                            data: {
                                contents: n.domNode
                            }
                        }), (0, a.sendEvent)({
            ...
            var l = s.Ember.Controller.extend({
                ...
                init() {
                    this._super(...arguments), this.get("rewardsService").optInToRewardsChallenges()
                },
                actions: {
                    openCalendar(e, t) {
                        const n = s.ComponentFactory.create("rcp-fe-lol-npe-rewards-calendar", {
            ...
            e.exports = s.Ember.Component.extend({
                ...
                didReceiveAttrs() {
                    ...
                    null !== a && e === a + 1 ? this.set("animatedTickIndex", e) : this.set("animatedTickIndex", null), a = e
                },
                shownRewardPacks: s.Ember.computed("lastClaimedReward", "currentReward", "shouldAnimate", (function() {
                    const e = [];
                    return this.get("lastClaimedReward") && this.get("shouldAnimate") && e.push(this.get("lastClaimedReward")), this.get("currentReward") && e.push(this.get("currentReward")), s.Ember.A(e)
                })),
                lastClaimedRewardIndex: s.Ember.computed("rewards.[]", "lastClaimedReward", (function() {
                    return this.get("lastClaimedReward") ? this.get("rewards").indexOf(this.get("lastClaimedReward")) : -1
                })),
                lastClaimedReward: s.Ember.computed("rewards.@each.state", (function() {
                    let e = null;
                    return this.get("rewards").forEach((t => {
                        "CLAIMED" === t.state && (e = t)
                    })), e
                })),
                ...
                allComplete: s.Ember.computed("completedCount", "currentReward", (function() {
                    return this.get("completedCount") && !this.get("currentReward")
                })),
                progressText: s.Ember.computed("totalCount", "tra.level_rewards_progress_metric", (function() {
                    return this.get("tra").formatString("level_rewards_progress_metric", {
            ...
            var s = n(1);
            n(23);
            var a, l = (a = n(24)) && a.__esModule ? a : {
                default: a
            };
            let r = null;
            e.exports = s.Ember.Component.extend({
                classNames: ["login-rewards-container", "rewards-container"],
                classNameBindings: ["allComplete", "shouldAnimate", "renderModeV3:render-mode-v3:rewards-container"],
                layout: n(25),
                currentTime: 0,
                animatedTickIndex: null,
                shouldAnimate: s.Ember.computed.notEmpty("animatedTickIndex"),
                ...
                didReceiveAttrs() {
                    const e = this.get("lastClaimedRewardIndex");
                    null !== r && e === r + 1 ? this.set("animatedTickIndex", e) : this.set("animatedTickIndex", null), r = e
                },
                updateTimer() {
                    const e = Date.now();
                    this.set("currentTime", e);
                    const t = 1e3 - e % 1e3;
                    this.updateTimerTimeout = window.setTimeout((() => this.updateTimer()), 0 === t ? 1e3 : t)
                },
                willDestroyElement() {
                    this._super(...arguments), this.updateTimerTimeout && window.clearTimeout(this.updateTimerTimeout)
                },
                shownRewardPacks: s.Ember.computed("lastClaimedReward", "currentReward", "shouldAnimate", (function() {
                    const e = [];
                    return this.get("lastClaimedReward") && this.get("shouldAnimate") && e.push(this.get("lastClaimedReward")), this.get("currentReward") && e.push(this.get("currentReward")), s.Ember.A(e)
                ...
                currentRewardUnavailable: s.Ember.computed("currentReward.unlockTime", "currentTime", (function() {
                    return this.get("currentTime") < this.get("currentReward.unlockTime")
                })),
                unlockTimeRemaining: s.Ember.computed("currentReward.unlockTime", "currentTime", (function() {
                    return this.get("currentReward.unlockTime") - this.get("currentTime")
                })),
                unlockRemainingHours: s.Ember.computed("unlockTimeRemaining", (function() {
                    const e = Math.floor(this.get("unlockTimeRemaining") / 36e5) % 60;
                    return (0, l.default)(e, 2)
                })),
                unlockRemainingMinutes: s.Ember.computed("unlockTimeRemaining", (function() {
                    const e = Math.floor(this.get("unlockTimeRemaining") / 6e4) % 60;
                    return (0, l.default)(e, 2)
                })),
                unlockRemainingSeconds: s.Ember.computed("unlockTimeRemaining", (function() {
                    const e = Math.floor(this.get("unlockTimeRemaining") / 1e3) % 60;
                    return (0, l.default)(e, 2)
                })),
                unlockRemainingString: s.Ember.computed("unlockRemainingHours", "unlockRemainingMinutes", "unlockRemainingSeconds", (function() {
                    return this.get("renderModeCarousel") ? this.get("unlockRemainingHours") < 1 ? this.get("tra").formatString("login_rewards_unlock_countdown_short", {
                        minutes: this.get("unlockRemainingMinutes"),
                        seconds: this.get("unlockRemainingSeconds")
                    }) : this.get("tra").formatString("login_rewards_unlock_countdown_long", {
                        hours: this.get("unlockRemainingHours"),
                        minutes: this.get("unlockRemainingMinutes")
                    }) : this.get("tra").formatString("login_rewards_unlock_countdown", {
                        hours: this.get("unlockRemainingHours"),
                        minutes: this.get("unlockRemainingMinutes"),
                        seconds: this.get("unlockRemainingSeconds")
                    })
                ...
                progressText: s.Ember.computed("totalCount", "tra.login_rewards_progress_metric", (function() {
                    return this.get("tra").formatString("login_rewards_progress_metric", {
                        count: this.get("totalCount")
                    })
                })),
                actions: {
            ...
            e.exports = s.Ember.Component.extend({
                ...
                layout: n(28),
                shouldAnimate: !1,
                rewardIndexIndicators: s.Ember.computed("totalCount", "completedCount", "shouldAnimate", (function() {
                    const e = this.get("totalCount"),
                        ...
                        o = [];
                    return n && t !== a && o.push(s.Ember.Object.create({
                        text: (0, l.default)(t, 2),
                        class: "animated-duplicate " + r
                    })), o.push(s.Ember.Object.create({
                        text: (0, l.default)(a, 2),
                        class: r
                    })), s.Ember.A(o)
                })),
                progressBarTicks: s.Ember.computed("totalCount", "completedCount", "shouldAnimate", (function() {
                    const e = s.Ember.A(),
                        t = this.get("totalCount"),
                        n = this.get("completedCount"),
                        a = this.get("shouldAnimate");
                    for (let s = 0; s < t; s++) a ? s === n - 1 ? (e.push("locked-current"), e.push("claimed animated-duplicate")) : s === n ? (e.push("locked"), e.push("locked-current animated-duplicate")) : s < n ? e.push("claimed") : s > n && e.push("locked") : s === n ? e.push("locked-current") : s < n ? e.push("claimed") : s > n && e.push("locked");
                    return e.map((e => ({
                        class: e,
                        _id: Math.random()
                    })))
            ...
            n(30), e.exports = s.Ember.Component.extend({
                ...
                listItems: s.Ember.computed("rewardPack", (function() {
                    ...
                    return t.forEach((e => {
                        switch (e.renderer) {
                            ...
                            case "champion_choice":
                                ...
                                break;
                            case "skin_shard":
                                e.data.name ? n.push("skin_shard_" + e.data.name) : n.push("skin_shard");
                                break;
                            case "client_feature":
                    ...
                    })), n.map((e => s.Ember.Object.create({
                        key: e,
                        description: this.get("tra").get("reward_short_description_" + e)
                    })))
                }))
            })
        }, (e, t, n) => {
            ...
            var r = s.Ember.Component.extend({
                ...
                init: function() {
                    this._super(...arguments), this.patcherButtonEnabledSubscriber = e => {
                        this.isDestroying || this.isDestroyed || this.set("playButtonDisabled", !e)
                    }, s.Navigation.isButtonEnabledSubscribe(this.patcherButtonEnabledSubscriber)
                },
                didInsertElement: function() {
                    this._super(...arguments), this.element && this.element.querySelector(".game-mode-carousel-video") && this.element.querySelector(".game-mode-carousel-video").playWithoutStopping()
                },
                didDestroyElement: function() {
                    this._super(...arguments), s.Navigation.isButtonEnabledUnsubscribe(this.patcherButtonEnabledSubscriber)
                },
                carouselVideoSrc: s.Ember.computed("currentCarouselSelection", (function() {
                    const e = this.get("currentCarouselSelection.queue.mapId");
                    return e ? `/fe/lol-static-assets/videos/npe-rewards-carousel-map-bg-${e}.webm` : ""
                })),
                currentCarouselSelection: s.Ember.computed("currentCarouselSelectionIndex", "carouselQueues", (function() {
                    return this.get("carouselQueues") ? this.get("carouselQueues")[this.get("currentCarouselSelectionIndex")] : null
                })),
                carouselQueues: s.Ember.computed("gameQueues", "eligibility", (function() {
                    if (!this.get("gameQueues") || !this.get("eligibility")) return null;
                    const e = s.Ember.A();
                    return l.forEach((t => {
                        const n = this.get("gameQueues").findBy("id", t),
                            a = this.get("eligibility").find((e => e.queueId === t));
                        n && a && a.eligible && e.pushObject(s.Ember.Object.create({
                            queue: n,
                            title: this.get("tra").get("queue_" + t + "_title"),
                            description: this.get("tra").get("queue_" + t + "_description")
                        }))
                    })), e
                })),
                multipleCarouselQueues: s.Ember.computed.gt("carouselQueues.length", 1),
                selectCarouselItem: function(e) {
                    ...
                    if (this.element && this.element.querySelector(".game-mode-carousel-queue-info")) {
                        const t = n.get("queue.mapId") !== this.get("currentCarouselSelection.queue.mapId");
                        let a;
                        this.set("isAnimating", !0), a = t ? this.element.querySelector(".game-mode-carousel-animation-target") : this.element.querySelector(".game-mode-carousel-queue-info");
                        const l = a.animate([{
                            opacity: 1
                        }, {
                            opacity: 0
                        ...
                        l.onfinish = () => {
                            this.set("currentCarouselSelectionIndex", e), s.Ember.run.scheduleOnce("afterRender", this, (() => {
                                t && this.element.querySelector(".game-mode-carousel-video").playWithoutStopping(), l.cancel();
                                a.animate([{
                                    opacity: 0
                                }, {
                                    opacity: 1
                ...
                actions: {
                    nextCarouselItem: function() {
                        this.selectCarouselItem(this.get("currentCarouselSelectionIndex") + 1)
                    },
                    ...
                    play: function() {
                        ...
                        }), (0, s.dataBinding)("/lol-lobby").post("/v2/lobby", {
                            queueId: t
                        }).then((() => {
            ...
            var l = s.Ember.Component.extend({
                ...
                startLoadingTimeout() {
                    this.set("shouldShowError", !1), this.loadingTimeout = s.Ember.run.later((() => this.set("shouldShowError", !0)), 8e3)
                }
            });
            t.default = l
        }, (e, t, n) => {
            ...
            e.exports = s.Ember.Component.extend({
                ...
                classNameBindings: ["renderModeSidebar:render-mode-sidebar", "renderModeCarousel:render-mode-carousel"],
                layout: n(40),
                rewardsService: s.Ember.inject.service("rewards"),
                newPlayerPackService: s.Ember.inject.service("new-player-pack"),
                rewardsPackDiscountDisabled: s.Ember.computed.alias("rewardsService.RewardsPackDiscountDisabled"),
                ...
                newPlayerPacks: null,
                didReceiveAttrs() {
                    this._super(...arguments), this.get("newPlayerPackService").getNewPlayerPacks().then((e => {
                        this.set("newPlayerPacks", e), this.get("renderModeCarousel") && this.startCarouselAutoNavigate()
                    }))
                },
                willDestroyElement() {
                    this._super(...arguments), this.clearCarouselAutoNavigateTimer()
                },
                visibleNewPlayerPacks: s.Ember.computed("renderModeCarousel", "newPlayerPacks", (function() {
                ...
                activePack: s.Ember.computed("visibleNewPlayerPacks", "activePackIndex", (function() {
                    const e = this.get("visibleNewPlayerPacks"),
                        t = this.get("activePackIndex");
                    return e && 0 !== e.length ? e[t] : null
                })),
                shouldShowCarouselFeatures: s.Ember.computed("renderModeCarousel", "visibleNewPlayerPacks", (function() {
                    const e = this.get("renderModeCarousel"),
                        t = this.get("visibleNewPlayerPacks");
                    return e && t.length > 1
                })),
                backgroundClass: s.Ember.computed("renderModeCarousel", "activePack", (function() {
                ...
                activePackDescription: s.Ember.computed("activePack.itemId", (function() {
                    const e = 99900610 === this.get("activePack.itemId") ? "new_player_pack_panel_description_v2" : "new_player_pack_starter_pack_panel_description";
                    return this.get("tra").formatString(e)
                })),
                shouldShowDiscount: s.Ember.computed("activePack.discountPercentage", "rewardsPackDiscountDisabled", (function() {
                ...
                startCarouselAutoNavigate() {
                    ...
                    const e = setTimeout((() => {
                        this.get("newPlayerPacksLoaded") && this.showNextPack(), this.startCarouselAutoNavigate()
                    }), 5e3);
                ...
                actions: {
                    ...
                    pauseCarousel() {
                        this.get("renderModeCarousel") && this.clearCarouselAutoNavigateTimer()
                    },
                    startCarousel() {
                        this.get("renderModeCarousel") && this.startCarouselAutoNavigate()
                    }
                }
            })
        }, (e, t, n) => {
            ...
            var s = n(1);
            n(5);
            n(42), e.exports = s.Ember.Component.extend({
                classNames: ["lol-npe-rewards-battle-pass-component"],
                layout: n(43),
                totalPointsEarned: s.Ember.computed.alias("tftService.battlePass.totalPointsEarned"),
                mockBattlePass: {
                    totalPointsEarned: 0,
                    milestones: [{
                        id: 0,
            ...
            var s = n(1),
                a = n(5);
            n(45), e.exports = s.Ember.Component.extend({
                classNames: ["lol-npe-rewards-progression-milestone-component"],
                layout: n(46),
                isFirst: s.Ember.computed.equal("milestoneIdx", 0),
                isLast: s.Ember.computed.equal("milestoneIdx", a.LENGTH_OF_MILESTONES - 1),
                isFirstMilestoneInProgress: s.Ember.computed.and("isInProgress", "isFirst"),
                isLastMilestoneComplete: s.Ember.computed.and("isComplete", "isLast"),
                isInProgress: s.Ember.computed.equal("milestone.state", a.BP_MILESTONE_IN_PROGRESS),
                isUnclaimed: s.Ember.computed.equal("milestone.state", a.BP_MILESTONE_CLAIMABLE),
                isAcquired: s.Ember.computed.equal("milestone.state", a.BP_MILESTONE_COMPLETE),
                isComplete: s.Ember.computed.or("isAcquired", "isUnclaimed"),
                progressBarWidth: s.Ember.computed("milestone.percentComplete", "isFirst", (function() {
                    const e = this.get("milestone.percentComplete");
                    return this.get("isFirst") ? a.PROGRESS_BAR_MAX_WIDTH * e * .01 / 2 : a.PROGRESS_BAR_MAX_WIDTH * e * .01
                })),
                progressBarStyle: s.Ember.computed("progressBarWidth", "isFirst", (function() {
                    const e = this.get("progressBarWidth"),
                        t = this.get("isFirst"),
                        n = a.PROGRESS_BAR_MAX_WIDTH / 2 - a.PROGRESS_BAR_END_OFFSET;
                    let s = `width: ${e}px;`;
                    return t && (s += ` left: ${a.PROGRESS_BAR_END_OFFSET}px; max-width: ${n}px;`), s
                }))
            })
        }, (e, t, n) => {
            "use strict";
            ...
            e.exports = s.Ember.Component.extend({
                ...
                setInitialScrollPosition() {
                    ...
                    this.get("currentIdx") > Math.floor(a.LENGTH_OF_MILESTONES / 2) ? (this.element.querySelector(l).disabled = !0, e.scrollLeft = e.scrollWidth, this.setMilestonesMask(e, "left")) : (this.element.querySelector(r).disabled = !0, this.setMilestonesMask(e, "right"))
                },
                ...
                actions: {
                    navigateToStart(e) {
                        ...
                        t.scrollLeft = 0, this.setMilestonesMask(t, "right"), e.target.disabled = !0, this.element.querySelector(l).disabled = !1
                    },
                    navigateToEnd(e) {
                        const t = this.element.querySelector(".milestones");
                        this.setMilestonesMask(t, "left"), t.scrollLeft = t.scrollWidth, e.target.disabled = !0, this.element.querySelector(r).disabled = !1
                    }
                }
            })
        }, (e, t, n) => {
            ...
            var s = n(1),
                a = n(5);
            n(51), e.exports = s.Ember.Component.extend({
                ...
                stateClassName: s.Ember.computed("milestone.state", (function() {
                    ...
                    if (e && "string" == typeof e) return e.toLowerCase().replace("_", "-")
                })),
                actions: {}
            })
        }, (e, t, n) => {
            ...
            var i = a.Ember.Component.extend({
                ...
                challengesProgress: a.Ember.computed.alias("rewardsService.challengesProgress"),
                currentProgress: a.Ember.computed.alias("challengesProgress.progress.currentProgress"),
                totalCount: a.Ember.computed.alias("challengesProgress.progress.totalCount"),
                allComplete: a.Ember.computed("currentProgress", "totalCount", (function() {
                    return !!this.get("totalCount") && this.get("currentProgress") === this.get("totalCount")
                })),
                progressBarStyle: a.Ember.computed("currentProgress", "totalCount", (function() {
                    return `width: ${this.get("currentProgress")/this.get("totalCount")*100}%;`
                })),
                actions: {
                    openMissions() {
                        a.Navigation.showTracker(), (0, r.sendEvent)({
                            eventName: "button-click",
                            buttonAction: "npe-challenges-mission-tracker-button-click"
                        })
                    },
                    openLoot() {
                        a.Router.navigateTo("rcp-fe-lol-loot"), (0, r.sendEvent)({
                            eventName: "button-click",
            ...
            var r = s.Ember.Component.extend({
                ...
                tooltipSetup() {
                    ...
                    if (this.tooltipHoverElement = this.element.parentElement, !e && this.tooltipHoverElement) {
                        ...
                        this.tooltipElement = this.element.querySelector(`#npe-tooltip-${e}`), this.attachTooltip(), this.toolTipAttached = !0
                    }
                },
                didInsertElement() {
            ...
            e.exports = s.HTMLBars.template({
                id: "JrslWKVa",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-npe-rewards\\\\src\\\\app\\\\templates\\\\components\\\\npe-tooltip.hbs\\" style-path=\\"null\\" js-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-npe-rewards\\\\src\\\\app\\\\components\\\\npe-tooltip.js\\" "],["text","\\n"],["open-element","lol-uikit-tooltip",[]],["dynamic-attr","id",["concat",["npe-tooltip-",["unknown",["tooltipId"]]]]],["flush-element"],["text","\\n  "],["yield","default"],["text","\\n"],["close-element"],["text","\\n"]],"locals":[],"named":[],"yields":["default"],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            var d = s.Ember.Service.extend({
                ...
                init() {
                    this._super(...arguments), this.binding = s.dataBinding.bindTo(s.socket), this._setConfigurationState(), this._initObservers()
                },
                willDestroy() {
                    this._super(...arguments), this.binding.unobserve(a), this.binding.unobserve(l), this.binding.unobserve(r), this.binding = null
                },
                visitHub: function() {
                    this.binding.patch(c, {
                        data: {
                            npeRewardsV1IntroSeen: !0
                        },
                        schemaVersion: 1
                    })
                },
                getHasVisitedHub: function() {
                    return this.binding.get(c).then((e => !(!e || !e.data) && Boolean(e.data.npeRewardsV1IntroSeen))).catch((e => (s.logger.error("Error fetching lol-tutorial settings from player preferences:", e), !1)))
                },
                _initObservers: function() {
                    this.binding.observe(a, (e => {
                        !e || this.isDestroying || this.isDestroyed || this.set("levelRewards", s.Ember.A(e.rewardPacks))
                    })), this.binding.observe(l, (e => {
                        !e || this.isDestroying || this.isDestroyed || this.set("loginRewards", s.Ember.A(e.rewardPacks))
                    })), this.binding.observe(r, (e => {
                        !e || this.isDestroying || this.isDestroyed || this.set("challengesProgress", s.Ember.Object.create(e))
                    }))
                },
                _setConfigurationState() {
                    return this._getPlatformConfig().then((e => {
                        this._setRewardsPackDiscountDisabled(e), this._setRewardsChallengesEnabled(e), this.set("configLoaded", !0)
                    })).catch((e => {
                        s.logger.error("Setting UI state from platform configuration failed:", e), this.set("configLoaded", !1)
                    }))
                },
                _getPlatformConfig() {
                    return this.promisedPlatformConfig || (this.promisedPlatformConfig = this.binding.get(i).then((e => e || (s.logger.error("There was a problem fetching platform configuration for NPE"), null)))), this.promisedPlatformConfig
                },
                _setRewardsPackDiscountDisabled(e) {
                    e && this.set("RewardsPackDiscountDisabled", Boolean(e.RewardsPackDiscountDisabled))
                },
                _setRewardsChallengesEnabled(e) {
                    e && this.set("isChallengesEnabled", Boolean(e.RewardsChallengesEnabled))
                },
            ...
            var i = s.Ember.Service.extend({
                init() {
                    this._super(...arguments), this.binding = s.dataBinding.bindTo(s.socket)
                },
                getNewPlayerPacks() {
                    return Promise.all([this.binding.get(o.newPlayerPacks), this.getOwnedInventory()]).then((([e, t]) => Promise.all([e, t, this.getBundleItemsFromCatalog(e)]))).then((([e, t, n]) => (this.prepareNewPlayerPacksForComponent(e, t, n), e)))
                },
                prepareNewPlayerPacksForComponent(e, t, n) {
                    if (Array.isArray(e)) {
                        for (const s of e) Object.assign(s, this.getBundleCostData(s, t, n));
                ...
                getOwnedInventory() {
                    return Promise.all(r.map((e => this.getOwnedInventoryByType(e)))).then((e => {
                        let t = [];
                ...
                createInventoryOwnershipMap(e) {
                    const t = {};
                    for (const n of e) t[n.inventoryType] || (t[n.inventoryType] = {}), "OWNED" === n.ownershipType && (t[n.inventoryType][n.itemId] = !0);
                    return t
                },
                getBundleItemsFromCatalog(e) {
                    const t = this.groupBundleItemsByInventoryType(e),
                        n = [];
                    for (const e of Object.keys(t)) n.push(this.getCatalogItemsByInventoryType(e, t[e]));
                ...
                groupBundleItemsByInventoryType(e) {
                    ...
                    const t = {};
                    for (const n of e)
                        for (const e of n.bundled.items) t[e.inventoryType] ? t[e.inventoryType].push(e) : t[e.inventoryType] = [e];
                    return t
                },
                ...
                fillMissingCatalogItems(e, t) {
                    for (const n of Object.keys(e)) {
                        ...
                        for (const s of e[n]) {
                            ...
                            (!t[e] || !t[e][n]) && a && (t[e][n] = this.createDummyCatalogItem(s))
                        }
                    }
                },
                ...
                getCatalogItemsByInventoryType(e, t) {
                    ...
                    return (0, s.dataBinding)("/lol-store").get(`/v1/catalog?inventoryType=["${e}"]&itemId=[${n.toString()}]`)
                },
                getBundleDiscountCost(e) {
                    return e.bundled.items.reduce(((e, t) => e + this.getRpCostFromPrices(t.discountPrices)), 0)
                },
                ...
                getBundleIsOwned: (e, t) => e.bundled.items.every((({
                    inventoryType: e,
                    itemId: n
                ...
                getBundleCostData(e, t, n) {
                    ...
                    let r = 0;
                    return 0 !== s && (r = Math.round((s - a) / s * 100)), {
                        totalCost: s,
                        discountCost: a,
            ...
            var i = s.Ember.Service.extend({
                ...
                eligibility: null,
                init() {
                    this._super(...arguments), this.binding = s.dataBinding.bindTo(s.socket), this._initObservers()
                },
                willDestroy() {
                    this._super(...arguments), this.binding.unobserve(a), this.binding.unobserve(l), this.binding.unobserve(r), this.binding = null
                },
                _initObservers() {
                    this.binding.observe(a, (e => {
                        !e || this.isDestroying || this.isDestroyed || this.set("gameQueues", s.Ember.A(e))
                    })), this.binding.observe(l, (e => {
                        !e || this.isDestroying || this.isDestroyed || this.set("lobby", e)
                    })), this.binding.observe(r, (e => {
                        (e || this.isDestroying || this.isDestroyed) && this.binding.post(o).then((e => {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                return s.Ember.Service.extend({
                    rewardsService: s.Ember.inject.service("rewards"),
                    getInitialRouteName() {
                        return this.get("rewardsService").getHasVisitedHub().then((e => e ? this.getPostSplashRouteName() : "splash")).catch((() => "splash"))
                    },
                    getPostSplashRouteName: () => e === a.LAYOUT_NAMES.V3 ? "rewardsV3" : "rewardsV4"
                })
            };
            var s = n(1),
                a = n(5)
            ...
            e.exports = s.HTMLBars.template({
                id: "7umcaCQI",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\Releases_13_22\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-npe-rewards\\\\src\\\\app\\\\templates\\\\application.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","rcp-fe-lol-npe-rewards"],["flush-element"],["text","\\n  "],["open-element","div",[]],["static-attr","class","lol-npe-rewards-content"],["flush-element"],["text","\\n    "],["append",["unknown",["outlet"]],false],["text","\\n  "],["close-element"],["text","\\n"],["close-element"],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const s = n(1).Ember;
            ...
            n(71), e.exports = s.Ember.Component.extend({
                ...
                setInitialSelectedItem: function() {
                    const e = this.get("rewards");
                    for (let t = 0; t < e.length; t++)
                        if ("LOCKED" === e[t].state) return this.set("selectedRewardIndex", t), void this.set("selectedReward", e[t]);
                    this.set("selectedRewardIndex", e.length - 1), this.set("selectedReward", e[e.length - 1])
                },
                lastItemNumber: s.Ember.computed.alias("rewards.length"),
                rewardsCalendarHeaderTitle: s.Ember.computed("rewardsType", (function() {
                    const e = this.get("tra"),
                        t = `calendar_rewards_header_${this.get("rewardsType")}_title`;
                    return e.get(t)
                })),
                rewardsCalendarHeaderDescription: s.Ember.computed("rewardsType", (function() {
                    const e = this.get("tra"),
                        t = `calendar_rewards_header_${this.get("rewardsType")}_description`;
                    return e.get(t)
                })),
                rewardsCalendarFooterMessage: s.Ember.computed("rewardsType", (function() {
                    const e = this.get("rewardsType");
                    return this.get("tra").get(`calendar_rewards_footer_${e}_message`)
                })),
                actions: {
                    selectRewardItem(e, t) {
                        this.set("selectedRewardIndex", t), this.set("selectedReward", e)
                    }
                }
            })
        }, (e, t, n) => {
            ...
            n(74), e.exports = s.Ember.Component.extend({
                ...
                hideMinorRewards: s.Ember.computed("reward.minorRewards", (function() {
                    for (const e of this.get("reward.minorRewards"))
                        if (!e.data.hideInCalendarDetail) return !1;
                    return !0
                })),
                isLastCalendarItem: s.Ember.computed("index", "lastItemNumber", (function() {
                    return this.get("index") === this.get("lastItemNumber") - 1
                })),
                isSelectedCalendarItem: s.Ember.computed("index", "selectedItemIndex", (function() {
                ...
                selectedItemClass: s.Ember.computed("isSelectedCalendarItem", (function() {
                    return this.get("isSelectedCalendarItem") ? " selected" : ""
                })),
                isChampionChoice: s.Ember.computed.equal("reward.majorReward.renderer", "champion_choice"),
                hasChampionChoiceRoleIcon: s.Ember.computed("isChampionChoice", "reward.majorReward.data.type", (function() {
            ...
            n(77), e.exports = s.Ember.Component.extend({
                ...
                init() {
                    this._super(...arguments), this.set("champions", s.Ember.A()), this.set("spellsIconsImages", s.Ember.A())
                },
                didReceiveAttrs() {
                    this._super(...arguments);
                    const e = this.get("selectedReward.majorReward.renderer");
                    "champion_choice" === e ? this.setAllChampions() : "spells" === e && this.setAllSpellsIcons()
                },
                setAllSpellsIcons: function() {
                    return this.set("spellsIconsImages", s.Ember.A()), (0, s.dataBinding)("lol-game-data").get("/assets/v1/summoner-spells.json").then((e => {
                        this.isDestroyed || this.isDestroying || this.setSpellIconImg(e)
                    }))
                },
                ...
                setAllChampions: function() {
                    ...
                    const e = this.get("selectedReward.majorReward.data.champIds").map((e => this.getChampion(e)));
                    return Promise.all(e).then((e => {
                        const t = s.Ember.A(e);
                        this.isDestroyed || this.isDestroying || this.set("champions", t)
                    }))
                },
                getChampion: function(e) {
                    return (0, s.dataBinding)("lol-game-data").get("/assets/v1/champions/" + e + ".json")
                },
                isChampionChoice: s.Ember.computed.equal("selectedReward.majorReward.renderer", "champion_choice"),
                isSpellChoice: s.Ember.computed.equal("selectedReward.majorReward.renderer", "spells"),
                progressNumberText: s.Ember.computed("rewardType", "selectedRewardIndex", (function() {
                    const e = this.get("rewardType"),
                        t = this.get("selectedRewardIndex");
                    return this.get("tra").formatString(`calendar_detail_${e}_title`, {
                        progressNumber: t + 1
                    })
                }))
            })
            ...
            e.exports = s.Ember.Helper.extend({
                compute: function(e) {
                    ...
                    if (!l) return n.get(r);
                    if ("minor" === a) {
                        if (l.type && (r += "_" + l.type), l.gameModes) return l.gameModes.map((e => n.get(r + "_" + e))).join(", ");
                        if (l.ids) return l.ids.map((e => n.get(r + "_" + e))).join(", ")
                    }
                    return l.quantity ? n.formatString(r, {
                        quantity: l.quantity
                    }) : n.get(r)
                }
            })
            ...
            e.exports = s.Ember.Helper.extend({
                compute: function(e) {
                    const t = e[0],
                        ...
                        s = e[2];
                    if ("minor" === s) {
                        return ["hextech-chest", "blue-essence", "hextech-key", "hextech-key-fragment", "orange-essence", "xp-boost"].includes(n) ? `${t}/npe-rewards-${n}.png` : `${t}/npe-rewards-unlock.png`
                    }
    ...
    n.r = e => {
        ...
        a.addEventListener(l, (function(e) {
            (0, e.registrationHandler)((e => t.default.init(e, {
                ...
                dataBinding: e => e.get("rcp-fe-common-libs").getDataBinding("rcp-fe-lol-npe-rewards"),
                Ember: e => e.get("rcp-fe-ember-libs").getEmber(),
                emberDataBinding: e => e.get("rcp-fe-ember-libs").getEmberDataBinding("rcp-fe-lol-npe-rewards"),
                fullPageModalManager: e => e.get("rcp-fe-lol-navigation").getFullPageModalManager(),
